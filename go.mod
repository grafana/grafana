...
require github.com/grpc-ecosystem/go-grpc-middleware/providers/prometheus v1.0.1 // indirect
...
replace github.com/grafana/grafana-plugin-sdk-go => github.com/grafana/grafana-plugin-sdk-go v0.225.1-0.20240425102539-d47a5a12b98f
