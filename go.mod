...
require (
	...
	github.com/grafana/alerting v0.0.0-20250911172908-2b26ef8f17eb // @grafana/alerting-backend
	...
	github.com/grafana/grafana-app-sdk/logging v0.43.1 // @grafana/grafana-app-platform-squad
