...
require github.com/grpc-ecosystem/go-grpc-middleware/providers/prometheus v1.0.0 // indirect
...
replace github.com/grafana/grafana-plugin-sdk-go => github.com/grafana/grafana-plugin-sdk-go v0.225.1-0.20240422184134-260496ef2e59
