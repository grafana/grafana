...
require (
	...
	github.com/grafana/authlib v0.0.0-20240826185126-5d9a84d9b410 // @grafana/identity-access-team
	github.com/grafana/authlib/claims v0.0.0-20240826185126-5d9a84d9b410 // @grafana/identity-access-team
