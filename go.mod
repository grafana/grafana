...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/s3 v1.99.0 // @grafana/grafana-search-and-storage
...
require github.com/thomaspoignant/go-feature-flag/modules/core v0.6.1 // indirect
