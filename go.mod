...
require (
	...
	github.com/grafana/grafana/apps/colorshapes v0.0.0 // learning exercise, see apps/colorshapes/plan.md
...
replace (
	...
	github.com/grafana/grafana/apps/colorshapes => ./apps/colorshapes
