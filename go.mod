...
require (
	...
	github.com/grafana/grafana-app-sdk v0.32.0 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.31.1 // @grafana/grafana-app-platform-squad
