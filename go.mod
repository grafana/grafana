...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.0.0-20220315192657-66a9c9b6fccb
	gocloud.dev v0.24.0
)
...
require (
	...
	go.opentelemetry.io/contrib v1.4.1-0.20220315192657-66a9c9b6fccb // indirect
)
