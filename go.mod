...
require (
	...
	github.com/grafana/alerting v0.0.0-20250310162546-f14994a830e7 // @grafana/alerting-backend
	...
	github.com/grafana/grafana-plugin-sdk-go v0.270.0 // @grafana/plugins-platform-backend
