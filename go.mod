...
require (
	...
	github.com/grafana/grafana-app-sdk v0.51.1 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.50.4 // @grafana/grafana-app-platform-squad
