...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.233.1-0.20240604102803-7945928e2f01 // @grafana/plugins-platform-backend
	...
	golang.org/x/tools v0.19.0 // @grafana/grafana-as-code
