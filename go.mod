...
require (
	...
	github.com/thomaspoignant/go-feature-flag v1.55.1 // @grafana/grafana-backend-group
...
require github.com/thomaspoignant/go-feature-flag/modules/core v0.7.2 // indirect
