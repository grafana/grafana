...
require (
	...
	github.com/grafana/grafana/apps/playlist v0.0.0-20241105124347-34991f5b440a // @grafana/grafana-app-platform-squad
)

require github.com/jmespath-community/go-jmespath v1.1.1 // @grafana/identity-access-team

require github.com/openzipkin/zipkin-go v0.4.3
