...
require (
	...
	github.com/grafana/grafana-app-sdk/logging v0.43.0 // @grafana/grafana-app-platform-squad
	...
	sigs.k8s.io/structured-merge-diff/v6 v6.3.0 // @grafana-app-platform-squad
...
require github.com/woodsbury/decimal128 v1.3.0 // indirect
