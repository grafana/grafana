...
require (
	...
	github.com/grafana/alerting v0.0.0-20260206215538-35f3427554ec // @grafana/alerting-backend
	github.com/grafana/authlib v0.0.0-20260427145542-9c256e2dbcb2 // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20260430180621-c21b3d474176 // @grafana/identity-access-team
	...
	github.com/mattn/go-isatty v0.0.22 // indirect; @grafana/grafana-backend-group
...
require (
	github.com/grafana/grafana/apps/advisor v0.0.0-00010101000000-000000000000 // @grafana/plugins-platform-backend
	github.com/grafana/grafana/apps/alerting/notifications v0.0.0-00010101000000-000000000000 // @grafana/alerting-backend
	github.com/grafana/grafana/apps/investigations v0.0.0-00010101000000-000000000000 // @fcjack @matryer
	github.com/grafana/grafana/apps/playlist v0.0.0-00010101000000-000000000000 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/aggregator v0.0.0-20250220163425-b4c4b9abbdc8 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20260506075041-5a961aa4e9f7 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20250220154326-6e5de80ef295 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/build v0.0.0-00010101000000-000000000000 // @grafana/grafana-developer-enablement-squad
	github.com/grafana/grafana/pkg/infra/log v0.0.0-00010101000000-000000000000 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana/pkg/storage/unified/apistore v0.0.0-00010101000000-000000000000 // @grafana/grafana-search-and-storage
	github.com/grafana/grafana/pkg/storage/unified/resource v0.0.0-00010101000000-000000000000 // @grafana/grafana-search-and-storage
)

replace (
	github.com/grafana/grafana/apps/advisor => ./apps/advisor
	github.com/grafana/grafana/apps/aggregator => ./apps/aggregator
	...
	github.com/grafana/grafana/pkg/build => ./pkg/build
	...
	github.com/grafana/grafana/pkg/storage/unified/resource => ./pkg/storage/unified/resource
)
...
replace github.com/prometheus/alertmanager => github.com/grafana/prometheus-alertmanager v0.25.1-0.20260206185757-70751e6fafe0
