...
require (
	...
	github.com/hashicorp/go-secure-stdlib/plugincontainer v0.4.1 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/prometheus v1.8.2-0.20220228151929-e25a59925555 // @grafana/alerting-backend
