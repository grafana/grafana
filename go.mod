...
require (
	...
	github.com/grafana/grafana/apps/palettes v0.0.0 // @grafana/grafana-app-platform-squad @grafana/grafana-frontend-platform
...
replace (
	...
	github.com/grafana/grafana/apps/palettes => ./apps/palettes
