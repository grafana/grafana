...
require (
	...
	github.com/grafana/alerting v0.0.0-20260206215212-37e3cac0b97c // @grafana/alerting-backend
	...
	github.com/modelcontextprotocol/go-sdk v1.6.0 // @grafana/grafana-app-platform-squad
