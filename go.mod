...
require (
	...
	github.com/grafana/grafana-app-sdk v0.51.0 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.51.0 // @grafana/grafana-app-platform-squad
