...
require (
	...
	github.com/grafana/authlib v0.0.0-20250221095612-1a4a1ee20638 // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20250221090651-96df7bfebb0a // @grafana/identity-access-team
