...
require (
	...
	cuelang.org/go v0.5.0 // @grafana/grafana-app-platform-squad
	...
	github.com/beevik/etree v1.1.0 // @grafana/backend-platform
	...
	github.com/crewjam/saml v0.4.12 // @grafana/backend-platform
	...
	github.com/google/go-cmp v0.5.9 // @grafana/alerting-squad-backend
	github.com/google/uuid v1.3.0 // @grafana/alerting-squad-backend
	github.com/google/wire v0.5.0 // @grafana/backend-platform
	github.com/gorilla/websocket v1.5.0 // @grafana/grafana-app-platform-squad
	github.com/grafana/alerting v0.0.0-20230428095912-33c5aa68a5ba // @grafana/alerting-squad-backend
	...
	github.com/grafana/grafana-plugin-sdk-go v0.162.0 // @grafana/alerting-squad-backend
	...
	github.com/prometheus/client_model v0.3.0 // @grafana/backend-platform
	github.com/prometheus/common v0.42.0 // @grafana/alerting-squad-backend
	...
	github.com/russellhaering/goxmldsig v1.2.0 // @grafana/backend-platform
	github.com/stretchr/testify v1.8.2 // @grafana/alerting-squad-backend
	...
	golang.org/x/crypto v0.7.0 // @grafana/backend-platform
	golang.org/x/exp v0.0.0-20230307190834-24139beb5833 // @grafana/alerting-squad-backend
	golang.org/x/net v0.10.0 // @grafana/grafana-bi-squad
	golang.org/x/oauth2 v0.6.0 // @grafana/backend-platform
	golang.org/x/sync v0.2.0 // @grafana/alerting-squad-backend
	golang.org/x/time v0.3.0 // @grafana/backend-platform
	golang.org/x/tools v0.9.3 // @grafana/grafana-as-code
	gonum.org/v1/gonum v0.11.0 // @grafana/observability-metrics
	google.golang.org/api v0.111.0 // @grafana/backend-platform
	google.golang.org/grpc v1.54.0 // @grafana/backend-platform
	google.golang.org/protobuf v1.30.0 // @grafana/grafana-app-platform-squad
...
require (
	...
	github.com/go-kit/log v0.2.1 // @grafana/alerting-squad-backend
	...
	github.com/hashicorp/go-multierror v1.1.1 // @grafana/alerting-squad-backend
	...
	golang.org/x/text v0.9.0 // @grafana/backend-platform
...
require (
	...
	github.com/grafana/dskit v0.0.0-20230202092222-880a7f8141cc // @grafana/alerting-squad-backend
	...
	go.etcd.io/etcd/api/v3 v3.5.5 // @grafana/backend-platform
...
require (
	...
	github.com/grafana/thema v0.0.0-20230524160113-4e9d6e28a640 // @grafana/grafana-app-platform-squad
	...
	github.com/weaveworks/common v0.0.0-20230208133027-16871410fca4 // @grafana/alerting-squad-backend
...
require (
	...
	github.com/hmarr/codeowners v1.1.2 // @grafana/grafana-app-platform-squad
