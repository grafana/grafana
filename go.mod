...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.59.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.75.2 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.306.0 // @grafana/data-sources-plugins
