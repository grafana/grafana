...
require (
	...
	github.com/charmbracelet/bubbles v0.21.0 // @grafana/grafana-app-platform-squad
...
require (
	...
	golang.org/x/exp v0.0.0-20260718201538-764159d718ef // indirect; @grafana/identity-access-team
