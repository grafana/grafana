...
require (
	...
	github.com/grafana/grafana-app-sdk v0.25.2-0.20241121130914-f68e3b25fbc6 // @grafana/grafana-app-platform-squad
	...
	github.com/grafana/grafana-plugin-sdk-go v0.259.3 // @grafana/plugins-platform-backend
