...
require (
	...
	github.com/grafana/grafana-app-sdk v0.33.1-0.20250313184517-44ca2b889c27 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.33.0 // @grafana/grafana-app-platform-squad
