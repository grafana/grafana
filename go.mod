...
replace github.com/grafana/grafana-plugin-sdk-go v0.284.0 => ../grafana-plugin-sdk-go
...
require (
	...
	github.com/grafana/grafana/apps/quotas v0.0.0-20251212093413-296fe610ba13 // @grafana/grafana-search-and-storage
