...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/kms v1.41.2 // @grafana/grafana-operator-experience-squad
	...
	github.com/redis/go-redis/extra/redisotel/v9 v9.20.0 // @grafana/grafana-operator-experience-squad
	github.com/redis/go-redis/v9 v9.20.0 // @grafana/alerting-backend
