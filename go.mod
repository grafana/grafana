...
require (
	...
	github.com/aws/aws-sdk-go v1.55.7 // indirect; @grafana/data-sources-plugins
	...
	github.com/aws/aws-sdk-go-v2/service/kms v1.52.2 // @grafana/grafana-operator-experience-squad
