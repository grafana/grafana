...
require (
	...
	github.com/thomaspoignant/go-feature-flag v1.53.0 // @grafana/grafana-backend-group
...
require github.com/thomaspoignant/go-feature-flag/modules/core v0.7.1 // indirect
