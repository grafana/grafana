...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.61.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.78.1 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.310.0 // @grafana/data-sources-plugins
