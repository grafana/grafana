...
require (
	...
	github.com/grafana/grafana-app-sdk v0.52.3-0.20260407171230-6cafdbafb353 // @grafana/grafana-app-platform-squad
	...
	golang.org/x/net v0.52.0 // @grafana/data-sources-plugins @grafana/partner-datasources
