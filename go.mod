...
require (
	...
	github.com/mattn/go-sqlite3 v1.14.22 // indirect; @grafana/grafana-backend-group
	...
	golang.org/x/exp v0.0.0-20241217172543-b2144cdd0a67 // @grafana/alerting-backend
