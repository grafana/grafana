...
require (
	...
	github.com/prometheus/prometheus v0.302.1 // @grafana/alerting-backend
	...
	go.opentelemetry.io/collector/pdata v1.24.0 // @grafana/grafana-backend-group
...
require (
	...
	github.com/prometheus/sigv4 v0.1.1 // @grafana/alerting-backend
