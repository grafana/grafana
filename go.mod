...
require (
	...
	dario.cat/mergo v1.0.2 // @grafana-app-platform-squad
...
require (
	...
	github.com/grafana/grafana/apps/preferences v0.0.0-20250805151731-da3da1b919ae // @grafana/grafana-app-platform-squad
