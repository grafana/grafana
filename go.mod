...
require (
	...
	cloud.google.com/go/storage v1.60.0 // @grafana/grafana-backend-group
	...
	github.com/redis/go-redis/v9 v9.17.3 // @grafana/alerting-backend
	...
	github.com/thomaspoignant/go-feature-flag v1.51.2 // @grafana/grafana-backend-group
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.16.0 // indirect; @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/otel/log v0.16.0 // indirect; @grafana/grafana-operator-experience-squad
	go.opentelemetry.io/otel/sdk v1.40.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/otel/sdk/log v0.16.0 // indirect; @grafana/grafana-operator-experience-squad
	...
	google.golang.org/api v0.266.0 // @grafana/grafana-backend-group
