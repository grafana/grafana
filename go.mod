...
require (
	...
	github.com/grafana/authlib v0.0.0-20260305185646-d85984ee73ca // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20260305185646-d85984ee73ca // @grafana/identity-access-team
