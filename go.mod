...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.288.1-0.20260218133939-d9e6496796fd // @grafana/plugins-platform-backend
...
require github.com/smarty/assertions v1.15.0 // indirect
