...
// github.com/hashicorp/consul v1.2.1 (/Users/fz/go/pkg/mod/github.com/hashicorp/consul@v1.2.1/api)
// github.com/hashicorp/consul/api v1.8.1 (/Users/fz/go/pkg/mod/github.com/hashicorp/consul/api@v1.8.1)
//
// Using same replace as in Loki repo.
