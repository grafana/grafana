...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.22.34 // @grafana/alerting-backend
	...
	github.com/aws/aws-sdk-go-v2/service/s3 v1.105.2 // @grafana/grafana-search-and-storage
