...
require (
	...
	github.com/grafana/grafana-app-sdk v0.25.0 // @grafana/grafana-app-platform-squad
...
require github.com/grafana/grafana/apps/secret v0.0.0-20241105090059-facca37f4d1f
