...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.260.4-0.20250107151639-03927e4e6baf // @grafana/plugins-platform-backend
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20241209162323-e6fa225c2576 // indirect; @grafana/plugins-platform-backend
