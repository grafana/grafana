...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace v0.37.0 // indirect; @grafana/grafana-operator-experience-squad
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.42.0 // indirect; @grafana/plugins-platform-backend
