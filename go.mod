...
require (
	...
	github.com/grafana/authlib v0.0.0-20250121093725-6a1acb5557ba // @grafana/identity-access-team
...
require github.com/grafana/authlib/claims v0.0.0-20240814074258-eae7d47f01db
