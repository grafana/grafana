...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.22.32 // @grafana/alerting-backend
	...
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.315.0 // @grafana/data-sources-plugins
