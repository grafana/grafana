...
require (
	...
	github.com/grafana/grafana-app-sdk/logging v0.39.2 // @grafana/grafana-app-platform-squad
...
require cloud.google.com/go/spanner v1.76.1 // @grafana/grafana-search-and-storage
