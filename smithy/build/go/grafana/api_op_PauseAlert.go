...
func (c *Client) PauseAlert(ctx context.Context, params *PauseAlertInput, optFns ...func(*Options)) (*PauseAlertOutput, error) {
	if params == nil { params = &PauseAlertInput{} }
	
	result, metadata, err := c.invokeOperation(ctx, "PauseAlert", params, optFns, c.addOperationPauseAlertMiddlewares)
...
func (c *Client) addOperationPauseAlertMiddlewares(stack *middleware.Stack, options Options) (err error) {
