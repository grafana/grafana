...
- **[v8.1.x] Alerting:** Fix alerts with evaluation interval more than 30 seconds resolving before notification. [#39522](https://github.com/grafana/grafana/pull/39522), [@grafanabot](https://github.com/grafanabot)
