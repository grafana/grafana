...
### Features / Enhancements
  * **Alerting API**: send 404 not found error and enrich delete with UID endpoint response with alert notification ID. [#27550](https://github.com/grafana/grafana/pull/27550), [@AgnesToulet](https://github.com/AgnesToulet)
  ...
  * **ApiKeys**: Fixes close('X') button layout issue. [#27625](https://github.com/grafana/grafana/pull/27625), [@nikasvan](https://github.com/nikasvan)
  ...
  * **Binary-prefixed data rates**. [#27022](https://github.com/grafana/grafana/pull/27022), [@Berbe](https://github.com/Berbe)
