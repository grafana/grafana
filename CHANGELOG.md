...
| `[alerting][enabled]` | `[unified_alerting][enabled]` | With Existing Leagcy Alerts | Result             |
| --------------------- | ----------------------------- | --------------------------- | ------------------ | --------------------------------------------------------------- |
| `true`                | `true`                        | N/A                         | Error              |
...
| `false`               | not set                       | N/A                         | Grafana 8 Alerting | Issue [#42200](https://github.com/grafana/grafana/issues/42200) |
