...
* **TimeSeries:** ensure series overrides containing color are migrated, and migrate previous `fieldConfig` when changing panel type. [#35676](https://github.com/grafana/grafana/pull/35676), [@ashharrison90](https://github.com/ashharrison90)
...
* **Fix:** fix loading symbolically linked plugins. [#35635](https://github.com/grafana/grafana/pull/35635), [@domasx2](https://github.com/domasx2)
* **LibraryPanels:** Fixes crash in libray panels list when panel plugin is not found. [#35907](https://github.com/grafana/grafana/pull/35907), [@torkelo](https://github.com/torkelo)
...
* **MSSQL:** Fixes issue with hidden queries still being executed. [#35837](https://github.com/grafana/grafana/pull/35837), [@torkelo](https://github.com/torkelo)
* **MSSQL:** Fixes issue with hidden queries still being executed. [#35787](https://github.com/grafana/grafana/pull/35787), [@torkelo](https://github.com/torkelo)
* **PanelEdit:** VisulizationPicker doesn't show if panel has an unknown panel plugin. [#35831](https://github.com/grafana/grafana/pull/35831), [@jackw](https://github.com/jackw)
* **Prometheus:** Fixes issue where legend name was replaced with name Value in stat & gauge panels. [#35863](https://github.com/grafana/grafana/pull/35863), [@torkelo](https://github.com/torkelo)
