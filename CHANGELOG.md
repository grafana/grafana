...
- **TemplateSrv**: Formatting options for ${__from} and ${\_\_to}, unix seconds epoch, ISO 8601/RFC 3339. [#26466](https://github.com/grafana/grafana/pull/26466), [@torkelo](https://github.com/torkelo)
