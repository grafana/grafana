...
* **Prometheus:** Fix issue where legend name was replaced with name Value in stat & gauge panels. [#35863](https://github.com/grafana/grafana/pull/35863), [@torkelo](https://github.com/torkelo)
