...
* **Field color**: handling color changes when switching panel types. [#28875](https://github.com/grafana/grafana/pull/28875), [@dprokop](https://github.com/dprokop)
* **Field config**: implement slider editor. [#27592](https://github.com/grafana/grafana/issues/27592)
* **Field config**: implementation slider editor (#27592). [#28007](https://github.com/grafana/grafana/pull/28007), [@isaozlerfm](https://github.com/isaozlerfm)
