...
func init() {
  ...
  "paths": {
    ...
    "/api/v1/namespace/{Namespace}/permissions": {
      "get": {
        "description": "sets an Alerting config",
        "tags": [
          "permissions"
        ],
        "operationId": "RouteGetNamespacePermissions",
        "parameters": [
          {
            "type": "string",
      ...
      "post": {
        ...
        "operationId": "RouteSetNamespacePermissions",
        "parameters": [
          {
            "type": "string",
            "description": "Namespace name to apply perms to",
            "name": "Namespace",
            "in": "path",
            "required": true
          },
          {
            "description": "New namespace permissions",
            "name": "Body",
            "in": "body",
            "schema": {
              "$ref": "#/definitions/Permissions"
  ...
  "definitions": {
    ...
    "ExtendedUpsertAlertDefinitionCommand": {
      ...
      "properties": {
        ...
        "data": {
          "description": "Data is an array of the queries and expressions",
          "type": "array",
          "items": {
            "$ref": "#/definitions/AlertQuery"
          },
        ...
        "uid": {
          "description": "UID is set only for existing definitions",
          "type": "string",
          "x-go-name": "UID"
        }
      },
    ...
    "SilenceBody": {
      ...
      "x-go-package": "github.com/grafana/alerting-api/pkg/tst"
    },
    "SlackAction": {
  ...
  "definitions": {
    ...
    "AlertResponse": {
      ...
      "properties": {
        "Body": {
          "$ref": "#/definitions/alertResponseBody"
        }
      },
      "x-go-package": "github.com/grafana/alerting-api/pkg/api"
    },
