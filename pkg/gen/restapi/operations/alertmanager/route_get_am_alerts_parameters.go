...
// RouteGetAmAlertsParams contains all the bound params for the route get am alerts operation
// typically these are obtained from a http.Request
//
// swagger:parameters RouteGetAmAlerts
...
//
// To ensure default values, the struct must have been initialized with NewRouteGetAmAlertsParams() beforehand.
func (o *RouteGetAmAlertsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RouteGetAmAlertsParams) bindDatasourceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RouteGetAmAlertsParams) bindActive(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RouteGetAmAlertsParams) bindInhibited(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RouteGetAmAlertsParams) bindMatchers(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *RouteGetAmAlertsParams) bindReceivers(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *RouteGetAmAlertsParams) bindSilenced(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
