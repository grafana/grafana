...
// RouteGetRuleStatusesParams contains all the bound params for the route get rule statuses operation
...
//
// To ensure default values, the struct must have been initialized with NewRouteGetRuleStatusesParams() beforehand.
func (o *RouteGetRuleStatusesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RouteGetRuleStatusesParams) bindDatasourceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
