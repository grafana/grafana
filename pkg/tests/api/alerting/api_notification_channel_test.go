			...
			Data: map[string]interface{}{
				...
				"Alerts": alertingTemplates.ExtendedAlerts{
					alertingTemplates.ExtendedAlert{
						...
						StartsAt:     time.Time{},
						EndsAt:       time.Time{},
						GeneratorURL: "http://localhost:3000/alerting/grafana/UID_EmailAlert/view", // LOGZ.IO GRAFANA CHANGE :: DEV-45466 removed orgId from urls
						Fingerprint:  "1e8f5e886dc14813",
						SilenceURL:   "http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=alertname%3DEmailAlert&matcher=grafana_folder%3Ddefault", // LOGZ.IO GRAFANA CHANGE :: DEV-45466 removed orgId from urls
						DashboardURL: "",
						PanelURL:     "",
		  ...
		  "attachments": [
			{
			  ...
			  "footer": "logz.io",
			  "footer_icon": "https://s3.amazonaws.com/logzio-static-content-cdn/logzio-logo.png",
			  "color": "#D63232",
			  "ts": %s,
              "mrkdwn_in": ["pretext"],
