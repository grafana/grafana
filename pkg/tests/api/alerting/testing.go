...
// PostableAlertmanagerUserConfig represents the format expected by the server
// where alertmanager_config is a YAML string, not a structured object
type PostableAlertmanagerUserConfig struct {
	AlertmanagerConfig string            `yaml:"alertmanager_config" json:"alertmanager_config"`
	TemplateFiles      map[string]string `yaml:"template_files" json:"template_files"`
}

func (a apiClient) ConvertPrometheusPostAlertmanagerConfig(t *testing.T, amCfg PostableAlertmanagerUserConfig, headers map[string]string) apimodels.ConvertPrometheusResponse {
	t.Helper()
...
func (a apiClient) RawConvertPrometheusPostAlertmanagerConfig(t *testing.T, amCfg PostableAlertmanagerUserConfig, headers map[string]string) (apimodels.ConvertPrometheusResponse, int, string) {
	t.Helper()
