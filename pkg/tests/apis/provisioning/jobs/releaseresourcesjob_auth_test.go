...
func TestIntegrationProvisioning_ReleaseResourcesJobAuthorization(t *testing.T) {
	...
	t.Run("admin can create releaseResources job for nonexistent repo", func(t *testing.T) {
		var statusCode int
	...
	t.Run("editor cannot create releaseResources job", func(t *testing.T) {
		var statusCode int
	...
	t.Run("viewer cannot create releaseResources job", func(t *testing.T) {
		var statusCode int
