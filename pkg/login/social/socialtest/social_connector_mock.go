...
import (
	...
	ssosettingsmodels "github.com/grafana/grafana/pkg/services/ssosettings/models"
)
...
func (_m *MockSocialConnector) Reload(ctx context.Context, settings ssosettingsmodels.SSOSettings) error {
	ret := _m.Called(ctx, settings)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, ssosettingsmodels.SSOSettings) error); ok {
		r0 = rf(ctx, settings)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockSocialConnector) Validate(ctx context.Context, settings ssosettingsmodels.SSOSettings) error {
	ret := _m.Called(ctx, settings)
