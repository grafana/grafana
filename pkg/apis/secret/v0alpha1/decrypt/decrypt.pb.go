...
type SecureValueDecryptResponseCollection struct {
	...
	DecryptedValues map[string]*ValueResult `protobuf:"bytes,1,rep,name=decrypted_values,json=decryptedValues,proto3" json:"decrypted_values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SecureValueDecryptResponseCollection) GetDecryptedValues() map[string]*ValueResult {
	if x != nil {
...
type ValueResult struct {
	...
	//
	//	*ValueResult_Value
	//	*ValueResult_ErrorMessage
	Result        isValueResult_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValueResult) GetResult() isValueResult_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ValueResult) GetValue() string {
	if x != nil {
		if x, ok := x.Result.(*ValueResult_Value); ok {
			return x.Value
		}
	}
	return ""
...
func (x *ValueResult) GetErrorMessage() string {
	if x != nil {
		if x, ok := x.Result.(*ValueResult_ErrorMessage); ok {
...
type isValueResult_Result interface {
	isValueResult_Result()
}

type ValueResult_Value struct {
	Value string `protobuf:"bytes,1,opt,name=value,proto3,oneof"`
}

type ValueResult_ErrorMessage struct {
	ErrorMessage string `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3,oneof"`
}

func (*ValueResult_Value) isValueResult_Result() {}

func (*ValueResult_ErrorMessage) isValueResult_Result() {}
...
var file_decrypt_proto_rawDesc = string([]byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0xef, 0x01, 0x0a, 0x24, 0x53, 0x65,
	...
	,
	...
	,
})
...
var file_decrypt_proto_goTypes = []any{
	...
	(*ValueResult)(nil),                          // 2: decrypt.ValueResult
...
var file_decrypt_proto_depIdxs = []int32{
	...
	2, // 1: decrypt.SecureValueDecryptResponseCollection.DecryptedValuesEntry.value:type_name -> decrypt.ValueResult
...
func file_decrypt_proto_init() {
	...
	file_decrypt_proto_msgTypes[2].OneofWrappers = []any{
		(*ValueResult_Value)(nil),
		(*ValueResult_ErrorMessage)(nil),
	}
	type x struct{}
