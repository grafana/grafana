...
// UnimplementedSecureValueDecrypterServer should be embedded to have
...
func (UnimplementedSecureValueDecrypterServer) testEmbeddedByValue() {}
...
func RegisterSecureValueDecrypterServer(s grpc.ServiceRegistrar, srv SecureValueDecrypterServer) {
	// If the following call pancis, it indicates UnimplementedSecureValueDecrypterServer was
