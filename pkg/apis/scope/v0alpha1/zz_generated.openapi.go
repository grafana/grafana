...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/grafana/grafana/pkg/apis/scope/v0alpha1.FindScopedDashboardsResults": schema_pkg_apis_scope_v0alpha1_FindScopedDashboardsResults(ref),
...
func schema_pkg_apis_scope_v0alpha1_FindScopedDashboardsResults(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
