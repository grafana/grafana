...
func (in *FindScopeNodeChildrenResults) DeepCopyInto(out *FindScopeNodeChildrenResults) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ScopeNodeChild, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScopeNodeChild) DeepCopyInto(out *ScopeNodeChild) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScopeNodeChild.
func (in *ScopeNodeChild) DeepCopy() *ScopeNodeChild {
	if in == nil {
		return nil
	}
	out := new(ScopeNodeChild)
	in.DeepCopyInto(out)
	return out
}
