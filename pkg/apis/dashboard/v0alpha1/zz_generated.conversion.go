...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*dashboard.Dashboard)(nil), (*Dashboard)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v0alpha1_Dashboard_To_dashboard_Dashboard(in *Dashboard, out *dashboard.Dashboard, s conversion.Scope) error {
	...
	// WARNING: in.Spec requires manual conversion: inconvertible types (github.com/grafana/grafana/pkg/apis/dashboard/migration.Unstructured vs github.com/grafana/grafana/pkg/apis/dashboard/migration.DashboardSpec)
	return nil
}

func autoConvert_dashboard_Dashboard_To_v0alpha1_Dashboard(in *dashboard.Dashboard, out *Dashboard, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	// WARNING: in.Spec requires manual conversion: inconvertible types (github.com/grafana/grafana/pkg/apis/dashboard/migration.DashboardSpec vs github.com/grafana/grafana/pkg/apis/dashboard/migration.Unstructured)
	return nil
}
