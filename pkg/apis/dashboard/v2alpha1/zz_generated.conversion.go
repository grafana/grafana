...
>>>>>>> 778069ffaba (Generate Dashboard kinds with `grafana-app-sdk`)
	...
	if err := s.AddConversionFunc((*dashboard.DashboardSpec)(nil), (*DashboardSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_dashboard_DashboardSpec_To_v2alpha1_DashboardSpec(a.(*dashboard.DashboardSpec), b.(*DashboardSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*DashboardSpec)(nil), (*dashboard.DashboardSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2alpha1_DashboardSpec_To_dashboard_DashboardSpec(a.(*DashboardSpec), b.(*dashboard.DashboardSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*Dashboard)(nil), (*dashboard.Dashboard)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2alpha1_Dashboard_To_dashboard_Dashboard(a.(*Dashboard), b.(*dashboard.Dashboard), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v2alpha1_Dashboard_To_dashboard_Dashboard(in *Dashboard, out *dashboard.Dashboard, s conversion.Scope) error {
	...
	// WARNING: in.DashboardStatus requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v2alpha1_DashboardSpec_To_dashboard_DashboardSpec(in *DashboardSpec, out *dashboard.DashboardSpec, s conversion.Scope) error {
	...
	// WARNING: in.CursorSync requires manual conversion: does not exist in peer-type
	// WARNING: in.Description requires manual conversion: does not exist in peer-type
	// WARNING: in.Editable requires manual conversion: does not exist in peer-type
	// WARNING: in.Elements requires manual conversion: does not exist in peer-type
	// WARNING: in.Layout requires manual conversion: does not exist in peer-type
	// WARNING: in.Links requires manual conversion: does not exist in peer-type
	// WARNING: in.LiveNow requires manual conversion: does not exist in peer-type
	// WARNING: in.Preload requires manual conversion: does not exist in peer-type
	...
	// WARNING: in.TimeSettings requires manual conversion: does not exist in peer-type
	out.Title = in.Title
...
func autoConvert_dashboard_DashboardSpec_To_v2alpha1_DashboardSpec(in *dashboard.DashboardSpec, out *DashboardSpec, s conversion.Scope) error {
	out.Title = in.Title
	// WARNING: in.Unstructured requires manual conversion: does not exist in peer-type
	return nil
}
