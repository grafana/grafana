...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/grafana/grafana/pkg/apis/example/v0alpha1.GenericHandlerOptions": schema_pkg_apis_example_v0alpha1_GenericHandlerOptions(ref),
...
func schema_pkg_apis_example_v0alpha1_GenericHandlerOptions(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
