...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/grafana/grafana/pkg/apis/datasource/v0alpha1.GenericDataSourceSettings":     schema_pkg_apis_datasource_v0alpha1_GenericDataSourceSettings(ref),
		"github.com/grafana/grafana/pkg/apis/datasource/v0alpha1.GenericDataSourceSettingsList": schema_pkg_apis_datasource_v0alpha1_GenericDataSourceSettingsList(ref),
...
func schema_pkg_apis_datasource_v0alpha1_GenericDataSourceSettings(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NOTE: this is only used for testdata right now",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"secure": {
						SchemaProps: spec.SchemaProps{
							Description: "Optional secure values",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/pkg/apimachinery/apis/common/v0alpha1.SecureValue"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apimachinery/apis/common/v0alpha1.SecureValue", "github.com/grafana/grafana/pkg/apis/datasource/v0alpha1.GenericDataSourceSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_datasource_v0alpha1_GenericDataSourceSettingsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/pkg/apis/datasource/v0alpha1.GenericDataSourceSettings"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/datasource/v0alpha1.GenericDataSourceSettings", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
