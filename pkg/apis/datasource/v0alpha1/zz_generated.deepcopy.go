...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecureValueInfo) DeepCopyInto(out *SecureValueInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecureValueInfo.
func (in *SecureValueInfo) DeepCopy() *SecureValueInfo {
	if in == nil {
		return nil
	}
	out := new(SecureValueInfo)
	in.DeepCopyInto(out)
	return out
}
