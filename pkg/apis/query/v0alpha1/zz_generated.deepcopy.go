...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SQLSchemasWrapper) DeepCopyInto(out *SQLSchemasWrapper) {
	*out = *in
	out.TypeMeta = in.TypeMeta
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SQLSchemasWrapper.
func (in *SQLSchemasWrapper) DeepCopy() *SQLSchemasWrapper {
	if in == nil {
		return nil
	}
	out := new(SQLSchemasWrapper)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SQLSchemasWrapper) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
