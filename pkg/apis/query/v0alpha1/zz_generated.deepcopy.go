...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResultDataContract) DeepCopyInto(out *ResultDataContract) {
	*out = *in
	out.TypeVersion = in.TypeVersion
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResultDataContract.
func (in *ResultDataContract) DeepCopy() *ResultDataContract {
	if in == nil {
		return nil
	}
	out := new(ResultDataContract)
	in.DeepCopyInto(out)
	return out
}
