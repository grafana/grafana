...
// on leaseName via a coordination GlobalLease; otherwise it falls back to
...
func newControllerElector(controllerCfg *ControllerConfig, leaseName string) (leaderelection.Elector, error) {
	...
	return globallease.New(restCfg, leaderelection.Config{LeaseName: leaseName}, log.New("provisioning-leaderelection"))
}
