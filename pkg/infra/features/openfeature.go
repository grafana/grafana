...
// InitOpenFeature initializes the global OpenFeature SDK with a remote OFREP provider.
// This sets up the feature provider and evaluation context that will be used by all
// OpenFeature clients in the application.
//
// This is a convenience function that:
// 1. Creates an OFREP provider with the provided URL and HTTP client
// 2. Sets it as the global OpenFeature provider
// 3. Configures the evaluation context with targeting key and attributes
//
// For custom providers or static flags, use NewOFREPProvider() or OpenFeature SDK directly.
