...
func ProvideService(cfg *setting.Cfg, sqlStore db.DB, usageStats usagestats.Service,
	secretsService secrets.Service) (*RemoteCache, error) { //nolint:staticcheck // SA1019: Legacy envelope encryption stack for core Grafana wiring.
...
func createClient(opts *setting.RemoteCacheSettings, sqlstore db.DB, secretsService secrets.Service) (cache CacheStorage, err error) { //nolint:staticcheck // SA1019: Legacy envelope encryption stack for core Grafana wiring.
	switch opts.Name {
	case redisCacheType:
