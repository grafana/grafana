...
func (s *spanner) SupportInsertMany() bool   { return true }  // Needs manual transaction batching
...
func (s *spanner) SupportDropIfExists() bool { return true }  // Drop should be handled differently
