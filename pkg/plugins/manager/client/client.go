...
func (s *Service) MigrateQuery(ctx context.Context, req *backend.QueryMigrationRequest) (*backend.QueryMigrationResponse, error) {
	if req == nil {
		return nil, errNilRequest
	}
	...
	return plugin.MigrateQuery(ctx, req)
}
