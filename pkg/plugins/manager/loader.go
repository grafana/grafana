...
func (l *Loader) Load(pluginJSONPath string) (*plugins.PluginV2, error) {
	...
	//defer func() {
	//	if err := reader.Close(); err != nil {
	//		pmlog.Warn("Failed to close JSON file", "path", jsonFPath, "err", err)
	//	}
	//}()
...
//func (l *Loader) loadPlugin(plugin *plugins.PluginV2, loader plugins.PluginLoader) (*plugins.PluginV2, error) {
//	err := loader.LoadV2(plugin.PluginDir, l.BackendPluginManager)
//	if err != nil {
//		return nil, err
//	}
