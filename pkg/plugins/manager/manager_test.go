...
func TestPluginManager_Init(t *testing.T) {
	t.Run("Plugin sources are loaded in order", func(t *testing.T) {
		loader := &fakeLoader{}
		pm := NewOrchestrator(&plugins.Cfg{}, newFakePluginRegistry(), []PluginSource{
...
func TestPluginManager_loadPlugins(t *testing.T) {
	t.Run("Managed backend plugin", func(t *testing.T) {
		...
		pm, ps := createOrchestrator(t, func(pm *Orchestrator) {
...
func createOrchestrator(t *testing.T, cbs ...func(*Orchestrator)) (*Orchestrator, plugins.Store) {
	t.Helper()

	fakeRegistry := newFakePluginRegistry()
	pm := NewOrchestrator(&plugins.Cfg{}, fakeRegistry, nil, &fakeLoader{})
...
func createManager(t *testing.T, cbs ...func(*PluginManager)) (*PluginManager, plugins.Store) {
	...
	fakeRegistry := newFakePluginRegistry()
	pm := New(&plugins.Cfg{}, fakeRegistry, &fakeLoader{})
...
func newScenario(t *testing.T, managed bool, fn func(t *testing.T, ctx *managerScenarioCtx)) {
	...
	manager := New(cfg, pluginRegistry, &fakeLoader{})
