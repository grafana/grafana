...
const file_sanitizer_proto_rawDesc = "" +
	"\n" +
	"\x0fsanitizer.proto\x12\x11pluginextensionv2\"\x7f\n" +
	"\x0fSanitizeRequest\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12\x18\n" +
	"\acontent\x18\x02 \x01(\fR\acontent\x12\x1e\n" +
	"\n" +
	"configType\x18\x03 \x01(\tR\n" +
	"configType\x12\x16\n" +
	"\x06config\x18\x04 \x01(\fR\x06config\"F\n" +
	"\x10SanitizeResponse\x12\x14\n" +
	"\x05error\x18\x01 \x01(\tR\x05error\x12\x1c\n" +
	"\tsanitized\x18\x02 \x01(\fR\tsanitized2`\n" +
	"\tSanitizer\x12S\n" +
	"\bSanitize\x12\".pluginextensionv2.SanitizeRequest\x1a#.pluginextensionv2.SanitizeResponseB\x15Z\x13.;pluginextensionv2b\x06proto3"
