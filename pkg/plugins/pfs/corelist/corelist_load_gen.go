...
func corePlugins(rt *thema.Runtime) []pfs.ParsedPlugin {
	return []pfs.ParsedPlugin{
		...
		parsePluginOrPanic("public/app/plugins/datasource/pmm-pt-summary-datasource", "pmm_pt_summary_datasource", rt),
		...
		parsePluginOrPanic("public/app/plugins/panel/pmm-check", "pmm_check_panel", rt),
		parsePluginOrPanic("public/app/plugins/panel/pmm-pt-summary-panel", "pmm_pt_summary_panel", rt),
		parsePluginOrPanic("public/app/plugins/panel/pmm-update", "pmm_update_panel", rt),
