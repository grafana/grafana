...
//
// Derived from the Thema lineage at pkg/coremodel/peerstatus
...
// Lineage returns the Thema lineage representing a Grafana peerstatus.
//
// The lineage is the canonical specification of the current peerstatus schema,
...
// Coremodel contains the foundational schema declaration for peerstatuss.
...
// CurrentSchema returns the current (latest) peerstatus Thema schema.
...
// New returns a new instance of the peerstatus coremodel.
//
