...
//
// Derived from the Thema lineage at pkg/coremodel/orgdto
...
// Lineage returns the Thema lineage representing a Grafana orgdto.
//
// The lineage is the canonical specification of the current orgdto schema,
...
// Coremodel contains the foundational schema declaration for orgdtos.
...
// CurrentSchema returns the current (latest) orgdto Thema schema.
...
// New returns a new instance of the orgdto coremodel.
//
