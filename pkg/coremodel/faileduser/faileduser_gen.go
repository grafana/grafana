...
// Faileduser defines model for faileduser.
//
...
// Lineage returns the Thema lineage representing a Grafana faileduser.
//
// The lineage is the canonical specification of the current faileduser schema,
...
// Coremodel contains the foundational schema declaration for failedusers.
...
// CurrentSchema returns the current (latest) faileduser Thema schema.
...
// New returns a new instance of the faileduser coremodel.
//
