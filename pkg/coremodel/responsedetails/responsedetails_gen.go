...
//
// Derived from the Thema lineage at pkg/coremodel/responsedetails

package responsedetails
...
// Lineage returns the Thema lineage representing a Grafana responsedetails.
//
// The lineage is the canonical specification of the current responsedetails schema,
...
// Coremodel contains the foundational schema declaration for responsedetailss.
...
// CurrentSchema returns the current (latest) responsedetails Thema schema.
...
// New returns a new instance of the responsedetails coremodel.
//
