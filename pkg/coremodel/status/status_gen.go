...
//
// Derived from the Thema lineage at pkg/coremodel/status
...
// Lineage returns the Thema lineage representing a Grafana status.
//
// The lineage is the canonical specification of the current status schema,
...
// Coremodel contains the foundational schema declaration for statuss.
...
// CurrentSchema returns the current (latest) status Thema schema.
...
// New returns a new instance of the status coremodel.
//
