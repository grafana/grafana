...
// Lineage returns the Thema lineage representing a Grafana json.
//
// The lineage is the canonical specification of the current json schema,
...
// Coremodel contains the foundational schema declaration for jsons.
...
// CurrentSchema returns the current (latest) json Thema schema.
...
// New returns a new instance of the json coremodel.
//
