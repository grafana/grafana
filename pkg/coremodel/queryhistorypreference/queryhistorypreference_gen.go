...
//
// Derived from the Thema lineage at pkg/coremodel/queryhistorypreference
...
// Lineage returns the Thema lineage representing a Grafana queryhistorypreference.
//
// The lineage is the canonical specification of the current queryhistorypreference schema,
...
// Coremodel contains the foundational schema declaration for queryhistorypreferences.
...
// CurrentSchema returns the current (latest) queryhistorypreference Thema schema.
...
// New returns a new instance of the queryhistorypreference coremodel.
//
