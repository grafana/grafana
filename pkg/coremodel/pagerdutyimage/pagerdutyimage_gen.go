...
//
// Derived from the Thema lineage at pkg/coremodel/pagerdutyimage
...
// Pagerdutyimage defines model for pagerdutyimage.
//
...
// Lineage returns the Thema lineage representing a Grafana pagerdutyimage.
//
// The lineage is the canonical specification of the current pagerdutyimage schema,
...
// Coremodel contains the foundational schema declaration for pagerdutyimages.
...
// CurrentSchema returns the current (latest) pagerdutyimage Thema schema.
...
// New returns a new instance of the pagerdutyimage coremodel.
//
