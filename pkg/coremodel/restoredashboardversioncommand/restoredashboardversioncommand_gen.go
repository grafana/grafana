...
// Lineage returns the Thema lineage representing a Grafana restoredashboardversioncommand.
//
// The lineage is the canonical specification of the current restoredashboardversioncommand schema,
...
// Coremodel contains the foundational schema declaration for restoredashboardversioncommands.
...
// CurrentSchema returns the current (latest) restoredashboardversioncommand Thema schema.
...
// New returns a new instance of the restoredashboardversioncommand coremodel.
//
