...
//
// Derived from the Thema lineage at pkg/coremodel/activeuserstats
...
type Model struct {
	ActiveAdminsAndEditors *int `json:"active_admins_and_editors,omitempty"`
...
// Lineage returns the Thema lineage representing a Grafana activeuserstats.
//
// The lineage is the canonical specification of the current activeuserstats schema,
...
// Coremodel contains the foundational schema declaration for activeuserstatss.
...
// CurrentSchema returns the current (latest) activeuserstats Thema schema.
...
// New returns a new instance of the activeuserstats coremodel.
//
