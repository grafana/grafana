...
// Lineage returns the Thema lineage representing a Grafana datalink.
//
// The lineage is the canonical specification of the current datalink schema,
...
// Coremodel contains the foundational schema declaration for datalinks.
...
// CurrentSchema returns the current (latest) datalink Thema schema.
...
// New returns a new instance of the datalink coremodel.
//
