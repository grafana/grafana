...
// Lineage returns the Thema lineage representing a Grafana changeuserpasswordcommand.
//
// The lineage is the canonical specification of the current changeuserpasswordcommand schema,
...
// Coremodel contains the foundational schema declaration for changeuserpasswordcommands.
...
// CurrentSchema returns the current (latest) changeuserpasswordcommand Thema schema.
...
// New returns a new instance of the changeuserpasswordcommand coremodel.
//
