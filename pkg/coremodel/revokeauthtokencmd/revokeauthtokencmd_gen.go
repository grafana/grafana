...
type Model struct {
	AuthTokenId *int `json:"authTokenId,omitempty"`
}
...
// Lineage returns the Thema lineage representing a Grafana revokeauthtokencmd.
//
// The lineage is the canonical specification of the current revokeauthtokencmd schema,
...
// Coremodel contains the foundational schema declaration for revokeauthtokencmds.
...
// CurrentSchema returns the current (latest) revokeauthtokencmd Thema schema.
...
// New returns a new instance of the revokeauthtokencmd coremodel.
//
