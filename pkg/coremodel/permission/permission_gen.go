...
//
// Derived from the Thema lineage at pkg/coremodel/permission
...
// Lineage returns the Thema lineage representing a Grafana permission.
//
// The lineage is the canonical specification of the current permission schema,
...
// Coremodel contains the foundational schema declaration for permissions.
...
// CurrentSchema returns the current (latest) permission Thema schema.
...
// New returns a new instance of the permission coremodel.
//
