...
//
// Derived from the Thema lineage at pkg/coremodel/alertstatus
...
const (
	ModelStateUnprocessedActiveSuppressed ModelState = "[unprocessed active suppressed]"
)
...
// Lineage returns the Thema lineage representing a Grafana alertstatus.
//
// The lineage is the canonical specification of the current alertstatus schema,
...
// Coremodel contains the foundational schema declaration for alertstatuss.
...
// CurrentSchema returns the current (latest) alertstatus Thema schema.
...
// New returns a new instance of the alertstatus coremodel.
//
