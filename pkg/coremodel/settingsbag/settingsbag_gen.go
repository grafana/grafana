...
//
// Derived from the Thema lineage at pkg/coremodel/settingsbag
...
// Lineage returns the Thema lineage representing a Grafana settingsbag.
//
// The lineage is the canonical specification of the current settingsbag schema,
...
// Coremodel contains the foundational schema declaration for settingsbags.
...
// CurrentSchema returns the current (latest) settingsbag Thema schema.
...
// New returns a new instance of the settingsbag coremodel.
//
