...
//
// Derived from the Thema lineage at pkg/coremodel/matcher
...
// Lineage returns the Thema lineage representing a Grafana matcher.
//
// The lineage is the canonical specification of the current matcher schema,
...
// Coremodel contains the foundational schema declaration for matchers.
...
// CurrentSchema returns the current (latest) matcher Thema schema.
...
// New returns a new instance of the matcher coremodel.
//
