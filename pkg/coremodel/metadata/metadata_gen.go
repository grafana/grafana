...
//
// Derived from the Thema lineage at pkg/coremodel/metadata
...
// Lineage returns the Thema lineage representing a Grafana metadata.
//
// The lineage is the canonical specification of the current metadata schema,
...
// Coremodel contains the foundational schema declaration for metadatas.
...
// CurrentSchema returns the current (latest) metadata Thema schema.
...
// New returns a new instance of the metadata coremodel.
//
