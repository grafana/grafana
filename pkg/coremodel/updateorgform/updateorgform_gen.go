...
//
// Derived from the Thema lineage at pkg/coremodel/updateorgform

package updateorgform
...
// Lineage returns the Thema lineage representing a Grafana updateorgform.
//
// The lineage is the canonical specification of the current updateorgform schema,
...
// Coremodel contains the foundational schema declaration for updateorgforms.
...
// CurrentSchema returns the current (latest) updateorgform Thema schema.
...
// New returns a new instance of the updateorgform coremodel.
//
