...
//
// Derived from the Thema lineage at pkg/coremodel/validationerror
...
// Lineage returns the Thema lineage representing a Grafana validationerror.
//
// The lineage is the canonical specification of the current validationerror schema,
...
// Coremodel contains the foundational schema declaration for validationerrors.
...
// CurrentSchema returns the current (latest) validationerror Thema schema.
...
// New returns a new instance of the validationerror coremodel.
//
