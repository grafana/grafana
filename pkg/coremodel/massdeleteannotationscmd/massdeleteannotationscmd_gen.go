...
// Lineage returns the Thema lineage representing a Grafana massdeleteannotationscmd.
//
// The lineage is the canonical specification of the current massdeleteannotationscmd schema,
...
// Coremodel contains the foundational schema declaration for massdeleteannotationscmds.
...
// CurrentSchema returns the current (latest) massdeleteannotationscmd Thema schema.
...
// New returns a new instance of the massdeleteannotationscmd coremodel.
//
