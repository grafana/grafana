...
type Model struct {
	...
	RotatedAt     *int    `json:"RotatedAt,omitempty"`
...
// Lineage returns the Thema lineage representing a Grafana usertoken.
//
// The lineage is the canonical specification of the current usertoken schema,
...
// Coremodel contains the foundational schema declaration for usertokens.
...
// CurrentSchema returns the current (latest) usertoken Thema schema.
...
// New returns a new instance of the usertoken coremodel.
//
