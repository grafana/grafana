...
//
// Derived from the Thema lineage at pkg/coremodel/valuemapping
...
// Lineage returns the Thema lineage representing a Grafana valuemapping.
//
// The lineage is the canonical specification of the current valuemapping schema,
...
// Coremodel contains the foundational schema declaration for valuemappings.
...
// CurrentSchema returns the current (latest) valuemapping Thema schema.
...
// New returns a new instance of the valuemapping coremodel.
//
