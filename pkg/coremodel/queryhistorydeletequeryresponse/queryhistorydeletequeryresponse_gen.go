...
// Queryhistorydeletequeryresponse defines model for queryhistorydeletequeryresponse.
//
...
// Lineage returns the Thema lineage representing a Grafana queryhistorydeletequeryresponse.
//
// The lineage is the canonical specification of the current queryhistorydeletequeryresponse schema,
...
// Coremodel contains the foundational schema declaration for queryhistorydeletequeryresponses.
...
// CurrentSchema returns the current (latest) queryhistorydeletequeryresponse Thema schema.
...
// New returns a new instance of the queryhistorydeletequeryresponse coremodel.
//
