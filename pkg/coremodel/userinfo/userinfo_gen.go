...
// Lineage returns the Thema lineage representing a Grafana userinfo.
//
// The lineage is the canonical specification of the current userinfo schema,
...
// Coremodel contains the foundational schema declaration for userinfos.
...
// CurrentSchema returns the current (latest) userinfo Thema schema.
...
// New returns a new instance of the userinfo coremodel.
//
