...
// Lineage returns the Thema lineage representing a Grafana alertmanager.
//
// The lineage is the canonical specification of the current alertmanager schema,
...
// Coremodel contains the foundational schema declaration for alertmanagers.
...
// CurrentSchema returns the current (latest) alertmanager Thema schema.
...
// New returns a new instance of the alertmanager coremodel.
//
