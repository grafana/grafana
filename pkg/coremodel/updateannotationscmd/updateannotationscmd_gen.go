...
// Lineage returns the Thema lineage representing a Grafana updateannotationscmd.
//
// The lineage is the canonical specification of the current updateannotationscmd schema,
...
// Coremodel contains the foundational schema declaration for updateannotationscmds.
...
// CurrentSchema returns the current (latest) updateannotationscmd Thema schema.
...
// New returns a new instance of the updateannotationscmd coremodel.
//
