...
// Lineage returns the Thema lineage representing a Grafana timerange.
//
// The lineage is the canonical specification of the current timerange schema,
...
// Coremodel contains the foundational schema declaration for timeranges.
...
// CurrentSchema returns the current (latest) timerange Thema schema.
...
// New returns a new instance of the timerange coremodel.
//
