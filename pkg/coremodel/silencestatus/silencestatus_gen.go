...
const (
	ModelStateExpiredActivePending ModelState = "[expired active pending]"
)
...
// Lineage returns the Thema lineage representing a Grafana silencestatus.
//
// The lineage is the canonical specification of the current silencestatus schema,
...
// Coremodel contains the foundational schema declaration for silencestatuss.
...
// CurrentSchema returns the current (latest) silencestatus Thema schema.
...
// New returns a new instance of the silencestatus coremodel.
//
