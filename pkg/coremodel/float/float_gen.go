...
//
// Derived from the Thema lineage at pkg/coremodel/float
...
type Model struct {
	Model64 *float32 `json:"Float64,omitempty"`
...
// Lineage returns the Thema lineage representing a Grafana float.
//
// The lineage is the canonical specification of the current float schema,
...
// Coremodel contains the foundational schema declaration for floats.
...
// CurrentSchema returns the current (latest) float Thema schema.
...
// New returns a new instance of the float coremodel.
//
