...
// Lineage returns the Thema lineage representing a Grafana notfound.
//
// The lineage is the canonical specification of the current notfound schema,
...
// Coremodel contains the foundational schema declaration for notfounds.
...
// CurrentSchema returns the current (latest) notfound Thema schema.
...
// New returns a new instance of the notfound coremodel.
//
