...
//
// Derived from the Thema lineage at pkg/coremodel/permissiondenied
...
// Lineage returns the Thema lineage representing a Grafana permissiondenied.
//
// The lineage is the canonical specification of the current permissiondenied schema,
...
// Coremodel contains the foundational schema declaration for permissiondenieds.
...
// CurrentSchema returns the current (latest) permissiondenied Thema schema.
...
// New returns a new instance of the permissiondenied coremodel.
//
