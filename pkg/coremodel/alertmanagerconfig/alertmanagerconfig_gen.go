...
// Alertmanagerconfig defines model for alertmanagerconfig.
//
...
// Lineage returns the Thema lineage representing a Grafana alertmanagerconfig.
//
// The lineage is the canonical specification of the current alertmanagerconfig schema,
...
// Coremodel contains the foundational schema declaration for alertmanagerconfigs.
...
// CurrentSchema returns the current (latest) alertmanagerconfig Thema schema.
...
// New returns a new instance of the alertmanagerconfig coremodel.
//
