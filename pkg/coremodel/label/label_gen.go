...
// Lineage returns the Thema lineage representing a Grafana label.
//
// The lineage is the canonical specification of the current label schema,
...
// Coremodel contains the foundational schema declaration for labels.
...
// CurrentSchema returns the current (latest) label Thema schema.
...
// New returns a new instance of the label coremodel.
//
