...
// Lineage returns the Thema lineage representing a Grafana createorgcommand.
//
// The lineage is the canonical specification of the current createorgcommand schema,
...
// Coremodel contains the foundational schema declaration for createorgcommands.
...
// CurrentSchema returns the current (latest) createorgcommand Thema schema.
...
// New returns a new instance of the createorgcommand coremodel.
//
