...
// Lineage returns the Thema lineage representing a Grafana labelset.
//
// The lineage is the canonical specification of the current labelset schema,
...
// Coremodel contains the foundational schema declaration for labelsets.
...
// CurrentSchema returns the current (latest) labelset Thema schema.
...
// New returns a new instance of the labelset coremodel.
//
