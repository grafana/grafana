...
func TestAzureMonitorGetQueryURL(t *testing.T) {
	...
	expected := `http://ds/#blade/Microsoft_Azure_MonitoringMetrics/Metrics.ReactView/Referer/MetricsExplorer/` +
		`TimeContext/%7B%22absolute%22%3A%7B%22startTime%22%3A%222018-03-15T09%3A00%3A00-04%3A00%22%2C%22endTime%22%3A%222018-03-15T09%3A34%3A00-04%3A00%22%7D%7D/` +
