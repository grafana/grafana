...
func TestBuildingAzureResourceLogAnalyticsQueries(t *testing.T) {
	datasource := &AzureResourceLogAnalyticsDatasource{}
	...
	tests := []struct {
		...
		azureLogAnalyticsQueries []*AzureResourceLogAnalyticsQuery
			...
			queryModel: []*tsdb.Query{
				{
					...
					Model: simplejson.NewFromAny(map[string]interface{}{
						"queryType": "Azure Resource Log Analytics",
						"azureResourceLogAnalytics": map[string]interface{}{
...
func TestResourcePluginRoutes(t *testing.T) {
	datasource := &AzureResourceLogAnalyticsDatasource{}
	plugin := &plugins.DataSourcePlugin{
		Routes: []*plugins.AppPluginRoute{
			{
				Path:   "resourceloganalyticsazure",
				Method: "POST",
			...
			{
				Path:   "chinaresourceloganalyticsazure",
				Method: "POST",
			...
			{
				Path:   "govresourceloganalyticsazure",
				Method: "POST",
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedProxypass: "resourceloganalyticsazure",
		...
		},
		{
			...
			expectedProxypass: "chinaresourceloganalyticsazure",
		...
		},
		{
			...
			expectedProxypass: "govresourceloganalyticsazure",
