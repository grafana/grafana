	...
	Convey("MySQL", t, func() {
		...
		Convey("Given a table with different native data types", func() {
			...
			Convey("Query with Table format should map MySQL column types to Go types", func() {
				...
				So(len(frames[0].Fields), ShouldEqual, 31)

				So(frames[0].Fields[0].At(0).(int8), ShouldEqual, 1)
				So(*frames[0].Fields[1].At(0).(*string), ShouldEqual, "abc")
				So(*frames[0].Fields[2].At(0).(*string), ShouldEqual, "def")
				So(frames[0].Fields[3].At(0).(int32), ShouldEqual, 1)
				So(frames[0].Fields[4].At(0).(int16), ShouldEqual, 10)
				So(frames[0].Fields[5].At(0).(int64), ShouldEqual, 100)
				So(frames[0].Fields[6].At(0).(int32), ShouldEqual, 1420070400)
				...
				So(*frames[0].Fields[14].At(0).(*string), ShouldHaveSameTypeAs, string([]byte{1}))
				...
				So(*frames[0].Fields[18].At(0).(*string), ShouldEqual, "blob")
				So(*frames[0].Fields[19].At(0).(*string), ShouldEqual, "mediumtext")
				So(*frames[0].Fields[20].At(0).(*string), ShouldEqual, "mediumblob")
				So(*frames[0].Fields[21].At(0).(*string), ShouldEqual, "longtext")
				So(*frames[0].Fields[22].At(0).(*string), ShouldEqual, "longblob")
				So(*frames[0].Fields[23].At(0).(*string), ShouldEqual, "val2")
				So(*frames[0].Fields[24].At(0).(*string), ShouldEqual, "a,b")
				So(frames[0].Fields[25].At(0).(*time.Time).Format("2006-01-02T00:00:00Z"), ShouldEqual, time.Now().UTC().Format("2006-01-02T00:00:00Z"))
				So(frames[0].Fields[26].At(0).(*time.Time).UnixNano(), ShouldEqual, 1514764861123456000)
				So(frames[0].Fields[27].At(0), ShouldEqual, nil)
				So(frames[0].Fields[28].At(0), ShouldEqual, nil)
				So(frames[0].Fields[29].At(0), ShouldEqual, nil)
				So(frames[0].Fields[30].At(0), ShouldEqual, nil)
			})
		})
