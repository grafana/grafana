...
func TestMySQL(t *testing.T) {
	...
	t.Run("Given a table with different native data types", func(t *testing.T) {
		...
		t.Run("Query with Table format should map MySQL column types to Go types", func(t *testing.T) {
			...
			require.Equal(t, "def", *frames[0].Fields[2].At(0).(*string))
			require.Equal(t, int32(1), frames[0].Fields[3].At(0).(int32))
			require.Equal(t, int16(10), frames[0].Fields[4].At(0).(int16))
			require.Equal(t, int64(100), frames[0].Fields[5].At(0).(int64))
			require.Equal(t, int32(1420070400), frames[0].Fields[6].At(0).(int32))
			require.Equal(t, 1.11, *frames[0].Fields[7].At(0).(*float64))
			require.Equal(t, 2.22, *frames[0].Fields[8].At(0).(*float64))
			require.Equal(t, float32(3.33), frames[0].Fields[9].At(0).(float32))
			// So(*frames[0].Fields[10].At(0).(*time.Time), ShouldHappenWithin, 10*time.Second, time.Now().UTC())
			// So(*frames[0].Fields[11].At(0).(*time.Time), ShouldHappenWithin, 10*time.Second, time.Now())
			require.Equal(t, "11:11:11", *frames[0].Fields[12].At(0).(*string))
			require.Equal(t, int64(2018), *frames[0].Fields[13].At(0).(*int64))
			require.Equal(t, string([]byte{1}), *frames[0].Fields[14].At(0).(*string))
			require.Equal(t, "tinytext", *frames[0].Fields[15].At(0).(*string))
			require.Equal(t, "tinyblob", *frames[0].Fields[16].At(0).(*string))
			require.Equal(t, "text", *frames[0].Fields[17].At(0).(*string))
			require.Equal(t, "blob", *frames[0].Fields[18].At(0).(*string))
			require.Equal(t, "mediumtext", *frames[0].Fields[19].At(0).(*string))
			require.Equal(t, "mediumblob", *frames[0].Fields[20].At(0).(*string))
			require.Equal(t, "longtext", *frames[0].Fields[21].At(0).(*string))
			require.Equal(t, "longblob", *frames[0].Fields[22].At(0).(*string))
			require.Equal(t, "val2", *frames[0].Fields[23].At(0).(*string))
			require.Equal(t, "a,b", *frames[0].Fields[24].At(0).(*string))
			// require.Equal(t, time.Now().UTC().Format("2006-01-02T00:00:00Z"), frames[0].Fields[25].At(0).(*time.Time).Format("2006-01-02T00:00:00Z"))
			require.Equal(t, int64(1514764861123456000), frames[0].Fields[26].At(0).(*time.Time).UnixNano())
			require.Nil(t, frames[0].Fields[27].At(0))
			require.Nil(t, frames[0].Fields[28].At(0))
			require.Nil(t, frames[0].Fields[29].At(0))
			require.Nil(t, frames[0].Fields[30].At(0))
		})
	})
