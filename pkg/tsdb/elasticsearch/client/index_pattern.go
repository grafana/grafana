...
type indexPattern interface {
	GetIndices(timeRange pluginmodels.TSDBTimeRange) ([]string, error)
}
...
func (ip *staticIndexPattern) GetIndices(timeRange pluginmodels.TSDBTimeRange) ([]string, error) {
...
func (ip *dynamicIndexPattern) GetIndices(timeRange pluginmodels.TSDBTimeRange) ([]string, error) {
