...
func SetupTestSecureSocksProxySettings(t *testing.T) *sdkproxy.SecureSocksProxyConfig {
	t.Helper()
	...
	settings := &sdkproxy.SecureSocksProxyConfig{
		Enabled:      true,
	...
	sdkproxy.SetSecureSocksProxyConfig(settings)
