...
var NamespaceMetricsMap = map[string][]string{
	...
	"AWS/Events":                         {"DeadLetterInvocations", "Events", "FailedInvocations", "IngestionToInvocationCompleteLatency", "IngestionToInvocationStartLatency", "InvocationAttempts", "Invocations", "InvocationsCreated", "InvocationsFailedToBeSentToDlq", "InvocationsSentToDlq", "MatchedEvents", "PutEventsApproximateCallCount", "PutEventsApproximateSuccessCount", "PutEventsEntriesCount", "PutEventsFailedEntriesCount", "PutEventsLatency", "PutEventsRequestSize", "SuccessfulInvocationAttempts", "ThrottledRules", "TriggeredRules"},
