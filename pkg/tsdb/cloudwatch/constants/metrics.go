...
var NamespaceDimensionKeysMap = map[string][]string{
	...
	"AWS/SageMaker":               {"EndpointName", "Host", "JobName", "LabelingJobName", "PipelineName", "StepName", "VariantName"},
