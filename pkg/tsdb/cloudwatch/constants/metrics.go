...
var NamespaceMetricsMap = map[string][]string{
	...
	"AWS/IVS":                  {"ConcurrentViews", "ConcurrentStreams", "LiveDeliveredTime", "LiveInputTime", "IngestAudioBitrate", "IngestFramerate", "IngestVideoBitrate", "KeyframeInterval", "LiveDeliveredTime", "LiveInputTime", "RecordedTime"},
