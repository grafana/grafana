...
var NamespaceMetricsMap = map[string][]string{
	...
	"AWS/Bedrock":                 {"Invocations", "InvocationLatency", "InvocationClientErrors", "InvocationServerErrors", "InvocationThrottles", "InputTokenCount", "OutputTokenCount", "OutputImageCount"},
