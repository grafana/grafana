...
func (e *cloudWatchExecutor) executeAnnotationQueryV2(ctx context.Context, model *simplejson.Json, query backend.DataQuery) (*backend.QueryDataResponse, error) {
	...
	respD.Frames = append(respD.Frames, transformAnnotationToTableV2(annotations, query))
...
func transformAnnotationToTableV2(d []map[string]string, query backend.DataQuery) *data.Frame {
