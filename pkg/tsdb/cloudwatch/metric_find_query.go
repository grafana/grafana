...
func init() {
	metricsMap = map[string][]string{
		...
		"AWS/IoT":               {"RulesExecuted", "NumLogEventsFailedToPublishThrottled", "NumLogBatchesFailedToPublishThrottled", "TopicMatch", "ParseError", "RuleNotFound", "RuleMessageThrottled", "Success", "Failure", "Connect.AuthError", "Connect.ClientError", "Connect.ServerError", "Connect.Success", "Connect.Throttle", "Ping.Success", "PublishIn.AuthError", "PublishIn.ClientError", "PublishIn.ServerError", "PublishIn.Success", "PublishIn.Throttle", "PublishOut.AuthError", "PublishOut.ClientError", "PublishOut.Success", "Subscribe.AuthError", "Subscribe.ClientError", "Subscribe.ServerError", "Subscribe.Success", "Subscribe.Throttle", "Unsubscribe.ClientError", "Unsubscribe.ServerError", "Unsubscribe.Success", "Unsubscribe.Throttle", "DeleteThingShadow.Accepted", "GetThingShadow.Accepted", "UpdateThingShadow.Accepted", "ServerError", "ClientError", "QueuedJobExecutionTotalCount", "InProgressJobExecutionTotalCount", "FailedJobExecutionTotalCount", "SuccededJobExecutionTotalCount", "CanceledJobExecutionTotalCount", "RejectedJobExecutionTotalCount", "RemovedJobExecutionTotalCount", "QueuedJobExecutionCount", "InProgressJobExecutionCount", "FailedJobExecutionCount", "SuccededJobExecutionCount", "CanceledJobExecutionCount", "RejectedJobExecutionCount", "RemovedJobExecutionCount", "NonCompliantResources", "ResourcesEvaluated", "Violations", "ViolationsCleared", "ViolationsInvalidated"},
	...
	dimensionsMap = map[string][]string{
		...
		"AWS/Inspector":         {},
		"AWS/IoT":               {"ActionType", "Protocol", "RuleName", "JobId", "CheckName", "ScheduledAuditName", "SecurityProfileName", "BehaviorName"},
