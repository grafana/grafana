...
func (e *cloudWatchExecutor) parseQueries(queries []backend.DataQuery) (map[string][]*requestQuery, error) {
	...
	for _, query := range queries {
		...
		refID := query.RefID
		query, err := parseRequestQuery(model, refID, query.TimeRange.From, query.TimeRange.To)
		if err != nil {
