...
// func (s *Service) executeLabelNamesQuery(ctx context.Context, req *backend.QueryDataRequest, dsInfo *DatasourceInfo) (*backend.QueryDataResponse, error) {
// 	client := dsInfo.promClient
// 	result := backend.QueryDataResponse{
// 		Responses: backend.Responses{},
// 	}

// 	queries, err := s.parseLabelNamesQuery(req, dsInfo)
...
// func (s *Service) parseLabelNamesQuery(queryContext *backend.QueryDataRequest, dsInfo *DatasourceInfo) ([]*PrometheusQuery, error) {
// 	qs := []*PrometheusQuery{}
...
// func parseLabelNamesResponse(value map[PrometheusQueryType]interface{}, query *PrometheusQuery) (data.Frames, error) {
// 	frames := data.Frames{}
