...
func TestIntegrationGenerateConnectionString(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			desc:        "Full URL with protocol and credentials",
			host:        "postgresql://user:pass@host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
			expConnStr:  "user='user' password='pass' host='host' dbname='dbname' port=5432 sslmode='verify-full'",
		},
		{
			desc:        "Full URL with protocol and credentials without the user and password fields",
			host:        "postgresql://user:pass@host:5432/dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
			expConnStr:  "user='user' password='pass' host='host' dbname='dbname' port=5432 sslmode='verify-full'",
		},
		{
			desc:        "Full URL with protocol and credentials and user and password fields",
			host:        "postgresql://user:pass@host:5432/dbname",
			user:        "newuser",
			password:    "newpass",
			database:    "newdbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
			expConnStr:  "user='newuser' password='newpass' host='host' dbname='newdbname' port=5432 sslmode='verify-full'",
		},
		{
			desc:        "Full URL with protocol without credentials",
			host:        "postgresql://host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
		...
		{
			desc:        "URL with database name",
			host:        "host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
		...
		{
			desc:        "Invalid IPv6 address format",
			host:        "[::1",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
			expErr:      "invalid IPv6 address format",
		},
		{
			desc:        "URL with path components",
			host:        "host:5432/dbname/schema",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
		...
		{
			desc:        "URL with postgres protocol",
			host:        "postgres://user:pass@host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
		...
		{
			desc:        "URL with postgres protocol",
			host:        "postgres://host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
		...
		{
			desc:        "URL with credentials in host",
			host:        "user:pass@host:5432/dbname",
			user:        "user",
			password:    "pass",
			database:    "dbname",
			tlsSettings: tlsSettings{Mode: "verify-full"},
