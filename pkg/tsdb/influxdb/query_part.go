...
type QueryDefinition struct {
	Renderer func(query *Query, queryContext models.DataQuery, part *QueryPart, innerExpr string) string
...
func fieldRenderer(query *Query, queryContext models.DataQuery, part *QueryPart, innerExpr string) string {
	if part.Params[0] == "*" {
		return "*"
	}
...
func functionRenderer(query *Query, queryContext models.DataQuery, part *QueryPart, innerExpr string) string {
...
func suffixRenderer(query *Query, queryContext models.DataQuery, part *QueryPart, innerExpr string) string {
	return fmt.Sprintf("%s %s", innerExpr, part.Params[0])
}

func aliasRenderer(query *Query, queryContext models.DataQuery, part *QueryPart, innerExpr string) string {
...
func (qp *QueryPart) Render(query *Query, queryContext models.DataQuery, expr string) string {
