...
import (
	...
	"github.com/grafana/grafana/pkg/kinds/rolemapping"
...
var (
	...
	_ kindsys.Core = &rolemapping.Kind{}
...
// RoleMapping returns the [kindsys.Interface] implementation for the rolemapping kind.
func (b *Base) RoleMapping() *rolemapping.Kind {
	return b.rolemapping
}
...
func doNewBase(rt *thema.Runtime) *Base {
	...
	reg.rolemapping, err = rolemapping.NewKind(rt)
	if err != nil {
		panic(fmt.Sprintf("error while initializing the rolemapping Kind: %s", err))
	}
	reg.all = append(reg.all, reg.rolemapping)
