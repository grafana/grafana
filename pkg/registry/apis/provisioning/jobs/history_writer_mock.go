...
func (_m *MockHistoryWriter) WriteJob(ctx context.Context, job *provisioningV1.Job) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *provisioningV1.Job) error); ok {
		r0 = rf(ctx, job)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockHistoryWriter_WriteJob_Call) Run(run func(ctx context.Context, job *provisioningV1.Job)) *MockHistoryWriter_WriteJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*provisioningV1.Job))
	})
	return _c
}
...
func (_c *MockHistoryWriter_WriteJob_Call) RunAndReturn(run func(context.Context, *provisioningV1.Job) error) *MockHistoryWriter_WriteJob_Call {
	_c.Call.Return(run)
	return _c
}
