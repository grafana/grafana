...
// RenderScreenshot provides a mock function with given fields: ctx, namespace, repoName, url
func (_m *MockPreviewRenderer) RenderScreenshot(ctx context.Context, namespace string, repoName string, url string) (string, error) {
	ret := _m.Called(ctx, namespace, repoName, url)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (string, error)); ok {
		return rf(ctx, namespace, repoName, url)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) string); ok {
		r0 = rf(ctx, namespace, repoName, url)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, string) error); ok {
		r1 = rf(ctx, namespace, repoName, url)
	} else {
		r1 = ret.Error(1)
	}
...
// MockPreviewRenderer_RenderScreenshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RenderScreenshot'
type MockPreviewRenderer_RenderScreenshot_Call struct {
	*mock.Call
}
...
//   - repoName string
//   - url string
func (_e *MockPreviewRenderer_Expecter) RenderScreenshot(ctx interface{}, namespace interface{}, repoName interface{}, url interface{}) *MockPreviewRenderer_RenderScreenshot_Call {
	return &MockPreviewRenderer_RenderScreenshot_Call{Call: _e.mock.On("RenderScreenshot", ctx, namespace, repoName, url)}
}

func (_c *MockPreviewRenderer_RenderScreenshot_Call) Run(run func(ctx context.Context, namespace string, repoName string, url string)) *MockPreviewRenderer_RenderScreenshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPreviewRenderer_RenderScreenshot_Call) Return(_a0 string, _a1 error) *MockPreviewRenderer_RenderScreenshot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPreviewRenderer_RenderScreenshot_Call) RunAndReturn(run func(context.Context, string, string, string) (string, error)) *MockPreviewRenderer_RenderScreenshot_Call {
	_c.Call.Return(run)
	return _c
}
