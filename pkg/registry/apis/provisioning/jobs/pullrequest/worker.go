...
//go:generate mockery --name=PullRequestRepo --output=./mocks --outpkg=pullrequest --filename=mock_pullrequest_repo.go --with-expecter
...
//go:generate mockery --name=ScreenshotRenderer --output=./mocks --outpkg=pullrequest --filename=mock_screenshot_renderer.go --with-expecter
...
//go:generate mockery --name=Commenter --output=./mocks --outpkg=pullrequest --filename=mock_commenter.go --with-expecter
