...
//go:generate go tool mockery --name FullSyncFn --structname MockFullSyncFn --inpackage --filename full_sync_fn_mock.go --with-expecter
...
//go:generate go tool mockery --name CompareFn --structname MockCompareFn --inpackage --filename compare_fn_mock.go --with-expecter
...
//go:generate go tool mockery --name IncrementalSyncFn --structname MockIncrementalSyncFn --inpackage --filename incremental_sync_fn_mock.go --with-expecter
...
//go:generate go tool mockery --name Syncer --structname MockSyncer --inpackage --filename syncer_mock.go --with-expecter
