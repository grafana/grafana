...
func TestExportWorker_IsSupported(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			r := NewExportWorker(nil, nil, nil, nil, nil, metrics, resources.ResourceMetrics{})
...
func TestExportWorker_ProcessNoExportSettings(t *testing.T) {
	...
	r := NewExportWorker(nil, nil, nil, nil, nil, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
...
func TestExportWorker_ProcessFailedToCreateClients(t *testing.T) {
	...
	r := NewExportWorker(mockClients, nil, nil, nil, nil, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
...
func TestExportWorker_ProcessNotReaderWriter(t *testing.T) {
	...
	r := NewExportWorker(mockClients, nil, nil, nil, mockStageFn.Execute, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
	err := r.Process(context.Background(), mockRepo, job, mockProgress)
...
func TestExportWorker_ProcessRepositoryResourcesError(t *testing.T) {
	...
	mockRepoResources.On("Client", mock.Anything, mock.Anything).Return(nil, fmt.Errorf("failed to create repository resources client"))
	...
	r := NewExportWorker(mockClients, mockRepoResources, nil, nil, mockStageFn.Execute, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
	err := r.Process(context.Background(), mockRepo, job, mockProgress)
...
func TestExportWorker_ProcessStageOptions(t *testing.T) {
	...
	r := NewExportWorker(mockClients, mockRepoResources, nil, mockExportFn.Execute, mockStageFn.Execute, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
	err := r.Process(context.Background(), mockRepo, job, mockProgress)
...
func TestExportWorker_ProcessQuotaExceeded(t *testing.T) {
	...
	r := NewExportWorker(mockClients, nil, mockLister, nil, nil, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
	err := r.Process(context.Background(), mockRepo, job, mockProgress)
...
func TestExportWorker_ProcessQuotaNotExceeded(t *testing.T) {
	...
	r := NewExportWorker(mockClients, mockRepoResources, mockLister, mockExportFn.Execute, mockStageFn.Execute, jobs.RegisterJobMetrics(prometheus.NewPedanticRegistry()), resources.ResourceMetrics{})
	err := r.Process(context.Background(), mockRepo, job, mockProgress)
	require.NoError(t, err)
}
