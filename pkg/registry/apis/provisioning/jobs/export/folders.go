...
func ExportFolders(ctx context.Context, repoName string, options provisioningV1.ExportJobOptions, folderClient dynamic.ResourceInterface, repositoryResources resources.RepositoryResources, progress jobs.JobProgressRecorder) error {
