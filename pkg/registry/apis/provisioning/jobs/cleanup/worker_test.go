...
func TestWorker_Process_ReleaseResources(t *testing.T) {
	...
	items := &provisioning.ResourceList{
		Items: []provisioning.ResourceListItem{
			{Name: "dash-1", Group: "dashboard.grafana.app", Resource: "dashboards", Path: "dash-1.json", Hash: "abc123"},
	...
	mockClients.EXPECT().ForResource(mock.Anything, schema.GroupVersionResource{
		Group: "dashboard.grafana.app", Resource: "dashboards",
	}).Return(fakeClient, schema.GroupVersionKind{}, nil)
