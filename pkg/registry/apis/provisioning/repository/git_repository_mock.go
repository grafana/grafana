...
func (_m *MockGitRepository) Stage(ctx context.Context, opts StageOptions) (StagedRepository, error) {
...
func (_c *MockGitRepository_Stage_Call) Run(run func(ctx context.Context, opts StageOptions)) *MockGitRepository_Stage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGitRepository_Stage_Call) Return(_a0 StagedRepository, _a1 error) *MockGitRepository_Stage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGitRepository_Stage_Call) RunAndReturn(run func(context.Context, StageOptions) (StagedRepository, error)) *MockGitRepository_Stage_Call {
	_c.Call.Return(run)
	return _c
}
