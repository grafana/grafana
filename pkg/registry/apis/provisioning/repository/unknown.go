...
func (r *unknownRepository) AfterCreate(ctx context.Context, logger *slog.Logger) (*provisioning.RepositoryStatus, error) {
	return nil, nil
}

func (r *unknownRepository) BeginUpdate(ctx context.Context, logger *slog.Logger, old Repository) (*provisioning.RepositoryStatus, error) {
	return nil, nil
}
