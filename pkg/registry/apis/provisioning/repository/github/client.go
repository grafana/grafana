...
//go:generate go tool mockery --name Client --structname MockClient --inpackage --filename mock_client.go --with-expecter
...
//go:generate go tool mockery --name RepositoryContent --structname MockRepositoryContent --inpackage --filename mock_repository_content.go --with-expecter
...
//go:generate go tool mockery --name CommitFile --structname MockCommitFile --inpackage --filename mock_commit_file.go --with-expecter
