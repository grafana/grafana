...
func (m mockWebhookClient) GetWebhook(context.Context, string) (repository.WebhookConfig, error) {
	panic("not needed for testing")
}
...
func (m mockWebhookClient) DeleteWebhook(ctx context.Context, _ string) error {
