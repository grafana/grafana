...
// The generic run-loop behavior (worker pool, key deduplication, retry policy,
// shutdown drain) is covered by the shared runner tests in
// apps/provisioning/pkg/controller/runner_test.go.
