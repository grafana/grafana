...
func (_m *MockCommenter) Comment(ctx context.Context, repo repository.PullRequestRepo, pr int, changeInfo3 changeInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.PullRequestRepo, int, changeInfo) error); ok {
...
//   - ctx context.Context
//   - repo repository.PullRequestRepo
//   - pr int
...
func (_c *MockCommenter_Comment_Call) Run(run func(ctx context.Context, repo repository.PullRequestRepo, pr int, changeInfo3 changeInfo)) *MockCommenter_Comment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(repository.PullRequestRepo), args[2].(int), args[3].(changeInfo))
	})
	return _c
}
...
func (_c *MockCommenter_Comment_Call) RunAndReturn(run func(context.Context, repository.PullRequestRepo, int, changeInfo) error) *MockCommenter_Comment_Call {
	_c.Call.Return(run)
	return _c
}
