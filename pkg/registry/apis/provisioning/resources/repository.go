...
type RepositoryResources interface {
	...
	RenameResourceFile(ctx context.Context, path, previousRef, newPath, newRef string, quotaCheck func() bool, folderOpts ...EnsurePathOption) (string, string, schema.GroupVersionKind, int, bool, error)
	// Stats
