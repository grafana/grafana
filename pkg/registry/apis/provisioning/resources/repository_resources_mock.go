...
// CheckResourceManagerKind provides a mock function with given fields: ctx, path, ref
func (_m *MockRepositoryResources) CheckResourceManagerKind(ctx context.Context, path string, ref string) (string, schema.GroupVersionKind, int, error) {
	ret := _m.Called(ctx, path, ref)

	if len(ret) == 0 {
		panic("no return value specified for CheckResourceManagerKind")
	}
	...
	var r2 int
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (string, schema.GroupVersionKind, int, error)); ok {
...
// MockRepositoryResources_CheckResourceManagerKind_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckResourceManagerKind'
type MockRepositoryResources_CheckResourceManagerKind_Call struct {
	*mock.Call
}

// CheckResourceManagerKind is a helper method to define mock.On call
//   - ctx context.Context
//   - path string
//   - ref string
func (_e *MockRepositoryResources_Expecter) CheckResourceManagerKind(ctx interface{}, path interface{}, ref interface{}) *MockRepositoryResources_CheckResourceManagerKind_Call {
	return &MockRepositoryResources_CheckResourceManagerKind_Call{Call: _e.mock.On("CheckResourceManagerKind", ctx, path, ref)}
}

func (_c *MockRepositoryResources_CheckResourceManagerKind_Call) Run(run func(ctx context.Context, path string, ref string)) *MockRepositoryResources_CheckResourceManagerKind_Call {
...
func (_c *MockRepositoryResources_CheckResourceManagerKind_Call) Return(_a0 string, _a1 schema.GroupVersionKind, _a2 int, _a3 error) *MockRepositoryResources_CheckResourceManagerKind_Call {
	_c.Call.Return(_a0, _a1, _a2, _a3)
	return _c
}

func (_c *MockRepositoryResources_CheckResourceManagerKind_Call) RunAndReturn(run func(context.Context, string, string) (string, schema.GroupVersionKind, int, error)) *MockRepositoryResources_CheckResourceManagerKind_Call {
	_c.Call.Return(run)
	return _c
}
