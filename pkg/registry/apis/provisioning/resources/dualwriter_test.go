	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false)}
		...
		},
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false), folderMetadataEnabled: true, folders: fm}
		...
		},
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				accessMock := auth.NewMockAccessChecker(t)
				accessMock.On("Check", mock.Anything, mock.Anything, mock.Anything).Return(nil)
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false), folderMetadataEnabled: true}
				return dw, DualWriteOptions{Path: "newfolder/"}
			},
			wantErr: true,
			errCheck: func(t *testing.T, err error) {
		...
		},
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false), folders: fm}
				return dw, DualWriteOptions{Path: "newfolder/"}
			},
			check: func(t *testing.T, result *provisioning.ResourceWrapper) {
		...
		},
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false), folders: fm, folderMetadataEnabled: true}
				return dw, DualWriteOptions{Path: "newfolder/"}
			},
			check: func(t *testing.T, result *provisioning.ResourceWrapper) {
				assert.NotNil(t, result.Resource.Upsert.Object)
	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				accessMock.On("Check", mock.Anything, mock.Anything, mock.Anything).Return(nil)
				fm := NewFolderManager(rw, nil, NewEmptyFolderTree(), FolderKind)
				dw := &DualReadWriter{repo: rw, authorizer: NewAuthorizer(config, rw, accessMock, authTestClients(), false), folderMetadataEnabled: false, folders: fm}
		...
		},
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{repo: urlRepo, authorizer: NewAuthorizer(config, urlRepo, accessMock, authTestClients(), false), folders: fm}
				return dw, DualWriteOptions{
					OriginalPath: "old/",
					Path:         "new/",
					Ref:          "feature-branch",
	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T) (*DualReadWriter, DualWriteOptions) {
				...
				dw := &DualReadWriter{
					repo:                  rw,
					authorizer:            NewAuthorizer(config, rw, accessMock, authTestClients(), false),
