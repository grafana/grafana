...
type Keeper interface {
	Store(ctx context.Context, cfg secretv0alpha1.KeeperConfig, namespace, name string, version int64, exposedValueOrRef string) (ExternalID, error)
	Update(ctx context.Context, cfg secretv0alpha1.KeeperConfig, namespace, name string, version int64, exposedValueOrRef string) error
	Expose(ctx context.Context, cfg secretv0alpha1.KeeperConfig, namespace, name string, version int64) (secretv0alpha1.ExposedSecureValue, error)
	Delete(ctx context.Context, cfg secretv0alpha1.KeeperConfig, namespace, name string, version int64) error
}
