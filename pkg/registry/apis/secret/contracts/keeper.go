...
type KeeperStorage interface {
	...
	Read(ctx context.Context, name string) (*secretv0alpha1.Keeper, error)
	Update(ctx context.Context, sv *secretv0alpha1.Keeper) (*secretv0alpha1.Keeper, error)
	Delete(ctx context.Context, name string) error
	List(ctx context.Context, options *internalversion.ListOptions) (*secretv0alpha1.KeeperList, error)
}
