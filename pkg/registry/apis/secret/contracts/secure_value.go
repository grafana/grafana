...
type SecureValueMetadataStorage interface {
	...
	Update(ctx context.Context, sv *secretv1beta1.SecureValue, actorUID string) (*secretv1beta1.SecureValue, error)
	...
	SetStatus(ctx context.Context, namespace xkube.Namespace, name string, status secretv1beta1.SecureValueStatus) error
