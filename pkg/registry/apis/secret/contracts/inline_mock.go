...
func (_m *MockInlineSecureValueStore) CanReference(ctx context.Context, owner v0alpha1.ObjectReference, values map[string]v0alpha1.InlineSecureValue) (bool, error) {
...
func (_c *MockInlineSecureValueStore_CanReference_Call) Run(run func(ctx context.Context, owner v0alpha1.ObjectReference, values map[string]v0alpha1.InlineSecureValue)) *MockInlineSecureValueStore_CanReference_Call {
...
func (_c *MockInlineSecureValueStore_CanReference_Call) RunAndReturn(run func(context.Context, v0alpha1.ObjectReference, map[string]v0alpha1.InlineSecureValue) (bool, error)) *MockInlineSecureValueStore_CanReference_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateSecureValues provides a mock function with given fields: ctx, owner, values
func (_m *MockInlineSecureValueStore) UpdateSecureValues(ctx context.Context, owner v0alpha1.ObjectReference, values map[string]v0alpha1.InlineSecureValue) (map[string]v0alpha1.InlineSecureValue, error) {
	ret := _m.Called(ctx, owner, values)
...
func (_c *MockInlineSecureValueStore_UpdateSecureValues_Call) Run(run func(ctx context.Context, owner v0alpha1.ObjectReference, values map[string]v0alpha1.InlineSecureValue)) *MockInlineSecureValueStore_UpdateSecureValues_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v0alpha1.ObjectReference), args[2].(map[string]v0alpha1.InlineSecureValue))
	})
	return _c
...
func (_c *MockInlineSecureValueStore_UpdateSecureValues_Call) RunAndReturn(run func(context.Context, v0alpha1.ObjectReference, map[string]v0alpha1.InlineSecureValue) (map[string]v0alpha1.InlineSecureValue, error)) *MockInlineSecureValueStore_UpdateSecureValues_Call {
	_c.Call.Return(run)
	return _c
}
