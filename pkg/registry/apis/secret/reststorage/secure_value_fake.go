...
func (s *fakeSecureValueStorage) Read(ctx context.Context, name string) (*secretv0alpha1.SecureValue, error) {
...
func (s *fakeSecureValueStorage) Delete(ctx context.Context, name string) error {
	namespace, ok := request.NamespaceFrom(ctx)
	if !ok {
...
func (s *fakeSecureValueStorage) List(ctx context.Context, options *internalversion.ListOptions) (*secretv0alpha1.SecureValueList, error) {
	namespace, ok := request.NamespaceFrom(ctx)
	if !ok {
		return nil, fmt.Errorf("namespace not found")
	}
