...
var _ builder.APIGroupBuilder = (*AuthorizationAPIBuilder)(nil)
var _ builder.APIGroupRouteProvider = (*AuthorizationAPIBuilder)(nil)

// This is used just so wire has something unique to return
type AuthorizationAPIBuilder struct {
...
func NewAPIService(store legacy.LegacyIdentityStore) *AuthorizationAPIBuilder {
	return &AuthorizationAPIBuilder{
		store:   store,
		display: user.NewLegacyDisplayREST(store),
...
func (b *AuthorizationAPIBuilder) GetGroupVersion() schema.GroupVersion {
	return iamv0.SchemeGroupVersion
}

func (b *AuthorizationAPIBuilder) InstallSchema(scheme *runtime.Scheme) error {
...
func (b *AuthorizationAPIBuilder) UpdateAPIGroupInfo(apiGroupInfo *genericapiserver.APIGroupInfo, _ builder.APIGroupOptions) error {
...
func (b *AuthorizationAPIBuilder) GetOpenAPIDefinitions() common.GetOpenAPIDefinitions {
	return iamv0.GetOpenAPIDefinitions
}

func (b *AuthorizationAPIBuilder) PostProcessOpenAPI(oas *spec3.OpenAPI) (*spec3.OpenAPI, error) {
	oas.Info.Description = "Access Management"

	defs := b.GetOpenAPIDefinitions()(func(path string) spec.Ref { return spec.Ref{} })
	defsBase := "github.com/grafana/grafana/pkg/apis/authz/v0alpha1."
...
func (b *AuthorizationAPIBuilder) GetAPIRoutes(gv schema.GroupVersion) *builder.APIRoutes {
	defs := b.GetOpenAPIDefinitions()(func(path string) spec.Ref { return spec.Ref{} })
	return b.display.GetAPIRoutes(defs)
}

func (b *AuthorizationAPIBuilder) GetAuthorizer() authorizer.Authorizer {
	return b.authorizer
}
