...
func (b *DashboardsAPIBuilder) InstallSchema(scheme *runtime.Scheme) error {
	...
	if err := dashv3alpha0.AddToScheme(scheme); err != nil {
		return err
	}
...
func (b *DashboardsAPIBuilder) UpdateAPIGroupInfo(apiGroupInfo *genericapiserver.APIGroupInfo, opts builder.APIGroupOptions) error {
	...
	// v3alpha0
	if err := b.storageForVersion(apiGroupInfo, opts, largeObjects,
		dashv3alpha0.DashboardResourceInfo,
		nil, // do not register library panel
		nil,
		func(obj runtime.Object, access *internal.DashboardAccess) (v runtime.Object, err error) {
			dto := &dashv3alpha0.DashboardWithAccessInfo{}
			dash, ok := obj.(*dashv3alpha0.Dashboard)
			if ok {
				dto.Dashboard = *dash
			}
			if access != nil {
...
func (b *DashboardsAPIBuilder) GetOpenAPIDefinitions() common.GetOpenAPIDefinitions {
	return func(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
		...
		maps.Copy(defs, dashv3alpha0.GetOpenAPIDefinitions(ref))
		...
		for _, defKey := range []string{
			...
			"github.com/grafana/grafana/apps/dashboard/pkg/apis/dashboard/v3alpha0.DashboardAnnotationQuerySpec",
		} {
