...
func (_m *MockMigrationDashboardAccessor) MigrateShortURLs(ctx context.Context, orgId int64, opts MigrateOptions, stream resourcepb.BulkStore_BulkProcessClient) error {
	ret := _m.Called(ctx, orgId, opts, stream)
...
// MockMigrationDashboardAccessor_MigrateShortURLs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MigrateShortURLs'
type MockMigrationDashboardAccessor_MigrateShortURLs_Call struct {
	*mock.Call
}
...
//   - opts MigrateOptions
//   - stream resourcepb.BulkStore_BulkProcessClient
func (_e *MockMigrationDashboardAccessor_Expecter) MigrateShortURLs(ctx interface{}, orgId interface{}, opts interface{}, stream interface{}) *MockMigrationDashboardAccessor_MigrateShortURLs_Call {
	return &MockMigrationDashboardAccessor_MigrateShortURLs_Call{Call: _e.mock.On("MigrateShortURLs", ctx, orgId, opts, stream)}
}

func (_c *MockMigrationDashboardAccessor_MigrateShortURLs_Call) Run(run func(ctx context.Context, orgId int64, opts MigrateOptions, stream resourcepb.BulkStore_BulkProcessClient)) *MockMigrationDashboardAccessor_MigrateShortURLs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(MigrateOptions), args[3].(resourcepb.BulkStore_BulkProcessClient))
	})
	return _c
...
func (_c *MockMigrationDashboardAccessor_MigrateShortURLs_Call) Return(_a0 error) *MockMigrationDashboardAccessor_MigrateShortURLs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockMigrationDashboardAccessor_MigrateShortURLs_Call) RunAndReturn(run func(context.Context, int64, MigrateOptions, resourcepb.BulkStore_BulkProcessClient) error) *MockMigrationDashboardAccessor_MigrateShortURLs_Call {
	_c.Call.Return(run)
	return _c
}
