...
func TestDashboardAPIBuilder_Mutate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			verb: "CREATE",
			input: &v1alpha1.Dashboard{
				Spec: dashboardSpecWithOverrides(v1alpha1.DashboardSpec{Title: "test"}, map[string]interface{}{
					"id": float64(1),
				}),
...
func dashboardSpecWithOverrides(dash v1alpha1.DashboardSpec, overrides map[string]interface{}) v1alpha1.DashboardSpec {
