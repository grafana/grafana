...
func RegisterAPIService(cfg *setting.Cfg, apiregistration builder.APIRegistrar, registerer prometheus.Registerer) *ServiceAPIBuilder {
	if !cfg.EnableKubernetesAggregator {
