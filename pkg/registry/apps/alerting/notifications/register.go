...
import (
	...
	notificationsResource "github.com/grafana/grafana/apps/alerting/notifications/pkg/apis/resource"
...
func getLegacyStorage(namespacer request.NamespaceMapper, ng *ngalert.AlertNG) runner.LegacyStorageGetter {
	return func(gvr schema.GroupVersionResource) grafanarest.LegacyStorage {
