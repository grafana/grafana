...
func convertToK8sResource(
	...
	k8sRule.Spec.NotificationSettings = convertToK8sNotificationSettings(rule)
...
// convertToK8sNotificationSettings maps a domain rule's routing configuration to the
// k8s notification settings, returning nil when the rule has no routing configured.
