...
import (
	...
	"github.com/grafana/grafana/pkg/registry/apps/alerting/rules/prometheusrule"
...
func (a *AppInstaller) GetAuthorizer() authorizer.Authorizer {
	...
	return authorizer.AuthorizerFunc(
		func(ctx context.Context, a authorizer.Attributes) (authorizer.Decision, string, error) {
			...
			case prometheusrule.ResourceInfo.GroupResource().Resource:
				return prometheusrule.Authorize(ctx, authz, a)
			}
