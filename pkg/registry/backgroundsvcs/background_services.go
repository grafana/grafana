...
import (
	...
	authzv1 "github.com/grafana/grafana/pkg/services/authorization/legacy"
...
func ProvideBackgroundServiceRegistry(
	...
	_ *grpcserver.HealthService, _ entity.EntityStoreServer, _ *authzv1.Server, _ *grpcserver.ReflectionService,
