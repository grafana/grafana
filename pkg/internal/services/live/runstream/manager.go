...
//go:generate mockgen -destination=mock.go -package=runstream github.com/grafana/grafana/pkg/internal/services/live/runstream StreamPacketSender,PresenceGetter,StreamRunner,PluginContextGetter
