...
func main() {
	...
	for _, ls := range lins {
		...
		if ls.IsAPIType {
			...
			wd.Add("GenerateTypescriptCoremodel", gcgen.File{
				RelativePath: filepath.Join(tsroot, rawTSGenPath(ls)),
	...
	wd.Add("TSIndex", gcgen.File{
		RelativePath: filepath.Join(tsroot, "index.gen.ts"),
		Data:         []byte(tsvidx.String()),
	})
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
`), b...)
	return gcgen.WithOne("genSharedSchemas", gcgen.File{
		RelativePath: filepath.Join(abspath, "mudball.gen.ts"),
		Data:         dat,
	}), nil
}
