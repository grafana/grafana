...
// LabelKeyDeprecatedInternalID will be removed in Grafana 13. Do not add any new usage of it.
...
type GrafanaMetaAccessor interface {
	...
	// Do not add new usage of this - it will be removed in Grafana 13
	GetDepreactedInternalID() int64
...
func (m *grafanaMetaAccessor) GetDepreactedInternalID() int64 {
