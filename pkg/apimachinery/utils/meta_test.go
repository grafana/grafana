...
type TestResource3 struct {
	...
	// This time defined with a strict struct
	Secure map[string]any `json:"secure,omitempty"`
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestResource3) DeepCopyInto(out *TestResource3) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Playlist.
func (in *TestResource3) DeepCopy() *TestResource3 {
	if in == nil {
		return nil
	}
	out := new(TestResource3)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TestResource3) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Spec3) DeepCopyInto(out *Spec3) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Spec.
func (in *Spec3) DeepCopy() *Spec3 {
	if in == nil {
		return nil
	}
	out := new(Spec3)
...
func TestMetaAccessor(t *testing.T) {
	...
	t.Run("get and set grafana metadata (TestResource)", func(t *testing.T) {
		...
		secure, err := meta.GetSecureValues()
		require.NoError(t, err)
		require.JSONEq(t, `{"x": {"create": "[REDACTED]", "description": "olleh"}}`, asJSON(secure, true))
	...
	t.Run("get and set grafana metadata (TestResource3 - generic map)", func(t *testing.T) {
		res := &TestResource3{
			Spec: Spec3{},
	...
	t.Run("manage secure values", func(t *testing.T) {
		...
		require.Equal(t, "DescForA", *sv["A"].Description)
