...
func TestMode2_Create(t *testing.T) {
	...
	for _, tt := range tests {
		...
		assert.IsType(t, &DualWriterMode2{}, dw)
...
func TestMode2_List(t *testing.T) {
	...
	for _, tt := range tests {
		...
		obj, err := mode2.List(context.Background(), &metainternalversion.ListOptions{})
...
func TestMode2_DeleteCollection(t *testing.T) {
	...
	for _, tt := range tests {
		...
		obj, err := mode2.DeleteCollection(context.Background(), func(ctx context.Context, obj runtime.Object) error { return nil }, &metav1.DeleteOptions{TypeMeta: metav1.TypeMeta{Kind: tt.input}}, &metainternalversion.ListOptions{})
