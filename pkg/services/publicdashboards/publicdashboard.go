...
type Service interface {
	...
	Delete(ctx context.Context, userOrgId int64, dashboardUid string, uid string) error
...
type Store interface {
	...
	Delete(ctx context.Context, userOrgId int64, dashboardUid, uid string) error
