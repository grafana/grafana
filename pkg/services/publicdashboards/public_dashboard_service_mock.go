...
import (
	...
	query "github.com/grafana/grafana/pkg/services/query"
...
// GetQueryDataResponse provides a mock function with given fields: ctx, skipDSCache, skipQueryCache, reqDTO, panelId, accessToken
func (_m *FakePublicDashboardService) GetQueryDataResponse(ctx context.Context, skipDSCache bool, skipQueryCache bool, reqDTO models.PublicDashboardQueryDTO, panelId int64, accessToken string) (query.QueryResponseWithHeaders, error) {
	ret := _m.Called(ctx, skipDSCache, skipQueryCache, reqDTO, panelId, accessToken)

	var r0 query.QueryResponseWithHeaders
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool, models.PublicDashboardQueryDTO, int64, string) query.QueryResponseWithHeaders); ok {
		r0 = rf(ctx, skipDSCache, skipQueryCache, reqDTO, panelId, accessToken)
	} else {
		r0 = ret.Get(0).(query.QueryResponseWithHeaders)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, bool, bool, models.PublicDashboardQueryDTO, int64, string) error); ok {
		r1 = rf(ctx, skipDSCache, skipQueryCache, reqDTO, panelId, accessToken)
	} else {
		r1 = ret.Error(1)
	}
