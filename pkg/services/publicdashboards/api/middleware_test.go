...
// proper model.ReqContext, setting web parameters, executing middleware, and
...
func runMw(t *testing.T, ctx *model.ReqContext, httpmethod string, path string, webparams map[string]string, mw func(c *model.ReqContext)) (*model.ReqContext, *httptest.ResponseRecorder) {
