...
// Delete provides a mock function with given fields: ctx, userOrgId, uid
func (_m *FakePublicDashboardStore) Delete(ctx context.Context, userOrgId int64, uid string) error {
	ret := _m.Called(ctx, userOrgId, uid)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, string) error); ok {
		r0 = rf(ctx, userOrgId, uid)
	} else {
		r0 = ret.Error(0)
	}
