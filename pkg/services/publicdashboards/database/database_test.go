...
func TestIntegrationEnabledPublicDashboardExistsByAccessToken(t *testing.T) {
	...
	t.Run("EnabledPublicDashboardExistsByAccessToken will return true when at least one public dashboard has a matching access token", func(t *testing.T) {
		setup()
		...
		res, err := publicdashboardStore.EnabledPublicDashboardExistsByAccessToken(context.Background(), "accessToken")
		require.NoError(t, err)

		require.True(t, res)
	})

	t.Run("EnabledPublicDashboardExistsByAccessToken will return false when IsEnabled=false", func(t *testing.T) {
		setup()
	...
	t.Run("EnabledPublicDashboardExistsByAccessToken will return false when no public dashboard has matching access token", func(t *testing.T) {
		setup()
...
func TestIntegrationEnabledPublicDashboardExistsByDashboardUid(t *testing.T) {
	...
	t.Run("EnabledPublicDashboardExistsByDashboardUid Will return true when dashboard has at least one enabled public dashboard", func(t *testing.T) {
		setup()
		...
		res, err := publicdashboardStore.EnabledPublicDashboardExistsByDashboardUid(context.Background(), savedDashboard.Uid)
		require.NoError(t, err)

		require.True(t, res)
	})

	t.Run("EnabledPublicDashboardExistsByDashboardUid will return false when dashboard has public dashboards but they are not enabled", func(t *testing.T) {
		setup()
