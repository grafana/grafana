...
var ErrFolderVersionMismatch = errors.New("the folder has been changed by someone else")
var ErrFolderTitleEmpty = errors.New("folder title cannot be empty")
var ErrFolderWithSameUIDExists = errors.New("a folder/dashboard with the same uid already exists")
var ErrFolderInvalidUID = errors.New("invalid uid for folder provided")
var ErrFolderAccessDenied = errors.New("access denied to folder")
...
var ErrFolderAccessEscalation = errutil.Forbidden("folders.accessEscalation", errutil.WithPublicMessage("Cannot move a folder to a folder where you have higher permissions"))
var ErrFolderCreationAccessDenied = errutil.Forbidden("folders.forbiddenCreation", errutil.WithPublicMessage("not enough permissions to create a folder in the selected location"))
var ErrFolderNameExists = errutil.BadGateway("folder.name-exists", errutil.WithPublicMessage("A folder with that name already exists"))
