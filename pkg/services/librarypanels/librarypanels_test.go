...
func createFolderWithACL(t *testing.T, sqlStore db.DB, title string, user *user.SignedInUser,
	...
	dashboardStore, err := database.ProvideDashboardStore(sqlStore, cfg, featuremgmt.WithFeatures(), tagimpl.ProvideService(sqlStore, cfg), quotaService)
	require.NoError(t, err)
	d := dashboardservice.ProvideDashboardService(cfg, dashboardStore, dashboardStore, nil, features, folderPermissions, dashboardPermissions, ac)
...
func testScenario(t *testing.T, desc string, fn func(t *testing.T, sc scenarioContext)) {
	...
	t.Run(desc, func(t *testing.T) {
		...
		dashboardService := dashboardservice.ProvideDashboardService(
			cfg, dashboardStore, dashboardStore, &alerting.DashAlertExtractorService{},
			features, folderPermissions, dashboardPermissions, ac,
		)
		folderService := folderimpl.ProvideService(ac, bus.ProvideBus(tracing.InitializeTracerForTest()), cfg, dashboardService, dashboardStore, dashboardStore, nil, features, folderPermissions, nil)
