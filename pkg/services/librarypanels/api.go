...
func (lps *LibraryPanelService) createHandler(c *models.ReqContext, cmd createLibraryPanelCommand) response.Response {
	...
	if err != nil {
		if errors.Is(err, errLibraryPanelAlreadyExists) {
			return utils.Error(400, errLibraryPanelAlreadyExists.Error(), err)
		}
		return utils.Error(500, "Failed to create library panel", err)
	}

	return utils.JSON(200, util.DynMap{"result": panel})
}
...
func (lps *LibraryPanelService) connectHandler(c *models.ReqContext) response.Response {
	if err := lps.connectDashboard(c, c.Params(":uid"), c.ParamsInt64(":dashboardId")); err != nil {
		if errors.Is(err, errLibraryPanelNotFound) {
			return utils.Error(404, errLibraryPanelNotFound.Error(), err)
		}
		return utils.Error(500, "Failed to connect library panel", err)
	}

	return utils.Success("Library panel connected")
}
...
func (lps *LibraryPanelService) deleteHandler(c *models.ReqContext) response.Response {
	...
	if err != nil {
		...
		return utils.Error(500, "Failed to delete library panel", err)
	}

	return utils.Success("Library panel deleted")
}
...
func (lps *LibraryPanelService) disconnectHandler(c *models.ReqContext) response.Response {
	...
	if err != nil {
		...
		if errors.Is(err, errLibraryPanelDashboardNotFound) {
			return utils.Error(404, errLibraryPanelDashboardNotFound.Error(), err)
		}
		return utils.Error(500, "Failed to disconnect library panel", err)
	}

	return utils.Success("Library panel disconnected")
}
...
func (lps *LibraryPanelService) getHandler(c *models.ReqContext) response.Response {
	...
	if err != nil {
		...
		return utils.Error(500, "Failed to get library panel", err)
	}

	return utils.JSON(200, util.DynMap{"result": libraryPanel})
}
...
func (lps *LibraryPanelService) getAllHandler(c *models.ReqContext) response.Response {
	...
	if err != nil {
		return utils.Error(500, "Failed to get library panels", err)
	}

	return utils.JSON(200, util.DynMap{"result": libraryPanels})
}
...
func (lps *LibraryPanelService) getConnectedDashboardsHandler(c *models.ReqContext) response.Response {
	...
	if err != nil {
		...
		return utils.Error(500, "Failed to get connected dashboards", err)
	}

	return utils.JSON(200, util.DynMap{"result": dashboardIDs})
}
...
func (lps *LibraryPanelService) patchHandler(c *models.ReqContext, cmd patchLibraryPanelCommand) response.Response {
	...
	if err != nil {
		...
		return utils.Error(500, "Failed to update library panel", err)
	}
