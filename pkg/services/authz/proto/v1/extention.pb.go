...
type BatchCheckResponse struct {
	...
	Groups map[string]*BatchCheckGroup `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *BatchCheckResponse) GetGroups() map[string]*BatchCheckGroup {
	if x != nil {
		return x.Groups
	}
	return nil
...
func (x *BatchCheckGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchCheckGroup) ProtoMessage() {}

func (x *BatchCheckGroup) ProtoReflect() protoreflect.Message {
	mi := &file_extention_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchCheckGroup.ProtoReflect.Descriptor instead.
func (*BatchCheckGroup) Descriptor() ([]byte, []int) {
	return file_extention_proto_rawDescGZIP(), []int{16}
}

func (x *BatchCheckGroup) GetItems() map[string]bool {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_extention_proto_rawDesc = []byte{
	...
	0x22, 0xc0, 0x01, 0x0a, 0x12, 0x42, 0x61, 0x74, 0x63, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xd8, 0x02, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x68,
...
var file_extention_proto_goTypes = []any{
	...
	(*BatchCheckGroup)(nil),          // 16: authz.extention.v1.BatchCheckGroup
	nil,                              // 17: authz.extention.v1.BatchCheckResponse.GroupsEntry
	nil,                              // 18: authz.extention.v1.BatchCheckGroup.ItemsEntry
...
var file_extention_proto_depIdxs = []int32{
	...
	18, // 13: authz.extention.v1.BatchCheckGroup.items:type_name -> authz.extention.v1.BatchCheckGroup.ItemsEntry
	16, // 14: authz.extention.v1.BatchCheckResponse.GroupsEntry.value:type_name -> authz.extention.v1.BatchCheckGroup
