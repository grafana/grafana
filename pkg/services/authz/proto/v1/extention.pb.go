...
const file_extention_proto_rawDesc = "" +
	...
	"deleteRole\x12\x80\x01\n" +
	"\x1fupdate_service_account_org_role\x18\x0e \x01(\v28.authz.extention.v1.UpdateServiceAccountOrgRoleOperationH\x00R\x1bupdateServiceAccountOrgRole\x12\x80\x01\n" +
	"\x1fdelete_service_account_org_role\x18\x0f \x01(\v28.authz.extention.v1.DeleteServiceAccountOrgRoleOperationH\x00R\x1bdeleteServiceAccountOrgRole\x12w\n" +
	"\x1cadd_service_account_org_role\x18\x10 \x01(\v25.authz.extention.v1.AddServiceAccountOrgRoleOperationH\x00R\x18addServiceAccountOrgRoleB\v\n" +
	"\toperation\"s\n" +
	...
	"!AddServiceAccountOrgRoleOperation\x12'\n" +
	"\x0fservice_account\x18\x01 \x01(\tR\x0eserviceAccount\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\"c\n" +
	"$UpdateServiceAccountOrgRoleOperation\x12'\n" +
	"\x0fservice_account\x18\x01 \x01(\tR\x0eserviceAccount\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\"c\n" +
	"$DeleteServiceAccountOrgRoleOperation\x12'\n" +
	"\x0fservice_account\x18\x01 \x01(\tR\x0eserviceAccount\x12\x12\n" +
