...
func (s *DatasourceServer) getDataSourceFromQuery(ctx context.Context, user *models.SignedInUser, skipCache bool, query *simplejson.Json) (*models.DataSource, error) {
...
// TODO: can this be shared with the query service?
func (s *DatasourceServer) decryptSecureJsonDataFn(ctx context.Context) func(ds *models.DataSource) map[string]string {
