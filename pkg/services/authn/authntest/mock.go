...
func (*MockService) Logout(_ context.Context, _ user.SessionAwareIdentityRequester, _ *usertoken.UserToken) (*authn.Redirect, error) {
	panic("unimplemented")
}
...
type MockClient struct {
	...
	LogoutFunc          func(ctx context.Context, user user.SessionAwareIdentityRequester) (*authn.Redirect, bool)
...
func (m *MockClient) Logout(ctx context.Context, user user.SessionAwareIdentityRequester) (*authn.Redirect, bool) {
	if m.LogoutFunc != nil {
