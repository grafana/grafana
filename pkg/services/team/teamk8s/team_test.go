	...
	tests := []struct {
	...
	}{
		{
				...
				resp := iamv0alpha1.GetSearchTeamsResponse{
					GetSearchTeamsBody: iamv0alpha1.GetSearchTeamsBody{
						...
						Hits: []iamv0alpha1.GetSearchTeamsTeamHit{
							{Name: "uid-1", Title: "Team One", Email: "one@example.com"},
							{Name: "uid-2", Title: "Team Two", Email: "two@example.com", Provisioned: true, ExternalUID: "ext-2"},
						},
					},
				}
				w.Header().Set("Content-Type", "application/json")
			...
			expectResult: team.SearchTeamQueryResult{
				...
				PerPage:    10,
				Teams: []*team.TeamDTO{
					{UID: "uid-1", OrgID: 1, Name: "Team One", Email: "one@example.com"},
					{UID: "uid-2", OrgID: 1, Name: "Team Two", Email: "two@example.com", IsProvisioned: true, ExternalUID: "ext-2"},
				},
			},
		},
		{
