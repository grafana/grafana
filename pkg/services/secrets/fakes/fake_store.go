...
func (f FakeSecretsStore) ReEncryptDataKeys(_ context.Context, _ map[secrets.ProviderID]secrets.Provider, _ secrets.ProviderID) error { //nolint:staticcheck // SA1019: Legacy envelope encryption stack for core Grafana wiring.
	return nil
}
