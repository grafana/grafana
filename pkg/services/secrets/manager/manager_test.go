...
func (f *fakeKMS) Provide() (map[secrets.ProviderID]secrets.Provider, error) { //nolint:staticcheck // SA1019: Legacy envelope encryption stack for core Grafana wiring.
