...
func (auth *AuthProxy) HasHeader(reqCtx *model.ReqContext) bool {
...
func (auth *AuthProxy) getKey(reqCtx *model.ReqContext) (string, error) {
	header := auth.getDecodedHeader(reqCtx, auth.cfg.AuthProxyHeaderName)
...
func (auth *AuthProxy) Login(reqCtx *model.ReqContext, ignoreCache bool) (int64, error) {
	if !ignoreCache {
...
func (auth *AuthProxy) getUserViaCache(reqCtx *model.ReqContext) (int64, error) {
...
func (auth *AuthProxy) RemoveUserFromCache(reqCtx *model.ReqContext) error {
	cacheKey, err := auth.getKey(reqCtx)
	if err != nil {
		return err
	}
...
func (auth *AuthProxy) LoginViaLDAP(reqCtx *model.ReqContext) (int64, error) {
...
func (auth *AuthProxy) loginViaHeader(reqCtx *model.ReqContext) (int64, error) {
	header := auth.getDecodedHeader(reqCtx, auth.cfg.AuthProxyHeaderName)
...
func (auth *AuthProxy) getDecodedHeader(reqCtx *model.ReqContext, headerName string) string {
...
func (auth *AuthProxy) headersIterator(reqCtx *model.ReqContext, fn func(field string, header string)) {
...
func (auth *AuthProxy) Remember(reqCtx *model.ReqContext, id int64) error {
