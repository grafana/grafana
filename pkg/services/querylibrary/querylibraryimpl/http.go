...
func (s *queriesServiceHTTPHandler) delete(c *model.ReqContext) response.Response {
	uid := c.Query("uid")
...
func (s *queriesServiceHTTPHandler) getBatch(c *model.ReqContext) response.Response {
...
func (s *queriesServiceHTTPHandler) update(c *model.ReqContext) response.Response {
