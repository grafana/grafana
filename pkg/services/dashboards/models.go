...
// FIXME: The dashboard interface in models is temporary and can be removed when
// all structs referencing dashboards are moved into their own services.
// Dashboard implements the models.Dashboard interface
var _ models.Dashboard = (*Dashboard)(nil)
