...
type DashboardProvisioningService interface {
	...
	SaveFolderForProvisionedDashboards(ctx context.Context, _ *SaveDashboardDTO) (*models.Dashboard, error)
...
func (dr *dashboardServiceImpl) buildSaveDashboardCommand(ctx context.Context, dto *SaveDashboardDTO,
...
func (dr *dashboardServiceImpl) SaveFolderForProvisionedDashboards(ctx context.Context,
	dto *SaveDashboardDTO) (*models.Dashboard, error) {
	dto.User = &models.SignedInUser{
		UserId:  0,
		OrgRole: models.ROLE_ADMIN,
	}
...
func (s *FakeDashboardService) GetProvisionedDashboardDataByDashboardID(ctx context.Context, id int64) (
