...
// RestoreDashboard provides a mock function with given fields: ctx, orgID, dashboardUid
func (_m *FakeDashboardService) RestoreDashboard(ctx context.Context, orgID int64, dashboardUid string) error {
