...
// GetDashboardsByFolder provides a mock function with given fields: ctx, query
func (_m *FakeDashboardService) GetDashboardsByFolder(ctx context.Context, query *GetDashboardsByFolderQuery) ([]*Dashboard, error) {
	ret := _m.Called(ctx, query)

	var r0 []*Dashboard
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetDashboardsByFolderQuery) ([]*Dashboard, error)); ok {
		return rf(ctx, query)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *GetDashboardsByFolderQuery) []*Dashboard); ok {
		r0 = rf(ctx, query)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*Dashboard)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *GetDashboardsByFolderQuery) error); ok {
		r1 = rf(ctx, query)
	} else {
		r1 = ret.Error(1)
	}
