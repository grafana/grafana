...
// CountInFolder provides a mock function with given fields: ctx, orgID, UID
func (_m *FakeDashboardService) CountInFolder(ctx context.Context, orgID int64, UID string) (int64, error) {
...
//   - orgID int64
//   - UID string
func (_e *FakeDashboardService_Expecter) CountInFolder(ctx interface{}, orgID interface{}, UID interface{}) *FakeDashboardService_CountInFolder_Call {
	return &FakeDashboardService_CountInFolder_Call{Call: _e.mock.On("CountInFolder", ctx, orgID, UID)}
}

func (_c *FakeDashboardService_CountInFolder_Call) Run(run func(ctx context.Context, orgID int64, UID string)) *FakeDashboardService_CountInFolder_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FakeDashboardService_CountInFolder_Call) RunAndReturn(run func(context.Context, int64, string) (int64, error)) *FakeDashboardService_CountInFolder_Call {
	_c.Call.Return(run)
	return _c
}
