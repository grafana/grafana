...
func (_m *FakeDashboardService) RestoreDashboard(ctx context.Context, dashboardUid string) error {
...
// SoftDeleteDashboard provides a mock function with given fields: ctx, dashboardUid
func (_m *FakeDashboardService) SoftDeleteDashboard(ctx context.Context, dashboardUid string) error {
	ret := _m.Called(ctx, dashboardUid)
