...
func (_m *FakeDashboardStore) GetSoftDeletedDashboard(ctx context.Context, query *GetDashboardQuery) (*Dashboard, error) {
	ret := _m.Called(ctx, query)
...
func (_m *FakeDashboardStore) SoftDeleteDashboard(ctx context.Context, dashboardUid string) error {
	ret := _m.Called(ctx, dashboardUid)
