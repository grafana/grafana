...
// SaveK8sDashboard provides a mock function with given fields: ctx, orgID, uid, meta, body
func (_m *FakeDashboardStore) SaveK8sDashboard(ctx context.Context, orgID int64, uid string, meta v1.ObjectMeta, body *simplejson.Json) (*Dashboard, error) {
	ret := _m.Called(ctx, orgID, uid, meta, body)

	var r0 *Dashboard
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, string, v1.ObjectMeta, *simplejson.Json) (*Dashboard, error)); ok {
		return rf(ctx, orgID, uid, meta, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, string, v1.ObjectMeta, *simplejson.Json) *Dashboard); ok {
		r0 = rf(ctx, orgID, uid, meta, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Dashboard)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, int64, string, v1.ObjectMeta, *simplejson.Json) error); ok {
		r1 = rf(ctx, orgID, uid, meta, body)
	} else {
		r1 = ret.Error(1)
	}
