...
func NewFolderNameScopeResolver(folderDB folder.FolderStore, folderStore folder.StoreTempRename) (string, ac.ScopeAttributeResolver) {
...
func NewFolderIDScopeResolver(folderDB folder.FolderStore, folderStore folder.StoreTempRename) (string, ac.ScopeAttributeResolver) {
...
func NewFolderUIDScopeResolver(folderStore folder.StoreTempRename) (string, ac.ScopeAttributeResolver) {
...
func NewDashboardIDScopeResolver(folderDB folder.FolderStore, ds DashboardService, folderStore folder.StoreTempRename) (string, ac.ScopeAttributeResolver) {
...
// into uid based scopes for both dashboard and folder
func NewDashboardUIDScopeResolver(folderDB folder.FolderStore, ds DashboardService, folderStore folder.StoreTempRename) (string, ac.ScopeAttributeResolver) {
...
func resolveDashboardScope(ctx context.Context, folderDB folder.FolderStore, orgID int64, dashboard *Dashboard, folderStore folder.StoreTempRename) ([]string, error) {
...
func GetInheritedScopes(ctx context.Context, orgID int64, folderUID string, folderStore folder.StoreTempRename) ([]string, error) {
