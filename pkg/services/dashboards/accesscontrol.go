...
func NewFolderNameScopeResolver(folderDB folder.FolderStore, folderSvc folder.Service, folderStore folder.Store) (string, ac.ScopeAttributeResolver) {
...
func NewFolderUIDScopeResolver(folderSvc folder.Service, folderStore folder.Store) (string, ac.ScopeAttributeResolver) {
...
func NewDashboardIDScopeResolver(folderDB folder.FolderStore, ds DashboardService, folderSvc folder.Service, folderStore folder.Store) (string, ac.ScopeAttributeResolver) {
...
// into uid based scopes for both dashboard and folder
func NewDashboardUIDScopeResolver(folderDB folder.FolderStore, ds DashboardService, folderSvc folder.Service, folderStore folder.Store) (string, ac.ScopeAttributeResolver) {
