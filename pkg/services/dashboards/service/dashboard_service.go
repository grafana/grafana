...
func (dr *DashboardServiceImpl) GetSoftDeletedDashboard(ctx context.Context, query *dashboards.GetDashboardQuery) (*dashboards.Dashboard, error) {
	return dr.dashboardStore.GetSoftDeletedDashboard(ctx, query)
}
