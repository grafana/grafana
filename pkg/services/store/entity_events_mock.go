...
// NewMockEntityEventsService creates a new instance of MockEntityEventsService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEntityEventsService(t testing.TB) *MockEntityEventsService {
