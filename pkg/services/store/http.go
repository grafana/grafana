...
func (s *standardStorageService) doWrite(c *model.ReqContext) response.Response {
...
func (s *standardStorageService) doUpload(c *model.ReqContext) response.Response {
	type rspInfo struct {
...
func (s *standardStorageService) read(c *model.ReqContext) response.Response {
...
func (s *standardStorageService) getOptions(c *model.ReqContext) response.Response {
	scope, path := getPathAndScope(c)
...
func (s *standardStorageService) doDelete(c *model.ReqContext) response.Response {
...
func (s *standardStorageService) doDeleteFolder(c *model.ReqContext) response.Response {
...
func (s *standardStorageService) doCreateFolder(c *model.ReqContext) response.Response {
	body, err := io.ReadAll(c.Req.Body)
	if err != nil {
		return response.Error(500, "error reading bytes", err)
	}
...
func (s *standardStorageService) list(c *model.ReqContext) response.Response {
...
func (s *standardStorageService) getConfig(c *model.ReqContext) response.Response {
