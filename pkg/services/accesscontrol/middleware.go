...
func authorize(c *model.ReqContext, ac AccessControl, user *user.SignedInUser, evaluator Evaluator) {
...
func deny(c *model.ReqContext, evaluator Evaluator, err error) {
	id := newID()
	if err != nil {
...
func unauthorized(c *model.ReqContext, err error) {
	if c.IsApiRequest() {
...
type OrgIDGetter func(c *model.ReqContext) (int64, error)
...
func UseOrgFromContextParams(c *model.ReqContext) (int64, error) {
...
func UseGlobalOrg(c *model.ReqContext) (int64, error) {
