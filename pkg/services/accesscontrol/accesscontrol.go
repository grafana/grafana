...
func HasGlobalAccess(ac AccessControl, service Service, c *model.ReqContext) func(fallback func(*model.ReqContext) bool, evaluator Evaluator) bool {
	return func(fallback func(*model.ReqContext) bool, evaluator Evaluator) bool {
		if ac.IsDisabled() {
			return fallback(c)
		}
...
func HasAccess(ac AccessControl, c *model.ReqContext) func(fallback func(*model.ReqContext) bool, evaluator Evaluator) bool {
	return func(fallback func(*model.ReqContext) bool, evaluator Evaluator) bool {
		if ac.IsDisabled() {
			return fallback(c)
		}
...
var ReqSignedIn = func(c *model.ReqContext) bool {
	return c.IsSignedIn
}

var ReqGrafanaAdmin = func(c *model.ReqContext) bool {
	return c.IsGrafanaAdmin
}

// ReqViewer returns true if the current user has org.RoleViewer. Note: this can be anonymous user as well
var ReqViewer = func(c *model.ReqContext) bool {
	return c.OrgRole.Includes(org.RoleViewer)
}

var ReqOrgAdmin = func(c *model.ReqContext) bool {
	return c.OrgRole == org.RoleAdmin
}

var ReqOrgAdminOrEditor = func(c *model.ReqContext) bool {
...
func ReqHasRole(role org.RoleType) func(c *model.ReqContext) bool {
	return func(c *model.ReqContext) bool { return c.HasRole(role) }
}
