...
func ProvideFolderPermissions(
	...
	folderPermissionsRegistration folder.PermissionsRegistrationService,
	...
	s := &FolderPermissionsService{srv}
	if folderPermissionsRegistration != nil {
		folderPermissionsRegistration.RegisterFolderPermissions(s)
	}
	return s, nil
}
