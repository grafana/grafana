...
func (a *api) registerEndpoints() {
	...
	a.router.Group(fmt.Sprintf("/api/access-control/%s", a.service.options.Resource), func(r routing.RouteRegister) {
		actionRead := a.service.getAction("read")
		actionWrite := a.service.getAction("write")
		scope := a.service.getScope(a.service.options.ResourceAttribute, accesscontrol.Parameter(":resourceID"))
