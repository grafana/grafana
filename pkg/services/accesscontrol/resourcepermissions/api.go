...
func (a *api) getDescription(c *model.ReqContext) response.Response {
...
func (a *api) getPermissions(c *model.ReqContext) response.Response {
...
func (a *api) setUserPermission(c *model.ReqContext) response.Response {
...
func (a *api) setTeamPermission(c *model.ReqContext) response.Response {
...
func (a *api) setBuiltinRolePermission(c *model.ReqContext) response.Response {
...
func (a *api) setPermissions(c *model.ReqContext) response.Response {
	resourceID := web.Params(c.Req)[":resourceID"]
