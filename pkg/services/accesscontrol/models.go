...
const (
	...
	// Settings scope for roles
	RoleScopeSettingsAll = "settings:*"

	// Global Scopes for roles
	RoleScopeGlobalUsersAll = "global:users:*"

	// Users scope for roles
	RoleScopeUsersAll = "users:*"
)
