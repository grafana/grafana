...
// {{.Flag.Description}}
func (ft *FeatureToggleInfo) Is{{.CamleCase}}Enabled() bool {
...
type FeatureToggleInfo struct {
	manager FeatureToggles
}

func NewFeatureToggleInfo(manager FeatureToggles) FeatureToggleInfo {
	return FeatureToggleInfo{
		manager: manager,
	}
}

var (
	_ FeatureToggles = (*FeatureToggleInfo)(nil)
)

// IsEnabled checks if a flag is enabled
func (ft *FeatureToggleInfo) IsEnabled(flag string) bool {
	return ft.manager.IsEnabled(flag)
}

// IsEnabled checks if a flag is enabled
func (ft *FeatureToggleInfo) GetEnabled() []string {
