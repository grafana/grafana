...
var (
	...
	standardFeatureFlags = []FeatureFlag{
		...
		{
			Name:         "grafana.exampleBooleanFlag",
			Description:  "Example boolean frontend feature flag",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendPlatformSquad,
			HideFromDocs: true,
			Expression:   "false",
		...
		{
			Name:         "grafana.exampleIntegerFlag",
			Description:  "Example integer frontend feature flag",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendPlatformSquad,
			HideFromDocs: true,
			Expression:   "42",
		...
		{
			Name:         "grafana.exampleFloatFlag",
			Description:  "Example float frontend feature flag",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendPlatformSquad,
			HideFromDocs: true,
			Expression:   "1.5",
		...
		{
			Name:         "grafana.exampleStringFlag",
			Description:  "Example string frontend feature flag",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendPlatformSquad,
			HideFromDocs: true,
			Expression:   "example",
		...
		{
			Name:         "grafana.exampleObjectFlag",
			Description:  "Example object frontend feature flag",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendPlatformSquad,
			HideFromDocs: true,
