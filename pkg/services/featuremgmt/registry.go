...
var standardFeatureFlags = []FeatureFlag{
	...
	{
		Name:              "alertingAlertmanagerSyncFlushStage",
		Description:       "the sync flush stage is an alertmanager stage which synchronizes instances' flush time. If this is enabled without alertingAlertmanagerSyncFlushStageSync, it will only emit a `syncing flush time` log",
		Stage:             FeatureStageExperimental,
		Owner:             grafanaAlertingSquad,
		HideFromAdminPage: true,
		HideFromDocs:      true,
	...
	{
		Name:              "alertingAlertmanagerSyncFlushStageSync",
		Description:       "the sync flush stage is an alertmanager stage which synchronizes instances' flush time. When enabled together with alertingAlertmanagerSyncFlushStage, it will delay the execution of the notification pipeline to synchronize instances",
		Stage:             FeatureStageExperimental,
		Owner:             grafanaAlertingSquad,
		HideFromAdminPage: true,
		HideFromDocs:      true,
