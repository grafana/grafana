...
const (
	...
	// FlagIpRangeAccessControlForDataSources
	// Enable IP range access control for Grafana data sources when the data source is accessed through Grafana
	FlagIpRangeAccessControlForDataSources = "ipRangeAccessControlForDataSources"
)
