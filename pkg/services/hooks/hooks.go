...
type IndexDataHook func(indexData *dtos.IndexViewData, req *model.ReqContext)

type LoginHook func(loginInfo *models.LoginInfo, req *model.ReqContext)
...
func (srv *HooksService) RunIndexDataHooks(indexData *dtos.IndexViewData, req *model.ReqContext) {
...
func (srv *HooksService) RunLoginHook(loginInfo *models.LoginInfo, req *model.ReqContext) {
