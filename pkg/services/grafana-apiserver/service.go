...
func ProvideService(cfg *setting.Cfg, rr routing.RouteRegister, restOptionsGetter func(runtime.Codec) genericregistry.RESTOptionsGetter, corereg *corekind.Base) (*service, error) {
	s := &service{
		rr:       rr,
