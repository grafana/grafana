...
type ExportService interface {
	...
	HandleGetStatus(c *model.ReqContext) response.Response

	// List Get Options
	HandleGetOptions(c *model.ReqContext) response.Response

	// Read raw file contents out of the store
	HandleRequestExport(c *model.ReqContext) response.Response

	// Cancel any running export
	HandleRequestStop(c *model.ReqContext) response.Response
}
...
func (ex *StandardExport) HandleGetOptions(c *model.ReqContext) response.Response {
...
func (ex *StandardExport) HandleGetStatus(c *model.ReqContext) response.Response {
	ex.mutex.Lock()
...
func (ex *StandardExport) HandleRequestStop(c *model.ReqContext) response.Response {
	ex.mutex.Lock()
	defer ex.mutex.Unlock()
...
func (ex *StandardExport) HandleRequestExport(c *model.ReqContext) response.Response {
