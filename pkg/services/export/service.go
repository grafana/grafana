...
func ProvideService(sql *sqlstore.SQLStore, features featuremgmt.FeatureToggles, gl *live.GrafanaLive, cfg *setting.Cfg, dashboardsnapshotsService dashboardsnapshots.Service, datasourceService datasources.DataSourceService) ExportService {
...
func (ex *StandardExport) HandleRequestExport(c *models.ReqContext) response.Response {
	...
	case "git":
		...
		job, err = startGitExportJob(cfg, ex.sql, ex.dashboardsnapshotsService, ex.datasourceService, dir, c.OrgId, broadcast)
	default:
