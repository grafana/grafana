...
// CreateServiceAccount provides a mock function with given fields: ctx, orgID, _a2, saForm
func (_m *MockServiceAccountService) CreateServiceAccount(ctx context.Context, orgID int64, _a2 *user.SignedInUser, saForm *serviceaccounts.CreateServiceAccountForm) (*serviceaccounts.ServiceAccountDTO, error) {
	ret := _m.Called(ctx, orgID, _a2, saForm)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, *user.SignedInUser, *serviceaccounts.CreateServiceAccountForm) (*serviceaccounts.ServiceAccountDTO, error)); ok {
		return rf(ctx, orgID, _a2, saForm)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, *user.SignedInUser, *serviceaccounts.CreateServiceAccountForm) *serviceaccounts.ServiceAccountDTO); ok {
		r0 = rf(ctx, orgID, _a2, saForm)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int64, *user.SignedInUser, *serviceaccounts.CreateServiceAccountForm) error); ok {
		r1 = rf(ctx, orgID, _a2, saForm)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockServiceAccountService) MigrateApiKey(ctx context.Context, orgID int64, keyId int64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for MigrateApiKey")
	}
