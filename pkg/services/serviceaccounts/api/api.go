...
func (api *ServiceAccountsAPI) RegisterAPIEndpoints(
	...
	api.RouterRegister.Group("/api/serviceaccounts", func(serviceAccountsRoute routing.RouteRegister) {
		...
		serviceAccountsRoute.Get("/status", auth(middleware.ReqOrgAdmin, accesscontrol.EvalPermission(serviceaccounts.ActionDelete, serviceaccounts.ScopeID)), routing.Wrap(api.IsDisabled))
	})
}
