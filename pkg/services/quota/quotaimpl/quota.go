...
func (s *serviceDisabled) QuotaReached(c *model.ReqContext, targetSrv quota.TargetSrv) (bool, error) {
	return false, nil
}
...
func (s *service) QuotaReached(c *model.ReqContext, targetSrv quota.TargetSrv) (bool, error) {
