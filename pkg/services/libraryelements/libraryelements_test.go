...
func testScenario(t *testing.T, desc string, fn func(t *testing.T, sc scenarioContext)) {
	...
	t.Run(desc, func(t *testing.T) {
		...
		service := LibraryElementService{
			...
			features:      featuremgmt.WithFeatures(),
			SQLStore:      sqlStore,
			folderService: folderimpl.ProvideService(ac, bus.ProvideBus(tracing.InitializeTracerForTest()), sqlStore.Cfg, dashboardStore, folderStore, nil, features, localcache.ProvideService()),
		}
