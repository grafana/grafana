...
type AlertRuleMetadata struct {
	...
	// PrometheusStyleRule is true if the rule is imported from Prometheus and should be treated as such.
	PrometheusStyleRule bool
}
...
func (alertRule *AlertRule) GetEvalSemantics() EvaluationSemantics {
	if alertRule.Metadata.PrometheusStyleRule {
