...
const (
	...
	// AutogeneratedRouteLabel a label name used to distinguish alerts that are supposed to be handled by autogenerated policy. Expected only value `true`.
	AutogeneratedRouteLabel = "__grafana_autogenerated__"
	// AutogeneratedRouteReceiverNameLabel a name of the label that contains a name of the receiver that is supposed to handle the alert in autogenerated policies.
	AutogeneratedRouteReceiverNameLabel = "__grafana_receiver__"
	// AutogeneratedRouteSettingsHashLabel a name of the label that contains a hash that uniquely identifies combination of notification settings (mute time interval, group_by, group_wait, repeat_interval etc)
...
var (
	...
	LabelsUserCannotSpecify = map[string]any{
		AutogeneratedRouteLabel:             nil,
		AutogeneratedRouteReceiverNameLabel: nil,
		AutogeneratedRouteSettingsHashLabel: nil,
	}
)
