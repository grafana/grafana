...
func (f *PrometheusApiHandler) handleRouteGetAlertStatuses(ctx *model.ReqContext, dsUID string) response.Response {
...
func (f *PrometheusApiHandler) handleRouteGetRuleStatuses(ctx *model.ReqContext, dsUID string) response.Response {
	t, err := f.getService(ctx)
	if err != nil {
		return errorToResponse(err)
	}
...
func (f *PrometheusApiHandler) handleRouteGetGrafanaAlertStatuses(ctx *model.ReqContext) response.Response {
	return f.GrafanaSvc.RouteGetAlertStatuses(ctx)
}

func (f *PrometheusApiHandler) handleRouteGetGrafanaRuleStatuses(ctx *model.ReqContext) response.Response {
	return f.GrafanaSvc.RouteGetRuleStatuses(ctx)
}

func (f *PrometheusApiHandler) getService(ctx *model.ReqContext) (*LotexProm, error) {
