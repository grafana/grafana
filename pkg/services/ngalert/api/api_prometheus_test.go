...
func Test_FormatValues(t *testing.T) {
	...
	classicMatchesState.SetNextValues(eval.Result{Values: map[string]eval.NumberValueCapture{
		"B10": {Var: "B", Metric: "disk_usage_bytes", Labels: data.Labels{"pod": "pod-10"}, Value: util.Pointer(10.0), Type: "classic_conditions"},
		"B0":  {Var: "B", Metric: "http_requests_total", Labels: data.Labels{"pod": "pod-0"}, Value: util.Pointer(val1), Type: "classic_conditions"},
		"B1":  {Var: "B", Metric: "http_requests_total", Labels: data.Labels{"pod": "pod-1"}, Value: util.Pointer(val2), Type: "classic_conditions"},
	}})
