 ...
 *
 *Do not manually edit these files, please find ngalert/api/tooling/swagger-codegen/ for commands on how to generate them.
 */
package api
...
type AlertmanagerApi interface {
	...
	RoutePostGrafanaAMAlerts(*contextmodel.ReqContext) response.Response
	...
	api.RouteRegister.Group("", func(group routing.RouteRegister) {
		...
		group.Post(
			...
			metrics.Instrument(
				http.MethodPost,
				"/api/alertmanager/grafana/api/v2/alerts",
				api.Hooks.Wrap(srv.RoutePostGrafanaAMAlerts),
				m,
			),
		)
		group.Post(
