...
func (api *API) authorize(method, path string) web.Handler {
	...
	case http.MethodGet + "/api/v1/provisioning/policies",
		...
		http.MethodGet + "/api/v1/provisioning/time-intervals",
		http.MethodGet + "/api/v1/provisioning/time-intervals/{name}",
	...
	case http.MethodPut + "/api/v1/provisioning/policies",
		...
		http.MethodPost + "/api/v1/provisioning/time-intervals",
		http.MethodPut + "/api/v1/provisioning/mute-timings/{name}",
		http.MethodPut + "/api/v1/provisioning/time-intervals/{name}",
		http.MethodDelete + "/api/v1/provisioning/mute-timings/{name}",
		http.MethodDelete + "/api/v1/provisioning/time-intervals/{name}",
