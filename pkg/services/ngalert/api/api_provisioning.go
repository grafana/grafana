...
func (srv *ProvisioningSrv) RouteGetPolicyTree(c *model.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RoutePutPolicyTree(c *model.ReqContext, tree definitions.Route) response.Response {
...
func (srv *ProvisioningSrv) RouteResetPolicyTree(c *model.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RouteGetContactPoints(c *model.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RoutePostContactPoint(c *model.ReqContext, cp definitions.EmbeddedContactPoint) response.Response {
...
func (srv *ProvisioningSrv) RoutePutContactPoint(c *model.ReqContext, cp definitions.EmbeddedContactPoint, UID string) response.Response {
	cp.UID = UID
...
func (srv *ProvisioningSrv) RouteDeleteContactPoint(c *model.ReqContext, UID string) response.Response {
...
func (srv *ProvisioningSrv) RouteGetTemplates(c *model.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RouteGetTemplate(c *model.ReqContext, name string) response.Response {
	templates, err := srv.templates.GetTemplates(c.Req.Context(), c.OrgID)
	if err != nil {
		return ErrResp(http.StatusInternalServerError, err, "")
	}
...
func (srv *ProvisioningSrv) RoutePutTemplate(c *model.ReqContext, body definitions.NotificationTemplateContent, name string) response.Response {
...
func (srv *ProvisioningSrv) RouteDeleteTemplate(c *model.ReqContext, name string) response.Response {
...
func (srv *ProvisioningSrv) RouteGetMuteTiming(c *model.ReqContext, name string) response.Response {
...
func (srv *ProvisioningSrv) RouteGetMuteTimings(c *model.ReqContext) response.Response {
	timings, err := srv.muteTimings.GetMuteTimings(c.Req.Context(), c.OrgID)
	if err != nil {
		return ErrResp(http.StatusInternalServerError, err, "")
	}
...
func (srv *ProvisioningSrv) RoutePostMuteTiming(c *model.ReqContext, mt definitions.MuteTimeInterval) response.Response {
...
func (srv *ProvisioningSrv) RoutePutMuteTiming(c *model.ReqContext, mt definitions.MuteTimeInterval, name string) response.Response {
	mt.Name = name
	mt.Provenance = alerting_models.ProvenanceAPI
...
func (srv *ProvisioningSrv) RouteDeleteMuteTiming(c *model.ReqContext, name string) response.Response {
...
func (srv *ProvisioningSrv) RouteGetAlertRules(c *model.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RouteRouteGetAlertRule(c *model.ReqContext, UID string) response.Response {
...
func (srv *ProvisioningSrv) RoutePostAlertRule(c *model.ReqContext, ar definitions.ProvisionedAlertRule) response.Response {
...
func (srv *ProvisioningSrv) RoutePutAlertRule(c *model.ReqContext, ar definitions.ProvisionedAlertRule, UID string) response.Response {
...
func (srv *ProvisioningSrv) RouteDeleteAlertRule(c *model.ReqContext, UID string) response.Response {
...
func (srv *ProvisioningSrv) RouteGetAlertRuleGroup(c *model.ReqContext, folder string, group string) response.Response {
...
func (srv *ProvisioningSrv) RoutePutAlertRuleGroup(c *model.ReqContext, ag definitions.AlertRuleGroup, folderUID string, group string) response.Response {
...
func determineProvenance(ctx *model.ReqContext) alerting_models.Provenance {
