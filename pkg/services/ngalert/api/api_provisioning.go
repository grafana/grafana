...
type AlertRuleService interface {
	...
	GetAlertRuleWithFolderFullpath(ctx context.Context, orgID int64, ruleUID string, u identity.Requester) (provisioning.AlertRuleWithFolderFullpath, error)
	GetAlertRuleGroupWithFolderFullpath(ctx context.Context, orgID int64, folder, group string, u identity.Requester) (alerting_models.AlertRuleGroupWithFolderFullpath, error)
	GetAlertGroupsWithFolderFullpath(ctx context.Context, orgID int64, folderUIDs []string, u identity.Requester) ([]alerting_models.AlertRuleGroupWithFolderFullpath, error)
}
