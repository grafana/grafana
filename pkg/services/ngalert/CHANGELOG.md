...
- [ENHANCEMENT] Scheduler: Drop ticks if rule evaluation is too slow and adds a metric grafana_alerting_rule_evaluations_missed_total to track missed evaluations per rule #48885
