...
func PostableGrafanaReceiverToEmbeddedContactPoint(contactPoint *definition.PostableGrafanaReceiver, provenance models.Provenance, decryptValue func(string) string) (definitions.EmbeddedContactPoint, error) {
