...
func NewNotificationPolicyService(am AMConfigStore, prov ProvisioningStore, xact TransactionManager, log log.Logger,
	settings setting.UnifiedAlertingSettings) *NotificationPolicyService {
