...
func alertInstanceMigration(mg *migrator.Migrator) {
	...
	mg.AddMigration("add index in alert_instance table on def_org_i, def_uid and current_state columns", migrator.NewAddIndexMigration(alertInstance, alertInstance.Indices[0]))
