...
func alertInstanceModelToProto(modelInstance models.AlertInstance) *pb.AlertInstance {
	...
	return &pb.AlertInstance{
		...
		ImageCaptureNextAttemptAt:       nullableTimeToTimestamp(modelInstance.ImageCaptureNextAttemptAt),
		ImageCaptureConsecutiveTimeouts: modelInstance.ImageCaptureConsecutiveTimeouts,
	}
}
...
func alertInstanceProtoToModel(ruleUID string, ruleOrgID int64, protoInstance *pb.AlertInstance) *models.AlertInstance {
	...
	return &models.AlertInstance{
		...
		LastResult:                      lastResult,
		ImageCaptureNextAttemptAt:       nullableTimestampToTime(protoInstance.ImageCaptureNextAttemptAt),
		ImageCaptureConsecutiveTimeouts: protoInstance.ImageCaptureConsecutiveTimeouts,
	}
}
