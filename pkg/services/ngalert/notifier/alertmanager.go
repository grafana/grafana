...
func (am *alertmanager) SaveAndApplyDefaultConfig(ctx context.Context) error {
	...
	am.Base.WithLock(func() {
		...
		err = am.Store.SaveAlertmanagerConfigurationWithCallback(ctx, cmd, func() error {
			autogenRoute, err := am.AddAutogenConfig(ctx, cfg)
			if err != nil {
				return err
			}
...
func (am *alertmanager) AddAutogenConfig(ctx context.Context, cfg *apimodels.PostableUserConfig) (*autogeneratedRoute, error) {
	...
	autogenRoute, err := newAutogeneratedRoute(ctx, am.logger, am.orgID, am.Store, cfg.AlertmanagerConfig.Route.Receiver, cfg.AlertmanagerConfig, true)
	if err != nil {
		return nil, err
	}
