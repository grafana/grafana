...
// (used to build autogenerated routes) comes from the rule store. These were a single DBstore
// before the rule store was split into its own package, and neither store re-exports the other.
