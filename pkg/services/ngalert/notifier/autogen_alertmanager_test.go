...
func TestAddAutogenConfig(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			storeSettings: []models.NotificationSettings{
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver1"), models.NSMuts{}.WithGroupInterval(util.Pointer(1*time.Minute))),
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver2"), models.NSMuts{}.WithGroupWait(util.Pointer(2*time.Minute))),
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver3"), models.NSMuts{}.WithRepeatInterval(util.Pointer(3*time.Minute))),
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver4"), models.NSMuts{}.WithGroupBy(model.AlertNameLabel, models.FolderTitleLabel, "custom")),
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver5"), models.NSMuts{}.WithMuteTimeIntervals("maintenance")),
				*models.NotificationSettingsGen(models.NotificationSettings{
					Receiver:          "receiver1",
		...
		},
		{
			...
			storeSettings: []models.NotificationSettings{
				...
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver1"), models.NSMuts{}.WithMuteTimeIntervals("maintenance")),        // Doesn't exist.
				*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver2"), models.NSMuts{}.WithGroupWait(util.Pointer(-2*time.Minute))), // Negative.
			},
			skipInvalid: true,
			expRoute: withChildRoutes(rootRoute(), &definitions.Route{
				Receiver:       "default",
		...
		},
		{
			...
			existingConfig:   configGen([]string{"receiver1", "receiver2", "receiver3"}, nil),
			storeSettings:    []models.NotificationSettings{*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver1"), models.NSMuts{}.WithMuteTimeIntervals("maintenance"))},
			skipInvalid:      false,
		...
		},
		{
			name:             "when skipInvalid=false, invalid settings throws error",
			existingConfig:   configGen([]string{"receiver1", "receiver2", "receiver3"}, nil),
			storeSettings:    []models.NotificationSettings{*models.NotificationSettingsGen(models.NewDefaultNotificationSettings("receiver2"), models.NSMuts{}.WithGroupWait(util.Pointer(-2*time.Minute)))},
			skipInvalid:      false,
