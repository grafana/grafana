...
func TestAddAutogenConfig(t *testing.T) {
	rootRoute := func() *definition.Route {
		return &definition.Route{
			Receiver: "default",
		}
	}
	configGen := func(receivers []string, muteIntervals []string) *definition.PostableApiAlertingConfig {
		cfg := &definition.PostableApiAlertingConfig{
			Config: definition.Config{
				Route: rootRoute(),
			},
		}
		for _, receiver := range receivers {
			cfg.Receivers = append(cfg.Receivers, &definition.PostableApiReceiver{
	...
	testCases := []struct {
		name             string
		existingConfig   *definition.PostableApiAlertingConfig
		...
		},
		{
			...
			storeSettings:  []models.NotificationSettings{},
			expRoute: withChildRoutes(rootRoute(), &definition.Route{
				Receiver:       "default",
