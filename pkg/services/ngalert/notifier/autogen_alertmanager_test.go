...
func TestAddAutogenConfig(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			storeSettings: []models.ContactPointRouting{
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute))),
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver2"), models.CPRMuts.WithGroupWait(util.Pointer(2*time.Minute))),
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver3"), models.CPRMuts.WithRepeatInterval(util.Pointer(3*time.Minute))),
		...
		},
		{
			...
			storeSettings: []models.ContactPointRouting{
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy()),
			},
			expRoute: withChildRoutes(rootRoute(), &definitions.Route{
				Receiver:       "default",
				ObjectMatchers: matcher(models.AutogeneratedRouteLabel, "true"),
		...
		},
		{
			...
			storeSettings: []models.ContactPointRouting{
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy()),
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy(models.DefaultNotificationSettingsGroupBy...)),
			},
			expRoute: withChildRoutes(rootRoute(), &definitions.Route{
				Receiver:       "default",
				ObjectMatchers: matcher(models.AutogeneratedRouteLabel, "true"),
		...
		},
		{
			...
			existingConfig: configGen([]string{"receiver1"}, nil),
			storeSettings: []models.ContactPointRouting{
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy(models.FolderTitleLabel)),
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy(model.AlertNameLabel)),
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver1"), models.CPRMuts.WithGroupInterval(util.Pointer(1*time.Minute)), models.CPRMuts.WithGroupBy(models.DefaultNotificationSettingsGroupBy...)),
			},
			expRoute: withChildRoutes(rootRoute(), &definitions.Route{
				Receiver:       "default",
		...
		},
		{
			...
			storeSettings: []models.ContactPointRouting{
				...
				models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver2"), models.CPRMuts.WithGroupWait(util.Pointer(-2*time.Minute))), // Negative.
			},
			skipInvalid: true,
			expRoute: withChildRoutes(rootRoute(), &definitions.Route{
				Receiver:       "default",
		...
		},
		{
			name:             "when skipInvalid=false, invalid settings throws error",
			existingConfig:   configGen([]string{"receiver1", "receiver2", "receiver3"}, nil),
			storeSettings:    []models.ContactPointRouting{models.CopyContactPointRouting(models.NewDefaultContactPointRouting("receiver2"), models.CPRMuts.WithGroupWait(util.Pointer(-2*time.Minute)))},
			skipInvalid:      false,
