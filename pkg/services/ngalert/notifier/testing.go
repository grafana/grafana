...
func NewFakeExternalAlertmanager(t *testing.T, tenantID, password string) *FakeExternalAlertmanager {
	...
	am.Server = httptest.NewServer(http.HandlerFunc(am.basicAuthMiddleware(am.Handler())))
...
func (am *FakeExternalAlertmanager) basicAuthMiddleware(next func(w http.ResponseWriter, r *http.Request)) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
