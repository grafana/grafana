...
// RefreshConfig will re-apply the latest alertmanager configuration for a given org.
// Can be used to force regeneration of autogenerated routes.
func (moa *MultiOrgAlertmanager) RefreshConfig(ctx context.Context, orgId int64) error {
	dbConfig, err := moa.configStore.GetLatestAlertmanagerConfiguration(ctx, orgId)
	if err != nil {
