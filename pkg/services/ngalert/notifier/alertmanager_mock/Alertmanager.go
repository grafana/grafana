...
func (_c *AlertmanagerMock_ApplyConfig_Call) Return(_a0 bool, _a1 error) *AlertmanagerMock_ApplyConfig_Call {
...
func (_m *AlertmanagerMock) CreateSilence(_a0 context.Context, _a1 *models.PostableSilence) (string, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *AlertmanagerMock_CreateSilence_Call) Run(run func(_a0 context.Context, _a1 *models.PostableSilence)) *AlertmanagerMock_CreateSilence_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AlertmanagerMock_CreateSilence_Call) RunAndReturn(run func(context.Context, *models.PostableSilence) (string, error)) *AlertmanagerMock_CreateSilence_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AlertmanagerMock) GetAlertGroups(ctx context.Context, active bool, silenced bool, inhibited bool, filter []string, receiver string) (models.AlertGroups, error) {
...
func (_c *AlertmanagerMock_GetAlertGroups_Call) Return(_a0 models.AlertGroups, _a1 error) *AlertmanagerMock_GetAlertGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlertmanagerMock_GetAlertGroups_Call) RunAndReturn(run func(context.Context, bool, bool, bool, []string, string) (models.AlertGroups, error)) *AlertmanagerMock_GetAlertGroups_Call {
	_c.Call.Return(run)
	return _c
}

// GetAlerts provides a mock function with given fields: ctx, active, silenced, inhibited, filter, receiver
func (_m *AlertmanagerMock) GetAlerts(ctx context.Context, active bool, silenced bool, inhibited bool, filter []string, receiver string) (models.GettableAlerts, error) {
	ret := _m.Called(ctx, active, silenced, inhibited, filter, receiver)
...
func (_c *AlertmanagerMock_GetAlerts_Call) Return(_a0 models.GettableAlerts, _a1 error) *AlertmanagerMock_GetAlerts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlertmanagerMock_GetAlerts_Call) RunAndReturn(run func(context.Context, bool, bool, bool, []string, string) (models.GettableAlerts, error)) *AlertmanagerMock_GetAlerts_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AlertmanagerMock) GetSilence(_a0 context.Context, _a1 string) (models.GettableSilence, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *AlertmanagerMock_GetSilence_Call) Return(_a0 models.GettableSilence, _a1 error) *AlertmanagerMock_GetSilence_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlertmanagerMock_GetSilence_Call) RunAndReturn(run func(context.Context, string) (models.GettableSilence, error)) *AlertmanagerMock_GetSilence_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AlertmanagerMock) ListSilences(_a0 context.Context, _a1 []string) (models.GettableSilences, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *AlertmanagerMock_ListSilences_Call) Return(_a0 models.GettableSilences, _a1 error) *AlertmanagerMock_ListSilences_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlertmanagerMock_ListSilences_Call) RunAndReturn(run func(context.Context, []string) (models.GettableSilences, error)) *AlertmanagerMock_ListSilences_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AlertmanagerMock) TestIntegration(ctx context.Context, receiverName string, integrationConfig ngalertmodels.Integration, alert alertingmodels.TestReceiversConfigAlertParams) (alertingmodels.IntegrationStatus, error) {
...
func (_c *AlertmanagerMock_TestIntegration_Call) Run(run func(ctx context.Context, receiverName string, integrationConfig ngalertmodels.Integration, alert alertingmodels.TestReceiversConfigAlertParams)) *AlertmanagerMock_TestIntegration_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AlertmanagerMock_TestIntegration_Call) RunAndReturn(run func(context.Context, string, ngalertmodels.Integration, alertingmodels.TestReceiversConfigAlertParams) (alertingmodels.IntegrationStatus, error)) *AlertmanagerMock_TestIntegration_Call {
	_c.Call.Return(run)
	return _c
}
