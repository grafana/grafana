...
func (_m *AlertmanagerMock) ApplyConfig(_a0 context.Context, _a1 *models.AlertConfiguration, _a2 ...models.ApplyConfigOption) error {
...
func (_e *AlertmanagerMock_Expecter) ApplyConfig(_a0 interface{}, _a1 interface{}, _a2 ...interface{}) *AlertmanagerMock_ApplyConfig_Call {
	return &AlertmanagerMock_ApplyConfig_Call{Call: _e.mock.On("ApplyConfig",
		append([]interface{}{_a0, _a1}, _a2...)...)}
}

func (_c *AlertmanagerMock_ApplyConfig_Call) Run(run func(_a0 context.Context, _a1 *models.AlertConfiguration, _a2 ...models.ApplyConfigOption)) *AlertmanagerMock_ApplyConfig_Call {
...
func (_c *AlertmanagerMock_ApplyConfig_Call) RunAndReturn(run func(context.Context, *models.AlertConfiguration, ...models.ApplyConfigOption) error) *AlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(run)
	return _c
}
