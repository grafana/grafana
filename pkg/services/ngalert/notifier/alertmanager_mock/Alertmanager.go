...
func (_m *AlertmanagerMock) ApplyConfig(_a0 context.Context, _a1 *definitions.PostableUserConfig) error {
...
func (_c *AlertmanagerMock_ApplyConfig_Call) RunAndReturn(run func(context.Context, *definitions.PostableUserConfig) error) *AlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AlertmanagerMock) GetReceivers(ctx context.Context) ([]models.Receiver, error) {
	ret := _m.Called(ctx)
...
func (_c *AlertmanagerMock_GetReceivers_Call) Return(_a0 []models.Receiver, _a1 error) *AlertmanagerMock_GetReceivers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlertmanagerMock_GetReceivers_Call) RunAndReturn(run func(context.Context) ([]models.Receiver, error)) *AlertmanagerMock_GetReceivers_Call {
	_c.Call.Return(run)
	return _c
}
