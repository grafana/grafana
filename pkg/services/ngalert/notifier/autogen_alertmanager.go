...
func newAutogeneratedRoute(ctx context.Context, logger log.Logger, orgId int64, store autogenRuleStore, defaultReceiver string, validator models.NotificationSettingsValidator) (autogeneratedRoute, error) {
