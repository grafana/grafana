...
func AddAutogenConfig(ctx context.Context, logger log.Logger, store autogenRuleStore, orgId int64, cfg *v1.AMConfigV1, invalidReceiverAction InvalidReceiversAction, features featuremgmt.FeatureToggles, timings *autogenRouteTimings) error {
	autogenRoute, err := newAutogeneratedRoute(ctx, logger, store, orgId, cfg, invalidReceiverAction, features, timings)
	if err != nil {
		return err
	}

	err = autogenRoute.addToRoute(cfg.AlertmanagerConfig.GetRoute())
	if err != nil {
		return err
	}
...
func newAutogeneratedRoute(ctx context.Context, logger log.Logger, store autogenRuleStore, orgId int64, cfg *v1.AMConfigV1, invalidReceiverAction InvalidReceiversAction, features featuremgmt.FeatureToggles, timings *autogenRouteTimings) (autogeneratedRoute, error) {
	...
	for _, receiver := range cfg.AlertmanagerConfig.GetReceivers() {
	...
	newAutogenRoute, err := generateRouteFromSettings(cfg.AlertmanagerConfig.GetRoute().Receiver, notificationSettings, timings)
	if err != nil {
