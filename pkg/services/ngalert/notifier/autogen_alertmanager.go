...
func newAutogeneratedRoute(ctx context.Context, logger log.Logger, orgId int64, store autogenRuleStore, defaultReceiver string, alertmanagerConfig definitions.PostableApiAlertingConfig, validate bool) (autogeneratedRoute, error) {
	...
	var validator models.NotificationSettingsValidator = noValidation{}
	if validate {
		validator = NewNotificationSettingsValidator(alertmanagerConfig)
	}
...
// RemoveAutogenConfig removes any autogenerated routes from the provided config.
