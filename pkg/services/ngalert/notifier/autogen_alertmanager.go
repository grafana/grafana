...
const (
	ErrorOnInvalidReceivers = models.ErrorOnInvalidReceivers
	LogInvalidReceivers     = models.LogInvalidReceivers
	IgnoreInvalidReceivers  = models.IgnoreInvalidReceivers
)

type InvalidReceiversAction = models.InvalidReceiversAction
