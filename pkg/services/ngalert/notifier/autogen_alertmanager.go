...
func AddAutogenConfig(ctx context.Context, logger log.Logger, store autogenRuleStore, orgId int64, cfg *v1.PostableApiAlertingConfig, invalidReceiverAction InvalidReceiversAction, features featuremgmt.FeatureToggles) error {
...
func newAutogeneratedRoute(ctx context.Context, logger log.Logger, store autogenRuleStore, orgId int64, cfg *v1.PostableApiAlertingConfig, invalidReceiverAction InvalidReceiversAction, features featuremgmt.FeatureToggles) (autogeneratedRoute, error) {
