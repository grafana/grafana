...
func AddAutogenConfig(ctx context.Context, logger log.Logger, store autogenRuleStore, orgId int64, cfg *v1.AMConfigV1, invalidReceiverAction InvalidReceiversAction, features featuremgmt.FeatureToggles) error {
