...
func getAvailableV0mimir1Notifiers() []*NotifierPlugin {
	return []*NotifierPlugin{
		...
		getPagerDutyMimirNotifier(),
		getSlackMimirNotifier(),
		getWebhookMimirNotifier(),
		getOpsGenieMimirNotifier(),
		getWeChatMimirNotifier(),
		getPushoverMimirNotifier(),
		getVictorOpsMimirNotifier(),
		getAmazonSNSMimirNotifier(),
		getTelegramMimirNotifier(),
		getWebexMimirNotifier(),
		getMicrosoftTeamsMimirNotifier(),
		getJiraMimirNotifier(),
	}
}
...
func getDiscordMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "discord",
		Name:        "Discord",
...
func getEmailMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "email",
		Name:        "Email",
...
func getPagerDutyMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "pagerduty",
		Name:        "PagerDuty",
...
func getSlackMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "slack",
		Name:        "Slack",
...
func getWebhookMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "webhook",
		Name:        "Webhook",
...
func getOpsGenieMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "opsgenie",
		Name:        "OpsGenie",
...
func getWeChatMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "wechat",
		Name:        "WeChat",
...
func getPushoverMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "pushover",
		Name:        "Pushover",
...
func getVictorOpsMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "victorops",
		Name:        "VictorOps",
...
func getAmazonSNSMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "sns",
		Name:        "Amazon SNS",
...
func getTelegramMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "telegram",
		Name:        "Telegram",
...
func getWebexMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "webex",
...
func getJiraMimirNotifier() *NotifierPlugin {
	return &NotifierPlugin{
		Type:        "jira",
		Name:        "Jira",
