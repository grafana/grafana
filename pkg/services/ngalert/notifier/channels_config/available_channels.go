		...
		},
		{
			...
			Options: []NotifierOption{
				...
				// },
				{
					...
					Description:  "The OnCall escalation chain to send alerts to.",
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
					Placeholder:  "FQZ9G4XHM34P6",
					PropertyName: "escalation_chain_id",
					Required:     true,
					DependsOn:    "slack_channel_id",
				},
				{
					Label:        "Chatops Slack Channel",
				...
				{
					Label:        "OnCall Team",
					Description:  "The OnCall Team to associate with the alert.",
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
