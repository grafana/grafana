	...
	return []*NotifierPlugin{
		{
			...
			Options: []NotifierOption{
				...
				{ // New in 9.3.
					...
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
					Description:  "title of the message, eg.  {{template \"default.title\" .}} ",
				...
				{ // New in 8.0.
					...
					Description:  "Custom DingDing message. You can use template variables. eg.  {{template \"default.message\" .}}",
