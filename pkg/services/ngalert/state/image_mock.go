...
//
//	mockgen -destination=image_mock.go -package=state github.com/grafana/grafana/pkg/services/ngalert/state ImageCapturer
//
...
func (m *MockImageCapturer) NewImage(ctx context.Context, r *models.AlertRule) (*models.Image, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewImage", ctx, r)
...
func (mr *MockImageCapturerMockRecorder) NewImage(ctx, r any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewImage", reflect.TypeOf((*MockImageCapturer)(nil).NewImage), ctx, r)
}
