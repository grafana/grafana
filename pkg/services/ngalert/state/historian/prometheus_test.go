	...
	testCases := []struct {
		...
		},
		{
			...
			expectedFrames: data.Frames{
				...
				createExpectedFrame(t, "rule-uid-error", "test rule", "error", "error", data.Labels{"state": "error"}, 1.0),
				createExpectedFrame(t, "rule-uid-nodata", "test rule", "nodata", "nodata", data.Labels{"state": "nodata"}, 1.0),
			},
		},
		...
		},
		{
			...
			expectedFrames: data.Frames{
				createExpectedFrame(t, "rule-uid", "test rule", "error", "error", data.Labels{"instance": "server1"}, 1.0),
			},
		},
		...
		},
		{
			...
			expectedFrames: data.Frames{
				createExpectedFrame(t, "rule-uid", "test rule", "error", "error", data.Labels{"instance": "server1"}, math.Float64frombits(promValue.StaleNaN)),
			},
		},
		{
