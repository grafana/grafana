...
func TestAlertInstanceOperations(t *testing.T) {
	...
	t.Run("can save and read new alert instance", func(t *testing.T) {
		...
		require.Equal(t, alertDefinition1.OrgID, getCmd.Result.RuleOrgID)
		require.Equal(t, alertDefinition1.UID, getCmd.Result.RuleUID)
	})
	...
	t.Run("can save and read new alert instance with no labels", func(t *testing.T) {
		...
		require.Equal(t, alertDefinition2.OrgID, getCmd.Result.RuleOrgID)
		require.Equal(t, alertDefinition2.UID, getCmd.Result.RuleUID)
		require.Equal(t, saveCmd.Labels, getCmd.Result.Labels)
	})
