...
func (ng *AlertNG) init() error {
	...
	receiverAuthz := ac.NewReceiverAccess[*models.Receiver](ng.accesscontrol, true)
	contactPointService := provisioning.NewContactPointService(receiverAuthz, configStore, ng.SecretsService, ng.store, ng.store, provisioningReceiverService, ng.Log, ng.store, ng.ResourcePermissions)
