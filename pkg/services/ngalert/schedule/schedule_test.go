...
func TestWarmStateCache(t *testing.T) {
	...
	st := state.NewManager(schedCfg.Logger, testMetrics.GetStateMetrics(), nil, dbstore, dbstore, ng.SQLStore, &dashboards.FakeDashboardService{}, &screenshot.NoopScreenshotService{})
	st.Warm(ctx)
