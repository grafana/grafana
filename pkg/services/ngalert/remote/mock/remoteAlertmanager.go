...
func (_m *RemoteAlertmanagerMock) ApplyConfig(_a0 context.Context, _a1 notify.NotificationsConfiguration) (bool, error) {
...
func (_c *RemoteAlertmanagerMock_ApplyConfig_Call) Run(run func(_a0 context.Context, _a1 notify.NotificationsConfiguration)) *RemoteAlertmanagerMock_ApplyConfig_Call {
...
func (_c *RemoteAlertmanagerMock_ApplyConfig_Call) Return(_a0 bool, _a1 error) *RemoteAlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_ApplyConfig_Call) RunAndReturn(run func(context.Context, notify.NotificationsConfiguration) (bool, error)) *RemoteAlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(run)
	return _c
}

// CompareAndSendConfiguration provides a mock function with given fields: _a0, _a1
func (_m *RemoteAlertmanagerMock) CompareAndSendConfiguration(_a0 context.Context, _a1 notify.NotificationsConfiguration) (bool, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call) Run(run func(_a0 context.Context, _a1 notify.NotificationsConfiguration)) *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(notify.NotificationsConfiguration))
	})
	return _c
...
func (_c *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call) Return(_a0 bool, _a1 error) *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call) RunAndReturn(run func(context.Context, notify.NotificationsConfiguration) (bool, error)) *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call {
	_c.Call.Return(run)
	return _c
}

// CreateSilence provides a mock function with given fields: _a0, _a1
func (_m *RemoteAlertmanagerMock) CreateSilence(_a0 context.Context, _a1 *models.PostableSilence) (string, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.PostableSilence) (string, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *models.PostableSilence) string); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *models.PostableSilence) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *RemoteAlertmanagerMock_CreateSilence_Call) Run(run func(_a0 context.Context, _a1 *models.PostableSilence)) *RemoteAlertmanagerMock_CreateSilence_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.PostableSilence))
	})
	return _c
}
...
func (_c *RemoteAlertmanagerMock_CreateSilence_Call) RunAndReturn(run func(context.Context, *models.PostableSilence) (string, error)) *RemoteAlertmanagerMock_CreateSilence_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) GetAlertGroups(ctx context.Context, active bool, silenced bool, inhibited bool, filter []string, receiver string) (models.AlertGroups, error) {
	...
	var r0 models.AlertGroups
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool, bool, []string, string) (models.AlertGroups, error)); ok {
		return rf(ctx, active, silenced, inhibited, filter, receiver)
	}
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool, bool, []string, string) models.AlertGroups); ok {
		r0 = rf(ctx, active, silenced, inhibited, filter, receiver)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(models.AlertGroups)
		}
	}
...
func (_c *RemoteAlertmanagerMock_GetAlertGroups_Call) Return(_a0 models.AlertGroups, _a1 error) *RemoteAlertmanagerMock_GetAlertGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_GetAlertGroups_Call) RunAndReturn(run func(context.Context, bool, bool, bool, []string, string) (models.AlertGroups, error)) *RemoteAlertmanagerMock_GetAlertGroups_Call {
	_c.Call.Return(run)
	return _c
}

// GetAlerts provides a mock function with given fields: ctx, active, silenced, inhibited, filter, receiver
func (_m *RemoteAlertmanagerMock) GetAlerts(ctx context.Context, active bool, silenced bool, inhibited bool, filter []string, receiver string) (models.GettableAlerts, error) {
	ret := _m.Called(ctx, active, silenced, inhibited, filter, receiver)
	...
	var r0 models.GettableAlerts
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool, bool, []string, string) (models.GettableAlerts, error)); ok {
		return rf(ctx, active, silenced, inhibited, filter, receiver)
	}
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool, bool, []string, string) models.GettableAlerts); ok {
		r0 = rf(ctx, active, silenced, inhibited, filter, receiver)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(models.GettableAlerts)
		}
	}
...
func (_c *RemoteAlertmanagerMock_GetAlerts_Call) Return(_a0 models.GettableAlerts, _a1 error) *RemoteAlertmanagerMock_GetAlerts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_GetAlerts_Call) RunAndReturn(run func(context.Context, bool, bool, bool, []string, string) (models.GettableAlerts, error)) *RemoteAlertmanagerMock_GetAlerts_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) GetSilence(_a0 context.Context, _a1 string) (models.GettableSilence, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 models.GettableSilence
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (models.GettableSilence, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) models.GettableSilence); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(models.GettableSilence)
	}
...
func (_c *RemoteAlertmanagerMock_GetSilence_Call) Return(_a0 models.GettableSilence, _a1 error) *RemoteAlertmanagerMock_GetSilence_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_GetSilence_Call) RunAndReturn(run func(context.Context, string) (models.GettableSilence, error)) *RemoteAlertmanagerMock_GetSilence_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) ListSilences(_a0 context.Context, _a1 []string) (models.GettableSilences, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 models.GettableSilences
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) (models.GettableSilences, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) models.GettableSilences); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(models.GettableSilences)
		}
	}
...
func (_c *RemoteAlertmanagerMock_ListSilences_Call) Return(_a0 models.GettableSilences, _a1 error) *RemoteAlertmanagerMock_ListSilences_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_ListSilences_Call) RunAndReturn(run func(context.Context, []string) (models.GettableSilences, error)) *RemoteAlertmanagerMock_ListSilences_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) TestIntegration(ctx context.Context, receiverName string, integrationConfig ngalertmodels.Integration, alert alertingmodels.TestReceiversConfigAlertParams) (alertingmodels.IntegrationStatus, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ngalertmodels.Integration, alertingmodels.TestReceiversConfigAlertParams) (alertingmodels.IntegrationStatus, error)); ok {
		return rf(ctx, receiverName, integrationConfig, alert)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, ngalertmodels.Integration, alertingmodels.TestReceiversConfigAlertParams) alertingmodels.IntegrationStatus); ok {
		r0 = rf(ctx, receiverName, integrationConfig, alert)
	} else {
		r0 = ret.Get(0).(alertingmodels.IntegrationStatus)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, ngalertmodels.Integration, alertingmodels.TestReceiversConfigAlertParams) error); ok {
...
//   - ctx context.Context
//   - receiverName string
//   - integrationConfig ngalertmodels.Integration
...
func (_c *RemoteAlertmanagerMock_TestIntegration_Call) Run(run func(ctx context.Context, receiverName string, integrationConfig ngalertmodels.Integration, alert alertingmodels.TestReceiversConfigAlertParams)) *RemoteAlertmanagerMock_TestIntegration_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(ngalertmodels.Integration), args[3].(alertingmodels.TestReceiversConfigAlertParams))
	})
	return _c
}
...
func (_c *RemoteAlertmanagerMock_TestIntegration_Call) RunAndReturn(run func(context.Context, string, ngalertmodels.Integration, alertingmodels.TestReceiversConfigAlertParams) (alertingmodels.IntegrationStatus, error)) *RemoteAlertmanagerMock_TestIntegration_Call {
	_c.Call.Return(run)
	return _c
}
