...
func (_m *RemoteAlertmanagerMock) ApplyConfig(_a0 context.Context, _a1 *definitions.PostableUserConfig) error {
...
func (_c *RemoteAlertmanagerMock_ApplyConfig_Call) Run(run func(_a0 context.Context, _a1 *definitions.PostableUserConfig)) *RemoteAlertmanagerMock_ApplyConfig_Call {
...
func (_c *RemoteAlertmanagerMock_ApplyConfig_Call) RunAndReturn(run func(context.Context, *definitions.PostableUserConfig) error) *RemoteAlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) CompareAndSendConfiguration(_a0 context.Context, _a1 *definitions.PostableUserConfig) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call) Run(run func(_a0 context.Context, _a1 *definitions.PostableUserConfig)) *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*definitions.PostableUserConfig))
	})
	return _c
...
func (_c *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call) RunAndReturn(run func(context.Context, *definitions.PostableUserConfig) error) *RemoteAlertmanagerMock_CompareAndSendConfiguration_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RemoteAlertmanagerMock) GetReceivers(ctx context.Context) ([]models.Receiver, error) {
	ret := _m.Called(ctx)

	var r0 []models.Receiver
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]models.Receiver, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []models.Receiver); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.Receiver)
		}
	}
...
func (_c *RemoteAlertmanagerMock_GetReceivers_Call) Return(_a0 []models.Receiver, _a1 error) *RemoteAlertmanagerMock_GetReceivers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RemoteAlertmanagerMock_GetReceivers_Call) RunAndReturn(run func(context.Context) ([]models.Receiver, error)) *RemoteAlertmanagerMock_GetReceivers_Call {
	_c.Call.Return(run)
	return _c
}
