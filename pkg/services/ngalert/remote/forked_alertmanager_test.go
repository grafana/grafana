...
func TestForkedAlertmanager_ModeRemoteSecondary(t *testing.T) {
	...
	t.Run("GetSilence", func(tt *testing.T) {
		// We should get the silence from the interna Alertmanager.
		internal, _, forked := genTestAlertmanagers(tt, ModeRemoteSecondary)
...
// TODO: test RemotePrimary
func TestForkedAlertmanager_ModeRemotePrimary(t *testing.T) {}

func genTestAlertmanagers(t *testing.T, mode Mode) (*alertmanager_mocks.AlertmanagerMock, *alertmanager_mocks.AlertmanagerMock, notifier.Alertmanager) {
	t.Helper()
