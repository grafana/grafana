...
func NewAlertmanager(
	...
	err = func() error {
		...
		routingTree := v1.RouteToDB(parsed.AlertmanagerConfig.Route)
		if err := notifier.AddAutogenConfig(ctx, am.log, emptyAutogenRuleStore{}, am.orgID, parsed, routingTree, notifier.IgnoreInvalidReceivers, am.features); err != nil {
			return fmt.Errorf("unable to add autogenerated routes: %w", err)
		}

		nc, err := notifier.PostableAPIConfigToNotificationsConfiguration(*parsed, routingTree, alertingNotify.DynamicLimits{})
		if err != nil {
