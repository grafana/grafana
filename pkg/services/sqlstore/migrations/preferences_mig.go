...
func addPreferencesMigrations(mg *Migrator) {
	...
	mg.AddMigration("Add query_history_json settings in preferences", NewAddColumnMigration(preferencesV2, &Column{
		Name: "query_history_json", Type: DB_Text, Nullable: true,
	}))
}
