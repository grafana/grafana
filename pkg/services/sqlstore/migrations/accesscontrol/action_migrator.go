...
func (m *actionNameMigrator) migrateActionNames() error {
	actionNameMapping := map[string]string{
		...
		"users.authtoken:update":   accesscontrol.ActionUsersAuthTokenWrite,
		"users.password:update":    accesscontrol.ActionUsersPasswordWrite,
		"users.permissions:update": accesscontrol.ActionUsersPermissionsWrite,
		"users.quotas:update":      accesscontrol.ActionUsersQuotasWrite,
		"teams.roles:list":         "teams.roles:read",
		"users.roles:list":         "users.roles:read",
		"users.authtoken:list":     accesscontrol.ActionUsersAuthTokenRead,
		"users.quotas:list":        accesscontrol.ActionUsersQuotasRead,
		"users.permissions:list":   "users.permissions:read",
		"alert.instances:update":   accesscontrol.ActionAlertingInstanceWrite,
		"alert.rules:update":       accesscontrol.ActionAlertingRuleWrite,
	}
