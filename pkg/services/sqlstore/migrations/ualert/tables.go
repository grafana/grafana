...
func AddTablesMigrations(mg *migrator.Migrator) {
	...
	mg.AddMigration("add column remote_alertmanager_uid in ngalert_configuration", migrator.NewAddColumnMigration(migrator.Table{Name: "ngalert_configuration"}, &migrator.Column{
		Name: "remote_alertmanager_uid", Type: migrator.DB_NVarchar, Length: UIDMaxLength, Nullable: true,
	}))
