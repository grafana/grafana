...
func AddAlertAdminConfigMigrations(mg *migrator.Migrator) {
	...
	mg.AddMigration("add column handling in ngalert_configuration", migrator.NewAddColumnMigration(adminConfiguration, &migrator.Column{
		Name: "handling", Type: migrator.DB_Int, Nullable: false, Default: "0",
	}))
}
