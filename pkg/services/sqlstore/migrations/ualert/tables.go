...
func AddTablesMigrations(mg *migrator.Migrator) {
	...
	mg.AddMigration("add column reject_alerts_without_descriptions in ngalert_configuration", migrator.NewAddColumnMigration(migrator.Table{Name: "ngalert_configuration"}, &migrator.Column{
		Name: "reject_alerts_without_descriptions", Type: migrator.DB_Bool, Nullable: true,
	}))
