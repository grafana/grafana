...
func AddAlertAdminConfigMigrations(mg *migrator.Migrator) {
	...
	mg.AddMigration("add column alertmanagers_choice in ngalert_configuration", migrator.NewAddColumnMigration(adminConfiguration, &migrator.Column{
		Name: "alertmanagers_choice", Type: migrator.DB_Int, Nullable: false, Default: "0",
	}))
}
