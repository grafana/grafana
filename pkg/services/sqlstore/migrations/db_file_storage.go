...
func convertFilePathHashIndexToPrimaryKey(mg *migrator.Migrator) {
	...
	deleteAutogeneratedPK := migrator.NewRawSQLMigration("")
	if deleteAutogeneratedIds(mg) {
		deleteAutogeneratedPK.Mysql(`ALTER TABLE file DROP PRIMARY KEY;`)
	}
	mg.AddMigration("drop auto-generated primary key for file table", deleteAutogeneratedPK)
...
func convertFileMetaPathHashKeyIndexToPrimaryKey(mg *migrator.Migrator) {
	...
	deleteAutogeneratedPK := migrator.NewRawSQLMigration("")
	if deleteAutogeneratedIds(mg) {
		deleteAutogeneratedPK.Mysql(`ALTER TABLE file_meta DROP PRIMARY KEY;`)
	}

	mg.AddMigration("drop auto-generated primary key for file_meta table", deleteAutogeneratedPK)
