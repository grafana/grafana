...
func convertFilePathHashIndexToPrimaryKey(mg *migrator.Migrator) {
	...
	migration1 := migrator.NewRawSQLMigration("").
		Mysql(mysqlWithoutAutogeneratedPKs).
		Postgres(postgres).
		SQLite(sqlite)

	migration1.Condition = &migrator.IfColumnNotExistsCondition{TableName: "file", ColumnName: "my_row_id"}
	mg.AddMigration("add primary key to file table (without auto-generated primary key)", migration1)

	migration2 := migrator.NewRawSQLMigration("").
		Mysql(mysqlWithAutogeneratedPKs).
		Postgres(postgres).
		SQLite(sqlite)

	migration2.Condition = &migrator.IfColumnExistsCondition{TableName: "file", ColumnName: "my_row_id"}
	mg.AddMigration("add primary key to file table (with auto-generated primary key)", migration2)
}
...
func convertFileMetaPathHashKeyIndexToPrimaryKey(mg *migrator.Migrator) {
	...
	migration1.Condition = &migrator.IfColumnNotExistsCondition{TableName: "file_meta", ColumnName: "my_row_id"}
	mg.AddMigration("add primary key to file_meta table (without auto-generated primary key)", migration1)
	...
	migration2.Condition = &migrator.IfColumnExistsCondition{TableName: "file_meta", ColumnName: "my_row_id"}
	mg.AddMigration("add primary key to file_meta table (with auto-generated primary key)", migration2)
}
