...
CREATE TABLE `cloud_migration_snapshot_partition` (
  ...
  `data` longblob NOT NULL,
  UNIQUE KEY `UQE_cloud_migration_snapshot_partition_srp_unique` (`snapshot_uid`,`resource_type`,`partition_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `secret_encrypted_value` (
  ...
  UNIQUE KEY `UQE_secret_encrypted_value_namespace_name_version` (`namespace`,`name`,`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
