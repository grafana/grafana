...
func New(cfg *setting.Cfg, encryption encryption.Internal) secrets.Provider { //nolint:staticcheck // SA1019: Legacy envelope encryption stack for core Grafana wiring.
