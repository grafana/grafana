...
func (s *Service) AddDataSource(ictx context.Context, cmd *models.AddDataSourceCommand) error {
	return s.SQLStore.InTransaction(ictx, func(ctx context.Context) error {
		var err error
