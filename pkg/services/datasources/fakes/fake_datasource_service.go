...
func (s *FakeDataSourceService) UpdateDataSourceLBACRules(ctx context.Context, cmd *datasources.UpdateDataSourceLBACRulesCommand) (*datasources.DataSource, error) {
	return nil, nil
}
