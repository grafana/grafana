...
func (s *Service) handleList(ctx *model.ReqContext) response.Response {
...
func (s *Service) handleCreate(ctx *model.ReqContext) response.Response {
	type command struct {
...
func (s *Service) handleDownload(ctx *model.ReqContext) response.Response {
...
func (s *Service) handleRemove(ctx *model.ReqContext) response.Response {
	uid := web.Params(ctx.Req)[":uid"]
...
func (s *Service) handleGetCollectors(ctx *model.ReqContext) response.Response {
