...
type DashboardProvisionerFactory func(context.Context, string, dashboards.Store, accesscontrol.PermissionsServices) (DashboardProvisioner, error)
...
func New(ctx context.Context, configDirectory string, store dashboards.Store, permissionsServices accesscontrol.PermissionsServices) (DashboardProvisioner, error) {
	...
	fileReaders, err := getFileReaders(configs, logger, store, permissionsServices)
	if err != nil {
...
func getFileReaders(configs []*config, logger log.Logger, store dashboards.Store, permissionsServices accesscontrol.PermissionsServices) ([]*FileReader, error) {
