...
func ProvideService(cfg *setting.Cfg, sqlStore *sqlstore.SQLStore, pluginRegistry plugifaces.PublicRegistry,
...
func newProvisioningServiceImpl(
	...
	provisionPlugins func(context.Context, string, plugins.Store, plugifaces.PublicRegistry, pluginsettings.Service) error,
...
type ProvisioningServiceImpl struct {
	...
	pluginRegistry          plugifaces.PublicRegistry
...
func (ps *ProvisioningServiceImpl) ProvisionPlugins(ctx context.Context) error {
	...
	if err := ps.provisionPlugins(ctx, appPath, ps.SQLStore, ps.pluginRegistry, ps.pluginsSettings); err != nil {
