...
func (mock *ProvisioningServiceMock) ProvisionApps() error {
	mock.Calls.ProvisionApps = append(mock.Calls.ProvisionApps, nil)
	if mock.ProvisionAppsFunc != nil {
		return mock.ProvisionAppsFunc()
	}
	return nil
}
