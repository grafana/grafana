	...
	t.Run("Plugin sources are added in order", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				l := &pluginpluginfakes.FakeLoader{
				...
				srcs := &pluginpluginfakes.FakeSourceRegistry{ListFunc: func(_ context.Context) []plugins.PluginSource {
					return []plugins.PluginSource{
						&pluginpluginfakes.FakePluginSource{
				...
				service, err := ProvideService(pluginpluginfakes.NewFakePluginRegistry(), srcs, l, features)
