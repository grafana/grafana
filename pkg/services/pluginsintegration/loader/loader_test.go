...
func TestLoader_Load(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			cfg:         &config.PluginManagementCfg{},
			pluginPaths: []string{filepath.Join(corePluginDir(t), "app/plugins/datasource/grafana-postgresql-datasource")},
			want: []*plugins.Plugin{
				{
					...
					FS:              mustNewStaticFSForTests(t, filepath.Join(corePluginDir(t), "app/plugins/datasource/grafana-postgresql-datasource")),
					Module:          "core:plugin/grafana-postgresql-datasource",
