...
func ExternalServiceRegistrationStep(cfg *config.PluginsCfg, externalServiceRegistry auth.ExternalServiceRegistry) initialization.InitializeFunc {
	return newExternalServiceRegistration(cfg, externalServiceRegistry).Register
}

func newExternalServiceRegistration(cfg *config.PluginsCfg, serviceRegistry auth.ExternalServiceRegistry) *ExternalServiceRegistration {
...
func NewDisablePluginsStep(cfg *config.PluginsCfg) *DisablePlugins {
...
// NewDisablePluginsStep returns a new DisablePlugins.
func NewAsExternalStep(cfg *config.PluginsCfg) *AsExternal {
	return &AsExternal{
		cfg: cfg,
