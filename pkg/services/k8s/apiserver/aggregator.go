...
func createAggregatorConfig(
	...
	genericConfig := *apiConfig.Config
	...
	etcdOptions := *apiConfig.EtcdOptions
	...
	if err := apiConfig.APIEnablement.ApplyTo(
		&genericConfig,
	...
	aggregatorConfig := &aggregatorapiserver.Config{
		GenericConfig: &genericapiserver.RecommendedConfig{
			...
			SharedInformerFactory: apiConfig.SharedInformers,
		},
		ExtraConfig: aggregatorapiserver.ExtraConfig{
			ServiceResolver:           apiConfig.ServiceResolver,
			ProxyTransport:            apiConfig.ProxyTransport,
			RejectForwardingRedirects: false,
		},
	}

	aggregatorConfig.GenericConfig.SecureServing = nil
	aggregatorConfig.GenericConfig.ExternalAddress = apiConfig.Config.ExternalAddress
	aggregatorConfig.GenericConfig.LoopbackClientConfig = apiConfig.Config.LoopbackClientConfig
