...
func k8sDashboardToDashboardDTO(dash *Dashboard) (*dashboards.SaveDashboardDTO, error) {
...
func parseAnnotations(dash *Dashboard, dto dashboards.SaveDashboardDTO) dashboards.SaveDashboardDTO {
