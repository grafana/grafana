...
func (crd Kind) GVR() k8schema.GroupVersionResource {
	gvk := crd.GVK()
	return k8schema.GroupVersionResource{
		Group:    gvk.Group,
		Version:  gvk.Version,
		Resource: crd.GrafanaKind.Props().(kindsys.CoreProperties).PluralMachineName,
	}
}
