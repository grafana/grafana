...
//nolint: gocyclo
func (s *queryReducer) Reduce(series pluginmodels.DataTimeSeries) null.Float {
...
func calculateDiff(series pluginmodels.DataTimeSeries, allNull bool, value float64, fn func(float64, float64) float64) (bool, float64) {
	var (
		points = series.Points
		first  float64
		i      int
