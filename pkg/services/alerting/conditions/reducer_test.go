...
func TestSimpleReducer(t *testing.T) {
	Convey("Test simple reducer by calculating", t, func() {
		...
		Convey("median should ignore null values", func() {
			...
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(1)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(2)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(3)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(float64(1)), null.FloatFrom(4)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(float64(2)), null.FloatFrom(5)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(float64(3)), null.FloatFrom(6)})
		...
		Convey("count_non_null", func() {
			Convey("with null values and real values", func() {
				...
				series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(1)})
				series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(2)})
				series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(3), null.FloatFrom(3)})
				series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(3), null.FloatFrom(4)})
		...
		Convey("avg of number values and null values should ignore nulls", func() {
			...
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(3), null.FloatFrom(1)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(2)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFromPtr(nil), null.FloatFrom(3)})
			series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(3), null.FloatFrom(4)})
...
func testReducer(reducerType string, datapoints ...float64) float64 {
	...
	for idx := range datapoints {
		series.Points = append(series.Points, pluginmodels.DataTimePoint{null.FloatFrom(datapoints[idx]), null.FloatFrom(1234134)})
	}
