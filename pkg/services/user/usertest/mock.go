...
import (
	...
	v0alpha1 "github.com/grafana/grafana/pkg/apimachinery/apis/identity/v0alpha1"
)
...
// GetDisplay provides a mock function with given fields: _a0, _a1
func (_m *MockService) GetDisplay(_a0 context.Context, _a1 *user.GetDisplayCommand) ([]v0alpha1.IdentityDisplay, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for GetDisplay")
	}

	var r0 []v0alpha1.IdentityDisplay
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *user.GetDisplayCommand) ([]v0alpha1.IdentityDisplay, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *user.GetDisplayCommand) []v0alpha1.IdentityDisplay); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]v0alpha1.IdentityDisplay)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *user.GetDisplayCommand) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
