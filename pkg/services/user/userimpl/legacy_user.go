...
func (s *LegacyService) GetUsageStats(ctx context.Context) map[string]any {
...
func (s *LegacyService) ListByIdOrUID(ctx context.Context, uids []string, ids []int64) ([]*user.User, error) {
...
func (s *LegacyService) shouldUpdateLastSeen(t time.Time) bool {
...
func (s *LegacyService) supportBundleCollector() supportbundles.Collector {
...
func (s *LegacyService) usage(ctx context.Context, _ *quota.ScopeParameters) (*quota.Map, error) {
	u := &quota.Map{}
