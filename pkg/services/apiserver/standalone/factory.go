...
type APIServerFactory interface {
	...
	GetDefaultBuildHandlerChainFunc(tracer tracing.Tracer, builders []builder.APIGroupBuilder) builder.BuildHandlerChainFunc
...
func (p *DummyAPIFactory) GetDefaultBuildHandlerChainFunc(_ tracing.Tracer, builders []builder.APIGroupBuilder) builder.BuildHandlerChainFunc {
	return nil
}
