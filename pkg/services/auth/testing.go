...
type FakeUserAuthTokenService struct {
	CreateTokenProvider         func(c *models.ReqContext, user *models.User) (*models.UserToken, error)
...
func (s *FakeUserAuthTokenService) CreateToken(c *models.ReqContext, user *models.User) (*models.UserToken, error) {
	return s.CreateTokenProvider(c, user)
}
