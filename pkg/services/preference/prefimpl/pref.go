...
func NewPreferenceStore(cfg *setting.Cfg, sqlStore sqlstore.Store) Store {
	return &Service{
		sqlStore: sqlStore,
		cfg:      cfg,
	}
...
func (s *Service) List(ctx context.Context, query *models.ListPreferencesQuery) ([]*models.Preferences, error) {
...
func (s *Service) GetDefaults() *models.Preferences {
...
func (s *Service) Get(ctx context.Context, query *models.GetPreferencesQuery) (*models.Preferences, error) {
...
func (s *Service) Set(ctx context.Context, cmd *models.SavePreferencesCommand) (*models.Preferences, error) {
	var prefs models.Preferences
