...
var themes = []ThemeDTO{
	...
	{ID: "catppuccin_frappe", Type: "dark", IsExtra: true},
	{ID: "catppuccin_latte", Type: "light", IsExtra: true},
	{ID: "catppuccin_macchiato", Type: "dark", IsExtra: true},
	{ID: "catppuccin_mocha", Type: "dark", IsExtra: true},
