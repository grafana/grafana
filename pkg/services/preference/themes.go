...
var themes = []ThemeDTO{
	...
	{ID: "grafana12dark", Type: "dark", IsExtra: true},
	{ID: "grafana12light", Type: "light", IsExtra: true},
	{ID: "grafanacon", Type: "dark", IsExtra: true},
	{ID: "greengold", Type: "dark", IsExtra: true},
