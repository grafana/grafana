...
func (s *Service) IsValidThemeID(ctx context.Context, orgID int64, id string) bool {
	...
	// Slow path: check custom themes via theme app (covers both global and user themes)
	return s.getTheme(ctx, orgID, id) != nil
}
...
func (s *Service) GetThemeByID(ctx context.Context, orgID int64, id string) *pref.ThemeDTO {
	...
	// Slow path: fetch from theme app (covers both global and user themes)
	return s.getTheme(ctx, orgID, id)
}

func (s *Service) getTheme(ctx context.Context, orgID int64, id string) *pref.ThemeDTO {
