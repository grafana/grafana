...
type Service interface {
	...
	Upsert(ctx context.Context, provider string, data interface{}) error
...
type Store interface {
	Get(ctx context.Context, provider string) (*models.SSOSettingsDb, error)
	List(ctx context.Context) ([]*models.SSOSettingsDb, error)
	Upsert(ctx context.Context, provider string, data interface{}) error
	Patch(ctx context.Context, provider string, data map[string]interface{}) error
	Delete(ctx context.Context, provider string) error
}
