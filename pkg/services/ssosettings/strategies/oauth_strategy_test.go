...
func TestParseConfigFromSystem_EnvVarsOnly(t *testing.T) {
	...
	require.Equal(t, expectedKVs, result)
...
func TestParseConfigFromSystem_EnvVarsWithIniFile(t *testing.T) {
	...
	expectedWithOverrides := expectedKVs
	expectedWithOverrides["enabled"] = "false"
	expectedWithOverrides["skip_org_role_sync"] = "false"

	require.Equal(t, expectedWithOverrides, result)
