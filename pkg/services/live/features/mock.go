...
// Source: github.com/grafana/grafana/pkg/services/live/features (interfaces: StreamPacketSender,PresenceGetter,PluginContextGetter,StreamRunner,SchemaCache)
...
// MockSchemaCache is a mock of SchemaCache interface.
type MockSchemaCache struct {
	ctrl     *gomock.Controller
	recorder *MockSchemaCacheMockRecorder
}

// MockSchemaCacheMockRecorder is the mock recorder for MockSchemaCache.
type MockSchemaCacheMockRecorder struct {
	mock *MockSchemaCache
}

// NewMockSchemaCache creates a new mock instance.
func NewMockSchemaCache(ctrl *gomock.Controller) *MockSchemaCache {
	mock := &MockSchemaCache{ctrl: ctrl}
	mock.recorder = &MockSchemaCacheMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSchemaCache) EXPECT() *MockSchemaCacheMockRecorder {
	return m.recorder
}

// Delete mocks base method.
func (m *MockSchemaCache) Delete(arg0 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockSchemaCacheMockRecorder) Delete(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockSchemaCache)(nil).Delete), arg0)
}

// Get mocks base method.
func (m *MockSchemaCache) Get(arg0 string) (json.RawMessage, bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSchemaCacheMockRecorder) Get(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockSchemaCache)(nil).Get), arg0)
}

// Update mocks base method.
func (m *MockSchemaCache) Update(arg0 string, arg1 json.RawMessage) error {
	m.ctrl.T.Helper()
...
func (mr *MockSchemaCacheMockRecorder) Update(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockSchemaCache)(nil).Update), arg0, arg1)
}
