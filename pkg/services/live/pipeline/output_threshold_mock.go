...
// Source: github.com/grafana/grafana/pkg/services/live/pipeline (interfaces: FrameGetSetter,FrameProcessor)
...
// MockFrameProcessor is a mock of FrameProcessor interface.
type MockFrameProcessor struct {
	ctrl     *gomock.Controller
	recorder *MockFrameProcessorMockRecorder
}

// MockFrameProcessorMockRecorder is the mock recorder for MockFrameProcessor.
type MockFrameProcessorMockRecorder struct {
	mock *MockFrameProcessor
}

// NewMockFrameProcessor creates a new mock instance.
func NewMockFrameProcessor(ctrl *gomock.Controller) *MockFrameProcessor {
	mock := &MockFrameProcessor{ctrl: ctrl}
	mock.recorder = &MockFrameProcessorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFrameProcessor) EXPECT() *MockFrameProcessorMockRecorder {
	return m.recorder
}

// ProcessFrame mocks base method.
func (m *MockFrameProcessor) ProcessFrame(arg0 context.Context, arg1 int64, arg2 string, arg3 *data.Frame) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessFrame", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// ProcessFrame indicates an expected call of ProcessFrame.
func (mr *MockFrameProcessorMockRecorder) ProcessFrame(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessFrame", reflect.TypeOf((*MockFrameProcessor)(nil).ProcessFrame), arg0, arg1, arg2, arg3)
}
