...
var (
	...
	ErrCannotDeleteThreadForbidden = errors.New("only the author or an admin can delete a thread")
	ErrCannotCloseThreadForbidden  = errors.New("only the author or an admin can close a thread")
	ErrCannotReopenThreadForbidden = errors.New("only an admin can reopen a thread")
