...
func (s *ServiceImpl) addAppLinks(treeRoot *navtree.NavTreeRoot, c *model.ReqContext) error {
...
func (s *ServiceImpl) processAppPlugin(plugin plugins.PluginDTO, c *model.ReqContext, topNavEnabled bool, treeRoot *navtree.NavTreeRoot) *navtree.NavLink {
...
func (s *ServiceImpl) addPluginToSection(c *model.ReqContext, treeRoot *navtree.NavTreeRoot, plugin plugins.PluginDTO, appLink *navtree.NavLink) {
...
func (s *ServiceImpl) hasAccessToInclude(c *model.ReqContext, pluginID string) func(include *plugins.Includes) bool {
	hasAccess := ac.HasAccess(s.accessControl, c)
