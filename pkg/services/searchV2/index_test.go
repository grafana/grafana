...
//
//func initTestIndexFromDashes(t *testing.T, dashboards []dashboard) (*searchIndex, *bluge.Reader, *bluge.Writer) {
//	t.Helper()
//	return initTestIndexFromDashesExtended(t, dashboards, &NoopDocumentExtender{})
//}
//
//func initTestIndexFromDashesExtended(t *testing.T, dashboards []dashboard, extender DocumentExtender) (*searchIndex, *bluge.Reader, *bluge.Writer) {
//	t.Helper()
