...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts server.Options, apiOpts api.ServerOptions) (*server.Server, error) {
	...
	folderAPIBuilder := folders.RegisterAPIService(cfg, featureToggles, apiserverService, folderPermissionsService, accessClient, userPermissionsClient, registerer, resourceClient, zanzanaClient, eventualRestConfigProvider, contentsCleaner)
