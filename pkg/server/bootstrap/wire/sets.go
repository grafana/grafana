...
// Core Wire provider sets shared by OSS and Enterprise builds.
// Edition-specific bindings live in pkg/server/wireext (OSS) or wireexts_enterprise.go (overlay).
package wire
...
var Basic = wire.NewSet(
	...
	server.ProvideMigrationRegistry,
