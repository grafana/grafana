...
var wireExtsBasicSet = wire.NewSet(
	...
	wire.FieldsOf(new(*resource.Client), "StorageClient", "SearchClient", "QuotaClient"),
	wire.Bind(new(resource.MigratorClient), new(*resource.Client)),
	wire.Bind(new(resource.DiagnosticsClient), new(*resource.Client)),
