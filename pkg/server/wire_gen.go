...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	dataSourceMigrator := migrator5.ProvideDataSourceMigrator(service14, inlineSecureValueSupport)
	...
	migrationRegistry := provideMigrationRegistry(foldersDashboardsMigrator, playlistMigrator, shortURLMigrator, snapshotMigrator, dataSourceMigrator, starsMigrator, queryCacheConfigMigrator)
