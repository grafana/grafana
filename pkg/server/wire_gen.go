...
import (
	...
	client2 "github.com/grafana/grafana/pkg/services/datasources/service/client"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	dataSourceConnectionClientFactory := client2.ProvideDataSourceConnectionClientFactory(eventualRestConfigProvider)
	collectionsAPIBuilder := collections.RegisterAPIService(cfg, featureToggles, sqlStore, starService, userService, apiserverService, dataSourceConnectionClientFactory, eventualRestConfigProvider)
