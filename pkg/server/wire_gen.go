...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	migrationRegistry := provideMigrationRegistry(foldersDashboardsMigrator, playlistMigrator, shortURLMigrator, snapshotMigrator, dataSourceMigrator, starsMigrator, preferencesMigrator, queryCacheConfigMigrator, correlationMigrator)
...
func provideMigrationRegistry(
	...
	correlationMigrator migrator7.CorrelationMigrator,
	...
	r.Register(correlations2.CorrelationMigration(correlationMigrator))
	return r
}
