...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	tokenExchangeMiddleware, err := middleware.ProvideTokenExchangeMiddleware(cfg)
	if err != nil {
		return nil, err
	}
	openFeatureService, err := featuremgmt.ProvideOpenFeatureService(cfg, httpclientProvider, tokenExchangeMiddleware)
	if err != nil {
		return nil, err
	}
