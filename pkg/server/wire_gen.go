...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	folderAPIBuilder := folders.RegisterAPIService(cfg, featureToggles, apiserverService, accessClient, folderimplService, folderPermissionsService, accessControl, acimplService, registerer, resourceClient)
