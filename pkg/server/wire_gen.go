...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	inlineSecureValueSupport := service5.ProvideInlineSecureValueService(tracer, secureValueService, accessClient)
