...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	natsService, err := nats.ProvideService(cfg, sqlStore)
	if err != nil {
		return nil, err
	}
	clientProvider := nats.ProvideClientProvider(natsService)
