...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	cloudAccessPolicyTokenSignerMiddlewareProvider, err := middleware.ProvideCloudAccessPolicyTokenSignerMiddlewareProvider(cfg)
	if err != nil {
		return nil, err
	}
