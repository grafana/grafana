...
import (
	...
	httpclient2 "github.com/grafana/grafana/pkg/infra/httpclient"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	graphiteService := provideGraphiteService(httpclientProvider, tracer, cfg)
	...
	corepluginRegistry := coreplugin.ProvideCoreRegistry(tracer, azuremonitorService, cloudwatchService, graphiteService, influxdbService, lokiService, prometheusService, testdatasourceService, postgresService, mysqlService, mssqlService, grafanadsService, pyroscopeService, parcaService, jaegerService)
...
func provideGraphiteService(httpClientProvider *httpclient.Provider, tracer trace.Tracer, cfg *setting.Cfg) *graphite.Service {
