...
func Initialize(cla setting.CommandLineArgs, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	tsdbService := tsdb.NewService(cfg, pluginManager, managerManager, service, provider, cloudmonitoringService, postgresService)
	alertEngine := alerting.ProvideAlertEngine(renderingService, inProcBus, ossPluginRequestValidator, tsdbService, cfg)
	usageStatsService := usagestats.ProvideService(cfg, inProcBus, sqlStore, alertEngine, pluginManager, socialService)
	...
	implementation := authinfoservice.ProvideAuthInfoService(inProcBus, sqlStore, ossUserProtectionImpl)
	...
	alertNG, err := ngalert.ProvideService(cfg, cacheServiceImpl, routeRegisterImpl, sqlStore, tsdbService, dataSourceProxyService, quotaService, metricsMetrics)
	if err != nil {
		return nil, err
	}
