...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	serviceFolderConsumer := service7.ProvideFolderConsumer(dashboardServiceImpl)
	asyncReconciler := folderreconcile.ProvideAsyncReconciler(cfg, resourceClient, eventualRestConfigProvider, orgService, alertRuleFolderConsumer, folderConsumer, serviceFolderConsumer)
