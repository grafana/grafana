...
import (
	...
	migrator3 "github.com/grafana/grafana/pkg/services/secrets/migrator"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	migrationRegistry := provideMigrationRegistry(foldersDashboardsMigrator, playlistMigrator)
	...
	secretsMigrator := migrator3.ProvideSecretsMigrator(serviceService, secretsService, sqlStore, ossImpl, featureToggles)
