...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	config := provideGraphiteConfig(cfg)
	graphiteService := graphite.ProvideService(config, httpclientProvider, tracer)
