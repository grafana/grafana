...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	passkeyStore := passkeyimpl.ProvideStore(sqlStore)
	passkeyimplService, err := passkeyimpl.ProvideService(cfg, passkeyStore, remoteCache, registerer)
	if err != nil {
		return nil, err
	}
