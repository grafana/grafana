...
import (
	...
	migrator6 "github.com/grafana/grafana/pkg/registry/apps/correlations/migrator"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	correlationsMigrator := migrator6.ProvideCorrelationsMigrator(legacyDatabaseProvider)
	migrationRegistry := provideMigrationRegistry(foldersDashboardsMigrator, playlistMigrator, shortURLMigrator, dataSourceMigrator, starsMigrator, preferencesMigrator, queryCacheConfigMigrator, correlationsMigrator)
	...
	natsService, err := nats.ProvideService(cfg, sqlStore, registerer)
	if err != nil {
		return nil, err
	}
...
func provideMigrationRegistry(
	...
	correlationsMigrator migrator6.CorrelationsMigrator,
	...
	r.Register(correlations2.CorrelationsMigration(correlationsMigrator))
	return r
}
