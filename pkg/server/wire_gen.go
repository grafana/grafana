...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	inlineSecureValueStore, err := metadata.ProvideInlineSecureValueStore(secureValueMetadataStorage, accessClient)
	if err != nil {
		return nil, err
	}
