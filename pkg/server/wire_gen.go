...
func InitializeForCLI(ctx context.Context, cfg *setting.Cfg) (Runner, error) {
	...
	consolidationHistoryStorage, err := metadata.ProvideConsolidationHistoryStore(databaseDatabase, tracer, registerer)
	if err != nil {
		return Runner{}, err
	}
	consolidationService := service6.ProvideConsolidationService(tracer, globalDataKeyStorage, encryptedValueStorage, globalEncryptedValueStorage, encryptionManager, consolidationHistoryStorage)
