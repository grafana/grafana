...
import (
	...
	"github.com/grafana/grafana/pkg/services/passkey/passkeyimpl"
...
var wireBasicSet = wire.NewSet(
	...
	passkeyimpl.ProvideStore,
	passkeyimpl.ProvideService,
	wire.Bind(new(passkey.Service), new(*passkeyimpl.Service)),
