...
var wireBasicSet = wire.NewSet(
	...
	wire.Bind(new(publicdashboards.Service), new(*publicdashboards.PublicDashboardServiceImpl)),
	publicdashboards.ProvideStore,
	wire.Bind(new(publicdashboards.Store), new(*publicdashboards.PublicDashboardStoreImpl)),
