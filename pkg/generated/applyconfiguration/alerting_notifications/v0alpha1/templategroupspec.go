...
// TemplateGroupSpecApplyConfiguration represents an declarative configuration of the TemplateGroupSpec type for use
// with apply.
...
// TemplateGroupSpecApplyConfiguration constructs an declarative configuration of the TemplateGroupSpec type for use with
// apply.
