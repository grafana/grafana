...
type Interface interface {
	...
	PeakqV0alpha1() peakqv0alpha1.PeakqV0alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	peakqV0alpha1   *peakqv0alpha1.PeakqV0alpha1Client
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.peakqV0alpha1, err = peakqv0alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.peakqV0alpha1 = peakqv0alpha1.New(c)
