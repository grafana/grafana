...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v0alpha1.SchemeGroupVersion.WithResource("querytemplates"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Peakq().V0alpha1().QueryTemplates().Informer()}, nil
