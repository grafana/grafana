...
// TSOldResourceJenny is a [OneToOne] that produces TypeScript types and
...
type TSOldResourceJenny struct{}

var _ codejen.OneToOne[SchemaForGen] = &TSOldResourceJenny{}

func (j TSOldResourceJenny) JennyName() string {
	return "TSOldResourceJenny"
}

func (j TSOldResourceJenny) Generate(sfg SchemaForGen) (*codejen.File, error) {
