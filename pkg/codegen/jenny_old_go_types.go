...
// [thema.Schema].
type GoOldTypesJenny struct {
	ApplyFuncs       []dstutil.ApplyFunc
	ExpandReferences bool
}

func (j GoOldTypesJenny) JennyName() string {
	return "GoOldTypesJenny"
}

func (j GoOldTypesJenny) Generate(sfg SchemaForGen) (*codejen.File, error) {
