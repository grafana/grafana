...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Backend)(nil), (*aggregation.Backend)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v0alpha1_Backend_To_aggregation_Backend(a.(*Backend), b.(*aggregation.Backend), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aggregation.Backend)(nil), (*Backend)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aggregation_Backend_To_v0alpha1_Backend(a.(*aggregation.Backend), b.(*Backend), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v0alpha1_Backend_To_aggregation_Backend(in *Backend, out *aggregation.Backend, s conversion.Scope) error {
	out.Type = aggregation.BackendType(in.Type)
...
// Convert_v0alpha1_Backend_To_aggregation_Backend is an autogenerated conversion function.
func Convert_v0alpha1_Backend_To_aggregation_Backend(in *Backend, out *aggregation.Backend, s conversion.Scope) error {
	return autoConvert_v0alpha1_Backend_To_aggregation_Backend(in, out, s)
}

func autoConvert_aggregation_Backend_To_v0alpha1_Backend(in *aggregation.Backend, out *Backend, s conversion.Scope) error {
	out.Type = BackendType(in.Type)
	out.PluginID = in.PluginID
...
// Convert_aggregation_Backend_To_v0alpha1_Backend is an autogenerated conversion function.
func Convert_aggregation_Backend_To_v0alpha1_Backend(in *aggregation.Backend, out *Backend, s conversion.Scope) error {
	return autoConvert_aggregation_Backend_To_v0alpha1_Backend(in, out, s)
}
...
func autoConvert_v0alpha1_DataPlaneServiceSpec_To_aggregation_DataPlaneServiceSpec(in *DataPlaneServiceSpec, out *aggregation.DataPlaneServiceSpec, s conversion.Scope) error {
	...
	if err := Convert_v0alpha1_Backend_To_aggregation_Backend(&in.Backend, &out.Backend, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_aggregation_DataPlaneServiceSpec_To_v0alpha1_DataPlaneServiceSpec(in *aggregation.DataPlaneServiceSpec, out *DataPlaneServiceSpec, s conversion.Scope) error {
	...
	if err := Convert_aggregation_Backend_To_v0alpha1_Backend(&in.Backend, &out.Backend, s); err != nil {
		return err
	}
	return nil
}
