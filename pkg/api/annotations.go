...
func AnnotationTypeScopeResolver(annotationsRepo annotations.Repository, features featuremgmt.FeatureToggles, dashSvc dashboards.DashboardService, folderSvc folder.Service, folderStore folder.Store) (string, accesscontrol.ScopeAttributeResolver) {
