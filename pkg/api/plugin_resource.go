...
func (hs *HTTPServer) CallResource(c *model.ReqContext) {
	hs.callPluginResource(c, web.Params(c.Req)[":pluginId"])
}

func (hs *HTTPServer) callPluginResource(c *model.ReqContext, pluginID string) {
...
func (hs *HTTPServer) callPluginResourceWithDataSource(c *model.ReqContext, pluginID string, ds *datasources.DataSource) {
...
func (hs *HTTPServer) pluginResourceRequest(c *model.ReqContext) (*http.Request, error) {
...
func handleCallResourceError(err error, reqCtx *model.ReqContext) {
