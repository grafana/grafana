...
func (hs *HTTPServer) AdminProvisioningReloadDashboards(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) AdminProvisioningReloadDatasources(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) AdminProvisioningReloadPlugins(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) AdminProvisioningReloadNotifications(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) AdminProvisioningReloadAlerting(c *model.ReqContext) response.Response {
