...
func (r *NormalResponse) WriteTo(ctx *model.ReqContext) {
	if r.err != nil {
...
// Required to implement api.Response.
func (r StreamingResponse) WriteTo(ctx *model.ReqContext) {
	header := ctx.Resp.Header()
	for k, v := range r.header {
		header[k] = v
	}
...
func (r *RedirectResponse) WriteTo(ctx *model.ReqContext) {
