	...
	teamsWriterRole := accesscontrol.RoleRegistration{
		Role: accesscontrol.RoleDTO{
			...
			Permissions: []accesscontrol.Permission{
				...
				{Action: accesscontrol.ActionTeamGroupsRead, Scope: accesscontrol.ScopeTeamsAll},
				{Action: accesscontrol.ActionTeamGroupsUpdate, Scope: accesscontrol.ScopeTeamsAll},
				{Action: accesscontrol.ActionTeamGroupsDelete, Scope: accesscontrol.ScopeTeamsAll},
			},
		},
		Grants: []string{string(models.ROLE_ADMIN)},
	}
