...
func (hs *HTTPServer) ProxyPluginRequest(c *contextmodel.ReqContext) {
	...
	p, err := pluginproxy.NewPluginProxy(ps, plugin.Routes, c, proxyPath, hs.permRegistry, hs.Cfg, hs.SecretsService, hs.tracer, pluginProxyTransport, hs.AccessControl, hs.Features)
	if err != nil {
