...
func (hs *HTTPServer) getFrontendSettings(c *contextmodel.ReqContext) (*dtos.FrontendSettingsDTO, error) {
	...
	frontendSettings := &dtos.FrontendSettingsDTO{
		...
		RendererImageWidth:               hs.Cfg.RendererDefaultImageWidth,
		RendererImageHeight:              hs.Cfg.RendererDefaultImageHeight,
		RendererImageScale:               hs.Cfg.RendererDefaultImageScale,
