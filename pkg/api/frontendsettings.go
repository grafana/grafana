...
func (hs *HTTPServer) GetFrontendSettings(c *model.ReqContext) {
...
func (hs *HTTPServer) getFrontendSettingsMap(c *model.ReqContext) (map[string]interface{}, error) {
...
func (hs *HTTPServer) getFSDataSources(c *model.ReqContext, enabledPlugins EnabledPlugins) (map[string]plugins.DataSourceDTO, error) {
