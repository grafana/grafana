...
import "github.com/grafana/grafana/pkg/services/contexthandler/model"
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) ProxyDataSourceRequest(c *model.ReqContext) {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) ProxyDataSourceRequestWithUID(c *model.ReqContext) {
