...
func GetSignUpOptions(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) SignUp(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) SignUpStep2(c *model.ReqContext) response.Response {
