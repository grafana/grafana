...
func TestHTTPServer_GetFrontendSettings_pluginLogos(t *testing.T) {
	type settings struct {
		PluginLogos map[string]plugins.Logos `json:"pluginLogos"`
	}
	...
	tests := []struct {
	...
	}{
		{
					...
					PluginList: []pluginstore.Plugin{
						{
							...
							JSONData: plugins.JSONData{
								ID: "test-app",
								Info: plugins.Info{Version: "0.5.0", Logos: plugins.Logos{
									Small: "test-app-logo-small",
									Large: "test-app-logo-large"},
								},
								Type:    plugins.TypeApp,
								Preload: true,
							},
			...
			pluginAssets: newPluginAssets(),
			expected: settings{
				PluginLogos: map[string]plugins.Logos{
					"test-app": {Small: "test-app-logo-small", Large: "test-app-logo-large"},
				},
			},
		},
		{
			desc: "apps no small logos",
			pluginStore: func() pluginstore.Store {
				return &pluginstore.FakePluginStore{
					PluginList: []pluginstore.Plugin{
						{
							...
							JSONData: plugins.JSONData{
								ID:      "test-app",
								Info:    plugins.Info{Version: "0.5.0", Logos: plugins.Logos{Large: "test-app-logo-large"}},
								Type:    plugins.TypeApp,
								Preload: true,
							},
						},
			...
			expected: settings{
				PluginLogos: map[string]plugins.Logos{
					"test-app": {Large: "test-app-logo-large", Small: ""},
				},
			},
		},
		{
			desc: "apps, panels, datasources plugins logos",
			pluginStore: func() pluginstore.Store {
				return &pluginstore.FakePluginStore{
					PluginList: []pluginstore.Plugin{
						{
							...
							JSONData: plugins.JSONData{
								ID:      "test-app",
								Info:    plugins.Info{Version: "0.5.0", Logos: plugins.Logos{Small: "test-app-logo-small"}},
								Type:    plugins.TypeApp,
								Preload: true,
							},
						},
						{
							...
							JSONData: plugins.JSONData{
								ID:      "test-panel",
								Info:    plugins.Info{Version: "0.5.0", Logos: plugins.Logos{Small: "test-panel-logo-small"}},
						...
						},
						{
							...
							JSONData: plugins.JSONData{
								ID:      "test-ds",
								Info:    plugins.Info{Version: "0.5.0", Logos: plugins.Logos{Small: "test-ds-logo-small"}},
								Type:    plugins.TypePanel,
								Preload: true,
							},
						},
			...
			expected: settings{
				PluginLogos: map[string]plugins.Logos{
					"test-app":   {Small: "test-app-logo-small"},
					"test-panel": {Small: "test-panel-logo-small"},
					"test-ds":    {Small: "test-ds-logo-small"},
				},
			},
		},
	}
