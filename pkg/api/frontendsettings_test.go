...
func TestHTTPServer_GetFrontendSettings_frontendSandboxMonitorOnly(t *testing.T) {
	type settings struct {
	...
	tests := []struct {
		...
		{
			desc: "With frontendSandboxMonitorOnly",
			mutateCfg: func(cfg *setting.Cfg) {
				cfg.FrontendSandboxMonitorOnly = true
			},
			expected: settings{FrontendSandboxMonitorOnly: true},
		},
		{
			desc: "Without frontendSandboxMonitorOnly",
			mutateCfg: func(cfg *setting.Cfg) {
				cfg.FrontendSandboxMonitorOnly = false
			},
			expected: settings{FrontendSandboxMonitorOnly: false},
		},
		{
			desc:     "FrontendSandboxMonitorOnly not set. Default to false",
			expected: settings{FrontendSandboxMonitorOnly: false},
		},
	}
