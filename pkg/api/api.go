...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/org/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, "grafana:website:org:users"), hs.Index)
	...
	r.Get("/admin/users", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, "grafana:website:admin:users"), hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/users", func(usersRoute routing.RouteRegister) {
			...
			usersRoute.Get("/", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, "api:users:list"), routing.Wrap(SearchUsers))
			usersRoute.Get("/search", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, "api:users:search"), routing.Wrap(SearchUsersWithPaging))
			...
			usersRoute.Get("/lookup", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, "api:users:lookup"), routing.Wrap(GetUserByLoginOrEmail))
		...
		apiRoute.Group("/org", func(orgRoute routing.RouteRegister) {
			...
			orgRoute.Get("/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, "grafana:api:org:users"), routing.Wrap(hs.GetOrgUsersForCurrentOrg))
			orgRoute.Get("/users/search", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, "grafana:api:org:users:search"), routing.Wrap(hs.SearchOrgUsersWithPaging))
			orgRoute.Post("/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersAdd, "grafana:api:org:users"), quota("user"), bind(models.AddOrgUserCommand{}), routing.Wrap(AddOrgUserToCurrentOrg))
		...
		apiRoute.Group("/orgs/:orgId", func(orgsRoute routing.RouteRegister) {
			...
			orgsRoute.Get("/users", authorize(reqGrafanaAdmin, accesscontrol.ActionOrgUsersRead, "grafana:api:orgs:users"), routing.Wrap(hs.GetOrgUsers))
			orgsRoute.Post("/users", authorize(reqGrafanaAdmin, accesscontrol.ActionOrgUsersAdd, "grafana:api:orgs:users"), bind(models.AddOrgUserCommand{}), routing.Wrap(AddOrgUser))
