...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/org/librarycredentials/", reqOrgAdmin, hs.Index)
	r.Get("/org/librarycredentials/*", reqOrgAdmin, hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/datasources", func(datasourceRoute routing.RouteRegister) {
			...
			datasourceRoute.Get("/name/:name", authorize(reqOrgAdmin, ac.EvalPermission(ActionDatasourcesRead, ScopeDatasourceName)), routing.Wrap(hs.GetDataSourceByName))
		})
