...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/org/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, accesscontrol.ResourceScopeUsersAll), hs.Index)
	...
	r.Get("/admin/users", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, accesscontrol.ResourceScopeGlobalUsersAll), hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/users", func(usersRoute routing.RouteRegister) {
			...
			usersRoute.Get("/", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, accesscontrol.ResourceScopeGlobalUsersAll), routing.Wrap(SearchUsers))
			usersRoute.Get("/search", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, accesscontrol.ResourceScopeGlobalUsersAll), routing.Wrap(SearchUsersWithPaging))
			...
			usersRoute.Get("/lookup", authorize(reqGrafanaAdmin, accesscontrol.ActionUsersRead, accesscontrol.ResourceScopeGlobalUsersAll), routing.Wrap(GetUserByLoginOrEmail))
		...
		apiRoute.Group("/org", func(orgRoute routing.RouteRegister) {
			...
			orgRoute.Get("/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, accesscontrol.ResourceScopeUsersAll), routing.Wrap(hs.GetOrgUsersForCurrentOrg))
			orgRoute.Get("/users/search", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersRead, accesscontrol.ResourceScopeUsersAll), routing.Wrap(hs.SearchOrgUsersWithPaging))
			orgRoute.Post("/users", authorize(reqOrgAdmin, accesscontrol.ActionOrgUsersAdd, accesscontrol.ResourceScopeUsersAll), quota("user"), bind(models.AddOrgUserCommand{}), routing.Wrap(AddOrgUserToCurrentOrg))
		...
		apiRoute.Group("/orgs/:orgId", func(orgsRoute routing.RouteRegister) {
			...
			orgsRoute.Get("/users", authorize(reqGrafanaAdmin, accesscontrol.ActionOrgUsersRead, accesscontrol.ResourceScopeUsersAll), routing.Wrap(hs.GetOrgUsers))
			orgsRoute.Post("/users", authorize(reqGrafanaAdmin, accesscontrol.ActionOrgUsersAdd, accesscontrol.ResourceScopeUsersAll), bind(models.AddOrgUserCommand{}), routing.Wrap(AddOrgUser))
