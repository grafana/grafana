...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/admin/users/edit/:uid/:page", authorize(ac.EvalPermission(ac.ActionUsersRead)), hs.Index)
	r.Get("/admin/users/edit/:id", authorize(ac.EvalPermission(ac.ActionUsersRead)), hs.Index)
	r.Get("/admin/users/roles/:uid", authorize(ac.EvalPermission(ac.ActionUsersRead)), hs.Index)
