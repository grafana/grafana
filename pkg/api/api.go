...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/alerts", func(alertsRoute routing.RouteRegister) {
			...
			alertsRoute.Post("/:alertId/pause", reqEditorRole, routing.Wrap(hs.PauseAlert(hs.Cfg.UnifiedAlerting.IsEnabled())))
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Post("/pause-all-alerts", reqGrafanaAdmin, routing.Wrap(hs.PauseAllAlerts(hs.Cfg.UnifiedAlerting.IsEnabled())))
