...
func (hs *HTTPServer) isDashboardStarredByUser(c *model.ReqContext, dashID int64) (bool, error) {
	if !c.IsSignedIn {
		return false, nil
	}
...
func (hs *HTTPServer) TrimDashboard(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetDashboard(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) getAnnotationPermissionsByScope(c *model.ReqContext, actions *dtos.AnnotationActions, scope string) {
	var err error
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) DeleteDashboardByUID(c *model.ReqContext) response.Response {
	return hs.deleteDashboard(c)
}

func (hs *HTTPServer) deleteDashboard(c *model.ReqContext) response.Response {
...
// 500: internalServerError
func (hs *HTTPServer) PostDashboard(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) postDashboard(c *model.ReqContext, cmd dashboards.SaveDashboardCommand) response.Response {
	ctx := c.Req.Context()
	var err error
	cmd.OrgID = c.OrgID
	cmd.UserID = c.UserID
...
// 401: unauthorisedError
// 500: internalServerError
func (hs *HTTPServer) GetHomeDashboard(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) addGettingStartedPanelToHomeDashboard(c *model.ReqContext, dash *simplejson.Json) {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetDashboardVersions(c *model.ReqContext) response.Response {
	var dashID int64
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetDashboardVersion(c *model.ReqContext) response.Response {
	var dashID int64
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) ValidateDashboard(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) CalculateDashboardDiff(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) RestoreDashboardVersion(c *model.ReqContext) response.Response {
	var dashID int64
...
// 401: unauthorisedError
// 500: internalServerError
func (hs *HTTPServer) GetDashboardTags(c *model.ReqContext) {
...
func (hs *HTTPServer) GetDashboardUIDs(c *model.ReqContext) {
