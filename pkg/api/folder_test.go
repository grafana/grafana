...
func (s *fakeFolderService) Get(ctx context.Context, cmd *folder.GetFolderQuery) (*folder.Folder, error) {
	return s.GetFolderResult, s.GetFolderError
}
