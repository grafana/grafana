...
// // #TODO: fix TestHTTPServer_FolderMetadataK8s. fk8s.userService is nil
...
// 	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) { // fix the create folder button also
// 		//nolint:errcheck
// 		fmt.Fprintln(w,
// 			`{
// 				"kind": "Folder",
