...
func setupAccessControlScenarioContext(t *testing.T, cfg *setting.Cfg, url string, permissions []accesscontrol.Permission) (*scenarioContext, *HTTPServer) {
	...
	hs := &HTTPServer{
		...
		searchUsersService: searchusers.ProvideUsersService(store, filters.ProvideOSSSearchUserFilter(), usertest.NewUserServiceFake()),
...
func setupHTTPServerWithCfgDb(t *testing.T, useFakeAccessControl bool, cfg *setting.Cfg, db *sqlstore.SQLStore, store sqlstore.Store, features *featuremgmt.FeatureManager) accessControlScenarioContext {
	...
	hs := &HTTPServer{
		...
		searchUsersService:     searchusers.ProvideUsersService(db, filters.ProvideOSSSearchUserFilter(), usertest.NewUserServiceFake()),
