...
func fakeSetIndexViewData(t *testing.T) {
	...
	setIndexViewData = func(*HTTPServer, *model.ReqContext) (*dtos.IndexViewData, error) {
...
func (r *loginHookTest) LoginHook(loginInfo *models.LoginInfo, req *model.ReqContext) {
	r.info = loginInfo
}
