...
func TestLoginViewRedirect(t *testing.T) {
	...
	redirectCases := []redirectCase{
		...
		{
			desc:        "url path is a host with two leading slashs",
			url:         "//example.com",
			redirectURL: "/",
			appURL:      "http://localhost:3000/",
			status:      302,
		...
		{
			desc:        "url path is a host with three leading slashs",
			url:         "///example.com",
			redirectURL: "/",
			appURL:      "http://localhost:3000/",
			status:      302,
		...
		{
			desc:        "url path is ip with two leading slashs",
			url:         "//0.0.0.0",
			redirectURL: "/",
			appURL:      "http://localhost:3000/",
			status:      302,
		...
		{
			desc:        "url path is ip with three leading slashs",
			url:         "///0.0.0.0",
			redirectURL: "/",
			appURL:      "http://localhost:3000/",
			status:      302,
