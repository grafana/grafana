...
func (hs *HTTPServer) CreateTeam(c *model.ReqContext) response.Response {
...
// 409: conflictError
// 500: internalServerError
func (hs *HTTPServer) UpdateTeam(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) DeleteTeamByID(c *model.ReqContext) response.Response {
	orgID := c.OrgID
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) SearchTeams(c *model.ReqContext) response.Response {
...
func userFilter(c *model.ReqContext) int64 {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetTeamByID(c *model.ReqContext) response.Response {
	teamId, err := strconv.ParseInt(web.Params(c.Req)[":teamId"], 10, 64)
	if err != nil {
		return response.Error(http.StatusBadRequest, "teamId is invalid", err)
	}
...
// 401: unauthorisedError
// 500: internalServerError
func (hs *HTTPServer) GetTeamPreferences(c *model.ReqContext) response.Response {
	teamId, err := strconv.ParseInt(web.Params(c.Req)[":teamId"], 10, 64)
	if err != nil {
		return response.Error(http.StatusBadRequest, "teamId is invalid", err)
	}
...
// 401: unauthorisedError
// 500: internalServerError
func (hs *HTTPServer) UpdateTeamPreferences(c *model.ReqContext) response.Response {
