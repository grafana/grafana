...
func (hs *HTTPServer) GetCurrentOrg(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) GetOrgByID(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) GetOrgByName(c *model.ReqContext) response.Response {
...
// 409: conflictError
// 500: internalServerError
func (hs *HTTPServer) CreateOrg(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) UpdateCurrentOrg(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) UpdateOrg(c *model.ReqContext) response.Response {
	form := dtos.UpdateOrgForm{}
	if err := web.Bind(c.Req, &form); err != nil {
		return response.Error(http.StatusBadRequest, "bad request data", err)
	}
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) UpdateCurrentOrgAddress(c *model.ReqContext) response.Response {
...
// 403: forbiddenError
// 500: internalServerError
func (hs *HTTPServer) UpdateOrgAddress(c *model.ReqContext) response.Response {
	form := dtos.UpdateOrgAddressForm{}
	if err := web.Bind(c.Req, &form); err != nil {
		return response.Error(http.StatusBadRequest, "bad request data", err)
	}
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) DeleteOrgByID(c *model.ReqContext) response.Response {
	orgID, err := strconv.ParseInt(web.Params(c.Req)[":orgId"], 10, 64)
	if err != nil {
		return response.Error(http.StatusBadRequest, "orgId is invalid", err)
	}
...
// 409: conflictError
// 500: internalServerError
func (hs *HTTPServer) SearchOrgs(c *model.ReqContext) response.Response {
