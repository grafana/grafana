...
// Note: this is a database test, so it should be located in pkg/services/sqlstore/annotation_test.go
// however, placing it there would currently result in circular dependencies.
// So this test should be moved once the SQL package is separated out.
