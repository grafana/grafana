...
func (hs *HTTPServer) GetCurrentOrgQuotas(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetOrgQuotas(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) getOrgQuotasHelper(c *model.ReqContext, orgID int64) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) UpdateOrgQuota(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetUserQuotas(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) UpdateUserQuota(c *model.ReqContext) response.Response {
	cmd := quota.UpdateQuotaCmd{}
	var err error
	if err := web.Bind(c.Req, &cmd); err != nil {
		return response.Err(quota.ErrBadRequest.Errorf("bad request data: %w", err))
