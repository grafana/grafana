...
// swagger:route POST /alertmanager/api/v2/alerts alertmanager RoutePostAmAlerts
//
...
// swagger:route GET /alertmanager/api/v2/alerts/groups alertmanager RouteGetAmAlertGroups
//
// get alertmanager alerts
//
//     Responses:
...
// swagger:route GET /alertmanager/api/v2/silences alertmanager RouteGetSilences
//
// get silences
//
//     Responses:
...
// swagger:route POST /alertmanager/api/v2/silences alertmanager RouteCreateSilence
//
// create silence
//
//     Responses:
...
// swagger:route GET /alertmanager/api/v2/silence/{SilenceId} alertmanager RouteGetSilence
//
// get silence
//
//     Responses:
...
// swagger:route DELETE /alertmanager/api/v2/silence/{SilenceId} alertmanager RouteDeleteSilence
//
// delete silence
//
//     Responses:
