...
func (hs *HTTPServer) GetPendingOrgInvites(c *model.ReqContext) response.Response {
...
// 500: internalServerError
func (hs *HTTPServer) AddOrgInvite(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) inviteExistingUserToOrg(c *model.ReqContext, user *user.User, inviteDto *dtos.AddInviteForm) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) RevokeInvite(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) GetInviteInfoByCode(c *model.ReqContext) response.Response {
...
func (hs *HTTPServer) CompleteInvite(c *model.ReqContext) response.Response {
