...
func (hs *HTTPServer) GetFolderPermissionList(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) UpdateFolderPermissions(c *model.ReqContext) response.Response {
