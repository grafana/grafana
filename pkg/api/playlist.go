...
func (hs *HTTPServer) ValidateOrgPlaylist(c *model.ReqContext) {
...
func (hs *HTTPServer) SearchPlaylists(c *model.ReqContext) response.Response {
	query := c.Query("query")
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetPlaylist(c *model.ReqContext) response.Response {
	uid := web.Params(c.Req)[":uid"]
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetPlaylistItems(c *model.ReqContext) response.Response {
	uid := web.Params(c.Req)[":uid"]
	cmd := playlist.GetPlaylistByUidQuery{UID: uid, OrgId: c.OrgID}
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) GetPlaylistDashboards(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) DeletePlaylist(c *model.ReqContext) response.Response {
	uid := web.Params(c.Req)[":uid"]
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) CreatePlaylist(c *model.ReqContext) response.Response {
...
// 404: notFoundError
// 500: internalServerError
func (hs *HTTPServer) UpdatePlaylist(c *model.ReqContext) response.Response {
