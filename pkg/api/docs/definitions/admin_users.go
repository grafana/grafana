...
// If you are running Grafana Enterprise and have Fine-grained access control enabled, you need to have a permission with action `users.authtoken:updatepkg/api/docs/definitions/org.go` and scope `global.users:*`.
//
// Security:
// - basic:
//
