...
func TestDataSourceProxy_routeRule(t *testing.T) {
	...
	t.Run("Plugin with routes", func(t *testing.T) {
		...
		setUp := func() (*model.ReqContext, *http.Request) {
...
func TestDataSourceProxy_requestHandling(t *testing.T) {
	...
	setUp := func(t *testing.T, cfgs ...setUpCfg) (*model.ReqContext, *datasources.DataSource) {
		writeErr = nil
...
func getDatasourceProxiedRequest(t *testing.T, ctx *model.ReqContext, cfg *setting.Cfg) *http.Request {
	ds := &datasources.DataSource{
		Type: "custom",
		Url:  "http://host/root/",
	}
