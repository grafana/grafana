...
func TestDataSourceProxy_routeRule(t *testing.T) {
	...
	t.Run("Plugin with routes", func(t *testing.T) {
		...
		t.Run("When matching route path", func(t *testing.T) {
			ctx, req := setUp()
			proxy, err := NewDataSourceProxy(ds, plugin, ctx, "api/v4/some/method", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
			require.NoError(t, err)
		...
		t.Run("When matching route path and has dynamic url", func(t *testing.T) {
			ctx, req := setUp()
			proxy, err := NewDataSourceProxy(ds, plugin, ctx, "api/common/some/method", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
			require.NoError(t, err)
		...
		t.Run("When matching route path with no url", func(t *testing.T) {
			ctx, req := setUp()
			proxy, err := NewDataSourceProxy(ds, plugin, ctx, "", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
			require.NoError(t, err)
		...
		t.Run("When matching route path and has dynamic body", func(t *testing.T) {
			ctx, req := setUp()
			proxy, err := NewDataSourceProxy(ds, plugin, ctx, "api/body", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
			require.NoError(t, err)
		...
		t.Run("Validating request", func(t *testing.T) {
			...
			t.Run("plugin route with admin role and user is editor", func(t *testing.T) {
				ctx, _ := setUp()
				proxy, err := NewDataSourceProxy(ds, plugin, ctx, "api/admin", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
				require.NoError(t, err)
				err = proxy.validateRequest()
				require.Error(t, err)
			})
	...
	t.Run("Plugin with multiple routes for token auth", func(t *testing.T) {
		...
		t.Run("When creating and caching access tokens", func(t *testing.T) {
			...
			t.Run("first call should add authorization header with access token", func(t *testing.T) {
				...
				proxy, err := NewDataSourceProxy(ds, plugin, ctx, "pathwithtoken1", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
				require.NoError(t, err)
				...
				t.Run("second call to another route should add a different access token", func(t *testing.T) {
					...
					proxy, err := NewDataSourceProxy(ds, plugin, ctx, "pathwithtoken2", cfg, httpClientProvider, &oauthtoken.OAuthTokenService{})
					require.NoError(t, err)
	...
	t.Run("When proxying graphite", func(t *testing.T) {
		...
		proxy, err := NewDataSourceProxy(ds, plugin, ctx, "/render", &setting.Cfg{BuildVersion: "5.3.0"}, httpClientProvider, &oauthtoken.OAuthTokenService{})
		require.NoError(t, err)
	...
	t.Run("When proxying InfluxDB", func(t *testing.T) {
		...
		ctx := &models.ReqContext{}
		proxy, err := NewDataSourceProxy(ds, plugin, ctx, "", &setting.Cfg{}, httpClientProvider, &oauthtoken.OAuthTokenService{})
		require.NoError(t, err)
	...
	t.Run("When proxying a custom datasource", func(t *testing.T) {
		...
		ctx := &models.ReqContext{}
		proxy, err := NewDataSourceProxy(ds, plugin, ctx, "/path/to/folder/", &setting.Cfg{}, httpClientProvider, &oauthtoken.OAuthTokenService{})
		require.NoError(t, err)
		req, err := http.NewRequest(http.MethodGet, "http://grafana.com/sub", nil)
...
func TestDataSourceProxy_requestHandling(t *testing.T) {
	...
	t.Run("When response header Set-Cookie is not set should remove proxied Set-Cookie header", func(t *testing.T) {
		ctx, ds := setUp(t)
		proxy, err := NewDataSourceProxy(ds, plugin, ctx, "/render", &setting.Cfg{}, httpClientProvider, &oauthtoken.OAuthTokenService{})
		require.NoError(t, err)
	...
	t.Run("Data source should handle proxy path url encoding correctly", func(t *testing.T) {
		...
		proxy, err := NewDataSourceProxy(ds, plugin, ctx, "/path/%2Ftest%2Ftest%2F", &setting.Cfg{}, httpClientProvider, &oauthtoken.OAuthTokenService{})
		require.NoError(t, err)
...
func TestNewDataSourceProxy_InvalidURL(t *testing.T) {
	...
	cfg := setting.Cfg{}
	plugin := plugins.DataSourcePlugin{}
	_, err := NewDataSourceProxy(&ds, &plugin, &ctx, "api/method", &cfg, httpclient.NewProvider(), &oauthtoken.OAuthTokenService{})
	require.Error(t, err)
...
func TestNewDataSourceProxy_MSSQL(t *testing.T) {
	...
	for _, tc := range tcs {
		t.Run(tc.description, func(t *testing.T) {
			...
			p, err := NewDataSourceProxy(&ds, &plugin, &ctx, "api/method", &cfg, httpclient.NewProvider(), &oauthtoken.OAuthTokenService{})
			if tc.err == nil {
				require.NoError(t, err)
...
func getDatasourceProxiedRequest(t *testing.T, ctx *models.ReqContext, cfg *setting.Cfg) *http.Request {
	...
	proxy, err := NewDataSourceProxy(ds, plugin, ctx, "", cfg, httpclient.NewProvider(), &oauthtoken.OAuthTokenService{})
	require.NoError(t, err)
	req, err := http.NewRequest(http.MethodGet, "http://grafana.com/sub", nil)
	require.NoError(t, err)
...
func runDatasourceAuthTest(t *testing.T, test *testCase) {
	plugin := &plugins.DataSourcePlugin{}
	ctx := &models.ReqContext{}
	proxy, err := NewDataSourceProxy(test.datasource, plugin, ctx, "", &setting.Cfg{}, httpclient.NewProvider(), &oauthtoken.OAuthTokenService{})
	require.NoError(t, err)
...
func Test_PathCheck(t *testing.T) {
	...
	ctx, _ := setUp()
	proxy, err := NewDataSourceProxy(&models.DataSource{}, plugin, ctx, "b", &setting.Cfg{}, httpclient.NewProvider(), &oauthtoken.OAuthTokenService{})
	require.NoError(t, err)
