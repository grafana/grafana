...
func setSnapshotEnabled(t *testing.T, enabled bool) {
	originalValue := setting.SnapshotEnabled
	t.Cleanup(func() {
		setting.SnapshotEnabled = originalValue
	})
	setting.SnapshotEnabled = enabled
}
