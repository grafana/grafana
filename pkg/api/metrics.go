...
func (hs *HTTPServer) QueryMetricsV2(c *models.ReqContext) response.Response {
	...
	resp, err := hs.queryDataService.QueryData(context.WithValue(c.Req.Context(), "logzioHeaders", c.Req.Header), c.SignedInUser, c.SkipCache, reqDTO, true) // LOGZ.IO CHANGE :: DEV-33325 Open expressions for Grafana 8.5.1
	if err != nil {
