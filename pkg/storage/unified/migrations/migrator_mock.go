...
// RebuildIndexes provides a mock function with given fields: ctx, info, resources
func (_m *MockUnifiedMigrator) RebuildIndexes(ctx context.Context, info types.NamespaceInfo, resources []schema.GroupResource) error {
	ret := _m.Called(ctx, info, resources)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.NamespaceInfo, []schema.GroupResource) error); ok {
		r0 = rf(ctx, info, resources)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockUnifiedMigrator_Expecter) RebuildIndexes(ctx interface{}, info interface{}, resources interface{}) *MockUnifiedMigrator_RebuildIndexes_Call {
	return &MockUnifiedMigrator_RebuildIndexes_Call{Call: _e.mock.On("RebuildIndexes", ctx, info, resources)}
}

func (_c *MockUnifiedMigrator_RebuildIndexes_Call) Run(run func(ctx context.Context, info types.NamespaceInfo, resources []schema.GroupResource)) *MockUnifiedMigrator_RebuildIndexes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.NamespaceInfo), args[2].([]schema.GroupResource))
	})
	return _c
}
...
func (_c *MockUnifiedMigrator_RebuildIndexes_Call) RunAndReturn(run func(context.Context, types.NamespaceInfo, []schema.GroupResource) error) *MockUnifiedMigrator_RebuildIndexes_Call {
	_c.Call.Return(run)
	return _c
}
