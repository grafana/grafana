	...
	synctest.Test(t, func(t *testing.T) {
		...
		list := func(context.Context) ([]runtime.Object, int64, error) {
			...
			case 0:
				return []runtime.Object{obj("a"), obj("b")}, 0, nil
			case 1:
				return []runtime.Object{obj("a")}, 0, ErrPartialList
			default:
				return []runtime.Object{obj("a"), obj("c")}, 0, ErrPartialList
			}
		}
		store := NewStore()
	...
	synctest.Test(t, func(t *testing.T) {
		...
		list := func(context.Context) ([]runtime.Object, int64, error) {
			...
			case 0:
				return []runtime.Object{obj("a"), obj("b")}, 0, nil
			case 1:
				return []runtime.Object{obj("a")}, 0, ErrPartialList // partial: b unread, not deleted
			default:
				return []runtime.Object{obj("a")}, 0, nil // complete: b is genuinely gone
			}
		}
		store := NewStore()
		n := NewInformer(sub, testGVR, testNamespace, time.Hour, testQueueGroup, store, newObjectFunc, list)
