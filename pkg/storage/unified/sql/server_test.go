...
func TestIsHighAvailabilityEnabled(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "MySQL with HA enabled in config",
			dbType:        migrator.MySQL,
			haConfigValue: boolPtr(true),
			isHA:          true,
		},
		{
			name:          "MySQL with HA disabled in config",
			dbType:        migrator.MySQL,
		...
		{
			name:          "Postgres with HA enabled in config",
			dbType:        migrator.Postgres,
			haConfigValue: boolPtr(true),
			isHA:          true,
		},
		{
			name:          "Postgres with HA disabled in config",
			dbType:        migrator.Postgres,
			haConfigValue: boolPtr(false),
			isHA:          false,
		},
		...
		{
			name:          "No database type set should default to false",
			dbType:        "",
			haConfigValue: nil,
			isHA:          true,
		},
		{
			name:          "No database type set with HA enabled in config",
			dbType:        "",
			haConfigValue: boolPtr(true),
			isHA:          true,
		},
		{
			name:          "No database type set with HA disabled in config",
			dbType:        "",
			haConfigValue: boolPtr(false),
			isHA:          false,
		},
