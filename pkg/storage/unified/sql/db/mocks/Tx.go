...
func (_m *Tx) ExecContext(ctx context.Context, query string, args ...interface{}) (db.Result, error) {
	var _ca []interface{}
...
func (_c *Tx_ExecContext_Call) Return(_a0 db.Result, _a1 error) *Tx_ExecContext_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Tx_ExecContext_Call) RunAndReturn(run func(context.Context, string, ...interface{}) (db.Result, error)) *Tx_ExecContext_Call {
	_c.Call.Return(run)
	return _c
}
