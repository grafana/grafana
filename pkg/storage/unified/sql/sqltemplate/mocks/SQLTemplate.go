...
func (_m *SQLTemplate) IsRowAlreadyExistsError(_a0 error) bool {
	ret := _m.Called(_a0)
...
// SQLTemplate_IsRowAlreadyExistsError_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsRowAlreadyExistsError'
type SQLTemplate_IsRowAlreadyExistsError_Call struct {
	*mock.Call
}

// IsRowAlreadyExistsError is a helper method to define mock.On call
//   - _a0 error
func (_e *SQLTemplate_Expecter) IsRowAlreadyExistsError(_a0 interface{}) *SQLTemplate_IsRowAlreadyExistsError_Call {
	return &SQLTemplate_IsRowAlreadyExistsError_Call{Call: _e.mock.On("IsRowAlreadyExistsError", _a0)}
}

func (_c *SQLTemplate_IsRowAlreadyExistsError_Call) Run(run func(_a0 error)) *SQLTemplate_IsRowAlreadyExistsError_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(error))
	})
	return _c
...
func (_c *SQLTemplate_IsRowAlreadyExistsError_Call) Return(_a0 bool) *SQLTemplate_IsRowAlreadyExistsError_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SQLTemplate_IsRowAlreadyExistsError_Call) RunAndReturn(run func(error) bool) *SQLTemplate_IsRowAlreadyExistsError_Call {
	_c.Call.Return(run)
	return _c
}
