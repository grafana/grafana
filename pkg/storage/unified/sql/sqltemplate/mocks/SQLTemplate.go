...
func (_m *SQLTemplate) JsonExtract(tableAlias string, column string, fieldKey string) string {
...
// SQLTemplate_JsonExtract_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'JsonExtract'
type SQLTemplate_JsonExtract_Call struct {
	*mock.Call
}
...
//   - column string
//   - fieldKey string
func (_e *SQLTemplate_Expecter) JsonExtract(tableAlias interface{}, column interface{}, fieldKey interface{}) *SQLTemplate_JsonExtract_Call {
	return &SQLTemplate_JsonExtract_Call{Call: _e.mock.On("JsonExtract", tableAlias, column, fieldKey)}
}

func (_c *SQLTemplate_JsonExtract_Call) Run(run func(tableAlias string, column string, fieldKey string)) *SQLTemplate_JsonExtract_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SQLTemplate_JsonExtract_Call) Return(_a0 string) *SQLTemplate_JsonExtract_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SQLTemplate_JsonExtract_Call) RunAndReturn(run func(string, string, string) string) *SQLTemplate_JsonExtract_Call {
	_c.Call.Return(run)
	return _c
}
