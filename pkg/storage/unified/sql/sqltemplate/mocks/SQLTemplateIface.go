...
// DerefString provides a mock function with given fields: s
func (_m *SQLTemplate) DerefString(s *string) string {
	ret := _m.Called(s)

	if len(ret) == 0 {
		panic("no return value specified for DerefString")
	}
...
// SQLTemplate_DerefString_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DerefString'
type SQLTemplate_DerefString_Call struct {
	*mock.Call
}

// DerefString is a helper method to define mock.On call
//   - s *string
func (_e *SQLTemplate_Expecter) DerefString(s interface{}) *SQLTemplate_DerefString_Call {
	return &SQLTemplate_DerefString_Call{Call: _e.mock.On("DerefString", s)}
}

func (_c *SQLTemplate_DerefString_Call) Run(run func(s *string)) *SQLTemplate_DerefString_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*string))
	})
	return _c
...
func (_c *SQLTemplate_DerefString_Call) Return(_a0 string) *SQLTemplate_DerefString_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SQLTemplate_DerefString_Call) RunAndReturn(run func(*string) string) *SQLTemplate_DerefString_Call {
	_c.Call.Return(run)
	return _c
}
