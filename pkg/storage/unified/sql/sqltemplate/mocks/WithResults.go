...
// IsRowAlreadyExistsError provides a mock function with given fields: _a0
func (_m *WithResults[T]) IsRowAlreadyExistsError(_a0 error) bool {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for IsRowAlreadyExistsError")
	}
...
// WithResults_IsRowAlreadyExistsError_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsRowAlreadyExistsError'
type WithResults_IsRowAlreadyExistsError_Call[T interface{}] struct {
	*mock.Call
}

// IsRowAlreadyExistsError is a helper method to define mock.On call
//   - _a0 error
func (_e *WithResults_Expecter[T]) IsRowAlreadyExistsError(_a0 interface{}) *WithResults_IsRowAlreadyExistsError_Call[T] {
	return &WithResults_IsRowAlreadyExistsError_Call[T]{Call: _e.mock.On("IsRowAlreadyExistsError", _a0)}
}

func (_c *WithResults_IsRowAlreadyExistsError_Call[T]) Run(run func(_a0 error)) *WithResults_IsRowAlreadyExistsError_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(error))
	})
	return _c
...
func (_c *WithResults_IsRowAlreadyExistsError_Call[T]) Return(_a0 bool) *WithResults_IsRowAlreadyExistsError_Call[T] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *WithResults_IsRowAlreadyExistsError_Call[T]) RunAndReturn(run func(error) bool) *WithResults_IsRowAlreadyExistsError_Call[T] {
	_c.Call.Return(run)
	return _c
}
