...
// JsonExtract provides a mock function with given fields: tableAlias, column, fieldKey
func (_m *WithResults[T]) JsonExtract(tableAlias string, column string, fieldKey string) string {
	ret := _m.Called(tableAlias, column, fieldKey)

	if len(ret) == 0 {
		panic("no return value specified for JsonExtract")
	}

	var r0 string
	if rf, ok := ret.Get(0).(func(string, string, string) string); ok {
		r0 = rf(tableAlias, column, fieldKey)
	} else {
		r0 = ret.Get(0).(string)
	}
...
// WithResults_JsonExtract_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'JsonExtract'
type WithResults_JsonExtract_Call[T interface{}] struct {
	*mock.Call
}

// JsonExtract is a helper method to define mock.On call
//   - tableAlias string
//   - column string
//   - fieldKey string
func (_e *WithResults_Expecter[T]) JsonExtract(tableAlias interface{}, column interface{}, fieldKey interface{}) *WithResults_JsonExtract_Call[T] {
	return &WithResults_JsonExtract_Call[T]{Call: _e.mock.On("JsonExtract", tableAlias, column, fieldKey)}
}

func (_c *WithResults_JsonExtract_Call[T]) Run(run func(tableAlias string, column string, fieldKey string)) *WithResults_JsonExtract_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *WithResults_JsonExtract_Call[T]) Return(_a0 string) *WithResults_JsonExtract_Call[T] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *WithResults_JsonExtract_Call[T]) RunAndReturn(run func(string, string, string) string) *WithResults_JsonExtract_Call[T] {
	_c.Call.Return(run)
	return _c
}
