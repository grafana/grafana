...
func (_m *WithResults[T]) DerefString(s *string) string {
	ret := _m.Called(s)
...
// WithResults_DerefString_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DerefString'
type WithResults_DerefString_Call[T interface{}] struct {
	*mock.Call
}

// DerefString is a helper method to define mock.On call
//   - s *string
func (_e *WithResults_Expecter[T]) DerefString(s interface{}) *WithResults_DerefString_Call[T] {
	return &WithResults_DerefString_Call[T]{Call: _e.mock.On("DerefString", s)}
}

func (_c *WithResults_DerefString_Call[T]) Run(run func(s *string)) *WithResults_DerefString_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*string))
	})
	return _c
...
func (_c *WithResults_DerefString_Call[T]) Return(_a0 string) *WithResults_DerefString_Call[T] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *WithResults_DerefString_Call[T]) RunAndReturn(run func(*string) string) *WithResults_DerefString_Call[T] {
	_c.Call.Return(run)
	return _c
}
