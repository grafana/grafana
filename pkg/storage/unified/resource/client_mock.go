...
func (_m *MockResourceClient) GetResourceDailyStats(ctx context.Context, in *resourcepb.GetResourceDailyStatsRequest, opts ...grpc.CallOption) (resourcepb.ResourceStats_GetResourceDailyStatsClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 resourcepb.ResourceStats_GetResourceDailyStatsClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *resourcepb.GetResourceDailyStatsRequest, ...grpc.CallOption) (resourcepb.ResourceStats_GetResourceDailyStatsClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *resourcepb.GetResourceDailyStatsRequest, ...grpc.CallOption) resourcepb.ResourceStats_GetResourceDailyStatsClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(resourcepb.ResourceStats_GetResourceDailyStatsClient)
		}
	}
...
func (_c *MockResourceClient_GetResourceDailyStats_Call) Return(_a0 resourcepb.ResourceStats_GetResourceDailyStatsClient, _a1 error) *MockResourceClient_GetResourceDailyStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResourceClient_GetResourceDailyStats_Call) RunAndReturn(run func(context.Context, *resourcepb.GetResourceDailyStatsRequest, ...grpc.CallOption) (resourcepb.ResourceStats_GetResourceDailyStatsClient, error)) *MockResourceClient_GetResourceDailyStats_Call {
	_c.Call.Return(run)
	return _c
}
...
// VectorSearch provides a mock function with given fields: ctx, in, opts
func (_m *MockResourceClient) VectorSearch(ctx context.Context, in *resourcepb.VectorSearchRequest, opts ...grpc.CallOption) (*resourcepb.VectorSearchResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *resourcepb.VectorSearchResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *resourcepb.VectorSearchRequest, ...grpc.CallOption) (*resourcepb.VectorSearchResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *resourcepb.VectorSearchRequest, ...grpc.CallOption) *resourcepb.VectorSearchResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*resourcepb.VectorSearchResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *resourcepb.VectorSearchRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockResourceClient_VectorSearch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VectorSearch'
type MockResourceClient_VectorSearch_Call struct {
	*mock.Call
}

// VectorSearch is a helper method to define mock.On call
//   - ctx context.Context
//   - in *resourcepb.VectorSearchRequest
//   - opts ...grpc.CallOption
func (_e *MockResourceClient_Expecter) VectorSearch(ctx interface{}, in interface{}, opts ...interface{}) *MockResourceClient_VectorSearch_Call {
	return &MockResourceClient_VectorSearch_Call{Call: _e.mock.On("VectorSearch",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockResourceClient_VectorSearch_Call) Run(run func(ctx context.Context, in *resourcepb.VectorSearchRequest, opts ...grpc.CallOption)) *MockResourceClient_VectorSearch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*resourcepb.VectorSearchRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockResourceClient_VectorSearch_Call) Return(_a0 *resourcepb.VectorSearchResponse, _a1 error) *MockResourceClient_VectorSearch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResourceClient_VectorSearch_Call) RunAndReturn(run func(context.Context, *resourcepb.VectorSearchRequest, ...grpc.CallOption) (*resourcepb.VectorSearchResponse, error)) *MockResourceClient_VectorSearch_Call {
	_c.Call.Return(run)
	return _c
}
