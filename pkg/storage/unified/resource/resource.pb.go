...
var file_resource_proto_rawDesc = []byte{
	...
	0x74, 0x10, 0x01, 0x32, 0xad, 0x03, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x30, 0x01, 0x32, 0xa9, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var file_resource_proto_goTypes = []any{
	...
	(*ListRepositoryObjectsRequest)(nil),                 // 28: resource.ListRepositoryObjectsRequest
	(*ListRepositoryObjectsResponse)(nil),                // 29: resource.ListRepositoryObjectsResponse
	(*CountRepositoryObjectsRequest)(nil),                // 30: resource.CountRepositoryObjectsRequest
	(*CountRepositoryObjectsResponse)(nil),               // 31: resource.CountRepositoryObjectsResponse
	...
	(*ResourceStatsResponse_Stats)(nil),                  // 44: resource.ResourceStatsResponse.Stats
	(*ResourceSearchRequest_Sort)(nil),                   // 45: resource.ResourceSearchRequest.Sort
	(*ResourceSearchRequest_Facet)(nil),                  // 46: resource.ResourceSearchRequest.Facet
	nil,                                                  // 47: resource.ResourceSearchRequest.FacetEntry
	(*ResourceSearchResponse_Facet)(nil),                 // 48: resource.ResourceSearchResponse.Facet
	(*ResourceSearchResponse_TermFacet)(nil),             // 49: resource.ResourceSearchResponse.TermFacet
	nil,                                                  // 50: resource.ResourceSearchResponse.FacetEntry
	(*ListRepositoryObjectsResponse_Item)(nil),           // 51: resource.ListRepositoryObjectsResponse.Item
	(*CountRepositoryObjectsResponse_ResourceCount)(nil), // 52: resource.CountRepositoryObjectsResponse.ResourceCount
	(*ResourceTableColumnDefinition_Properties)(nil),     // 53: resource.ResourceTableColumnDefinition.Properties
}
var file_resource_proto_depIdxs = []int32{
	...
	44, // 22: resource.ResourceStatsResponse.stats:type_name -> resource.ResourceStatsResponse.Stats
	...
	45, // 25: resource.ResourceSearchRequest.sortBy:type_name -> resource.ResourceSearchRequest.Sort
	47, // 26: resource.ResourceSearchRequest.facet:type_name -> resource.ResourceSearchRequest.FacetEntry
	...
	34, // 29: resource.ResourceSearchResponse.results:type_name -> resource.ResourceTable
	50, // 30: resource.ResourceSearchResponse.facet:type_name -> resource.ResourceSearchResponse.FacetEntry
	51, // 31: resource.ListRepositoryObjectsResponse.items:type_name -> resource.ListRepositoryObjectsResponse.Item
	7,  // 32: resource.ListRepositoryObjectsResponse.error:type_name -> resource.ErrorResult
	52, // 33: resource.CountRepositoryObjectsResponse.items:type_name -> resource.CountRepositoryObjectsResponse.ResourceCount
	7,  // 34: resource.CountRepositoryObjectsResponse.error:type_name -> resource.ErrorResult
	2,  // 35: resource.HealthCheckResponse.status:type_name -> resource.HealthCheckResponse.ServingStatus
	35, // 36: resource.ResourceTable.columns:type_name -> resource.ResourceTableColumnDefinition
	36, // 37: resource.ResourceTable.rows:type_name -> resource.ResourceTableRow
	3,  // 38: resource.ResourceTableColumnDefinition.type:type_name -> resource.ResourceTableColumnDefinition.ColumnType
	53, // 39: resource.ResourceTableColumnDefinition.properties:type_name -> resource.ResourceTableColumnDefinition.Properties
	5,  // 40: resource.ResourceTableRow.key:type_name -> resource.ResourceKey
	5,  // 41: resource.RestoreRequest.key:type_name -> resource.ResourceKey
	7,  // 42: resource.RestoreResponse.error:type_name -> resource.ErrorResult
	5,  // 43: resource.PutBlobRequest.resource:type_name -> resource.ResourceKey
	4,  // 44: resource.PutBlobRequest.method:type_name -> resource.PutBlobRequest.Method
	7,  // 45: resource.PutBlobResponse.error:type_name -> resource.ErrorResult
	5,  // 46: resource.GetBlobRequest.resource:type_name -> resource.ResourceKey
	7,  // 47: resource.GetBlobResponse.error:type_name -> resource.ErrorResult
	46, // 48: resource.ResourceSearchRequest.FacetEntry.value:type_name -> resource.ResourceSearchRequest.Facet
	49, // 49: resource.ResourceSearchResponse.Facet.terms:type_name -> resource.ResourceSearchResponse.TermFacet
	48, // 50: resource.ResourceSearchResponse.FacetEntry.value:type_name -> resource.ResourceSearchResponse.Facet
	5,  // 51: resource.ListRepositoryObjectsResponse.Item.object:type_name -> resource.ResourceKey
	16, // 52: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	10, // 53: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	12, // 54: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	14, // 55: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	37, // 56: resource.ResourceStore.Restore:input_type -> resource.RestoreRequest
	20, // 57: resource.ResourceStore.List:input_type -> resource.ListRequest
	22, // 58: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	26, // 59: resource.ResourceIndex.Search:input_type -> resource.ResourceSearchRequest
	24, // 60: resource.ResourceIndex.GetStats:input_type -> resource.ResourceStatsRequest
	30, // 61: resource.RepositoryIndex.CountRepositoryObjects:input_type -> resource.CountRepositoryObjectsRequest
	28, // 62: resource.RepositoryIndex.ListRepositoryObjects:input_type -> resource.ListRepositoryObjectsRequest
	39, // 63: resource.BlobStore.PutBlob:input_type -> resource.PutBlobRequest
	41, // 64: resource.BlobStore.GetBlob:input_type -> resource.GetBlobRequest
	32, // 65: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	17, // 66: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	11, // 67: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	13, // 68: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	15, // 69: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	38, // 70: resource.ResourceStore.Restore:output_type -> resource.RestoreResponse
	21, // 71: resource.ResourceStore.List:output_type -> resource.ListResponse
	23, // 72: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	27, // 73: resource.ResourceIndex.Search:output_type -> resource.ResourceSearchResponse
	25, // 74: resource.ResourceIndex.GetStats:output_type -> resource.ResourceStatsResponse
	31, // 75: resource.RepositoryIndex.CountRepositoryObjects:output_type -> resource.CountRepositoryObjectsResponse
	29, // 76: resource.RepositoryIndex.ListRepositoryObjects:output_type -> resource.ListRepositoryObjectsResponse
	40, // 77: resource.BlobStore.PutBlob:output_type -> resource.PutBlobResponse
	42, // 78: resource.BlobStore.GetBlob:output_type -> resource.GetBlobResponse
	33, // 79: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
