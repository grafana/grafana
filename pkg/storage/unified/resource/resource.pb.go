...
var file_resource_proto_rawDesc = []byte{
	...
	0x45, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x03, 0x22, 0xd3, 0x01, 0x0a, 0x0e,
	...
	0x01, 0x32, 0xc3, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x6e,
	0x64, 0x65, 0x78, 0x12, 0x35, 0x0a, 0x04, 0x52, 0x65, 0x61, 0x64, 0x12, 0x15, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x16, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65,
	0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x07, 0x48, 0x69,
...
var file_resource_proto_depIdxs = []int32{
	...
	35, // 19: resource.WatchEvent.resource:type_name -> resource.WatchEvent.Resource
	35, // 20: resource.WatchEvent.previous:type_name -> resource.WatchEvent.Resource
	4,  // 21: resource.HistoryRequest.key:type_name -> resource.ResourceKey
	6,  // 22: resource.HistoryResponse.items:type_name -> resource.ResourceMeta
	7,  // 23: resource.HistoryResponse.error:type_name -> resource.ErrorResult
	4,  // 24: resource.OriginRequest.key:type_name -> resource.ResourceKey
	4,  // 25: resource.ResourceOriginInfo.key:type_name -> resource.ResourceKey
	27, // 26: resource.OriginResponse.items:type_name -> resource.ResourceOriginInfo
	7,  // 27: resource.OriginResponse.error:type_name -> resource.ErrorResult
	2,  // 28: resource.HealthCheckResponse.status:type_name -> resource.HealthCheckResponse.ServingStatus
	4,  // 29: resource.PutBlobRequest.resource:type_name -> resource.ResourceKey
	3,  // 30: resource.PutBlobRequest.method:type_name -> resource.PutBlobRequest.Method
	7,  // 31: resource.PutBlobResponse.error:type_name -> resource.ErrorResult
	4,  // 32: resource.GetBlobRequest.resource:type_name -> resource.ResourceKey
	7,  // 33: resource.GetBlobResponse.error:type_name -> resource.ErrorResult
	16, // 34: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	10, // 35: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	12, // 36: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	14, // 37: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	20, // 38: resource.ResourceStore.List:input_type -> resource.ListRequest
	22, // 39: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	16, // 40: resource.ResourceIndex.Read:input_type -> resource.ReadRequest
	...
	31, // 43: resource.BlobStore.PutBlob:input_type -> resource.PutBlobRequest
	33, // 44: resource.BlobStore.GetBlob:input_type -> resource.GetBlobRequest
	29, // 45: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	17, // 46: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	11, // 47: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	13, // 48: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	15, // 49: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	21, // 50: resource.ResourceStore.List:output_type -> resource.ListResponse
	23, // 51: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	17, // 52: resource.ResourceIndex.Read:output_type -> resource.ReadResponse
	25, // 53: resource.ResourceIndex.History:output_type -> resource.HistoryResponse
	28, // 54: resource.ResourceIndex.Origin:output_type -> resource.OriginResponse
	32, // 55: resource.BlobStore.PutBlob:output_type -> resource.PutBlobResponse
	34, // 56: resource.BlobStore.GetBlob:output_type -> resource.GetBlobResponse
	30, // 57: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
