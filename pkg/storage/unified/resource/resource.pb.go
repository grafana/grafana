...
type ListResponse struct {
	...
	Error *ErrorResult `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	// The actual items
	Items []*ResourceWrapper `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
	...
	// +optional
	RemainingItemCount int64 `protobuf:"varint,5,opt,name=remaining_item_count,json=remainingItemCount,proto3" json:"remaining_item_count,omitempty"` // 0 won't be set either (no next page token)
}
...
type HistoryResponse struct {
	...
	// Error details
	Error *ErrorResult `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	// Show historical items
	Items []*ResourceMeta `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
...
type OriginResponse struct {
	...
	// Error details
	Error *ErrorResult          `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	Items []*ResourceOriginInfo `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
	// More results exist... pass this in the next request
	NextPageToken string `protobuf:"bytes,3,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	// ResourceVersion of the list response
	ResourceVersion int64 `protobuf:"varint,4,opt,name=resource_version,json=resourceVersion,proto3" json:"resource_version,omitempty"`
...
var file_resource_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x2f, 0x0a, 0x05, 0x69, 0x74,
	0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x2c, 0x0a, 0x05,
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x72, 0x65,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x32, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var file_resource_proto_depIdxs = []int32{
	...
	6,  // 15: resource.ListResponse.error:type_name -> resource.ErrorResult
	4,  // 16: resource.ListResponse.items:type_name -> resource.ResourceWrapper
	...
	6,  // 22: resource.HistoryResponse.error:type_name -> resource.ErrorResult
	...
	6,  // 26: resource.OriginResponse.error:type_name -> resource.ErrorResult
	26, // 27: resource.OriginResponse.items:type_name -> resource.ResourceOriginInfo
