...
func (x *StoredValue) GetRaw() []byte {
	if x != nil {
		return x.Raw
	}
	return nil
...
func (x *StoredValue) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *StoredValue) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
func (x *StoredValue) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
func (x *StoredValue) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StoredValue) GetFolder() string {
	if x != nil {
		return x.Folder
	}
	return ""
...
var file_resource_proto_rawDesc = []byte{
	...
	0x9b, 0x01, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12,
	0x10, 0x0a, 0x03, 0x72, 0x61, 0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x72, 0x61,
	0x77, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x02,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x2a, 0x33, 0x0a,
...
var file_resource_proto_goTypes = []any{
	...
	(*StoredValue)(nil),                    // 37: resource.StoredValue
	(*WatchEvent_Resource)(nil),            // 38: resource.WatchEvent.Resource
}
var file_resource_proto_depIdxs = []int32{
	...
	38, // 19: resource.WatchEvent.resource:type_name -> resource.WatchEvent.Resource
	38, // 20: resource.WatchEvent.previous:type_name -> resource.WatchEvent.Resource
