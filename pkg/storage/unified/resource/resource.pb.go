...
var file_resource_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x6f, 0x77, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x22, 0x92, 0x01, 0x0a, 0x0f,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x97, 0x01, 0x0a, 0x0e, 0x4f, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65,
	...
	0x03, 0x2a, 0x33, 0x0a, 0x14, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x56, 0x65, 0x72,
	...
	0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x32, 0xc3, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x35, 0x0a, 0x04, 0x52, 0x65, 0x61, 0x64,
	0x12, 0x15, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x61, 0x64,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_resource_proto_goTypes = []any{
	...
	(*HistoryRequest)(nil),                 // 21: resource.HistoryRequest
	(*HistoryResponse)(nil),                // 22: resource.HistoryResponse
	(*OriginRequest)(nil),                  // 23: resource.OriginRequest
	(*ResourceOriginInfo)(nil),             // 24: resource.ResourceOriginInfo
	(*OriginResponse)(nil),                 // 25: resource.OriginResponse
	(*HealthCheckRequest)(nil),             // 26: resource.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 27: resource.HealthCheckResponse
	(*WatchEvent_Resource)(nil),            // 28: resource.WatchEvent.Resource
}
var file_resource_proto_depIdxs = []int32{
	...
	28, // 16: resource.WatchEvent.resource:type_name -> resource.WatchEvent.Resource
	28, // 17: resource.WatchEvent.previous:type_name -> resource.WatchEvent.Resource
	3,  // 18: resource.HistoryRequest.key:type_name -> resource.ResourceKey
	5,  // 19: resource.HistoryResponse.items:type_name -> resource.ResourceMeta
	3,  // 20: resource.OriginRequest.key:type_name -> resource.ResourceKey
	3,  // 21: resource.ResourceOriginInfo.key:type_name -> resource.ResourceKey
	24, // 22: resource.OriginResponse.items:type_name -> resource.ResourceOriginInfo
	2,  // 23: resource.HealthCheckResponse.status:type_name -> resource.HealthCheckResponse.ServingStatus
	13, // 24: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	7,  // 25: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	9,  // 26: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	11, // 27: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	17, // 28: resource.ResourceStore.List:input_type -> resource.ListRequest
	19, // 29: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	13, // 30: resource.ResourceIndex.Read:input_type -> resource.ReadRequest
	21, // 31: resource.ResourceIndex.History:input_type -> resource.HistoryRequest
	23, // 32: resource.ResourceIndex.Origin:input_type -> resource.OriginRequest
	26, // 33: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	14, // 34: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	8,  // 35: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	10, // 36: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	12, // 37: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	18, // 38: resource.ResourceStore.List:output_type -> resource.ListResponse
	20, // 39: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	14, // 40: resource.ResourceIndex.Read:output_type -> resource.ReadResponse
	22, // 41: resource.ResourceIndex.History:output_type -> resource.HistoryResponse
	25, // 42: resource.ResourceIndex.Origin:output_type -> resource.OriginResponse
	27, // 43: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
