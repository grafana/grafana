...
var file_resource_proto_rawDesc = []byte{
	...
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x45, 0x53, 0x43, 0x10, 0x01, 0x22, 0x94, 0x01, 0x0a,
	...
	0x6e, 0x73, 0x22, 0xc4, 0x01, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x49, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb9, 0x01, 0x0a, 0x0c, 0x57, 0x61,
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
...
var file_resource_proto_depIdxs = []int32{
	...
	1,  // 10: resource.Sort.order:type_name -> resource.Sort.Order
	5,  // 11: resource.ListOptions.key:type_name -> resource.ResourceKey
	19, // 12: resource.ListOptions.labels:type_name -> resource.Requirement
	19, // 13: resource.ListOptions.fields:type_name -> resource.Requirement
	0,  // 14: resource.ListRequest.version_match:type_name -> resource.ResourceVersionMatch
	21, // 15: resource.ListRequest.options:type_name -> resource.ListOptions
	6,  // 16: resource.ListResponse.items:type_name -> resource.ResourceWrapper
	21, // 17: resource.WatchRequest.options:type_name -> resource.ListOptions
	2,  // 18: resource.WatchEvent.type:type_name -> resource.WatchEvent.Type
	...
	5,  // 21: resource.HistoryRequest.key:type_name -> resource.ResourceKey
	7,  // 22: resource.HistoryResponse.items:type_name -> resource.ResourceMeta
	5,  // 23: resource.OriginRequest.key:type_name -> resource.ResourceKey
	5,  // 24: resource.ResourceOriginInfo.key:type_name -> resource.ResourceKey
	29, // 25: resource.OriginResponse.items:type_name -> resource.ResourceOriginInfo
	3,  // 26: resource.HealthCheckResponse.status:type_name -> resource.HealthCheckResponse.ServingStatus
	5,  // 27: resource.PutBlobRequest.resource:type_name -> resource.ResourceKey
	4,  // 28: resource.PutBlobRequest.method:type_name -> resource.PutBlobRequest.Method
	8,  // 29: resource.PutBlobResponse.error:type_name -> resource.ErrorResult
	5,  // 30: resource.GetBlobRequest.resource:type_name -> resource.ResourceKey
	8,  // 31: resource.GetBlobResponse.error:type_name -> resource.ErrorResult
	...
	17, // 38: resource.ResourceIndex.Read:input_type -> resource.ReadRequest
	26, // 39: resource.ResourceIndex.History:input_type -> resource.HistoryRequest
	28, // 40: resource.ResourceIndex.Origin:input_type -> resource.OriginRequest
	33, // 41: resource.BlobStore.PutBlob:input_type -> resource.PutBlobRequest
	35, // 42: resource.BlobStore.GetBlob:input_type -> resource.GetBlobRequest
	31, // 43: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	...
	23, // 48: resource.ResourceStore.List:output_type -> resource.ListResponse
	25, // 49: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	18, // 50: resource.ResourceIndex.Read:output_type -> resource.ReadResponse
	27, // 51: resource.ResourceIndex.History:output_type -> resource.HistoryResponse
	30, // 52: resource.ResourceIndex.Origin:output_type -> resource.OriginResponse
	34, // 53: resource.BlobStore.PutBlob:output_type -> resource.PutBlobResponse
	36, // 54: resource.BlobStore.GetBlob:output_type -> resource.GetBlobResponse
	32, // 55: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
