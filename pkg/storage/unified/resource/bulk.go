...
// singleRequestBatchIterator wraps a BulkRequestIterator to satisfy
// BulkRequestBatchIterator by yielding one-element batches.
type singleRequestBatchIterator struct {
	iter  BulkRequestIterator
	batch []*resourcepb.BulkRequest
}

// NewSingleRequestBatchIterator wraps a BulkRequestIterator into a
// BulkRequestBatchIterator that yields one-element batches.
func NewSingleRequestBatchIterator(iter BulkRequestIterator) BulkRequestBatchIterator {
	return &singleRequestBatchIterator{iter: iter}
}
