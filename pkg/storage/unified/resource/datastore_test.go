...
func TestDataStore_ListResourceKeysAtRevision(t *testing.T) {
	...
	t.Run("list at revision rv1 - should return only resource1 initial version", func(t *testing.T) {
		...
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv1}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list at revision rv2 - should return resource1, resource2 and resource4", func(t *testing.T) {
		resultKeys := make([]DataKey, 0, 3)
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv2}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list at revision rv3 - should return resource1, resource2 and resource4", func(t *testing.T) {
		resultKeys := make([]DataKey, 0, 3)
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv3}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list at revision rv4 - should return all resources", func(t *testing.T) {
		...
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv4}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list at revision rv5 - should exclude deleted resource4", func(t *testing.T) {
		resultKeys := make([]DataKey, 0, 3)
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv5}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list with specific resource name", func(t *testing.T) {
		...
		resultKeys := make([]DataKey, 0, 2)
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: specificListKey, ResourceVersion: rv3}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
	...
	t.Run("list at revision 0 should use MaxInt64", func(t *testing.T) {
		resultKeys := make([]DataKey, 0, 4)
		for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: 0}) {
			require.NoError(t, err)
			resultKeys = append(resultKeys, dataKey)
		}
...
func TestDataStore_ListResourceKeysAtRevision_ValidationErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			for _, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: tt.key, ResourceVersion: 0}) {
				require.Error(t, err)
				return
			}
		})
...
func TestDataStore_ListResourceKeysAtRevision_ResourcesNewerThanRevision(t *testing.T) {
	...
	resultKeys := make([]DataKey, 0, 1)
	for dataKey, err := range ds.ListResourceKeysAtRevision(ctx, ListRequestOptions{StartKey: listKey, ResourceVersion: rv - 1000}) {
		require.NoError(t, err)
		resultKeys = append(resultKeys, dataKey)
	}
