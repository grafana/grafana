...
// NewLocalResourceClient creates a client that implements StorageClient, SearchClient,
// MigratorClient, QuotaClient, and DiagnosticsClient, communicating with the given
// ResourceServer in-process using an in-memory channel.
//
// Use this when the resource server runs in the same process
func NewLocalResourceClient(server ResourceServer) *Client {
...
func newLegacyResourceClient(channel grpc.ClientConnInterface, indexChannel grpc.ClientConnInterface) *Client {
