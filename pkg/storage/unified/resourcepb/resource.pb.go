...
// A single usage event recorded against a resource (e.g. a dashboard view).
type ResourceStatsEvent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Identifies the object the event is about (group/resource/namespace/name).
	Key *ResourceKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Metric name, must be declared for the resource (e.g. view/query/error).
	Metric string `protobuf:"bytes,2,opt,name=metric,proto3" json:"metric,omitempty"`
	// Number of occurrences. 0 is treated as 1.
	Count         int64 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResourceStatsEvent) Reset() {
	*x = ResourceStatsEvent{}
	mi := &file_resource_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourceStatsEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceStatsEvent) ProtoMessage() {}

func (x *ResourceStatsEvent) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceStatsEvent.ProtoReflect.Descriptor instead.
func (*ResourceStatsEvent) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{31}
}

func (x *ResourceStatsEvent) GetKey() *ResourceKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *ResourceStatsEvent) GetMetric() string {
	if x != nil {
		return x.Metric
	}
	return ""
...
func (x *ResourceStatsEvent) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
type RecordEventRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Events may target multiple objects/metrics in a single call to reduce
	// client->storage RPC volume.
	Events        []*ResourceStatsEvent `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordEventRequest) GetEvents() []*ResourceStatsEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
type RecordEventResponse struct {
	...
	// Error details
	Error *ErrorResult `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	// Number of events that were dropped (untracked resource / invalid metric).
...
func (x *RecordEventResponse) GetError() *ErrorResult {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *RecordEventResponse) GetDropped() int64 {
	if x != nil {
		return x.Dropped
	}
	return 0
...
const file_resource_proto_rawDesc = "" +
	...
	"\x06object\x18\x04 \x01(\fR\x06object\x12\x1f\n" +
	"\vsort_fields\x18\x05 \x03(\tR\n" +
	"sortFields\"<\n" +
	"\x11QuotaUsageRequest\x12'\n" +
	"\x03key\x18\x01 \x01(\v2\x15.resource.ResourceKeyR\x03key\"k\n" +
	"\x12ResourceStatsEvent\x12'\n" +
	"\x03key\x18\x01 \x01(\v2\x15.resource.ResourceKeyR\x03key\x12\x16\n" +
	"\x06metric\x18\x02 \x01(\tR\x06metric\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05count\"J\n" +
	"\x12RecordEventRequest\x124\n" +
	"\x06events\x18\x01 \x03(\v2\x1c.resource.ResourceStatsEventR\x06events\"\\\n" +
	"\x13RecordEventResponse\x12+\n" +
	"\x05error\x18\x01 \x01(\v2\x15.resource.ErrorResultR\x05error\x12\x18\n" +
	"\adropped\x18\x02 \x01(\x03R\adropped\"m\n" +
	"\x12QuotaUsageResponse\x12+\n" +
	"\x05error\x18\x01 \x01(\v2\x15.resource.ErrorResultR\x05error\x12\x14\n" +
	"\x05usage\x18\x02 \x01(\x03R\x05usage\x12\x14\n" +
	...
	"\fNotOlderThan\x10\x032\xb9\x03\n" +
	"\rResourceStore\x125\n" +
	...
	"\x05Watch\x12\x16.resource.WatchRequest\x1a\x14.resource.WatchEvent0\x01\x12J\n" +
	"\vRecordEvent\x12\x1c.resource.RecordEventRequest\x1a\x1d.resource.RecordEventResponse2K\n" +
	"\tBulkStore\x12>\n" +
	...
	"\vDiagnostics\x12H\n" +
	"\tIsHealthy\x12\x1c.resource.HealthCheckRequest\x1a\x1d.resource.HealthCheckResponse2T\n" +
	"\x06Quotas\x12J\n" +
	"\rGetQuotaUsage\x12\x1b.resource.QuotaUsageRequest\x1a\x1c.resource.QuotaUsageResponseB;Z9github.com/grafana/grafana/pkg/storage/unified/resourcepbb\x06proto3"
...
var file_resource_proto_goTypes = []any{
	...
	(*ResourceStatsEvent)(nil),                        // 38: resource.ResourceStatsEvent
	(*RecordEventRequest)(nil),                        // 39: resource.RecordEventRequest
	(*RecordEventResponse)(nil),                       // 40: resource.RecordEventResponse
	(*QuotaUsageResponse)(nil),                        // 41: resource.QuotaUsageResponse
	(*WatchEvent_Resource)(nil),                       // 42: resource.WatchEvent.Resource
	(*BulkResponse_Summary)(nil),                      // 43: resource.BulkResponse.Summary
	(*BulkResponse_Rejected)(nil),                     // 44: resource.BulkResponse.Rejected
	(*ListManagedObjectsResponse_Item)(nil),           // 45: resource.ListManagedObjectsResponse.Item
	(*CountManagedObjectsResponse_ResourceCount)(nil), // 46: resource.CountManagedObjectsResponse.ResourceCount
	(*ResourceTableColumnDefinition_Properties)(nil),  // 47: resource.ResourceTableColumnDefinition.Properties
}
var file_resource_proto_depIdxs = []int32{
	...
	42, // 21: resource.WatchEvent.resource:type_name -> resource.WatchEvent.Resource
	42, // 22: resource.WatchEvent.previous:type_name -> resource.WatchEvent.Resource
	...
	43, // 26: resource.BulkResponse.summary:type_name -> resource.BulkResponse.Summary
	44, // 27: resource.BulkResponse.rejected:type_name -> resource.BulkResponse.Rejected
	45, // 28: resource.ListManagedObjectsResponse.items:type_name -> resource.ListManagedObjectsResponse.Item
	9,  // 29: resource.ListManagedObjectsResponse.error:type_name -> resource.ErrorResult
	46, // 30: resource.CountManagedObjectsResponse.items:type_name -> resource.CountManagedObjectsResponse.ResourceCount
	...
	47, // 36: resource.ResourceTableColumnDefinition.properties:type_name -> resource.ResourceTableColumnDefinition.Properties
	...
	7,  // 39: resource.ResourceStatsEvent.key:type_name -> resource.ResourceKey
	38, // 40: resource.RecordEventRequest.events:type_name -> resource.ResourceStatsEvent
	9,  // 41: resource.RecordEventResponse.error:type_name -> resource.ErrorResult
	9,  // 42: resource.QuotaUsageResponse.error:type_name -> resource.ErrorResult
	7,  // 43: resource.BulkResponse.Rejected.key:type_name -> resource.ResourceKey
	4,  // 44: resource.BulkResponse.Rejected.action:type_name -> resource.BulkRequest.Action
	7,  // 45: resource.ListManagedObjectsResponse.Item.object:type_name -> resource.ResourceKey
	18, // 46: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	12, // 47: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	14, // 48: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	16, // 49: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	22, // 50: resource.ResourceStore.List:input_type -> resource.ListRequest
	24, // 51: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	39, // 52: resource.ResourceStore.RecordEvent:input_type -> resource.RecordEventRequest
	26, // 53: resource.BulkStore.BulkProcess:input_type -> resource.BulkRequest
	30, // 54: resource.ManagedObjectIndex.CountManagedObjects:input_type -> resource.CountManagedObjectsRequest
	28, // 55: resource.ManagedObjectIndex.ListManagedObjects:input_type -> resource.ListManagedObjectsRequest
	32, // 56: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	37, // 57: resource.Quotas.GetQuotaUsage:input_type -> resource.QuotaUsageRequest
	19, // 58: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	13, // 59: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	15, // 60: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	17, // 61: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	23, // 62: resource.ResourceStore.List:output_type -> resource.ListResponse
	25, // 63: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	40, // 64: resource.ResourceStore.RecordEvent:output_type -> resource.RecordEventResponse
	27, // 65: resource.BulkStore.BulkProcess:output_type -> resource.BulkResponse
	31, // 66: resource.ManagedObjectIndex.CountManagedObjects:output_type -> resource.CountManagedObjectsResponse
	29, // 67: resource.ManagedObjectIndex.ListManagedObjects:output_type -> resource.ListManagedObjectsResponse
	33, // 68: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
	41, // 69: resource.Quotas.GetQuotaUsage:output_type -> resource.QuotaUsageResponse
