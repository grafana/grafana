...
type ResourceWrapper struct {
	...
	// Empty for keys_only requests.
	Value []byte `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	// Metadata returned for keys_only requests.
...
func (x *ResourceWrapper) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ResourceWrapper) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResourceWrapper) GetFolder() string {
	if x != nil {
		return x.Folder
	}
	return ""
...
type ResourceTableRow struct {
	...
	// Sort fields for the hit, encoded as strings. This can be used in ResourceSearchRequest search_after or search_before fields.
	// +optional
	SortFields    []string `protobuf:"bytes,5,rep,name=sort_fields,json=sortFields,proto3" json:"sort_fields,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResourceTableRow) GetSortFields() []string {
	if x != nil {
		return x.SortFields
	}
	return nil
...
// A single usage event recorded against an object (e.g. a dashboard view).
type ResourceEvent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Metric name, e.g. "views", "queries", "errors". Must be declared for the
	// object's group/resource.
	Metric string `protobuf:"bytes,1,opt,name=metric,proto3" json:"metric,omitempty"`
	// Increment to apply for the metric. Must not be negative.
...
func (x *ResourceEvent) GetMetric() string {
	if x != nil {
		return x.Metric
	}
	return ""
...
func (x *ResourceEvent) GetValue() uint64 {
	if x != nil {
		return x.Value
	}
	return 0
...
type RecordEventRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The object the events are recorded against (group/resource/namespace/name).
	Key *ResourceKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// The events to record.
	Events        []*ResourceEvent `protobuf:"bytes,2,rep,name=events,proto3" json:"events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordEventRequest) GetKey() *ResourceKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *RecordEventRequest) GetEvents() []*ResourceEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
// Empty on success; failures are reported via gRPC status.
...
type GetResourceDailyStatsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetResourceDailyStatsRequest) Reset() {
	*x = GetResourceDailyStatsRequest{}
	mi := &file_resource_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetResourceDailyStatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetResourceDailyStatsRequest) ProtoMessage() {}

func (x *GetResourceDailyStatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetResourceDailyStatsRequest.ProtoReflect.Descriptor instead.
func (*GetResourceDailyStatsRequest) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{35}
}

func (x *GetResourceDailyStatsRequest) GetKey() *ResourceKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *GetResourceDailyStatsRequest) GetFromDay() string {
	if x != nil {
		return x.FromDay
	}
	return ""
...
func (x *GetResourceDailyStatsRequest) GetToDay() string {
	if x != nil {
		return x.ToDay
	}
	return ""
...
func (x *DailyStat) GetMetrics() map[string]uint64 {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_resource_proto_rawDesc = string([]byte{
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x9c, 0x01,
	...
	,
	...
	0x63, 0x6f, 0x64, 0x65, 0x22, 0xba, 0x01, 0x0a, 0x0c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65,
	...
	,
	...
	0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x22, 0x4e, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x68, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6e, 0x22, 0x79, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x61, 0x0a, 0x0b, 0x52, 0x65, 0x61, 0x64, 0x52,
	...
	0x72, 0x63, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x7c, 0x0a, 0x0c, 0x52, 0x65,
	0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x05, 0x65, 0x72,
	...
	0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x53, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75,
	...
	0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x94, 0x01,
	0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x27, 0x0a,
	...
	0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x2d, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x6c,
	0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x2d, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x66, 0x69,
	0x65, 0x6c, 0x64, 0x73, 0x22, 0xcf, 0x03, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x22, 0xd7, 0x01, 0x0a, 0x0b, 0x42, 0x75, 0x6c,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x34, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1c, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x42, 0x75, 0x6c,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x6f, 0x6c, 0x64, 0x65, 0x72, 0x22, 0x3b, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x10, 0x03, 0x22, 0xda, 0x04, 0x0a, 0x0c, 0x42, 0x75, 0x6c, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
	...
	,
	...
	0x6b, 0x65, 0x79, 0x12, 0x34, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x42,
	0x75, 0x6c, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72,
	0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22,
	0x85, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f,
	...
	0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xd4, 0x02, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74,
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x22, 0x5e,
	0x0a, 0x1a, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f, 0x62,
	...
	0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x92,
	0x02, 0x0a, 0x1b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f,
	...
	0x72, 0x63, 0x65, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52,
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x1a, 0x7b, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x67,
	...
	0xb5, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x61, 0x62, 0x6c,
	...
	0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x6f, 0x72,
	0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x3c, 0x0a, 0x11, 0x51, 0x75, 0x6f, 0x74, 0x61,
	0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x03,
	...
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x6d, 0x0a, 0x12, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x55, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x05, 0x65,
	...
	0x74, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14,
	0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6c,
	0x69, 0x6d, 0x69, 0x74, 0x22, 0x3d, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x18,
	...
	0x6c, 0x75, 0x65, 0x22, 0x6e, 0x0a, 0x12, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	...
	,
	...
	0x28, 0x04, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x6c, 0x0a,
	0x1a, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x6e,
	...
	,
	...
	,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x32, 0xd9, 0x01, 0x0a, 0x12, 0x4d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x64, 0x65,
	0x78, 0x12, 0x62, 0x0a, 0x13, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x24, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x23, 0x2e, 0x72, 0x65,
	...
	0x1a, 0x24, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65,
	...
	0x54, 0x0a, 0x06, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x73, 0x12, 0x4a, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	0x51, 0x75, 0x6f, 0x74, 0x61, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1b, 0x2e, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x55, 0x73, 0x61, 0x67, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x2e, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73,
...
var file_resource_proto_goTypes = []any{
	...
	(*ResourceEvent)(nil),                             // 39: resource.ResourceEvent
	(*RecordEventRequest)(nil),                        // 40: resource.RecordEventRequest
	(*RecordEventResponse)(nil),                       // 41: resource.RecordEventResponse
	(*GetResourceDailyStatsRequest)(nil),              // 42: resource.GetResourceDailyStatsRequest
	(*DailyStat)(nil),                                 // 43: resource.DailyStat
	(*ListStoredResourcesRequest)(nil),                // 44: resource.ListStoredResourcesRequest
	(*ListStoredResourcesResponse)(nil),               // 45: resource.ListStoredResourcesResponse
	...
	(*ListManagedObjectsResponse_Item)(nil),           // 49: resource.ListManagedObjectsResponse.Item
	(*CountManagedObjectsResponse_ResourceCount)(nil), // 50: resource.CountManagedObjectsResponse.ResourceCount
	(*ResourceTableColumnDefinition_Properties)(nil),  // 51: resource.ResourceTableColumnDefinition.Properties
	nil, // 52: resource.DailyStat.MetricsEntry
	(*ListStoredResourcesResponse_StoredResource)(nil), // 53: resource.ListStoredResourcesResponse.StoredResource
}
var file_resource_proto_depIdxs = []int32{
	...
	49, // 28: resource.ListManagedObjectsResponse.items:type_name -> resource.ListManagedObjectsResponse.Item
	9,  // 29: resource.ListManagedObjectsResponse.error:type_name -> resource.ErrorResult
	50, // 30: resource.CountManagedObjectsResponse.items:type_name -> resource.CountManagedObjectsResponse.ResourceCount
	...
	51, // 36: resource.ResourceTableColumnDefinition.properties:type_name -> resource.ResourceTableColumnDefinition.Properties
	...
	7,  // 40: resource.RecordEventRequest.key:type_name -> resource.ResourceKey
	39, // 41: resource.RecordEventRequest.events:type_name -> resource.ResourceEvent
	7,  // 42: resource.GetResourceDailyStatsRequest.key:type_name -> resource.ResourceKey
	52, // 43: resource.DailyStat.metrics:type_name -> resource.DailyStat.MetricsEntry
	53, // 44: resource.ListStoredResourcesResponse.items:type_name -> resource.ListStoredResourcesResponse.StoredResource
	7,  // 45: resource.BulkResponse.Rejected.key:type_name -> resource.ResourceKey
	4,  // 46: resource.BulkResponse.Rejected.action:type_name -> resource.BulkRequest.Action
	7,  // 47: resource.ListManagedObjectsResponse.Item.object:type_name -> resource.ResourceKey
	18, // 48: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	12, // 49: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	14, // 50: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	16, // 51: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	22, // 52: resource.ResourceStore.List:input_type -> resource.ListRequest
	24, // 53: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	44, // 54: resource.ResourceStore.ListStoredResources:input_type -> resource.ListStoredResourcesRequest
	40, // 55: resource.ResourceStats.RecordEvent:input_type -> resource.RecordEventRequest
	42, // 56: resource.ResourceStats.GetResourceDailyStats:input_type -> resource.GetResourceDailyStatsRequest
	26, // 57: resource.BulkStore.BulkProcess:input_type -> resource.BulkRequest
	30, // 58: resource.ManagedObjectIndex.CountManagedObjects:input_type -> resource.CountManagedObjectsRequest
	28, // 59: resource.ManagedObjectIndex.ListManagedObjects:input_type -> resource.ListManagedObjectsRequest
	32, // 60: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	37, // 61: resource.Quotas.GetQuotaUsage:input_type -> resource.QuotaUsageRequest
	19, // 62: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	13, // 63: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	15, // 64: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	17, // 65: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	23, // 66: resource.ResourceStore.List:output_type -> resource.ListResponse
	25, // 67: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	45, // 68: resource.ResourceStore.ListStoredResources:output_type -> resource.ListStoredResourcesResponse
	41, // 69: resource.ResourceStats.RecordEvent:output_type -> resource.RecordEventResponse
	43, // 70: resource.ResourceStats.GetResourceDailyStats:output_type -> resource.DailyStat
	27, // 71: resource.BulkStore.BulkProcess:output_type -> resource.BulkResponse
	31, // 72: resource.ManagedObjectIndex.CountManagedObjects:output_type -> resource.CountManagedObjectsResponse
	29, // 73: resource.ManagedObjectIndex.ListManagedObjects:output_type -> resource.ListManagedObjectsResponse
	33, // 74: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
	38, // 75: resource.Quotas.GetQuotaUsage:output_type -> resource.QuotaUsageResponse
