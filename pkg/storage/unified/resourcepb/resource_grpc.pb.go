...
const (
	...
	ResourceStore_RecordEvent_FullMethodName = "/resource.ResourceStore/RecordEvent"
)
...
type ResourceStoreClient interface {
	...
	// Record usage events (views/queries/errors) against resources. Events are
	// accumulated in memory and flushed to storage asynchronously; this call
	// does not issue a full object update.
...
func (c *resourceStoreClient) RecordEvent(ctx context.Context, in *RecordEventRequest, opts ...grpc.CallOption) (*RecordEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RecordEventResponse)
	err := c.cc.Invoke(ctx, ResourceStore_RecordEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedResourceStoreServer) RecordEvent(context.Context, *RecordEventRequest) (*RecordEventResponse, error) {
...
func RegisterResourceStoreServer(s grpc.ServiceRegistrar, srv ResourceStoreServer) {
	// If the following call panics, it indicates UnimplementedResourceStoreServer was
...
func _ResourceStore_RecordEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecordEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResourceStoreServer).RecordEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ResourceStore_RecordEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceStoreServer).RecordEvent(ctx, req.(*RecordEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ResourceStore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ResourceStore_RecordEvent_Handler,
		},
	},
...
func (UnimplementedBulkStoreServer) BulkProcess(grpc.ClientStreamingServer[BulkRequest, BulkResponse]) error {
	return status.Error(codes.Unimplemented, "method BulkProcess not implemented")
}
...
func RegisterBulkStoreServer(s grpc.ServiceRegistrar, srv BulkStoreServer) {
	// If the following call panics, it indicates UnimplementedBulkStoreServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedManagedObjectIndexServer) CountManagedObjects(context.Context, *CountManagedObjectsRequest) (*CountManagedObjectsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CountManagedObjects not implemented")
}
func (UnimplementedManagedObjectIndexServer) ListManagedObjects(context.Context, *ListManagedObjectsRequest) (*ListManagedObjectsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListManagedObjects not implemented")
}
...
func RegisterManagedObjectIndexServer(s grpc.ServiceRegistrar, srv ManagedObjectIndexServer) {
	// If the following call panics, it indicates UnimplementedManagedObjectIndexServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedQuotasServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedQuotasServer) testEmbeddedByValue() {}
...
func RegisterQuotasServer(s grpc.ServiceRegistrar, srv QuotasServer) {
	// If the following call panics, it indicates UnimplementedQuotasServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
