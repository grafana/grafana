...
type RebuildIndexesResponse struct {
	...
	// Number of pods contacted (only set by distributor)
	ContactedPods int32 `protobuf:"varint,4,opt,name=contactedPods,proto3" json:"contactedPods,omitempty"`
	// Build times for indexes (set by search pods, aggregated as MIN by distributor)
	BuildTimes    []*RebuildIndexesResponse_IndexBuildTime `protobuf:"bytes,5,rep,name=buildTimes,proto3" json:"buildTimes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RebuildIndexesResponse) GetContactedPods() int32 {
	if x != nil {
		return x.ContactedPods
	}
	return 0
}
...
var file_search_proto_rawDesc = string([]byte{
	...
	0x4b, 0x65, 0x79, 0x52, 0x04, 0x6b, 0x65, 0x79, 0x73, 0x22, 0xe4, 0x02, 0x0a, 0x16, 0x52, 0x65,
	...
	0x24, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x65, 0x64, 0x50, 0x6f, 0x64, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x65,
	0x64, 0x50, 0x6f, 0x64, 0x73, 0x12, 0x4f, 0x0a, 0x0a, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x1a, 0x68, 0x0a, 0x0e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42,
