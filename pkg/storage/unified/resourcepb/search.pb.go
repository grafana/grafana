...
type ResourceSearchRequest struct {
	...
	// When true, use hybrid text + vector search with reciprocal rank fusion.
	Semantic bool `protobuf:"varint,16,opt,name=semantic,proto3" json:"semantic,omitempty"`
	// Number of nearest neighbours for the vector leg (default 10). Only used when semantic=true.
	K int64 `protobuf:"varint,17,opt,name=k,proto3" json:"k,omitempty"`
	// Vector field name override (default: querier config's vector_field). Only used when semantic=true.
	VectorField   string `protobuf:"bytes,18,opt,name=vector_field,json=vectorField,proto3" json:"vector_field,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResourceSearchRequest) GetSemantic() bool {
	if x != nil {
		return x.Semantic
	}
	return false
...
func (x *ResourceSearchRequest) GetK() int64 {
	if x != nil {
		return x.K
	}
	return 0
...
func (x *ResourceSearchRequest) GetVectorField() string {
	if x != nil {
...
const file_search_proto_rawDesc = "" +
	"\n" +
	"\fsearch.proto\x12\bresource\x1a\x0eresource.proto\"b\n" +
	"\x14ResourceStatsRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12\x14\n" +
	"\x05kinds\x18\x02 \x03(\tR\x05kinds\x12\x16\n" +
	"\x06folder\x18\x03 \x01(\tR\x06folder\"\xd2\x01\n" +
	"\x15ResourceStatsResponse\x12+\n" +
	"\x05error\x18\x01 \x01(\v2\x15.resource.ErrorResultR\x05error\x12;\n" +
	"\x05stats\x18\x02 \x03(\v2%.resource.ResourceStatsResponse.StatsR\x05stats\x1aO\n" +
	"\x05Stats\x12\x14\n" +
	"\x05group\x18\x01 \x01(\tR\x05group\x12\x1a\n" +
	"\bresource\x18\x02 \x01(\tR\bresource\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05count\"\xd8\a\n" +
	"\x15ResourceSearchRequest\x12/\n" +
	"\aoptions\x18\x01 \x01(\v2\x15.resource.ListOptionsR\aoptions\x123\n" +
	"\tfederated\x18\x02 \x03(\v2\x15.resource.ResourceKeyR\tfederated\x12\x14\n" +
	...
	"\x06sortBy\x18\x06 \x03(\v2$.resource.ResourceSearchRequest.SortR\x06sortBy\x12@\n" +
	"\x05facet\x18\a \x03(\v2*.resource.ResourceSearchRequest.FacetEntryR\x05facet\x12\x16\n" +
	"\x06fields\x18\b \x03(\tR\x06fields\x12\x18\n" +
	"\aexplain\x18\t \x01(\bR\aexplain\x12\x1d\n" +
	"\n" +
	"is_deleted\x18\n" +
	" \x01(\bR\tisDeleted\x12\x12\n" +
	"\x04page\x18\v \x01(\x03R\x04page\x12\x1e\n" +
	"\n" +
	"permission\x18\f \x01(\x03R\n" +
	"permission\x12M\n" +
	"\fquery_fields\x18\r \x03(\v2*.resource.ResourceSearchRequest.QueryFieldR\vqueryFields\x12!\n" +
	"\fsearch_after\x18\x0e \x03(\tR\vsearchAfter\x12#\n" +
	"\rsearch_before\x18\x0f \x03(\tR\fsearchBefore\x12\x1a\n" +
	"\bsemantic\x18\x10 \x01(\bR\bsemantic\x12\f\n" +
	"\x01k\x18\x11 \x01(\x03R\x01k\x12!\n" +
	"\fvector_field\x18\x12 \x01(\tR\vvectorField\x1a0\n" +
	"\x04Sort\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x12\n" +
	"\x04desc\x18\x02 \x01(\bR\x04desc\x1a3\n" +
	"\x05Facet\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x03R\x05limit\x1ad\n" +
	"\n" +
	"QueryField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12,\n" +
	"\x04type\x18\x02 \x01(\x0e2\x18.resource.QueryFieldTypeR\x04type\x12\x14\n" +
	"\x05boost\x18\x03 \x01(\x02R\x05boost\x1a_\n" +
	"\n" +
	"FacetEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.resource.ResourceSearchRequest.FacetR\x05value:\x028\x01\"\x95\x05\n" +
	"\x16ResourceSearchResponse\x12+\n" +
	"\x05error\x18\x01 \x01(\v2\x15.resource.ErrorResultR\x05error\x12'\n" +
	"\x03key\x18\x02 \x01(\v2\x15.resource.ResourceKeyR\x03key\x121\n" +
	"\aresults\x18\x03 \x01(\v2\x17.resource.ResourceTableR\aresults\x12\x1d\n" +
	"\n" +
	"total_hits\x18\x04 \x01(\x03R\ttotalHits\x12\x1d\n" +
	"\n" +
	"query_cost\x18\x05 \x01(\x01R\tqueryCost\x12\x1b\n" +
	"\tmax_score\x18\x06 \x01(\x01R\bmaxScore\x12A\n" +
	"\x05facet\x18\a \x03(\v2+.resource.ResourceSearchResponse.FacetEntryR\x05facet\x12)\n" +
	"\x10resource_version\x18\b \x01(\x03R\x0fresourceVersion\x1a\x8f\x01\n" +
	"\x05Facet\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x03R\x05total\x12\x18\n" +
	"\amissing\x18\x03 \x01(\x03R\amissing\x12@\n" +
	"\x05terms\x18\x04 \x03(\v2*.resource.ResourceSearchResponse.TermFacetR\x05terms\x1a5\n" +
	"\tTermFacet\x12\x12\n" +
	...
	"FacetEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.resource.ResourceSearchResponse.FacetR\x05value:\x028\x01\"`\n" +
	"\x15RebuildIndexesRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12)\n" +
	"\x04keys\x18\x02 \x03(\v2\x15.resource.ResourceKeyR\x04keys\"\xf4\x02\n" +
	"\x16RebuildIndexesResponse\x12\"\n" +
	"\frebuildCount\x18\x01 \x01(\x03R\frebuildCount\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\x12+\n" +
	"\x05error\x18\x03 \x01(\v2\x15.resource.ErrorResultR\x05error\x12O\n" +
	"\n" +
	"buildTimes\x18\x04 \x03(\v2/.resource.RebuildIndexesResponse.IndexBuildTimeR\n" +
	"buildTimes\x124\n" +
	"\x15ContactedAllInstances\x18\x05 \x01(\bR\x15ContactedAllInstances\x1ah\n" +
	"\x0eIndexBuildTime\x12\x14\n" +
	"\x05group\x18\x01 \x01(\tR\x05group\x12\x1a\n" +
	"\bresource\x18\x02 \x01(\tR\bresource\x12$\n" +
	"\rbuildTimeUnix\x18\x03 \x01(\x03R\rbuildTimeUnix*@\n" +
	"\x0eQueryFieldType\x12\v\n" +
	"\aDEFAULT\x10\x00\x12\b\n" +
	"\x04TEXT\x10\x01\x12\v\n" +
	"\aKEYWORD\x10\x02\x12\n" +
	"\n" +
	"\x06PHRASE\x10\x032\xfe\x01\n" +
	"\rResourceIndex\x12K\n" +
	"\x06Search\x12\x1f.resource.ResourceSearchRequest\x1a .resource.ResourceSearchResponse\x12K\n" +
	"\bGetStats\x12\x1e.resource.ResourceStatsRequest\x1a\x1f.resource.ResourceStatsResponse\x12S\n" +
	"\x0eRebuildIndexes\x12\x1f.resource.RebuildIndexesRequest\x1a .resource.RebuildIndexesResponseB;Z9github.com/grafana/grafana/pkg/storage/unified/resourcepbb\x06proto3"
