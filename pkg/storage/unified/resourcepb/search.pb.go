...
const file_search_proto_rawDesc = "" +
	...
	"\x06folder\x18\x03 \x03(\tR\x06folder\"\xd2\x01\n" +
	...
	"\x05count\x18\x03 \x01(\x03R\x05count\"\x8b\a\n" +
	...
	"\rsearch_before\x18\x0f \x03(\tR\fsearchBefore\x1a0\n" +
	"\x04Sort\x12\x14\n" +
	...
	"\rbuildTimeUnix\x18\x03 \x01(\x03R\rbuildTimeUnix\"\x9b\x01\n" +
	...
	"\afilters\x18\x04 \x03(\v2\x15.resource.RequirementR\afilters\"{\n" +
	"\x14VectorSearchResponse\x12+\n" +
	"\x05error\x18\x01 \x01(\v2\x15.resource.ErrorResultR\x05error\x126\n" +
	"\aresults\x18\x02 \x03(\v2\x1c.resource.VectorSearchResultR\aresults\"\xc4\x01\n" +
	"\x12VectorSearchResult\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vsubresource\x18\x03 \x01(\tR\vsubresource\x12\x18\n" +
	"\acontent\x18\x04 \x01(\tR\acontent\x12\x14\n" +
	"\x05score\x18\x05 \x01(\x01R\x05score\x12\x16\n" +
	"\x06folder\x18\x06 \x01(\tR\x06folder\x12\x1a\n" +
	...
	"\x0eRebuildIndexes\x12\x1f.resource.RebuildIndexesRequest\x1a .resource.RebuildIndexesResponse\x12M\n" +
	"\fVectorSearch\x12\x1d.resource.VectorSearchRequest\x1a\x1e.resource.VectorSearchResponseB;Z9github.com/grafana/grafana/pkg/storage/unified/resourcepbb\x06proto3"
