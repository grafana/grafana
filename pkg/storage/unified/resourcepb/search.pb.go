...
var file_search_proto_rawDesc = string([]byte{
	...
	0x10, 0x03, 0x32, 0xfe, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49,
...
var file_search_proto_goTypes = []any{
	...
	(*RebuildIndexesResponse_IndexBuildTime)(nil), // 15: resource.RebuildIndexesResponse.IndexBuildTime
	(*ErrorResult)(nil),                           // 16: resource.ErrorResult
	(*ListOptions)(nil),                           // 17: resource.ListOptions
	(*ResourceKey)(nil),                           // 18: resource.ResourceKey
	(*ResourceTable)(nil),                         // 19: resource.ResourceTable
}
var file_search_proto_depIdxs = []int32{
	16, // 0: resource.ResourceStatsResponse.error:type_name -> resource.ErrorResult
	7,  // 1: resource.ResourceStatsResponse.stats:type_name -> resource.ResourceStatsResponse.Stats
	17, // 2: resource.ResourceSearchRequest.options:type_name -> resource.ListOptions
	18, // 3: resource.ResourceSearchRequest.federated:type_name -> resource.ResourceKey
	...
	16, // 7: resource.ResourceSearchResponse.error:type_name -> resource.ErrorResult
	18, // 8: resource.ResourceSearchResponse.key:type_name -> resource.ResourceKey
	19, // 9: resource.ResourceSearchResponse.results:type_name -> resource.ResourceTable
	14, // 10: resource.ResourceSearchResponse.facet:type_name -> resource.ResourceSearchResponse.FacetEntry
	18, // 11: resource.RebuildIndexesRequest.keys:type_name -> resource.ResourceKey
	16, // 12: resource.RebuildIndexesResponse.error:type_name -> resource.ErrorResult
	15, // 13: resource.RebuildIndexesResponse.buildTimes:type_name -> resource.RebuildIndexesResponse.IndexBuildTime
	0,  // 14: resource.ResourceSearchRequest.QueryField.type:type_name -> resource.QueryFieldType
	9,  // 15: resource.ResourceSearchRequest.FacetEntry.value:type_name -> resource.ResourceSearchRequest.Facet
	13, // 16: resource.ResourceSearchResponse.Facet.terms:type_name -> resource.ResourceSearchResponse.TermFacet
	12, // 17: resource.ResourceSearchResponse.FacetEntry.value:type_name -> resource.ResourceSearchResponse.Facet
	3,  // 18: resource.ResourceIndex.Search:input_type -> resource.ResourceSearchRequest
	1,  // 19: resource.ResourceIndex.GetStats:input_type -> resource.ResourceStatsRequest
	5,  // 20: resource.ResourceIndex.RebuildIndexes:input_type -> resource.RebuildIndexesRequest
	4,  // 21: resource.ResourceIndex.Search:output_type -> resource.ResourceSearchResponse
	2,  // 22: resource.ResourceIndex.GetStats:output_type -> resource.ResourceStatsResponse
	6,  // 23: resource.ResourceIndex.RebuildIndexes:output_type -> resource.RebuildIndexesResponse
