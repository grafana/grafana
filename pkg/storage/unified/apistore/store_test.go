...
func init() {
	...
	storagetesting.NewContext = func() context.Context {
		testUserA := &identity.StaticRequester{
			...
			IDToken: "eyJhbGciOiJFUzI1NiIsInR5cCI6Imp3dCJ9." +
				"eyJhdWQiOiJncmFmYW5hIiwiYXV0aGVudGljYXRlZ" +
				"EJ5IjoiZXh0ZW5kZWRfand0IiwiZW1haWwiOiJ0ZX" +
				"N0dXNlckBleGFtcGxlLm9yZyIsImV4cCI6MjA0MTQ" +
				"5MzA3MywiaWF0IjoxNzI1OTcxMDc3LCJpZGVudGlm" +
				"aWVyIjoidXNlcjoxMjMiLCJuYW1lc3BhY2UiOiJkZ" +
				"WZhdWx0Iiwic3ViIjoidXNlcjoxMjMiLCJ0eXAiOi" +
				"Jqd3QiLCJ0eXBlIjoidXNlciIsInVzZXJuYW1lIjo" +
				"idGVzdHVzZXIifQ." +
				"5EV617rb5v1JFTnqnA0yLVIkpWpYyzC8vuspNsH-L" +
				"fnUJx-tgC56gDkV28pMQ-44Mrui5a4390F-VJijN4ALVw",
			// This token has been generated by using https://github.com/gamab/simple-jwt-creator
