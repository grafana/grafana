...
var (
	...
	sqlExistsSecureValueUsingKeeper = mustTemplate("keeper_exists_secure_value.sql")
...
type existsSecureValueUsingKeeper struct {
	sqltemplate.SQLTemplate
	Namespace string
	Name      string
}

func (r existsSecureValueUsingKeeper) Validate() error {
	return nil // TODO
}
