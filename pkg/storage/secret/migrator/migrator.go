...
func (*SecretDB) AddMigration(mg *migrator.Migrator) {
	...
	mg.AddMigration("add owner_reference_uid column to "+TableNameSecureValue, migrator.NewAddColumnMigration(secureValueTable, &migrator.Column{
		Name:     "owner_reference_uid",
		Type:     migrator.DB_NVarchar,
		Length:   253, // Limit enforced by K8s.
		Nullable: true,
	}))
