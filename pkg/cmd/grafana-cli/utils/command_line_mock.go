...
// Application provides a mock function with no fields
...
// FlagNames provides a mock function with no fields
func (_m *MockCommandLine) FlagNames() []string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for FlagNames")
	}
...
func (_m *MockCommandLine) Generic(name string) interface{} {
	...
	if len(ret) == 0 {
		panic("no return value specified for Generic")
	}
...
// GrafanaComAPIToken provides a mock function with no fields
func (_m *MockCommandLine) GrafanaComAPIToken() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GrafanaComAPIToken")
	}
...
// PluginDirectory provides a mock function with no fields
func (_m *MockCommandLine) PluginDirectory() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PluginDirectory")
	}
...
// PluginRepoURL provides a mock function with no fields
func (_m *MockCommandLine) PluginRepoURL() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PluginRepoURL")
	}
...
// PluginURL provides a mock function with no fields
func (_m *MockCommandLine) PluginURL() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PluginURL")
	}
...
// ShowHelp provides a mock function with no fields
func (_m *MockCommandLine) ShowHelp() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ShowHelp")
	}
...
// ShowVersion provides a mock function with no fields
