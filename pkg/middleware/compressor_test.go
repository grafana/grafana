...
func TestNegotiateEncoding(t *testing.T) {
	preferredEncodings := []string{"zstd", "br", "gzip", "deflate"}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := negotiateEncoding(tt.acceptEncoding, preferredEncodings)
...
func TestNegotiateEncodingPrefersConfiguredOrder(t *testing.T) {
	result := negotiateEncoding("gzip, br, zstd", []string{"br", "gzip"})
	assert.Equal(t, "br", result)
}

func TestNegotiateEncodingDefaultsToGzipWhenNoPreferenceConfigured(t *testing.T) {
	result := negotiateEncoding("gzip, br, zstd", normalizePreferredEncodings(nil))
...
func TestCompressorMiddleware(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			middleware := Compressor([]string{"zstd", "br", "gzip", "deflate"})(handler)
...
func TestCompressorDefaultUsesGzip(t *testing.T) {
	body := "default gzip test"
	...
	middleware := Compressor(nil)(handler)
	middleware.ServeHTTP(rw, req)
...
func TestCompressionDisabledDoesNotSetContentEncoding(t *testing.T) {
	body := "plain response when compression disabled"
	...
	if enableCompression {
		wrapped = Compressor([]string{"zstd", "br", "deflate", "gzip"})(wrapped)
	}
