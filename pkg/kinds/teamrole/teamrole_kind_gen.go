...
const rootrel string = "kinds/teamrole"

// TODO standard generated docs
type Kind struct {
	kindsys.Core
	lin    thema.ConvergentLineage[*TeamRole]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*TeamRole]
}
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*TeamRole](cursch, &TeamRole{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("teamrole.json")
...
// to the the TeamRole type generated from the current schema, v0.0.
func (k *Kind) ConvergentLineage() thema.ConvergentLineage[*TeamRole] {
	return k.lin
}

// JSONValueMux is a version multiplexer that maps a []byte containing JSON data
// at any schematized dashboard version to an instance of TeamRole.
//
// Validation and translation errors emitted from this func will identify the
// input bytes as "dashboard.json".
//
// This is a thin wrapper around Thema's [vmux.ValueMux].
func (k *Kind) JSONValueMux(b []byte) (*TeamRole, thema.TranslationLacunas, error) {
	return k.valmux(b)
}
