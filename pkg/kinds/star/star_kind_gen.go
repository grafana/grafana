...
const rootrel string = "kinds/star"

// TODO standard generated docs
type Kind struct {
	lin    thema.ConvergentLineage[*Star]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Star]
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Star](cursch, &Star{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("star.json")
...
// representing the static properties declared in the star kind.
//
