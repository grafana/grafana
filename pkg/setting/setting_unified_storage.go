...
func (cfg *Cfg) setUnifiedStorageConfig() {
	...
	cfg.IndexEnableSharding = section.Key("index_enable_sharding").MustBool(false)
	cfg.IndexMemberlistBindAddr = section.Key("index_memberlist_bind_addr").MustString("127.0.0.1")
	cfg.IndexMemberlistJoinMember = section.Key("index_memberlist_join_member").String()
	cfg.IndexRingDebugServerPort = section.Key("index_ring_debug_server_port").String()
