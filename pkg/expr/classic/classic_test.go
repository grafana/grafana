...
func TestConditionsCmd(t *testing.T) {
	tests := []struct {
		...
		vars: mathexp.Vars{
			"A": mathexp.Results{
				Values: []mathexp.Value{
					newSeries(util.Pointer(1), util.Pointer(5)),
				},
			},
		},
		cmd: &ConditionsCmd{
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(3)}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(4)}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(2)}})
			return newResults(v)
		},
	}, {
		...
		vars: mathexp.Vars{
			"A": mathexp.Results{
				Values: []mathexp.Value{
					newSeries(util.Pointer(1), util.Pointer(5)),
					newSeries(util.Pointer(2), util.Pointer(10)),
				},
			},
		},
		cmd: &ConditionsCmd{
		...
		vars: mathexp.Vars{
			"A": mathexp.Results{
				Values: []mathexp.Value{
					newSeries(util.Pointer(1), util.Pointer(5)),
					newSeriesWithLabels(data.Labels{"foo": "bar"}, util.Pointer(2), util.Pointer(10)),
				},
			},
		},
		cmd: &ConditionsCmd{
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(2), Labels: data.Labels{"foo": "bar"}}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(5)}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(1)}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(5)}, {Value: util.Pointer(1)}})
			return newResults(v)
		},
	}, {
		...
		vars: mathexp.Vars{
			"A": mathexp.Results{
				Values: []mathexp.Value{
					newNumber(util.Pointer(5)),
					newNumber(util.Pointer(10)),
					newNumber(util.Pointer(15)),
				},
			},
		},
		cmd: &ConditionsCmd{
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(1))
			v.SetMeta([]EvalMatch{
				{Value: util.Pointer(5)},
				{Value: util.Pointer(10)},
				{Value: util.Pointer(15)},
			})
			return newResults(v)
		},
	}, {
		...
		vars: mathexp.Vars{
			...
			"B": mathexp.Results{
				Values: []mathexp.Value{newSeries(util.Pointer(5))},
			},
		},
		cmd: &ConditionsCmd{
			Conditions: []condition{
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(0))
			v.SetMeta([]EvalMatch{{Metric: "NoData"}, {Value: util.Pointer(5)}})
			return newResults(v)
		},
	}, {
		...
		expected: func() mathexp.Results {
			v := newNumber(util.Pointer(0))
			v.SetMeta([]EvalMatch{{Value: util.Pointer(5)}, {Metric: "NoData"}})
			return newResults(v)
		},
	}, {
