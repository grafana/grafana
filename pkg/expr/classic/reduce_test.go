...
func TestReducer(t *testing.T) {
	var tests = []struct {
	...
	}{
		{
			name:           "sum",
			reducer:        reducer("sum"),
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(3)),
			expectedNumber: newNumber(util.Pointer(6)),
		},
		{
			name:           "min",
			reducer:        reducer("min"),
			inputSeries:    newSeries(util.Pointer(3), util.Pointer(2), util.Pointer(1)),
			expectedNumber: newNumber(util.Pointer(1)),
		},
		{
		...
		},
		{
			...
			reducer:        reducer("max"),
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(3)),
			expectedNumber: newNumber(util.Pointer(3)),
		},
		{
			name:           "count",
			reducer:        reducer("count"),
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(3000)),
			expectedNumber: newNumber(util.Pointer(3)),
		},
		{
			name:           "last",
			...
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(3000)),
			expectedNumber: newNumber(util.Pointer(3000)),
		},
		{
			name:           "median with odd amount of numbers",
			reducer:        reducer("median"),
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(3000)),
			expectedNumber: newNumber(util.Pointer(2)),
		},
		{
			name:           "median with even amount of numbers",
			reducer:        reducer("median"),
			inputSeries:    newSeries(util.Pointer(1), util.Pointer(2), util.Pointer(4), util.Pointer(3000)),
			expectedNumber: newNumber(util.Pointer(3)),
		},
		{
			name:           "median with one value",
			reducer:        reducer("median"),
			inputSeries:    newSeries(util.Pointer(1)),
			expectedNumber: newNumber(util.Pointer(1)),
		},
		{
			name:           "median should ignore null values",
			reducer:        reducer("median"),
			inputSeries:    newSeries(nil, nil, nil, util.Pointer(1), util.Pointer(2), util.Pointer(3)),
			expectedNumber: newNumber(util.Pointer(2)),
		},
		{
			name:           "avg",
		...
		},
		{
			...
			reducer:        reducer("avg"),
			inputSeries:    newSeries(util.Pointer(3), nil, nil, util.Pointer(3)),
			expectedNumber: newNumber(util.Pointer(3)),
		},
		{
			name:           "count_non_null with mixed null/real values",
			reducer:        reducer("count_non_null"),
			inputSeries:    newSeries(nil, nil, util.Pointer(3), util.Pointer(4)),
			expectedNumber: newNumber(util.Pointer(2)),
		},
		{
			name:           "count_non_null with mixed null/real values",
...
func TestDiffReducer(t *testing.T) {
	var tests = []struct {
	...
	}{
		{
			...
			inputSeries:    newSeries(util.Pointer(30)),
			expectedNumber: newNumber(util.Pointer(0)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(util.Pointer(30), util.Pointer(40)),
			expectedNumber: newNumber(util.Pointer(10)),
		},
		{
			name:           "diff two positive points [2]",
			inputSeries:    newSeries(util.Pointer(30), util.Pointer(20)),
			expectedNumber: newNumber(util.Pointer(-10)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(util.Pointer(-30), util.Pointer(-10)),
			expectedNumber: newNumber(util.Pointer(20)),
		},
		{
			name:           "diff of one positive and one negative point",
			inputSeries:    newSeries(util.Pointer(30), util.Pointer(-40)),
			expectedNumber: newNumber(util.Pointer(-70)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(util.Pointer(30), util.Pointer(40), util.Pointer(50)),
			expectedNumber: newNumber(util.Pointer(20)),
		},
		{
