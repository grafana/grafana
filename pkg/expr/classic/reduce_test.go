...
func TestReducer(t *testing.T) {
	var tests = []struct {
	...
	}{
		{
			name:           "sum",
			reducer:        reducer("sum"),
			inputSeries:    newSeries(new(1.0), new(2.0), new(3.0)),
			expectedNumber: newNumber(new(6.0)),
		},
		{
			name:           "min",
			reducer:        reducer("min"),
			inputSeries:    newSeries(new(3.0), new(2.0), new(1.0)),
			expectedNumber: newNumber(new(1.0)),
		},
		{
			name:           "min with NaNs only",
			reducer:        reducer("min"),
			inputSeries:    newSeries(new(math.NaN()), new(math.NaN()), new(math.NaN())),
		...
		},
		{
			...
			reducer:        reducer("max"),
			inputSeries:    newSeries(new(1.0), new(2.0), new(3.0)),
			expectedNumber: newNumber(new(3.0)),
		},
		{
			name:           "count",
			reducer:        reducer("count"),
			inputSeries:    newSeries(new(1.0), new(2.0), new(3000.0)),
			expectedNumber: newNumber(new(3.0)),
		},
		{
			name:           "last",
			...
			inputSeries:    newSeries(new(1.0), new(2.0), new(3000.0)),
			expectedNumber: newNumber(new(3000.0)),
		},
		{
			name:           "median with odd amount of numbers",
			reducer:        reducer("median"),
			inputSeries:    newSeries(new(1.0), new(2.0), new(3000.0)),
			expectedNumber: newNumber(new(2.0)),
		},
		{
			name:           "median with even amount of numbers",
			reducer:        reducer("median"),
			inputSeries:    newSeries(new(1.0), new(2.0), new(4.0), new(3000.0)),
			expectedNumber: newNumber(new(3.0)),
		},
		{
			name:           "median with one value",
			reducer:        reducer("median"),
			inputSeries:    newSeries(new(1.0)),
			expectedNumber: newNumber(new(1.0)),
		},
		{
			name:           "median should ignore null values",
			reducer:        reducer("median"),
			inputSeries:    newSeries(nil, nil, nil, new(1.0), new(2.0), new(3.0)),
			expectedNumber: newNumber(new(2.0)),
		},
		{
			name:           "avg",
		...
		},
		{
			...
			reducer:        reducer("avg"),
			inputSeries:    newSeries(new(3.0), nil, nil, new(3.0)),
			expectedNumber: newNumber(new(3.0)),
		},
		{
			name:           "count_non_null with mixed null/real values",
			reducer:        reducer("count_non_null"),
			inputSeries:    newSeries(nil, nil, new(3.0), new(4.0)),
			expectedNumber: newNumber(new(2.0)),
		},
		{
			name:           "count_non_null with mixed null/real values",
...
func TestDiffReducer(t *testing.T) {
	var tests = []struct {
	...
	}{
		{
			...
			inputSeries:    newSeries(new(30.0)),
			expectedNumber: newNumber(new(0.0)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(new(30.0), new(40.0)),
			expectedNumber: newNumber(new(10.0)),
		},
		{
			name:           "diff two positive points [2]",
			inputSeries:    newSeries(new(30.0), new(20.0)),
			expectedNumber: newNumber(new(-10.0)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(new(-30.0), new(-10.0)),
			expectedNumber: newNumber(new(20.0)),
		},
		{
			name:           "diff of one positive and one negative point",
			inputSeries:    newSeries(new(30.0), new(-40.0)),
			expectedNumber: newNumber(new(-70.0)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(new(30.0), new(40.0), new(50.0)),
			expectedNumber: newNumber(new(20.0)),
		},
		{
...
func TestPercentDiffReducer(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			inputSeries:    newSeries(new(30.0), new(40.0)),
			expectedNumber: newNumber(new(33.33333333333333)),
		},
		{
		...
		},
		{
			...
			inputSeries:    newSeries(new(-30.0), new(-10.0)),
			expectedNumber: newNumber(new(66.66666666666666)),
		},
		{
			name:           "percent_diff of one positive and one negative point",
			inputSeries:    newSeries(new(30.0), new(-40.0)),
			expectedNumber: newNumber(new(-233.33333333333334)),
		},
		{
