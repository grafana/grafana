...
func TestRangedEvaluator(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			evaluator:   &rangedEvaluator{"within_range", 1, 100},
			inputNumber: newNumber(new(300.0)),
			expected:    false,
		},
		{
		...
		// outside
		{
			...
			inputNumber: newNumber(new(1000.0)),
			expected:    true,
		},
		{
			name:        "value 50 is outside range 1, 100: false",
			evaluator:   &rangedEvaluator{"outside_range", 1, 100},
			inputNumber: newNumber(new(50.0)),
			expected:    false,
		},
		{
		...
		},
		{
			...
			evaluator:   &rangedEvaluator{"outside_range", 1, 100},
			inputNumber: newNumber(new(100.)),
			expected:    false,
		},
		{
			name:        "value 1 is outside range 1, 100: false",
			evaluator:   &rangedEvaluator{"outside_range", 1, 100},
			inputNumber: newNumber(new(1.)),
			expected:    false,
		},
		{
