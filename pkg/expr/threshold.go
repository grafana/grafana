...
func (tc *ThresholdCommand) Execute(ctx context.Context, vars mathexp.Vars, timeRange models.TimeRange) (mathexp.Results, error) {
	...
	return mathCommand.Execute(ctx, vars, timeRange)
}
