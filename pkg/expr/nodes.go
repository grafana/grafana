...
func buildCMDNode(dp *simple.DirectedGraph, rn *rawNode, r LoadedMetricsReader, toggles featuremgmt.FeatureToggles) (*CMDNode, error) {
	...
	case TypeThreshold:
		node.Command, err = UnmarshalThresholdCommand(rn, r, toggles)
	default:
