...
require (
	...
	github.com/google/uuid v1.5.0 // indirect; @grafana/backend-platform
	...
	google.golang.org/grpc v1.60.1 // indirect; @grafana/plugins-platform-backend
	google.golang.org/protobuf v1.32.0 // indirect; @grafana/plugins-platform-backend
...
require github.com/urfave/cli v1.22.14 // @grafana/backend-platform
