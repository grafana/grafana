...
require (
	...
	github.com/docker/docker v28.5.0+incompatible // @grafana/grafana-developer-enablement-squad
	...
	golang.org/x/time v0.13.0 // indirect; @grafana/grafana-backend-group
