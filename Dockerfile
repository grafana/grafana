...
ARG JS_IMAGE=aus-harborpd-01.bmc.com/helix-cloudops/adereporting-base-node:22-alpine
...
ARG GO_IMAGE=aus-harborpd-01.bmc.com/helix-cloudops/adereporting-base-golang:1.24.11-alpine
