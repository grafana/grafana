...
Thanks for your interest in contributing to Grafana! We welcome all people who wants to contribute in a healthy and constructive manner within our community. To help us create a safe and positive community experience for all, we require all participants to adhere to the [Code of Conduct](CODE_OF_CONDUCT.md).
...
For more ways you can contribute, check out the [Open Source Guides](https://opensource.guide/how-to-contribute/).
...
- [Beginner-friendly](https://github.com/grafana/grafana/issues?q=is%3Aopen+is%3Aissue+label%3A%22beginner+friendly%22) issues shouldn't require more than changing a small number of lines.
...
When you're ready to contribute your change, it's time to [Create a pull request](/contribute/pull-request.md).

#### Contributor License Agreement (CLA)

Before we can accept your pull request, we need you to [submit a CLA](https://grafana.com/docs/contribute/cla/).
