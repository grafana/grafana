...
echo "    }"
echo ""
echo "  See public/app/api/clients/folder/v1beta1/hooks.ts for a"
echo "  reference example using config.featureToggles.foldersAppPlatformAPI."
echo ""
...
echo "Questions? #proj-mt-frontend"
exit 1
