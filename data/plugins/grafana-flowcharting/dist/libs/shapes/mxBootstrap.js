...
mxShapeBootstrapRating.prototype.customProperties = [{
  ...
  name: 'ratingScale',
  dispName: 'Rating Scale',
  type: 'int',
  min: 1,
  defVal: 5
}, {
  name: 'emptyFillColor',
  dispName: 'Inactive Color',
  type: 'color',
  defVal: 'none'
}, {
  name: 'grade',
...
mxShapeBootstrapRating.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  if (ratingStyle === mxShapeBootstrapRating.prototype.cst.RATING_STAR) {
    ...
    for (var i = 0; i < grade; i++) {
      ...
      c.curveTo(i * h * 1.2 + h * 0.558, h * 0.908, i * h * 1.2 + h * 0.778, h * 0.682, i * h * 1.2 + h * 0.916, h * 0.54);
      c.curveTo(i * h * 1.2 + h * 1.039, h * 0.414, i * h * 1.2 + h * 1.036, h * 0.229, i * h * 1.2 + h * 0.924, h * 0.115);
      c.curveTo(i * h * 1.2 + h * 0.812, 0, i * h * 1.2 + h * 0.631, 0, i * h * 1.2 + h * 0.519, h * 0.115);
      c.curveTo(i * h * 1.2 + h * 0.408, 0, i * h * 1.2 + h * 0.227, 0, i * h * 1.2 + h * 0.115, h * 0.115);
      c.curveTo(i * h * 1.2 + h * 0.03, h * 0.229, i * h * 1.2, h * 0.414, i * h * 1.2 + h * 0.123, h * 0.54);
      c.close();
      c.fillAndStroke();
    }
  }
