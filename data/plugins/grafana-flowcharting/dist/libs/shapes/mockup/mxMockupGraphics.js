...
mxShapeMockupColumnChart.prototype.customProperties = [{
  name: 'strokeColor2',
  dispName: 'Bar Stroke Color',
  type: 'color'
}, {
  name: 'strokeColor3',
  dispName: 'Coord System Color',
  type: 'color'
}, {
  name: 'fillColor2',
  dispName: 'Bar1 Color',
...
mxShapeMockupLineChart.prototype.customProperties = [{
  ...
  name: 'strokeColor3',
  dispName: 'Line1 Color',
  type: 'color'
}, {
  name: 'strokeColor4',
  dispName: 'Line2 Color',
  type: 'color'
}];
...
mxShapeMockupPieChart.prototype.customProperties = [{
  ...
  type: 'int',
  defVal: 4,
  dependentProps: ['partColors', 'parts']
}, {
  name: 'partColors',
...
mxShapeMockupBubbleChart.prototype.customProperties = [{
  ...
  name: 'fillColor2',
  dispName: 'Bubble1 Color',
  type: 'color'
}, {
  name: 'fillColor3',
  dispName: 'Bubble2 Color',
  type: 'color'
}];
...
mxShapeMockupGauge.prototype.customProperties = [{
  name: 'scaleColors',
  dispName: 'Scale Colors',
  type: 'String'
}, {
  name: 'needleColor',
  dispName: 'Needle Color',
  type: 'color'
}, {
  name: 'gaugePos',
  dispName: 'Needle Position',
  type: 'float',
  min: 0,
  max: 100,
  defVal: 25
