...
mxShapeIOS7MarginRect.prototype.customProperties = [{
  name: 'rx',
  dispName: 'Hor. Rounding Size',
  type: 'float',
  min: 0,
  defVal: 3
}, {
  name: 'ry',
  dispName: 'Ver. Rounding Size',
  type: 'float',
  min: 0,
  defVal: 3
}, {
  name: 'rectMargin',
  dispName: 'Global Margin',
  type: 'float',
  min: 0,
  defVal: 5
}, {
  ...
  name: 'rectMarginLeft',
  dispName: 'Left Margin',
  type: 'float',
  min: 0,
  defVal: 0
}, {
  name: 'rectMarginBottom',
  dispName: 'Bottom Margin',
  type: 'float',
  min: 0,
  defVal: 0
}, {
  name: 'rectMarginRight',
  dispName: 'Right Margin',
  type: 'float',
  min: 0,
  defVal: 0
}];
