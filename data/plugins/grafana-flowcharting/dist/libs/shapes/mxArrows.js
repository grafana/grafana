...
mxShapeArrows2Arrow.prototype.getLabelBounds = function (rect) {
  if (mxUtils.getValue(this.style, "boundedLbl", false)) {
    ...
    if (mxUtils.getValue(this.style, "flipH", false)) {
      if (direction == mxConstants.DIRECTION_WEST) direction = mxConstants.DIRECTION_EAST;else if (direction == mxConstants.DIRECTION_EAST) direction = mxConstants.DIRECTION_WEST;
    }

    if (mxUtils.getValue(this.style, "flipV", false)) {
      if (direction == mxConstants.DIRECTION_NORTH) direction = mxConstants.DIRECTION_SOUTH;else if (direction == mxConstants.DIRECTION_SOUTH) direction = mxConstants.DIRECTION_NORTH;
    }
...
mxShapeArrows2SharpArrow.prototype.customProperties = [{
  name: 'dx1',
  dispName: 'Arrowhead Arrow Width',
  type: 'float',
  min: 0,
  defVal: 18
}, {
  name: 'dy1',
  dispName: 'Arrow Arrow Width',
  type: 'float',
  min: 0,
  max: 1,
  defVal: 0.67
...
mxShapeArrows2SharpArrow2.prototype.customProperties = [{
  ...
  name: 'dx3',
  dispName: 'Arrowhead Edge X',
  type: 'float',
  min: 0,
  defVal: 27
}, {
  name: 'dy3',
  dispName: 'Arrowhead Edge Y',
  type: 'float',
  min: 0,
  max: 1,
  defVal: 0.15
