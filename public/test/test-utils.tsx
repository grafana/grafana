...
import { LocationServiceRouter } from 'app/core/navigation/LocationServiceRouter';
...
const getWrapper = ({
  ...
  /**
   * Conditional router - either a LocationServiceRouter or just a Fragment
   */
  const PotentialRouter = renderWithRouter
    ? ({ children }: PropsWithChildren) => (
        <LocationServiceRouter service={locationService}>{children}</LocationServiceRouter>
      )
    : Fragment;
