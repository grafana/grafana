...
import { NamespaceContext, ResourceContext, ResourceInfo, SchemaContext, SchemaType } from './context';

/* eslint-disable react/display-name */
export const WrappedPlugins = function () {
  return {
    wrapComponents: {
      parameterRow: (Original: React.ElementType) => (props: any) => {
      ...
      JsonSchemaForm: (Original: React.ElementType) => (props: any) => {
