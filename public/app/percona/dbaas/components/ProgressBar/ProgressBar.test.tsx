...
describe('ProgressBar::', () => {
  ...
  it('renders without message and rounds float width to nearest integer', () => {
    render(<ProgressBar finishedSteps={4} totalSteps={7} status={ProgressBarStatus.progress} />);
  ...
  it('renders with error status', () => {
    render(<ProgressBar finishedSteps={0} totalSteps={1} message="test message" status={ProgressBarStatus.error} />);
  ...
  it('handles invalid total steps', () => {
    render(<ProgressBar finishedSteps={5} totalSteps={0} status={ProgressBarStatus.progress} />);
