...
import type { DataQuery, RelativeTimeRange } from '@grafana/data/types';
...
type GrafanaNotificationSettingsBase = {
  group_by?: string[];
  group_wait?: string;
...
/** Exactly one of `receiver` or `policy` must be present — they are mutually exclusive. */
export type GrafanaNotificationSettings = MergeExclusive<
  GrafanaNotificationSettingsBase & { receiver: string },
