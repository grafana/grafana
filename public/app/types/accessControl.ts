...
export enum AccessControlAction {
  ...
  ServiceaccountsTeamRead = 'serviceaccounts.teams:read',
  ServiceaccountsAuthTokenList = 'serviceaccounts.authtoken:list',
  ServiceaccountsAuthTokenUpdate = 'serviceaccounts.authtoken:update',
  ServiceaccountsPasswordUpdate = 'serviceaccounts.password:update',
  ServiceaccountsDelete = 'serviceaccounts:delete',
  ServiceaccountsCreate = 'serviceaccounts:create',
  ServiceaccountsEnable = 'serviceaccounts:enable',
  ServiceaccountsDisable = 'serviceaccounts:disable',
  ServiceaccountsPermissionsUpdate = 'serviceaccounts.permissions:update',
  ServiceaccountsLogout = 'serviceaccounts:logout',
  ServiceaccountsQuotasList = 'serviceaccounts.quotas:list',
  ServiceaccountsQuotasUpdate = 'serviceaccounts.quotas:update',
