...
export type RepositorySpec = {
  ...
  description?: string;
  /** The repository on a git server. Mutually exclusive with local | github */
  ...
  /** The repository type.  When selected oneOf the values below should be non-nil
    ...
    Possible enum values:
     - `"git"` is a pure git repository type
     - `"github"` is a GitHub repository type
     - `"local"` is a local repository type */
