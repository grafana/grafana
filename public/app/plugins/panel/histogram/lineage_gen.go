...
// PluginTree returns the plugin tree representing the statically analyzable contents of the histogram plugin.
...
// PanelLineage returns the Thema lineage for the histogram panel plugin's
