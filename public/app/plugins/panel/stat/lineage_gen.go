...
// PluginTree returns the plugin tree representing the statically analyzable contents of the stat plugin.
...
// PanelLineage returns the Thema lineage for the stat panel plugin's
