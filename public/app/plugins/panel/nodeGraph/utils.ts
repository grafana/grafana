...
import { NodeNameOverrides, EdgeNameOverrides } from './panelcfg.gen';
...
export function processNodes(
  ...
  nodeNameOverrides: NodeNameOverrides | undefined,
  edgeNameOverrides: EdgeNameOverrides | undefined
): {
  nodes: NodeDatum[];
  edges: EdgeDatum[];
  legend?: Array<{
