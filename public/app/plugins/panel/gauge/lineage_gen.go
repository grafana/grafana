...
// PluginTree returns the plugin tree representing the statically analyzable contents of the gauge plugin.
...
// PanelLineage returns the Thema lineage for the gauge panel plugin's
