...
export const PrometheusInstantResultsPanel = memo(
  ({ data, options, fieldConfig, replaceVariables, timeZone }: Props) => {
...
PrometheusInstantResultsPanel.displayName = 'PrometheusInstantResultsPanel';
