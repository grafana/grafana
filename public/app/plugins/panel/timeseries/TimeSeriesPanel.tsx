...
import { KeyboardPlugin, TimeSeries, TooltipPlugin2, usePanelContext, ZoomPlugin } from '@grafana/ui';
      ...
      {(config, alignedDataFrame) => {
        ...
        return (
          <>
            ...
            {options.tooltip.mode === TooltipDisplayMode.None || <TooltipPlugin2 config={config} />}
