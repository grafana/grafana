...
import { AnnotationTooltipHeaderCloseIcon } from '../annotations2/AnnotationTooltipHeaderCloseIcon';
...
export const AnnotationEditor2Clustering = ({ annoVals, annoIdx, dismiss, timeZone, ...otherProps }: Props) => {
  ...
  return (
    <div ref={clickAwayRef} className={styles.editor} {...otherProps}>
      ...
      <Form<AnnotationEditFormDTO>
        onSubmit={onSubmit}
        defaultValues={{
          description: annoVals.text?.[annoIdx] ?? undefined,
          tags: annoVals.tags?.[annoIdx] || [],
        }}
      >
