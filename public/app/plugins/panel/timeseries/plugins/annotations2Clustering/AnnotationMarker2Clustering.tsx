...
import { AnnotationEditor2Clustering } from './AnnotationEditor2Clustering';
import { AnnotationTooltip2Clustering } from './AnnotationTooltip2';
...
export const AnnotationMarker2Clustering = ({
  frame,
  annoVals,
  annoIdx,
  style,
  ...
  const _editIdx = annoVals?.id?.findIndex((id) => id === editAnnotationId);
