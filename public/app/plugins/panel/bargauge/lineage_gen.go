...
// PluginTree returns the plugin tree representing the statically analyzable contents of the bargauge plugin.
...
// PanelLineage returns the Thema lineage for the bargauge panel plugin's
