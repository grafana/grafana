...
export function MultiStatBar(props: Props) {
  ...
  let rootElemLength = options.layout === MultistatPanelLayout.Horizontal ? props.size.h : props.size.w;
  ...
  const totalWidth = options.layout === MultistatPanelLayout.Horizontal ? props.size.w : props.size.h;
