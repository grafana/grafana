...
// PluginTree returns the plugin tree representing the statically analyzable contents of the annolist plugin.
...
// PanelLineage returns the Thema lineage for the annolist panel plugin's
