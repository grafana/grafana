...
// Fallback for Loki data source which doesn't has a severity field and uses the detected_level label
...
export function detectLevelField(logsFrame: LogsFrame) {
