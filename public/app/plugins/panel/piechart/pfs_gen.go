...
// PluginTree returns the plugin tree representing the statically analyzable contents of the piechart plugin.
...
// PanelLineage returns the Thema lineage for the piechart panel plugin's
