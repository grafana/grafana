...
describe('when rendering table', () => {
  describe('given 2 columns', () => {
    ...
    it('undefined value should render as -', () => {
      ...
      expect(html).to.be('<td align="auto"></td>');
    });
  });
});
