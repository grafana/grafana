...
export type MetricsExplorerProps = {
...
export const MetricsExplorer = (props: MetricsExplorerProps) => {
  ...
  const updateMetricsMetadata = useCallback(async () => {
    ...
    const data: MetricsExplorerMetadata = await setMetrics(datasource, query, initialMetrics);
    dispatch(
      buildMetrics({
        isLoading: false,
