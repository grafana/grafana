...
function processTemplate(templateData: TemplateData, metric: string, labels: string): Suggestion {
  return {
    component: templateData.template.replace('metric_a', metric).replace('{}', labels),
...
export function getTemplateSuggestions(metricName: string, metricType: string, labels: string): Suggestion[] {
