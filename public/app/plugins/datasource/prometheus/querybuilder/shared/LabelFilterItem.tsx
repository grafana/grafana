...
export function LabelFilterItem({
  ...
  const labelNameSearch = debounce((query: string) => getLabelNames(query), 300);
  const labelValueSearch = debounce((query: string) => getLabelValues(query), 300);
