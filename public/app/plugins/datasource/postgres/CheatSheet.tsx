...
export function CheatSheet() {
  ...
  return (
    <div>
      <h2>
        <Trans i18nKey="cheat-sheet.title">PostgreSQL cheat sheet</Trans>
      </h2>
      {t('cheat-sheet.time-series.title', 'Time series:')}
      <ul className={styles.ulPadding}>
        <Trans i18nKey="cheat-sheet.time-series.description">
          <li>
      ...
      {t('cheat-sheet.optional.title', 'Optional:')}
      <ul className={styles.ulPadding}>
        <Trans i18nKey="cheat-sheet.optional.description">
          <li>
      ...
      <p>
        <Trans i18nKey="cheat-sheet.time-series.note">
          Resultsets of time series queries need to be sorted by time.
        </Trans>
      </p>
      {t('cheat-sheet.table.title', 'Table:')}
      <ul className={styles.ulPadding}>
        <Trans i18nKey="cheat-sheet.table.description">
          <li>return any set of columns</li>
        </Trans>
      </ul>
      {t('cheat-sheet.macros.title', 'Macros:')}
      <ul className={styles.ulPadding}>
        <Trans i18nKey="cheat-sheet.macros.description">
          ...
          <li>
            $__timeGroup(column,&apos;5m&apos;[, fillvalue]) -&gt; (extract(epoch from column)/300)::bigint*300 by
            setting fillvalue grafana will fill in missing values according to the interval fillvalue can be either a
            literal value, NULL or previous; previous will fill in the previous seen value or NULL if none has been seen
            yet
          </li>
          <li>
      ...
      <p>
        <Trans i18nKey="cheat-sheet.macros.example-note">Example of group by and order by with $__timeGroup:</Trans>
      </p>
      <pre>
        <code>
      ...
      {t(
        'cheat-sheet.macros.conditionals-note',
