...
package grafana_azure_monitor_datasource
...
// PluginTree returns the plugin tree representing the statically analyzable contents of the grafana-azure-monitor-datasource plugin.
