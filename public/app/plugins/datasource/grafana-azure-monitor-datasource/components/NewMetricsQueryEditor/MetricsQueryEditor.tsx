...
import type { AzureMonitorErrorish, AzureMonitorOption, AzureMonitorQuery } from '../../types';
...
import { useMetricMetadata, useMetricNames, useMetricNamespaces } from './dataHooks';
