...
function (angular) {
  ...
  module
    .factory('netCrunchCounters', function ($q, netCrunchCounterConsts, netCrunchCounterTypes) {
      ...
      function NetCrunchCounters(adrem, netCrunchServerConnection) {
      ...
      return {
        getNetCrunchCounters : function (adrem, netCrunchServerConnection) {
          return new NetCrunchCounters(adrem, netCrunchServerConnection);
        }
      };
