...
define([
  ...
  function (angular) {
    ...
    module.directive('ngVirtualScrollList', function ($compile, $timeout, $interval, $window, $document, $q) {
        ...
        compile: function($element) {
          ...
          function preLink($scope, $element, $attributes) {
            var ngRepeatElement = angular.element(ngRepeatHtmlTemplate),
                scrollParent = closestElement.call($element, $attributes.ngVirtualScrollListParent) || $element,
            ...
            function drawVirtualView() {
              ...
              if (VRI != null) {
                updateInvisibleElementSize(invisibleSpaces.leadingSpace, VRI.invisibleLeadingElementHeight);
                ...
                updateInvisibleElementSize(invisibleSpaces.followingSpace, VRI.invisibleFollowingElementHeight);
              }
            }
            ...
            $scope.$watch(
              function() {
                return (isHorizontal === true) ? scrollParentContainer.clientHeight : scrollParentContainer.clientWidth;
              },
              function() {
                updateSubSetElements();
              }
          ...
          function postLink($scope, $element) {
            ...
            function updateVirtualScrollListState(mode) {
              ...
              function updateState(scrollState) {
                ...
                scrollState.firstVisibleElementIndex =
                  findCompleteDisplayedElement(firstVirtualElementIndex, lastVirtualElementIndex, 'first');
                scrollState.lastVirtualElementIndex = lastVirtualElementIndex;
                scrollState.lastVisibleElementIndex =
                  findCompleteDisplayedElement(firstVirtualElementIndex, lastVirtualElementIndex, 'last');
            ...
            function checkComponentLoseFocus(event) {
              ...
              if (allElements.length > 0) {
                ...
                if ((itemTabIndex != null) && (firstComponentTabIndex != null) && (lastComponentTabIndex != null)) {
                  if ((itemTabIndex < firstComponentTabIndex) || (itemTabIndex > lastComponentTabIndex)) {
                    setComponentFocus(false);
                  }
                } else {
                  setComponentFocus(false);
            ...
            function setFocus() {
              ...
              if ((ngVirtualScrollListKeyMode === true) && (getComponentFocus() === true) && (allElements.length > 0)) {
                firstVirtualTabIndex = getFirstVirtualTabIndex();
                lastVirtualTabIndex = getLastVirtualTabIndex();
              ...
              if ((ngVirtualScrollListID != null) && (ngVirtualScrollListID !== '')) {
                $scope.$on('ngVirtualScrollListTrigger(' + ngVirtualScrollListID + ')',
                           function(event, args) {
                             ...
                             if ((itemIndex != null) && (itemIndex >= 0) && (itemIndex < allElements.length)) {
          ...
          return {
            pre: function($scope, $element, $attributes) {
              $timeout(function() {
                preLink($scope, $element, $attributes);
                preLinkReady.resolve();
              }, 0);
            },

            post: function($scope, $element) {
              preLinkReady.promise.then(function() {
