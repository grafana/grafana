      ...
      function prepareTreeConfig (config) {
        ...
        for (i = 1; i <= maxTreeLevel; i+=1) {
          if (config[i] != null) {
            ...
            configLevelBuffer.innerDepth = config[lastExistLevel].innerDepth + deltaInnerDepth * (i-lastExistLevel);
          ...
          function preLink($scope, $element) {
            ...
            function calculateTreeModel(treeNodeAdapters) {
              ...
              function calculateTreeWidth (levelCount) {
                ...
                for (i=1; i<=levelCount; i+=1) {
                  ...
                  levelWidth = nodeConfig.innerDepth + nodeConfig.contentWidth + nodeConfig.paddingRight;
            ...
            function createNodeDOMElement(nodeAdapter, elementWidth) {
              ...
              function nodeElementFocusHandler (event) {
                if ((hasComponentFocus === true) || (ngTreeFocusedNode == null) ||
                    (ngTreeFocusedNode < getFirstModelTabIndex()) || (ngTreeFocusedNode > getLastVirtualTabIndex())) {
              ...
              function nodeElementKeyboardHandler (event) {
                      ...
                      if (event.shiftKey === true) {
                        if (firstTabIndexPointer > 0) {
                          ...
                          if (lastTabIndexPointer < tabIndexElements.index.length - 1) {
                            calculatedTabIndex = tabIndexElements.index[tabIndexElements.index.length - 1];
                          } else {
                            changeFocus = false;
                          }
                        }
                        ...
                        if (lastTabIndexPointer < (tabIndexElements.index.length - 1)) {
                          calculatedTabIndex = tabIndexElements.index[lastTabIndexPointer + 1];
                        } else {
                          if (firstTabIndexPointer > 0) {
                ...
                keyMapper[END_CODE] = function (event) {
                  ...
                  if (bottomPosition < scrollParent[0].clientHeight) {
                    ...
                    if ((treeModel.totalTreeHeight - treeModel[nodeModelIndex].top) < scrollParent[0].clientHeight) {
                ...
                keyMapper[UP_ARROW_CODE] = function (event) {
                  ...
                  if (nodeTabIndex > getFirstModelTabIndex()) {
                    ...
                    if ((nodeTabIndex === firstVirtualTabIndex) || (topPrevNodePosition < topScrollPosition)) {
                ...
                keyMapper[PAGE_UP_CODE] = function(event) {
                  ...
                  destinationPosition = treeModel[nodeModelIndex].top - scrollParent[0].clientHeight;
                ...
                keyMapper[DOWN_ARROW_CODE] = function (event) {
                  ...
                  if (nodeTabIndex < getLastModelTabIndex()) {
                    ...
                    bottomScrollPosition = scrollParent[0].scrollTop + scrollParent[0].clientHeight;
                    bottomNextNodePosition = treeModel[nextNodeModelIndex].top +
                                             treeModel[nextNodeModelIndex].height - 1;

                    if ((nodeTabIndex === lastVirtualTabIndex) || (bottomNextNodePosition > bottomScrollPosition)){
            ...
            function checkVirtualViewNeedReposition (event) {
              ...
              if ((ngTreeKeyboardMode === true) && (hasComponentFocus === true) &&
                ...
                if ((ngTreeFocusedNode < getFirstVirtualTabIndex()) || (ngTreeFocusedNode > getLastVirtualTabIndex())) {
            ...
            function moveVirtualViewToNodeIndex(nodeIndex, position) {
              ...
              if (treeModel.length > 0) {
                if ((nodeIndex >= 0) && (nodeIndex < treeModel.length) && (treeModel[nodeIndex] != null)) {
                  calculatedScrollPosition = treeModel[nodeIndex].top;
                  nodeHeight = treeModel[nodeIndex].height;

                  if (position === 'center') {
                    calculatedScrollPosition = calculatedScrollPosition - (parentHeight / 2) + (nodeHeight / 2);
                  }
                  if (position === 'bottom') {
                    calculatedScrollPosition = calculatedScrollPosition + nodeHeight - parentHeight;
                  }
            ...
            function checkComponentLoseFocus (event) {
              ...
              if (treeModel.length > 0) {
                ...
                if ((elementTabIndex != null) && (firstComponentTabIndex != null) && (lastComponentTabIndex != null)) {
                  if ((elementTabIndex < firstComponentTabIndex) || (elementTabIndex > lastComponentTabIndex)) {
                    hasComponentFocus = false;
                  }
                } else {
                  hasComponentFocus = false;
            ...
            function drawVirtualView () {
              ...
              updateFillElementSize(invisibleSpaces.leadingSpace, invisibleElementWidth, leadingElementHeight);
              ...
              updateFillElementSize(invisibleSpaces.followingSpace, invisibleElementWidth, followingElementHeight);
              if ((ngTreeKeyboardMode === true) && (hasComponentFocus === true) && (treeModel.length > 0)) {
            ...
            function calculateVisibleRangeIndex (container, treeModel) {
              ...
              if (bottomPosition >= treeModel.totalTreeHeight) {
                ...
                invisibleFollowingElementHeight = treeModel.totalTreeHeight - (treeModel[lastVirtualNodeIndex].top +
            ...
            function updateVirtualRangeIndex() {
              ...
              if (currentRangeIndex == null) {
                ...
                if ((currentRI.invisibleLeadingElementHeight !== calculatedRI.invisibleLeadingElementHeight) ||
                    ...
                    (currentRI.invisibleFollowingElementHeight !== calculatedRI.invisibleFollowingElementHeight)) {
