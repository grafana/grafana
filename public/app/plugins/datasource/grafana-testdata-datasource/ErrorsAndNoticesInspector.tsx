...
type Props = ErrorsAndNoticesInspectorProps<TestDataDataSource, TestDataDataQuery>;
...
export function ErrorsAndNoticesInspector({ data, errors }: Props) {
  ...
  if (entries.length === 0) {
    return <div className={styles.empty}>No errors or notices for this query.</div>;
  }
