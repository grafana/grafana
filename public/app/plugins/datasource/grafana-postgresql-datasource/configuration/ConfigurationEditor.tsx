...
export const postgresVersions: Array<ComboboxOption<number>> = [
  { label: '9.0', value: 900 },
  { label: '9.1', value: 901 },
  { label: '9.2', value: 902 },
  { label: '9.3', value: 903 },
...
export const PostgresConfigEditor = (props: DataSourcePluginOptionsEditorProps<PostgresOptions, SecureJsonData>) => {
  ...
  const tlsModes: Array<ComboboxOption<PostgresTLSModes>> = [
  ...
  const onJSONDataOptionSelected = <T extends string | number>(property: keyof PostgresOptions) => {
    return (value: ComboboxOption<T>) => {
                  ...
                  <Label>
                    <EditorStack gap={0.5}>
                      ...
                      <Tooltip
                        content={
                          <span>
                            TimescaleDB is a time-series database built as a PostgreSQL extension. If enabled, Grafana
                            will use
                            <code>time_bucket</code> in the <code>$__timeGroup</code> macro and display TimescaleDB
