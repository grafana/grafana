...
export const sortQuery = {
  ...
  tokens: [
    [
      ...
      new Token(20, LogsTokenTypes.Keyword, CLOUDWATCH_LOGS_LANGUAGE_DEFINITION_ID),
      new Token(24, LogsTokenTypes.Whitespace, CLOUDWATCH_LOGS_LANGUAGE_DEFINITION_ID),
    ],
  ],
