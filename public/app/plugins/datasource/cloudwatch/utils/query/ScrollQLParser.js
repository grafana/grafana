...
var symbolicNames = [ null, "WS", "COMMENT", "K_SOURCE", "K_START", "K_END", 
                      "K_NOW", "K_LIVE", "K_PARSE", "K_SEARCH", "K_FIELDS", 
                      "K_DISPLAY", "K_FILTER", "K_STATS", "K_SORT", "K_ORDER", 
                      "K_ASC", "K_DESC", "K_HEAD", "K_LIMIT", "K_TAIL", 
                      "K_REGEX", "K_IN", "K_GROUP", "K_BY", "K_AS", "K_AND", 
                      "K_OR", "K_NOT", "K_LIKE", "K_MATCHES", "K_TU_MS", 
                      "K_TU_MSEC", "K_TU_MSECOND", "K_TU_S", "K_TU_SEC", 
                      "K_TU_SECOND", "K_TU_M", "K_TU_MIN", "K_TU_MINUTE", 
                      "K_TU_H", "K_TU_HR", "K_TU_HOUR", "K_TU_D", "K_TU_DAY", 
                      "K_TU_W", "K_TU_WEEK", "K_TU_MO", "K_TU_MON", "K_TU_MONTH", 
                      "K_TU_Q", "K_TU_QTR", "K_TU_QUARTER", "K_TU_Y", "K_TU_YR", 
                      "K_TU_YEAR", "RAW_ID", "LIT_INTEGER", "LIT_NUMBER", 
                      "SDQUOTED_STRING", "SSQUOTED_STRING", "CDQUOTED_STRING", 
                      "CSQUOTED_STRING", "QUOTED_IDENT", "SYM_EQTILDE", 
                      "SYM_TILDEEQ", "SYM_AT", "SYM_COMMA", "SYM_LPAREN", 
                      "SYM_RPAREN", "SYM_PIPE", "SYM_WRITE", "SYM_COLON", 
                      "SYM_CARET", "SYM_NOT", "SYM_MUL", "SYM_DIV", "SYM_MOD", 
                      "SYM_PLUS", "SYM_MINUS", "SYM_TILDE", "SYM_LT", "SYM_GT", 
                      "SYM_LTEQ", "SYM_GTEQ", "SYM_EQ", "SYM_NEQ", "SYM_LBRACKET", 
                      "SYM_RBRACKET", "REGEX_WS", "REGEX_COMMENT", "REGEX", 
                      "RE_SDQUOTED_STRING", "RE_SSQUOTED_STRING", "RE_CDQUOTED_STRING", 
                      "RE_CSQUOTED_STRING", "RE_RAW_ID", "RE_SYM_AT", "RE_QUOTED_IDENT", 
                      "SE_WS", "SE_COMMENT", "SE_K_SEARCH", "SE_SYM_LPAREN", 
                      "SE_SYM_RPAREN", "SE_K_AND", "SE_K_OR", "SE_K_NOT", 
                      "SE_SDQUOTED_STRING", "SE_SSQUOTED_STRING", "SE_CDQUOTED_STRING", 
                      "SE_CSQUOTED_STRING", "SE_UNQUOTED_STRING", "SE_PIPE" ];

var ruleNames =  [ "query", "logQuery", "logAesthetic", "logSourceStage", 
                   "logStatsStage", "logOp", "logAestheticOp", "logSource", 
                   "timeExpr", "nowTimeExpr", "relativeTimeExpr", "iso8601TimeExpr", 
                   "epochTimeExpr", "bareSpaceDelimited", "logStats", "statsExpr", 
                   "statsGroupField", "logOpFields", "fieldSpec", "logOpParse", 
                   "logOpSearch", "implicitLogOpSearch", "searchExpr", "searchTerm", 
                   "logOpFilter", "logOpSort", "sortExpr", "logOpLimit", 
                   "expressionRoot", "expression", "term", "likeTerm", "func", 
                   "functionArg", "array", "arrayElem", "number", "string", 
                   "stringOrBareString", "regex", "regexString", "logId", 
                   "fieldId", "aliasId", "userId", "unquotedUserId", "unquotedUserAtId", 
                   "unquotedUserBareId", "quotedUserId", "systemId", "unquotedSystemId", 
                   "quotedSystemId", "resultId", "functionId", "rawId", 
                   "keywords", "timeUnitKeywords" ];
...
ScrollQLParser.prototype.bareSpaceDelimited = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 56)) & ~0x1f) == 0 && ((1 << (_la - 56)) & ((1 << (ScrollQLParser.RAW_ID - 56)) | (1 << (ScrollQLParser.LIT_INTEGER - 56)) | (1 << (ScrollQLParser.LIT_NUMBER - 56)) | (1 << (ScrollQLParser.SYM_COLON - 56)) | (1 << (ScrollQLParser.SYM_MINUS - 56)))) !== 0)) {
            this.state = 218;
            _la = this._input.LA(1);
            if(!(((((_la - 56)) & ~0x1f) == 0 && ((1 << (_la - 56)) & ((1 << (ScrollQLParser.RAW_ID - 56)) | (1 << (ScrollQLParser.LIT_INTEGER - 56)) | (1 << (ScrollQLParser.LIT_NUMBER - 56)) | (1 << (ScrollQLParser.SYM_COLON - 56)) | (1 << (ScrollQLParser.SYM_MINUS - 56)))) !== 0))) {
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 2:
                    ...
                    _la = this._input.LA(1);
                    if(!(((((_la - 75)) & ~0x1f) == 0 && ((1 << (_la - 75)) & ((1 << (ScrollQLParser.SYM_MUL - 75)) | (1 << (ScrollQLParser.SYM_DIV - 75)) | (1 << (ScrollQLParser.SYM_MOD - 75)))) !== 0))) {
                ...
                case 4:
                    ...
                    localctx.bop = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 81)) & ~0x1f) == 0 && ((1 << (_la - 81)) & ((1 << (ScrollQLParser.SYM_LT - 81)) | (1 << (ScrollQLParser.SYM_GT - 81)) | (1 << (ScrollQLParser.SYM_LTEQ - 81)) | (1 << (ScrollQLParser.SYM_GTEQ - 81)))) !== 0))) {
                        localctx.bop = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 8:
                    ...
                    this.state = 416;
                    _la = this._input.LA(1);
                    if(!(_la===ScrollQLParser.K_LIKE || _la===ScrollQLParser.SYM_EQTILDE || _la===ScrollQLParser.SYM_TILDEEQ)) {
                    this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
...
ScrollQLParser.prototype.keywords = function() {
    ...
    try {
        ...
        this.state = 564;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ScrollQLParser.K_SOURCE) | (1 << ScrollQLParser.K_START) | (1 << ScrollQLParser.K_END) | (1 << ScrollQLParser.K_NOW) | (1 << ScrollQLParser.K_LIVE) | (1 << ScrollQLParser.K_PARSE) | (1 << ScrollQLParser.K_SEARCH) | (1 << ScrollQLParser.K_FIELDS) | (1 << ScrollQLParser.K_DISPLAY) | (1 << ScrollQLParser.K_FILTER) | (1 << ScrollQLParser.K_STATS) | (1 << ScrollQLParser.K_SORT) | (1 << ScrollQLParser.K_ORDER) | (1 << ScrollQLParser.K_ASC) | (1 << ScrollQLParser.K_DESC) | (1 << ScrollQLParser.K_HEAD) | (1 << ScrollQLParser.K_LIMIT) | (1 << ScrollQLParser.K_TAIL) | (1 << ScrollQLParser.K_REGEX) | (1 << ScrollQLParser.K_IN) | (1 << ScrollQLParser.K_GROUP) | (1 << ScrollQLParser.K_BY) | (1 << ScrollQLParser.K_AS) | (1 << ScrollQLParser.K_AND) | (1 << ScrollQLParser.K_OR) | (1 << ScrollQLParser.K_NOT) | (1 << ScrollQLParser.K_LIKE) | (1 << ScrollQLParser.K_MATCHES))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
ScrollQLParser.prototype.timeUnitKeywords = function() {
    ...
    try {
        ...
        case ScrollQLParser.K_TU_MSECOND:
            ...
            this.state = 566;
            _la = this._input.LA(1);
            if(!(((((_la - 31)) & ~0x1f) == 0 && ((1 << (_la - 31)) & ((1 << (ScrollQLParser.K_TU_MS - 31)) | (1 << (ScrollQLParser.K_TU_MSEC - 31)) | (1 << (ScrollQLParser.K_TU_MSECOND - 31)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_SECOND:
            ...
            this.state = 567;
            _la = this._input.LA(1);
            if(!(((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (ScrollQLParser.K_TU_S - 34)) | (1 << (ScrollQLParser.K_TU_SEC - 34)) | (1 << (ScrollQLParser.K_TU_SECOND - 34)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_MINUTE:
            ...
            this.state = 568;
            _la = this._input.LA(1);
            if(!(((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (ScrollQLParser.K_TU_M - 37)) | (1 << (ScrollQLParser.K_TU_MIN - 37)) | (1 << (ScrollQLParser.K_TU_MINUTE - 37)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_HOUR:
            ...
            this.state = 569;
            _la = this._input.LA(1);
            if(!(((((_la - 40)) & ~0x1f) == 0 && ((1 << (_la - 40)) & ((1 << (ScrollQLParser.K_TU_H - 40)) | (1 << (ScrollQLParser.K_TU_HR - 40)) | (1 << (ScrollQLParser.K_TU_HOUR - 40)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_MONTH:
            ...
            this.state = 572;
            _la = this._input.LA(1);
            if(!(((((_la - 47)) & ~0x1f) == 0 && ((1 << (_la - 47)) & ((1 << (ScrollQLParser.K_TU_MO - 47)) | (1 << (ScrollQLParser.K_TU_MON - 47)) | (1 << (ScrollQLParser.K_TU_MONTH - 47)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_QUARTER:
            ...
            this.state = 573;
            _la = this._input.LA(1);
            if(!(((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (ScrollQLParser.K_TU_Q - 50)) | (1 << (ScrollQLParser.K_TU_QTR - 50)) | (1 << (ScrollQLParser.K_TU_QUARTER - 50)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
        ...
        case ScrollQLParser.K_TU_YEAR:
            ...
            this.state = 574;
            _la = this._input.LA(1);
            if(!(((((_la - 53)) & ~0x1f) == 0 && ((1 << (_la - 53)) & ((1 << (ScrollQLParser.K_TU_Y - 53)) | (1 << (ScrollQLParser.K_TU_YR - 53)) | (1 << (ScrollQLParser.K_TU_YEAR - 53)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
