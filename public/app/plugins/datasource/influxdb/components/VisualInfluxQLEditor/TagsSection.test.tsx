...
function assertText(tags: InfluxQueryTag[], textResult: string) {
  const { container } = render(
    <TagsSection tags={tags} getTagKeys={getTagKeys} getTagValuesForKey={getTagValuesForKey} onChange={() => null} />
  );
...
describe('RawInfluxQLEditor', () => {
  it('should display correct data', () => {
    assertText(tags, 'Wheret1=t1_v1ANDt2!=t2_v2ORt3<>t3_v3+');
  });
  it('should handle incorrect data', () => {
    ...
    assertText(incorrectTags, 'Wheret1=t1_v1ANDt2!=t2_v2ORt3=t3_v3ORt4=~/t4_v4/XORt5hahat5_v5+');
  });
  ...
  it('should handle adding a new tag check', async () => {
    ...
    render(
      <TagsSection tags={tags} getTagKeys={getTagKeys} getTagValuesForKey={getTagValuesForKey} onChange={onChange} />
    );
