...
import { Alert, DataSourceHttpSettings, InlineField, InlineFormLabel, LegacyForms, Select } from '@grafana/ui/src';
...
export class ConfigEditor extends PureComponent<Props, State> {
  ...
  onVersionChanged = (selected: SelectableValue<InfluxVersion>) => {
    ...
    const copy: DataSourceSettings<InfluxOptions, InfluxSecureJsonData> = {
      ...options,
      jsonData: {
        ...options.jsonData,
        version: selected.value ?? InfluxVersion.InfluxQL,
      },
    };
