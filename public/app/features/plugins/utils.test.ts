...
describe('buildPluginSectionNav', () => {
  ...
  it('Should return return section nav', () => {
    const result = buildPluginSectionNav(appsSection, '/a/plugin1/page1');
    expect(result?.main.text).toBe('apps');
  });

  it('Should set active page', () => {
    const result = buildPluginSectionNav(appsSection, '/a/plugin1/page2');
