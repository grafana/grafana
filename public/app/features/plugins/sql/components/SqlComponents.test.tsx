...
describe('SqlQueryEditor', () => {
  describe('alerts', () => {
    runTestIf(sqlDatasourceDatabaseSelectionFeatureFlagIsEnabled)(
      'should ONLY render the `database update` alert',
      async () => {
        // @ts-ignore
...
describe('DatasetSelector', () => {
  describe('should render with the correct default placeholder values', () => {
    ...
    runTestIf(sqlDatasourceDatabaseSelectionFeatureFlagIsEnabled)(
      'should render with `database 1` since a preconfigured database exists',
      async () => {
  ...
  describe('database calls', () => {
    ...
    runTestIf(sqlDatasourceDatabaseSelectionFeatureFlagIsEnabled)(
      'should not query the database if preconfigured',
      async () => {
