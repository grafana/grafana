...
describe('Plugins/Helpers', () => {
  ...
  //     expect(mapRemoteToCatalog(pluginWithoutSignature).catalogInfo?.signature).toBe(PluginSignatureStatus.missing);
  //     expect(mapRemoteToCatalog(pluginWithSignature1).catalogInfo?.signature).toBe(PluginSignatureStatus.valid);
  //     expect(mapRemoteToCatalog(pluginWithSignature2).catalogInfo?.signature).toBe(PluginSignatureStatus.valid);
  //   });
  ...
  //     expect(mapRemoteToCatalog(enterprisePlugin).catalogInfo?.isEnterprise).toBe(true);
  //     expect(mapRemoteToCatalog(notEnterprisePlugin).catalogInfo?.isEnterprise).toBe(false);
  //   });
  ...
  //     expect(mapRemoteToCatalog(corePlugin).catalogInfo?.isCore).toBe(true);
  //     expect(mapRemoteToCatalog(notCorePlugin).catalogInfo?.isCore).toBe(false);
  //   });
  // });
  ...
  //     expect(mapLocalToCatalog(pluginWithoutInternalSignature).catalogInfo?.isCore).toBe(false);
  //     expect(mapLocalToCatalog(pluginWithInternalSignature).catalogInfo?.isCore).toBe(true);
  //   });
  //   test('isDev if local.dev', () => {
  //     const pluginWithoutDev = { ...localPlugin, dev: false };
  //     const pluginWithDev = { ...localPlugin, dev: true };
  //     expect(mapLocalToCatalog(pluginWithoutDev).catalogInfo?.isDev).toBe(false);
  //     expect(mapLocalToCatalog(pluginWithDev).catalogInfo?.isDev).toBe(true);
  //   });
  // });
