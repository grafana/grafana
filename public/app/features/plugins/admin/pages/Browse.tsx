  ...
  const subTitle = (
    <div>
      ...
      <a className="external-link" href={`${CONNECTIONS_ROUTES.AddNewConnection}?cat=data-source`}>
        <Trans i18nKey="plugins.browse.sub-title.connections">Connections</Trans>
      </a>
      .
    </div>
  );
      ...
      <Page.Contents>
        <HorizontalGroup wrap>
          ...
          <HorizontalGroup wrap className={styles.actionBar}>
            ...
            {/* Sorting */}
            <Field label={t('plugins.browse.label-sort', 'Sort')}>
              <Select
                aria-label={t('plugins.browse.aria-label-sort-plugins-list', 'Sort Plugins List')}
                width={24}
                value={sortBy}
