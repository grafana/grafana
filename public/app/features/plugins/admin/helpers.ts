...
export function mapRemoteToCatalog(plugin: RemotePlugin, error?: PluginError): CatalogPlugin {
  ...
  return {
    ...
    info: {
      logos: {
        small: `/api/gnet/plugins/${id}/versions/${version}/logos/small`,
        large: `/api/gnet/plugins/${id}/versions/${version}/logos/large`,
      },
      keywords,
    },
    name,
...
export function mapToCatalogPlugin(local?: LocalPlugin, remote?: RemotePlugin, error?: PluginError): CatalogPlugin {
  ...
  if (remote) {
    logos = {
      small: `/api/gnet/plugins/${id}/versions/${remote.version}/logos/small`,
      large: `/api/gnet/plugins/${id}/versions/${remote.version}/logos/large`,
    };
