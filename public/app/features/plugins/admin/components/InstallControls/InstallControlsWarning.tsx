  ...
  if (plugin.type === PluginType.secretsmanager) {
    return (
      <Alert
        severity="warning"
        title={t(
          'plugins.install-controls-warning.title-secrets-manager-plugins-cannot-managed-plugin',
      ...
      <Alert severity="warning" title="" className={styles.alert}>
        <div>
          ...
          <a href="https://www.grafana.com/plugins" target="__blank" rel="noreferrer">
            <Trans i18nKey="plugins.install-controls-warning.grafanacomplugins">grafana.com/plugins</Trans>
          </a>{' '}
