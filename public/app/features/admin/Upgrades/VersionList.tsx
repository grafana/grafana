          ...
          return (
            <tr key={v.version}>
              ...
              <td>
                ...
                >
                  <LinkButton type="button" variant="secondary" icon="info-circle" href={`https://github.com/grafana/grafana/releases/tag/v${v.version}`} target="_blank" rel="noopener noreferrer">Release Notes</LinkButton>
                </a>
              </td>
            </tr>
          );
