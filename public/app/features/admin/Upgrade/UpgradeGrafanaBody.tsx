...
import { GrafanaChangelog } from './GrafanaChangelog';
import { GrafanaVersionList } from './GrafanaVersionList';
...
const TAB_PAGE_MAP: Record<TabView, React.ReactElement> = {
  ...
  [TabView.CHANGELOG]: <GrafanaChangelog changelog={mockDetails.changelog}/>,
  [TabView.VERSIONS]: <GrafanaVersionList versions={mockDetails.versions} installedVersion={mockDetails.installedVersion}/>,
};
...
export function UpgradeGrafanaBody() {
