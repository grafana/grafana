...
const DeleteUserModal = ({ user, onDismiss }: { user: SessionUser; onDismiss: () => void }) => {
  ...
  const body = (
    <p className={styles.description}>
      The user {user.email} is currently present in {user.publicDashboards!.length} public dashboards. If you wish to
      remove this user, please navigate to the settings of the corresponding public dashboard.
    </p>
  );
