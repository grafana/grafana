...
const ContentSection = () => {
  ...
  const { data: popularDashboards, isLoading: dashboardsLoading } = useGetPopularDashboards({
    limit: 4,
    period: '30d',
  });
  ...
  ({ queryParams, onToggleSparkJoy }: { queryParams: Record<string, string>; onToggleSparkJoy: () => void }) => {
    ...
    return (
      ...
      >
        ...
        {isSearching ? <SearchResults searchState={searchState} query={searchState.query || ''} /> : <ContentSection />}
