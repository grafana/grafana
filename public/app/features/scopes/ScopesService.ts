        ...
        if (
          ...
          this.apiClient
            ...
            .then((name) => {
              ...
              // mount should land the user on the scope's redirectPath when
              // one is configured, matching the behavior of selecting the
              // scope manually. The scope metadata is already in the
