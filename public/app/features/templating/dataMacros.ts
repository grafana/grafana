import { type DisplayProcessor, formattedValueToString, getDisplayProcessor, getFieldDisplayValuesProxy, getFrameDisplayName, type ScopedVars } from '@grafana/data';
