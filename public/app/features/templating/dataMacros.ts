...
import { getDisplayProcessor, getFieldDisplayValuesProxy, getFrameDisplayName } from '@grafana/data/field';
import type { DisplayProcessor, ScopedVars } from '@grafana/data/types';
