...
describe('templateSrv', () => {
  ...
  describe('init', () => {
    beforeEach(() => {
      _templateSrv = initTemplateSrv(uid, [{ type: 'query', name: 'test', current: { value: 'oogle' } }]);
    });
  ...
  describe('getAdhocFilters', () => {
    beforeEach(() => {
      _templateSrv = initTemplateSrv(uid, [
        {
          type: 'datasource',
          name: 'ds',
  ...
  describe('lucene format', () => {
    it('should properly escape $test with lucene escape sequences', () => {
      _templateSrv = initTemplateSrv(uid, [{ type: 'query', name: 'test', current: { value: 'value/4' } }]);
  ...
  describe('updateIndex with simple value', () => {
    beforeEach(() => {
      _templateSrv = initTemplateSrv(uid, [{ type: 'query', name: 'test', current: { value: 'muuuu' } }]);
    });
  ...
  describe('handle objects gracefully', () => {
    beforeEach(() => {
      _templateSrv = initTemplateSrv(uid, [{ type: 'query', name: 'test', current: { value: { test: 'A' } } }]);
    });
  ...
  describe('handle objects gracefully and call toString if defined', () => {
    beforeEach(() => {
      ...
      _templateSrv = initTemplateSrv(uid, [{ type: 'query', name: 'test', current: { value } }]);
    });
