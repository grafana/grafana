...
import { DataSourceWithBackend, toDataQueryError } from '@grafana/runtime';
...
export function callQueryMethod(
  ...
  if (datasource instanceof DataSourceWithBackend && datasource.dataSourceApi.type === 'public-ds') {
