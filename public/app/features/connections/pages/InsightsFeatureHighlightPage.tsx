...
export function InsightsFeatureHighlightPage() {
  return (
    ...
    footer={<div>Grafana Enterprise offers you not only usage insights but many more advanced features like Enterprise plugins, dashboard search and reporting.</div>}
