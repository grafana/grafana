...
export const FILTER_BY_OPTIONS = (translator: typeof t): SelectableValue[] => [
  ...
  {
    value: 'installed',
    label: translator('connections.add-new-connection.filter-by-options.label.installed', 'Installed'),
  },
  {
    value: 'has-update',
...
export const GROUP_BY_OPTIONS = (translator: typeof t): SelectableValue[] => [
  ...
  {
    value: 'category',
    label: translator('connections.add-new-connection.group-by-options.label.category', 'Category'),
  },
];
...
export const SORT_OPTIONS = (translator: typeof t): Array<{ value: string; label: string }> => [
  ...
  {
    value: 'published',
    label: translator('connections.add-new-connection.label.by-published-date', 'By published date'),
  },
