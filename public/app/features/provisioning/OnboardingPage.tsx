        ...
        {legacyStorage ? (
          <>
            <Alert severity="info" title="Setting up this connection could cause a temporary outage">
              When you connect your whole instance, depending on its size, the setup might make the dashboard
              unavailable to users for up to 30 minutes. We recommend warning your users before starting the process.
              You can use the announcement banner or your preferred channels.
            </Alert>
            <EmptyState
