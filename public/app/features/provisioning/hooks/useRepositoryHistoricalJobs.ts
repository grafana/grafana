...
function labelSelectors({ originalJobName, repositoryName }: Pick<RepositoryHistoricalJobsArgs, "originalJobName" | "repositoryName">): string | undefined {
...
export function useRepositoryHistoricalJobs(args: RepositoryHistoricalJobsArgs = {}): [
