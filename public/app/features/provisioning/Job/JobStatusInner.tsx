...
import { useListJobQuery } from 'app/api/clients/provisioning/v0alpha1';

import { FinishedJobStatus } from './FinishedJobStatus';
import { JobContent } from './JobContent';
import { type JobStatusProps } from './JobStatus';

export function JobStatusInner({ jobType, watch, onStatusChange, onRetry }: JobStatusProps) {
