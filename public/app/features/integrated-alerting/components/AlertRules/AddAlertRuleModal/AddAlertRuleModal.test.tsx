...
describe('AddAlertRuleModal', () => {
  ...
  it('renders new rule fields', async () => {
    ...
    expect(wrapper.find(dataQa('add-alert-rule-modal-add-button')).at(0).text()).toBe(Messages.create);
  });
  ...
  it('renders edit fields', async () => {
    ...
    expect(wrapper.find(dataQa('threshold-text-input'))).toHaveLength(1);
    expect(wrapper.find(dataQa('add-alert-rule-modal-add-button')).at(0).text()).toBe(Messages.update);
  });
  ...
  it('closes the modal when the user clicks on the cancel button', async () => {
    ...
    wrapper.find(dataQa('add-alert-rule-modal-cancel-button')).at(0).simulate('click');
