...
import { showConfirmModal, thresholdChanged } from '@grafana/data';
...
export class AlertTabCtrl {
  ...
  $onInit() {
    ...
    this.panelCtrl.events.on(thresholdChanged, thresholdChangedEventHandler);

    // set panel alert edit mode
    this.$scope.$on('$destroy', () => {
      this.panelCtrl.events.off(thresholdChanged, thresholdChangedEventHandler);
