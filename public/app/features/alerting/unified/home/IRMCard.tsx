...
const LINK = "https://grafana.com/auth/sign-up/create-user?irm=&redirectPath=irm&utm_source=oss-grafana&cnt=alerting-irm";
const HELP_FLAG_IRM = 0x0010;

export function IRMCard() {
  return <AdCard
    title={t("alerting.home.irm-card-title", "Incident response and management")}
    description={t("alerting.home.irm-card-description", "Unify on-call, alerting, and incident response with Grafana Cloud IRM.")}
    href={LINK}
    logoUrl={irmSvg}
    items={[
