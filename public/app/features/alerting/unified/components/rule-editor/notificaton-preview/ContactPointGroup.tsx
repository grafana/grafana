...
import { alertingAPIv0alpha1, getContactPointDescription } from '@grafana/alerting/unstable';
...
export function GrafanaContactPointGroup({ name, matchedInstancesCount, children }: ContactPointGroupProps) {
  ...
  const { data, isLoading } = alertingAPIv0alpha1.endpoints.listReceiver.useQuery({
