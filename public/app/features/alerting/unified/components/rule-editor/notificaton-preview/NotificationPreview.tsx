...
import { Folder, KBObjectArray, KVObject } from '../../../types/rule-form';
...
export const NotificationPreview = ({
  ...
  const onPreview = () => {
    ...
    if (policy && policy !== ROOT_ROUTE_NAME) {
      customLabels.push({
        key: NAMED_ROOT_LABEL_NAME,
        value: policy,
      });
    } else {
      customLabels = customLabels.filter(({ key }: KVObject): Boolean => key != NAMED_ROOT_LABEL_NAME)
    }
