...
import { trackAIAlertRuleFeedback } from 'app/extensions/alerting/AI/analytics/tracking';
import { AIFeedbackComponent } from 'app/features/alerting/unified/AI/components/AIFeedbackComponent';
...
import { useAIRuleFeedback } from '../../../hooks/AI/useAIRuleFeedback';
...
export const AlertRuleForm = ({ existing, prefill, isManualRestore }: Props) => {
  ...
  // AI feedback state
  const { isFromAI, feedbackGiven, handleAIFeedback } = useAIRuleFeedback(
    trackAIAlertRuleFeedback,
    config.featureToggles.alertingAIGenAlertRules === true
  );
      ...
      <form onSubmit={(e) => e.preventDefault()} className={styles.form}>
        <div className={styles.contentOuter}>
          ...
          <Stack direction="column" gap={3}>
            ...
            {/* AI Feedback : only show for rules generated by AI */}
            {isFromAI && (
              <AIFeedbackComponent onFeedback={handleAIFeedback} showComment={true} feedbackGiven={feedbackGiven} />
            )}
