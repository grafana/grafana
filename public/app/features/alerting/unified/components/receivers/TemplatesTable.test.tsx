...
describe('TemplatesTable', () => {
  ...
  it('shows "Provisioned from Prometheus/Mimir" badge for templates with converted_prometheus provenance', () => {
    ...
    const badge = within(templateRow).getByText('Provisioned from Prometheus/Mimir');
