...
const AlertRuleMenu = ({
  ...
  const menuItems = (
    <>
      ...
      {canSilence && (
        <Menu.Item
          label={t('alerting.alert-rule-menu.menu-items.label-silence-notifications', 'Silence notifications')}
          icon="bell-slash"
      ...
      {canDuplicate && (
        <Menu.Item
          label={t('alerting.alert-rule-menu.menu-items.label-duplicate', 'Duplicate')}
          icon="copy"
      ...
      {shareUrl && (
        <Menu.Item
          label={t('alerting.alert-rule-menu.menu-items.label-copy-link', 'Copy link')}
          icon="share-alt"
      ...
      {canExport && (
        <Menu.Item
          label={t('alerting.alert-rule-menu.menu-items.label-export', 'Export')}
          icon="download-alt"
      ...
      {canDelete && rulerRule && (
        <>
          <Menu.Divider />
          <Menu.Item
            label={t('alerting.alert-rule-menu.menu-items.label-delete', 'Delete')}
            icon="trash-alt"
            destructive
...
const ExportMenuItem = ({ identifier }: ExportMenuItemProps) => {
  ...
  return (
    <Menu.Item
      ...
      label={t('alerting.export-menu-item.label-with-modifications', 'With modifications')}
      icon="file-edit-alt"
      url={url}
    />
  );
