...
function AlertEnrichments({ enrichments }: AlertEnrichmentsProps) {
...
function EnrichmentItemView({ item }: { item: EnrichmentItem }) {
  const styles = useStyles2(getEnrichmentStyles);
...
const getEnrichmentStyles = (theme: GrafanaTheme2) => ({
  enrichmentItem: css({
