...
const useAddPolicyModal = (
  ...
  const modalElement = useMemo(
    ...
    [AmRouteReceivers, handleAdd, handleDismiss, loading, parentRoute, showModal, isAutoGenerated]
  );
...
const useEditPolicyModal = (
  ...
  const handleShow = useCallback((route: RouteWithID, isDefaultPolicy?: boolean, isAutogenerated?: boolean) => {
    setIsDefaultPolicy(isDefaultPolicy ?? false);
    setIsAutoGenerated(isAutogenerated ?? false);
    setRoute(route);
    setShowModal(true);
  }, []);
