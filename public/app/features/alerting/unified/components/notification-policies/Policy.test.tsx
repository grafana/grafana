...
import { AUTOGENERATED_ROOT_LABEL_NAME, Policy, isAutoGeneratedRootAndSimplifiedEnabled } from './Policy';
  ...
  it('should render a policy tree', async () => {
    ...
    renderPolicy(
      <Policy
        ...
        isAutogeneratedChunkOpen={false}
        toggleAutogeneratedChunk={noop}
      />
    );
  ...
  it('should show export option when export is allowed and supported returns true', async () => {
    ...
    renderPolicy(
      <Policy
        ...
        isAutogeneratedChunkOpen={false}
        toggleAutogeneratedChunk={jest.fn()}
      />
    );
    // should have default policy
    const defaultPolicy = screen.getByTestId('am-root-route-container');
