...
describe('useCreateDropdownMenuActions', () => {
  ...
  const testCases = [
    ...
    { isAutoGenerated: true, isDefaultPolicy: true, provisioned: true, expectedMenu: ['view-policy'] },
    { isAutoGenerated: true, isDefaultPolicy: false, provisioned: false, expectedMenu: ['view-policy'] },
    { isAutoGenerated: true, isDefaultPolicy: true, provisioned: false, expectedMenu: ['view-policy'] },
    { isAutoGenerated: true, isDefaultPolicy: false, provisioned: true, expectedMenu: ['view-policy'] },
  ];
