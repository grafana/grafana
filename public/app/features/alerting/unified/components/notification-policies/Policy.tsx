...
const Policy = (props: PolicyComponentProps) => {
  ...
  const isThisPolicyCollapsible = useShoudPolicyBeCollapsible(currentRoute);
      ...
      <Stack direction="column" gap={1.5}>
        ...
        >
          ...
          <PolicyItem
            ...
            isThisPolicyCollapsible={isThisPolicyCollapsible}
          />
        </div>
 ...
 */
function useShoudPolicyBeCollapsible(route: RouteWithID): boolean {
  const [isSupportedToSeeAutogeneratedChunk, isAllowedToSeeAutogeneratedChunk] = useAlertmanagerAbility(
    AlertmanagerAction.ViewAutogeneratedPolicyTree
  );
  return (
...
interface PolicyItemProps extends PolicyComponentProps {
  ...
  toggleBranchOpen?: () => void;
  isThisPolicyCollapsible?: boolean;
}
        ...
        <div>
          <Stack direction="row" alignItems="center" gap={1}>
            {isThisPolicyCollapsible && (
              <Icon name={isBranchOpen ? 'angle-down' : 'angle-right'} onClick={toggleBranchOpen} />
            )}
