...
const Policy = (props: PolicyComponentProps) => {
  ...
  const { supported: isSupportedToSeeAutogeneratedChunk, allowed: isAllowedToSeeAutogeneratedChunk } =
    useAlertmanagerAbilityState(AlertmanagerAction.ViewAutogeneratedPolicyTree);
...
export const useCreateDropdownMenuActions = (
  ...
  const [
    ...
    { supported: deletePolicySupported, allowed: deletePolicyAllowed },
  ...
  const showResetAction =
    isDefaultPolicy && !isAutoGenerated && deletePolicySupported && deletePolicyAllowed && Boolean(onResetPolicy);
