            ...
            <>
              ...
              <Stack direction="row" alignItems="center" gap={1} wrap="wrap-reverse">
                ...
                <Stack direction="row" gap={0.5}>
                  {!isAutoGenerated && !readOnly && canCreatePolicy && (
...
export const useCreateDropdownMenuActions = (
  ...
  const showEditAction = updateAbility.granted;
  const showDeleteAction = deleteAbility.granted && !isDefaultPolicy && !isAutoGenerated;
