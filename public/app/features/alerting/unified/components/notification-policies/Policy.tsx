  ...
  return (
    <div className={styles.metadataRow}>
      <Stack direction="row" alignItems="center" gap={1}>
        ...
        {!inheritedGrouping && <GroupingOptionsMeta isDefaultPolicy={isDefaultPolicy} groupBy={groupBy} />}
        {hasMuteTimings && (
...
interface GroupingOptionsMetaProps {
  groupBy?: string[];
  isDefaultPolicy?: boolean;
}

export const GroupingOptionsMeta = ({ groupBy, isDefaultPolicy = false }: GroupingOptionsMetaProps) => {
  const noGrouping = isArray(groupBy) && groupBy.at(0) === '...';
