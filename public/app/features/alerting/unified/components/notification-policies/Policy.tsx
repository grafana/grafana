...
const Policy = (props: PolicyComponentProps) => {
  ...
  const { filtersApplied, matchedRoutes, matchedRoutesWithPath } = routesMatchingFilters;
  ...
  const childPoliciesToRender = !filtersApplied
  ...
  const moreCount = hasSomeChildPoliciesBelongingToMatchPath
    ? childPoliciesBelongingToMatchPath.length - visibleChildPolicies
    : childPolicies.length - visibleChildPolicies;
