...
export const useCreateDropdownMenuActions = (
  ...
  const showEditAction = updateAbility.granted && hasAbilityToEdit;
  const showDeleteAction = deleteAbility.granted && hasAbilityToDelete && !isDefaultPolicy && !isAutoGenerated;
