...
const Policy = (props: PolicyComponentProps) => {
  ...
  return (
    // This Policy will be collapsible only when it's the autogenerated root
    <ConditionalWrap
      shouldWrap={isAutoGeneratedRootAndSimplifiedEnabled(currentRoute)}
      wrap={(children) => CollapsiblePolicy(children, isBranchOpen, toggleAutogeneratedChunk)}
    >
      <Stack direction="column" gap={1.5}>
        ...
        >
          ...
          <PolicyItem
            ...
            toggleShowExportDrawer={toggleShowExportDrawer}
...
interface PolicyItemProps extends PolicyComponentProps {
...
function PolicyItem({
  ...
  const dropdownMenuActions: JSX.Element[] = createDropdownMenuActions(
    isAutoGenerated,
    isDefaultPolicy,
    provisioned,
    openDetailModal,
    ...
    toggleShowExportDrawer,
    onDeletePolicy,
    exportPoliciesAllowed,
    exportPoliciesSupported,
    updatePoliciesSupported,
    updatePoliciesAllowed,
    deletePolicySupported,
    deletePolicyAllowed
  );
  const isAllowedToSeeAutogeneratedChunk = isAbleToSeeAutogeneratedChunk();
  const showCurrentPolicy = !isAutoGenerated || (isAutoGenerated && isAllowedToSeeAutogeneratedChunk);
...
const createDropdownMenuActions = (
  isAutoGenerated: boolean,
  isDefaultPolicy: boolean,
  provisioned: boolean,
  openDetailModal: (route: RouteWithID, isDefault?: boolean, readOnly?: boolean) => void,
  ...
  toggleShowExportDrawer: (nextValue?: any) => void,
  onDeletePolicy: (route: RouteWithID) => void,
  exportPoliciesAllowed: boolean,
  exportPoliciesSupported: boolean,
  updatePoliciesSupported: boolean,
  updatePoliciesAllowed: boolean,
  deletePolicySupported: boolean,
  deletePolicyAllowed: boolean
) => {
  ...
  if (showDeleteAction && !readOnlyPolicy) {
    dropdownMenuActions.push(
...
export function isAbleToSeeAutogeneratedChunk() {
