...
const Policy = (props: PolicyComponentProps) => {
  ...
  const autogenAbility = useAlertmanagerAbilityState(AlertmanagerAction.ViewAutogeneratedPolicyTree);
              ...
              <Stack direction="row" alignItems="center" gap={1} wrap="wrap-reverse">
                ...
                <Stack direction="row" gap={0.5}>
                  {!isAutoGenerated && !readOnly && (
                    <AbilityAny actions={[AlertmanagerAction.CreateNotificationPolicy]}>
