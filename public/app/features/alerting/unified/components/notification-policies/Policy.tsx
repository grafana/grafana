...
const Policy: FC<PolicyComponentProps> = ({
  ...
  const showExportAction =
    exportPoliciesAllowed && exportPoliciesSupported && (isDefaultPolicy || isAutogeneratedPolicyRoot); // not sure about this one
  ...
  const showAutoGeneratdPolicyChunk = updatePoliciesSupported && updatePoliciesAllowed; // ARE WE GOING TO HAVE ANOTHER PERMISSION FOR THIS?
      ...
      <Fragment key="edit-policy">
        <ConditionalWrap shouldWrap={provisioned} wrap={ProvisionedTooltip}>
          <Menu.Item
            ...
            label="Edit"
            onClick={() => onEditPolicy(currentRoute, isDefaultPolicy, isAutoGenerated)}
          />
        </ConditionalWrap>
      </Fragment>
    );
  ...
  return showThisPolicyChunk ? (
    <ConditionalWrap
      shouldWrap={isAutoGeneratedRoot(currentRoute)}
            ...
            {childPolicies.map((child) => {
              ...
              return (
                <Policy
                  ...
                  isAutoGenerated={isAutoGenerated || isAutoGeneratedRoot(child)}
...
function isAutoGeneratedRoot(route: RouteWithID) {
