...
const Policy = (props: PolicyComponentProps) => {
  ...
  // simplified routing conditionals
  ...
  const shouldWrap =
    ...
    isAutoGeneratedRootAndSimplifiedEnabled(currentRoute);

  const showCurrentPolicy =
    !isAutoGenerated || (isAutoGenerated && isAllowedToSeeAutogeneratedChunk && isSupportedToSeeAutogeneratedChunk);
