...
const Policy: FC<PolicyComponentProps> = ({
  ...
  const showAutoGeneratdPolicyChunk = updatePoliciesSupported && updatePoliciesAllowed; //todo: ARE WE GOING TO HAVE ANOTHER PERMISSION FOR THIS?
  const showThisPolicyChunk = !isAutoGenerated || (isAutoGenerated && showAutoGeneratdPolicyChunk);
