    ...
    <NeedHelpInfo
      ...
      contentText={
        <Trans i18nKey="alerting.import-to-gma.step1.policy-tree-help">
          ...
          rules that should use this routing. Use a label you will recognize—for example data source, team, cluster, or
          environment (such as prometheus-prod or platform-team).
        </Trans>
      }
    />
  );
