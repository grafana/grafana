...
const AmRoutes = () => {
  ...
  const [isAutogeneratedChunkOpen, onToggleAutogeneratedChunk] = useToggle(false);
                ...
                <Stack direction="column" gap={1}>
                  ...
                  {rootRoute && (
                    <Policy
                      ...
                      isBranchOpen={isAutogeneratedChunkOpen}
                      toggleAutogeneratedChunk={onToggleAutogeneratedChunk}
                    />
                  )}
                </Stack>
                {addModal}
