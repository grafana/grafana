...
import { toPageless, useGrafanaGroupsGenerator } from './hooks/prometheusGroupsGenerator';
...
export function PaginatedGrafanaLoader() {
  ...
  const groupsGenerator = useRef(toPageless(grafanaGroupsGenerator(GRAFANA_GROUP_PAGE_SIZE)));
