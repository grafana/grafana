 ...
 * both alert + recording rules), with cursor pagination. Used by the grouped view's
 * "Single /search request" mode as an alternative to {@link useK8sFolderRules}'s two queries.
 */
