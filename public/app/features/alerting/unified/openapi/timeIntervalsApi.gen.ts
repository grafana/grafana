...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      deletecollectionNamespacedTimeInterval: build.mutation<
        DeletecollectionNamespacedTimeIntervalApiResponse,
        DeletecollectionNamespacedTimeIntervalApiArg
      >({
        query: (queryArg) => ({
          url: `/apis/notifications.alerting.grafana.app/v0alpha1/namespaces/${queryArg['namespace']}/timeintervals`,
          method: 'DELETE',
...
export type DeletecollectionNamespacedTimeIntervalApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1Status;
export type DeletecollectionNamespacedTimeIntervalApiArg = {
  /** object name and auth scope, such as for teams and projects */
  namespace: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
