...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      patchNamespacedTemplateGroup: build.mutation<
        PatchNamespacedTemplateGroupApiResponse,
        PatchNamespacedTemplateGroupApiArg
      >({
        query: (queryArg) => ({
          url: `/apis/notifications.alerting.grafana.app/v0alpha1/namespaces/${queryArg['namespace']}/templategroups/${queryArg.name}`,
          method: 'PATCH',
...
export type PatchNamespacedTemplateGroupApiResponse = /** status 200 OK */
  | ComGithubGrafanaGrafanaPkgApisAlertingNotificationsV0Alpha1TemplateGroup
  | /** status 201 Created */ ComGithubGrafanaGrafanaPkgApisAlertingNotificationsV0Alpha1TemplateGroup;
export type PatchNamespacedTemplateGroupApiArg = {
  /** name of the TemplateGroup */
  name: string;
  /** object name and auth scope, such as for teams and projects */
  namespace: string;
