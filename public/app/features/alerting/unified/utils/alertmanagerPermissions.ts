...
export const grafanaContactPointPermissions: Record<ContactPointAction, AccessControlAction[]> = {
  ...
  'test-contact-point': [
    notificationsPermissions.update.grafana, // Legacy broad permission
    AccessControlAction.AlertingReceiversTest, // Deprecated specific permission
    AccessControlAction.AlertingReceiversTestCreate, // Current scoped permission
  ],
};
...
export const externalContactPointPermissions: Record<ContactPointAction, AccessControlAction[]> = {
  ...
  'bulk-export-contact-points': [], // Grafana Alertmanager only
  'test-contact-point': [], // Grafana Alertmanager only
};
...
export const grafanaNotificationPolicyPermissions: Record<NotificationPolicyAction, AccessControlAction[]> = {
  ...
  'view-autogenerated-policy-tree': [], // Admin role check
};
