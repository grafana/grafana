...
import { PostableRuleGrafanaRuleDTO, RulerGrafanaRuleDTO } from 'app/types/unified-alerting-dto';

import { fetchRulerRules, fetchRulerRulesGroup } from '../api/ruler';
...
export function getRulerClient(rulerConfig: RulerDataSourceConfig): RulerClient {
  ...
  //   // @TODO refactor this function so we use useProduceNewRuleGroup hook
  //   await dispatch(
  ...
  //         payload,
  //       },
  //       // we don't need to track the state in the Redux store
  //       { track: false }
  //     )
  //   );
  ...
  //       {
  //         rulerConfig,
  //         namespace: existingRule.namespace_uid ?? '',
  //         payload: {
...
export function copyGrafanaUID(
