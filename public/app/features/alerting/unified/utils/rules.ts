...
export const alertStateToState: Record<PromAlertingRuleState | GrafanaAlertState | AlertState, State> = {
  ...
  [GrafanaAlertState.AlertingNoData]: 'bad',
  [GrafanaAlertState.AlertingError]: 'bad',
  [GrafanaAlertState.Error]: 'bad',
  [GrafanaAlertState.NoData]: 'info',
  [GrafanaAlertState.Normal]: 'good',
  [GrafanaAlertState.NormalNoData]: 'good',
  [GrafanaAlertState.NormalError]: 'good',
  [GrafanaAlertState.Pending]: 'warning',
  [GrafanaAlertState.PendingNoData]: 'warning',
  [GrafanaAlertState.PendingError]: 'warning',
