...
describe('async request state reducers', () => {
  it('tracks a fulfilled request', () => {
    const reducer = createAsyncSliceForTypePrefix<string>('request', typePrefix).reducer;
  ...
  it('tracks requests independently in a map', () => {
    const reducer = createAsyncMapSliceForTypePrefix<string, string>('requests', typePrefix, (arg) => arg).reducer;
