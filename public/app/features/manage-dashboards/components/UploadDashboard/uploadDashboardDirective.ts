  ...
  return {
    ...
    link: (scope: any, elem: JQuery) => {
        ...
        const readerOnload = () => {
          return (e: any) => {
            ...
            try {
              ...
              console.log(err);
              appEvents.emit(alertError, ['Import failed', 'JSON -> JS Serialization failed: ' + err.message]);
              return;
            }
      ...
      if (wnd.File && wnd.FileReader && wnd.FileList && wnd.Blob) {
        ...
        appEvents.emit(alertError, ['Oops', 'The HTML5 File APIs are not fully supported in this browser']);
      }
    },
  };
}
