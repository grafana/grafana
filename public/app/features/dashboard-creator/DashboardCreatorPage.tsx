          ...
          <header className={styles.header}>
            ...
            <p className={styles.description}>
              <Trans i18nKey="dashboard-creator.header.description">
                A purpose-built assistant for Grafana that helps you draft new dashboards — panels, queries, and layout
            ...
            {!isAvailable && (
              <p className={styles.unavailable}>
                <Trans i18nKey="dashboard-creator.prompt.unavailable">
                  The Grafana Assistant isn&apos;t available in this environment. You can still start from a template, a
                  blank dashboard, or by importing JSON below.
                </Trans>
              </p>
            )}
          </section>

          <section className={styles.templateSection} aria-label={t('dashboard-creator.templates.label', 'Templates')}>
