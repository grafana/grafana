...
const getText = (requiredImageRendererPluginVersion?: string) => {
  if (requiredImageRendererPluginVersion) {
    return {
      ...
      afterLink: ` to ver ${requiredImageRendererPluginVersion} to use the dashboard previews. Please contact your Grafana administrator to update the plugin`,
    };
  }
  ...
  return {
    ...
    link: 'Grafana image renderer plugin',
    afterLink: ` to use the dashboard previews. Please contact your Grafana administrator to install the plugin.`,
  };
};
