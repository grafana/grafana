...
function buildTab(options: {
  ...
  const panel = new VizPanel({
    // Read the same way every panel-building site reads it, so a flag-off case really is a panel
    // that was never opted in rather than one opted in by the fixture.
