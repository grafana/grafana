...
import { findOriginalPanelByKey, findVizPanelByKey, getLibraryPanelBehavior } from '../utils/utils';
...
export class DashboardSceneUrlSync implements SceneObjectUrlSyncHandler {
  ...
  updateFromUrl(values: SceneObjectUrlValues): void {
    ...
    if (typeof values.editPanel === 'string') {
      const panel = findOriginalPanelByKey(this._scene, values.editPanel);
