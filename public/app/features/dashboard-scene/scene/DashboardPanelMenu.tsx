...
export class DashboardPanelMenu extends VizPanelMenu {
  public static Component = DashboardPanelMenuRenderer;

  public async updateLinks(extensionLinks: PluginExtensionLink[]) {}
}

function DashboardPanelMenuRenderer({ model }: SceneComponentProps<DashboardPanelMenu>) {
  ...
  useEffect(() => {
    model.updateLinks(links);
  }, [links, model]);

  return <VizPanelMenu.Component model={model} />;
}
