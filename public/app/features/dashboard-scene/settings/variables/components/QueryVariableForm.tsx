        ...
        description={
          <div>
            ...
            <a
              ...
              target="__blank"
            >
              <Trans i18nKey="dashboard-scene.query-variable-editor-form.see-examples">see examples</Trans>
            </a>
            ).
          </div>
        }
        placeholder={t(
          'dashboard-scene.query-variable-editor-form.placeholder-textvalue',
          '/.*-(?<text>.*)-(?<value>.*)-.*/'
        )}
