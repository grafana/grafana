...
import { FilterPill, Grid, Input, Stack, Switch, useStyles2 } from '@grafana/ui';
...
export function TransformationTypePicker() {
  ...
  const { search, setSearch, selectedFilter, setSelectedFilter, categories, filteredTransformations, onSearchKeyDown } =
