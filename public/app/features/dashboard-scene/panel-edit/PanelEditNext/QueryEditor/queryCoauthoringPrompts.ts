...
export function buildCoauthoringSystemPrompt(
  ...
  return [
    ...
    'Follow the datasource-provided editing guidance. If the request cannot be resolved from the query, guidance, and context, ask one concise clarification question in plain text and do not call a tool.',
...
export function buildAssistantHandoffPrompt(
  ...
  return [
    `Help me continue this ${context.language.displayName} editing task.`,
