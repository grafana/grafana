  ...
  return (
    ...
    >
      {editorType === QueryEditorType.Expression && (
        <Icon
          name={QUERY_EDITOR_TYPE_CONFIG[QueryEditorType.Expression].icon}
          color={QUERY_EDITOR_TYPE_CONFIG[QueryEditorType.Expression].color}
        />
      )}
      {editorType === QueryEditorType.Query && <DataSourceLogo dataSource={queryDsSettings} />}
