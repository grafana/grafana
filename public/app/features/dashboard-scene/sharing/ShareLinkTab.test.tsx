...
describe('ShareLinkTab', () => {
  ...
  it('should generate render url', async () => {
    ...
    expect(
      ...
      'href',
      'http://dashboards.grafana.com/grafana/render/d-solo/dash-1?from=2019-02-11T13:00:00.000Z&to=2019-02-11T19:00:00.000Z&panelId=12&width=1000&height=500&tz=Pacific%2FEaster'
    );
  });
});
