    ...
    () => [
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: 'org_most_used_dashboards',
            label: 'Org - most used in dashboards',
            description: 'Option 41',
            enabled: false,
            available: false,
          },
          {
            id: 'org_most_used_in_alert_rules',
            label: 'Org - most used in alert rules',
            description: 'Option 42',
            enabled: false,
            available: false,
          },
          {
          ...
          {
            id: 'team_most_used_in_dashboards',
            label: 'Team - most used in dashboards',
            description: 'Option 51',
            enabled: false,
            available: false,
          },
          {
            id: 'team_most_used_in_alert_rules',
            label: 'Team - most used in alert rules',
            description: 'Option 62',
            enabled: false,
            available: false,
          },
        ],
