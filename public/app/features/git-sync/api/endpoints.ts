...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    listRepositoryForAllNamespaces: build.query<
      ListRepositoryForAllNamespacesApiResponse,
      ListRepositoryForAllNamespacesApiArg
    >({
      query: (queryArg) => ({
        url: `/apis/provisioning.grafana.app/v0alpha1/repositories`,
        params: {
          allowWatchBookmarks: queryArg.allowWatchBookmarks,
          continue: queryArg['continue'],
          fieldSelector: queryArg.fieldSelector,
    ...
    watchNamespacedRepositoryList: build.query<
      WatchNamespacedRepositoryListApiResponse,
      WatchNamespacedRepositoryListApiArg
    >({
      query: (queryArg) => ({
        url: `/apis/provisioning.grafana.app/v0alpha1/watch/namespaces/${queryArg['namespace']}/repositories`,
        params: {
          allowWatchBookmarks: queryArg.allowWatchBookmarks,
          continue: queryArg['continue'],
          fieldSelector: queryArg.fieldSelector,
    ...
    watchNamespacedRepository: build.query<WatchNamespacedRepositoryApiResponse, WatchNamespacedRepositoryApiArg>({
      query: (queryArg) => ({
        url: `/apis/provisioning.grafana.app/v0alpha1/watch/namespaces/${queryArg['namespace']}/repositories/${queryArg.name}`,
        params: {
          allowWatchBookmarks: queryArg.allowWatchBookmarks,
          continue: queryArg['continue'],
          fieldSelector: queryArg.fieldSelector,
    ...
    watchRepositoryListForAllNamespaces: build.query<
      WatchRepositoryListForAllNamespacesApiResponse,
      WatchRepositoryListForAllNamespacesApiArg
    >({
      query: (queryArg) => ({
        url: `/apis/provisioning.grafana.app/v0alpha1/watch/repositories`,
        params: {
          allowWatchBookmarks: queryArg.allowWatchBookmarks,
          continue: queryArg['continue'],
          fieldSelector: queryArg.fieldSelector,
...
export type CreateNamespacedRepositoryApiResponse =
  /** status 200 OK */
...
export type ReplaceNamespacedRepositoryApiResponse =
  /** status 200 OK */
  | ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1Repository
  | /** status 201 Created */ ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1Repository;
...
export type DeleteNamespacedRepositoryApiResponse =
  /** status 200 OK */
  IoK8SApimachineryPkgApisMetaV1Status | /** status 202 Accepted */ IoK8SApimachineryPkgApisMetaV1Status;
...
export type PatchNamespacedRepositoryApiResponse =
  /** status 200 OK */
  | ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1Repository
  | /** status 201 Created */ ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1Repository;
...
export type ListRepositoryForAllNamespacesApiResponse =
  /** status 200 OK */ ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1RepositoryList;
export type ListRepositoryForAllNamespacesApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchNamespacedRepositoryListApiResponse = /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent;
export type WatchNamespacedRepositoryListApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchNamespacedRepositoryApiResponse = /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent;
export type WatchNamespacedRepositoryApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchRepositoryListForAllNamespacesApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent;
export type WatchRepositoryListForAllNamespacesApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1GitHubRepository = {
...
export type ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1LocalRepository = {
  path?: string;
};
export type ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1S3Repository = {
  bucket?: string;
};
export type ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1RepositorySpec = {
  ...
  github?: ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1GitHubRepository;
  /** The repository on the local file system. Mutually exclusive with s3 and github. */
  local?: ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1LocalRepository;
  /** The repository in an S3 bucket. Mutually exclusive with local and github. */
  s3?: ComGithubGrafanaGrafanaPkgApisProvisioningV0Alpha1S3Repository;
};
...
export const {
  ...
  useListRepositoryForAllNamespacesQuery,
  useWatchNamespacedRepositoryListQuery,
  useWatchNamespacedRepositoryQuery,
  useWatchRepositoryListForAllNamespacesQuery,
} = injectedRtkApi;
