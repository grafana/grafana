...
export type DashboardRangeMap = {
  ...
  /** And this is no longer producing valid TS / Go output type: MappingType & "range" */
  type: string;
};
...
export type DashboardRegexMap = {
  ...
  /** And this is no longer producing valid TS / Go output type: MappingType & "regex" */
  type: string;
};
...
export type DashboardSpecialValueMap = {
  ...
  /** And this is no longer producing valid TS / Go output type: MappingType & "special" */
  type: string;
};
export type DashboardValueMap = {
  ...
  /** And this is no longer producing valid TS / Go output type: MappingType & "value" */
  type: string;
};
