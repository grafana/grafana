...
import { DashboardCursorSync, DashboardSpec } from '@grafana/schema/dist/esm/schema/dashboard/v2alpha0/dashboard.gen';
...
export class K8sDashboardV2APIStub implements DashboardAPI<DashboardSpec> {
  // @ts-ignore
  ...
  getDashboardDTO(uid: string, params?: UrlQueryMap) {
    ...
    const result: DashboardDTO<DashboardSpec> = {
      // redirectUri: '',
      meta: {
        isNew: false,
        isFolder: false,
