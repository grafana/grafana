...
export class CustomTimeRangeEditor extends PureComponent<Props, { mode: string }> {
  constructor(props) {
    super(props);
  ...
  move(index, dir) {
    i = index;
    console.log(index, dir, 'Move clicked');
  }
  setupNew() {
    ...
    return (
      <div>
        ...
        {this.state.mode === 'list' ? (
          <List ranges={ranges} add={this.setupNew} move={this.move} edit={this.edit} delete={this.delete} />
        ) : null}
...
export default hot(module)(connect(mapStateToProps)(CustomTimeRangeEditor));
