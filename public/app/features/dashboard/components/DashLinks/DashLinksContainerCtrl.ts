...
import { clientRefreshed, dashLinksUpdated } from '@grafana/data';
...
function dashLink($compile: any, $sanitize: any, linkSrv: LinkSrv) {
  return {
    ...
    link: (scope: any, elem: JQuery) => {
      ...
      update();
      dashboard.events.on(clientRefreshed, update, scope);
    },
  };
}
...
export class DashLinksContainerCtrl {
  ...
  constructor(
    ...
    updateDashLinks();
    $rootScope.onAppEvent(dashLinksUpdated, updateDashLinks, $scope);
  }
}
