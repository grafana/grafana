    ...
    <div className={styles.container}>
      ...
      <div className={styles.footer}>
        <Icon
          ...
          aria-label={t('dashboard.gen-aihistory.aria-label-exclamationcircle', 'exclamation-circle')}
        ...
        <Text variant="bodySmall" color="secondary">
          ...
          <TextLink
            ...
            onClick={onClickDocs}
          >
            <Trans i18nKey="dashboard.gen-aihistory.grafana-llm-plugin">Grafana LLM plugin</Trans>
          </TextLink>
        </Text>
      </div>
    </div>
