...
// so popovers can be anchored to the caret / selection. This is the standard
// "mirror div" technique: clone the textarea's text and styles into a hidden
// div and read back the offset of a marker span.
