...
const tutorialSteps: Step[] = [
  {
    target: `[data-testid='import-tutorial']`,
  ...
  },
  {
    ...
    content: `This is the tutorial preview. You can see the steps and what you'll be doing. It'll even show you your progress through the tutorial and how far you got if you stopped before the end.`,
    placement: `left`,
  },
];
...
console.log(tutorialPageTutorial);
