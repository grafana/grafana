  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case PageTypes.Roles:
        ...
        return (
          <Alert severity="info" title="Coming soon">
            <Trans i18nKey="serviceaccounts.service-account-pages.roles-placeholder">
      ...
      case PageTypes.ResourceAccess:
        ...
        return (
          <Alert severity="info" title="Coming soon">
            <Trans i18nKey="serviceaccounts.service-account-pages.resource-access-placeholder">
              Resource access view will be available here.
            </Trans>
          </Alert>
        );
      default:
