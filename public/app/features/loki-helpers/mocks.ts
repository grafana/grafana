...
/**
 * Builds a Loki datasource-like object for tests. The real datasource lives in the
 * grafana-loki-datasource plugin, so this returns a lightweight stand-in shaped like a
 * datasource instance (its settings are spread onto the returned object).
 */
export function createLokiDatasource(
  ...
  return {
    ...customSettings,
    templateSrv: templateSrvMock as TemplateSrv,
