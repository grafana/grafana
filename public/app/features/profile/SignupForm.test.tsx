...
describe('SignupForm', () => {
  describe('With different values for verifyEmail and autoAssignOrg', () => {
    it('should render input fields', () => {
      const wrapper = shallow(<SignupForm routeParams={{}} verifyEmailEnabled={true} autoAssignOrg={false} />);
    ...
    it('should not render input fields', () => {
      const wrapper = shallow(<SignupForm routeParams={{}} verifyEmailEnabled={false} autoAssignOrg={true} />);
