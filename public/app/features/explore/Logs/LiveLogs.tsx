    ...
    return (
      <div>
        ...
        <div className={styles.logsRowsIndicator}>
          ...
          >
            {isPaused ? t('live-logs.resume-button') : t('live-logs.pause-button')}
          </Button>
          ...
          {isPaused ||
            (this.rowsToRender().length > 0 && (
              <div>
                <Trans i18nKey="live-logs.last-line-received">Last line received:</Trans>
                <ElapsedTime resetKey={this.props.logRows} humanize={true} />
                <Trans i18nKey="live-logs.ago">ago</Trans>
              </div>
            ))}
        </div>
      </div>
