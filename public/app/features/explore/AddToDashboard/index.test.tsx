...
const openModal = async () => {
  ...
  // expect(await screen.findByText('dialog', { name: 'Add panel to dashboard' })).toBeInTheDocument();
  expect(await screen.findByText('Add panel to dashboard')).toBeInTheDocument();
};
...
describe('Add to Dashboard Button', () => {
  ...
  it('Opens and closes the modal correctly', async () => {
    ...
    expect(screen.queryByText('Add panel to dashboard')).not.toBeInTheDocument();
  });
  ...
  it('All queries are correctly passed through', async () => {
    ...
    await waitForElementToBeRemoved(() => screen.queryByText('Add panel to dashboard'));
