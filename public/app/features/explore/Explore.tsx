...
export class Explore extends React.PureComponent<Props, ExploreState> {
  ...
  renderCompactUrlWarning(containerStyles: string) {
    return (
      <div className={containerStyles}>
        {config.featureToggles.legacyExploreCompactURL ? (
          <Alert severity="warning" title="Compact URL deprecation notice">
            The URL that brought you here was a compact URL - this format is deprecated. Please replace the URL
            previously saved with the URL available now.
          </Alert>
        ) : (
          <Alert severity="error" title="Compact URL detected">
            <p>
              Support for compact URLs in Explore has been removed and your default data source is being used instead.
            </p>
            <p>
              If you have existing links pointing to Explore you can use the <code>legacyExploreCompactUrl</code>{' '}
              feature flag to temporarily add back support for the deprecated URL format. Please update them using the
              format generated by Explore upon navigation.
            </p>
          </Alert>
        )}
      </div>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {isFromCompactUrl && this.renderCompactUrlWarning(styles.warningContainer)}
        {datasourceMissing && this.renderEmptyState(styles.exploreContainer)}
        {datasourceInstance && (
