...
export function initializeExplore(
  ...
  return async dispatch => {
    ...
    dispatch(
      initializeExploreAction(exploreId)({
        containerWidth,
        eventBridge,
        exploreDatasources,
        queries,
...
export const loadDatasourceSuccess = (exploreId: ExploreId, instance: any): ActionOf<LoadDatasourceSuccessPayload> => {
  ...
  return loadDatasourceSuccessAction(exploreId)({
    StartPage,
...
export function queryTransactionSuccess(
  ...
  return (dispatch, getState) => {
    ...
    dispatch(
      queryTransactionSuccessAction(exploreId)({
        history: nextHistory,
 ...
 */
const togglePanelActionCreator = (actionCreator: NoPayloadHigherOrderActionCreator) => (
  exploreId: ExploreId,
