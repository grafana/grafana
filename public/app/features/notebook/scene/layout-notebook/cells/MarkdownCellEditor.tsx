...
// so gutters/line numbers stay off. There is no read-only counterpart here — MarkdownCell never mounts
// this component at all unless it's editing.
...
export interface MarkdownCellEditorProps {
  ...
  /**
   * Built by the always-mounted MarkdownCell rather than here: its refs need to survive every
   * isEditing toggle, which only holds for a component that stays mounted across them — this one
   * doesn't, it unmounts every time editing stops. See MarkdownCell's own doc comment.
   */
