...
/**
 * Builds a fresh extension that puts the caret in the editor.
 *
 * A plugin runs when the lazy editor creates its view. Deferring focus by one
 * frame lets CodeMirror attach its DOM and lets the language picker close.
 */
...
export function CodeCellImplementation({ content, isEditing, autoFocus, onChange }: CodeCellProps) {
