...
describe('buildDeclareIncidentParams', () => {
  ...
  it('prefixes the title and attaches the notebook link with a caption', () => {
  ...
  it('prefers a short notebook description as the incident title', () => {
    const params = buildDeclareIncidentParams({
      uid: 'nb1',
      title: 'scratch notes',
  ...
  it('falls back to the first markdown line when description is empty', () => {
    const params = buildDeclareIncidentParams({
      uid: 'nb1',
      title: 'my notebook',
