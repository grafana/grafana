...
interface RuleRowProps {
  ...
  data: Parameters<typeof GroupToNestedTableTransformerEditor>[0]['input'];
...
export const GroupToNestedTableTransformerEditor = ({ input, options: rawOptions, onChange }: EditorProps) => {
