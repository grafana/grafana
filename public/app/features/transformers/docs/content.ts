...
> **Note:** If a variable is used in this transformation, the default alias will be interpolated with the value of the variable. Explicitly define an alias if you want the alias to be unaffected by variable changes.
