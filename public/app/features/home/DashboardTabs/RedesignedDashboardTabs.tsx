...
export function RedesignedDashboardTabs({ extensionComponents }: Props) {
  ...
  return (
    <Stack direction="column" gap={2}>
      ...
      <HomeSection padding={2} paddingTop={1}>
        <TabsBar>
          {contentTabs.map((tab) => {
        ...
        {DEFAULT_TAB_IDS.includes(activeTab) && (
          <TabContent className={styles.tabContent}>
            <ScrollContainer showScrollIndicators maxHeight="300px" minHeight="300px">
