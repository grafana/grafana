...
import { fieldsToLabelsTransformerRegistryItem } from '../components/TransformersUI/fieldsToLabels/FieldsToLabelsTransformerEditor';
...
export const getStandardTransformers = (): Array<TransformerRegistryItem<any>> => {
  return [
    ...
    fieldsToLabelsTransformerRegistryItem,
  ];
};
