...
describe('file_export', () => {
  ...
  describe('when exporting series as rows', () => {
    it('should export points in proper order', () => {
      const text = fileExport.convertSeriesListToCsv(ctx.seriesList, ctx.timeFormat, false);
      const expectedText =
        '"Series";"Time";"Value"\r\n' +
  ...
  describe('when exporting series as columns', () => {
    it('should export points in proper order', () => {
      const text = fileExport.convertSeriesListToCsvColumns(ctx.seriesList, ctx.timeFormat, false, '');
      const expectedText =
    ...
    it('should not modify series.datapoints', () => {
      ...
      fileExport.convertSeriesListToCsvColumns(ctx.seriesList, ctx.timeFormat, false, '');
