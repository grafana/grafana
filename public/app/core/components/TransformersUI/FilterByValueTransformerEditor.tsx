...
import { FilterByValueTransformerOptions } from '@grafana/data/src/transformations/transformers/filterByValue';
...
export const FilterByValueTransformerEditor: React.FC<TransformerUIProps<FilterByValueTransformerOptions>> = ({
  ...
  return (
    <div>
      <div className="gf-form-inline">
        <div className="gf-form">
          <div className="gf-form-label width-8">Filter by Value</div>
          <Select
            className="width-16"
            options={fieldNameOptions}
