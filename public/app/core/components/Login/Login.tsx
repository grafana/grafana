...
const BgElements = ({ flipIndex }) => {
    return Array.from(Array(elementsInWidth * elementRows)).map((el, index) => {
        // const bgColor1 = getColor(index)
        // const bgColor2 = getColor(index+2);
        return (<div className={`login-bg login-bg-${index} ${flipIndex === index ? 'login-bg-flip': ''}`} key={index} />);
    });
};
...
export class Login extends Component {
    ...
    componentWillMount() {
        var intervalID = setInterval(this.flipElements, 3000);
    }
