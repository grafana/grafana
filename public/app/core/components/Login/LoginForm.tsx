      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          <Input
            ...
            autoFocus
            autoCapitalize="none"
            placeholder={loginHint ? loginHint : t('login.form.username-placeholder', 'email or username')}
        ...
        >
          <PasswordField
            ...
            placeholder={passwordHint ? passwordHint : t('login.form.password-placeholder', 'password')}
          />
        </Field>
        <Button
          type="submit"
