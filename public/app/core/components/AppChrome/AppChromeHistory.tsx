...
export const AppChromeHistory = ({}: Props) => {
  ...
  const isOpen = state.historyOpen && !state.historyDocked;
  const onClose = () => chrome.setHistoryOpen(false);
          ...
          <>
            {isOpen && (
              <FocusScope contain autoFocus restoreFocus>
                <HistoryDrawer {...overlayProps} {...dialogProps} />
              </FocusScope>
            )}
          </>
        </CSSTransition>
