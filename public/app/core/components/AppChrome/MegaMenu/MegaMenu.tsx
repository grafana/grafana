...
export const MegaMenu = memo(
  forwardRef<HTMLDivElement, Props>(({ onClose, ...restProps }, ref) => {
    ...
    // Going fully nuclear: when simplified navigation is on, the entire nav is
    // replaced by the (purely cosmetic) gcx terminal.
    const showTerminal = Boolean(config.featureToggles.simplifiedNavigation);
