  ...
  return (
    ...
    >
      <div className={styles.bounce}>
        {/* BMC Change: Next line: Inline to set bmc logo */}
        <img
          alt=""
          src={`public/img/${theme.isDark ? 'bmc_helix_dark' : 'bmc_helix_light'}.svg`}
...
// BMC Change: Comment out frame animation styling
