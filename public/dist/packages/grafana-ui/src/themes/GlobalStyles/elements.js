...
export function getElementStyles(theme) {
    return css({
        ...
        body: Object.assign({ height: '100%', width: '100%', position: 'absolute', color: theme.colors.text.primary, backgroundColor: theme.colors.background.canvas }, getVariantStyles(theme.typography.body)),
