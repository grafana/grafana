...
export var cacheInitialized = false;
export var iconRoot = 'public/img/icons';
...
function cacheItem(content, path) {
    cacheStore[iconRoot + path] = { content: content, status: 'loaded', queue: [] };
}
export function initIconCache() {
    ...
    var grafanaPublicPath = window.__grafana_public_path__;
...
//# sourceMappingURL=iconBundle.js.map