...
describe('SearchResultsCards', () => {
    ...
    describe('when there is data', () => {
        ...
        it('shows the list with the correct accessible label', () => {
            render(React.createElement(SearchResultsCards, { keyboardEvents: mockKeyboardEvents, response: mockSearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
    ...
    describe('when there is no data', () => {
        ...
        it('shows a "No data" message', () => {
            render(React.createElement(SearchResultsCards, { keyboardEvents: mockKeyboardEvents, response: mockEmptySearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
            expect(screen.queryByRole('list', { name: 'Search results list' })).not.toBeInTheDocument();
            expect(screen.getByText('No data')).toBeInTheDocument();
        });
    });
});
//# sourceMappingURL=SearchResultsCards.test.js.map