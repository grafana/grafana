...
describe('ConfirmModal', () => {
    it('should render correct title, body, dismiss-, cancel- and delete-text', () => {
        ...
        render(React.createElement(ConfirmDeleteModal, { onDeleteItems: () => { }, results: selectedItems, onDismiss: () => { } }));
    ...
    describe('with nestedFolders feature flag', () => {
        ...
        it("should ask to type 'delete' to confirm when a folder is selected", () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=ConfirmDeleteModal.test.js.map