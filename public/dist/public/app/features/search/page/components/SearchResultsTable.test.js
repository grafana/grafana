...
import { applyFieldOverrides, createTheme, DataFrameView, FieldType, toDataFrame } from '@grafana/data';
...
describe('SearchResultsTable', () => {
    ...
    const mockKeyboardEvents = new Subject();
    describe('when there is data', () => {
        ...
        const mockSearchResult = {
            ...
            view: new DataFrameView(dataFrames[0]),
        };
        beforeAll(() => {
            jest.spyOn(getGrafanaSearcher(), 'search').mockResolvedValue(mockSearchResult);
        });
        it('shows the table with the correct accessible label', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(SearchResultsTable, { keyboardEvents: mockKeyboardEvents, response: mockSearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
            const table = yield screen.findByRole('table', { name: 'Search results table' });
            expect(table).toBeInTheDocument();
        }));
        it('has the correct row headers', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(SearchResultsTable, { keyboardEvents: mockKeyboardEvents, response: mockSearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
        ...
        it('displays the data correctly in the table', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(SearchResultsTable, { keyboardEvents: mockKeyboardEvents, response: mockSearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
            yield screen.findByRole('table');
    ...
    describe('when there is no data', () => {
        ...
        it('shows a "No data" message', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(SearchResultsTable, { keyboardEvents: mockKeyboardEvents, response: mockEmptySearchResult, onTagSelected: mockOnTagSelected, selection: mockSelection, selectionToggle: mockSelectionToggle, clearSelection: mockClearSelection, height: 1000, width: 1000 }));
            const noData = yield screen.findByText('No data');
            expect(noData).toBeInTheDocument();
            expect(screen.queryByRole('table', { name: 'Search results table' })).not.toBeInTheDocument();
        }));
    });
});
//# sourceMappingURL=SearchResultsTable.test.js.map