...
jest.mock('@grafana/scenes', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/scenes')), { sceneGraph: {
        interpolate: (...args) => interpolateMock(...args),
    } })));
describe('templateSrv', () => {
    ...
    describe('replace with interpolations map', function () {
        ...
        it('replace can save interpolation result', () => {
            let interpolations = [];
            const target = _templateSrv.replace('test.${test}.${scoped}.${nested.name}.${test}.${optionTest:raw}.$notfound', {
    ...
    describe('handle objects gracefully', () => {
        ...
        it('should not pass object to custom function', () => {
            ...
            _templateSrv.replace('this.${test}.filters', {}, (value) => {
                passedValue = value;
                return '';
            });
