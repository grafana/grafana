...
export function formatVariableValue(value, format, variable, text) {
    ...
    const formatVariable = getVariableWrapper(variable, value, text !== null && text !== void 0 ? text : value);
    return formatItem.formatter(value, args, formatVariable);
}
//# sourceMappingURL=formatVariableValue.js.map