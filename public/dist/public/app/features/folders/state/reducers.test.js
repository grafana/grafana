...
import { folderReducer, initialState, loadFolder, loadFolderPermissions, setCanViewFolderPermissions, setFolderTitle, } from './reducers';
...
describe('folder reducer', () => {
    describe('when loadFolder is dispatched', () => {
        it('should load folder and set hasChanged to false', () => {
            reducerTester()
                .givenReducer(folderReducer, Object.assign(Object.assign({}, initialState), { hasChanged: true }))
                .whenActionIsDispatched(loadFolder(getTestFolder()))
                .thenStateShouldEqual(Object.assign(Object.assign(Object.assign({}, initialState), { hasChanged: false }), getTestFolder()));
        });
    });
    describe('when setFolderTitle is dispatched', () => {
        describe('and title has length', () => {
            it('then state should be correct', () => {
                reducerTester()
                    .givenReducer(folderReducer, Object.assign({}, initialState))
                    .whenActionIsDispatched(setFolderTitle('ready'))
                    .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { hasChanged: true, title: 'ready' }));
            });
        });
        describe('and title has no length', () => {
            it('then state should be correct', () => {
                reducerTester()
                    ...
                    .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { hasChanged: false, title: '' }));
            });
        });
    });
    describe('when loadFolderPermissions is dispatched', () => {
        it('then state should be correct', () => {
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { permissions: [
                    {
                        dashboardId: 10,
                        id: 4,
                        inherited: true,
    ...
    describe('setCanViewFolderPermissions', () => {
        it('should set the canViewFolderPermissions value', () => {
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { canViewFolderPermissions: true }));
        });
    });
});
