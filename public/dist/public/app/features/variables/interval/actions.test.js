...
describe('interval actions', () => {
    ...
    describe('when updateIntervalVariableOptions is dispatched', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenActionIsDispatched(toKeyedAction('key', addVariable(toVariablePayload(interval, { global: false, index: 0, model: interval }))))
                .whenAsyncActionIsDispatched(updateIntervalVariableOptions(toKeyedVariableIdentifier(interval)), true);
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', createIntervalOptions({ type: 'interval', id: '0', data: undefined })), toKeyedAction('key', setCurrentVariableValue({
                type: 'interval',
                id: '0',
    ...
    describe('when updateOptions is dispatched but something throws', () => {
        ...
        it('then an notifyApp action should be dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            const interval = intervalBuilder()
                .withId('0')
                .withRootStateKey('key')
                .withQuery('1s,1m,1h,1d')
            ...
            tester.thenDispatchedActionsPredicateShouldEqual((dispatchedActions) => {
                ...
                expect(dispatchedActions[2]).toEqual(toKeyedAction('key', variableStateFailed(toVariablePayload(interval, {
    ...
    describe('when updateAutoValue is dispatched', () => {
        describe('and auto is false', () => {
            it('then no dependencies are called', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('and auto is true', () => {
            it('then correct dependencies are called', () => __awaiter(void 0, void 0, void 0, function* () {
                const interval = intervalBuilder()
                    .withId('0')
                    .withRootStateKey('key')
