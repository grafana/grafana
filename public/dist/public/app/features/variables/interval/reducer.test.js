    ...
    describe('when createIntervalOptions is dispatched', () => {
        describe('and auto is false', () => {
            it('then state should be correct', () => {
                ...
                const auto = false;
                const { initialState } = getVariableTestContext(adapter, { id, query, auto });
                ...
                reducerTester()
                    ...
                    '0': Object.assign(Object.assign({}, initialState['0']), { id: '0', query: '1s,1m,1h,1d', auto: false, options: [
        ...
        describe('and auto is true', () => {
            it('then state should be correct', () => {
                ...
                reducerTester()
                    ...
                    .whenActionIsDispatched(createIntervalOptions(payload))
                    .thenStateShouldEqual({
                    '0': Object.assign(Object.assign({}, initialState['0']), { id: '0', query: '1s,1m,1h,1d', auto: true, options: [
        ...
        describe('and query contains "', () => {
            it('then state should be correct', () => {
                ...
                reducerTester()
                    ...
                    .whenActionIsDispatched(createIntervalOptions(payload))
                    .thenStateShouldEqual({
                    '0': Object.assign(Object.assign({}, initialState['0']), { id: '0', query: '"kalle, anka","donald, duck"', auto: false, options: [
