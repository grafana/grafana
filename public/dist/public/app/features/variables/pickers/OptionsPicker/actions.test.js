...
import { hideOptions, initialOptionPickerState, moveOptionsHighlight, showOptions, toggleOption, updateOptionsAndFilter, updateSearchQuery, } from './reducer';
const datasource = {
    metricFindQuery: jest.fn(() => Promise.resolve([])),
};
jest.mock('@grafana/runtime', () => {
    const original = jest.requireActual('@grafana/runtime');
    return Object.assign(Object.assign({}, original), { getDataSourceSrv: jest.fn(() => ({
            get: () => datasource,
        })), locationService: {
            partial: jest.fn(),
            getSearchObject: () => ({}),
...
describe('options picker actions', () => {
    ...
    describe('when navigateOptions is dispatched with navigation key cancel', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const option = Object.assign(Object.assign({}, createOption(['A'])), { selected: true, value: ['A'] });
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))), toKeyedAction('key', changeVariableProp(toVariablePayload(variable, { propName: 'queryValue', propValue: '' }))), toKeyedAction('key', hideOptions()));
        }));
    });
    describe('when navigateOptions is dispatched with navigation key select without clearOthers', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenAsyncActionIsDispatched(navigateOptions('key', key, clearOthers), true);
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', toggleOption({ option, forceSelect: false, clearOthers })));
        }));
    });
    ...
    describe('when navigateOptions is dispatched with navigation key select after highlighting the third option', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenActionIsDispatched(navigateOptions('key', NavigationKey.moveDown, clearOthers))
                .whenAsyncActionIsDispatched(navigateOptions('key', key, clearOthers), true);
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', toggleOption({ option: options[2], forceSelect: false, clearOthers })));
        }));
    });
    describe('when navigateOptions is dispatched with navigation key select after highlighting the second option', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenAsyncActionIsDispatched(navigateOptions('key', key, clearOthers), true);
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', toggleOption({ option: options[1], forceSelect: false, clearOthers })));
        }));
    });
    it('supports having variables with the same label and different values', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('when navigateOptions is dispatched with navigation key selectAndClose after highlighting the second option', () => {
        it('then correct actions are dispatched for multi-value variable', () => __awaiter(void 0, void 0, void 0, function* () {
            const options = [createOption('A'), createOption('B'), createOption('C')];
            const variable = createMultiVariable({ options, current: createOption(['A'], ['A'], true), includeAll: false });
            const clearOthers = false;
            const key = NavigationKey.selectAndClose;
        ...
        it('then correct actions are dispatched for single-value variable', () => __awaiter(void 0, void 0, void 0, function* () {
            const options = [createOption('A'), createOption('B'), createOption('C')];
            ...
            const tester = yield reduxTester()
                ...
                .whenActionIsDispatched(navigateOptions('key', NavigationKey.moveUp, clearOthers))
                .whenAsyncActionIsDispatched(navigateOptions('key', key, clearOthers), true);
            const option = Object.assign(Object.assign({}, createOption('B')), { selected: true, value: 'B' });
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', toggleOption({ option: options[1], forceSelect: true, clearOthers })), toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))), toKeyedAction('key', changeVariableProp(toVariablePayload(variable, { propName: 'queryValue', propValue: '' }))), toKeyedAction('key', hideOptions()), toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))));
    ...
    describe('when filterOrSearchOptions is dispatched with simple filter', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', updateSearchQuery(filter)), toKeyedAction('key', updateOptionsAndFilter(variable.options)));
        }));
    });
    describe('when openOptions is dispatched and there is no picker state yet', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const preloadedState = getPreloadedState('key', {
                variables: {
                    [variable.id]: Object.assign({}, variable),
                },
                optionsPicker: Object.assign({}, initialOptionPickerState),
            });
    ...
    describe('when openOptions is dispatched and picker.id is same as variable.id', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const preloadedState = getPreloadedState('key', {
                ...
                optionsPicker: Object.assign(Object.assign({}, initialOptionPickerState), { id: variable.id }),
            });
            const tester = yield reduxTester({ preloadedState })
                .givenRootReducer(getRootReducer())
                .whenAsyncActionIsDispatched(openOptions(toKeyedVariableIdentifier(variable), undefined));
    ...
    describe('when openOptions is dispatched and picker.id is not the same as variable.id', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const preloadedState = getPreloadedState('key', {
                variables: {
                    [variable.id]: Object.assign({}, variable),
                    [variableInPickerState.id]: Object.assign({}, variableInPickerState),
                },
                optionsPicker: Object.assign(Object.assign({}, initialOptionPickerState), { id: variableInPickerState.id }),
            });
            const tester = yield reduxTester({ preloadedState })
                .givenRootReducer(getRootReducer())
                .whenAsyncActionIsDispatched(openOptions(toKeyedVariableIdentifier(variable), undefined));
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', setCurrentVariableValue({ type: 'query', id: 'query1', data: { option: undefined } })), toKeyedAction('key', changeVariableProp({ type: 'query', id: 'query1', data: { propName: 'queryValue', propValue: '' } })), toKeyedAction('key', hideOptions()), toKeyedAction('key', showOptions(variable)));
        }));
    });
    ...
    describe('when commitChangesToVariable is dispatched with changes', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenAsyncActionIsDispatched(commitChangesToVariable('key'), true);
            const option = Object.assign(Object.assign({}, createOption([])), { selected: true, value: [] });
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))), toKeyedAction('key', changeVariableProp(toVariablePayload(variable, { propName: 'queryValue', propValue: '' }))), toKeyedAction('key', hideOptions()), toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))));
    ...
    describe('when commitChangesToVariable is dispatched with changes and list of options is filtered', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const tester = yield reduxTester()
                ...
                .whenAsyncActionIsDispatched(commitChangesToVariable('key'), true);
            const option = Object.assign(Object.assign({}, createOption([])), { selected: true, value: [] });
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))), toKeyedAction('key', changeVariableProp(toVariablePayload(variable, { propName: 'queryValue', propValue: 'C' }))), toKeyedAction('key', hideOptions()), toKeyedAction('key', setCurrentVariableValue(toVariablePayload(variable, { option }))));
            expect(locationService.partial).toHaveBeenLastCalledWith({ 'var-Constant': [] });
        }));
    });
    ...
    describe('when toggleOptionByHighlight is dispatched with changes selected from a filtered options list', () => {
        it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            tester.thenDispatchedActionsShouldEqual(toKeyedAction('key', toggleOption({ option: optionA, forceSelect: false, clearOthers })), toKeyedAction('key', updateSearchQuery('B')), toKeyedAction('key', updateOptionsAndFilter(variable.options)), toKeyedAction('key', moveOptionsHighlight(1)), toKeyedAction('key', moveOptionsHighlight(1)), toKeyedAction('key', toggleOption({ option: optionBD, forceSelect: false, clearOthers })));
        }));
    });
});
function createMultiVariable(extend) {
    return createVariable(Object.assign({ multi: true, includeAll: true }, (extend !== null && extend !== void 0 ? extend : {})));
}
function createVariable(extend) {
    return Object.assign(Object.assign(Object.assign({}, initialVariableModelState), { type: 'query', id: '0', rootStateKey: 'key', index: 0, current: createOption([]), options: [], query: 'options-query', name: 'Constant', datasource: { uid: 'datasource' }, definition: '', sort: VariableSort.alphabeticalAsc, refresh: VariableRefresh.never, regex: '', multi: false, includeAll: false }), (extend !== null && extend !== void 0 ? extend : {}));
}
function createOption(text, value, selected) {
    const metric = createMetric(text);
    return Object.assign(Object.assign({}, metric), { value: value !== null && value !== void 0 ? value : metric.value, selected: selected !== null && selected !== void 0 ? selected : false });
}
