...
import { cleanPickerState, hideOptions, initialOptionPickerState as optionsPickerInitialState, moveOptionsHighlight, OPTIONS_LIMIT, optionsPickerReducer, showOptions, toggleAllOptions, toggleOption, updateOptionsAndFilter, updateOptionsFromSearch, updateSearchQuery, } from './reducer';
const getVariableTestContext = (extend) => {
    return {
        initialState: Object.assign(Object.assign({}, optionsPickerInitialState), extend),
    };
};
describe('optionsPickerReducer', () => {
    describe('when toggleOption is dispatched', () => {
        ...
        const expectToggleOptionState = (args) => {
            ...
            const expectedAsRecord = args.expectSelected.reduce((all, current) => {
                all[current] = current;
                return all;
            }, {});
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { selectedValues: args.expectSelected.map((value) => ({ value, text: value, selected: true })), options: args.options.map((option) => {
                    return Object.assign(Object.assign({}, option), { selected: !!expectedAsRecord[option.value] });
                }) }));
        };
        describe('When toggleOption with undefined option is dispatched', () => {
            it('should update selected values', () => {
                ...
                reducerTester()
                    .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                    .whenActionIsDispatched(toggleOption(payload))
                    .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { selectedValues: [], options: [] }));
            });
        });
        ...
        `('and we toggle $option with options: { forceSelect: $forceSelect, clearOthers: $clearOthers } we expect $expectSelected to be selected', ({ option, forceSelect, clearOthers, expectSelected }) => expectToggleOptionState({
                    options,
                    multi,
                    option,
                    clearOthers,
    ...
    describe('when showOptions is dispatched', () => {
        it('then correct values should be selected', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: payload.options, id: payload.id, multi: payload.multi, selectedValues: [{ text: 'B', value: 'B', selected: true }], queryValue: '' }));
        });
    });
    describe('when showOptions is dispatched and picker has queryValue and variable has searchFilter', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(showOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: payload.options, queryValue, id: payload.id, multi: payload.multi, selectedValues: [selected] }));
        });
    });
    describe('when showOptions is dispatched and queryValue and variable has no searchFilter', () => {
        it('then state should be correct', () => {
            ...
            const { initialState } = getVariableTestContext({});
            const payload = { type: 'query', id: '0', current, query, options, queryValue };
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(showOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { id: '0', queryValue: '', selectedValues: [
                    {
    ...
    describe('when hideOptions is dispatched', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign({}, optionsPickerInitialState));
        });
    });
    describe('when changeQueryVariableHighlightIndex is dispatched with -1 and highlightIndex is 0', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { highlightIndex: -1 }));
        });
    });
    describe('when changeQueryVariableHighlightIndex is dispatched with -1 and highlightIndex is 1', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(moveOptionsHighlight(-1))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { highlightIndex: 0 }));
        });
    });
    ...
    describe('when toggleAllOptions is dispatched', () => {
        it('should toggle all values except All to true', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: [
                    { text: 'All', value: '$__all', selected: false },
                    { text: 'A', value: 'A', selected: true },
                    { text: 'B', value: 'B', selected: true },
                ], selectedValues: [
        ...
        describe('but option is null', () => {
            it('then state should be correct', () => {
                ...
                reducerTester()
                    .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                    .whenActionIsDispatched(updateOptionsAndFilter(options))
                    .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: [{ text: 'All', value: '$__all', selected: true }], selectedValues: [{ text: 'All', value: '$__all', selected: true }], queryValue: 'A', highlightIndex: 0 }));
            });
        });
        describe('and option count is are greater then OPTIONS_LIMIT', () => {
            it('then state should be correct', () => {
                ...
                reducerTester()
                    .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                    .whenActionIsDispatched(updateOptionsAndFilter(options))
                    .thenStateShouldEqual(Object.assign(Object.assign({}, cloneDeep(initialState)), { options: [{ text: 'option:1337', value: 'option:1337', selected: false }], selectedValues: [], queryValue: 'option:1337', highlightIndex: 0 }));
            });
        });
    });
    ...
    describe('when updateOptionsFromSearch is dispatched and variable has searchFilter', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: options, selectedValues: [{ text: 'All', value: '$__all', selected: true }], highlightIndex: 0 }));
        });
    });
    describe('when updateSearchQuery is dispatched', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { queryValue: searchQuery }));
        });
    });
    describe('when large data for updateOptionsAndFilter', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateOptionsAndFilter(options))
                .thenStateShouldEqual(Object.assign(Object.assign({}, cloneDeep(initialState)), { options: [{ text: 'option:11256', value: 'option:11256', selected: false }], selectedValues: [], queryValue: 'option:11256', highlightIndex: 0 }));
        });
    });
    describe('when large data for updateOptionsFromSearch is dispatched and variable has searchFilter', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateOptionsFromSearch(options))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: options.slice(0, OPTIONS_LIMIT), selectedValues: [{ text: 'All', value: '$__all', selected: true }], highlightIndex: 0 }));
        });
    });
    describe('when large data for showOptions', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(optionsPickerReducer, cloneDeep(initialState))
                .whenActionIsDispatched(showOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { options: checkOptions, id: '0', multi: false, queryValue: '' }));
        });
    });
