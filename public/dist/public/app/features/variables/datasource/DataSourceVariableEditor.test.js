...
const props = {
    ...
    variable: Object.assign(Object.assign({}, initialDataSourceVariableModelState), { rootStateKey: 'foo' }),
...
describe('DataSourceVariableEditor', () => {
    ...
    it('has a data source select menu', () => {
        render(React.createElement(DataSourceVariableEditor, Object.assign({}, props)));
        const selectContainer = getSelectParent(screen.getByLabelText('Type'));
        expect(selectContainer).toHaveTextContent('Prometheus');
    });
    it('calls the handler when the data source is changed', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(DataSourceVariableEditor, Object.assign({}, props)));
        yield selectOptionInTest(screen.getByLabelText('Type'), 'Loki');
...
//# sourceMappingURL=DataSourceVariableEditor.test.js.map