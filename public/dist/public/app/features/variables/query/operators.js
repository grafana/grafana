...
import { FieldType, getFieldDisplayName, getProcessedDataFrames, isDataFrame, } from '@grafana/data';
import { validateVariableSelectionState } from '../state/actions';
import { toKeyedAction } from '../state/keyedVariablesReducer';
import { toKeyedVariableIdentifier, toVariablePayload } from '../utils';
import { updateVariableOptions } from './reducer';
export function toMetricFindValuesOperator() {
    return (source) => source.pipe(map(toMetricFindValues));
}
export function toMetricFindValues(panelData) {
