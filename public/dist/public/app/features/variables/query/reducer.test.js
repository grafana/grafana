...
describe('queryVariableReducer', () => {
    ...
    describe('when updateVariableOptions is dispatched and includeAll is true and payload is an empty array', () => {
        it('then state should be correct', () => {
            const { initialState } = getVariableTestContext(adapter, { includeAll: true });
            const update = { results: [], templatedRegex: '' };
            const payload = toVariablePayload({ id: '0', type: 'query' }, update);
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'All', value: '$__all', selected: false }] }) }));
        });
    });
    describe('when updateVariableOptions is dispatched and includeAll is false and payload is an empty array', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'None', value: '', selected: false, isNone: true }] }) }));
        });
    });
    ...
    describe('when updateVariableOptions is dispatched and includeAll is false and regex is set', () => {
        it('then state should be correct', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'A', value: 'A', selected: false }] }) }));
        });
    });
    describe('when updateVariableOptions is dispatched and includeAll is false and regex is set and uses capture groups', () => {
        it('normal regex should capture in order matches', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'atext', value: 'avalue', selected: false }] }) }));
        });
        ...
        it('unmatched text capture will use value capture', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'avalue', value: 'avalue', selected: false }] }) }));
        });
        it('unmatched value capture will use text capture', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'atext', value: 'atext', selected: false }] }) }));
        });
        it('unnamed capture group returns any unnamed match', () => {
            ...
            reducerTester()
                .givenReducer(queryVariableReducer, cloneDeep(initialState))
                .whenActionIsDispatched(updateVariableOptions(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { '0': Object.assign(Object.assign({}, initialState[0]), { options: [{ text: 'counter', value: 'counter', selected: false }] }) }));
        });
...
describe('sortVariableValues', () => {
    ...
    `('then it should sort the options correctly without throwing (sortOrder:$sortOrder)', ({ options, sortOrder, expected }) => {
...
describe('metricNamesToVariableValues', () => {
    const item = (str) => ({ text: str, value: str, selected: false });
    const metricsNames = [
