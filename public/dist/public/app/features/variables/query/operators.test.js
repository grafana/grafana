...
describe('operators', () => {
    ...
    describe('validateVariableSelection', () => {
        describe('when called', () => {
            it('then the correct observable should be created', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('when called', () => {
            it('then the correct observable should be created', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield expect(observable).toEmitValuesWith((received) => {
                    ...
                    expect(dispatch).toHaveBeenCalledTimes(1);
                    expect(dispatch).toHaveBeenCalledWith(toKeyedAction('key', updateVariableOptions({
                        id: 'query',
                        type: 'query',
    ...
    describe('toMetricFindValues', () => {
        ...
        describe('when called without metric find values and string fields', () => {
            it('then the observable throws', () => {
                ...
                const panelData = { series: [frameWithTimeField] };
                expect(() => toMetricFindValues(panelData)).toThrow(new Error("Couldn't find any field of type string in the results."));
            });
        });
    });
});
