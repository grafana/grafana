...
function getTestContext(ds, dsInstance) {
    jest.clearAllMocks();
    const key = 'key';
    ...
    describe('when called and variables have legacy data source props', () => {
        describe('and data source exists', () => {
            it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                expect(dispatch.mock.calls[0][0]).toEqual(toKeyedAction(key, changeVariableProp(toVariablePayload(query, {
                    propName: 'datasource',
                    propValue: { uid: 'a random uid', type: 'prometheus' },
                }))));
                expect(dispatch.mock.calls[1][0]).toEqual(toKeyedAction(key, changeVariableProp(toVariablePayload(adhoc, {
                    propName: 'datasource',
                    propValue: { uid: 'a random uid', type: 'prometheus' },
                }))));
            }));
        ...
        describe('and data source does not exist', () => {
            it('then correct actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                migrateVariablesDatasourceNameToRef(key, getDatasourceSrvFunc)(dispatch, getState, undefined);
                expect(dispatch).toHaveBeenCalledTimes(2);
                expect(dispatch.mock.calls[0][0]).toEqual(toKeyedAction(key, changeVariableProp(toVariablePayload(query, { propName: 'datasource', propValue: { uid: '${ds}' } }))));
                expect(dispatch.mock.calls[1][0]).toEqual(toKeyedAction(key, changeVariableProp(toVariablePayload(adhoc, { propName: 'datasource', propValue: { uid: '${ds}' } }))));
            }));
        });
    });
    describe('when called and variables have dataSourceRef', () => {
        it('then no actions are dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=migrateVariablesDatasourceNameToRef.test.js.map