...
function getTestContext(urlQueryMap = {}, variable = undefined) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const panelModelB = new PanelModel(Object.assign(Object.assign({}, modelJson), { id: 2, targets: [{ refId: 'B', queryType: '${variableB}' }] }));
        const templateVariableValueUpdatedMock = jest.fn();
        const startRefreshMock = jest.fn();
        const dashboard = Object.assign(Object.assign({}, initialState), { getModel: () => {
        ...
        const variables = { variable, variableB };
        const state = Object.assign({ dashboard }, getPreloadedState(key, { variables }));
        const getState = () => state;
        const dispatch = jest.fn();
        const thunk = templateVarsChangedInUrl(key, urlQueryMap);
        yield thunk(dispatch, getState, undefined);
...
describe('templateVarsChangedInUrl', () => {
    describe('when called with no variables in url query map', () => {
        it('then no value should change and dashboard should not be refreshed', () => __awaiter(void 0, void 0, void 0, function* () {
            const { setValueFromUrlMock, templateVariableValueUpdatedMock, startRefreshMock } = yield getTestContext();
    ...
    describe('when called with variables in url query map matching variables in state', () => {
        ...
        describe('and the values in url query map are the not the same as current in state', () => {
            it('then the value should change to the value in url query map and dashboard should be refreshed', () => __awaiter(void 0, void 0, void 0, function* () {
                const { setValueFromUrlMock, templateVariableValueUpdatedMock, startRefreshMock, variable } = yield getTestContext({
            ...
            it('should update URL value and only refresh panels with variableB dependency', () => __awaiter(void 0, void 0, void 0, function* () {
                const { setValueFromUrlMock, templateVariableValueUpdatedMock, startRefreshMock, variableB } = yield getTestContext({
            ...
            describe('but the values in url query map were removed', () => {
                it('then the value should change to the value in dashboard json and dashboard should be refreshed', () => __awaiter(void 0, void 0, void 0, function* () {
                    const { setValueFromUrlMock, templateVariableValueUpdatedMock, startRefreshMock, variable } = yield getTestContext({
