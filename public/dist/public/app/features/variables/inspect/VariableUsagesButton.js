...
export var VariableUsagesButton = function (_a) {
    var id = _a.id, usages = _a.usages, isAdhoc = _a.isAdhoc;
    var network = useMemo(function () { return usages.find(function (n) { return n.variable.id === id; }); }, [usages, id]);
