...
describe('createNewVariable', () => {
    ...
    it('should dispatch with the correct rootStateKey', () => {
        ...
        const model = Object.assign(Object.assign({}, initialConstantVariableModelState), { name: mockId, id: mockId, rootStateKey: 'null' });
        createNewVariable(null, 'constant')(mockDispatch, mockGetState, undefined);
        expect(mockDispatch).toHaveBeenCalledTimes(1);
        expect(mockDispatch.mock.calls[0][0]).toEqual(toKeyedAction('null', addVariable({ data: { global: false, index: 0, model }, type: 'constant', id: mockId })));
    });
});
