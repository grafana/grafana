...
describe('panel state actions', () => {
    describe('changePanelPlugin', () => {
        it('Should load plugin and call changePlugin', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('Should apply options and fieldConfig', () => __awaiter(void 0, void 0, void 0, function* () {
            const sourcePanel = new PanelModel({ id: 12, type: 'graph' });
            yield thunkTester({
                plugins: {
                    panels: {},
