...
export const promiseWithRemoteObservableAsObservable = (promiseWithProxyObservable) => from(promiseWithProxyObservable).pipe(switchMap((val) => remoteObservableAsObservable(val)));
