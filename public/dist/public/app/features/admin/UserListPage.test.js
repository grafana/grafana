...
jest.mock('@grafana/runtime', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/runtime')), { getBackendSrv: () => ({ get: jest.fn().mockResolvedValue([]) }) })));
jest.mock('./UserListAdminPage', () => ({
    UserListAdminPageContent: () => React.createElement("div", { "data-testid": selectors.UserListAdminPage.container }),
}));
jest.mock('../users/UsersListPage', () => ({
    UsersListPageContent: () => React.createElement("div", { "data-testid": selectors.UsersListPage.container }),
}));
jest.mock('./UserListPublicDashboardPage/UserListPublicDashboardPage', () => ({
    UserListPublicDashboardPage: () => React.createElement("div", { "data-testid": selectors.UsersListPublicDashboardsPage.container }),
}));
const renderPage = () => {
...
const enableEmailSharing = () => {
    ...
    config.licenseInfo = Object.assign(Object.assign({}, config.licenseInfo), { enabledFeatures: { publicDashboardsEmailSharing: true } });
};
let originalConfigData;
beforeEach(() => {
    originalConfigData = Object.assign({}, config);
});
afterEach(() => {
...
describe('Tabs rendering', () => {
    it('should render All and Org Users tabs when user has permissions to read to org users and is admin', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should render All, Org and Public dashboard tabs when user has permissions to read org users, is admin and has email sharing enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(true);
        enableEmailSharing();
        renderPage();
        expect(screen.getByTestId(tabsSelector.allUsers)).toBeInTheDocument();
    ...
    describe('No permissions to read org users or not admin', () => {
        it('should render no tabs when user has no permissions to read org users', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('No permissions to read org users but email sharing enabled', () => {
        it(`should render User and Public dashboard tabs when no permissions to read org users but has email sharing enabled`, () => __awaiter(void 0, void 0, void 0, function* () {
            jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(false);
            enableEmailSharing();
            renderPage();
            expect(screen.queryByTestId(tabsSelector.allUsers)).not.toBeInTheDocument();
...
describe('Tables rendering', () => {
    ...
    it('should render UsersListPage when user is admin and has org read permissions', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(true);
        renderPage();
        expect(screen.getByTestId(tabsSelector.allUsers).className.includes('activeTabStyle')).toBeTruthy();
        expect(screen.getByTestId(tabsSelector.orgUsers)).toBeInTheDocument();
        expect(screen.getByTestId(selectors.UserListAdminPage.container)).toBeInTheDocument();
        yield userEvent.click(screen.getByTestId(tabsSelector.orgUsers));
    ...
    it('should render UsersListPage when user has org read permissions and is not admin', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(false);
        renderPage();
        expect(screen.queryByTestId(tabsSelector.allUsers)).not.toBeInTheDocument();
        expect(screen.queryByTestId(tabsSelector.orgUsers)).not.toBeInTheDocument();
    ...
    it('should render UserListPublicDashboardPage when user has email sharing enabled and is not admin', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(false);
        enableEmailSharing();
        renderPage();
        expect(screen.queryByTestId(tabsSelector.allUsers)).not.toBeInTheDocument();
        ...
        yield userEvent.click(screen.getByTestId(tabsSelector.publicDashboardsUsers));
    ...
    it('should render UsersListPage when user is not admin and does not have nor org read perms neither email sharing enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(false);
        renderPage();
        expect(screen.queryByTestId(tabsSelector.allUsers)).not.toBeInTheDocument();
        expect(screen.queryByTestId(tabsSelector.orgUsers)).not.toBeInTheDocument();
...
//# sourceMappingURL=UserListPage.test.js.map