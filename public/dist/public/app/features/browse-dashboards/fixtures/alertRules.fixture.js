...
export function getRulerRulesResponse(folderName, folderUid, seed = 1) {
...
export function getPrometheusRulesResponse(folderName, seed = 1) {
    const random = Chance(seed);
    return {
        status: 'success',
        data: {
...
//# sourceMappingURL=alertRules.fixture.js.map