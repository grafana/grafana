...
export function getFolderPermissions(folderDTO) {
    ...
    const canCreateFolders = Boolean((!folderDTO || config.featureToggles.nestedFolders) && checkFolderPermission(AccessControlAction.FoldersCreate));
