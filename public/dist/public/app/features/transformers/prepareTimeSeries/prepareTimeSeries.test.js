import { toDataFrame, FieldType, toDataFrameDTO, DataFrameType, getFrameDisplayName, } from '@grafana/data';
...
describe('Prepare time series transformer', () => {
    ...
    it('should transform none when source only has long frames', () => {
        ...
        expect(toEquableDataFrames(prepareTimeSeriesTransformer.transformer(config, ctx)(source))).toEqual(toEquableDataFrames(source.map((frame) => (Object.assign(Object.assign({}, frame), { meta: {
                type: DataFrameType.TimeSeriesMulti,
            } })))));
    });
    ...
    it('should handle long to wide', () => {
        expect(prepareTimeSeriesTransformer.transformer({
...
function toEquableDataFrame(source) {
    return toDataFrame(Object.assign(Object.assign({ meta: undefined }, source), { fields: source.fields.map((field) => {
            return Object.assign(Object.assign({}, field), { config: {} });
        }) }));
}
