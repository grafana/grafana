...
function assertFieldsEqual(field1, field2) {
    var _a, _b;
    expect(field1.type).toEqual(field2.type);
    expect(field1.name).toEqual(field2.name);
    expect(field1.values).toEqual(field2.values);
    expect((_a = field1.labels) !== null && _a !== void 0 ? _a : {}).toEqual((_b = field2.labels) !== null && _b !== void 0 ? _b : {});
}
function assertDataFrameField(field, matchesFrames) {
...
function getTimeSeries(refId, labels, values = [10]) {
    return toDataFrame({
        refId,
        fields: [
...
function getTable(refId, fields) {
    return toDataFrame({
        refId,
...
//# sourceMappingURL=timeSeriesTableTransformer.test.js.map