...
import { FieldMatcherID, PluginState, TransformerCategory, } from '@grafana/data';
...
export function ConfigFromQueryTransformerEditor({ input, onChange, options }) {
    var _a;
    ...
    const currentMatcher = (_a = options.applyTo) !== null && _a !== void 0 ? _a : { id: FieldMatcherID.byType, options: 'number' };
    ...
    const onRefIdChange = (value) => {
        onChange(Object.assign(Object.assign({}, options), { configRefId: value.value || 'config' }));
    };
    const onMatcherChange = (value) => {
        onChange(Object.assign(Object.assign({}, options), { applyTo: { id: value.value } }));
    };
    const onMatcherConfigChange = (matcherOption) => {
        onChange(Object.assign(Object.assign({}, options), { applyTo: { id: currentMatcher.id, options: matcherOption } }));
    };
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(InlineFieldRow, null,
            React.createElement(InlineField, { label: "Config query", labelWidth: 20 },
                React.createElement(Select, { onChange: onRefIdChange, options: refIds, value: currentRefId, width: 30 }))),
        React.createElement(InlineFieldRow, null,
            React.createElement(InlineField, { label: "Apply to", labelWidth: 20 },
                React.createElement(Select, { onChange: onMatcherChange, options: matchers, value: currentMatcher.id, width: 30 }))),
        React.createElement(InlineFieldRow, null,
        ...
        React.createElement(InlineFieldRow, null, configFrame && (React.createElement(FieldToConfigMappingEditor, { frame: configFrame, mappings: options.mappings, onChange: (mappings) => onChange(Object.assign(Object.assign({}, options), { mappings })), withReducers: true })))));
}
