...
describe('Lookup gazetteer', () => {
    it('adds lat/lon based on string field', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const cfg = {
        ...
        const matcher = fieldMatchers.get(FieldMatcherID.byName).get((_a = cfg.options) === null || _a === void 0 ? void 0 : _a.lookupField);
        ...
        const out = yield addFieldsFromGazetteer([data], gaz, matcher)[0];
    ...
    it('goes through entire gazetteer to find matches', () => __awaiter(void 0, void 0, void 0, function* () {
        var _b;
        const cfg = {
            id: DataTransformerID.fieldLookup,
            options: {
        ...
        const matcher = fieldMatchers.get(FieldMatcherID.byName).get((_b = cfg.options) === null || _b === void 0 ? void 0 : _b.lookupField);
        const frame = toDataFrame({
            fields: [
