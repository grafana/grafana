...
describe('Fields from JSON', () => {
    it('adds fields from JSON in string', () => __awaiter(void 0, void 0, void 0, function* () {
        const cfg = {
            source: 'line',
            replace: true,
        };
        ...
        expect(frames[0].fields.reduce((acc, v) => {
            acc[v.name] = v.type;
            return acc;
    ...
    it('skips null values', () => __awaiter(void 0, void 0, void 0, function* () {
        const cfg = {
            source: 'line',
            replace: false,
        };
...
//# sourceMappingURL=extractFields.test.js.map