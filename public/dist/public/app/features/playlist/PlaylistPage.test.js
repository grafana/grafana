...
function getTestContext() {
    return render(React.createElement(TestProvider, null,
        React.createElement(PlaylistPage, null)));
}
describe('PlaylistPage', () => {
    ...
    describe('when mounted without a playlist', () => {
        ...
        it('then show empty list', () => __awaiter(void 0, void 0, void 0, function* () {
            const { getByText } = getTestContext();
            yield waitFor(() => getByText('There are no playlists created yet'));
        }));
        describe('and signed in user is not a viewer', () => {
            it('then create playlist button should not be disabled', () => __awaiter(void 0, void 0, void 0, function* () {
                contextSrv.isEditor = true;
                const { getByRole } = getTestContext();
                const createPlaylistButton = yield waitFor(() => getByRole('link', { name: /create playlist/i }));
                expect(createPlaylistButton).not.toHaveStyle('pointer-events: none');
            }));
        });
        describe('and signed in user is a viewer', () => {
            it('then create playlist button should be disabled', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('when mounted with a playlist', () => {
        ...
        describe('and signed in user is not a viewer', () => {
            it('then playlist title and all playlist buttons should appear on the page', () => __awaiter(void 0, void 0, void 0, function* () {
                contextSrv.isEditor = true;
                const { getByRole, getByText } = getTestContext();
                yield waitFor(() => getByText('A test playlist'));
        ...
        describe('and signed in user is a viewer', () => {
            it('then playlist title and only start playlist button should appear on the page', () => __awaiter(void 0, void 0, void 0, function* () {
                contextSrv.isEditor = false;
