...
export var PlaylistNewPage = function (_a) {
    ...
    return (React.createElement(Page, { navModel: navModel },
        React.createElement(Page.Contents, { isLoading: loading },
            React.createElement("h3", { className: styles.subHeading }, "New Playlist"),
