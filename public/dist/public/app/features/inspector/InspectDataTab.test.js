...
const createProps = (propsOverride) => {
    const defaultProps = {
        isLoading: false,
        options: {
...
describe('InspectDataTab', () => {
    describe('when panel is not passed as prop (Explore)', () => {
        it('should render InspectDataTab', () => {
            render(React.createElement(InspectDataTab, Object.assign({}, createProps())));
        ...
        it('should show available options', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(InspectDataTab, Object.assign({}, createProps())));
            const dataOptions = screen.getByText(/Data options/i);
            yield userEvent.click(dataOptions);
        ...
        it('should show available dataFrame options', () => __awaiter(void 0, void 0, void 0, function* () {
            render(React.createElement(InspectDataTab, Object.assign({}, createProps())));
            const dataOptions = screen.getByText(/Data options/i);
            yield userEvent.click(dataOptions);
            const dataFrameInput = screen.getByRole('combobox', { name: /Select dataframe/i });
            yield userEvent.click(dataFrameInput);
        ...
        it('should show download logs button if logs data', () => {
            ...
            render(React.createElement(InspectDataTab, Object.assign({}, createProps({ data: dataWithLogs }))));
        ...
        it('should show download traces button if traces data', () => {
            ...
            render(React.createElement(InspectDataTab, Object.assign({}, createProps({ data: dataWithtraces }))));
