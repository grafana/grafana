...
import { dataFrameFromJSON, dateTimeFormat, FieldType, LogsMetaKind } from '@grafana/data';
...
describe('inspector download', () => {
    ...
    describe('downloadDataFrameAsCsv', () => {
        ...
        it.each([[dataFrameFromJSON(json), 'test', '"time","name","value"\r\n100,a,1']])('should, when logsModel is %s and title is %s, resolve in %s', (dataFrame, title, expected) => __awaiter(void 0, void 0, void 0, function* () {
            downloadDataFrameAsCsv(dataFrame, title);
            const call = saveAs.mock.calls[0];
            const blob = call[0];
    ...
    describe('downloadAsJson', () => {
        ...
        ])('should, when logsModel is %s and title is %s, resolve in %s', (logsModel, title, expected) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            [
                {
                    ...
                    rows: [{ timeEpochMs: 100, entry: 'testEntry' }],
                },
                'test',
