...
describe('InspectErrorTab', () => {
    it('should return null when error does not exist', () => {
        const { container } = render(React.createElement(InspectErrorTab, null));
    ...
    it('should return a jsonFormatter object of error.data if it exists', () => {
        ...
        render(React.createElement(InspectErrorTab, { errors: [error] }));
    ...
    it('should return a jsonFormatter object of error.message if it exists and data does not exist', () => {
        const error = {
            message: '{ "error": { "code": "BadRequest", "message": "Please provide below info when asking for support.", "details": [] } }',
        };
        const { container } = render(React.createElement(InspectErrorTab, { errors: [error] }));
    ...
    it('should return an h3 and jsonFormatter object of error.message if it exists and data does not exist', () => {
        const error = {
            message: '400 BadRequest, Error from Azure: { "error": { "code": "BadRequest", "message": "Please provide below info when asking for support.", "details": [] } }',
        };
        const { container } = render(React.createElement(InspectErrorTab, { errors: [error] }));
    ...
    it('should return multiple errors', () => {
        ...
        render(React.createElement(InspectErrorTab, { errors: errors }));
...
//# sourceMappingURL=InspectErrorTab.test.js.map