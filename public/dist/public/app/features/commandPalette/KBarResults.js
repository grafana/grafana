...
const START_INDEX = 0;
export const KBarResults = (props) => {
    ...
    const execute = React.useCallback((ev, item) => {
        var _a, _b;
    ...
    return (React.createElement("div", { ref: parentRef, style: {
        ...
        React.createElement("div", { role: "listbox", id: KBAR_LISTBOX, style: {
            ...
            const handlers = typeof item !== 'string' && {
                ...
                onClick: (ev) => execute(ev, item),
            };
            const active = virtualRow.index === activeIndex;
            const childProps = Object.assign({ id: getListboxItemId(virtualRow.index), role: 'option', 'aria-selected': active, style: {
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    width: '100%',
            ...
            const renderedItem = React.cloneElement(props.onRender({
                item,
                active,
            }), {
            ...
            if (url) {
                return (React.createElement("a", Object.assign({ key: virtualRow.index, href: url, target: target, 
                    // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
                    ref: active ? activeRef : null }, childProps), renderedItem));
            }
            return (React.createElement("div", Object.assign({ key: virtualRow.index, 
                // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
                ref: active ? activeRef : null }, childProps), renderedItem));
        }))));
};
//# sourceMappingURL=KBarResults.js.map