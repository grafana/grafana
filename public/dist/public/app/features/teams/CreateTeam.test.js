...
describe('Create team', () => {
    ...
    it('should send correct data to the server', () => __awaiter(void 0, void 0, void 0, function* () {
        setup();
        yield userEvent.type(screen.getByRole('textbox', { name: /name/i }), 'Test team');
        yield userEvent.type(screen.getByLabelText(/email/i), 'team@test.com');
        yield userEvent.click(screen.getByRole('button', { name: /create/i }));
        yield waitFor(() => {
