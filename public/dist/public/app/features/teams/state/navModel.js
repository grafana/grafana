...
export function buildNavModel(team) {
    ...
    if (highlightTrial()) {
        teamGroupSync.tabSuffix = () => ProBadge({ experimentId: isLoadingTeam ? '' : 'feature-highlights-team-sync-badge', eventVariant: 'trial' });
    }
    ...
    if (featureEnabled('teamsync')) {
        ...
        navModel.children.push(Object.assign(Object.assign({}, teamGroupSync), { tabSuffix: () => ProBadge({ experimentId: isLoadingTeam ? '' : 'feature-highlights-team-sync-badge' }) }));
    }
    return navModel;
}
