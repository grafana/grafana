...
jest.mock('app/core/services/backend_srv', () => ({
    backendSrv: {
        getInspectorStream: () => new Observable((subscriber) => {
...
const setup = (propOverrides = {}) => {
    const props = Object.assign({ width: 100, exploreId: 'left', onClose: jest.fn(), timeZone: InternalTimeZones.utc, queryResponse: {
    ...
    return render(React.createElement(ExploreQueryInspector, Object.assign({}, props)));
};
