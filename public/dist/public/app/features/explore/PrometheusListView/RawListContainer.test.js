...
import { FieldType, toDataFrame } from '@grafana/data/src';
...
describe('RawListContainer', () => {
    it('should render', () => {
        render(React.createElement(RawListContainer, Object.assign({}, defaultProps)));
...
//# sourceMappingURL=RawListContainer.test.js.map