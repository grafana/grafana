...
export function useExplorePageTitle(params) {
    ...
    useEffect(() => {
        ...
        Promise.allSettled(Object.values(safeParseJson(params.panes)).map((pane) => {
            if (!pane ||
                typeof pane !== 'object' ||
...
//# sourceMappingURL=useExplorePageTitle.js.map