...
import { EventBusSrv, FieldType, LoadingState, LogLevel, MutableDataFrame, standardTransformersRegistry, toUtc, } from '@grafana/data';
...
jest.mock('app/core/utils/shortLinks', () => (Object.assign(Object.assign({}, jest.requireActual('app/core/utils/shortLinks')), { createAndCopyShortLink: (url) => createAndCopyShortLink(url) })));
...
jest.mock('../state/explorePane', () => (Object.assign(Object.assign({}, jest.requireActual('../state/explorePane')), { changePanelState: (exploreId, panel, panelState) => {
...
describe('Logs', () => {
    ...
    const getComponent = (partialProps, logs) => {
        ...
        return (React.createElement(Logs, Object.assign({ exploreId: 'left', splitOpen: () => undefined, logsVolumeEnabled: true, onSetLogsVolumeEnabled: () => null, onClickFilterLabel: () => null, onClickFilterOutLabel: () => null, logsVolumeData: undefined, loadLogsVolumeData: () => undefined, logRows: logs !== null && logs !== void 0 ? logs : rows, timeZone: 'utc', width: 50, loading: false, loadingState: LoadingState.Done, absoluteRange: {
            ...
            }, addResultsToCache: () => { }, onChangeTime: () => { }, clearCache: () => { }, getFieldLinks: () => {
                return [];
            }, eventBus: new EventBusSrv(), isFilterLabelActive: jest.fn(), logsFrames: [testDataFrame] }, partialProps)));
    };
    ...
    describe('scrolling behavior', () => {
        ...
        describe('when `exploreScrollableLogsContainer` is not set', () => {
            ...
            it('should call `scrollElement.scroll`', () => {
                ...
                setup({ scrollElement: scrollElementMock, panelState: { logs: { id: 'uid47' } } }, logs);
                // element.getBoundingClientRect().top will always be 0 for jsdom
    ...
    it('should render a load more button', () => {
        ...
        render(React.createElement(Logs, { exploreId: 'left', splitOpen: () => undefined, logsVolumeEnabled: true, onSetLogsVolumeEnabled: () => null, onClickFilterLabel: () => null, onClickFilterOutLabel: () => null, logsVolumeData: undefined, loadLogsVolumeData: () => undefined, logRows: [], onStartScanning: scanningStarted, timeZone: 'utc', width: 50, loading: false, loadingState: LoadingState.Done, absoluteRange: {
                from: toUtc('2019-01-01 10:00:00').valueOf(),
                to: toUtc('2019-01-01 16:00:00').valueOf(),
            }, range: {
                from: toUtc('2019-01-01 10:00:00'),
                ...
                return [];
            }, eventBus: new EventBusSrv(), isFilterLabelActive: jest.fn() }));
    ...
    it('should flip the order', () => __awaiter(void 0, void 0, void 0, function* () {
        setup();
        const oldestFirstSelection = screen.getByLabelText('Oldest first');
        yield userEvent.click(oldestFirstSelection);
        const logsSection = screen.getByTestId('logRows');
        let logRows = logsSection.querySelectorAll('tr');
        expect(logRows.length).toBe(3);
    ...
    describe('for permalinking', () => {
        ...
        it('should scroll the scrollElement into view if rows contain id', () => {
            ...
            setup({ loading: false, scrollElement: scrollElementMock, panelState });
        ...
        it('should call reportInteraction on permalinkClick', () => __awaiter(void 0, void 0, void 0, function* () {
            const panelState = { logs: { id: 'not-included' } };
            setup({ loading: false, panelState });
            const row = screen.getAllByRole('row');
            yield userEvent.hover(row[0]);
            const linkButton = screen.getByLabelText('Copy shortlink');
            yield userEvent.click(linkButton);
        ...
        it('should call createAndCopyShortLink on permalinkClick', () => __awaiter(void 0, void 0, void 0, function* () {
            const panelState = { logs: { id: 'not-included' } };
            setup({ loading: false, panelState });
            const row = screen.getAllByRole('row');
            yield userEvent.hover(row[0]);
    ...
    describe('with table visualisation', () => {
        ...
        it('should change visualisation to table on toggle', () => __awaiter(void 0, void 0, void 0, function* () {
            setup();
            const logsSection = screen.getByRole('radio', { name: 'Show results in table visualisation' });
            yield userEvent.click(logsSection);
...
const makeLog = (overrides) => {
    ...
    return Object.assign({ uid, entryFieldIndex: 0, rowIndex: 0, dataFrame: new MutableDataFrame(), logLevel: LogLevel.debug, entry, hasAnsi: false, hasUnescapedContent: false, labels: {}, raw: entry, timeFromNow: '', timeEpochMs: 1, timeEpochNs: '1000000', timeLocal: '', timeUtc: '' }, overrides);
};
