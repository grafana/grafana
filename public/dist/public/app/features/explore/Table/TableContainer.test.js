...
describe('TableContainer', () => {
    describe('With one main frame', () => {
        it('should render component', () => {
            render(React.createElement(TableContainer, Object.assign({}, defaultProps)));
        ...
        it('should render 0 series returned on no items', () => {
            ...
            render(React.createElement(TableContainer, Object.assign({}, defaultProps, { tableResult: emptyFrames })));
            expect(screen.getByText('0 series returned')).toBeInTheDocument();
        });
        it('should update time when timezone changes', () => {
            const { rerender } = render(React.createElement(TableContainer, Object.assign({}, defaultProps)));
            ...
            rerender(React.createElement(TableContainer, Object.assign({}, defaultProps, { timeZone: "cest" })));
    ...
    describe('With multiple main frames', () => {
        it('should render multiple tables for multiple frames', () => {
            ...
            const multiDefaultProps = Object.assign(Object.assign({}, defaultProps), { tableResult: dataFrames });
            render(React.createElement(TableContainer, Object.assign({}, multiDefaultProps)));
            const tables = getTables();
