...
describe('useStructureRev', () => {
    ...
    it('should increment only when relevant fields in frame change', () => {
        let frames = [toDataFrame({ fields: [{ name: 'time', type: FieldType.time, values: [1, 2, 3] }] })];
...
//# sourceMappingURL=useStructureRev.test.js.map