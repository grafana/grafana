...
describe('loadAndInitDatasource', () => {
    ...
    it('falls back to default datasource if the provided one was not found', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { instance } = yield loadAndInitDatasource(1, { uid: 'Unknown' });
    ...
    it('saves last loaded data source uid', () => __awaiter(void 0, void 0, void 0, function* () {
        setLastUsedDatasourceUIDSpy = jest.spyOn(exploreUtils, 'setLastUsedDatasourceUID');
        dataSourceMock.get.mockResolvedValue(TEST_DATASOURCE);
        const { instance } = yield loadAndInitDatasource(1, { uid: 'Test' });
