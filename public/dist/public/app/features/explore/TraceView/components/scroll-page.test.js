...
describe('scroll-by', () => {
    beforeEach(() => {
        ...
        jest.mocked(Tween).mockImplementation((opts) => {
            const rv = { to: opts.to, onUpdate: opts.onUpdate, cancel: jest.fn(), getCurrent: jest.fn() };
    ...
    describe('_onTweenUpdate', () => {
        ...
        it('scrolls to `value`', () => {
            ...
            onUpdate === null || onUpdate === void 0 ? void 0 : onUpdate({ value, done: false });
        ...
        it('discards the in-progress scroll if the scroll is done', () => {
            ...
            onUpdate === null || onUpdate === void 0 ? void 0 : onUpdate({ value: 123, done: true });
...
//# sourceMappingURL=scroll-page.test.js.map