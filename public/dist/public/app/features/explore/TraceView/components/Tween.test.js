...
describe('Tween', () => {
    ...
    describe('ctor', () => {
        ...
        it('adds delay to the startTime', () => {
            const n = Math.random();
            nowFn.mockReturnValue(n);
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { delay: 10 }));
            expect(tween.startTime).toBe(n + 10);
        });
        describe('with callbacks', () => {
            it('schedules setTimeout if there is a delay', () => {
                const delay = 10;
                const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { delay, onUpdate: jest.fn() }));
                expect(setTimeout).lastCalledWith(tween._frameCallback, delay);
            });
            it('schedules animation frame if there is not a delay', () => {
                const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { onUpdate: jest.fn() }));
    ...
    describe('getCurrent()', () => {
        it('returns `{done: false, value: from}` when time is before the delay is finished', () => {
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { delay: 1 }));
    ...
    describe('_frameCallback', () => {
        it('freezes the callback argument', () => {
            ...
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { onUpdate: fn }));
        ...
        it('does not call onComplete if there is an onComplete callback and the tween is not complete', () => {
            const fn = jest.fn();
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { onComplete: fn }));
            tween._frameCallback();
        ...
        it('schedules an animatinon frame if the tween is not complete', () => {
            ...
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { onUpdate: () => { } }));
    ...
    describe('cancel()', () => {
        ...
        it('releases references to callbacks', () => {
            const tween = new Tween(Object.assign(Object.assign({}, baseOptions), { onComplete: () => { }, onUpdate: () => { } }));
            tween.cancel();
