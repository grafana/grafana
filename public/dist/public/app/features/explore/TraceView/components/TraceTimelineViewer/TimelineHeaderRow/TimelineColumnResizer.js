...
export default class TimelineColumnResizer extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { className: styles.TimelineColumnResizer, ref: this._setRootElm, "data-testid": "TimelineColumnResizer" },
            React.createElement("div", { className: cx(styles.gripIcon, isDragging && styles.gripIconDragging), style: gripStyle, "data-testid": "TimelineColumnResizer--gripIcon" }),
            React.createElement("div", { "aria-hidden": true, className: cx(styles.dragger, isDragging && styles.draggerDragging, isDraggingRight && styles.draggerDraggingRight, isDraggingLeft && styles.draggerDraggingLeft), onMouseDown: this._dragManager.handleMouseDown, style: draggerStyle, "data-testid": "TimelineColumnResizer--dragger" })));
    }
}
//# sourceMappingURL=TimelineColumnResizer.js.map