...
const setup = (propOverrides) => {
    const props = Object.assign({ compact: false, data: references, highContrast: false, isOpen: false, onToggle: jest.fn(), createFocusSpanLink: () => link }, propOverrides);
    return render(React.createElement(AccordianReferences, Object.assign({}, props)));
};
...
//# sourceMappingURL=AccordianReferences.test.js.map