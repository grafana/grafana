...
export function deduplicateTags(tags) {
    ...
    const dedupedTags = tags.reduce((uniqueTags, tag) => {
...
// exported for tests
export function orderTags(tags, topPrefixes) {
    var _a;
    const orderedTags = (_a = tags === null || tags === void 0 ? void 0 : tags.slice()) !== null && _a !== void 0 ? _a : [];
...
export default function transformTraceData(data) {
    if (!(data === null || data === void 0 ? void 0 : data.traceID)) {
        return null;
    }
    ...
    data.processes = Object.entries(data.processes).reduce((processes, [id, process]) => {
        processes[id] = Object.assign(Object.assign({}, process), { tags: orderTags(process.tags) });
        return processes;
    }, {});
...
//# sourceMappingURL=transform-trace-data.js.map