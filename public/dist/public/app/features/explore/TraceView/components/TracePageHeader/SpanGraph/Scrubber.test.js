...
describe('<Scrubber>', () => {
    ...
    let rerender;
    beforeEach(() => {
        ({ rerender } = render(React.createElement("svg", null,
            React.createElement(Scrubber, Object.assign({}, defaultProps)))));
    });
    ...
    it('calculates the correct x% for a timestamp', () => {
        rerender(React.createElement("svg", null,
            React.createElement(Scrubber, Object.assign({}, defaultProps, { position: 0.5 }))));
