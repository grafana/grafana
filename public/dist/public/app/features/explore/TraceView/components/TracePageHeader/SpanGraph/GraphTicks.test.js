...
const setup = (propOverrides) => {
    const defaultProps = Object.assign({ items: [
            { valueWidth: 100, valueOffset: 25, serviceName: 'a' },
            { valueWidth: 100, valueOffset: 50, serviceName: 'b' },
        ], valueWidth: 200, numTicks: 4 }, propOverrides);
    return render(React.createElement("svg", null,
        React.createElement(GraphTicks, Object.assign({}, defaultProps))));
};
...
//# sourceMappingURL=GraphTicks.test.js.map