...
export default function LabeledList(props) {
    ...
    return (React.createElement("ul", { className: cx(styles.LabeledList, className) }, items.map(({ key, label, value }) => {
        return (React.createElement("li", { className: styles.LabeledListItem, key: `${key}` },
            React.createElement("span", { className: styles.LabeledListLabel }, label),
            React.createElement("strong", { className: styles.LabeledListValue }, value)));
    })));
}
//# sourceMappingURL=LabeledList.js.map