...
const setupAccordian = (propOverrides) => {
    const props = Object.assign({ compact: false, data: tags, isOpen: true, label: 'test accordian', onToggle: jest.fn() }, propOverrides);
    return render(React.createElement(AccordianKeyValues, Object.assign({}, props)));
};
const setupKeyValues = (propOverrides) => {
    const props = Object.assign({ data: tags }, propOverrides);
    return render(React.createElement(KeyValuesSummary, Object.assign({}, props)));
};
...
//# sourceMappingURL=AccordianKeyValues.test.js.map