...
describe('spanAncestorIdsSpy', () => {
    ...
    it('ignores references without a span', () => {
        const spanWithSomeEmptyReferences = Object.assign(Object.assign({}, span), { references: [{ refType: 'CHILD_OF' }, { refType: 'FOLLOWS_FROM', span: {} }, ...span.references] });
        expect(spanAncestorIdsSpy(spanWithSomeEmptyReferences)).toEqual(expectedAncestorIds);
    });
});
//# sourceMappingURL=span-ancestor-ids.test.js.map