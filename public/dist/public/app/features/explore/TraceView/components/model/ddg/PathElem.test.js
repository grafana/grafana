...
describe('PathElem', () => {
    const getPath = () => {
        ...
        const members = simplePath.map(({ operation, service }, i) => new PathElem({
            memberIdx: i,
            operation: {
                name: operation,
                service: {
    ...
    it('is external if it is first or last PathElem in memberOf.path and not the focalElem', () => {
        ...
        const path = Object.assign(Object.assign({}, testPath), { focalIdx: testPath.members.length - 1 });
...
//# sourceMappingURL=PathElem.test.js.map