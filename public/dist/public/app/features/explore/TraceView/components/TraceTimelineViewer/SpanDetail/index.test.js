...
describe('<SpanDetail>', () => {
    ...
    it('renders without exploding', () => {
        expect(() => render(React.createElement(SpanDetail, Object.assign({}, props)))).not.toThrow();
    });
    it('shows the operation name', () => {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
    ...
    it('renders the span tags', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
        yield userEvent.click(screen.getByRole('switch', { name: /Span Attributes/ }));
        expect(props.tagsToggle).toHaveBeenLastCalledWith(span.spanID);
    }));
    it('renders the process tags', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
        yield userEvent.click(screen.getByRole('switch', { name: /Resource Attributes/ }));
        expect(props.processToggle).toHaveBeenLastCalledWith(span.spanID);
    }));
    it('renders the logs', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
        yield userEvent.click(screen.getByRole('switch', { name: /Events/ }));
        expect(props.logsToggle).toHaveBeenLastCalledWith(span.spanID);
        yield userEvent.click(screen.getByRole('switch', { name: /oh the log/ }));
        expect(props.logItemToggle).toHaveBeenLastCalledWith(span.spanID, props.span.logs[0]);
    }));
    it('renders the warnings', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
        yield userEvent.click(screen.getByRole('switch', { name: /Warnings/ }));
        expect(props.warningsToggle).toHaveBeenLastCalledWith(span.spanID);
    }));
    it('renders the references', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanDetail, Object.assign({}, props)));
        yield userEvent.click(screen.getByRole('switch', { name: /References/ }));
