...
describe('<SpanBar>', () => {
    ...
    it('renders without exploding', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(SpanBar, Object.assign({}, props)));
        expect(screen.getByText(shortLabel)).toBeInTheDocument();
        expect(screen.queryByText(longLabel)).not.toBeInTheDocument();
        yield userEvent.hover(screen.getByTestId(selectors.components.TraceViewer.spanBar));
        expect(screen.queryByText(shortLabel)).not.toBeInTheDocument();
        expect(screen.getByText(longLabel)).toBeInTheDocument();
        yield userEvent.unhover(screen.getByTestId(selectors.components.TraceViewer.spanBar));
        expect(screen.getByText(shortLabel)).toBeInTheDocument();
        expect(screen.queryByText(longLabel)).not.toBeInTheDocument();
    }));
...
//# sourceMappingURL=SpanBar.test.js.map