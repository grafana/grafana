...
describe('DraggableManager', () => {
    ...
    function startDragging(dragManager) {
        dragManager.handleMouseDown(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mousedown' }));
    ...
    describe('minor mouse events', () => {
        it('throws an error for invalid event types', () => {
            ...
            const throwers = [
                () => instance.handleMouseEnter(Object.assign(Object.assign({}, baseMouseEvt), { type })),
                () => instance.handleMouseMove(Object.assign(Object.assign({}, baseMouseEvt), { type })),
                () => instance.handleMouseLeave(Object.assign(Object.assign({}, baseMouseEvt), { type })),
            ];
        ...
        it('does nothing if already dragging', () => {
            ...
            instance.handleMouseEnter(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mouseenter' }));
            instance.handleMouseMove(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mousemove' }));
            instance.handleMouseLeave(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mouseleave' }));
            ...
            const evt = Object.assign(Object.assign({}, baseMouseEvt), { type: 'invalid-type' });
        ...
        it('passes data based on the mouse event type to callbacks', () => {
            ...
            cases.forEach((testCase) => {
                ...
                const event = Object.assign(Object.assign({}, baseMouseEvt), { type });
                handler(event);
                expect((_a = jest.mocked(callback)) === null || _a === void 0 ? void 0 : _a.mock.calls).toEqual([
    ...
    describe('drag events', () => {
        ...
        it('throws an error for invalid event types', () => {
            expect(() => instance.handleMouseDown(Object.assign(Object.assign({}, baseMouseEvt), { type: 'invalid-event-type' }))).toThrow();
        });
        describe('mousedown', () => {
            it('is ignored if already dragging', () => {
                ...
                (_a = jest.mocked(ctorOpts.onDragStart)) === null || _a === void 0 ? void 0 : _a.mockReset();
                expect(getBounds.mock.calls.length).toBe(1);
                instance.handleMouseDown(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mousedown' }));
                expect(getBounds.mock.calls.length).toBe(1);
        ...
        describe('mousemove', () => {
            it('is ignored if not already dragging', () => {
                instance._handleDragEvent(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mousemove' }));
        ...
        describe('mouseup', () => {
            it('is ignored if not already dragging', () => {
                instance._handleDragEvent(Object.assign(Object.assign({}, baseMouseEvt), { type: 'mouseup' }));
...
//# sourceMappingURL=DraggableManager.test.js.map