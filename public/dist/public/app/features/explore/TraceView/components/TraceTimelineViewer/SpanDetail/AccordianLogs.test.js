...
const setup = (propOverrides) => {
    const props = Object.assign({ logs, isOpen: false, onItemToggle: jest.fn(), onToggle: () => { }, openedItems: new Set([logs[1]]), timestamp: 5 }, propOverrides);
    return render(React.createElement(AccordianLogs, Object.assign({}, props)));
};
...
//# sourceMappingURL=AccordianLogs.test.js.map