...
const setup = (propOverrides) => {
    const props = Object.assign({ data: data }, propOverrides);
    return render(React.createElement(KeyValuesTable, Object.assign({}, props)));
};
describe('LinkValue', () => {
    it('renders as expected', () => {
        ...
        render(React.createElement(LinkValue, { href: href, title: title }, childrenText));
...
describe('KeyValuesTable tests', () => {
    ...
    it('renders a single link correctly', () => {
        setup({
            linksGetter: (array, i) => array[i].key === 'span.kind'
                ? [
                    {
    ...
    it('renders a link in json and properly escapes it', () => {
        ...
        expect((_a = link.attributes.getNamedItem('href')) === null || _a === void 0 ? void 0 : _a.value).toBe('https://example.com%22id=x%20tabindex=1%20onfocus=alert(1)');
    });
...
//# sourceMappingURL=KeyValuesTable.test.js.map