...
export default class TreeNode {
    ...
    get depth() {
        var _a;
        return (_a = this.children) === null || _a === void 0 ? void 0 : _a.reduce((depth, child) => Math.max(child.depth + 1, depth), 1);
    }
    get size() {
        let i = 0;
        this.walk(() => i++);
    ...
    addChild(child) {
        var _a;
        (_a = this.children) === null || _a === void 0 ? void 0 : _a.push(child instanceof TreeNode ? child : new TreeNode(child));
        return this;
    }
    find(search) {
