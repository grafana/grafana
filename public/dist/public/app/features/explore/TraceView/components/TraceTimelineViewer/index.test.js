...
describe('<TraceTimelineViewer>', () => {
    ...
    it('it does not explode', () => {
        expect(() => render(React.createElement(TraceTimelineViewer, Object.assign({}, props)))).not.toThrow();
    });
    it('it sets up actions', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(TraceTimelineViewer, Object.assign({}, props)));
        ...
        yield userEvent.click(expandOne);
        expect(props.expandOne).toHaveBeenCalled();
        yield userEvent.click(collapseOne);
        expect(props.collapseOne).toHaveBeenCalled();
        yield userEvent.click(expandAll);
        expect(props.expandAll).toHaveBeenCalled();
        yield userEvent.click(collapseAll);
