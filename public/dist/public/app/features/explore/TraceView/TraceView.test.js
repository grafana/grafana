...
import { MutableDataFrame, getDefaultTimeRange, LoadingState } from '@grafana/data';
import { setDataSourceSrv } from '@grafana/runtime';
import { configureStore } from '../../../store/configureStore';
import { TraceView } from './TraceView';
import { TopOfViewRefType } from './components/TraceTimelineViewer/VirtualizedTraceView';
import { transformDataFrames } from './utils/transform';
function getTraceView(frames) {
    ...
    return (React.createElement(Provider, { store: store },
        React.createElement(TraceView, { exploreId: "left", dataFrames: frames, splitOpenFn: () => { }, traceProp: transformDataFrames(frames[0]), queryResponse: mockPanelData, datasource: undefined, topOfViewRef: topOfViewRef, topOfViewRefType: TopOfViewRefType.Explore })));
}
...
describe('TraceView', () => {
    ...
    it('toggles detailState', () => __awaiter(void 0, void 0, void 0, function* () {
        renderTraceViewNew();
        ...
        yield userEvent.click(spanView);
    ...
    it('correctly shows processes for each span', () => __awaiter(void 0, void 0, void 0, function* () {
        renderTraceView();
        let table;
        ...
        yield userEvent.click(firstSpan);
        yield userEvent.click(screen.getByText(/Resource/));
