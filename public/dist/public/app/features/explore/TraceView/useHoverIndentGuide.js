...
export function useHoverIndentGuide() {
    var _a = __read(useState(new Set()), 2), hoverIndentGuideIds = _a[0], setHoverIndentGuideIds = _a[1];
    var addHoverIndentGuideId = useCallback(function addHoverIndentGuideId(spanID) {
    ...
    var removeHoverIndentGuideId = useCallback(function removeHoverIndentGuideId(spanID) {
        setHoverIndentGuideIds(function (prevState) {
            var newHoverIndentGuideIds = new Set(prevState);
    ...
    return { hoverIndentGuideIds: hoverIndentGuideIds, addHoverIndentGuideId: addHoverIndentGuideId, removeHoverIndentGuideId: removeHoverIndentGuideId };
}
//# sourceMappingURL=useHoverIndentGuide.js.map