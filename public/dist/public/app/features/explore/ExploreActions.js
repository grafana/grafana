    ...
    useEffect(() => {
        ...
        if (splitted) {
            ...
            const hasMixed = Object.values(panes).some((pane) => {
                var _a;
                return ((_a = pane === null || pane === void 0 ? void 0 : pane.datasourceInstance) === null || _a === void 0 ? void 0 : _a.uid) === MIXED_DATASOURCE_NAME;
            });
...
//# sourceMappingURL=ExploreActions.js.map