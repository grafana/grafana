...
export class AlertTabCtrl {
    ...
    getAlertHistory() {
        promiseToDigest(this.$scope)(getBackendSrv()
            ...
            this.alertHistory = map(res, (ah) => {
                var _a;
                ah.time = (_a = this.dashboardSrv.getCurrent()) === null || _a === void 0 ? void 0 : _a.formatDate(ah.time, 'MMM D, YYYY HH:mm:ss');
    ...
    initModel() {
        ...
        for (const addedNotification of alert.notifications) {
            ...
            let model = find(this.notifications, { uid: identifier });
    ...
    buildConditionModel(source) {
        const cm = { source: source, type: source.type };
