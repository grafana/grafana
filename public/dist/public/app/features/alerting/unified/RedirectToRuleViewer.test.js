...
jest.mock('react-router-dom', () => (Object.assign(Object.assign({}, jest.requireActual('react-router-dom')), { Redirect: jest.fn(({}) => `Redirected`) })));
jest.mock('react-use');
const renderRedirectToRuleViewer = (pathname, search) => {
    ...
    return render(React.createElement(TestProvider, null,
        React.createElement(RedirectToRuleViewer, null)));
};
