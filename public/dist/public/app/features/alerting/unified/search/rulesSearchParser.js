import { isPromAlertingRuleState, PromAlertingRuleState } from '../../../../types/unified-alerting-dto';
import { getRuleHealth, isPromRuleType } from '../utils/rules';
import * as terms from './search.terms';
import { applyFiltersToQuery, FilterSupportedTerm, parseQueryToFilter, } from './searchParser';
const filterSupportedTerms = [
...
export var RuleHealth;
(function (RuleHealth) {
    RuleHealth["Ok"] = "ok";
    RuleHealth["Error"] = "error";
    RuleHealth["NoData"] = "nodata";
    RuleHealth["Unknown"] = "unknown";
})(RuleHealth || (RuleHealth = {}));
// Define how to map parsed tokens into the filter object
export function getSearchFilterFromQuery(query) {
    const filter = { labels: [], freeFormWords: [], dataSourceNames: [] };
    const tokenToFilterMap = {
...
export function applySearchFilterToQuery(query, filter) {
...
//# sourceMappingURL=rulesSearchParser.js.map