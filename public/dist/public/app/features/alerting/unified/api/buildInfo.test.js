...
describe('discoverDataSourceFeatures', () => {
    describe('When buildinfo returns 200 response', () => {
        it('Should return Prometheus with disabled ruler API when application and features fields are missing', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield discoverDataSourceFeatures({
        ...
        it.each([true, false])(`Should return Mimir with rulerApiEnabled set to %p according to the ruler_config_api value`, (rulerApiEnabled) => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockReturnValue(of({
                data: {
                    status: 'success',
                    data: {
        ...
        it('When the data source is Loki should not call the buildinfo endpoint', () => __awaiter(void 0, void 0, void 0, function* () {
            yield discoverDataSourceFeatures({ url: '/datasource/proxy', name: 'Loki', type: 'loki' });
            expect(fetch).not.toBeCalled();
        }));
        it('When the data source is Loki should test Prom and Ruler API endpoints to discover available features', () => __awaiter(void 0, void 0, void 0, function* () {
            mocks.fetchTestRulerRulesGroup.mockResolvedValue(null);
            mocks.fetchRules.mockResolvedValue([]);
            const response = yield discoverDataSourceFeatures({ url: '/datasource/proxy', name: 'Loki', type: 'loki' });
    ...
    describe('When buildinfo returns 404 error', () => {
        it('Should return cortex with ruler API disabled when prom rules works and ruler api returns not avaiable errors', () => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockReturnValue(throwError(() => ({
                status: 404,
            })));
        ...
        it('Should return cortex with ruler API enabled when prom rules works and ruler api returns cortex error', () => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockReturnValue(throwError(() => ({
                status: 404,
            })));
            mocks.fetchTestRulerRulesGroup.mockResolvedValue(null);
