...
import { mockAlertQuery, mockCombinedRule, mockCombinedRuleGroup, mockCombinedRuleNamespace, mockDataSource, MockDataSourceSrv, mockPromAlert, mockPromAlertingRule, mockRulerGrafanaRule, } from '../mocks';
...
describe('filterRules', function () {
    ...
    // Typos there are deliberate to test the fuzzy search
    it.each(['availability', 'avialability', 'avail group'])('should filter out rules by evaluation group name = "%s"', function (groupFilter) {
        const ns = mockCombinedRuleNamespace({
            groups: [
...
//# sourceMappingURL=useFilteredRules.test.js.map