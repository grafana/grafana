...
import { AlertmanagerAction, useAlertmanagerAbilities, useAlertmanagerAbility, useAllAlertmanagerAbilities, } from './useAbilities';
/**
...
function createWrapper(alertmanagerSourceName) {
    const wrapper = (props) => (React.createElement(Router, { history: createBrowserHistory() },
        React.createElement(AlertmanagerProvider, { accessType: 'notification', alertmanagerSourceName: alertmanagerSourceName }, props.children)));
    return wrapper;
}
//# sourceMappingURL=useAbilities.test.js.map