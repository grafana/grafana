...
function withState(state, labels) {
    return { activeAt: '', annotations: {}, labels: labels || {}, state: state, value: '' };
}
function withDate(activeAt, labels) {
    return {
        activeAt: activeAt || '',
        annotations: {},
        labels: labels || {},
...
describe('createExploreLink', () => {
    it('should create a correct explore link', () => {
        ...
        expect(url).toBe('/explore?left=%7B%22datasource%22%3A%22uid%22%2C%22queries%22%3A%5B%7B%22refId%22%3A%22A%22%2C%22datasource%22%3A%7B%22uid%22%3A%22uid%22%2C%22type%22%3A%22type%22%7D%2C%22expr%22%3A%22cpu_utilization+%3E+0.5%22%7D%5D%2C%22range%22%3A%7B%22from%22%3A%22now-1h%22%2C%22to%22%3A%22now%22%7D%7D');
    });
});
