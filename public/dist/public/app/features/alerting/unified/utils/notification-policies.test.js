...
import { findMatchingRoutes, normalizeRoute, getInheritedProperties, computeInheritedTree, } from './notification-policies';
...
describe('findMatchingRoutes', () => {
    ...
    it('should match catch-all route', () => {
        var _a;
        const policiesWithAll = Object.assign(Object.assign({}, policies), { routes: [CATCH_ALL_ROUTE, ...((_a = policies.routes) !== null && _a !== void 0 ? _a : [])] });
    ...
    it('should match multiple routes with continue', () => {
        var _a;
        const policiesWithAll = Object.assign(Object.assign({}, policies), { routes: [
                Object.assign(Object.assign({}, CATCH_ALL_ROUTE), { continue: true }),
                ...((_a = policies.routes) !== null && _a !== void 0 ? _a : []),
            ] });
...
//# sourceMappingURL=notification-policies.test.js.map