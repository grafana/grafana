...
const getReferencedIdsForClassicCondition = (model) => {
    var _a;
    return (_a = model.conditions) === null || _a === void 0 ? void 0 : _a.map((condition) => {
...
const getReferencedIdsForMath = (model, queries) => {
    return (queries
        ...
        .filter((q) => { var _a; return q.queryType === 'query' && ((_a = model.expression) === null || _a === void 0 ? void 0 : _a.includes(q.refId)); })
        .map((q) => {
        return q.refId;
    }));
};
