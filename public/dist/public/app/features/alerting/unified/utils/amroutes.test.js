...
const buildAmRoute = (override = {}) => {
    return Object.assign(Object.assign({}, emptyAmRoute), override);
};
const buildFormAmRoute = (override = {}) => {
    return Object.assign(Object.assign({}, emptyRoute), override);
};
describe('formAmRouteToAmRoute', () => {
    describe('when called with overrideGrouping=false', () => {
        it('Should not set groupBy', () => {
            // Arrange
            const route = buildFormAmRoute({ id: '1', overrideGrouping: false, groupBy: ['SHOULD NOT BE SET'] });
            // Act
    ...
    describe('when called with overrideGrouping=true', () => {
        it('Should set groupBy', () => {
            // Arrange
            const route = buildFormAmRoute({ id: '1', overrideGrouping: true, groupBy: ['SHOULD BE SET'] });
            // Act
            const amRoute = formAmRouteToAmRoute('test', route, { id: 'root' });
            // Assert
