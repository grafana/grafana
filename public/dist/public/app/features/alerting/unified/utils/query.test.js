...
describe('alertRuleToQueries', function () {
    it('it should convert grafana alert', function () {
        var combinedRule = {
            name: 'Test alert',
            query: 'up',
            labels: {},
        ...
        var result = alertRuleToQueries(combinedRule);
        expect(result).toEqual(grafanaAlert.data);
    });
    it('shoulds convert cloud alert', function () {
        var combinedRule = {
            name: 'cloud test',
            labels: {},
            query: 'up == 0',
