...
export function getMostFiredRulesScene(datasource, panelTitle) {
    ...
    return new SceneFlexItem(Object.assign(Object.assign({}, PANEL_STYLES), { body: PanelBuilders.table().setTitle(panelTitle).setDescription(panelTitle).setData(transformation).build() }));
}
//# sourceMappingURL=MostFiredRulesTable.js.map