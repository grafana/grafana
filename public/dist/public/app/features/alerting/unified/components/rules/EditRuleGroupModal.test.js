...
import { mockCombinedRule, mockCombinedRuleNamespace, mockDataSource, mockPromAlertingRule, mockPromRecordingRule, mockRulerAlertingRule, mockRulerRecordingRule, mockRulerRuleGroup, mockStore, } from '../../mocks';
...
const ui = {
    ...
    folderLink: byTitle(/Go to folder/),
...
describe('EditGroupModal', () => {
    it('Should disable all inputs but interval when intervalEditOnly is set', () => {
        ...
        render(React.createElement(EditCloudGroupModal, { namespace: namespace, group: group, intervalEditOnly: true, onClose: () => jest.fn() }), {
...
describe('EditGroupModal component on cloud alert rules', () => {
    ...
    it('Should show alert table in case of having some non-recording rules in the group', () => {
        ...
        render(React.createElement(EditCloudGroupModal, { namespace: promNs, group: group, onClose: () => jest.fn() }), {
            wrapper: getProvidersWrapper(),
        });
...
describe('EditGroupModal component on grafana-managed alert rules', () => {
    ...
    it('Should show alert table', () => {
        render(React.createElement(EditCloudGroupModal, { namespace: grafanaNamespace, group: grafanaGroup1, onClose: jest.fn() }), {
            wrapper: getProvidersWrapper(),
        });
...
//# sourceMappingURL=EditRuleGroupModal.test.js.map