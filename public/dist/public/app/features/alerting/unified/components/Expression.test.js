...
const expression = '100 - ( avg by ( agent_hostname ) ( rate ( node_cpu_seconds_total { mode = "idle" } [ 2h ] ) ) * 100 ) > 97';
const rulesSource = {
    id: 5,
    uid: 'gdev-prometheus',
    type: 'prometheus',
...
describe('Expression', () => {
    it('Should not allow to edit the text in the editor', () => {
        render(React.createElement(Expression, { expression: expression, rulesSource: rulesSource }));
