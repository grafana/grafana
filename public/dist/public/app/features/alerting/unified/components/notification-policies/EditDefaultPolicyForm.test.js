    ...
    describe('Timing options', function () {
        it('should render prometheus duration strings in form inputs', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield user.click(ui.timingOptionsBtn.get());
...
function renderRouteForm(route, receivers = [], onSubmit = noop) {
    render(React.createElement(AmRootRouteForm, { alertManagerSourceName: GRAFANA_RULES_SOURCE_NAME, actionButtons: React.createElement(Button, { type: "submit" }, "Update default policy"), onSubmit: onSubmit, receivers: receivers, route: route }), { wrapper: TestProvider });
}
//# sourceMappingURL=EditDefaultPolicyForm.test.js.map