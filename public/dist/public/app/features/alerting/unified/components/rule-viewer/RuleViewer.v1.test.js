...
import { getCloudRule, getGrafanaRule, grantUserPermissions, mockDataSource, mockPromAlertingRule, mockRulerAlertingRule, promRuleFromRulerRule, } from '../../mocks';
...
const mockRoute = (id) => ({
    ...
    match: { params: { id: id !== null && id !== void 0 ? id : 'test1', sourceName: 'grafana' }, isExact: false, url: 'asdf', path: '' },
...
const renderRuleViewer = (ruleId) => __awaiter(void 0, void 0, void 0, function* () {
    render(React.createElement(TestProvider, null,
        React.createElement(RuleViewer, Object.assign({}, mockRoute(ruleId)))));
...
describe('RuleViewer', () => {
    ...
    it('should render page with grafana alert', () => __awaiter(void 0, void 0, void 0, function* () {
        mocks.useIsRuleEditable.mockReturnValue({ loading: false, isEditable: false });
        yield renderRuleViewer();
        expect(screen.getByText(/test alert/i)).toBeInTheDocument();
    }));
    it('should render page with cloud alert', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.spyOn(contextSrv, 'hasPermission').mockReturnValue(true);
        jest
            .mocked(discoverFeatures)
            .mockResolvedValue({ application: PromApplication.Mimir, features: { rulerApiEnabled: true } });
        mocks.useIsRuleEditable.mockReturnValue({ loading: false, isEditable: false });
        yield renderRuleViewer(ruleId.stringifyIdentifier(rulerRuleIdentifier));
...
describe('RuleDetails RBAC', () => {
    describe('Grafana rules action buttons in details', () => {
        ...
        it('Should render Edit button for users with the update permission', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
        ...
        it('Should render Delete button for users with the delete permission', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Act
            yield renderRuleViewer();
            yield user.click(ui.moreButton.get());
            // Assert
        ...
        it('Should render clone button for users having create rule permission', () => __awaiter(void 0, void 0, void 0, function* () {
            mocks.useIsRuleEditable.mockReturnValue({ loading: false, isEditable: false });
            mockCombinedRule.mockReturnValue({
        ...
        it('Should NOT render clone button for users without create rule permission', () => __awaiter(void 0, void 0, void 0, function* () {
            mocks.useIsRuleEditable.mockReturnValue({ loading: false, isEditable: true });
            mockCombinedRule.mockReturnValue({
                result: getGrafanaRule({ name: 'Grafana rule' }),
                loading: false,
...
//# sourceMappingURL=RuleViewer.v1.test.js.map