...
export const StateTag = ({ children, state, size = 'md', muted = false }) => {
    const styles = useStyles2(getStyles);
    return (React.createElement("span", { className: cx(styles.common, styles[state], styles[size], { [styles.muted]: muted }) }, children || state));
};
