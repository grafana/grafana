...
const formValuesForRule2Updated = Object.assign(Object.assign({}, defaultValues), { queries: [
        {
            refId: 'A',
    ...
    ], condition: 'A', forTime: 2455, name: 'Rule2 updated', labels: [{ key: 'newLabel', value: 'newLabel' }], annotations: [{ key: 'summary', value: 'This grafana rule2 updated' }] });
const expectedModifiedRule2 = (uid) => ({
    annotations: {
...
//# sourceMappingURL=getPayloadToExport.test.js.map