import { alertDetailsSnippet, alertsLoopSnippet, annotationsLoopSnippet, commonAnnotationsLoopSnippet, commonLabelsLoopSnippet, groupLabelsLoopSnippet, labelsLoopSnippet, } from './snippets';
// Suggestions available at the top level of a template
export function getGlobalSuggestions(monaco) {
...
export function getAlertSuggestions(monaco) {
    const kind = monaco.languages.CompletionItemKind.Field;
    return [
        {
...
export function getAlertsSuggestions(monaco) {
    const kind = monaco.languages.CompletionItemKind.Field;
    return [
...
export function getKeyValueSuggestions(monaco) {
    const kind = monaco.languages.CompletionItemKind.Field;
    return [
...
// Snippets
export function getSnippetsSuggestions(monaco) {
...
//# sourceMappingURL=templateDataSuggestions.js.map