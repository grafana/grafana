 ...
 */
export function useContactPointsWithStatus(selectedAlertmanager) {
    var _a;
    ...
    const fetchAlertmanagerConfiguration = alertmanagerApi.endpoints.getAlertmanagerConfiguration.useQuery(selectedAlertmanager, {
        refetchOnFocus: true,
        refetchOnReconnect: true,
        selectFromResult: (result) => (Object.assign(Object.assign({}, result), { contactPoints: result.data ? enhanceContactPointsWithStatus(result.data, fetchContactPointsStatus.data) : [] })),
    });
    // TODO kinda yucky to combine hooks like this, better alternative?
    const error = (_a = fetchAlertmanagerConfiguration.error) !== null && _a !== void 0 ? _a : fetchContactPointsStatus.error;
...
export function useDeleteContactPoint(selectedAlertmanager) {
    const [fetchAlertmanagerConfig] = alertmanagerApi.endpoints.getAlertmanagerConfiguration.useLazyQuery();
    const [updateAlertManager, updateAlertmanagerState] = alertmanagerApi.endpoints.updateAlertmanagerConfiguration.useMutation();
    const deleteTrigger = (contactPointName) => {
        return fetchAlertmanagerConfig(selectedAlertmanager).then(({ data }) => {
            ...
            const newConfig = produce(data, (draft) => {
                var _a, _b;
                remove((_b = (_a = draft === null || draft === void 0 ? void 0 : draft.alertmanager_config) === null || _a === void 0 ? void 0 : _a.receivers) !== null && _b !== void 0 ? _b : [], (receiver) => receiver.name === contactPointName);
                return draft;
            });
...
//# sourceMappingURL=useContactPoints.js.map