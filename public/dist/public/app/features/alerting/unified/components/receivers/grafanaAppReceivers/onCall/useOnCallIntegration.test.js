...
describe('useOnCallIntegration', () => {
    ...
    describe('When OnCall Alerting V2 integration enabled', () => {
        it('extendOnCalReceivers should add new settings to the oncall receiver', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield waitFor(() => expect(result.current.isLoadingOnCallIntegration).toBe(false));
            ...
            expect(receiverConfig.settings[OnCallIntegrationSetting.IntegrationType]).toBe(OnCallIntegrationType.ExistingIntegration);
        ...
        it('createOnCallIntegrations should provide integration name and url validators', () => __awaiter(void 0, void 0, void 0, function* () {
            mockApi(server).plugins.getPluginSettings(Object.assign(Object.assign({}, onCallPluginMetaMock), { enabled: true }));
            mockApi(server).oncall.features([ONCALL_INTEGRATION_V2_FEATURE]);
            mockApi(server).oncall.getOnCallIntegrations([
                {
            ...
            const gfValidationResult = yield waitFor(() => onCallFormValidators.integration_name('grafana-integration'));
            expect(gfValidationResult).toBe('Integration of this name already exists in OnCall');
            const amValidationResult = yield waitFor(() => onCallFormValidators.integration_name('alertmanager-integration'));
            ...
            expect(onCallFormValidators.url('https://oncall.com/alertmanager-integration')).toBe('Selection of existing OnCall integration is required');
        }));
        it('extendOnCallNotifierFeatures should add integration type and name options and swap url to a select option', () => __awaiter(void 0, void 0, void 0, function* () {
            mockApi(server).plugins.getPluginSettings(Object.assign(Object.assign({}, onCallPluginMetaMock), { enabled: true }));
            mockApi(server).oncall.features([ONCALL_INTEGRATION_V2_FEATURE]);
            mockApi(server).oncall.getOnCallIntegrations([
                {
    ...
    describe('When OnCall Alerting V2 integration disabled', () => {
        it('extendOnCalReceivers should not add new settings to the oncall receiver', () => __awaiter(void 0, void 0, void 0, function* () {
            mockApi(server).plugins.getPluginSettings(Object.assign(Object.assign({}, onCallPluginMetaMock), { enabled: true }));
        ...
        it('extendConCallNotifierFeatures should not extend notifier', () => __awaiter(void 0, void 0, void 0, function* () {
            mockApi(server).plugins.getPluginSettings(Object.assign(Object.assign({}, onCallPluginMetaMock), { enabled: true }));
            mockApi(server).oncall.features([]);
            mockApi(server).oncall.getOnCallIntegrations([]);
            const { result } = renderHook(() => useOnCallIntegration(), { wrapper: TestProvider });
...
//# sourceMappingURL=useOnCallIntegration.test.js.map