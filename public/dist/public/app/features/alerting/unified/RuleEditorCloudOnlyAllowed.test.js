...
jest.mock('./components/rule-editor/util', () => {
    ...
    return Object.assign(Object.assign({}, originalModule), { getThresholdsForQueries: jest.fn(() => ({})) });
});
const dataSources = {
    // can edit rules
    loki: mockDataSource({
...
function getDiscoverFeaturesMock(application, features) {
    return {
        application: application,
        features: Object.assign({ rulerApiEnabled: false, alertManagerConfigApi: false, federatedRules: false, querySharding: false }, features),
    };
}
describe('RuleEditor cloud: checking editable data sources', () => {
    ...
    it('for cloud alerts, should only allow to select editable rules sources', () => __awaiter(void 0, void 0, void 0, function* () {
        mocks.api.discoverFeatures.mockImplementation((dataSourceName) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        mocks.api.fetchRulerRulesGroup.mockImplementation(({ dataSourceName }) => __awaiter(void 0, void 0, void 0, function* () {
            if (dataSourceName === 'loki with ruler' || dataSourceName === 'cortex with ruler') {
                return null;
            }
            if (dataSourceName === 'loki with local rule store') {
...
//# sourceMappingURL=RuleEditorCloudOnlyAllowed.test.js.map