...
describe('Alert rules', () => {
    ...
    describe('when loadAlertRules is dispatched', () => {
        it('then state should be correct', () => {
            reducerTester()
                .givenReducer(alertRulesReducer, Object.assign({}, initialState))
                .whenActionIsDispatched(loadAlertRules())
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { isLoading: true }));
        });
    });
    describe('when setSearchQuery is dispatched', () => {
        it('then state should be correct', () => {
            reducerTester()
                ...
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { searchQuery: 'query' }));
        });
    });
    describe('when loadedAlertRules is dispatched', () => {
        it('then state should be correct', () => {
            reducerTester()
                .givenReducer(alertRulesReducer, Object.assign(Object.assign({}, initialState), { isLoading: true }))
                .whenActionIsDispatched(loadedAlertRules(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialState), { isLoading: false, items: [
                    {
                        dashboardId: 7,
                        dashboardSlug: 'alerting-with-testdata',
                        dashboardUid: 'ggHbN42mk',
...
describe('Notification channel', () => {
    ...
    describe('Load notification channel', () => {
        it('should migrate non secure settings to secure fields', () => {
            ...
            reducerTester()
                .givenReducer(notificationChannelReducer, Object.assign(Object.assign({}, initialChannelState), { notifiers: notifiers }))
                .whenActionIsDispatched(notificationChannelLoaded(payload))
                .thenStateShouldEqual(Object.assign(Object.assign({}, initialChannelState), { notifiers: notifiers, notificationChannel: expected }));
        });
