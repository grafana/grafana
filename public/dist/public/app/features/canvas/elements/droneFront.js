...
const DroneFrontDisplay = ({ data }) => {
    const styles = useStyles2(getStyles);
    const droneFrontTransformStyle = `rotate(${(data === null || data === void 0 ? void 0 : data.rollAngle) ? data.rollAngle : 0}deg)`;
    return (React.createElement("svg", { className: styles.droneFront, xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 1300 290", style: { transform: droneFrontTransformStyle, stroke: defaultBgColor } },
        ...
        React.createElement("g", { className: "body", stroke: defaultBgColor, strokeWidth: "28px" },
            ...
            React.createElement("circle", { cx: "650", cy: "160", r: "40", fill: "none" })),
...
export const droneFrontItem = {
    ...
    prepareData: (ctx, cfg) => {
        const data = {
            rollAngle: (cfg === null || cfg === void 0 ? void 0 : cfg.rollAngle) ? ctx.getScalar(cfg.rollAngle).value() : 0,
        };
        return data;
    },
...
//# sourceMappingURL=droneFront.js.map