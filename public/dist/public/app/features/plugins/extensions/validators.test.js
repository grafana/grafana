...
import { assertConfigureIsValid, assertLinkPathIsValid, assertExtensionPointIdIsValid, assertPluginExtensionLink, assertStringProps, isPluginExtensionConfigValid, isReactComponent, } from './validators';
describe('Plugin Extension Validators', () => {
    ...
    describe('isPluginExtensionConfigValid()', () => {
        it('should return TRUE if the plugin extension configuration is valid', () => {
            ...
            expect(isPluginExtensionConfigValid(pluginId, {
                type: PluginExtensionTypes.link,
                title: 'Title',
                description: 'Description',
                onClick: jest.fn(),
    ...
    describe('isReactComponent()', () => {
        it('should return TRUE if we pass in a valid React component', () => {
            expect(isReactComponent(() => React.createElement("div", null, "Some text"))).toBe(true);
        });
        it('should return TRUE if we pass in a component wrapped with React.memo()', () => {
            const Component = () => React.createElement("div", null, "Some text");
            const wrapped = React.memo(() => (React.createElement("div", null,
