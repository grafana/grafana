...
describe('Plugin Extensions / Utils', () => {
    ...
    describe('isPluginExtensionLinkConfig()', () => {
        test('should return TRUE if the object is a command extension config', () => {
            expect(isPluginExtensionLinkConfig({
    ...
    describe('getEventHelpers', () => {
        describe('openModal', () => {
            ...
            afterAll(() => {
                renderModalSubscription === null || renderModalSubscription === void 0 ? void 0 : renderModalSubscription.unsubscribe();
            });
            it('should open modal with provided title and body', () => __awaiter(void 0, void 0, void 0, function* () {
                const { openModal } = getEventHelpers();
                openModal({
                    title: 'Title in modal',
                    body: () => React.createElement("div", null, "Text in body"),
                });
                expect(screen.getByRole('dialog')).toBeVisible();
                expect(screen.getByRole('heading')).toHaveTextContent('Title in modal');
                expect(screen.getByText('Text in body')).toBeVisible();
            }));
            it('should open modal with default width if not specified', () => __awaiter(void 0, void 0, void 0, function* () {
                const { openModal } = getEventHelpers();
                openModal({
                    title: 'Title in modal',
                    body: () => React.createElement("div", null, "Text in body"),
            ...
            it('should open modal with specified width', () => __awaiter(void 0, void 0, void 0, function* () {
                const { openModal } = getEventHelpers();
                openModal({
                    title: 'Title in modal',
                    body: () => React.createElement("div", null, "Text in body"),
            ...
            it('should open modal with specified height', () => __awaiter(void 0, void 0, void 0, function* () {
                const { openModal } = getEventHelpers();
                openModal({
                    title: 'Title in modal',
                    body: () => React.createElement("div", null, "Text in body"),
