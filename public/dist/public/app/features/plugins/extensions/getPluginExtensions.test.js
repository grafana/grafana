...
describe('getPluginExtensions()', () => {
    ...
    test('should be possible to limit the number of extensions per plugin for a given placement', () => {
        const registry = createPluginExtensionRegistry([
            { pluginId, extensionConfigs: [link1, link1, link1, link2] },
            {
                pluginId: 'my-plugin',
                extensionConfigs: [
                    Object.assign(Object.assign({}, link1), { path: '/a/my-plugin/declare-incident' }),
                    Object.assign(Object.assign({}, link1), { path: '/a/my-plugin/declare-incident' }),
                    Object.assign(Object.assign({}, link1), { path: '/a/my-plugin/declare-incident' }),
                    Object.assign(Object.assign({}, link2), { path: '/a/my-plugin/declare-incident' }),
                ],
            },
        ]);
    ...
    test('should be possible to update the basic properties with the configure() function', () => {
        ...
        expect((_a = extension.path) === null || _a === void 0 ? void 0 : _a.startsWith(`/a/${pluginId}/updated-path`)).toBeTruthy();
    ...
    test('should append link tracking to path when running configure() function', () => {
        ...
        assertPluginExtensionLink(extension);
        expect(link2.configure).toHaveBeenCalledTimes(1);
        expect(extension.path).toBe(`/a/${pluginId}/updated-path?uel_pid=grafana-basic-app&uel_epid=plugins%2Fmyorg-basic-app%2Fstart`);
    });
    ...
    test('should pass a read only context to the configure() function', () => {
        ...
        const [extension] = extensions;
        const readOnlyContext = link2.configure.mock.calls[0][0];
        assertPluginExtensionLink(extension);
        expect(link2.configure).toHaveBeenCalledTimes(1);
    ...
    test('should pass event, context and helper to extension onClick()', () => {
        ...
        expect(link2.onClick).toHaveBeenCalledWith(event, expect.objectContaining({
            context,
            openModal: expect.any(Function),
        }));
    });
    test('should catch errors in async/promise-based onClick function and log them as warnings', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        link2.path = undefined;
        ...
        const [extension] = extensions;
        assertPluginExtensionLink(extension);
        yield ((_a = extension.onClick) === null || _a === void 0 ? void 0 : _a.call(extension, {}));
        expect(extensions).toHaveLength(1);
        expect(link2.onClick).toHaveBeenCalledTimes(1);
        expect(global.console.warn).toHaveBeenCalledTimes(1);
    }));
    test('should catch errors in the onClick() function and log them as warnings', () => {
        ...
        const [extension] = extensions;
        assertPluginExtensionLink(extension);
        (_a = extension.onClick) === null || _a === void 0 ? void 0 : _a.call(extension, {});
        expect(link2.onClick).toHaveBeenCalledTimes(1);
        expect(global.console.warn).toHaveBeenCalledTimes(1);
        expect(global.console.warn).toHaveBeenCalledWith('[Plugin Extensions] Something went wrong!');
    });
    test('should pass a read only context to the onClick() function', () => {
        ...
        assertPluginExtensionLink(extension);
        (_a = extension.onClick) === null || _a === void 0 ? void 0 : _a.call(extension, {});
        const helpers = link2.onClick.mock.calls[0][1];
        expect(link2.configure).toHaveBeenCalledTimes(1);
        ...
        const registry = createPluginExtensionRegistry([
            {
                pluginId,
                extensionConfigs: [
                    Object.assign(Object.assign({}, link1), { path: undefined, onClick: jest.fn() }),
                ],
            },
        ]);
        const { extensions } = getPluginExtensions({ registry, extensionPointId: extensionPoint1 });
...
//# sourceMappingURL=getPluginExtensions.test.js.map