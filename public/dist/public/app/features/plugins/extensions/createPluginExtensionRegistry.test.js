...
describe('createRegistry()', () => {
    ...
    beforeEach(() => {
        ...
        link2 = {
            ...
            configure: jest.fn().mockImplementation((context) => ({ title: context === null || context === void 0 ? void 0 : context.title })),
        };
    ...
    it('should be possible to register extensions', () => {
        ...
        expect(registry[placement1]).toEqual(expect.arrayContaining([
            expect.objectContaining({
                pluginId,
                config: Object.assign(Object.assign({}, link1), { configure: expect.any(Function) }),
            }),
        ]));
        // Placement 2
        expect(registry[placement2]).toHaveLength(1);
        expect(registry[placement2]).toEqual(expect.arrayContaining([
            expect.objectContaining({
                pluginId,
                config: Object.assign(Object.assign({}, link2), { configure: expect.any(Function) }),
            }),
        ]));
    });
    it('should not register link extensions with invalid path configured', () => {
        const registry = createPluginExtensionRegistry([
            { pluginId, extensionConfigs: [Object.assign(Object.assign({}, link1), { path: 'invalid-path' }), link2] },
        ]);
    ...
    it('should not register an extension if it has an invalid configure() function', () => {
        const registry = createPluginExtensionRegistry([
            ...
            { pluginId, extensionConfigs: [Object.assign(Object.assign({}, link1), { configure: '...' }), link2] },
        ]);
        expect(Object.getOwnPropertyNames(registry)).toEqual([placement2]);
    ...
    it('should not register an extension if it has invalid properties (empty title / description)', () => {
        const registry = createPluginExtensionRegistry([
            { pluginId, extensionConfigs: [Object.assign(Object.assign({}, link1), { title: '', description: '' }), link2] },
        ]);
        expect(Object.getOwnPropertyNames(registry)).toEqual([placement2]);
        // Placement 2 (checking if it still registers the extension with a valid configuration)
        expect(registry[placement2]).toHaveLength(1);
...
//# sourceMappingURL=createPluginExtensionRegistry.test.js.map