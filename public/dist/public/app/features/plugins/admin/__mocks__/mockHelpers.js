...
export const getCatalogPluginMock = (overrides) => (Object.assign(Object.assign({}, catalogPluginMock), overrides));
// Returns a sample mock for a local (installed) plugin with the possibility to extend it
export const getLocalPluginMock = (overrides) => (Object.assign(Object.assign({}, localPluginMock), overrides));
// Returns a sample mock for a remote plugin with the possibility to extend it
export const getRemotePluginMock = (overrides) => (Object.assign(Object.assign({}, remotePluginMock), overrides));
// Returns a mock for the Redux store state of plugins
export const getPluginsStateMock = (plugins = []) => ({
    ...
    items: {
        ...
        entities: plugins.reduce((prev, current) => (Object.assign(Object.assign({}, prev), { [current.id]: current })), {}),
    },
    requests: {
        'plugins/fetchAll': {
...
export const mockPluginApis = ({ remote: remoteOverride, local: localOverride, versions, }) => {
    ...
    setBackendSrv(Object.assign(Object.assign({}, originalBackendSrv), { get: (path) => {
