...
function setup(opts) {
    ...
    render(React.createElement(TestProvider, null,
        React.createElement(InstallControlsButton, { plugin: Object.assign(Object.assign({}, plugin), { angularDetected: opts.angularDetected }), pluginStatus: PluginStatus.INSTALL })));
}
describe('InstallControlsButton', () => {
    ...
    it("should allow to uninstall a plugin even if it's unpublished", () => {
        render(React.createElement(TestProvider, null,
            React.createElement(InstallControlsButton, { plugin: Object.assign(Object.assign({}, plugin), { isPublished: false }), pluginStatus: PluginStatus.UNINSTALL })));
        const el = screen.getByRole('button');
    ...
    it('should not render install or upgrade buttons if the plugin is unpublished', () => {
        render(React.createElement(TestProvider, null,
            React.createElement(InstallControlsButton, { plugin: Object.assign(Object.assign({}, plugin), { isPublished: false }), pluginStatus: PluginStatus.INSTALL })));
        expect(screen.queryByRole('button')).not.toBeInTheDocument();
    });
});
//# sourceMappingURL=InstallControlsButton.test.js.map