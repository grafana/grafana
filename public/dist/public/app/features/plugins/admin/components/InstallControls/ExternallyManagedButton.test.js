...
function setup(opts) {
    ...
    render(React.createElement(ExternallyManagedButton, { pluginId: 'some-plugin-id', angularDetected: opts.angularDetected, pluginStatus: PluginStatus.INSTALL }));
}
describe('ExternallyManagedButton', () => {
    ...
    describe.each([{ angularSupportEnabled: true }, { angularSupportEnabled: false }])('angular support is $angularSupportEnabled', ({ angularSupportEnabled }) => {
        it.each([
...
//# sourceMappingURL=ExternallyManagedButton.test.js.map