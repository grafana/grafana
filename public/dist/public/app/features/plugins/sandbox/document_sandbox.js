...
export function getSafeSandboxDomElement(element, pluginId) {
 ...
 */
export function markDomElementStyleAsALiveTarget(el) {
 ...
 */
export function patchObjectAsLiveTarget(obj) {
    if (!obj) {
        return;
    }
...
export function isLiveTarget(el) {
 ...
 *
 */
export function isDomElementInsideSandbox(el, pluginId) {
    return !document.contains(el) || el.closest(`[data-plugin-sandbox=${pluginId}]`) !== null;
}
let sandboxBody;
export function getSandboxMockBody() {
    if (!sandboxBody) {
...
//# sourceMappingURL=document_sandbox.js.map