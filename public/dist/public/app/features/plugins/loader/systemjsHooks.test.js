...
jest.mock('./cache', () => ({
    resolveWithCache: (url) => `${url}?_cache=1234`,
}));
import { server, mockAmdModule, mockSystemModule, mockAmdModuleNamedNoDeps, mockAmdModuleNamedWithDeps, mockAmdModuleNamedWithDeps2, mockAmdModuleNamedWithDeps3, mockAmdModuleOnlyFunction, mockAmdModuleWithComments, mockModuleWithDefineMethod, mockAmdModuleWithComments2, } from './pluginLoader.mock';
...
describe('SystemJS Loader Hooks', () => {
    ...
    systemJSPrototype.resolve = (moduleId) => moduleId;
    ...
    describe('decorateSystemJSFetch', () => {
        it('wraps AMD modules in an AMD iife', () => __awaiter(void 0, void 0, void 0, function* () {
            const basicResult = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModule/module.js', {});
            const basicSource = yield basicResult.text();
            const basicExpected = `(function(define) {
  ${mockAmdModule}
})(window.__grafana_amd_define);`;
            expect(basicSource).toBe(basicExpected);
            const mockAmdModuleNamedNoDepsResult = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleNamedNoDeps/module.js', {});
            const mockAmdModuleNamedNoDepsSource = yield mockAmdModuleNamedNoDepsResult.text();
  ...
  ${mockAmdModuleNamedNoDeps}
            ...
            const mockAmdModuleNamedWithDepsResult = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleNamedWithDeps/module.js', {});
            const mockAmdModuleNamedWithDepsSource = yield mockAmdModuleNamedWithDepsResult.text();
  ...
  ${mockAmdModuleNamedWithDeps}
            ...
            const mockAmdModuleNamedWithDeps2Result = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleNamedWithDeps2/module.js', {});
            const mockAmdModuleNamedWithDeps2Source = yield mockAmdModuleNamedWithDeps2Result.text();
  ...
  ${mockAmdModuleNamedWithDeps2}
            ...
            const mockAmdModuleNamedWithDeps3Result = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleNamedWithDeps3/module.js', {});
            const mockAmdModuleNamedWithDeps3Source = yield mockAmdModuleNamedWithDeps3Result.text();
  ...
  ${mockAmdModuleNamedWithDeps3}
            ...
            const mockAmdModuleOnlyFunctionResult = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleOnlyFunction/module.js', {});
            const mockAmdModuleOnlyFunctionSource = yield mockAmdModuleOnlyFunctionResult.text();
  ...
  ${mockAmdModuleOnlyFunction}
            ...
            const mockAmdModuleWithCommentsResult = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleWithComments/module.js', {});
            const mockAmdModuleWithCommentsSource = yield mockAmdModuleWithCommentsResult.text();
  ...
  ${mockAmdModuleWithComments}
            ...
            const mockAmdModuleWithComments2Result = yield decorateSystemJSFetch(originalFetch, '/public/plugins/mockAmdModuleWithComments2/module.js', {});
            const mockAmdModuleWithComments2Source = yield mockAmdModuleWithComments2Result.text();
  ...
  ${mockAmdModuleWithComments2}
        ...
        it("doesn't wrap system modules in an AMD iife", () => __awaiter(void 0, void 0, void 0, function* () {
            const url = '/public/plugins/mockSystemModule/module.js';
            const result = yield decorateSystemJSFetch(originalFetch, url, {});
            const source = yield result.text();
            expect(source).toBe(mockSystemModule);
        }));
        it("doesn't wrap modules with a define method in an AMD iife", () => __awaiter(void 0, void 0, void 0, function* () {
            const url = '/public/plugins/mockModuleWithDefineMethod/module.js';
            const result = yield decorateSystemJSFetch(originalFetch, url, {});
            const source = yield result.text();
            expect(source).toBe(mockModuleWithDefineMethod);
        }));
        it('only transforms plugin source code hosted on cdn with cdn paths', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const cdnResult = yield decorateSystemJSFetch(originalFetch, cdnUrl, {});
            const cdnSource = yield cdnResult.text();
...
//# sourceMappingURL=systemjsHooks.test.js.map