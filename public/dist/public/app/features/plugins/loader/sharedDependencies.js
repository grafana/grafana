...
const jQueryFlotDeps = [
    ...
    'jquery.flot.time',
    'jquery.flot',
].reduce((acc, flotDep) => (Object.assign(Object.assign({}, acc), { [flotDep]: { fakeDep: 1 } })), {});
export const sharedDependenciesMap = Object.assign(Object.assign({ '@emotion/css': emotion, '@emotion/react': emotionReact, '@grafana/data': grafanaData, '@grafana/runtime': grafanaRuntime, '@grafana/slate-react': slateReact, '@grafana/ui': grafanaUI, 'app/core/app_events': {
        default: appEvents,
        __useDefault: true,
    }, 'app/core/config': {
        default: config,
        ...
        BackendSrv,
        getBackendSrv,
    }, 'app/core/table_model': { default: TableModel, __useDefault: true }, 'app/core/time_series': { default: TimeSeries, __useDefault: true }, 'app/core/time_series2': { default: TimeSeries, __useDefault: true }, 'app/core/utils/datemath': grafanaData.dateMath, 'app/core/utils/flatten': flatten, 'app/core/utils/kbn': {
        default: kbn,
        __useDefault: true,
    }, 'app/core/utils/ticks': ticks, 'app/features/dashboard/impression_store': {
        impressions: impressionSrv,
    }, d3: d3, emotion: emotion, 
    // bundling grafana-ui in plugins requires sharing i18next state
    i18next: i18next, jquery: {
        default: jquery,
        __useDefault: true,
    } }, jQueryFlotDeps), { lodash: {
        default: _,
        __useDefault: true,
    }, moment: {
        default: moment,
        __useDefault: true,
    }, prismjs: prismjs, react: react, 'react-dom': reactDom, 
    // bundling grafana-ui in plugins requires sharing react-inlinesvg for the icon cache
    'react-inlinesvg': reactInlineSvg, 'react-redux': reactRedux, 
    ...
    'react-router-dom': reactRouterDom, 'react-router': reactRouterCompat, redux: redux, rxjs: rxjs, 'rxjs/operators': rxjsOperators, slate: slate, 'slate-plain-serializer': slatePlain, 'slate-react': slateReact });
