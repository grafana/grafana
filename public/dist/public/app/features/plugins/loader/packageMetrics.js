...
const cachedMetricProxies = new WeakMap();
const trackedKeys = {};
function createMetricsProxy(obj, parentName, packageName) {
    const handler = {
        get(target, key) {
            if (
...
export function trackPackageUsage(obj, packageName) {
    return createMetricsProxy(obj, packageName, packageName);
}
//# sourceMappingURL=packageMetrics.js.map