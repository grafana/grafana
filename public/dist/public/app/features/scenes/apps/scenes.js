...
import { SceneFlexLayout, SceneByFrameRepeater, SceneTimePicker, EmbeddedScene, SceneDataNode, SceneTimeRange, VariableValueSelectors, SceneQueryRunner, SceneControlsSpacer, SceneDataTransformer, SceneRefreshPicker, SceneFlexItem, PanelBuilders, } from '@grafana/scenes';
...
export function getHttpHandlerListScene() {
    ...
    const httpHandlersTable = PanelBuilders.table()
        ...
        .overrideLinks([
        {
            ...
            onBuildUrl: () => {
                ...
                return getLinkUrlWithAppUrlState('/scenes/grafana-monitoring/handlers/${__value.text:percentencode}', params);
            },
        },
    ]))
        .build();
        ...
        getLayoutChild: (data, frame, frameIndex) => {
            return new SceneFlexItem({
                ...
                $data: new SceneDataNode({
                    data: Object.assign(Object.assign({}, data), { series: [frame] }),
                }),
                body: new SceneFlexLayout({
                    direction: 'row',
                    key: `row-${frameIndex}`,
                    children: [
                        new SceneFlexItem({
                            ...
                            body: PanelBuilders.timeseries()
                                ...
                                .setHeaderActions(React.createElement(LinkButton, { fill: "text", size: "sm", icon: "arrow-right", href: getHandlerDrilldownUrl(frame.fields[1].labels.handler) }, "Details"))
                                .build(),
                        }),
                        new SceneFlexItem({
...
function getInstantStatPanel(query, title) {
...
export function getHandlerLogsScene(handler) {
...
export function getOverviewLogsScene() {
    const logsQuery = new SceneQueryRunner({
        datasource: { uid: 'gdev-loki' },
        queries: [
            {
