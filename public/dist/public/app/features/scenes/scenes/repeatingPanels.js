import { SceneTimePicker, SceneTimeRange, VariableValueSelectors, SceneVariableSet, TestVariable, SceneRefreshPicker, PanelBuilders, SceneGridLayout, SceneControlsSpacer, SceneGridRow, } from '@grafana/scenes';
 ...
 */
export function getRepeatingPanelsDemo() {
...
function changeVariable(variable) {
    const sub = variable.subscribeToState((state, old) => {
        ...
        if (!state.loading && old.loading) {
            if (((_a = variable.state.optionsToReturn) === null || _a === void 0 ? void 0 : _a.length) === 2) {
                variable.setState({
                    query: 'ABC',
                    optionsToReturn: [
                        { label: 'A', value: 'A' },
...
export function getRepeatingRowsDemo() {
    return new DashboardScene({
...
//# sourceMappingURL=repeatingPanels.js.map