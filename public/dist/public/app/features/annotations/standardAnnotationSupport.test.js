...
describe('DataFrame to annotations', () => {
    test('simple conversion', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(getAnnotationsFromData([frame])).toEmitValues([
            [
                {
                    color: 'red',
                    tags: ['aaa', 'bbb'],
    ...
    test('explicit mappings', () => __awaiter(void 0, void 0, void 0, function* () {
        const frame = toDataFrame({
            fields: [
    ...
    it('all valid key names should be included in the output result', () => __awaiter(void 0, void 0, void 0, function* () {
        const frame = toDataFrame({
            fields: [
    ...
    it('key names that are not valid should be excluded in the output result', () => __awaiter(void 0, void 0, void 0, function* () {
        const frame = toDataFrame({
            fields: [
                { name: 'time', values: [100] },
                { name: 'text', values: ['text'] },
        ...
        const observable = getAnnotationsFromData([frame]);
        yield expect(observable).toEmitValues([[{ color: 'red', text: 'text', time: 100, type: 'default' }]]);
    }));
});
