...
describe('DataFrame to annotations', function () {
    test('simple conversion', function () { return __awaiter(void 0, void 0, void 0, function () {
        var frame;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, expect(getAnnotationsFromData([frame])).toEmitValues([
                            [
                                {
                                    color: 'red',
                                    tags: ['aaa', 'bbb'],
    ...
    test('explicit mappins', function () { return __awaiter(void 0, void 0, void 0, function () {
        var frame, observable;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    frame = toDataFrame({
    ...
    it('all valid key names should be included in the output result', function () { return __awaiter(void 0, void 0, void 0, function () {
        var frame, observable;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('key names that are not valid should be excluded in the output result', function () { return __awaiter(void 0, void 0, void 0, function () {
        var frame, observable;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    observable = getAnnotationsFromData([frame]);
                    return [4 /*yield*/, expect(observable).toEmitValues([[{ color: 'red', text: 'text', time: 100, type: 'default' }]])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=standardAnnotationSupport.test.js.map