...
export class DashboardLoaderSrv {
    ...
    loadDashboard(type, slug, uid) {
        ...
        if (type === 'script' && slug) {
            ...
            promise = backendSrv
                ...
                .catch((e) => {
                const isPublicDashboardPaused = e.data.statusCode === 403 && e.data.messageId === 'publicdashboards.notEnabled';
                const isPublicDashboardNotFound = e.data.statusCode === 404 && e.data.messageId === 'publicdashboards.notFound';
                const dashboardModel = this._dashboardLoadFailed(isPublicDashboardPaused ? 'Public Dashboard paused' : 'Public Dashboard Not found', true);
                return Object.assign(Object.assign({}, dashboardModel), { meta: Object.assign(Object.assign({}, dashboardModel.meta), { publicDashboardEnabled: isPublicDashboardNotFound ? undefined : !isPublicDashboardPaused, dashboardNotFound: isPublicDashboardNotFound }) });
            });
        }
        else if (uid) {
            promise = backendSrv
     ...
     * loading code
     */
    _loadFromDatasource(dsid) {
        return __awaiter(this, void 0, void 0, function* () {
            const ds = yield getDatasourceSrv().get(dsid);
            if (!ds) {
    ...
    _executeScript(result) {
        ...
        const scriptResult = scriptFunc(locationService.getSearchObject(), kbn, dateMath, _, moment, window, document, $, $, services);
