...
describe('applyPanelTimeOverrides', () => {
    ...
    it('Calculate panel height with panel plugin zeroChromePadding', () => __awaiter(void 0, void 0, void 0, function* () {
        const panelModel = new PanelModel({});
        yield panelModel.pluginLoaded(getPanelPlugin({ id: 'table' }, null, null).setNoPadding());
        const height = calculateInnerPanelHeight(panelModel, 100);
