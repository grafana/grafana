...
import { AppEvents, rangeUtil, dateMath, dateTimeAsMoment } from '@grafana/data';
...
export const removePanel = (dashboard, panel, ask) => {
    // confirm deletion
    if (ask !== false) {
        const text2 = panel.alert && !config.unifiedAlertingEnabled
...
export function calculateNewPanelGridPos(dashboard) {
