import { dateTime, FieldType, LoadingState, PluginExtensionTypes, toDataFrame, } from '@grafana/data';
...
jest.mock('@grafana/runtime', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/runtime')), { setPluginExtensionGetter: jest.fn(), getPluginLinkExtensions: jest.fn() })));
...
describe('getPanelMenu()', () => {
    ...
    describe('when extending panel menu from plugins', () => {
        it('should contain menu item from link extension', () => {
            ...
            const dashboard = createDashboardModelFixture({});
            const menuItems = getPanelMenu(dashboard, panel);
            const extensionsSubMenu = (_a = menuItems.find((i) => i.text === 'Extensions')) === null || _a === void 0 ? void 0 : _a.subMenu;
            expect(extensionsSubMenu).toEqual(expect.arrayContaining([
        ...
        it('should pass onClick from plugin extension link to menu item', () => {
            ...
            const menuItems = getPanelMenu(dashboard, panel);
            const extensionsSubMenu = (_a = menuItems.find((i) => i.text === 'Extensions')) === null || _a === void 0 ? void 0 : _a.subMenu;
            const menuItem = extensionsSubMenu === null || extensionsSubMenu === void 0 ? void 0 : extensionsSubMenu.find((i) => (i.text = 'Declare incident when...'));
            (_b = menuItem === null || menuItem === void 0 ? void 0 : menuItem.onClick) === null || _b === void 0 ? void 0 : _b.call(menuItem, {});
    ...
    describe('when panel is in view mode', () => {
        it('should return the correct panel menu items', () => {
            ...
            const angularComponent = { getScope: () => scope };
