...
import { dateTime, VariableHide } from '@grafana/data';
...
import { createAnnotationJSONFixture, createDashboardModelFixture, createPanelSaveModel, createVariableJSONFixture, } from './__fixtures__/dashboardFixtures';
...
describe('DashboardModel', () => {
    ...
    describe('isSubMenuVisible with hidden template var', () => {
        ...
        beforeEach(() => {
            model = createDashboardModelFixture({
                templating: {
                    list: [
                        Object.assign(Object.assign({}, defaultVariableModel), { hide: VariableHide.hideVariable }),
                    ],
                },
            });
        });
    ...
    describe('When collapsing row', () => {
        ...
        it('should remove panels and put them inside collapsed row', () => {
            ...
            expect((_a = dashboard.panels[1].panels) === null || _a === void 0 ? void 0 : _a.length).toBe(2);
        });
    ...
    describe('Given model with time', () => {
        ...
        it('getSaveModelClone should remove repeated panels and scopedVars', () => {
            ...
            expect((_c = (_b = (_a = model.panels.find((x) => x.type !== 'row')) === null || _a === void 0 ? void 0 : _a.scopedVars) === null || _b === void 0 ? void 0 : _b.dc) === null || _c === void 0 ? void 0 : _c.value).toBe('dc1');
            expect((_f = (_e = (_d = model.panels.find((x) => x.type !== 'row')) === null || _d === void 0 ? void 0 : _d.scopedVars) === null || _e === void 0 ? void 0 : _e.app) === null || _f === void 0 ? void 0 : _f.value).toBe('se1');
            const saveModel = model.getSaveModelCloneOld();
        ...
        it('getSaveModelClone should not remove repeated panels and scopedVars during snapshot', () => {
            ...
            expect((_j = (_h = (_g = saveModel.panels.find((x) => x.type !== 'row')) === null || _g === void 0 ? void 0 : _g.scopedVars) === null || _h === void 0 ? void 0 : _h.dc) === null || _j === void 0 ? void 0 : _j.value).toBe('dc1');
            expect((_m = (_l = (_k = saveModel.panels.find((x) => x.type !== 'row')) === null || _k === void 0 ? void 0 : _k.scopedVars) === null || _l === void 0 ? void 0 : _l.app) === null || _m === void 0 ? void 0 : _m.value).toBe('se1');
            model.collapseRows();
            const savedModelWithCollapsedRows = model.getSaveModelCloneOld();
    ...
    `('when called with canEdit:{$canEdit}, canMakeEditable:{$canMakeEditable}, canAdd:{$canAdd} and expected:{$expected}', ({ canEdit, canMakeEditable, canAdd, expected }) => {
    ...
    describe('canEditAnnotations', () => {
      ...
      ${true}  | ${true}         | ${false}                 | ${false}
      ${false} | ${false}        | ${false}                 | ${false}
    `('when called with canEdit:{$canEdit}, canMakeEditable:{$canMakeEditable}, canEditWithOrgPermission:{$canEditWithOrgPermission} and expected:{$expected}', ({ canEdit, canMakeEditable, canEditWithOrgPermission, expected }) => {
            const dashboard = createDashboardModelFixture({}, {
                annotationsPermissions: {
      ...
      ${true}  | ${true}         | ${false}                       | ${false}
      ${false} | ${false}        | ${false}                       | ${false}
    `('when called with canEdit:{$canEdit}, canMakeEditable:{$canMakeEditable}, canEditWithDashboardPermission:{$canEditWithDashboardPermission} and expected:{$expected}', ({ canEdit, canMakeEditable, canEditWithDashboardPermission, expected }) => {
            const dashboard = createDashboardModelFixture({}, {
                annotationsPermissions: {
    ...
    describe('canDeleteAnnotations', () => {
      ...
      ${true}  | ${true}         | ${false}                   | ${false}
      ${false} | ${false}        | ${false}                   | ${false}
    `('when called with canEdit:{$canEdit}, canMakeEditable:{$canMakeEditable}, canDeleteWithOrgPermission:{$canDeleteWithOrgPermission} and expected:{$expected}', ({ canEdit, canMakeEditable, canDeleteWithOrgPermission, expected }) => {
            const dashboard = createDashboardModelFixture({}, {
                annotationsPermissions: {
      ...
      ${true}  | ${true}         | ${false}                         | ${false}
      ${false} | ${false}        | ${false}                         | ${false}
    `('when called with canEdit:{$canEdit}, canMakeEditable:{$canMakeEditable}, canDeleteWithDashboardPermission:{$canDeleteWithDashboardPermission} and expected:{$expected}', ({ canEdit, canMakeEditable, canDeleteWithDashboardPermission, expected }) => {
            const dashboard = createDashboardModelFixture({}, {
                annotationsPermissions: {
