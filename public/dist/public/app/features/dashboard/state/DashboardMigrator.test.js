...
describe('DashboardModel', () => {
    ...
    describe('when migrating to new Text Panel', () => {
        ...
        it('should not migrate panel with old Text Panel id', () => {
            const oldAngularPanel = model.panels[0];
    ...
    describe('when migrating folded panel without fieldConfig.defaults', () => {
        ...
        it('should ignore fieldConfig.defaults', () => {
            var _a;
            expect((_a = model.panels[0].panels) === null || _a === void 0 ? void 0 : _a[0].fieldConfig.defaults).toEqual(undefined);
        });
    });
    ...
    describe('migrating legacy CloudWatch queries', () => {
        ...
        describe('with nested panels', () => {
            ...
            beforeEach(() => {
                ...
                panel1Targets = (_a = nestedModel.panels[0].panels) === null || _a === void 0 ? void 0 : _a[0].targets;
                panel2Targets = (_b = nestedModel.panels[0].panels) === null || _b === void 0 ? void 0 : _b[1].targets;
            });
    ...
    describe('when migrating datasource to refs', () => {
        ...
        it('should update datasources in panels collapsed rows', () => {
            var _a;
            expect((_a = model.panels[3].panels) === null || _a === void 0 ? void 0 : _a[0].datasource).toEqual({ type: 'prometheus', uid: 'prom-uid' });
        });
    });
    describe('when fixing query and panel data source refs out of sync due to default data source change', () => {
        ...
        it('should use data source on query level as source of truth', () => {
            var _a, _b, _c;
            expect((_b = (_a = model.panels[0].targets[0]) === null || _a === void 0 ? void 0 : _a.datasource) === null || _b === void 0 ? void 0 : _b.uid).toEqual('prom-not-default-uid');
            expect((_c = model.panels[0].datasource) === null || _c === void 0 ? void 0 : _c.uid).toEqual('prom-not-default-uid');
        });
    });
...
function getGridPositions(dashboard) {
    return map(dashboard.panels, (panel) => {
