...
describe('DashboardModel', function () {
    describe('when creating dashboard with old schema', function () {
        ...
        it('singlestat panel should be mapped to stat panel', function () {
        ...
        it('singlestat panel should be mapped to gauge panel', function () {
        ...
        it('table type should be deprecated', function () {
        ...
        it('graph thresholds should be migrated onto specified thresholds', function () {
            model = new DashboardModel({
                panels: [
                    {
                        type: 'graph',
    ...
    describe('when migrating labels from DataFrame to Field', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                panels: [
        ...
        describe('data links', function () {
            it('should replace __series.label variable with __field.label', function () {
                expect(model.panels[0].options.dataLinks[0].url).toBe('http://mylink.com?series=${__field.labels}&${__field.labels.a}');
                expect(model.panels[1].options.fieldOptions.defaults.links[0].url).toBe('http://mylink.com?series=${__field.labels}&${__field.labels.x}');
            });
        });
    });
    describe('when migrating variables with multi support', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                templating: {
        ...
        it('should have two variables after migration', function () {
            expect(model.templating.list.length).toBe(2);
        });
        it('should be migrated if being out of sync', function () {
        ...
        it('should not be migrated if being in sync', function () {
    ...
    describe('when migrating variables with tags', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                templating: {
        ...
        it('should have three variables after migration', function () {
        ...
        it('should have no tagsQuery property', function () {
        ...
        it('should have no tagValuesQuery property', function () {
        ...
        it('should have no useTags property', function () {
    ...
    describe('when migrating to new Text Panel', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                panels: [
                    ...
                    },
                    {
                        ...
                        options: {
                            mode: 'markdown',
                            content: '# React Text Panel from scratch\n# $constant\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)\n\n## $text',
                        },
                    },
                    {
                        id: 4,
        ...
        it('should have 3 panels after migration', function () {
            expect(model.panels.length).toBe(3);
        });
        it('should not migrate panel with old Text Panel id', function () {
            var oldAngularPanel = model.panels[0];
            ...
            expect(oldAngularPanel.content).toEqual('# Angular Text Panel\n# $constant\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)\n\n## $text\n\n');
            expect(oldAngularPanel.mode).toEqual('markdown');
        });
        it('should migrate panels with new Text Panel id', function () {
            var reactPanel = model.panels[1];
            ...
            expect(reactPanel.options.content).toEqual('# React Text Panel from scratch\n# $constant\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)\n\n## $text');
            expect(reactPanel.options.mode).toEqual('markdown');
        });
        it('should clean up old angular options for panels with new Text Panel id', function () {
            var reactPanel = model.panels[2];
            expect(reactPanel.id).toEqual(4);
            expect(reactPanel.type).toEqual('text');
            expect(reactPanel.title).toEqual('React Text Panel from Angular Panel');
            expect(reactPanel.options.content).toEqual('# React Text Panel from Angular Panel\n# $constant\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)\n\n## $text');
            expect(reactPanel.options.mode).toEqual('markdown');
            expect(reactPanel.options.angular).toBeUndefined();
        });
    });
    describe('when migrating constant variables so they are always hidden', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                templating: {
        ...
        it('should have six variables after migration', function () {
            expect(model.templating.list.length).toBe(6);
        });
        it('should not touch other variable types', function () {
        ...
        it('should migrate visible constant variables to textbox variables', function () {
        ...
        it('should change current and options for hidden constant variables', function () {
    ...
    describe('when migrating variable refresh to on dashboard load', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                templating: {
        ...
        it('should have 11 variables after migration', function () {
            expect(model.templating.list.length).toBe(14);
        });
        it('should not affect custom variable types', function () {
            var custom = model.templating.list[10];
            expect(custom.type).toEqual('custom');
            expect(custom.options).toEqual([{ text: 'custom', value: 'custom' }]);
        });
        it('should not affect textbox variable types', function () {
            var textbox = model.templating.list[11];
            expect(textbox.type).toEqual('textbox');
            expect(textbox.options).toEqual([{ text: 'Hello', value: 'World' }]);
        });
        it('should not affect datasource variable types', function () {
            var datasource = model.templating.list[12];
            expect(datasource.type).toEqual('datasource');
            expect(datasource.options).toEqual([{ text: 'ds', value: 'ds' }]);
        });
        it('should not affect interval variable types', function () {
            var interval = model.templating.list[13];
            expect(interval.type).toEqual('interval');
            expect(interval.options).toEqual([{ text: '1m', value: '1m' }]);
        });
        it('should removed options from all query variables', function () {
            var queryVariables = model.templating.list.filter(function (v) { return v.type === 'query'; });
            expect(queryVariables).toHaveLength(10);
            var noOfOptions = queryVariables.reduce(function (all, variable) { return all + variable.options.length; }, 0);
            expect(noOfOptions).toBe(0);
        });
        it('should set the refresh prop to on dashboard load for all query variables that have never or unknown', function () {
    ...
    describe('when migrating old value mapping model', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                panels: [
        ...
        it('should migrate value mapping model', function () {
    ...
    describe('when migrating tooltipOptions to tooltip', function () {
        it('should rename options.tooltipOptions to options.tooltip', function () {
    ...
    describe('when migrating singlestat value mappings', function () {
        it('should migrate value mapping', function () {
            var model = new DashboardModel({
                panels: [
                    {
                        type: 'singlestat',
        ...
        it('should migrate range mapping', function () {
            var model = new DashboardModel({
                panels: [
                    {
                        type: 'singlestat',
    ...
    describe('when migrating folded panel without fieldConfig.defaults', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                schemaVersion: 29,
        ...
        it('should ignore fieldConfig.defaults', function () {
            expect(model.panels[0].panels[0].fieldConfig.defaults).toEqual(undefined);
        });
    });
    describe('labelsToFields should be split into two transformers', function () {
        var model;
        beforeEach(function () {
            model = new DashboardModel({
                schemaVersion: 29,
        ...
        it('should create two transormatoins', function () {
            var xforms = model.panels[0].transformations;
            expect(xforms).toMatchInlineSnapshot("\n        Array [\n          Object {\n            \"id\": \"labelsToFields\",\n          },\n          Object {\n            \"id\": \"merge\",\n            \"options\": Object {},\n          },\n        ]\n      ");
        });
    });
    describe('migrating legacy CloudWatch queries', function () {
        var model;
        var panelTargets;
        beforeEach(function () {
            model = new DashboardModel({
        ...
        it('multiple stats query should have been split into three', function () {
            expect(panelTargets.length).toBe(4);
        });
        it('new stats query should get the right statistic', function () {
        ...
        it('new stats queries should be put in the end of the array', function () {
        ...
        describe('with nested panels', function () {
            var panel1Targets;
            var panel2Targets;
            var nestedModel;
            beforeEach(function () {
            ...
            it('multiple stats query should have been split into one query per stat', function () {
...
function createRow(options, panelDescriptions) {
    ...
    var panels = [];
    each(panelDescriptions, function (panelDesc) {
...
function getGridPositions(dashboard) {
    return map(dashboard.panels, function (panel) {
