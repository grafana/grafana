...
import { FieldConfigProperty, standardEditorsRegistry, standardFieldConfigEditorRegistry, dateTime, } from '@grafana/data';
...
const getVariableWithName = (name) => variablesMock.filter((v) => v.name === name)[0];
...
describe('PanelModel', () => {
    describe('when creating new panel model', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield model.pluginLoaded(tablePlugin);
        }));
        describe('migrations', () => {
            let initialMigrator = undefined;
            beforeEach(() => {
            ...
            it('should run sync migrations', () => __awaiter(void 0, void 0, void 0, function* () {
                model.options.valueToMigrate = 'old-legacy';
                tablePlugin.onPanelMigration = (p) => (Object.assign(Object.assign({}, p.options), { valueToMigrate: 'new-version' }));
            ...
            it('should run async migrations', () => __awaiter(void 0, void 0, void 0, function* () {
                model.options.valueToMigrate = 'old-legacy';
                tablePlugin.onPanelMigration = (p) => __awaiter(void 0, void 0, void 0, function* () {
                    return new Promise((resolve) => {
                        setTimeout(() => resolve(Object.assign(Object.assign({}, p.options), { valueToMigrate: 'new-version' })), 10);
                    });
                });
                yield model.pluginLoaded(tablePlugin);
                expect(model.options).toMatchObject({ valueToMigrate: 'new-version' });
        ...
        it('getSaveModel should clean libraryPanels from a collapsed row', () => {
            const newmodelJson = {
                type: 'row',
                panels: [
                    Object.assign(Object.assign({}, modelJson), { libraryPanel: {
                            uid: 'BVIBScisnl',
                            model: modelJson,
        ...
        describe('when changing to react panel from angular panel', () => {
            let panelQueryRunner;
            const onPanelTypeChanged = jest.fn();
            const reactPlugin = getPanelPlugin({ id: 'react' }).setPanelChangeHandler(onPanelTypeChanged);
            beforeEach(() => {
        ...
        describe('when autoMigrateFrom angular to react', () => {
            const onPanelTypeChanged = (panel, prevPluginId, prevOptions) => {
