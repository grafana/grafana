...
jest.mock('app/features/dashboard/services/TimeSrv', () => {
    ...
    return Object.assign(Object.assign({}, original), { getTimeSrv: () => (Object.assign(Object.assign({}, original.getTimeSrv()), { timeRange: jest.fn().mockReturnValue(undefined) })) });
});
...
jest.mock('@grafana/runtime', () => {
    ...
    return Object.assign(Object.assign({}, original), { getDataSourceSrv: jest.fn().mockImplementation(() => (Object.assign(Object.assign({}, original.getDataSourceSrv()), { getInstanceSettings: jest.fn() }))) });
});
jest.mock('@grafana/data', () => {
    const original = jest.requireActual('@grafana/data');
    return Object.assign(Object.assign({}, original), { EventBusSrv: jest.fn().mockImplementation(() => ({
            publish: jest.fn(),
        })) });
});
...
function describeInitScenario(description, scenarioFn) {
    describe(description, () => {
        ...
        const ctx = {
            ...
            loaderSrv,
            actions: [],
            storeState: Object.assign({ location: {
                    query: {},
                }, dashboard: {
                ...
                variables: {},
                transaction: Object.assign(Object.assign({}, initialTransactionState), { uid: DASH_UID, status: TransactionStatus.Completed }),
            })),
            setup: (fn) => {
                setupFn = fn;
            },
        ...
        beforeEach(() => __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            yield store.dispatch(initDashboard(ctx.args));
