...
var FolderPickerCtrl = /** @class */ (function () {
    /** @ngInject */
    function FolderPickerCtrl(validationSrv, contextSrv, $scope) {
    ...
    FolderPickerCtrl.prototype.getOptions = function (query) {
        ...
        return promiseToDigest(this.$scope)(backendSrv.get('api/search', params).then(function (result) {
            if (_this.isEditor &&
                (query === '' ||
                    query.toLowerCase() === 'g' ||
    ...
    FolderPickerCtrl.prototype.createFolder = function (evt) {
        ...
        return promiseToDigest(this.$scope)(createFolder({ title: this.newFolderName }).then(function (result) {
    ...
    FolderPickerCtrl.prototype.loadInitialValue = function () {
        ...
        this.getOptions('').then(function (result) {
            ...
            if (_this.initialFolderId) {
                // @ts-ignore
                folder = find(result, { value: _this.initialFolderId });
            }
