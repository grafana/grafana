...
import { orderProperties, isObject, getDashboardStringDiff } from './jsonDiffText';
describe('orderProperties', () => {
    ...
    it('should match reordered and modified arrays to nearest keys', () => {
        ...
        const after = [{ name: 'Charlie', country: 'Foxtrot' }, { name: 'Alice' }];
        const result = orderProperties(before, after);
...
describe('getDashboardStringDiff', () => {
    ...
    it('should no return changes when nothing changes', () => {
        ...
        expect(result).toEqual({
            migrationDiff: 'Index: Original Title\n' +
                '===================================================================\n' +
                '--- Original Title\t\n' +
                '+++ Original Title\t\n',
            userDiff: 'Index: Original Title\n' +
                '===================================================================\n' +
                '--- Original Title\t\n' +
                '+++ Original Title\t\n',
        });
...
//# sourceMappingURL=jsonDiffText.test.js.map