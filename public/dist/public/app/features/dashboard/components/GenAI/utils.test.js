...
describe('getDashboardChanges', () => {
    it('should correctly split user changes and migration changes', () => {
        ...
        dashboard.updatePanels([
            Object.assign(Object.assign({}, dashboard.panels[0]), { title: 'New title' }),
...
describe('isLLMPluginEnabled', () => {
    it('should return true if LLM plugin is enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        // Mock llms.openai.enabled to return true
        jest.mocked(openai.enabled).mockResolvedValue(true);
        const enabled = yield isLLMPluginEnabled();
        expect(enabled).toBe(true);
    }));
    it('should return false if LLM plugin is not enabled', () => __awaiter(void 0, void 0, void 0, function* () {
