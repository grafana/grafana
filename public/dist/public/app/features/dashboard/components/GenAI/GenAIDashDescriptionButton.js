...
const DESCRIPTION_GENERATION_STANDARD_PROMPT = 'You are an expert in creating Grafana Dashboards.\n' +
...
export const GenAIDashDescriptionButton = ({ onGenerate, dashboard }) => {
    const messages = React.useMemo(() => getMessages(dashboard), [dashboard]);
    return (React.createElement(GenAIButton, { messages: messages, onGenerate: onGenerate, loadingText: 'Generating description', eventTrackingSrc: EventTrackingSrc.dashboardDescription, toggleTipTitle: 'Improve your dashboard description' }));
};
...
//# sourceMappingURL=GenAIDashDescriptionButton.js.map