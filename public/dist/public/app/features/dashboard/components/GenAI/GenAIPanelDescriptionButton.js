...
const DESCRIPTION_GENERATION_STANDARD_PROMPT = 'You are an expert in creating Grafana Panels.\n' +
...
export const GenAIPanelDescriptionButton = ({ onGenerate, panel }) => {
    const messages = React.useMemo(() => getMessages(panel), [panel]);
    return (React.createElement(GenAIButton, { messages: messages, onGenerate: onGenerate, loadingText: 'Generating description', eventTrackingSrc: EventTrackingSrc.panelDescription, toggleTipTitle: 'Improve your panel description' }));
};
...
//# sourceMappingURL=GenAIPanelDescriptionButton.js.map