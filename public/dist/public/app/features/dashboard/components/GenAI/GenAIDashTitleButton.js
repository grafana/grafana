...
import { getDashboardPanelPrompt, Role } from './utils';
const TITLE_GENERATION_STANDARD_PROMPT = 'You are an expert in creating Grafana Dashboards.\n' +
...
export const GenAIDashTitleButton = ({ onGenerate, dashboard }) => {
    const messages = React.useMemo(() => getMessages(dashboard), [dashboard]);
    return (React.createElement(GenAIButton, { messages: messages, onGenerate: onGenerate, loadingText: 'Generating title', eventTrackingSrc: EventTrackingSrc.dashboardTitle, toggleTipTitle: 'Improve your dashboard title' }));
};
function getMessages(dashboard) {
    return [
        {
...
//# sourceMappingURL=GenAIDashTitleButton.js.map