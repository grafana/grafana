...
describe('DashboardRow', () => {
    ...
    it('Should not have collapsed class when collaped is false', () => {
        render(React.createElement(DashboardRow, { panel: panel, dashboard: dashboardMock }));
        const row = screen.getByTestId('dashboard-row-container');
        expect(row).toBeInTheDocument();
        expect(row).not.toHaveClass('dashboard-row--collapsed');
    });
    it('Should collapse when the panel is collapsed', () => __awaiter(void 0, void 0, void 0, function* () {
        const panel = new PanelModel({ collapsed: true });
        render(React.createElement(DashboardRow, { panel: panel, dashboard: dashboardMock }));
        const row = screen.getByTestId('dashboard-row-container');
        expect(row).toHaveClass('dashboard-row--collapsed');
    }));
    it('Should collapse after clicking title', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(DashboardRow, { panel: panel, dashboard: dashboardMock }));
        yield userEvent.click(screen.getByTestId('data-testid dashboard-row-title-'));
    ...
    it('Should return warning message when row panel has a panel with dashboard ds set', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('Should not return warning message when row panel does not have a panel with dashboard ds set', () => __awaiter(void 0, void 0, void 0, function* () {
        const panel = new PanelModel({
            datasource: {
                type: 'datasource',
                uid: 'ds-uid',
