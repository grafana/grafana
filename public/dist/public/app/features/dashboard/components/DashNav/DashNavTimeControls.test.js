...
describe('DashNavTimeControls', () => {
    ...
    it('renders RefreshPicker with run button in panel view', () => {
        const container = render(React.createElement(DashNavTimeControls, { dashboard: dashboardModel, onChangeTimeZone: jest.fn(), key: "time-controls" }));
    ...
    it('should not render RefreshPicker interval button in panel edit', () => {
        const panel = new PanelModel({ destroy: jest.fn(), isEditing: true });
