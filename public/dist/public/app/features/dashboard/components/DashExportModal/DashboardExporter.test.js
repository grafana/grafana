...
jest.mock('app/features/library-panels/state/api', () => ({
    getLibraryPanel: jest.fn().mockReturnValue(Promise.resolve({
        model: {
            type: 'graph',
            datasource: {
                type: 'testdb',
...
it('handles a default datasource in a template variable', () => __awaiter(void 0, void 0, void 0, function* () {
    const dashboard = {
        templating: {
            list: [
                {
    ...
    const exported = yield exporter.makeExportable(dashboardModel);
    expect(exported.templating.list[0].datasource.uid).toBe('${DS_GFDB}');
}));
it('replaces datasource ref in library panel', () => __awaiter(void 0, void 0, void 0, function* () {
    const dashboard = {
        editable: true,
        graphTooltip: 1,
        schemaVersion: 38,
...
it('If a panel queries has no datasource prop ignore it', () => __awaiter(void 0, void 0, void 0, function* () {
    const dashboard = {
        panels: [
            {
                id: 1,
...
describe('given dashboard with repeated panels', () => {
    ...
    it('should explicitly specify default datasources', () => {
        ...
        expect(exported.__inputs.some((ds) => ds.name === 'DS_GFDB')).toBeTruthy();
        expect(panel.datasource.uid).toBe('${DS_GFDB}');
        expect(panel.targets[0].datasource).toEqual({ type: 'testdb', uid: '${DS_GFDB}' });
    });
    it('should not include default datasource in __inputs unnecessarily', () => __awaiter(void 0, void 0, void 0, function* () {
        const testJson = {
            panels: [{ id: 1, datasource: { uid: 'other', type: 'other' }, type: 'graph' }],
        };
        const testDash = new DashboardModel(testJson);
        const exporter = new DashboardExporter();
        const exportedJson = yield exporter.makeExportable(testDash);
        expect(exportedJson.__inputs.some((ds) => ds.name === 'DS_GFDB')).toBeFalsy();
    }));
    ...
    it('should add library panels as elements', () => {
        const element = exported.__elements['ah8NqyDPs'];
    ...
    it('should add library panels in collapsed rows as elements', () => {
        const element = exported.__elements['jL6MrxCMz'];
...
function getStubInstanceSettings(v) {
    var _a, _b, _c;
    let key = (_a = v === null || v === void 0 ? void 0 : v.type) !== null && _a !== void 0 ? _a : v;
    return ((_c = stubs[(_b = key) !== null && _b !== void 0 ? _b : 'gfdb']) !== null && _c !== void 0 ? _c : stubs['gfdb']);
}
// Stub responses
const stubs = {};
stubs['gfdb'] = {
