...
import { onCreateNewPanel, onCreateNewRow, onAddLibraryPanel, getCopiedPanelPlugin, } from 'app/features/dashboard/utils/dashboard';
import AddPanelMenu from './AddPanelMenu';
jest.mock('app/types', () => (Object.assign(Object.assign({}, jest.requireActual('app/types')), { useDispatch: () => jest.fn(), useSelector: () => jest.fn() })));
jest.mock('@grafana/runtime', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/runtime')), { locationService: {
        partial: jest.fn(),
    }, reportInteraction: jest.fn(), config: {} })));
...
function setup() {
    ...
    const { rerender } = render(React.createElement(AddPanelMenu, { dashboard: props.dashboard }));
    return rerender;
}
beforeEach(() => {
...
it('renders with all buttons enabled', () => {
    getCopiedPanelPlugin.mockReturnValue({
        id: 'someid',
        name: 'nameofit',
...
//# sourceMappingURL=AddPanelMenu.test.js.map