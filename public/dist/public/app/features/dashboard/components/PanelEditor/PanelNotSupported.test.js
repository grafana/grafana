...
const setupTestContext = (options) => {
    ...
    render(React.createElement(PanelNotSupported, Object.assign({}, props)));
    return { props };
};
describe('PanelNotSupported', () => {
    ...
    describe('when the back to queries button is clicked', () => {
        it('then correct action should be dispatched', () => __awaiter(void 0, void 0, void 0, function* () {
            setupTestContext({});
            yield userEvent.click(screen.getByRole('button', { name: /go back to queries/i }));
