import { standardFieldConfigEditorRegistry, ThresholdsMode, } from '@grafana/data';
...
describe('updateDefaultFieldConfigValue', () => {
  ...
  `('when updating property:$property (is custom: $isCustom) with $newValue', ({ property, isCustom, newValue, expected }) => {
        const config = {
            defaults: {
                a: 1,
                b: {
