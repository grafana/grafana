...
import { FieldType, LoadingState, standardEditorsRegistry, standardFieldConfigEditorRegistry, toDataFrame, } from '@grafana/data';
...
class OptionsPaneOptionsTestScenario {
    constructor() {
        ...
        this.dashboard = createDashboardModelFixture();
...
describe('OptionsPaneOptions', () => {
    it('should render panel frame options', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should render all categories', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
        scenario.render();
    ...
    it('should call onFieldConfigsChange when updating field config', () => {
        ...
        fireEvent.change(input, { target: { value: 'New' } });
        fireEvent.blur(input);
        const newFieldConfig = scenario.panel.fieldConfig;
    ...
    it('should only render hits when search query specified', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
        scenario.render();
    ...
    it('should not render field override options non data panel', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
        scenario.plugin = getPanelPlugin({
            id: 'TestPanel',
        });
    ...
    it('should allow standard properties extension', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
        scenario.plugin = getPanelPlugin({
            id: 'TestPanel',
        }).useFieldConfig({
    ...
    it('should show data override info dot', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
    ...
    it('should show override rule info dot', () => __awaiter(void 0, void 0, void 0, function* () {
        const scenario = new OptionsPaneOptionsTestScenario();
