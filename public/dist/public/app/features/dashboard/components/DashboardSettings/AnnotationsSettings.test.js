...
function setup(dashboard, editIndex) {
    const sectionNav = {
        main: { text: 'Dashboard' },
        node: {
            text: 'Annotations',
    ...
    return render(React.createElement(TestProvider, null,
        React.createElement(AnnotationsSettings, { sectionNav: sectionNav, dashboard: dashboard, editIndex: editIndex })));
}
describe('AnnotationsSettings', () => {
    ...
    test('it renders empty list cta if only builtIn annotation', () => __awaiter(void 0, void 0, void 0, function* () {
        setup(dashboard);
        expect(screen.queryByRole('grid')).toBeInTheDocument();
        expect(screen.getByRole('row', { name: /annotations & alerts \(built-in\) -- grafana --/i })).toBeInTheDocument();
        expect(screen.getByTestId(selectors.components.CallToActionCard.buttonV2('Add annotation query'))).toBeInTheDocument();
        expect(screen.queryByRole('link', { name: /annotations documentation/i })).toBeInTheDocument();
    }));
    test('it renders empty list if annotations', () => __awaiter(void 0, void 0, void 0, function* () {
        dashboard.annotations.list = [];
        setup(dashboard);
        expect(screen.getByTestId(selectors.components.CallToActionCard.buttonV2('Add annotation query'))).toBeInTheDocument();
    }));
    test('it renders the annotation names or uid if annotation does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        dashboard.annotations.list = [
            ...dashboard.annotations.list,
            {
                builtIn: 0,
    ...
    test('it renders a sortable table of annotations', () => __awaiter(void 0, void 0, void 0, function* () {
        dashboard.annotations.list = [
            ...dashboard.annotations.list,
            {
                builtIn: 0,
        ...
        yield userEvent.click(within(getTableBody()).getAllByRole('button', { name: 'Move down' })[0]);
        yield userEvent.click(within(getTableBody()).getAllByRole('button', { name: 'Move down' })[1]);
        yield userEvent.click(within(getTableBody()).getAllByRole('button', { name: 'Move up' })[0]);
    ...
    test('Adding a new annotation', () => __awaiter(void 0, void 0, void 0, function* () {
        setup(dashboard);
        yield userEvent.click(screen.getByTestId(selectors.components.CallToActionCard.buttonV2('Add annotation query')));
        expect(locationService.getSearchObject().editIndex).toBe('1');
        expect(dashboard.annotations.list.length).toBe(2);
    }));
    test('Editing annotation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield userEvent.clear(nameInput);
        yield userEvent.type(nameInput, 'My Prometheus Annotation');
        yield userEvent.click(screen.getByText(/testdata/i));
        expect(yield screen.findByText(/Prometheus/i)).toBeVisible();
        expect(screen.queryAllByText(/testdata/i)).toHaveLength(2);
        yield userEvent.click(screen.getByText(/prometheus/i));
        expect(screen.getByRole('checkbox', { name: /hidden/i })).not.toBeChecked();
    }));
    test('Deleting annotation', () => __awaiter(void 0, void 0, void 0, function* () {
        dashboard.annotations.list = [
            ...dashboard.annotations.list,
            {
                builtIn: 0,
...
//# sourceMappingURL=AnnotationsSettings.test.js.map