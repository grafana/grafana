...
function setup(options) {
    ...
    const props = {
        ...
        canCreate: (_a = options === null || options === void 0 ? void 0 : options.canCreate) !== null && _a !== void 0 ? _a : true,
    };
    const { rerender } = render(React.createElement(DashboardEmpty, { dashboard: props.dashboard, canCreate: props.canCreate }));
    return rerender;
}
beforeEach(() => {
...
//# sourceMappingURL=DashboardEmpty.test.js.map