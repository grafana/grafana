...
import { dateTimeParse, FieldType, LoadingState, LogLevel, LogsDedupStrategy, LogsMetaKind, LogsVolumeType, MutableDataFrame, sortDataFrame, toDataFrame, } from '@grafana/data';
import { MockObservableDataSourceApi } from '../../../test/mocks/datasource_srv';
import { COMMON_LABELS, dataFrameToLogsModel, dedupLogRows, filterLogLevels, getSeriesProperties, LIMIT_LABEL, logSeriesToLogsModel, queryLogsSample, queryLogsVolume, } from './logsModel';
...
describe('logs volume', () => {
    ...
    let volumeProvider, datasource, request;
    function createFrame(labels, timestamps, values, refId) {
        return toDataFrame({
            refId,
            fields: [
    ...
    it('applies correct meta data', () => __awaiter(void 0, void 0, void 0, function* () {
        setup(setupMultipleResults);
        const logVolumeCustomMeta = {
        ...
        yield expect(volumeProvider).toEmitValuesWith((received) => {
    ...
    it('applies correct meta data when streaming', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('logs sample', () => {
    ...
    let logsSampleProvider, datasource, request;
    ...
    const resultAFrame2 = createFrame([{ app: 'app01', level: 'error' }], [400, 500, 600], ['line 4', 'line 5', 'line 6']);
    const resultBFrame1 = createFrame([{ app: 'app02' }], [700, 800, 900], ['line A', 'line B', 'line C']);
    const resultBFrame2 = createFrame([{ app: 'app02', level: 'error' }], [1000, 1100, 1200], ['line D', 'line E', 'line F']);
    function setupMultipleResults() {
        datasource = new MockObservableDataSourceApi('loki', [
            {
                data: [resultAFrame1, resultAFrame2],
    ...
    it('returns data', () => __awaiter(void 0, void 0, void 0, function* () {
        setup(setupMultipleResults);
        yield expect(logsSampleProvider).toEmitValuesWith((received) => {
            expect(received).toContainEqual({ state: LoadingState.Loading, error: undefined, data: [] });
...
//# sourceMappingURL=logsModel.test.js.map