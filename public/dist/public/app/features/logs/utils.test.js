import { FieldType, LogLevel, LogsSortOrder, MutableDataFrame, } from '@grafana/data';
import { calculateLogsLabelStats, calculateStats, checkLogsError, getLogLevel, getLogLevelFromKey, getLogsVolumeMaximumRange, logRowsToReadableJson, mergeLogsVolumeDataFrames, sortLogsResult, } from './utils';
...
describe('mergeLogsVolumeDataFrames', () => {
    function mockLogVolume(level, timestamps, values) {
...
describe('getLogsVolumeDimensions', () => {
    function mockLogVolumeDataFrame(values, absoluteRange) {
