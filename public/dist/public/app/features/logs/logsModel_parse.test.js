import { FieldType, dateTimeFormatISO, DataFrameType } from '@grafana/data';
import { logSeriesToLogsModel } from './logsModel';
jest.mock('@grafana/data', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/data')), { 
    // this produces relative time, so the test-results would keep changing,
    // so we have to mock it
    dateTimeFormatTimeAgo: (p1, p2) => `mock:dateTimeFormatTimeAgo:${dateTimeFormatISO(p1, p2)}` })));
...
//# sourceMappingURL=logsModel_parse.test.js.map