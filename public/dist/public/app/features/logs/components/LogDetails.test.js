...
import { LogLevel, MutableDataFrame, createTheme, FieldType } from '@grafana/data';
...
const setup = (propOverrides, rowOverrides) => {
    ...
    const props = Object.assign({ displayedFields: [], showDuplicates: false, wrapLogMessage: false, row: createLogRow(Object.assign({ logLevel: LogLevel.error, timeEpochMs: 1546297200000 }, rowOverrides)), getRows: () => [], onClickFilterLabel: () => { }, onClickFilterOutLabel: () => { }, onClickShowField: () => { }, onClickHideField: () => { }, theme,
        styles }, (propOverrides || {}));
    render(React.createElement("table", null,
        React.createElement("tbody", null,
            React.createElement(LogDetails, Object.assign({}, props)))));
};
describe('LogDetails', () => {
    describe('when labels are present', () => {
        ...
        describe('With toggleLabelsInLogsUI=true', () => {
            ...
            it('should provide the log row to Explore filter functions', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield userEvent.click(screen.getByLabelText('Filter for value in query A'));
                ...
                yield userEvent.click(screen.getByLabelText('Filter out value in query A'));
...
//# sourceMappingURL=LogDetails.test.js.map