...
function getAnnotation({ enable = true, useSnapshotData = false, datasource = LEGACY_DS_NAME, } = {}) {
    const annotation = {
    ...
    return Object.assign(Object.assign({}, annotation), { snapshotData: useSnapshotData ? getSnapshotData(annotation) : undefined });
}
