...
const setup = (partialProps = {}) => {
    ...
    const props = Object.assign(Object.assign({}, partialProps), { onChange: partialProps.onChange || jest.fn(), onDismiss: partialProps.onDismiss || jest.fn(), current: partialProps.current || mockDS1 });
    return render(React.createElement(DataSourceModal, Object.assign({}, props)));
};
...
describe('DataSourceDropdown', () => {
    ...
    describe('configuration', () => {
        it('displays the configure new datasource when the list is empty', () => __awaiter(void 0, void 0, void 0, function* () {
            const user = userEvent.setup();
            setup();
            const searchBox = yield screen.findByRole('searchbox');
        ...
        it('only displays the file drop area when the the ff is enabled', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield screen.queryByTestId('file-drop-zone-default-children')).toBeInTheDocument();
            config.featureToggles.editPanelCSVDragAndDrop = defaultValue;
        }));
        it('does not show the file drop area when the ff is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
            const defaultValue = config.featureToggles.editPanelCSVDragAndDrop;
            config.featureToggles.editPanelCSVDragAndDrop = false;
            setup({ uploadFile: true });
            expect(yield screen.queryByTestId('file-drop-zone-default-children')).toBeNull();
            config.featureToggles.editPanelCSVDragAndDrop = defaultValue;
        }));
        it('should not display the drop zone by default', () => __awaiter(void 0, void 0, void 0, function* () {
            const defaultValue = config.featureToggles.editPanelCSVDragAndDrop;
            config.featureToggles.editPanelCSVDragAndDrop = true;
        ...
        it('should display the drop zone when uploadFile is enabled', () => __awaiter(void 0, void 0, void 0, function* () {
            const defaultValue = config.featureToggles.editPanelCSVDragAndDrop;
            config.featureToggles.editPanelCSVDragAndDrop = true;
            setup({ uploadFile: true });
            expect(yield screen.queryByTestId('file-drop-zone-default-children')).toBeInTheDocument();
        ...
        it('should fetch the DS applying the correct filters consistently across lists', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const props = Object.assign({ onChange: () => { }, onDismiss: () => { }, current: mockDS1.name }, filters);
            getListMock.mockClear();
            render(React.createElement(DataSourceModal, Object.assign({}, props)));
    ...
    describe('interactions', () => {
        it('should be searchable', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield screen.findByText(mockDS2.name, { selector: 'span' })).toBeInTheDocument();
            yield user.keyboard('foobarbaz'); //Search for a DS that should not exist
            expect(yield screen.findByText('No data sources found')).toBeInTheDocument();
        }));
        //Skipping this test as it's flaky on drone
        it.skip('calls the onChange with the default query containing the file', () => __awaiter(void 0, void 0, void 0, function* () {
            const user = userEvent.setup();
            config.featureToggles.editPanelCSVDragAndDrop = true;
            const onChange = jest.fn();
            setup({ onChange, uploadFile: true });
            const fileInput = (yield screen.queryByTestId('file-drop-zone-default-children')).parentElement.parentElement.querySelector('input');
            const file = new File([''], 'test.csv', { type: 'text/plain' });
            expect(fileInput).toBeInTheDocument();
            yield user.upload(fileInput, file);
        ...
        it('should call the onChange handler with the correct datasource', () => __awaiter(void 0, void 0, void 0, function* () {
            const user = userEvent.setup();
            const onChange = jest.fn();
            setup({ onChange });
...
//# sourceMappingURL=DataSourceModal.test.js.map