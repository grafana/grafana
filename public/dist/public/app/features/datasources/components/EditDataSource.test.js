...
jest.mock('@grafana/runtime', () => {
    return Object.assign(Object.assign({}, jest.requireActual('@grafana/runtime')), { getDataSourceSrv: jest.fn(() => ({
...
const setup = (props) => {
    ...
    return render(React.createElement(Provider, { store: store },
        React.createElement(EditDataSourceView, Object.assign({ dataSource: getMockDataSource(), dataSourceMeta: getMockDataSourceMeta(), dataSourceSettings: getMockDataSourceSettingsState(), dataSourceRights: { readOnly: false, hasWriteRights: true, hasDeleteRights: true }, exploreUrl: '/explore', onDelete: jest.fn(), onDefaultChange: jest.fn(), onNameChange: jest.fn(), onOptionsChange: jest.fn(), onTest: jest.fn(), onUpdate: jest.fn() }, props))));
};
describe('<EditDataSource>', () => {
    ...
    describe('On editing', () => {
        ...
        it('should render an alpha info message if the plugin is still in Alpha state', () => {
            ...
            expect(screen.getByTitle('This feature is experimental and future updates might not be backward compatible')).toBeVisible();
        });
    ...
    describe('when extending the datasource config form', () => {
                ...
                extensions: [
                    {
                        ...
                        component: () => React.createElement("div", null, message),
                    },
                ],
            }));
            setup({
        ...
        it('should pass a context prop to the rendered UI extension component', () => {
            const message = "I'm a UI extension component!";
            const component = jest.fn().mockReturnValue(React.createElement("div", null, message));
            setPluginExtensionGetter(jest.fn().mockReturnValue({
                extensions: [
                    {
                        id: '1',
...
//# sourceMappingURL=EditDataSource.test.js.map