...
export function buildNavModel(dataSource, plugin) {
    ...
    if (featureEnabled('dspermissions.enforcement')) {
        ...
        navModel.children.push(Object.assign(Object.assign({}, dsPermissions), { url: dsPermissions.url + '/upgrade', tabSuffix: () => ProBadge({ experimentId: permissionsExperimentId }) }));
    }
    ...
    if (featureEnabled('analytics')) {
        ...
        navModel.children.push(Object.assign(Object.assign({}, analytics), { url: analytics.url + '/upgrade', tabSuffix: () => ProBadge({ experimentId: analyticsExperimentId }) }));
    }
    ...
    if (featureEnabled('caching')) {
        ...
        navModel.children.push(Object.assign(Object.assign({}, caching), { url: caching.url + '/upgrade', tabSuffix: () => ProBadge({ experimentId: cachingExperimentId }) }));
    }
    return navModel;
}
