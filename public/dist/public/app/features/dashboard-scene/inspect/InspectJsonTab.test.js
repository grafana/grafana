...
import { SceneCanvasText, SceneDataNode, SceneDataTransformer, SceneGridItem, SceneGridLayout, VizPanel, } from '@grafana/scenes';
...
describe('InspectJsonTab', () => {
    it('Can show panel json', () => __awaiter(void 0, void 0, void 0, function* () {
        const { tab } = yield buildTestScene();
        const obj = JSON.parse(tab.state.jsonText);
        expect(obj.gridPos).toEqual({ x: 0, y: 0, w: 10, h: 12 });
        expect(tab.isEditable()).toBe(true);
    }));
    it('Can show panel data with field config', () => __awaiter(void 0, void 0, void 0, function* () {
        const { tab } = yield buildTestScene();
    ...
    it('Can show raw data frames', () => __awaiter(void 0, void 0, void 0, function* () {
        const { tab } = yield buildTestScene();
    ...
    it('Can update model', () => __awaiter(void 0, void 0, void 0, function* () {
        const { tab, panel, scene } = yield buildTestScene();
      ...
      "transparent": false
        ...
        expect(panel2.parent.state.width).toBe(3);
...
//# sourceMappingURL=InspectJsonTab.test.js.map