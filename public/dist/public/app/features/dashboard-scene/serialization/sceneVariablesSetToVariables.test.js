import { of } from 'rxjs';
import { FieldType, getDefaultTimeRange, LoadingState, PluginType, toDataFrame, VariableSupportType, } from '@grafana/data';
...
const runRequestMock = jest.fn().mockReturnValue(of({
...
const fakeDsMock = {
    ...
    variables: {
        ...
        toDataQuery: (q) => (Object.assign(Object.assign({}, q), { refId: 'FakeDataSource-refId' })),
    },
    id: 1,
    uid: 'fake-std',
};
...
//# sourceMappingURL=sceneVariablesSetToVariables.test.js.map