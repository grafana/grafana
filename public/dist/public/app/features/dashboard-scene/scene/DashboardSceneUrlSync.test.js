...
describe('DashboardSceneUrlSync', () => {
    describe('Given a standard scene', () => {
        it('Should set inspectPanelKey when url has inspect key', () => {
            ...
            (_a = scene.urlSync) === null || _a === void 0 ? void 0 : _a.updateFromUrl({ inspect: '2' });
            expect(scene.state.inspectPanelKey).toBe('2');
        });
        it('Should handle inspect key that is not found', () => {
            var _a;
            const scene = buildTestScene();
            (_a = scene.urlSync) === null || _a === void 0 ? void 0 : _a.updateFromUrl({ inspect: '12321' });
            expect(scene.state.inspectPanelKey).toBe(undefined);
        });
        it('Should set viewPanelKey when url has viewPanel', () => {
            var _a;
            const scene = buildTestScene();
            (_a = scene.urlSync) === null || _a === void 0 ? void 0 : _a.updateFromUrl({ viewPanel: '2' });
    ...
    describe('Given a viewPanelKey with clone that is not found', () => {
        ...
        (_a = scene.urlSync) === null || _a === void 0 ? void 0 : _a.updateFromUrl({ viewPanel: 'panel-1-clone-1' });
...
//# sourceMappingURL=DashboardSceneUrlSync.test.js.map