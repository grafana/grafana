...
import { SceneObjectBase, VariableDependencyConfig, SceneGridLayout, SceneVariableSet, sceneGraph, MultiValueVariable, LocalValueVariable, } from '@grafana/scenes';
import { GRID_CELL_HEIGHT, GRID_CELL_VMARGIN } from 'app/core/constants';
import { getMultiVariableValues } from '../utils/utils';
import { DashboardRepeatsProcessedEvent } from './types';
export class PanelRepeaterGridItem extends SceneObjectBase {
    constructor(state) {
        super(state);
     ...
     */
    _handleGridResize(newState, prevState) {
        var _a, _b;
        const itemCount = (_b = (_a = this.state.repeatedPanels) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 1;
        const stateChange = {};
        // Height changed
    ...
    _performRepeat() {
        ...
        const stateChange = { repeatedPanels: repeatedPanels };
        const itemHeight = (_a = this.state.itemHeight) !== null && _a !== void 0 ? _a : 10;
    ...
    getMaxPerRow() {
        var _a;
        return (_a = this.state.maxPerRow) !== null && _a !== void 0 ? _a : 4;
    }
    getRepeatDirection() {
...
PanelRepeaterGridItem.Component = ({ model }) => {
    var _a;
    const { repeatedPanels, itemHeight } = model.useState();
    const itemCount = (_a = repeatedPanels === null || repeatedPanels === void 0 ? void 0 : repeatedPanels.length) !== null && _a !== void 0 ? _a : 0;
    const layoutStyle = useLayoutStyle(model.getRepeatDirection(), itemCount, model.getMaxPerRow(), itemHeight !== null && itemHeight !== void 0 ? itemHeight : 10);
    if (!repeatedPanels) {
        return null;
    }
    return (React.createElement("div", { className: layoutStyle }, repeatedPanels.map((panel) => (React.createElement("div", { className: itemStyle, key: panel.state.key },
        React.createElement(panel.Component, { model: panel, key: panel.state.key }))))));
};
function useLayoutStyle(direction, itemCount, maxPerRow, itemHeight) {
    return useMemo(() => {
...
//# sourceMappingURL=PanelRepeaterGridItem.js.map