...
export function panelMenuBehavior(menu) {
    const asyncFunc = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (contextSrv.hasAccessToExplore() && !(panelPlugin === null || panelPlugin === void 0 ? void 0 : panelPlugin.meta.skipDataQuery) && queryRunner) {
...
//# sourceMappingURL=PanelMenuBehavior.js.map