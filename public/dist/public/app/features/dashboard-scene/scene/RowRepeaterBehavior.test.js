...
import { EmbeddedScene, SceneCanvasText, SceneGridItem, SceneGridLayout, SceneGridRow, SceneTimeRange, SceneVariableSet, TestVariable, } from '@grafana/scenes';
...
describe('RowRepeaterBehavior', () => {
    describe('Given scene with variable with 5 values', () => {
        ...
        it('Should repeat row', () => {
            ...
            const row1 = grid.state.children[1];
            expect((_a = row1.state.$behaviors) === null || _a === void 0 ? void 0 : _a[0]).toBeInstanceOf(RowRepeaterBehavior);
            expect(row1.state.$variables.state.variables[0].getValue()).toBe('1');
            const row2 = grid.state.children[2];
            expect((_c = (_b = row2.state.$variables.state.variables[0]).getValueText) === null || _c === void 0 ? void 0 : _c.call(_b)).toBe('B');
            // Should give repeated panels unique keys
            const gridItem = row2.state.children[0];
            expect((_d = gridItem.state.body) === null || _d === void 0 ? void 0 : _d.state.key).toBe('canvas-1-row-1');
        });
        it('Should push row at the bottom down', () => {
            // Should push row at the bottom down
            const rowAtTheBottom = grid.state.children[6];
        ...
        it('Should handle second repeat cycle and update remove old repeats', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=RowRepeaterBehavior.test.js.map