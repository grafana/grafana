...
export var SlideDown = function (_a) {
    ...
    return (React.createElement(Transition, { in: inProp, timeout: defaultDuration }, function (state) { return (React.createElement("div", { style: __assign(__assign({}, style), transitionStyles[state]) }, children)); }));
};
