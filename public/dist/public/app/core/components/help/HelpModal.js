    ...
    return [
        ...
        },
        {
            ...
            shortcuts: [
                ...
                {
                    keys: ['d', 'a'],
                    description: t('help-modal.shortcuts-description.toggle-auto-fit', 'Toggle auto fit panels (experimental feature)'),
                },
                {
                    keys: [`${modKey} + o`],
        ...
        },
        {
            ...
            shortcuts: [
                ...
                {
                    keys: ['t', 'a'],
                    description: t('help-modal.shortcuts-description.make-time-range-permanent', 'Make time range absolute/permanent'),
                },
            ],
        },
    ];
};
export const HelpModal = ({ onDismiss }) => {
    const styles = useStyles2(getStyles);
    const modKey = useMemo(() => getModKey(), []);
    const shortcuts = useMemo(() => getShortcuts(modKey), [modKey]);
    return (React.createElement(Modal, { title: t('help-modal.title', 'Shortcuts'), isOpen: true, onDismiss: onDismiss, onClickBackdrop: onDismiss },
        React.createElement("div", { className: styles.categories }, Object.values(shortcuts).map(({ category, shortcuts }, i) => (React.createElement("div", { className: styles.shortcutCategory, key: i },
            React.createElement("table", { className: styles.shortcutTable },
                React.createElement("tbody", null,
                    ...
                    shortcuts.map((shortcut, j) => (React.createElement("tr", { key: `${i}-${j}` },
                        React.createElement("td", { className: styles.shortcutTableKeys }, shortcut.keys.map((key, k) => (React.createElement("span", { className: styles.shortcutTableKey, key: `${i}-${j}-${k}` }, key)))),
