...
describe('SanitizedSVG', () => {
    it('should cleanup the style and generate an ID', () => {
        ...
        expect(svgId === null || svgId === void 0 ? void 0 : svgId.startsWith('x')).toBeTruthy();
        expect(updatedStyle === null || updatedStyle === void 0 ? void 0 : updatedStyle.indexOf(`#${svgId}`)).toBeGreaterThan(-1);
...
//# sourceMappingURL=SanitizedSVG.test.js.map