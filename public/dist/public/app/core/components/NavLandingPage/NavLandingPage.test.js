...
describe('NavLandingPage', () => {
    ...
    const setup = (showHeader = false) => {
        ...
        const header = showHeader ? React.createElement("h3", null, "Custom Header") : undefined;
        return render(React.createElement(TestProvider, null,
            React.createElement(NavLandingPage, { navId: mockId, header: header })));
    };
...
//# sourceMappingURL=NavLandingPage.test.js.map