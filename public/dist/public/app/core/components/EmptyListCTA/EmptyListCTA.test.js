...
describe('EmptyListCTA', () => {
    it('should return a button element if there is no buttonLink prop', () => {
        render(React.createElement(EmptyListCTA, { title: "title", buttonIcon: "plus", buttonTitle: "button title" }));
        expect(screen.getByRole('button', { name: 'button title' }));
    });
    it('should return an anchor element if there is a buttonLink prop', () => {
        render(React.createElement(EmptyListCTA, { title: "title", buttonIcon: "plus", buttonLink: "href", buttonTitle: "button title" }));
