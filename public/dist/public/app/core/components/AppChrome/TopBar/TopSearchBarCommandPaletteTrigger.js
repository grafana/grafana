...
export function TopSearchBarCommandPaletteTrigger() {
    ...
    if (isSmallScreen) {
        return (React.createElement(ToolbarButton, { iconOnly: true, icon: "search", "aria-label": t('nav.search.placeholderCommandPalette', 'Search or jump to...'), onClick: onOpenSearch }));
    }
    return React.createElement(PretendTextInput, { onClick: onOpenSearch });
}
function PretendTextInput({ onClick }) {
    ...
    return (React.createElement("div", { className: styles.wrapper },
        React.createElement("div", { className: styles.inputWrapper },
            React.createElement("div", { className: styles.prefix },
                React.createElement(Icon, { name: "search" })),
            React.createElement("button", { className: styles.fakeInput, onClick: onClick }, t('nav.search.placeholderCommandPalette', 'Search or jump to...')),
            React.createElement("div", { className: styles.suffix },
                React.createElement(Icon, { name: "keyboard" }),
                React.createElement("span", { className: styles.shortcut },
                    modKey,
                    "+k")))));
}
...
//# sourceMappingURL=TopSearchBarCommandPaletteTrigger.js.map