import { createTheme, FieldType, ThresholdsMode, toDataFrame, dateTime } from '@grafana/data';
import { LegendDisplayMode } from '@grafana/schema';
import { findNextStateIndex, fmtDuration, getThresholdItems, prepareTimelineFields, prepareTimelineLegendItems, } from './utils';
...
describe('prepare timeline graph', () => {
    ...
    it('will merge duplicate values', () => {
        ...
        expect(field === null || field === void 0 ? void 0 : field.values).toMatchInlineSnapshot(`
      [
        1,
        1,
        undefined,
    ...
    it('should try to sort time fields', () => {
        ...
        expect((_a = result.frames) === null || _a === void 0 ? void 0 : _a[0].fields[0].values).toEqual([1, 2, 3, 4]);
    });
});
...
describe('getThresholdItems', () => {
    it('should handle only one threshold', () => {
        const result = getThresholdItems({ thresholds: { mode: ThresholdsMode.Absolute, steps: [{ color: 'black', value: 0 }] } }, theme);
...
describe('prepareTimelineLegendItems', () => {
    it('should return legend items without crashing when single (base) threshold', () => {
        ...
        const result = prepareTimelineLegendItems(frames, { displayMode: LegendDisplayMode.List }, theme);
        expect(result).toHaveLength(1);
    });
});
describe('duration', () => {
