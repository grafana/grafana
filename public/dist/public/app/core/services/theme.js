...
export function changeTheme(themeId, runtimeOnly) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const currentPref = yield service.load();
        yield service.update(Object.assign(Object.assign({}, currentPref), { theme: newTheme.colors.mode }));
    });
}
