...
import { GrafanaJavascriptAgentBackend } from './GrafanaJavascriptAgentBackend';
jest.mock('@grafana/faro-web-sdk', () => {
    const originalModule = jest.requireActual('@grafana/faro-web-sdk');
    return Object.assign(Object.assign({ __esModule: true }, originalModule), { initializeFaro: jest.fn() });
});
describe('GrafanaJavascriptAgentEchoBackend', () => {
    ...
    it('will set up FetchTransport if customEndpoint is provided', () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const originalModule = jest.requireActual('@grafana/faro-web-sdk');
    ...
    it('will initialize GrafanaJavascriptAgent and set user', () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const mockedSetUser = jest.fn();
        const mockedInstrumentationsForConfig = [];
        ...
        const mockedAgent = () => {
            return {
                ...
                config: {
                    ...
                    unpatchedConsole: Object.assign({}, console),
                },
                metas: {
                    add: jest.fn(),
                    remove: jest.fn(),
    ...
    it('will forward events to transports', () => __awaiter(void 0, void 0, void 0, function* () {
        //arrange
        const mockedSetUser = jest.fn();
        const mockedInstrumentationsForConfig = [];
        const mockedInstrumentations = {
        ...
        jest.mocked(initializeFaro).mockImplementation(mockedAgent);
        const backend = new GrafanaJavascriptAgentBackend(Object.assign(Object.assign({}, options), { preventGlobalExposure: true }));
        backend.transports = [
            /* eslint-disable */
            { send: jest.fn() },
            { send: jest.fn() },
...
//# sourceMappingURL=GrafanaJavascriptAgentBackend.test.js.map