...
export class ContextSrv {
    ...
    fetchUserPermissions() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.user.permissions = yield getBackendSrv().get('/api/access-control/user/actions', {
                    reloadcache: true,
                });
            }
            catch (e) {
    ...
    hasPermissionInMetadata(action, object) {
        var _a;
        return !!((_a = object.accessControl) === null || _a === void 0 ? void 0 : _a[action]);
    }
    // Checks whether user has required permission
