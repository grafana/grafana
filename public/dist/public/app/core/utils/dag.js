...
var Node = /** @class */ (function () {
    ...
    Node.prototype.getEdgeFrom = function (from) {
        ...
        if (typeof from === 'object') {
            return this.inputEdges.find(function (e) { var _a; return ((_a = e.inputNode) === null || _a === void 0 ? void 0 : _a.name) === from.name; });
        }
        return this.inputEdges.find(function (e) { var _a; return ((_a = e.inputNode) === null || _a === void 0 ? void 0 : _a.name) === from; });
    };
    Node.prototype.getEdgeTo = function (to) {
        ...
        if (typeof to === 'object') {
            return this.outputEdges.find(function (e) { var _a; return ((_a = e.outputNode) === null || _a === void 0 ? void 0 : _a.name) === to.name; });
        }
        return this.outputEdges.find(function (e) { var _a; return ((_a = e.outputNode) === null || _a === void 0 ? void 0 : _a.name) === to; });
    };
    Node.prototype.getOptimizedInputEdges = function () {
        ...
        this.inputEdges.forEach(function (e) {
            var _a;
            var inputEdgesNodes = (_a = e.inputNode) === null || _a === void 0 ? void 0 : _a.inputEdges.map(function (e) { return e.inputNode; });
            inputEdgesNodes === null || inputEdgesNodes === void 0 ? void 0 : inputEdgesNodes.forEach(function (n) {
                var edgeToRemove = n === null || n === void 0 ? void 0 : n.getEdgeTo(_this.name);
                if (edgeToRemove) {
...
export var printGraph = function (g) {
    Object.keys(g.nodes).forEach(function (name) {
        var n = g.nodes[name];
        var outputEdges = n.outputEdges.map(function (e) { var _a; return (_a = e.outputNode) === null || _a === void 0 ? void 0 : _a.name; }).join(', ');
        if (!outputEdges) {
            outputEdges = '<none>';
        }
        var inputEdges = n.inputEdges.map(function (e) { var _a; return (_a = e.inputNode) === null || _a === void 0 ? void 0 : _a.name; }).join(', ');
        if (!inputEdges) {
            inputEdges = '<none>';
        }
