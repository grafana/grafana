...
describe('parseUrlFromOptions', () => {
  ...
  `("when called with params: '$params' and url: '$url' then result should be '$expected'", ({ params, url, expected }) => {
...
describe('parseInitFromOptions', () => {
  ...
  `("when called with method: '$method', data: '$data', withCredentials: '$withCredentials' and credentials: '$credentials' then result should be '$expected'", ({ method, data, withCredentials, credentials, expected }) => {
...
describe('parseBody', () => {
  ...
  `("when called with options: '$options' and isAppJson: '$isAppJson' then the result should be '$expected'", ({ options, isAppJson, expected }) => {
...
describe('parseCredentials', () => {
  ...
  `("when called with options: '$options' then the result should be '$expected'", ({ options, isAppJson, expected }) => {
...
describe('parseResponseBody', () => {
    ...
    it('parses json', () => __awaiter(void 0, void 0, void 0, function* () {
        const value = { hello: 'world' };
        const body = yield parseResponseBody(Object.assign(Object.assign({}, rsp), { json: jest.fn().mockImplementationOnce(() => value) }), 'json');
        expect(body).toEqual(value);
    }));
    it('returns an empty object {} when the response is empty but is declared as JSON type', () => __awaiter(void 0, void 0, void 0, function* () {
        rsp.headers.set('Content-Length', '0');
        jest.spyOn(console, 'warn').mockImplementation();
        const json = jest.fn();
        const body = yield parseResponseBody(Object.assign(Object.assign({}, rsp), { json }), 'json');
        expect(body).toEqual({});
        expect(json).not.toHaveBeenCalled();
        expect(console.warn).toHaveBeenCalledTimes(1);
    }));
    it('parses text', () => __awaiter(void 0, void 0, void 0, function* () {
        const value = 'RAW TEXT';
        const body = yield parseResponseBody(Object.assign(Object.assign({}, rsp), { text: jest.fn().mockImplementationOnce(() => value) }), 'text');
        expect(body).toEqual(value);
    }));
    it('undefined text', () => __awaiter(void 0, void 0, void 0, function* () {
        const value = 'RAW TEXT';
        const body = yield parseResponseBody(Object.assign(Object.assign({}, rsp), { text: jest.fn().mockImplementationOnce(() => value) }));
        expect(body).toEqual(value);
    }));
    it('undefined as parsed json', () => __awaiter(void 0, void 0, void 0, function* () {
        const value = { hello: 'world' };
        const body = yield parseResponseBody(Object.assign(Object.assign({}, rsp), { text: jest.fn().mockImplementationOnce(() => JSON.stringify(value)) }));
        expect(body).toEqual(value);
    }));
});
