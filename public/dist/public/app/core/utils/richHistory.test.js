...
import { RichHistoryStorageWarning } from '../history/RichHistoryStorage';
import { addToRichHistory, updateStarredInRichHistory, updateCommentInRichHistory, mapNumbertoTimeInSlider, createDateStringFromTs, createQueryHeading, deleteAllFromRichHistory, deleteQueryInRichHistory, SortOrder, } from './richHistory';
const richHistoryStorageMock = {};
...
describe('richHistory', () => {
    beforeEach(() => {
        ...
        richHistoryStorageMock.addToRichHistory = jest.fn((r) => {
            return Promise.resolve({ richHistoryQuery: Object.assign(Object.assign({}, r), { id: 'GENERATED ID', createdAt: Date.now() }) });
        });
        ...
        richHistoryStorageMock.updateComment = jest.fn((id, comment) => {
            return Object.assign(Object.assign({}, mock), { comment });
        });
        richHistoryStorageMock.updateStarred = jest.fn((id, starred) => {
            return Object.assign(Object.assign({}, mock), { starred });
        });
    });
    afterEach(() => {
        jest.useRealTimers();
    ...
    describe('addToRichHistory', () => {
        ...
        it('should append query to query history', () => __awaiter(void 0, void 0, void 0, function* () {
            Date.now = jest.fn(() => 2);
            const { limitExceeded, richHistoryStorageFull } = yield addToRichHistory(mock.testDatasourceUid, mock.testDatasourceName, mock.testQueries, mock.testStarred, mock.testComment, true, true);
        ...
        it('it should return a flag indicating that the limit has been exceed', () => __awaiter(void 0, void 0, void 0, function* () {
            Date.now = jest.fn(() => 2);
            richHistoryStorageMock.addToRichHistory = jest.fn((query) => {
                return Promise.resolve({
                    richHistoryQuery: Object.assign(Object.assign({}, query), { id: 'GENERATED ID', createdAt: Date.now() }),
                    warning: {
            ...
            const { richHistoryStorageFull, limitExceeded } = yield addToRichHistory(mock.testDatasourceUid, mock.testDatasourceName, mock.testQueries, mock.testStarred, mock.testComment, true, true);
            expect(richHistoryStorageFull).toBeFalsy();
            expect(limitExceeded).toBeTruthy();
        }));
    });
    describe('updateStarredInRichHistory', () => {
        it('should update starred in query in history', () => __awaiter(void 0, void 0, void 0, function* () {
            const updatedStarred = yield updateStarredInRichHistory('1', !mock.starred);
            expect(updatedStarred.starred).toEqual(!mock.starred);
        }));
    });
    describe('updateCommentInRichHistory', () => {
        it('should update comment in query in history', () => __awaiter(void 0, void 0, void 0, function* () {
            const updatedComment = yield updateCommentInRichHistory('1', 'new comment');
            expect(updatedComment.comment).toEqual('new comment');
        }));
    });
    describe('deleteQueryInRichHistory', () => {
        it('should delete query in query in history', () => __awaiter(void 0, void 0, void 0, function* () {
            const deletedHistoryId = yield deleteQueryInRichHistory('1');
