...
export function getNavTitle(navId) {
...
export function getNavSubTitle(navId) {
    switch (navId) {
        case 'dashboards':
        ...
        case 'dashboards/snapshots':
            return t('nav.snapshots.subtitle', 'Interactive, publically available, point-in-time representations of dashboards');
        case 'dashboards/library-panels':
        ...
        case 'receivers':
            return t('nav.alerting-receivers.subtitle', 'Choose how to notify your contact points when an alert instance fires');
        case 'am-routes':
        ...
        case 'admin':
            return t('nav.admin.subtitle', 'Manage server-wide settings and access to resources such as organizations, users, and licenses');
        case 'cfg/general':
...
//# sourceMappingURL=navBarItem-translations.js.map