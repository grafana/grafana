...
describe('MySQL connection details:: ', () => {
    it('should have max query length attribute', () => {
        render(React.createElement(Form, { onSubmit: jest.fn(), render: () => React.createElement(MySQLConnectionDetails, { remoteInstanceCredentials: {} }) }));
...
//# sourceMappingURL=MySQLConnectionDetails.test.js.map