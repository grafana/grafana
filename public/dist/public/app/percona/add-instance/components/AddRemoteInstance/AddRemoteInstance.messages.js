export const Messages = {
    ...
    success: {
        title: (service) => `Service “${service}” added to your inventory`,
        description: (serviceType) => `Your ${serviceType} service instance is now ready to be monitored.`,
    },
};
//# sourceMappingURL=AddRemoteInstance.messages.js.map