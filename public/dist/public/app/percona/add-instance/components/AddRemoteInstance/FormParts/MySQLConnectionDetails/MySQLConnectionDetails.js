...
export const MySQLConnectionDetails = ({ form, remoteInstanceCredentials }) => {
    ...
    return (React.createElement("div", { className: styles.groupWrapper },
        ...
        React.createElement("div", { className: styles.group },
            React.createElement(TextInputField, { "data-testid": "service-name-label", name: "serviceName", label: Messages.form.labels.mainDetails.serviceName, tooltipText: Messages.form.tooltips.mainDetails.serviceName, placeholder: Messages.form.placeholders.mainDetails.serviceName }),
        ...
        React.createElement("div", { className: styles.group },
            React.createElement(TextInputField, { key: "maxQueryLength", name: "maxQueryLength", label: Messages.form.labels.mysqlDetails.maxQueryLength, tooltipText: Messages.form.tooltips.mysqlDetails.maxQueryLength, placeholder: Messages.form.placeholders.mysqlDetails.maxQueryLength, validators: maxQueryLengthValidators }),
            React.createElement("div", null))));
};
//# sourceMappingURL=MySQLConnectionDetails.js.map