...
export const MainDetailsFormPart = ({ form, remoteInstanceCredentials }) => {
    ...
    return (React.createElement("div", { className: styles.groupWrapper },
        ...
        React.createElement("div", { className: styles.group },
            React.createElement(TextInputField, { name: "serviceName", label: Messages.form.labels.mainDetails.serviceName, tooltipText: Messages.form.tooltips.mainDetails.serviceName, placeholder: Messages.form.placeholders.mainDetails.serviceName }),
...
//# sourceMappingURL=MainDetails.js.map