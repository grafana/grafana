...
describe('RestoreHistoryDetails', () => {
    it('should render', () => {
        render(React.createElement(RestoreHistoryDetails, { name: "restore one", pitrTimestamp: PITR_TS, dataModel: DataModel.PHYSICAL }));
    ...
    it('should hide "PITR timestamp" when null', () => {
        render(React.createElement(RestoreHistoryDetails, { name: "restore one", dataModel: DataModel.PHYSICAL }));
        expect(screen.queryByTestId('restore-details-pitr')).not.toBeInTheDocument();
    });
});
//# sourceMappingURL=RestoreHistoryDetails.test.js.map