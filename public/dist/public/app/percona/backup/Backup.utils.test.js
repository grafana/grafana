...
describe('Backup::utils', () => {
    describe('formatStatus', () => {
        it('should correctly format status', () => {
            ...
            expect(formatStatus('bla')).toBe(statusMsg.error);
        });
    });
    describe('formatDataModel', () => {
        it('should correctly format status', () => {
            ...
            expect(formatDataModel('bla')).toBe('');
        });
    });
    describe('formatBackupMode', () => {
        it('should correctly format backup mode', () => {
            ...
            expect(formatBackupMode('bla')).toBe(backupModeMsg.invalid);
        });
    });
});
//# sourceMappingURL=Backup.utils.test.js.map