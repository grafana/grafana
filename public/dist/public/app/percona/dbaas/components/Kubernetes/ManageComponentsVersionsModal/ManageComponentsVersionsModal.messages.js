...
export const Messages = {
    ...
    operatorLabel: {
        [Operators.pxc]: (version) => `Percona Operator for MySQL ${version}`,
        [Operators.psmdb]: (version) => `Percona Operator for MongoDB ${version}`,
    },
    componentLabel: {
...
//# sourceMappingURL=ManageComponentsVersionsModal.messages.js.map