...
describe('TextareaInputField::', () => {
    it('should render a textarea element', () => {
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { name: "test" })));
    ...
    it('should call passed validators', () => {
        ...
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { name: "test", validators: [validatorOne, validatorTwo] })));
    ...
    it('should show validation errors on blur if specified', () => {
        ...
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { showErrorOnBlur: true, name: "test", validators: [validatorOne, validatorTwo] })));
        const input = screen.getByRole('textbox');
        fireEvent.change(input, { target: { value: 'Test' } });
        expect(validatorOne).toBeCalledTimes(2);
    ...
    it('should show validation errors on render if specified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const validatorTwo = jest.fn().mockReturnValue('some error');
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { showErrorOnRender: true, name: "test", validators: [validatorOne, validatorTwo] })));
        expect(validatorOne).toBeCalledTimes(1);
        expect(validatorTwo).toBeCalledTimes(1);
    ...
    it('should show a label if one is specified', () => {
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { label: "test label", name: "test" })));
    ...
    it('should show an asterisk on the label if the field is required', () => {
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { label: "test label", name: "test", required: true })));
        expect(screen.queryByTestId('test-field-label')).toHaveTextContent('test label *');
    });
    it('should not pass the required prop to the input if the field is required', () => {
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { name: "test", required: true })));
    ...
    it('should apply the passed class name to the inner textarea element', () => {
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { name: "test", className: "testClass" })));
    ...
    it('should accept any valid input html attributes and pass them over to the textarea tag', () => {
        ...
        render(React.createElement(FormWrapper, null,
            React.createElement(TextareaInputField, { name: "test", inputProps: {
                    autoComplete: 'off',
                    onChange,
                    title,
                } })));
