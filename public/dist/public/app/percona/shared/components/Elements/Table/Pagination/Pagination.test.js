...
describe('Pagination', () => {
    it('should render at least one page', () => {
        render(React.createElement(Pagination, { totalItems: 0, pageCount: 1, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 0 }));
    ...
    it('should disable left navigation buttons when in first page', () => {
        render(React.createElement(Pagination, { totalItems: 30, pageCount: 10, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3 }));
    ...
    it('should disable right navigation buttons when in last page', () => {
        render(React.createElement(Pagination, { totalItems: 10, pageCount: 1, pageSizeOptions: [], pageSize: 10, nrRowsOnCurrentPage: 10 }));
    ...
    it('should enable all navigation buttons while active page is not first or last', () => {
        render(React.createElement(Pagination, { totalItems: 30, pageCount: 3, pageSizeOptions: [], pageSize: 10, nrRowsOnCurrentPage: 10 }));
    ...
    it('should show all pages when pagesPerView > totalPages', () => {
        render(React.createElement(Pagination, { pagesPerView: 25, totalItems: 10, pageCount: 4, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3 }));
    ...
    it('should show "pagesPerView" pages if pageCount > pagesPerView', () => {
        render(React.createElement(Pagination, { pagesPerView: 5, totalItems: 100, pageCount: 10, pageSizeOptions: [], pageSize: 10, nrRowsOnCurrentPage: 10 }));
        expect(screen.getAllByTestId('page-button')).toHaveLength(4);
        expect(screen.getAllByTestId('page-button-active')).toHaveLength(1);
    });
    it('should keep the selected page in the center, when pagesPerView is odd and while last page button is not visible', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(Pagination, { pagesPerView: 5, totalItems: 20, pageCount: 7, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3 }));
    ...
    it('should keep the selected page in the center-left, when pagesPerView is even and while last page button is not visible', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(Pagination, { pagesPerView: 6, totalItems: 80, pageCount: 8, pageSizeOptions: [], pageSize: 10, nrRowsOnCurrentPage: 10 }));
    ...
    it('should keep moving from the center when last page button is already visible', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(Pagination, { pagesPerView: 3, totalItems: 15, pageCount: 5, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3 }));
    ...
    it('should correctly show the items interval being shown', () => __awaiter(void 0, void 0, void 0, function* () {
        render(React.createElement(Pagination, { pagesPerView: 3, totalItems: 15, pageCount: 5, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3 }));
        expect(screen.getByTestId('pagination-items-inverval')).toHaveTextContent(Messages.getItemsIntervalMessage(1, 3, 15));
        for (let i = 0; i < 2; i++) {
            const btn = screen.getByTestId('next-page-button');
            yield waitFor(() => fireEvent.click(btn));
        }
        expect(screen.getByTestId('pagination-items-inverval')).toHaveTextContent(Messages.getItemsIntervalMessage(7, 9, 15));
    }));
    it('should show "showing 0 - 0 of 0 items" when empty', () => {
        render(React.createElement(Pagination, { pagesPerView: 3, totalItems: 0, pageCount: 0, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 0 }));
        expect(screen.getByTestId('pagination-items-inverval')).toHaveTextContent(Messages.getItemsIntervalMessage(0, 0, 0));
    });
    it('should trigger a page change', () => {
        const cb = jest.fn();
        render(React.createElement(Pagination, { pagesPerView: 3, totalItems: 15, pageCount: 5, pageSizeOptions: [], pageSize: 3, nrRowsOnCurrentPage: 3, onPageChange: cb }));
        const btn = screen.getByTestId('next-page-button');
        fireEvent.click(btn);
    ...
    it('should go to first page after page size changes', () => {
        ...
        render(React.createElement(Pagination, { pagesPerView: 3, totalItems: 15, pageCount: 5, pageSizeOptions: options, pageSize: 3, nrRowsOnCurrentPage: 3, onPageChange: jest.fn(), onPageSizeChange: cb }));
        for (let i = 0; i < 5; i++) {
            const btn = screen.getByTestId('next-page-button');
            fireEvent.click(btn);
        }
