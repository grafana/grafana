...
import { ACTIVE_SERVICE_TYPES_CHECK_INTERVAL_MS, getPmmSettingsPage, PMM_ACCESS_ROLES_PAGE, PMM_ACCESS_ROLE_CREATE_PAGE, PMM_ACCESS_ROLE_EDIT_PAGE, PMM_ADD_INSTANCE_PAGE, PMM_BACKUP_PAGE, PMM_DBAAS_PAGE, PMM_EDIT_INSTANCE_PAGE, PMM_ENTITLEMENTS_PAGE, PMM_ENVIRONMENT_OVERVIEW_PAGE, PMM_INVENTORY_PAGE, PMM_TICKETS_PAGE, } from './PerconaNavigation.constants';
import { addAccessRolesLink, addFolderLinks, buildAdvisorsNavItem, buildIntegratedAlertingMenuItem, buildInventoryAndSettings, 
// filterByServices,
removeAlertingMenuItem, } from './PerconaNavigation.utils';
const PerconaNavigation = () => {
    ...
    useEffect(() => {
        ...
        if (isAuthorized) {
            if (result === null || result === void 0 ? void 0 : result.enableAccessControl) {
...
//# sourceMappingURL=PerconaNavigation.js.map