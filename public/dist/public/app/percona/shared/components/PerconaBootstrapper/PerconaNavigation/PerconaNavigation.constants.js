...
export const PMM_ALERTING_PERCONA_ALERTS = [
    {
...
export const PMM_INVENTORY_PAGE = {
    id: 'inventory',
    icon: 'server-network',
    text: 'PMM Inventory',
...
export const PMM_HEADING_LINK = {
    id: 'settings-pmm',
    text: 'PMM',
};
export const PMM_ADD_INSTANCE_PAGE = {
    id: 'add-instance',
...
export const PMM_EDIT_INSTANCE_PAGE = {
    id: 'edit-instance',
...
export const PMM_ACCESS_ROLE_CREATE_PAGE = {
    id: 'rbac-create-role',
...
export const PMM_ACCESS_ROLE_EDIT_PAGE = {
    id: 'rbac-edit-role',
...
export const PMM_ACCESS_ROLES_PAGE = {
    id: 'rbac-roles',
    icon: 'user-square',
...
export const getPmmSettingsPage = (alertingEnabled = false) => {
    const children = [
        {
...
export const PMM_ENTITLEMENTS_PAGE = {
    id: 'entitlements',
    icon: 'cloud',
    text: 'Entitlements',
...
export const PMM_ENVIRONMENT_OVERVIEW_PAGE = {
 ...
 */
export const NAV_FOLDER_MAP = {
    system: 'OS',
    mysql: 'MySQL',
    mongo: 'MongoDB',
    postgre: 'PostgreSQL',
};
export const NAV_ID_TO_SERVICE = {
...
//# sourceMappingURL=PerconaNavigation.constants.js.map