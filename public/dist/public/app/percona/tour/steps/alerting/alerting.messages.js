export const Messages = {
    ...
    alertRuleTemplates: {
        ...
        offers: 'Percona offers a set of default templates for common events and expressions, but you can also create custom templates to fit your unique requirements.',
    },
    alertRules: {
        title: 'Alert Rules',
        rules: 'Alert rules specify the conditions for firing alerts.',
        start: 'Start from your available templates to pre-fill some of these conditions, and create your rule by adding more conditions and changing the template values.',
    ...
    contactPoints: {
        ...
        grafana: 'Grafana supports a multitude of ChatOps tools to ensure that your team is notified via the most relevant channel.',
    },
    ...
    silences: {
        ...
        silences: 'Silences will prevent notifications from getting created, but they will not prevent alerting rules from being evaluated or recorded in the Fired Alerts tab. A silence only lasts for a specified window of time.',
    },
    alertGroups: {
        title: 'Alert Groups',
...
//# sourceMappingURL=alerting.messages.js.map