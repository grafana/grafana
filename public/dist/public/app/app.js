...
import { locationService, registerEchoBackend, setBackendSrv, setDataSourceSrv, setEchoSrv, setLocationSrv, setQueryRunnerFactory, setRunRequest, setPluginImportUtils, setPluginExtensionGetter, setAppEvents, } from '@grafana/runtime';
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const preloadResults = yield preloadPlugins(config.apps);
                ...
                const pluginExtensionGetter = (options) => getPluginExtensions(Object.assign(Object.assign({}, options), { registry: extensionRegistry }));
...
function initEchoSrv() {
    ...
    if (config.grafanaJavascriptAgent.enabled) {
        registerEchoBackend(new GrafanaJavascriptAgentBackend(Object.assign(Object.assign({}, config.grafanaJavascriptAgent), { app: {
                version: config.buildInfo.version,
                environment: config.buildInfo.env,
            }, buildInfo: config.buildInfo, user: {
                id: String((_a = config.bootData.user) === null || _a === void 0 ? void 0 : _a.id),
                email: (_b = config.bootData.user) === null || _b === void 0 ? void 0 : _b.email,
            } })));
    }
    ...
    if (config.googleAnalytics4Id) {
        registerEchoBackend(new GA4EchoBackend({
