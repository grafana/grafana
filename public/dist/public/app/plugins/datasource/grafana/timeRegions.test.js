...
describe('grafana data source', () => {
    it('supports time region query', () => {
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, toDayOfWeek: 2 }, {
    ...
    it('handles timezone conversion UTC-UTC', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, timezone: 'utc' }, {
            from: dateTime('2023-03-01'),
    ...
    it('handles timezone conversion browser-UTC', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, timezone: 'browser' }, {
            from: dateTime('2023-03-01'),
            to: dateTime('2023-03-08'),
            raw: {
                to: '',
    ...
    it('handles timezone conversion CST-UTC', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, timezone: 'America/Chicago' }, {
            from: dateTime('2023-03-01'),
            to: dateTime('2023-03-08'),
            raw: {
                to: '',
    ...
    it('handles timezone conversion Europe/Amsterdam-UTC', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, timezone: 'Europe/Amsterdam' }, {
            from: dateTime('2023-03-01'),
            to: dateTime('2023-03-08'),
            raw: {
                to: '',
    ...
    it('handles timezone conversion Asia/Hovd-UTC', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, timezone: 'Asia/Hovd' }, {
            from: dateTime('2023-03-01'),
            to: dateTime('2023-03-08'),
            raw: {
                to: '',
    ...
    it('handles timezone conversion UTC-CST', () => {
        ...
        const frame = doTimeRegionQuery('test', { fromDayOfWeek: 1, from: '08:00', timezone: 'utc' }, {
            from: dateTime('2023-03-01'),
            to: dateTime('2023-03-08'),
            raw: {
                to: '',
