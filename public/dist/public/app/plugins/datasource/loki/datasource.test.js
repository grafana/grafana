...
import { AbstractLabelOperator, CoreApp, dataFrameToJSON, dateTime, FieldType, SupplementaryQueryType, } from '@grafana/data';
import { config, getBackendSrv, reportInteraction, setBackendSrv, } from '@grafana/runtime';
...
describe('LokiDatasource', () => {
    ...
    describe('when doing logs queries with limits', () => {
        const runTest = (queryMaxLines, dsMaxLines, expectedMaxLines, app) => __awaiter(void 0, void 0, void 0, function* () {
            const settings = {
                jsonData: {
                    maxLines: dsMaxLines,
                },
            ...
            yield expect(ds.query(options).pipe(take(1))).toEmitValuesWith(() => {
                expect(fetchMock.mock.calls.length).toBe(1);
                expect(spy.mock.calls[0][0].maxLines).toBe(expectedMaxLines);
            });
        });
        it('should use datasource max lines when no query max lines', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(undefined, '40', 40, undefined);
        }));
        it('should use query max lines, if exists', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(80, undefined, 80, undefined);
        }));
        it('should use query max lines, if both exist, even if it is higher than ds max lines', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(80, '40', 80, undefined);
        }));
        it('should use query max lines, if both exist, even if it is 0', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(0, '40', 0, undefined);
        }));
        it('should report query interaction', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(80, '40', 80, CoreApp.Explore);
            expect(reportInteraction).toHaveBeenCalledWith('grafana_loki_query_executed', expect.objectContaining({
                query_type: 'logs',
                line_limit: 80,
                parsed_query: parseToNodeNamesArray('{a="b"}').join(','),
            }));
        }));
        it('should not report query interaction for dashboard query', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(80, '40', 80, CoreApp.Dashboard);
            expect(reportInteraction).not.toBeCalled();
        }));
        it('should not report query interaction for panel edit query', () => __awaiter(void 0, void 0, void 0, function* () {
            yield runTest(80, '40', 80, CoreApp.PanelEditor);
            expect(reportInteraction).toHaveBeenCalledWith('grafana_loki_query_executed', expect.objectContaining({
                query_type: 'logs',
                line_limit: 80,
                parsed_query: parseToNodeNamesArray('{a="b"}').join(','),
    ...
    describe('When using adhoc filters', () => {
        ...
        const query = { expr: DEFAULT_EXPR, refId: 'A' };
        const mockedGetAdhocFilters = templateSrvStub.getAdhocFilters;
        const ds = createLokiDatasource(templateSrvStub);
        it('should not modify expression with no filters', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(ds.applyTemplateVariables(query, {}).expr).toBe(DEFAULT_EXPR);
        }));
        it('should add filters to expression', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(ds.applyTemplateVariables(query, {}).expr).toBe('rate({bar="baz", job="foo", k1="v1", k2!="v2"} |= "bar" [5m])');
        }));
        it('should add escaping if needed to regex filter expressions', () => __awaiter(void 0, void 0, void 0, function* () {
            mockedGetAdhocFilters.mockReturnValue([
                {
                    key: 'k1',
                    operator: '=~',
            ...
            expect(ds.applyTemplateVariables(query, {}).expr).toBe('rate({bar="baz", job="foo", k1=~"v.*", k2=~"v\\\\\'.*"} |= "bar" [5m])');
        }));
    });
    describe('when interpolating variables', () => {
        ...
        beforeEach(() => {
            ...
            variable = Object.assign({}, initialCustomVariableModelState);
        });
    ...
    describe('when calling annotationQuery', () => {
        const getTestContext = (frame, options = {}) => {
        ...
        it('should transform the loki data to annotation response', () => __awaiter(void 0, void 0, void 0, function* () {
            const testFrame = {
                refId: 'A',
                fields: [
                    {
            ...
            const res = yield getTestContext(testFrame, { stepInterval: '15s' });
        ...
        describe('Formatting', () => {
            ...
            describe('When tagKeys is set', () => {
                it('should only include selected labels', () => __awaiter(void 0, void 0, void 0, function* () {
                    const res = yield getTestContext(testFrame, { tagKeys: 'label2,label3', stepInterval: '15s' });
            ...
            describe('When textFormat is set', () => {
                it('should format the text accordingly', () => __awaiter(void 0, void 0, void 0, function* () {
                    const res = yield getTestContext(testFrame, { textFormat: 'hello {{label2}}', stepInterval: '15s' });
                    expect(res.length).toBe(1);
                    expect(res[0].text).toBe('hello value2');
                }));
            });
            describe('When titleFormat is set', () => {
                it('should format the title accordingly', () => __awaiter(void 0, void 0, void 0, function* () {
                    const res = yield getTestContext(testFrame, { titleFormat: 'Title {{label2}}', stepInterval: '15s' });
                    expect(res.length).toBe(1);
    ...
    describe('metricFindQuery', () => {
        ...
        it('should return label names for Loki', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const legacyResult = yield ds.metricFindQuery('label_names()');
            const result = yield ds.metricFindQuery({ refId: 'test', type: LokiVariableQueryType.LabelNames });
        ...
        it('should return label values for Loki when no matcher', () => __awaiter(void 0, void 0, void 0, function* () {
            const { ds } = getTestContext();
            const legacyResult = yield ds.metricFindQuery('label_values(label1)');
            const result = yield ds.metricFindQuery({
                refId: 'test',
        ...
        it('should return label values for Loki with matcher', () => __awaiter(void 0, void 0, void 0, function* () {
            const { ds } = getTestContext();
            const legacyResult = yield ds.metricFindQuery('label_values({label1="value1", label2="value2"},label5)');
            const result = yield ds.metricFindQuery({
                refId: 'test',
                type: LokiVariableQueryType.LabelValues,
        ...
        it('should return empty array when incorrect query for Loki', () => __awaiter(void 0, void 0, void 0, function* () {
            const { ds } = getTestContext();
            const result = yield ds.metricFindQuery('incorrect_query');
            expect(result).toEqual([]);
        }));
        it('should interpolate strings in the query', () => __awaiter(void 0, void 0, void 0, function* () {
            const { ds } = getTestContext();
            const scopedVars = { scopedVar1: { value: 'A' } };
            yield ds.metricFindQuery('label_names()', { scopedVars });
            yield ds.metricFindQuery({
                refId: 'test',
                type: LokiVariableQueryType.LabelValues,
                stream: '{label1="value1", label2="value2"}',
                label: 'label5',
            ...
            expect(templateSrvStub.replace).toHaveBeenCalledWith('{label1="value1", label2="value2"}', scopedVars, expect.any(Function));
        ...
        describe('when called with ADD_FILTER', () => {
            ...
            describe('and query has no parser', () => {
                it('then the correct label should be added for logs query', () => {
                    const query = { refId: 'A', expr: '{bar="baz"}' };
                ...
                it('then the correct label should be added for metrics query', () => {
                    const query = { refId: 'A', expr: 'rate({bar="baz"}[5m])' };
                    const action = { options: { key: 'job', value: 'grafana' }, type: 'ADD_FILTER' };
                    const result = ds.modifyQuery(query, action);
                    expect(result.refId).toEqual('A');
            ...
            describe('and query has parser', () => {
                it('then the correct label should be added for logs query', () => {
                    const query = { refId: 'A', expr: '{bar="baz"} | logfmt' };
                    const action = { options: { key: 'job', value: 'grafana' }, type: 'ADD_FILTER' };
                    const result = ds.modifyQuery(query, action);
                    expect(result.refId).toEqual('A');
                ...
                it('then the correct label should be added for metrics query', () => {
                    const query = { refId: 'A', expr: 'rate({bar="baz"} | logfmt [5m])' };
                    const action = { options: { key: 'job', value: 'grafana' }, type: 'ADD_FILTER' };
                    const result = ds.modifyQuery(query, action);
                    expect(result.refId).toEqual('A');
    ...
    describe('toggleQueryFilter', () => {
        describe('when called with FILTER', () => {
            ...
            describe('and query has no parser', () => {
                it('then the correct label should be added for logs query', () => {
                    const query = { refId: 'A', expr: '{bar="baz"}' };
                    const action = { options: { key: 'job', value: 'grafana' }, type: 'FILTER_FOR' };
                ...
                it('then the correctly escaped label should be added for logs query', () => {
                    const query = { refId: 'A', expr: '{bar="baz"}' };
                    const action = { options: { key: 'job', value: '\\test' }, type: 'FILTER_FOR' };
                    const result = ds.toggleQueryFilter(query, action);
                    expect(result.refId).toEqual('A');
                    expect(result.expr).toEqual('{bar="baz", job="\\\\test"}');
                });
                ...
                describe('and the filter is already present', () => {
                    it('then it should remove the filter', () => {
                        const query = { refId: 'A', expr: '{bar="baz", job="grafana"}' };
                        const action = { options: { key: 'job', value: 'grafana' }, type: 'FILTER_FOR' };
                        const result = ds.toggleQueryFilter(query, action);
                        expect(result.refId).toEqual('A');
                    ...
                    it('then it should remove the filter with escaped value', () => {
                        const query = { refId: 'A', expr: '{place="luna", job="\\"grafana/data\\""}' };
                        const action = { options: { key: 'job', value: '"grafana/data"' }, type: 'FILTER_FOR' };
                        const result = ds.toggleQueryFilter(query, action);
                        expect(result.refId).toEqual('A');
            ...
            describe('and query has parser', () => {
                ...
                describe('and the filter is already present', () => {
                    it('then it should remove the filter', () => {
                        const query = { refId: 'A', expr: '{bar="baz"} | logfmt | job="grafana"' };
                        const action = { options: { key: 'job', value: 'grafana' }, type: 'FILTER_FOR' };
                        const result = ds.toggleQueryFilter(query, action);
                        expect(result.refId).toEqual('A');
    ...
    describe('addAdHocFilters', () => {
        let ds;
        const createTemplateSrvMock = (options) => {
            return {
                getAdhocFilters: () => options.adHocFilters,
                replace: (a) => a,
            };
        };
        describe('when called with "=" operator', () => {
            beforeEach(() => {
                const defaultAdHocFilters = [
                    {
                        condition: '',
                        key: 'job',
                        operator: '=',
            ...
            describe('and query has no parser', () => {
                ...
                it('should correctly escape special characters in ad hoc filter', () => {
                    const ds = createLokiDatasource(createTemplateSrvMock({
                        adHocFilters: [
                            {
                                condition: '',
                                key: 'instance',
    ...
    describe('getSupplementaryQuery', () => {
        ...
        describe('logs sample', () => {
            it('returns logs sample query for range metric query', () => {
                expect(ds.getSupplementaryQuery({ type: SupplementaryQueryType.LogsSample }, {
                    expr: 'rate({label=value}[5m]',
                    queryType: LokiQueryType.Range,
                    refId: 'A',
                })).toEqual({
            ...
            it('correctly overrides maxLines if limit is set', () => {
                expect(ds.getSupplementaryQuery({ type: SupplementaryQueryType.LogsSample, limit: 5 }, {
                    expr: 'rate({label=value}[5m]',
                    queryType: LokiQueryType.Instant,
                    refId: 'A',
                })).toEqual({
    ...
    describe('importing queries', () => {
        ...
        it('keeps all labels when no labels are loaded', () => __awaiter(void 0, void 0, void 0, function* () {
            ds.getResource = () => Promise.resolve({ data: [] });
            const queries = yield ds.importFromAbstractQueries([
                {
                    refId: 'A',
                    labelMatchers: [
        ...
        it('filters out non existing labels', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getDataSamples', () => {
        ...
        it('uses the current interval in the request', () => {
            const spy = jest.spyOn(ds, 'query').mockImplementation(() => of({}));
    ...
    describe('Query splitting', () => {
        beforeAll(() => {
            ...
            jest.mocked(runSplitQuery).mockReturnValue(of({
                data: [],
            }));
        });
        afterAll(() => {
        ...
        ])('supports query splitting when the requirements are met', (targets) => __awaiter(void 0, void 0, void 0, function* () {
            const ds = createLokiDatasource(templateSrvStub);
            const query = getQueryOptions({
                targets,
                app: CoreApp.Dashboard,
            });
            yield expect(ds.query(query)).toEmitValuesWith(() => {
    ...
    describe('getQueryStats', () => {
        ...
        beforeEach(() => {
            ...
            ds.interpolateString = jest.fn().mockImplementation((value) => value.replace('$__interval', '1m'));
            query = { refId: 'A', expr: '', queryType: LokiQueryType.Range };
        });
        it('uses statsMetadataRequest', () => __awaiter(void 0, void 0, void 0, function* () {
            query.expr = '{foo="bar"}';
            const result = yield ds.getQueryStats(query);
            expect(ds.statsMetadataRequest).toHaveBeenCalled();
            expect(result).toEqual({ streams: 1, chunks: 1, bytes: 1, entries: 1 });
        }));
        it('supports queries with template variables', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('does not call stats if the query is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
            query.expr = 'rate({label="value"}';
            const result = yield ds.getQueryStats(query);
            expect(ds.statsMetadataRequest).not.toHaveBeenCalled();
            expect(result).toBe(undefined);
        }));
        it('combines the stats of each label matcher', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('statsMetadataRequest', () => {
        it('throws error if url starts with /', () => {
            ...
            expect(() => __awaiter(void 0, void 0, void 0, function* () {
                yield ds.statsMetadataRequest('/index');
    ...
    describe('with template and built-in variables', () => {
        ...
        it('should not interpolate __interval variables', () => {
            const templateSrvMock = {
                getAdhocFilters: jest.fn().mockImplementation((query) => query),
                replace: jest.fn((a, ...rest) => a),
            };
            const ds = createLokiDatasource(templateSrvMock);
            ds.addAdHocFilters = jest.fn().mockImplementation((query) => query);
            ds.applyTemplateVariables({ expr: 'rate({job="grafana"}[$__interval]) + rate({job="grafana"}[$__interval_ms])', refId: 'A' }, scopedVars);
            expect(templateSrvMock.replace).toHaveBeenCalledTimes(2);
            // Interpolated legend
            expect(templateSrvMock.replace).toHaveBeenCalledWith(undefined, expect.not.objectContaining({
                __interval: { text: '1m', value: '1m' },
                __interval_ms: { text: '1000', value: '1000' },
            }));
            // Interpolated expr
            expect(templateSrvMock.replace).toHaveBeenCalledWith('rate({job="grafana"}[$__interval]) + rate({job="grafana"}[$__interval_ms])', expect.not.objectContaining({
                __interval: { text: '1m', value: '1m' },
                __interval_ms: { text: '1000', value: '1000' },
            }), expect.any(Function));
        });
        it('should not interpolate __range variables', () => {
            ...
            // Interpolated expr
            expect(templateSrvMock.replace).toHaveBeenCalledWith('rate({job="grafana"}[$__range]) + rate({job="grafana"}[$__range_ms]) + rate({job="grafana"}[$__range_s])', expect.not.objectContaining({
                __range: { text: '1m', value: '1m' },
                __range_ms: { text: '1000', value: '1000' },
                __range_s: { text: '60', value: '60' },
            }), expect.any(Function));
...
describe('makeStatsRequest', () => {
    ...
    it('should support queries with variables', () => {
        ...
        datasource.interpolateString = jest
            .fn()
            .mockImplementationOnce((value) => value.replace('$__interval', '1h'));
        datasource.getQueryStats = jest
            .fn()
            .mockResolvedValue({ streams: 1, chunks: 12611, bytes: 12913664, entries: 78344 });
        expect(datasource.getStats(query)).resolves.toEqual({
...
function assertAdHocFilters(query, expectedResults, ds) {
    const lokiQuery = { refId: 'A', expr: query };
...
function makeAnnotationQueryRequest(options = {}) {
    ...
    return {
        annotation: Object.assign({ expr: '{test=test}', refId: '', datasource: {
                type: 'loki',
            }, enable: true, name: 'test-annotation', iconColor: 'red' }, options),
        dashboard: {
            id: 1,
        },
        range: Object.assign(Object.assign({}, timeRange), { raw: timeRange }),
        rangeRaw: timeRange,
    };
}
