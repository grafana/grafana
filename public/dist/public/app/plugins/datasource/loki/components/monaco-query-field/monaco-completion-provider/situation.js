import { parser, VectorAggregationExpr, String, Selector, RangeAggregationExpr, Range, PipelineExpr, PipelineStage, Matchers, Matcher, LogQL, LogRangeExpr, LogExpr, Logfmt, Identifier, Grouping, Expr, LiteralExpr, MetricExpr, UnwrapExpr, DropLabelsExpr, KeepLabelsExpr, DropLabels, KeepLabels, ParserFlag, LabelExtractionExpression, LabelExtractionExpressionList, LogfmtExpressionParser, } from '@grafana/lezer-logql';
...
function getLabelOp(opNode) {
    var _a;
    return (_a = LABEL_OP_MAP.get(opNode.name)) !== null && _a !== void 0 ? _a : null;
}
...
function getLabels(selectorNode, text) {
    ...
    if (((_a = selectorNode === null || selectorNode === void 0 ? void 0 : selectorNode.parent) === null || _a === void 0 ? void 0 : _a.type.id) === Selector) {
        ...
        listNode =
            ...
            (_c = (_b = traverse(selectorNode, [['parent', Matchers]])) !== null && _b !== void 0 ? _b : 
            // Node after all other labels
            walk(selectorNode, [['firstChild', Matchers]])) !== null && _c !== void 0 ? _c : 
...
function resolvePipeError(node, text, pos) {
    ...
    if (((_a = exprNode === null || exprNode === void 0 ? void 0 : exprNode.parent) === null || _a === void 0 ? void 0 : _a.type.id) === LogExpr || ((_b = exprNode === null || exprNode === void 0 ? void 0 : exprNode.parent) === null || _b === void 0 ? void 0 : _b.type.id) === LogRangeExpr) {
...
function resolveLogfmtParser(_, text, cursorPosition) {
    ...
    const otherLabels = labelNodes
        .map((label) => label.getChild(Identifier))
        .filter((label) => label !== null)
        .map((label) => getNodeText(label, text));
...
function resolveSelector(node, text, pos) {
    ...
    const selectorNode = node.type.id === ERROR_NODE_ID
        ? walk(node, [
            ['parent', Matchers],
            ['parent', Selector],
        ])
...
function resolveAfterKeepAndDrop(node, text, pos) {
    ...
    if ((keepAndDropParent === null || keepAndDropParent === void 0 ? void 0 : keepAndDropParent.type.id) === PipelineStage) {
