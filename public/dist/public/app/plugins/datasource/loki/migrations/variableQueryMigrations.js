...
export function migrateVariableQuery(rawQuery) {
    ...
    if (labelNames) {
        return Object.assign(Object.assign({}, queryBase), { type: LokiVariableQueryType.LabelNames });
    }
    const labelValues = rawQuery.match(labelValuesRegex);
    if (labelValues) {
        return Object.assign(Object.assign({}, queryBase), { type: LokiVariableQueryType.LabelValues, label: labelValues[2] ? labelValues[2] : labelValues[1], stream: labelValues[2] ? labelValues[1] : undefined });
    }
    return queryBase;
}
