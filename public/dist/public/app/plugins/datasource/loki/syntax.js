...
export var RANGE_VEC_FUNCTIONS = [
    {
...
export var FUNCTIONS = __spreadArray(__spreadArray([], __read(AGGREGATION_OPERATORS), false), __read(RANGE_VEC_FUNCTIONS), false);
var tokenizer = {
    comment: {
        pattern: /#.*/,
    },
    ...
    'context-pipe': {
        ...
        inside: {
            ...
            'pipe-operations': {
                pattern: new RegExp("" + __spreadArray(__spreadArray([], __read(PIPE_PARSERS), false), __read(PIPE_OPERATORS), false).map(function (f) { return f.label; }).join('|'), 'i'),
                alias: 'keyword',
            },
        },
    },
