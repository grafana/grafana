import { And, BinOpExpr, Bool, By, ConvOp, Decolorize, DropLabel, DropLabels, DropLabelsExpr, Filter, FilterOp, Grouping, GroupingLabelList, GroupingLabels, Identifier, Ip, IpLabelFilter, Json, JsonExpressionParser, KeepLabel, KeepLabels, KeepLabelsExpr, LabelExtractionExpression, LabelFilter, LabelFormatMatcher, LabelParser, LineFilter, LineFormatExpr, LogfmtExpressionParser, LogfmtParser, LogRangeExpr, Matcher, MetricExpr, Number as NumberLezer, On, Or, parser, ParserFlag, Range, RangeAggregationExpr, RangeOp, String, UnitFilter, Unwrap, UnwrapExpr, VectorAggregationExpr, VectorOp, Without, BinOpModifier, OnOrIgnoringModifier, } from '@grafana/lezer-logql';
import { ErrorId, getAllByType, getLeftMostChild, getString, makeBinOp, makeError, replaceVariables, } from '../../prometheus/querybuilder/shared/parsingUtils';
...
function getLabel(expr, node) {
    ...
    const op = getString(expr, labelNode === null || labelNode === void 0 ? void 0 : labelNode.nextSibling);
...
function getLineFilter(expr, node) {
    ...
    const ipLineFilter = (_a = node.getChild(FilterOp)) === null || _a === void 0 ? void 0 : _a.getChild(Ip);
    if (ipLineFilter) {
        return {
            operation: {
...
function getLabelParser(expr, node) {
    ...
    if (opDef && !checkParamsAreValid(opDef, params)) {
        params = (opDef === null || opDef === void 0 ? void 0 : opDef.defaultParams) || [];
    }
    return {
        id: parser,
        params,
...
function getLabelFilter(expr, node) {
    ...
    if (node.firstChild.type.id === IpLabelFilter) {
        ...
        const label = ipLabelFilter === null || ipLabelFilter === void 0 ? void 0 : ipLabelFilter.getChild(Identifier);
        const op = label === null || label === void 0 ? void 0 : label.nextSibling;
        const value = ipLabelFilter === null || ipLabelFilter === void 0 ? void 0 : ipLabelFilter.getChild(String);
...
function handleUnwrapExpr(expr, node, context) {
    ...
    if (unwrapChild) {
        if (((_a = unwrapChild.nextSibling) === null || _a === void 0 ? void 0 : _a.type.id) === ConvOp) {
...
function handleRangeAggregation(expr, node, context) {
    ...
    const range = logExpr === null || logExpr === void 0 ? void 0 : logExpr.getChild(Range);
...
function handleVectorAggregation(expr, node, context) {
    ...
    if (metricExpr) {
        ...
        if (((_a = metricExpr.firstChild) === null || _a === void 0 ? void 0 : _a.type.id) === BinOpExpr) {
            context.errors.push({
                text: 'Query parsing is ambiguous.',
                from: metricExpr.firstChild.from,
                to: (_b = metricExpr.firstChild) === null || _b === void 0 ? void 0 : _b.to,
            });
        }
...
function handleBinary(expr, node, context) {
    ...
    if (rightNumber) {
        visQuery.operations.push(makeBinOp(opDef, expr, right, !!(binModifier === null || binModifier === void 0 ? void 0 : binModifier.isBool)));
    }
    else if (rightBinary) {
        // Due to the way binary ops are parsed we can get a binary operation on the right that starts with a number which
        // is a factor for a current binary operation. So we have to add it as an operation now.
        const leftMostChild = getLeftMostChild(right);
        if ((leftMostChild === null || leftMostChild === void 0 ? void 0 : leftMostChild.type.id) === NumberLezer) {
            visQuery.operations.push(makeBinOp(opDef, expr, leftMostChild, !!(binModifier === null || binModifier === void 0 ? void 0 : binModifier.isBool)));
        }
        ...
        if (binModifier === null || binModifier === void 0 ? void 0 : binModifier.isMatcher) {
...
function getBinaryModifier(expr, node) {
    ...
    if (!matcher && boolMatcher) {
        ...
        const labels = getString(expr, (_a = matcher.getChild(GroupingLabels)) === null || _a === void 0 ? void 0 : _a.getChild(GroupingLabelList));
        return {
            isMatcher: true,
            isBool: !!boolMatcher,
            matches: labels,
...
function isIntervalVariableError(node) {
    var _a;
    return ((_a = node === null || node === void 0 ? void 0 : node.parent) === null || _a === void 0 ? void 0 : _a.type.id) === Range;
}
export function handleQuotes(string) {
...
function handleDropFilter(expr, node, context) {
    ...
    while (exploringNode) {
        ...
        exploringNode = exploringNode === null || exploringNode === void 0 ? void 0 : exploringNode.getChild(DropLabels);
    }
    labels.reverse();
    return {
...
function handleKeepFilter(expr, node, context) {
    ...
    while (exploringNode) {
        ...
        exploringNode = exploringNode === null || exploringNode === void 0 ? void 0 : exploringNode.getChild(KeepLabels);
    }
    labels.reverse();
    return {
