...
describe('buildVisualQueryFromString', () => {
    it('creates no errors for empty query', () => {
        expect(buildVisualQueryFromString('')).toEqual(noErrors({
            labels: [],
            operations: [],
        }));
    });
    ...
    it('parses binary operation with query', () => {
        ...
        buildVisualQueryFromString('max by(stream) (count_over_time({app="aggregator"}[1m])) > bool ignoring(stream) avg(count_over_time({app="aggregator"}[1m]))')).toEqual({
            query: {
                binaryQueries: [
                    {
    ...
    it('parses simple query with label-values', () => {
        expect(buildVisualQueryFromString('{app="frontend"}')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with multiple label-values pairs', () => {
        expect(buildVisualQueryFromString('{app="frontend", instance!="1"}')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with line filter', () => {
        expect(buildVisualQueryFromString('{app="frontend"} |= "line"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with label filter and escaped quote', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | bar="\\"baz"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('returns error for query with ip matching line filter', () => {
        ...
        expect(context).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('returns error when parsing ambiguous query', () => {
        ...
        const context = buildVisualQueryFromString('topk(5,count_over_time({app="aggregator"}[1m])/count_over_time({cluster="dev-eu-west-2"}[1m]))');
    ...
    it('parses query with number label filter', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | bar >= 8')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with no pipe errors filter', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | __error__=""')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with unit label filter', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | bar < 8m')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with parser', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | json')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with simple unwrap', () => {
        expect(buildVisualQueryFromString('sum_over_time({app="frontend"} | logfmt | unwrap bytes_processed [1m])')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with unwrap and error filter', () => {
        expect(buildVisualQueryFromString('sum_over_time({app="frontend"} | logfmt | unwrap duration | __error__="" [1m])')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with unwrap and label filter', () => {
        expect(buildVisualQueryFromString('sum_over_time({app="frontend"} | logfmt | unwrap duration | label="value" [1m])')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with unwrap and conversion function', () => {
        const context = buildVisualQueryFromString('sum_over_time({app="frontend"} | logfmt | unwrap duration(label) [5m])');
        expect(context).toEqual(noErrors({
            labels: [
                {
                    op: '=',
    ...
    it('parses query with with only decolorize', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | decolorize')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with with decolorize and other operations', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | logfmt | decolorize | __error__=""')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with function', () => {
        expect(buildVisualQueryFromString('rate({app="frontend"} | json [5m])')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with function and aggregation', () => {
        expect(buildVisualQueryFromString('sum(rate({app="frontend"} | json [5m]))')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with function and aggregation with grouping', () => {
        expect(buildVisualQueryFromString('sum by (job,name) (rate({app="frontend"} | json [5m]))')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with function and aggregation with grouping at the end', () => {
        ...
        expect(buildVisualQueryFromString(expression)).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with function and aggregation and filters', () => {
        expect(buildVisualQueryFromString('sum(rate({app="frontend"} |~ `abc` | json | bar="baz" [5m]))')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses metrics query with vector aggregation with number', () => {
        expect(buildVisualQueryFromString('topk(10, sum(count_over_time({app="frontend"} | logfmt | __error__=`` [5m])))')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses template variables in strings', () => {
        expect(buildVisualQueryFromString('{instance="$label_variable"}')).toEqual(noErrors({
            labels: [{ label: 'instance', op: '=', value: '$label_variable' }],
            operations: [],
        }));
    });
    it('parses metrics query with interval variables', () => {
        expect(buildVisualQueryFromString('rate({app="frontend"} [$__interval])')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses quantile queries', () => {
        expect(buildVisualQueryFromString(`quantile_over_time(0.99, {app="frontend"} [1m])`)).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with line format', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | line_format "abc"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with label format', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | label_format renameTo=original')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses binary query', () => {
        expect(buildVisualQueryFromString('rate({project="bar"}[5m]) / rate({project="foo"}[5m])')).toEqual(noErrors({
    ...
    it('parses binary scalar query', () => {
        expect(buildVisualQueryFromString('rate({project="bar"}[5m]) / 2')).toEqual(noErrors({
            labels: [{ op: '=', value: 'bar', label: 'project' }],
            operations: [
                { id: LokiOperationId.Rate, params: ['5m'] },
    ...
    it('parses a regexp with empty string param', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | regexp "" ')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a pattern with empty string param', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | pattern "" ')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it.each(['$__interval', '5m'])('parses query range with unwrap and regex', (range) => {
        expect(buildVisualQueryFromString('avg_over_time({test="value"} |= `restart counter is at` | regexp `restart counter is at (?P<restart_counter>[0-9]+)s*.*.*?$` | unwrap restart_counter [' +
            range +
            '])')).toEqual({
            errors: [],
            query: {
    ...
    it('parses a log query with drop and no labels', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | drop')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a log query with drop and labels', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | drop id, email')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a log query with drop, labels and expressions', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | drop id, email, test="test1"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a log query with keep and no labels', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | keep')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a log query with keep and labels', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | keep id, email')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses a log query with keep, labels and expressions', () => {
        expect(buildVisualQueryFromString('{app="frontend"} | keep id, email, test="test1"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'frontend',
    ...
    it('parses query with logfmt parser', () => {
        expect(buildVisualQueryFromString('{label="value"} | logfmt')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'value',
    ...
    it('parses query with logfmt parser and flags', () => {
        expect(buildVisualQueryFromString('{label="value"} | logfmt --keep-empty --strict')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'value',
    ...
    it('parses query with logfmt parser, flags, and labels', () => {
        expect(buildVisualQueryFromString('{label="value"} | logfmt --keep-empty --strict label1, label2, label3="label4"')).toEqual(noErrors({
            labels: [
                {
                    op: '=',
                    value: 'value',
