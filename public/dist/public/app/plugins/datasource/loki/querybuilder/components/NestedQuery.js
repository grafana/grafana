...
export const NestedQuery = React.memo(({ nestedQuery, index, datasource, onChange, onRemove, onRunQuery, showExplain }) => {
    ...
    return (React.createElement("div", { className: styles.card },
        React.createElement("div", { className: styles.header },
            ...
            React.createElement(Select, { "aria-label": "Select operator", width: "auto", options: operators, value: toOption(nestedQuery.operator), onChange: (value) => {
            ...
            React.createElement(IconButton, { name: "times", size: "sm", onClick: () => onRemove(index), tooltip: "Remove nested query" })),
        React.createElement("div", { className: styles.body },
            React.createElement(EditorRows, null,
                React.createElement(LokiQueryBuilder, { showExplain: showExplain, query: nestedQuery.query, datasource: datasource, onRunQuery: onRunQuery, onChange: (update) => {
