import { createAggregationOperation, createAggregationOperationWithParam, } from '../../prometheus/querybuilder/shared/operationUtils';
import { binaryScalarOperations } from './binaryScalarOperations';
import { UnwrapParamEditor } from './components/UnwrapParamEditor';
import { addLokiOperation, addNestedQueryHandler, createRangeOperation, createRangeOperationWithGrouping, getLineFilterRenderer, labelFilterRenderer, pipelineRenderer, } from './operationUtils';
...
export function getOperationDefinitions() {
    ...
    ].flatMap((opId) => createAggregationOperation(opId, {
...
[Read the docs](https://grafana.com/docs/loki/latest/logql/log_queries/#labels-format-expression) for more.
        ...
        },
        {
            ...
            explainHandler: (op) => {
                ...
                return `Use the extracted label \`${label}\` as sample values instead of log lines for the subsequent range aggregation.${op.params[1]
 ...
 */
export function explainOperator(id) {
    var _a;
    const definition = definitions.find((operation) => operation.id === id);
    const explain = ((_a = definition === null || definition === void 0 ? void 0 : definition.explainHandler) === null || _a === void 0 ? void 0 : _a.call(definition, { id: '', params: ['<value>'] })) || '';
...
export function checkParamsAreValid(def, params) {
