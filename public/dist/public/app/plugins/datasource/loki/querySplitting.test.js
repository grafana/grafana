...
describe('runSplitQuery()', () => {
    ...
    test('Splits datasource queries', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(runSplitQuery(datasource, request)).toEmitValuesWith(() => {
            // 3 days, 3 chunks, 3 requests.
            expect(datasource.runQuery).toHaveBeenCalledTimes(3);
        });
    }));
    test('Correctly splits queries without step', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(runSplitQuery(datasource, request)).toEmitValuesWith(() => {
            expect(datasource.runQuery).toHaveBeenNthCalledWith(1, expect.objectContaining({
                requestId: 'TEST_3',
                intervalMs: 60000,
            ...
            expect(datasource.runQuery).toHaveBeenNthCalledWith(2, expect.objectContaining({
                requestId: 'TEST_2',
                intervalMs: 60000,
                range: expect.objectContaining({
                    from: expect.objectContaining({
            ...
            expect(datasource.runQuery).toHaveBeenNthCalledWith(3, expect.objectContaining({
                requestId: 'TEST_1',
                intervalMs: 60000,
                range: expect.objectContaining({
                    from: expect.objectContaining({
    ...
    test('Correctly splits queries with step', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('Handles and reports errors', () => __awaiter(void 0, void 0, void 0, function* () {
        jest
            .spyOn(datasource, 'runQuery')
            .mockReturnValue(of({ state: LoadingState.Error, error: { refId: 'A', message: 'Error' }, data: [] }));
        yield expect(runSplitQuery(datasource, request)).toEmitValuesWith((values) => {
            expect(values).toHaveLength(1);
            expect(values[0]).toEqual(expect.objectContaining({ error: { refId: 'A', message: 'Error' }, state: LoadingState.Streaming }));
        });
    }));
    describe('Hidden and empty queries', () => {
        ...
        test('Ignores hidden queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
            ...
            yield expect(runSplitQuery(datasource, request)).toEmitValuesWith(() => {
                ...
                expect(trackGroupedQueries).toHaveBeenCalledWith({
                    ...
                    {
                        partition: [],
                        request: Object.assign(Object.assign({}, request), { targets: request.targets.filter((query) => !query.hide) }),
                    },
                ], request, new Date(), { predefinedOperations: '' });
            });
        }));
        test('Ignores empty queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
            ...
            yield expect(runSplitQuery(datasource, request)).toEmitValuesWith(() => {
                ...
                expect(trackGroupedQueries).toHaveBeenCalledWith({
                    ...
                    {
                        partition: [],
                        request: Object.assign(Object.assign({}, request), { targets: request.targets.filter((query) => query.expr) }),
                    },
                ], request, new Date(), { predefinedOperations: '' });
            });
        }));
    ...
    describe('Dynamic maxLines for logs requests', () => {
        ...
        test('Stops requesting once maxLines of logs have been received', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(runSplitQuery(datasource, request)).toEmitValuesWith(() => {
                // 3 days, 3 chunks, 2 responses of 2 logs, 2 requests
                expect(datasource.runQuery).toHaveBeenCalledTimes(2);
            });
        }));
        test('Performs all the requests if maxLines has not been reached', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Performs all the requests if not a log query', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Splitting multiple targets', () => {
        ...
        test('Sends logs and metric queries individually', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A' },
        ...
        test('Groups metric queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: 'count_over_time({a="b"}[1m])', refId: 'A' },
        ...
        test('Groups logs queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A' },
                    { expr: '{c="d"}', refId: 'B' },
        ...
        test('Groups instant queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('Respects maxLines of logs queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const { logFrameA } = getMockFrames();
            const request = getQueryOptions({
                targets: [
        ...
        test('Groups multiple queries into logs, queries, instant', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: 'count_over_time({a="b"}[1m])', refId: 'A', queryType: LokiQueryType.Instant },
                    { expr: '{c="d"}', refId: 'B' },
    ...
    describe('Splitting targets based on splitDuration', () => {
        ...
        test('with 30m splitDuration runs 2 queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
        ...
        test('with 1h splitDuration runs 1 queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
        ...
        test('with 1h splitDuration and 2 targets runs 1 queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('with 1h/30m splitDuration and 2 targets runs 3 queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A', splitDuration: '1h' },
        ...
        test('with mixed splitDuration runs the expected amount of queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('with 1h/30m splitDuration and 1 log and 2 metric target runs 3 queries', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A', splitDuration: '1h' },
    ...
    describe('Splitting targets based on resolution', () => {
        ...
        test('Groups logs queries by resolution', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('Groups metric queries with no step by calculated stepMs', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('Groups metric queries with step by stepMs', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
        ...
        test('Groups mixed queries by stepMs', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A', resolution: 3 },
                    { expr: '{a="b"}', refId: 'B', resolution: 5 },
        ...
        test('Chunked groups mixed queries by stepMs', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = getQueryOptions({
                targets: [
                    { expr: '{a="b"}', refId: 'A', resolution: 3 },
                    { expr: '{a="b"}', refId: 'B', resolution: 5 },
...
//# sourceMappingURL=querySplitting.test.js.map