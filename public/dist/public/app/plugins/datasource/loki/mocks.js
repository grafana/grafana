...
import { DataFrameType, FieldType, PluginType, toUtc, } from '@grafana/data';
...
export function createLokiDatasource(templateSrvMock = defaultTemplateSrvMock, settings = {}, timeSrvStub = defaultTimeSrvMock) {
...
export function createMetadataRequest(labelsAndValues, series) {
    ...
    return function metadataRequestMock(url, params) {
