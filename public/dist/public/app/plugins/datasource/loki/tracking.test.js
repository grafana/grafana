...
const originalRequest = getQueryOptions({
    targets: [
        Object.assign({ expr: 'count_over_time({a="b"}[1m])', refId: 'A' }, baseTarget),
        Object.assign({ expr: '{a="b"}', refId: 'B', maxLines: 10 }, baseTarget),
        Object.assign(Object.assign({ expr: 'count_over_time({hidden="true"}[1m])', refId: 'C' }, baseTarget), { hide: true }),
    ],
    range,
    app: 'explore',
});
const requests = [
    {
        request: Object.assign(Object.assign({}, getQueryOptions({
            targets: [Object.assign({ expr: 'count_over_time({a="b"}[1m])', refId: 'A' }, baseTarget)],
            range,
        })), { app: 'explore' }),
    ...
    {
        request: Object.assign(Object.assign({}, getQueryOptions({
            targets: [Object.assign({ expr: '{a="b"}', refId: 'B', maxLines: 10 }, baseTarget)],
            range,
        })), { app: 'explore' }),
...
test('Tracks queries', () => {
    ...
    expect(reportInteraction).toHaveBeenCalledWith('grafana_loki_query_executed', {
        ...
        parsed_query: 'LogQL,Expr,MetricExpr,RangeAggregationExpr,RangeOp,CountOverTime,LogRangeExpr,Selector,Matchers,Matcher,Identifier,Eq,String,Range,Duration',
        query_type: 'metric',
