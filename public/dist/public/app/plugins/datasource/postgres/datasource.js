...
var PostgresDatasource = /** @class */ (function (_super) {
    __extends(PostgresDatasource, _super);
    function PostgresDatasource(instanceSettings, templateSrv, timeSrv) {
        ...
        _this.queryModel = new PostgresQueryModel({});
    ...
    PostgresDatasource.prototype.filterQuery = function (query) {
        return !query.hide;
    };
    PostgresDatasource.prototype.applyTemplateVariables = function (target, scopedVars) {
        var queryModel = new PostgresQueryModel(target, this.templateSrv, scopedVars);
        return {
            refId: target.refId,
    ...
    PostgresDatasource.prototype.targetContainsTemplate = function (target) {
        ...
        if (target.rawQuery) {
            ...
            var query = new PostgresQueryModel(target);
