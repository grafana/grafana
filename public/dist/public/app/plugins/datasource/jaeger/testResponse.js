...
function toVectors(fields) {
    return fields.map(function (f) { return (__assign(__assign({}, f), { values: new ArrayVector(f.values) })); });
}
export var testResponseDataFrameFields = toVectors([
...
export var testResponseNodesFields = toNodesFrame([
...
export var testResponseEdgesFields = toEdgesFrame([
    ['3fa414edcef6ad90--0f5c1808567e4403'],
    ['0f5c1808567e4403'],
    ['3fa414edcef6ad90'],
]);
export function toNodesFrame(values) {
    return toVectors([
...
export function toEdgesFrame(values) {
    return toVectors([
        { name: 'id', values: values[0] },
