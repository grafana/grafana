import { cacheFieldDisplayNames, createDataFrame, FieldType, } from '@grafana/data';
...
describe('Prometheus Result Transformer', () => {
    ...
    describe('transformV2', () => {
        ...
        it('results with table format should be transformed to table dataFrames', () => {
            ...
            expect((_a = series.data[0].meta) === null || _a === void 0 ? void 0 : _a.preferredVisualisationType).toEqual('rawPrometheus');
        });
        ...
        it('results with table and time_series format should be correctly transformed', () => {
            ...
            expect((_b = series.data[1].meta) === null || _b === void 0 ? void 0 : _b.preferredVisualisationType).toEqual('rawPrometheus');
        });
        ...
        it('should not add a link with an error when exemplarTraceIdDestinations is not configured properly', () => {
            ...
            expect((_a = traceField.config.links) === null || _a === void 0 ? void 0 : _a.length).toBe(0);
        });
    });
    describe('transformDFToTable', () => {
        ...
        it('transforms dataframes with metadata resolving from their refIds', () => {
            ...
            expect((_a = transformedTableDataFrames[0].meta) === null || _a === void 0 ? void 0 : _a.executedQueryString).toEqual(executedQueryForRefA);
            expect((_b = transformedTableDataFrames[1].meta) === null || _b === void 0 ? void 0 : _b.executedQueryString).toEqual(executedQueryForRefB);
        });
    });
    describe('transform', () => {
        ...
        describe('When nothing is returned', () => {
            it('should return empty array', () => {
                ...
                const series = transform({ data: response }, options);
                expect(series).toEqual([]);
            });
            it('should return empty array', () => {
                const response = {
                ...
                const result = transform({ data: response }, Object.assign(Object.assign({}, options), { target: { format: 'table' } }));
        ...
        describe('When resultFormat is table', () => {
            ...
            it('should return data frame', () => {
                const result = transform({ data: response }, Object.assign(Object.assign({}, options), { target: {
        ...
        describe('When instant = true', () => {
            ...
            it('should return data frame', () => {
                const result = transform({ data: response }, Object.assign(Object.assign({}, options), { query: { instant: true } }));
        ...
        describe('When resultFormat is heatmap', () => {
            ...
            it('should convert cumulative histogram to regular', () => {
                ...
                const result = transform({ data: response }, { query: options, target: options });
        ...
        describe('When the response is a matrix', () => {
            it('should have labels with the value field', () => {
                ...
                const result = transform({ data: response }, Object.assign({}, options));
            ...
            it('should transform into a data frame', () => {
                ...
                const result = transform({ data: response }, Object.assign(Object.assign({}, options), { query: {
                        start: 0,
                        end: 2,
                    } }));
            ...
            it('should fill null values', () => {
                const result = transform({ data: matrixResponse }, Object.assign(Object.assign({}, options), { query: { step: 1, start: 0, end: 2 } }));
                expect(result[0].fields[0].values).toEqual([0, 1000, 2000]);
                expect(result[0].fields[1].values).toEqual([null, 10, 0]);
            });
            it('should use __name__ label as series name', () => {
                const result = transform({ data: matrixResponse }, Object.assign(Object.assign({}, options), { query: {
                        step: 1,
                        start: 0,
                        end: 2,
                    } }));
            ...
            it('should not set displayName for ValueFields', () => {
                const result = transform({ data: matrixResponse }, options);
            ...
            it('should align null values with step', () => {
                ...
                const result = transform({ data: response }, Object.assign(Object.assign({}, options), { query: { step: 2, start: 0, end: 8 } }));
        ...
        describe('When the response is exemplar data', () => {
            it('should return as an data frame with a dataTopic annotations', () => {
                var _a;
                const result = transform({ data: exemplarsResponse }, options);
            ...
            describe('data link', () => {
                it('should be added to the field if found with url', () => {
                    const result = transform({ data: exemplarsResponse }, Object.assign(Object.assign({}, options), { exemplarTraceIdDestinations: [{ name: 'traceID', url: 'http://localhost' }] }));
                    expect(result[0].fields.some((f) => { var _a; return (_a = f.config.links) === null || _a === void 0 ? void 0 : _a.length; })).toBe(true);
                });
                it('should be added to the field if found with internal link', () => {
                    const result = transform({ data: exemplarsResponse }, Object.assign(Object.assign({}, options), { exemplarTraceIdDestinations: [{ name: 'traceID', datasourceUid: 'jaeger' }] }));
                    expect(result[0].fields.some((f) => { var _a; return (_a = f.config.links) === null || _a === void 0 ? void 0 : _a.length; })).toBe(true);
                });
                it('should not add link if exemplarTraceIdDestinations is not configured', () => {
                    const result = transform({ data: exemplarsResponse }, options);
                    expect(result[0].fields.some((f) => { var _a; return (_a = f.config.links) === null || _a === void 0 ? void 0 : _a.length; })).toBe(false);
                });
                it('should not add a datalink with an error when exemplarTraceIdDestinations is not configured', () => {
                    ...
                    const result = transform({ data: exemplarsResponse }, testOptions);
