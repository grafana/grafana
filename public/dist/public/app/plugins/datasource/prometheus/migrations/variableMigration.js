...
export function migrateVariableQueryToEditor(rawQuery) {
    ...
    if (labelNamesMatchQuery) {
        return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.LabelNames, match: labelNamesMatchQuery[1] });
    }
    const labelNames = rawQuery.match(PrometheusLabelNamesRegex);
    if (labelNames) {
        return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.LabelNames });
    }
    ...
    if (labelValuesCheck) {
        ...
        if (metric) {
            ...
            return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.LabelValues, label, metric: visQuery.query.metric, labelFilters: visQuery.query.labels });
        }
        else {
            return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.LabelValues, label });
        }
    }
    ...
    if (metricNamesCheck) {
        ...
        return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.MetricNames, metric });
    }
    ...
    if (queryResultCheck) {
        ...
        return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.VarQueryResult, varQuery });
    }
    // seriesQuery does not have a function and no regex above
    if (!labelNames && !labelValuesCheck && !metricNamesCheck && !queryResultCheck) {
        return Object.assign(Object.assign({}, queryBase), { qryType: QueryType.SeriesQuery, seriesQuery: rawQuery });
    }
    return queryBase;
}
// migrate it back to a string with the correct varialbes in place
export function migrateVariableEditorBackToVariableSupport(QueryVariable) {
    var _a, _b, _c;
    switch (QueryVariable.qryType) {
        ...
        case QueryType.LabelValues:
            if (QueryVariable.metric || (QueryVariable.labelFilters && QueryVariable.labelFilters.length !== 0)) {
                const visualQueryQuery = {
                    ...
                    labels: (_a = QueryVariable.labelFilters) !== null && _a !== void 0 ? _a : [],
                    operations: [],
                };
        ...
        case QueryType.SeriesQuery:
            return (_b = QueryVariable.seriesQuery) !== null && _b !== void 0 ? _b : '';
        case QueryType.ClassicQuery:
            return (_c = QueryVariable.classicQuery) !== null && _c !== void 0 ? _c : '';
    }
    return '';
}
