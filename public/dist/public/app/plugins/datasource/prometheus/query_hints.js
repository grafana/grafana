...
export function getQueryHints(query, series, datasource) {
    ...
    if (query.indexOf('rate(') === -1 && query.indexOf('increase(') === -1) {
        ...
        const metricsMetadata = (_a = datasource === null || datasource === void 0 ? void 0 : datasource.languageProvider) === null || _a === void 0 ? void 0 : _a.metricsMetadata;
        let certain = false;
        if (metricsMetadata) {
            ...
            counterNameMetric =
                (_b = queryTokens.find((metricName) => {
    ...
    if (datasource && datasource.ruleMappings) {
        ...
        const mappingForQuery = Object.keys(mapping).reduce((acc, ruleName) => {
            if (query.search(ruleName) > -1) {
                return Object.assign(Object.assign({}, acc), { [ruleName]: mapping[ruleName] });
            }
            return acc;
        }, {});
