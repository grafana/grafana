...
export function createFunction(definition) {
    ...
    return Object.assign(Object.assign({}, definition), { id: definition.id, name: (_a = definition.name) !== null && _a !== void 0 ? _a : getPromAndLokiOperationDisplayName(definition.id), params: (_b = definition.params) !== null && _b !== void 0 ? _b : [], defaultParams: (_c = definition.defaultParams) !== null && _c !== void 0 ? _c : [], category: (_d = definition.category) !== null && _d !== void 0 ? _d : PromVisualQueryOperationCategory.Functions, renderer: (_e = definition.renderer) !== null && _e !== void 0 ? _e : (definition.params ? functionRendererRight : functionRendererLeft), addOperationHandler: (_f = definition.addOperationHandler) !== null && _f !== void 0 ? _f : defaultAddOperationHandler });
}
...
export function addOperationWithRangeVector(def, query, modeller) {
    ...
    if (query.operations.length > 0) {
        ...
        if (firstOp.addOperationHandler === addOperationWithRangeVector) {
            return Object.assign(Object.assign({}, query), { operations: [newOperation, ...query.operations.slice(1)] });
        }
    }
    return Object.assign(Object.assign({}, query), { operations: [newOperation, ...query.operations] });
}
