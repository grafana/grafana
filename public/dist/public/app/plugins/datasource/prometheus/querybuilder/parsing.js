import { AggregateExpr, AggregateModifier, AggregateOp, BinaryExpr, BinModifiers, Expr, FunctionCall, FunctionCallArgs, FunctionCallBody, FunctionIdentifier, GroupingLabel, GroupingLabelList, GroupingLabels, LabelMatcher, LabelName, MatchOp, MetricIdentifier, NumberLiteral, On, OnOrIgnoring, ParenExpr, parser, StringLiteral, VectorSelector, Without, } from '@prometheus-io/lezer-promql';
import { binaryScalarOperatorToOperatorName } from './binaryScalarOperations';
import { ErrorId, getAllByType, getLeftMostChild, getString, makeBinOp, makeError, replaceVariables, } from './shared/parsingUtils';
/**
...
function isIntervalVariableError(node) {
    var _a, _b, _c;
    return ((_a = node.prevSibling) === null || _a === void 0 ? void 0 : _a.type.id) === Expr && ((_c = (_b = node.prevSibling) === null || _b === void 0 ? void 0 : _b.firstChild) === null || _c === void 0 ? void 0 : _c.type.id) === VectorSelector;
}
...
function handleAggregation(expr, node, context) {
    ...
    const body = node.getChild(FunctionCallBody);
    const callArgs = body.getChild(FunctionCallArgs);
    const callArgsExprChild = callArgs === null || callArgs === void 0 ? void 0 : callArgs.getChild(Expr);
    const binaryExpressionWithinAggregationArgs = callArgsExprChild === null || callArgsExprChild === void 0 ? void 0 : callArgsExprChild.getChild(BinaryExpr);
    ...
    switch (node.type.id) {
        ...
        case FunctionCallArgs: {
            ...
            while (child) {
                ...
                const binaryExpressionWithinFunctionArgs = callArgsExprChild === null || callArgsExprChild === void 0 ? void 0 : callArgsExprChild.getChild(BinaryExpr);
...
function handleBinary(expr, node, context) {
    ...
    if (rightNumber) {
        ...
        if ((leftMostChild === null || leftMostChild === void 0 ? void 0 : leftMostChild.type.id) === NumberLiteral) {
