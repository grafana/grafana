...
const interpolateStringTest = (query) => {
    return query.expr;
};
const getPrometheusTargetSignature = (request, targ) => {
    var _a, _b;
    return `${interpolateStringTest(targ)}|${(_a = targ.interval) !== null && _a !== void 0 ? _a : request.interval}|${JSON.stringify((_b = request.rangeRaw) !== null && _b !== void 0 ? _b : '')}|${targ.exemplar}`;
};
const mockPromRequest = (request) => {
    // Histogram
    const defaultRequest = {
        ...
        timezone: '',
        range: {
            from: moment('2023-01-30T19:33:01.332Z'),
            to: moment('2023-01-30T20:33:01.332Z'),
    ...
    return Object.assign(Object.assign({}, defaultRequest), request);
};
const getPromProfileData = (request, targ) => {
    var _a;
    return {
        expr: targ.expr,
...
describe('QueryCache: Generic', function () {
    ...
    it('will not modify or crash with empty response', () => {
        ...
        const firstStoredFrames = storage.procFrames(mockPromRequest({
            range: firstRange,
        ...
        expect(cached === null || cached === void 0 ? void 0 : cached.frames[0].fields[0].values.length).toEqual((_c = (_b = (_a = firstFrames[0]) === null || _a === void 0 ? void 0 : _a.fields[0]) === null || _b === void 0 ? void 0 : _b.values) === null || _c === void 0 ? void 0 : _c.length);
        expect((_d = firstStoredFrames[0]) === null || _d === void 0 ? void 0 : _d.fields[0].values.length).toEqual((_g = (_f = (_e = firstFrames[0]) === null || _e === void 0 ? void 0 : _e.fields[0]) === null || _f === void 0 ? void 0 : _f.values) === null || _g === void 0 ? void 0 : _g.length);
        ...
        const secondStoredFrames = storage.procFrames(secondRequest, {
            requests: [],
            targSigs: cache,
            shouldCache: true,
        }, secondFrames);
        ...
        storageLengthAfterSubsequentQuery === null || storageLengthAfterSubsequentQuery === void 0 ? void 0 : storageLengthAfterSubsequentQuery.frames.forEach((dataFrame, index) => {
...
describe('QueryCache: Prometheus', function () {
    it('Merges incremental queries in storage', () => {
        ...
        scenarios.forEach((scenario, index) => {
            ...
            const firstFrames = scenario.first.dataFrames;
            const secondFrames = scenario.second.dataFrames;
            ...
            const firstStoredFrames = storage.procFrames(request, {
                requests: [],
            ...
            expect(cached === null || cached === void 0 ? void 0 : cached.frames[0].fields[0].values.length).toEqual(firstFrames[0].fields[0].values.length);
            // Should return the request frames unaltered
            expect(firstStoredFrames).toEqual(firstFrames);
            const secondRequest = mockPromRequest({
                range: secondRange,
            ...
            const secondRequestModified = Object.assign(Object.assign({}, secondRequest), { range: Object.assign(Object.assign({}, secondRequest.range), { to: dateTime(secondRequest.range.to.valueOf() + 30000) }) });
            ...
            expect(cacheRequest.requests[0].range.from.valueOf() - 21000000).toEqual(secondRequestModified.range.from.valueOf());
    ...
    it('Will evict old dataframes, and use stored data when user shortens query window', () => {
        ...
        const targetSignature = `1=1|${interval}|${JSON.stringify((_a = request.rangeRaw) !== null && _a !== void 0 ? _a : '')}`;
        cache.set(targetIdentity, targetSignature);
        ...
        const secondQueryResult = storage.procFrames(mockPromRequest({
            range: secondRange,
            dashboardUID: dashboardId,
            panelId: panelId,
        }), {
        ...
        storage.procFrames(mockPromRequest({
            range: thirdRange,
            dashboardUID: dashboardId,
            panelId: panelId,
        }), {
        ...
        const storageLengthAfterThirdQuery = cachedAfterThird === null || cachedAfterThird === void 0 ? void 0 : cachedAfterThird.frames[0].fields[0].values.length;
...
//# sourceMappingURL=QueryCache.test.js.map