 ...
 */
export const getMockTimeFrameArray = (length, start, step) => {
    let timeValues = [];
 ...
 * @param high
 */
export const getMockValueFrameArray = (length, values = 0) => {
        ...
        dataFrames: [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        labels: Object.assign(Object.assign({}, mockLabels), { le: '+Inf' }),
            ...
            },
            {
                ...
                meta: {
                    ...
                    executedQueryString: 'Expr: {__name__="cortex_request_duration_seconds_bucket", cluster="dev-us-central-0", container="aggregator", instance=~"aggregator-7:aggregator:http-metrics|aggregator-6:aggregator:http-metrics", job="mimir-dev-11/aggregator", le=~"\\\\+Inf|0.5", method="GET", namespace="mimir-dev-11", pod="aggregator-7"}\nStep: 30s',
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        typeInfo: { frame: 'float64' },
                        labels: Object.assign(Object.assign({}, mockLabels), { le: '0.5' }),
                ...
                dataFrames: [
                    {
                        ...
                        meta: {
                            type: 'heatmap-rows',
                            custom: { resultType: 'matrix' },
                            executedQueryString: 'Expr: sum by(le) (rate(cortex_request_duration_seconds_bucket{cluster="dev-us-central-0", job="cortex-dev-01/cortex-gw-internal", namespace="cortex-dev-01"}[1m0s]))\nStep: 15s',
                        },
                        fields: [
                            {
                                name: 'Time',
...
//# sourceMappingURL=QueryCacheTestData.js.map