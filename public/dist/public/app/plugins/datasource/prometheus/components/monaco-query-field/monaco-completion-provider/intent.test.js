...
describe('intent', function () {
    ...
    it('handles label names', function () {
        assertIntent('something{^}', {
    ...
    it('handles label values', function () {
