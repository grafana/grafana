...
var PromCheatSheet = function (props) { return (React.createElement("div", null,
    React.createElement("h2", null, "PromQL Cheat Sheet"),
    CHEAT_SHEET_ITEMS.map(function (item, index) { return (React.createElement("div", { className: "cheat-sheet-item", key: index },
        React.createElement("div", { className: "cheat-sheet-item__title" }, item.title),
        item.expression ? (React.createElement("div", { className: "cheat-sheet-item__example", onClick: function (e) { return props.onClickExample({ refId: 'A', expr: item.expression }); } },
            React.createElement("code", null, item.expression))) : null,
