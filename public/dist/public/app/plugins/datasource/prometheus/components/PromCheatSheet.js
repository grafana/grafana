...
const PromCheatSheet = (props) => (React.createElement("div", null,
    React.createElement("h2", null, "PromQL Cheat Sheet"),
    CHEAT_SHEET_ITEMS.map((item, index) => (React.createElement("div", { className: "cheat-sheet-item", key: index },
        React.createElement("div", { className: "cheat-sheet-item__title" }, item.title),
        item.expression ? (React.createElement("button", { type: "button", className: "cheat-sheet-item__example", onClick: (e) => props.onClickExample({ refId: 'A', expr: item.expression }) },
