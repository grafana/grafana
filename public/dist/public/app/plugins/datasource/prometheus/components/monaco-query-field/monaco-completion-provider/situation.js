import { AggregateExpr, AggregateModifier, EqlRegex, EqlSingle, FunctionCallBody, GroupingLabels, Identifier, LabelMatcher, LabelMatchers, LabelMatchList, LabelName, MatchOp, MatrixSelector, MetricIdentifier, Neq, NeqRegex, parser, PromQL, StringLiteral, VectorSelector, } from '@prometheus-io/lezer-promql';
...
const ERROR_NODE_NAME = 0; // this is used as error-id
const RESOLVERS = [
    {
...
function getLabelOp(opNode) {
    ...
    return (_a = LABEL_OP_MAP.get(opChild.type.id)) !== null && _a !== void 0 ? _a : null;
}
