...
import { CoreApp, dateTime, getFieldDisplayName, LoadingState, toDataFrame, VariableHide, } from '@grafana/data';
...
describe('PrometheusDatasource', () => {
    ...
    describe('Query', () => {
        it('returns empty array when no queries', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(ds.query(createDataRequest([]))).toEmitValuesWith((response) => {
                expect(response[0].data).toEqual([]);
                expect(response[0].state).toBe(LoadingState.Done);
            });
        }));
        it('performs time series queries', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(ds.query(createDataRequest([{}]))).toEmitValuesWith((response) => {
                expect(response[0].data.length).not.toBe(0);
                expect(response[0].state).toBe(LoadingState.Done);
            });
        }));
        it('with 2 queries and used from Explore, sends results as they arrive', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(ds.query(createDataRequest([{}, {}], { app: CoreApp.Explore }))).toEmitValuesWith((response) => {
                expect(response[0].data.length).not.toBe(0);
                expect(response[0].state).toBe(LoadingState.Loading);
                expect(response[1].state).toBe(LoadingState.Done);
            });
        }));
        it('with 2 queries and used from Panel, waits for all to finish until sending Done status', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(ds.query(createDataRequest([{}, {}], { app: CoreApp.Dashboard }))).toEmitValuesWith((response) => {
                expect(response[0].data.length).not.toBe(0);
                expect(response[0].state).toBe(LoadingState.Done);
            });
        }));
        it('throws if using direct access', () => __awaiter(void 0, void 0, void 0, function* () {
            const instanceSettings = {
                url: 'proxied',
                directUrl: 'direct',
                user: 'test',
            ...
            yield expect(lastValueFrom(directDs.query(createDataRequest([{}, {}], { app: CoreApp.Dashboard })))).rejects.toMatchObject({ message: expect.stringMatching('Browser access') });
            ...
            yield expect(directDs.annotationQuery({
                range: Object.assign(Object.assign({}, range), { raw: range }),
                rangeRaw: range,
            ...
            yield directDs.getTagKeys({ filters: [] });
            // Language provider currently catches and just logs the error
            expect(errorMock).toHaveBeenCalledTimes(1);
            yield expect(directDs.getTagValues({ filters: [], key: 'A' })).rejects.toMatchObject({
                message: expect.stringMatching('Browser access'),
            });
        }));
    });
    ...
    describe('customQueryParams', () => {
        ...
        describe('with GET http method', () => {
            const promDs = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: { customQueryParameters: 'customQuery=123', httpMethod: 'GET' } }), templateSrvStub, timeSrvStub);
            ...
            it('adds params to exemplars query', () => {
                promDs.query(makeQuery(Object.assign(Object.assign({}, target), { exemplar: true })));
            ...
            it('adds params to instant query', () => {
                promDs.query(makeQuery(Object.assign(Object.assign({}, target), { instant: true })));
                expect(fetchMock.mock.calls.length).toBe(1);
                expect(fetchMock.mock.calls[0][0].url).toContain('&customQuery=123');
            });
        });
        describe('with POST http method', () => {
            const promDs = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: { customQueryParameters: 'customQuery=123', httpMethod: 'POST' } }), templateSrvStub, timeSrvStub);
    ...
    describe('When using adhoc filters', () => {
        ...
        const target = { expr: DEFAULT_QUERY_EXPRESSION, refId: 'A' };
        it('should not modify expression with no filters', () => {
            const result = ds.createQuery(target, { interval: '15s' }, 0, 0);
        ...
        it('should add filters to expression', () => {
            ...
            const result = ds.createQuery(target, { interval: '15s', filters }, 0, 0);
    ...
    describe('When converting prometheus histogram to heatmap format', () => {
        ...
        it('should convert cumulative histogram to ordinary', () => __awaiter(void 0, void 0, void 0, function* () {
            const resultMock = [
                {
            ...
            yield expect(ds.query(query)).toEmitValuesWith((result) => {
        ...
        it('should sort series by label value', () => __awaiter(void 0, void 0, void 0, function* () {
            const resultMock = [
                {
            ...
            ds.performTimeSeriesQuery = jest.fn().mockReturnValue(of(responseMock));
            yield expect(ds.query(query)).toEmitValuesWith((result) => {
                const seriesLabels = result[0].data[0].fields.slice(1).map((field) => getFieldDisplayName(field));
    ...
    describe('Test query range snapping', () => {
        it('test default 1 minute quantization', () => {
            const dataSource = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: Object.assign(Object.assign({}, instanceSettings.jsonData), { cacheLevel: PrometheusCacheLevel.Low }) }), templateSrvStub, timeSrvStub);
        ...
        it('test 10 minute quantization', () => {
            const dataSource = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: Object.assign(Object.assign({}, instanceSettings.jsonData), { cacheLevel: PrometheusCacheLevel.Medium }) }), templateSrvStub, timeSrvStub);
            const quantizedRange = dataSource.getAdjustedInterval();
            expect(parseInt(quantizedRange.end, 10) - parseInt(quantizedRange.start, 10)).toBe(600);
        });
        it('test 60 minute quantization', () => {
            const dataSource = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: Object.assign(Object.assign({}, instanceSettings.jsonData), { cacheLevel: PrometheusCacheLevel.High }) }), templateSrvStub, timeSrvStub);
            const quantizedRange = dataSource.getAdjustedInterval();
            expect(parseInt(quantizedRange.end, 10) - parseInt(quantizedRange.start, 10)).toBe(3600);
        });
        it('test quantization turned off', () => {
            const dataSource = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: Object.assign(Object.assign({}, instanceSettings.jsonData), { cacheLevel: PrometheusCacheLevel.None }) }), templateSrvStub, timeSrvStub);
            const quantizedRange = dataSource.getAdjustedInterval();
            expect(parseInt(quantizedRange.end, 10) - parseInt(quantizedRange.start, 10)).toBe((toSeconds - fromSeconds) / 1000);
        });
    });
    describe('alignRange', () => {
    ...
    describe('applyTemplateVariables', () => {
        afterAll(() => {
            replaceMock.mockImplementation((a, ...rest) => a);
        });
        ...
        it('should add ad-hoc filters to expr', () => {
            replaceMock.mockImplementation((a) => a);
            const filters = [
                {
                    key: 'k1',
                    operator: '=',
        ...
        it('should add ad-hoc filters only to expr', () => {
            replaceMock.mockImplementation((a) => { var _a; return (_a = a === null || a === void 0 ? void 0 : a.replace('$A', '99')) !== null && _a !== void 0 ? _a : a; });
            const filters = [
                {
                    key: 'k1',
                    operator: '=',
        ...
        it('should add ad-hoc filters only to expr and expression has template variable as label value??', () => {
            ...
            replaceMock.mockImplementation((a) => { var _a; return (_a = a === null || a === void 0 ? void 0 : a.replace(searchPattern, '99')) !== null && _a !== void 0 ? _a : a; });
            const filters = [
                {
                    key: 'k1',
                    operator: '=',
    ...
    describe('metricFindQuery', () => {
        beforeEach(() => {
            const prometheusDatasource = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { jsonData: Object.assign(Object.assign({}, instanceSettings.jsonData), { cacheLevel: PrometheusCacheLevel.None }) }), templateSrvStub, timeSrvStubOld);
...
describe('PrometheusDatasource2', () => {
    ...
    describe('When querying prometheus with one target using query editor target spec', () => {
        describe('and query syntax is valid', () => {
            ...
            const urlExpected = `proxied/api/v1/query_range?query=${encodeURIComponent('test{job="testjob"}')}&start=60&end=180&step=60`;
    ...
    describe('When querying prometheus with one target and instant = true', () => {
        let results;
        const urlExpected = `/api/datasources/uid/ABCDEF/resources/api/v1/query?query=${encodeURIComponent('test{job="testjob"}')}&time=123`;
        const query = {
    ...
    describe('annotationQuery', () => {
        ...
        describe('handle result with empty fields', () => {
            it('should return empty results', () => __awaiter(void 0, void 0, void 0, function* () {
                fetchMock.mockImplementation(() => of(emptyResponse));
                yield ds.annotationQuery(options).then((data) => {
                    results = data;
                });
        ...
        describe('step parameter', () => {
            ...
            it('should use default step for short range if no interval is given', () => {
                const query = Object.assign(Object.assign({}, options), { range: {
                        from: time({ seconds: 63 }),
                        to: time({ seconds: 123 }),
                    } });
            ...
            it('should use default step for short range when annotation step is empty string', () => {
                const query = Object.assign(Object.assign({}, options), { annotation: Object.assign(Object.assign({}, options.annotation), { step: '' }), range: {
                        from: time({ seconds: 63 }),
                        to: time({ seconds: 123 }),
                    } });
                ds.annotationQuery(query);
            ...
            it('should use custom step for short range', () => {
                const annotation = Object.assign(Object.assign({}, options.annotation), { step: '10s' });
                const query = Object.assign(Object.assign({}, options), { annotation, range: {
                        from: time({ seconds: 63 }),
                        to: time({ seconds: 123 }),
                    } });
                ds.annotationQuery(query);
        ...
        describe('region annotations for sectors', () => {
            ...
            function runAnnotationQuery(data) {
            ...
            it('should handle gaps and inactive values', () => __awaiter(void 0, void 0, void 0, function* () {
                const results = yield runAnnotationQuery([
            ...
            it('should handle single region', () => __awaiter(void 0, void 0, void 0, function* () {
                const results = yield runAnnotationQuery([
                    [2 * 60000, 3 * 60000],
                    [1, 1],
                ]);
            ...
            it('should handle 0 active regions', () => __awaiter(void 0, void 0, void 0, function* () {
                const results = yield runAnnotationQuery([
            ...
            it('should handle single active value', () => __awaiter(void 0, void 0, void 0, function* () {
                const results = yield runAnnotationQuery([[2 * 60000], [1]]);
        ...
        describe('with template variables', () => {
            ...
            it('should interpolate variables in query expr', () => {
                const query = Object.assign(Object.assign({}, options), { annotation: Object.assign(Object.assign({}, options.annotation), { expr: '$variable' }), range: {
                        from: time({ seconds: 1 }),
                        to: time({ seconds: 2 }),
                    } });
    ...
    describe('The "step" query parameter', () => {
        ...
        it('should be min interval when greater than auto interval', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
        ...
        it('step should be fractional for sub second intervals', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [{ expr: 'test' }],
        ...
        it('should be auto interval when greater than min interval', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should result in querying fewer than 11000 data points', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 hour range
        ...
        it('should not apply min interval when interval * intervalFactor greater', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should apply min interval when interval * intervalFactor smaller', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should apply intervalFactor to auto interval when greater', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should not not be affected by the 11000 data points limit when large enough', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 1 week range
        ...
        it('should be determined by the 11000 data points limit when too small', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 1 week range
                range: { from: time({}), to: time({ hours: 7 * 24 }) },
                targets: [
            ...
            const urlExpected = 'proxied/api/v1/query_range?query=test' +
                '&start=' +
                adjusted.start +
                '&end=' +
                (adjusted.end + step) +
    ...
    describe('The __interval and __interval_ms template variables', () => {
        ...
        it('should be unchanged when auto interval is greater than min interval', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
            ...
            const urlExpected = 'proxied/api/v1/query_range?query=' +
        ...
        it('should be min interval when it is greater than auto interval', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should account for intervalFactor', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should be interval * intervalFactor when greater than min interval', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should be min interval when greater than interval * intervalFactor', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 6 minute range
                range: { from: time({ minutes: 1 }), to: time({ minutes: 7 }) },
                targets: [
        ...
        it('should be determined by the 11000 data points limit, accounting for intervalFactor', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = {
                // 1 week range
                range: { from: time({}), to: time({ hours: 7 * 24 }) },
                targets: [
    ...
    describe('The __range, __range_s and __range_ms variables', () => {
        ...
        it('should use overridden ranges, not dashboard ranges', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const urlExpected = `proxied/api/v1/query_range?query=${encodeURIComponent(query.targets[0].expr)}&start=0&end=3600&step=60`;
            replaceMock.mockImplementation((str) => str);
            fetchMock.mockImplementation(() => of(response));
            ds.query(query);
            const res = fetchMock.mock.calls[0][0];
    ...
    describe('The __rate_interval variable', () => {
        ...
        it('should fall back to a scrape interval of 15s if min step is set to 0, resulting in 4*15s = 60s', () => {
            ds.createQuery(Object.assign(Object.assign({}, target), { interval: '' }), { interval: '15s' }, 0, 300);
            expect(replaceMock.mock.calls[1][1]['__rate_interval'].value).toBe('60s');
        });
        it('should be 4 times the scrape interval if min step set to 1m and interval is 15s', () => {
            // For a 5m graph, $__interval is 15s
            ds.createQuery(Object.assign(Object.assign({}, target), { interval: '1m' }), { interval: '15s' }, 0, 300);
        ...
        it('should be interval + scrape interval if min step set to 1m and interval is 5m', () => {
            ...
            ds.createQuery(Object.assign(Object.assign({}, target), { interval: '1m' }), { interval: '5m' }, 0, 10080);
        ...
        it('should be interval + scrape interval if resolution is set to 1/2 and interval is 10m', () => {
            ...
            ds.createQuery(Object.assign(Object.assign({}, target), { intervalFactor: 2 }), { interval: '10m' }, 0, 10080);
        ...
        it('should be 4 times the scrape interval if resolution is set to 1/2 and interval is 15s', () => {
            // For a 5m graph, $__interval is 15s
            ds.createQuery(Object.assign(Object.assign({}, target), { intervalFactor: 2 }), { interval: '15s' }, 0, 300);
            expect(replaceMock.mock.calls[1][1]['__rate_interval'].value).toBe('60s');
        });
        it('should interpolate min step if set', () => {
            replaceMock.mockImplementation((_) => '15s');
            ds.createQuery(Object.assign(Object.assign({}, target), { interval: '$int' }), { interval: '15s' }, 0, 300);
...
describe('PrometheusDatasource for POST', () => {
    ...
    describe('When querying prometheus via check headers X-Dashboard-Id X-Panel-Id and X-Dashboard-UID', () => {
        const options = { panelId: 2, dashboardUID: 'WFlOM-jM1' };
        const httpOptions = {
            headers: {},
        };
        const instanceSettings = {
        ...
        it('with direct access tracing headers should not be added', () => {
            ...
            const mockDs = new PrometheusDatasource(Object.assign(Object.assign({}, instanceSettings), { url: 'http://127.0.0.1:8000' }), templateSrvStub, timeSrvStub);
...
function getPrepareTargetsContext({ targets, app, queryOptions, languageProvider, }) {
    const instanceSettings = {
        url: 'proxied',
        directUrl: 'direct',
        access: 'proxy',
    ...
    const end = 1;
    const panelId = '2';
    const options = Object.assign({ targets, interval: '1s', panelId,
        app }, queryOptions);
    ...
    describe('when run from Explore', () => {
        describe('when query type Both is selected', () => {
            ...
            it('then it should return both instant and time series related objects', () => {
                ...
                expect(activeTargets[0]).toEqual(Object.assign(Object.assign({}, target), { format: 'table', instant: true, valueWithRefId: true }));
                ...
                expect(activeTargets[1]).toEqual(Object.assign(Object.assign({}, target), { format: 'time_series', instant: false }));
            });
        });
        describe('when query type Instant is selected', () => {
            it('then it should target and modify its format to table', () => {
                ...
                expect(activeTargets[0]).toEqual(Object.assign(Object.assign({}, target), { format: 'table' }));
            });
        });
    });
    ...
    describe('when called with ADD_FILTER', () => {
        describe('and query has no labels', () => {
            it('then the correct label should be added', () => {
                const query = { refId: 'A', expr: 'go_goroutines' };
                const action = { options: { key: 'cluster', value: 'us-cluster' }, type: 'ADD_FILTER' };
                const instanceSettings = { jsonData: {} };
                const ds = new PrometheusDatasource(instanceSettings, templateSrvStub, timeSrvStub);
        ...
        describe('and query has labels', () => {
            it('then the correct label should be added', () => {
                const query = { refId: 'A', expr: 'go_goroutines{cluster="us-cluster"}' };
...
function createDataRequest(targets, overrides) {
    const defaults = {
        ...
        targets: targets.map((t) => {
            return Object.assign({ instant: false, start: dateTime().subtract(5, 'minutes'), end: dateTime(), expr: 'test' }, t);
        }),
        range: {
            from: dateTime(),
            to: dateTime(),
