...
import { AbstractLabelOperator, CoreApp, PluginType } from '@grafana/data';
...
describe('Pyroscope data source', () => {
    ...
    describe('importing queries', () => {
        it('keeps all labels and values', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('exporting queries', () => {
        it('keeps all labels and values', () => __awaiter(void 0, void 0, void 0, function* () {
            const queries = yield ds.exportToAbstractQueries([
                {
                    refId: 'A',
    ...
    describe('applyTemplateVariables', () => {
        ...
        templateSrv.replace = jest.fn((query) => {
        ...
        it('should update labelSelector if there are template variables', () => {
            ds = new PyroscopeDataSource(defaultSettings, templateSrv);
            const query = ds.applyTemplateVariables(defaultQuery({ labelSelector: `{$var="$var"}`, profileTypeId: '$var' }), {});
...
describe('normalizeQuery', () => {
    ...
    it('correctly normalizes the query when in explore', () => {
        // We need the type assertion here because the query types are inherently wrong in explore.
        const normalized = normalizeQuery({}, CoreApp.Explore);
        expect(normalized).toMatchObject({
            labelSelector: '{}',
            groupBy: [],
            queryType: 'both',
...
const defaultQuery = (query) => {
    return Object.assign({ refId: 'x', groupBy: [], labelSelector: '', profileTypeId: '', queryType: defaultPyroscopeQueryType }, query);
};
