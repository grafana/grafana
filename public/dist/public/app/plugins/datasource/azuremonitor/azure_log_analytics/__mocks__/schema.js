export default class FakeSchemaData {
        ...
        return {
            ...
            functions: [
                ...
                },
                {
                    ...
                    description: 'Returns the list of Recovery Sevices vaults in your Azure environment that are associated with the workspace',
                    ...
                    parameters: 'RangeStart:datetime = datetime(null), VaultSubscriptionList:string="*", ExcludeLegacyEvent:bool=True',
                    related: {
    ...
    static getLogAnalyticsFakeEngineSchema(tableOverride) {
        const database = {
            name: 'test',
            tables: tableOverride !== null && tableOverride !== void 0 ? tableOverride : [
                {
                    id: 't/Alert',
                    name: 'Alert',
                    timespanColumn: 'TimeGenerated',
