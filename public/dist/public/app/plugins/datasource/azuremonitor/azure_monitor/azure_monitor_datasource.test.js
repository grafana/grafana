...
describe('AzureMonitorDatasource', () => {
    ...
    describe('applyTemplateVariables', () => {
        ...
        it('should migrate resource URI template variable to resource object', () => {
            ...
            replace = (target) => {
                if (target === null || target === void 0 ? void 0 : target.includes('$resourceUri')) {
        ...
        it('expand template variables in resource groups and names', () => {
            ...
            replace = (target) => {
                if (target === null || target === void 0 ? void 0 : target.includes('$rg')) {
                    return 'rg1,rg2';
                }
                if (target === null || target === void 0 ? void 0 : target.includes('$rn')) {
                    return 'rn1,rn2';
                }
                return target || '';
            };
        ...
        it('expand template variables for a region', () => {
            const region = '$reg';
            replace = (target) => {
                if (target === null || target === void 0 ? void 0 : target.includes('$reg')) {
                    return 'eastus';
                }
                return target || '';
            };
        ...
        it('should migrate legacy properties before interpolation', () => {
            replace = (target) => {
                if (target === null || target === void 0 ? void 0 : target.includes('$resourcegroup')) {
                    return 'test-rg';
                }
                if (target === null || target === void 0 ? void 0 : target.includes('$resourcename')) {
                    return 'test-resource';
                }
                if (target === null || target === void 0 ? void 0 : target.includes('$metric')) {
                    return 'test-ns';
                }
                return target || '';
            };
    ...
    describe('When performing getMetricNamespaces', () => {
        ...
        beforeEach(() => {
            ctx.ds.azureMonitorDatasource.getResource = jest.fn().mockImplementation((path) => {
        ...
        it('should return list of Metric Namspaces', () => {
            return ctx.ds.azureMonitorDatasource
                .getMetricNamespaces({
                resourceUri: '/subscriptions/mock-subscription-id/resourceGroups/nodeapp/providers/microsoft.insights/components/resource1',
            }, true)
                .then((results) => {
    ...
    describe('When performing interpolateVariablesInQueries for azure_monitor_metrics', () => {
        ...
        it('should return a query with any template variables replaced', () => {
            ...
            query.azureMonitor = Object.assign(Object.assign({}, query.azureMonitor), azureMonitorQuery);
            const templatedQuery = ctx.ds.interpolateVariablesInQueries([query], {});
    ...
    describe('When performing getLocations', () => {
        ...
        beforeEach(() => {
            ctx.ds.azureMonitorDatasource.getResource = jest.fn().mockImplementation((path) => {
                const expectedPaths = [1, 2].map((sub) => `azuremonitor/subscriptions/mock-subscription-id-${sub}/locations?api-version=2020-01-01`);
        ...
        it('should return a locations map', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c;
            const result = yield ctx.ds.azureMonitorDatasource.getLocations(['mock-subscription-id-1']);
            expect(result.size).toBe(1);
            expect(result.has('northeurope')).toBe(true);
            expect((_a = result.get('northeurope')) === null || _a === void 0 ? void 0 : _a.name).toBe('northeurope');
            expect((_b = result.get('northeurope')) === null || _b === void 0 ? void 0 : _b.displayName).toBe('North Europe');
            expect((_c = result.get('northeurope')) === null || _c === void 0 ? void 0 : _c.supportsLogs).toBe(undefined);
        }));
        it('should return a locations map with locations deduped', () => __awaiter(void 0, void 0, void 0, function* () {
            var _d, _e, _f, _g, _h, _j;
            const result = yield ctx.ds.azureMonitorDatasource.getLocations([
                'mock-subscription-id-1',
                'mock-subscription-id-2',
            ]);
            expect(result.size).toBe(2);
            expect(result.has('northeurope')).toBe(true);
            expect((_d = result.get('northeurope')) === null || _d === void 0 ? void 0 : _d.name).toBe('northeurope');
            expect((_e = result.get('northeurope')) === null || _e === void 0 ? void 0 : _e.displayName).toBe('North Europe');
            expect((_f = result.get('northeurope')) === null || _f === void 0 ? void 0 : _f.supportsLogs).toBe(undefined);
            expect(result.has('eastus2')).toBe(true);
            expect((_g = result.get('eastus2')) === null || _g === void 0 ? void 0 : _g.name).toBe('eastus2');
            expect((_h = result.get('eastus2')) === null || _h === void 0 ? void 0 : _h.displayName).toBe('East US 2');
            expect((_j = result.get('eastus2')) === null || _j === void 0 ? void 0 : _j.supportsLogs).toBe(undefined);
        }));
    });
    describe('Legacy Azure Monitor Query Object data fetchers', () => {
        ...
        describe('When performing getResourceGroups', () => {
            ...
            it('should return list of Resource Groups', () => {
                return ctx.ds.getResourceGroups('subscriptionId').then((results) => {
                    expect(results.length).toEqual(2);
        ...
        describe('When performing getResourceNames', () => {
            ...
            describe('and there are no special cases', () => {
                ...
                beforeEach(() => {
                    ctx.ds.azureMonitorDatasource.getResource = jest.fn().mockImplementation((path) => {
                        ...
                        expect(path).toBe(`${basePath}/${resourceGroup}/resources?api-version=2021-04-01&$filter=resourceType eq '${metricNamespace}'${region ? ` and location eq '${region}'` : ''}`);
                        return Promise.resolve(response);
                    });
                });
                ...
                it('should return multiple resources from a template variable', () => {
                    replace = (target) => {
                        ...
                        return target === `$${multiVariable.id}` ? 'foo,bar' : target !== null && target !== void 0 ? target : '';
                    };
            ...
            describe('and the metric definition is blobServices', () => {
                ...
                it('should return list of Resource Names', () => {
                    ...
                    return ctx.ds
                        ...
                        expect(ctx.ds.azureMonitorDatasource.getResource).toHaveBeenCalledWith(`azuremonitor/subscriptions/${subscription}/resourceGroups/${resourceGroup}/resources?api-version=2021-04-01&$filter=resourceType eq '${validMetricNamespace}'`);
                    });
                });
            });
            describe('and there are several pages', () => {
                ...
                beforeEach(() => {
                    ...
                    // first page
                    fn.mockImplementationOnce((path) => {
            ...
            describe('without a resource group or a metric definition', () => {
                ...
                it('should return list of Resource Names', () => {
                    return ctx.ds.getResourceNames(subscription).then((results) => {
                        expect(results.length).toEqual(2);
                    });
                });
            });
