...
let replaceMock = jest.fn().mockImplementation((s) => s);
...
describe('AzureMonitorUrlBuilder', () => {
    ...
    describe('buildResourceUri', () => {
        it('builds a resource uri when the required properties are provided', () => {
            expect(UrlBuilder.buildResourceUri(templateSrv, {
                subscription: 'sub',
                resourceGroup: 'group',
        ...
        it('builds a resource uri correctly when the namespace includes a storage sub-resource', () => {
            expect(UrlBuilder.buildResourceUri(templateSrv, {
                ...
                resourceName: 'name',
            })).toEqual('/subscriptions/sub/resourceGroups/group/providers/Microsoft.Storage/storageAccounts/name/tableServices/default');
        });
    ...
    describe('when a resource uri is provided', () => {
        it('builds a getMetricNamesnamespace url', () => {
            ...
            expect(url).toBe('/subscriptions/sub/resource-uri/resource/providers/microsoft.insights/metricNamespaces?api-version=2017-05-01-preview&region=global');
        });
    });
    describe('when a resource uri and metric namespace is provided', () => {
        it('builds a getMetricNames url', () => {
            ...
            expect(url).toBe('/subscriptions/sub/resource-uri/resource/providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview');
        });
        it('handles a custom namespace', () => {
            ...
            expect(url).toBe('/subscriptions/sub/resource-uri/resource/providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview&metricnamespace=custom%2Fnamespace');
        });
    });
    describe('Legacy query object', () => {
        describe('when metric definition is Microsoft.NetApp/netAppAccounts/capacityPools/volumes', () => {
            it('should build the getMetricNamespaces url in the even longer format', () => {
                ...
                expect(url).toBe('/subscriptions/sub1/resourceGroups/rg/providers/Microsoft.NetApp/netAppAccounts/rn1/capacityPools/rn2/volumes/rn3/' +
        ...
        describe('when metric definition is Microsoft.Storage/storageAccounts/blobServices and the metricNamespace', () => {
            it('should build the getMetricNames url in the longer format', () => {
                ...
                expect(url).toBe('/subscriptions/sub1/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/rn1/blobServices/default/' +
                    'providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview');
            });
        });
        describe('when metric definition is Microsoft.Storage/storageAccounts/fileServices and the metricNamespace', () => {
            it('should build the getMetricNames url in the longer format', () => {
                ...
                expect(url).toBe('/subscriptions/sub1/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/rn1/fileServices/default/' +
                    'providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview');
            });
        });
        describe('when metric definition is Microsoft.Storage/storageAccounts/tableServices and the metricNamespace', () => {
            it('should build the getMetricNames url in the longer format', () => {
                ...
                expect(url).toBe('/subscriptions/sub1/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/rn1/tableServices/default/' +
                    'providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview');
            });
        });
        describe('when metric definition is Microsoft.Storage/storageAccounts/queueServices and the metricNamespace', () => {
            it('should build the getMetricNames url in the longer format', () => {
                ...
                expect(url).toBe('/subscriptions/sub1/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/rn1/queueServices/default/' +
                    'providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview');
            });
        });
        describe('when multiple resources are selected', () => {
            it('passes metricNamespace as query param', () => {
                const url = UrlBuilder.buildAzureMonitorGetMetricNamesUrl('', '2017-05-01-preview', {
                    resourceUri: '/subscriptions/sub/resource-uri/resource',
                    metricNamespace: 'Microsoft.Sql/servers',
                }, templateSrv, true, 'region');
                expect(url).toBe('/subscriptions/sub/resource-uri/resource/providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview&metricnamespace=Microsoft.Sql%2Fservers&region=region');
            });
        });
    });
});
