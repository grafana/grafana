...
describe('migrateStringQueriesToObjectQueries', () => {
    ...
    it('successfully converts all old string queries into formatted query objects', () => __awaiter(void 0, void 0, void 0, function* () {
        return expectedMigrations.map(({ input, output }) => __awaiter(void 0, void 0, void 0, function* () {
            const datasource = createMockDatasource({
                azureMonitorDatasource: {
                    defaultSubscriptionId: 'defaultSubscriptionId',
                },
            });
            const actual = yield migrateStringQueriesToObjectQueries(input, { datasource });
...
describe('migrateStringQueriesToObjectQueries', () => {
    ...
    it('successfully converts all old variable functions into formatted predefined queries', () => __awaiter(void 0, void 0, void 0, function* () {
        return expectedMigrations.map(({ input, output }) => __awaiter(void 0, void 0, void 0, function* () {
            const datasource = createMockDatasource({
                azureMonitorDatasource: {
                    defaultSubscriptionId: 'defaultSubscriptionId',
            ...
            const actual = yield migrateQuery(input, { datasource });
            expect(actual).toMatchObject(output);
        }));
    }));
});
//# sourceMappingURL=grafanaTemplateVariables.test.js.map