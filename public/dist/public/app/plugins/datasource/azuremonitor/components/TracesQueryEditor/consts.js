...
export const Tables = {
    ...
    traces: {
        label: 'Traces',
        description: 'Diagnostic logs emitted using TrackTrace and similar methods. Note: Traces are not visualised if the result format is set to Trace',
    },
};
...
export const availabilityResultsSchema = Object.assign(Object.assign({}, common), { location: 'Location', message: 'Message', size: 'Size' });
// Additional properties for dependencies
export const dependenciesSchema = Object.assign(Object.assign({}, common), { data: 'Data', resultCode: 'ResultCode', target: 'Target', type: 'DependencyType' });
...
export const pageViewsSchema = omit(Object.assign(Object.assign({}, common), { url: 'Url' }), ['success']);
...
export const exceptionsSchema = omit(Object.assign(Object.assign({}, common), { assembly: 'Assembly', details: 'Details', handledAt: 'HandledAt', innermostAssembly: 'InnermostAssembly', innermostMessage: 'InnermostMessage', innermostMethod: 'InnermostMethod', innermostType: 'InnermostType', message: 'Message', method: 'Method', outerAssembly: 'OuterAssembly', outerMessage: 'OuterMessage', outerMethod: 'OuterMethod', outerType: 'OuterType', problemId: 'ProblemId', severityLevel: 'SeverityLevel', type: 'ExceptionType' }), ['duration', 'id', 'name', 'performanceBucket', 'success']);
...
export const tableTags = Object.entries(tablesSchema).reduce((val, [k, v]) => (Object.assign(Object.assign({}, val), { [k]: Object.keys(omit(v, attributesOmit)).join(',') })), {});
