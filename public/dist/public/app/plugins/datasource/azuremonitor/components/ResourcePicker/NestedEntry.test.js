...
describe('NestedEntry', () => {
    it('should be selectable', () => {
        render(React.createElement(NestedEntry, Object.assign({}, defaultProps, { isSelectable: true })));
        const box = screen.getByRole('checkbox');
        expect(box).toBeInTheDocument();
    });
    it('should not be selectable', () => {
        render(React.createElement(NestedEntry, Object.assign({}, defaultProps)));
        const box = screen.queryByRole('checkbox');
        expect(box).not.toBeInTheDocument();
    });
});
//# sourceMappingURL=NestedEntry.test.js.map