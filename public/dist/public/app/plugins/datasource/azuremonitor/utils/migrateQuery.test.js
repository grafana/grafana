...
const azureMonitorQueryV9_0 = {
    azureMonitor: {
        ...
        resourceGroup: 'cloud-datasources',
        resourceName: 'AppInsightsTestData',
        resourceUri: '/subscriptions/44693801-6ee6-49de-9b2d-9106972f9572/resourceGroups/cloud-datasources/providers/microsoft.insights/components/AppInsightsTestData',
        timeGrain: 'auto',
    },
    azureLogAnalytics: {
        query: '//change this example to create your own time series query\n<table name>                                                              //the table to query (e.g. Usage, Heartbeat, Perf)\n| where $__timeFilter(TimeGenerated)                                      //this is a macro used to show the full chart’s time range, choose the datetime column here\n| summarize count() by <group by column>, bin(TimeGenerated, $__interval) //change “group by column” to a column in your table, such as “Computer”. The $__interval macro is used to auto-select the time grain. Can also use 1h, 5m etc.\n| order by TimeGenerated asc',
...
describe('AzureMonitor: migrateQuery', () => {
    ...
    describe('migrating from a v8 query to the latest query version', () => {
        it('will not change valid dimension filters', () => {
            ...
            const result = migrateQuery(Object.assign(Object.assign({}, azureMonitorQueryV8), { azureMonitor: { dimensionFilters } }));
        ...
        it('correctly updates old filter containing wildcard', () => {
            const dimensionFilters = [{ dimension: 'TestDimension', operator: 'eq', filter: '*' }];
            const result = migrateQuery(Object.assign(Object.assign({}, azureMonitorQueryV8), { azureMonitor: { dimensionFilters } }));
            expect(result).toMatchObject(expect.objectContaining({
                azureMonitor: expect.objectContaining({
                    dimensionFilters: [
        ...
        it('correctly updates old filter containing value', () => {
            const dimensionFilters = [{ dimension: 'TestDimension', operator: 'eq', filter: 'test' }];
            const result = migrateQuery(Object.assign(Object.assign({}, azureMonitorQueryV8), { azureMonitor: { dimensionFilters } }));
            expect(result).toMatchObject(expect.objectContaining({
                azureMonitor: expect.objectContaining({
                    dimensionFilters: [
        ...
        it('correctly removes outdated fields', () => {
            const result = migrateQuery(Object.assign(Object.assign({}, azureMonitorQueryV8), { azureMonitor: { dimension: 'testDimension', dimensionFilter: 'testFilter' } }));
            expect(result).toMatchObject(expect.objectContaining({
                azureMonitor: expect.objectContaining({
                    dimensionFilters: [
                        {
        ...
        it('correctly migrates a metric definition', () => {
            const result = migrateQuery(Object.assign(Object.assign({}, azureMonitorQueryV8), { azureMonitor: { metricDefinition: 'ms.ns/mn' } }));
            expect(result).toMatchObject(expect.objectContaining({
                azureMonitor: expect.objectContaining({
        ...
        it('correctly adds the dashboardTime property', () => {
            const result = migrateQuery(Object.assign({}, azureMonitorQueryV8));
            expect(result).toMatchObject(expect.objectContaining({
    ...
    describe('migrating from a v9.0 query to the latest query version', () => {
        ...
        it('correctly adds the dashboardTime property', () => {
            const result = migrateQuery(Object.assign({}, azureMonitorQueryV9_0));
            expect(result).toMatchObject(expect.objectContaining({
                azureLogAnalytics: expect.objectContaining({
                    dashboardTime: false,
                }),
    ...
    it('should migrate a single resource for Logs', () => {
        var _a;
        const q = Object.assign(Object.assign({}, modernMetricsQuery), { azureLogAnalytics: Object.assign(Object.assign({}, modernMetricsQuery.azureLogAnalytics), { resource: 'foo' }) });
        const result = migrateQuery(q);
        expect((_a = result.azureLogAnalytics) === null || _a === void 0 ? void 0 : _a.resources).toEqual(['foo']);
    });
    it('correctly migrates intersectTime to dashboardTime', () => {
        var _a;
        const query = modernMetricsQuery;
        (_a = query.azureLogAnalytics) === null || _a === void 0 ? true : delete _a.dashboardTime;
        const result = migrateQuery(Object.assign(Object.assign({}, query), { azureLogAnalytics: Object.assign(Object.assign({}, query.azureLogAnalytics), { intersectTime: true }) }));
        expect(result).toMatchObject(expect.objectContaining({
            azureLogAnalytics: expect.objectContaining({
                dashboardTime: true,
            }),
...
//# sourceMappingURL=migrateQuery.test.js.map