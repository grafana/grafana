...
describe('When interpolating variables', () => {
    ...
    describe('and variable allows multi-value and value is a string', () => {
        it('should return a quoted value', () => {
            const variable = Object.assign(Object.assign({}, initialCustomVariableModelState), { multi: true });
    ...
    describe('and variable allows all and value is a string', () => {
        it('should return a quoted value', () => {
            const variable = Object.assign(Object.assign({}, initialCustomVariableModelState), { includeAll: true });
            expect(interpolateVariable('abc', variable)).toEqual("'abc'");
        });
        it('should not return a quoted value if the all value is modified', () => {
            const variable = Object.assign(Object.assign({}, initialCustomVariableModelState), { includeAll: true, allValue: 'All' });
            expect(interpolateVariable('abc', variable)).toEqual('abc');
        });
        it('should return a quoted value if multi is selected even if the allValue is set', () => {
            const variable = Object.assign(Object.assign({}, initialCustomVariableModelState), { includeAll: true, multi: true, allValue: 'All' });
            expect(interpolateVariable('abc', variable)).toEqual("'abc'");
        });
    });
});
