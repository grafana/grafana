...
export function buildSegments(state, modifyLastSegment = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield checkOtherSegments(state, checkOtherSegmentsIndex, modifyLastSegment);
    });
}
/**
 ...
 */
export function checkOtherSegments(state, fromIndex, modifyLastSegment = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const segments = yield state.datasource.metricFindQuery(path);
            if (segments.length === 0) {
                ...
                if (state.segments.length === fromIndex) {
                    ...
                    yield checkOtherSegments(state, currentFromIndex);
                }
            }
        }
        catch (err) {
