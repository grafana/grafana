...
import { AbstractLabelOperator, getFrameDisplayName, dateTime } from '@grafana/data';
...
describe('graphiteDatasource', () => {
    ...
    describe('When querying graphite with one target using query editor target spec', () => {
        ...
        it('X-Dashboard and X-Panel headers to be set!', () => {
            var _a, _b;
            expect((_a = requestOptions.headers) === null || _a === void 0 ? void 0 : _a['X-Dashboard-Id']).toBe(5);
            expect((_b = requestOptions.headers) === null || _b === void 0 ? void 0 : _b['X-Panel-Id']).toBe(3);
        });
        ...
        it('should return series list', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(response).toEmitValuesWith((values) => {
                const results = values[0];
                expect(results.data.length).toBe(1);
                expect(results.data[0].name).toBe('prod1.count');
            });
        }));
        it('should convert to millisecond resolution', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(response).toEmitValuesWith((values) => {
                const results = values[0];
    ...
    describe('when fetching Graphite Events as annotations', () => {
        ...
        describe('and tags are returned as string', () => {
            ...
            beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield ctx.ds.annotationEvents(options.range, options.targets[0]).then((data) => {
                    results = data;
                });
            }));
        ...
        it('and tags response is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockImplementation((options) => {
    ...
    describe('when fetching Graphite function descriptions', () => {
        ...
        it('should parse the response with an invalid JSON', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('querying for template variables', () => {
        ...
        it('should generate tags query', () => {
            ...
            expect((_a = requestOptions.params) === null || _a === void 0 ? void 0 : _a.expr).toEqual([]);
        ...
        it('should generate tags query with a filter expression', () => {
            ...
            expect(requestOptions.url).toBe('/api/datasources/proxy/1/tags/autoComplete/tags');
            expect((_a = requestOptions.params) === null || _a === void 0 ? void 0 : _a.expr).toEqual(['server=backend_01']);
            expect(results).not.toBe(null);
        });
        ...
        it('should generate tag values query for one tag', () => {
            ...
            expect((_a = requestOptions.params) === null || _a === void 0 ? void 0 : _a.tag).toBe('server');
            expect((_b = requestOptions.params) === null || _b === void 0 ? void 0 : _b.expr).toEqual([]);
            expect(results).not.toBe(null);
        });
        it('should generate tag values query for a tag and expression', () => {
            ...
            expect(requestOptions.url).toBe('/api/datasources/proxy/1/tags/autoComplete/values');
            expect((_a = requestOptions.params) === null || _a === void 0 ? void 0 : _a.tag).toBe('server');
            expect((_b = requestOptions.params) === null || _b === void 0 ? void 0 : _b.expr).toEqual(['server=~backend*']);
            expect(results).not.toBe(null);
        });
        ...
        it('should request expanded metrics', () => {
            ...
            expect((_a = requestOptions.params) === null || _a === void 0 ? void 0 : _a.query).toBe('*.servers.*');
            expect(results).not.toBe(null);
        });
        it('should fetch from /metrics/find endpoint when queryType is default or query is string', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const data = yield ctx.ds.metricFindQuery(objectQuery);
            expect(requestOptions.url).toBe('/api/datasources/proxy/1/metrics/find');
            expect(data).toBeTruthy();
        }));
        it('should fetch from /render endpoint when queryType is value', () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockImplementation((options) => {
                requestOptions = options;
                return of(createFetchResponse([
                    {
            ...
            const data = yield ctx.ds.metricFindQuery(fq);
            expect(requestOptions.url).toBe('/api/datasources/proxy/1/render');
            expect(data).toBeTruthy();
        }));
        it('should return values of a query when queryType is GraphiteQueryType.Value', () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockImplementation((options) => {
                requestOptions = options;
                return of(createFetchResponse([
                    {
        ...
        it('should return metric names when queryType is GraphiteQueryType.MetricName', () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockImplementation((options) => {
                requestOptions = options;
                return of(createFetchResponse([
                    {
    ...
    describe('exporting to abstract query', () => {
        function assertQueryExport(target, labelMatchers) {
            return __awaiter(this, void 0, void 0, function* () {
                let abstractQueries = yield ctx.ds.exportToAbstractQueries([
                    {
                        refId: 'A',
                        target,
                    },
        ...
        beforeEach(() => {
            ...
            ctx.ds.createFuncInstance = jest.fn().mockImplementation((name) => ({
                name,
                params: [],
                def: {
                    name,
        ...
        it('extracts metric name based on configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            yield assertQueryExport('interpolate(alias(servers.west.001.cpu,1,2))', [
                { name: 'cluster', operator: AbstractLabelOperator.Equal, value: 'west' },
                { name: 'server', operator: AbstractLabelOperator.Equal, value: '001' },
            ]);
            yield assertQueryExport('interpolate(alias(servers.east.001.request.POST.200,1,2))', [
                { name: 'cluster', operator: AbstractLabelOperator.Equal, value: 'east' },
                { name: 'server', operator: AbstractLabelOperator.Equal, value: '001' },
            ]);
            yield assertQueryExport('interpolate(alias(servers.*.002.*,1,2))', [
                { name: 'server', operator: AbstractLabelOperator.Equal, value: '002' },
            ]);
        }));
        it('extracts tags', () => __awaiter(void 0, void 0, void 0, function* () {
            yield assertQueryExport("interpolate(seriesByTag('cluster=west', 'server=002'), inf))", [
                { name: 'cluster', operator: AbstractLabelOperator.Equal, value: 'west' },
                { name: 'server', operator: AbstractLabelOperator.Equal, value: '002' },
            ]);
            yield assertQueryExport("interpolate(seriesByTag('foo=bar', 'server=002'), inf))", [
                { name: 'foo', operator: AbstractLabelOperator.Equal, value: 'bar' },
                { name: 'server', operator: AbstractLabelOperator.Equal, value: '002' },
            ]);
        }));
        it('extracts regular expressions', () => __awaiter(void 0, void 0, void 0, function* () {
            yield assertQueryExport('interpolate(alias(servers.eas*.{001,002}.request.POST.200,1,2))', [
        ...
        it('does not extract metrics when the config does not match', () => __awaiter(void 0, void 0, void 0, function* () {
            yield assertQueryExport('interpolate(alias(test.west.001.cpu))', []);
            yield assertQueryExport('interpolate(alias(servers.west.001))', []);
        }));
    });
});
