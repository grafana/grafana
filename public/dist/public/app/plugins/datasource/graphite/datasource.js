...
import { lastValueFrom, merge, Observable, of, pipe, throwError } from 'rxjs';
import { catchError, map } from 'rxjs/operators';
import { AbstractLabelOperator, DataSourceApi, dateMath, dateTime, toDataFrame, getSearchFilterScopedVar, } from '@grafana/data';
...
// Types
import { GraphiteQueryType, GraphiteType, } from './types';
...
export class GraphiteDatasource extends DataSourceApi {
    constructor(instanceSettings, templateSrv = getTemplateSrv()) {
        ...
        this.metricMappings = ((_b = (_a = instanceSettings.jsonData.importConfiguration) === null || _a === void 0 ? void 0 : _a.loki) === null || _b === void 0 ? void 0 : _b.mappings) || [];
    ...
    exportToAbstractQuery(query) {
        const graphiteQuery = new GraphiteQueryModel(this, Object.assign(Object.assign({}, query), { target: query.target || '', textEditor: false }), getTemplateSrv());
    ...
    interpolateVariablesInQueries(queries, scopedVars) {
        ...
        if (queries && queries.length > 0) {
            expandedQueries = queries.map((query) => {
                var _a;
                const expandedQuery = Object.assign(Object.assign({}, query), { datasource: this.getRef(), target: this.templateSrv.replace((_a = query.target) !== null && _a !== void 0 ? _a : '', scopedVars) });
    ...
    annotationEvents(range, target) {
        ...
        if (target.target) {
            ...
            const tags = this.templateSrv.replace((_a = target.tags) === null || _a === void 0 ? void 0 : _a.join(' '));
    ...
    targetContainsTemplate(target) {
        var _a;
        return this.templateSrv.containsTemplate((_a = target.target) !== null && _a !== void 0 ? _a : '');
    }
    ...
    metricFindQuery(findQuery, optionalOptions) {
        ...
        let query = (_a = queryObject.target) !== null && _a !== void 0 ? _a : '';
     ...
     */
    requestMetricRender(queryObject, options, queryType) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const requestId = (_a = options.requestId) !== null && _a !== void 0 ? _a : `Q${this.requestCounter++}`;
            const range = (_b = options.range) !== null && _b !== void 0 ? _b : {
            ...
            const queryReq = {
                ...
                intervalMs: 10000,
                startTime: Date.now(),
                targets: [Object.assign({}, queryObject)],
                timezone: 'browser',
                scopedVars: {},
                requestId,
                range,
            };
            const data = yield lastValueFrom(this.query(queryReq));
            let result;
