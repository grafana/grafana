...
describe('Graphite query model', function () {
    ...
    describe('when query is generated from segments', function () {
        beforeEach(function () {
            ctx.target = { refId: 'A', target: '' };
            ctx.queryModel = new GraphiteQuery(ctx.datasource, ctx.target, ctx.templateSrv);
        });
        it('and no segments are selected then the query is empty', function () {
        ...
        it('and some segments are selected then segments without selected value are omitted', function () {
