...
function replaceVariablesDummy(str) {
...
describe('when rendering func instance', function () {
    ...
    it('should not quote variables that have numeric value', function () {
        var func = gfunc.createFuncInstance('movingAverage');
    ...
    it('should quote variables that have string value', function () {
        var func = gfunc.createFuncInstance('movingAverage');
        func.params[0] = '$variable';
        var replaceVariables = function (str) {
