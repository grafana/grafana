...
import { of } from 'rxjs';
import { dateTime, FieldType, MutableDataFrame } from '@grafana/data';
...
describe('influxdb response parser', () => {
    ...
    describe('Should get the table', () => {
        ...
        it('preferredVisualisationType correctly', () => {
            var _a;
            expect((_a = table.meta) === null || _a === void 0 ? void 0 : _a.preferredVisualisationType).toBe('table');
        });
        it('executedQueryString correctly', () => {
            var _a;
            expect((_a = table.meta) === null || _a === void 0 ? void 0 : _a.executedQueryString).toBe('SELECT everything!');
        });
    });
    ...
    describe('When issuing annotationQuery', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            response = yield ctx.ds.annotationEvents(queryOptions, annotation);
        }));
        it('should return annotation list', () => {
            ...
            expect((_a = response[0].tags) === null || _a === void 0 ? void 0 : _a[0]).toBe('cbfa07e0e3bb 1');
            expect((_b = response[0].tags) === null || _b === void 0 ? void 0 : _b[1]).toBe('/var/log/host/install.log 1');
            ...
            expect((_c = response[1].tags) === null || _c === void 0 ? void 0 : _c[0]).toBe('cbfa07e0e3bb 2');
            expect((_d = response[1].tags) === null || _d === void 0 ? void 0 : _d[1]).toBe('/var/log/host/install.log 2');
        });
    });
});
const mockQuery = {
...
const mockDataFramesWithAlias = [
    {
        name: 'cpu.ALIAS1 { geohash: tz6h548nc111 }',
        refId: 'A',
        meta: {
            executedQueryString: 'SELECT mean("value") AS "ALIAS1", mean("value") AS "ALIAS2" FROM "bar"."cpu" WHERE time >= 1686582333244ms and time <= 1686583233244ms GROUP BY time(500ms), "geohash"::tag fill(null) ORDER BY time ASC',
        },
        fields: [
            {
                name: 'Time',
...
const mockDataframesWithTwoFieldSelect = [
    {
        name: 'cpu.mean',
        refId: 'A',
        meta: {
            typeVersion: [0, 0],
            executedQueryString: 'SELECT mean("value"), mean("value") FROM "bar"."cpu" WHERE time >= 1686585763070ms and time <= 1686585793070ms GROUP BY time(10ms) fill(null) ORDER BY time ASC',
        },
        fields: [
            {
                name: 'Time',
...
const mockQueryWithTwoFieldSelect = {
    datasource: {
        type: 'influxdb',
        uid: '1234',
    },
