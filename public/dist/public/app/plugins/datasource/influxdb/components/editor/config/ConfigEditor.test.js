...
jest.mock('lodash', () => {
    const uniqueId = (prefix) => `${prefix}42`;
    const orig = jest.requireActual('lodash');
    return Object.assign(Object.assign({}, orig), { uniqueId });
});
const setup = (optionOverrides) => {
    const props = {
        options: Object.assign({ id: 21, uid: 'z', orgId: 1, name: 'InfluxDB-3', type: 'influxdb', typeName: 'Influx', typeLogoUrl: '', access: 'proxy', url: '', user: '', database: '', basicAuth: false, basicAuthUser: '', withCredentials: false, isDefault: false, jsonData: {
                httpMode: 'POST',
                timeInterval: '4',
            }, secureJsonFields: {}, version: 1, readOnly: false }, optionOverrides),
        onOptionsChange: jest.fn(),
    };
    return render(React.createElement(ConfigEditor, Object.assign({}, props)));
};
