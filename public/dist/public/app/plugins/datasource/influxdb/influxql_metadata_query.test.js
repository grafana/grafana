...
describe('influx_metadata_query', () => {
    ...
    mockMetricFindQuery.mockImplementation((q) => {
        query = q;
        return Promise.resolve([]);
    });
    mockRunMetadataQuery.mockImplementation((t) => {
        target = t;
        query = t.query;
        return Promise.resolve([]);
    });
    ...
    describe('backend mode disabled', () => {
        ...
        describe('getTagValues', () => {
            ...
            it('with key ends with ::field', () => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield getTagValues(ds, [], 'test_key::field');
            ...
            it('with measurement', () => {
                ...
                frontendModeChecks();
                expect(query).toBe('SHOW TAG VALUES FROM "test_measurement" WITH KEY = "test_key" WHERE "tagKey" = \'tag_val\'');
            });
            it('with retention policy', () => {
                getTagValues(ds, [{ key: 'tagKey', value: 'tag_val' }], 'test_key', 'test_measurement', 'rp');
                frontendModeChecks();
                expect(query).toBe('SHOW TAG VALUES FROM "rp"."test_measurement" WITH KEY = "test_key" WHERE "tagKey" = \'tag_val\'');
            });
        });
...
//# sourceMappingURL=influxql_metadata_query.test.js.map