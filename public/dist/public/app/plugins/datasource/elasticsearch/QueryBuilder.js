...
import { defaultBucketAgg, defaultMetricAgg, findMetricById, highlightTags, defaultGeoHashPrecisionString, } from './queryDef';
...
export class ElasticQueryBuilder {
    ...
    buildTermsAgg(aggDef, queryNode, target) {
        ...
        const size = ((_a = aggDef.settings) === null || _a === void 0 ? void 0 : _a.size) ? parseInt(aggDef.settings.size, 10) : 500;
    ...
    getFiltersAgg(aggDef) {
        var _a;
        const filterObj = {};
        for (let { query, label } of ((_a = aggDef.settings) === null || _a === void 0 ? void 0 : _a.filters) || []) {
    ...
    build(target) {
        ...
        if (((_b = (_a = target.metrics) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.type) === 'raw_document' || ((_d = (_c = target.metrics) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.type) === 'raw_data') {
            metric = target.metrics[0];
            // TODO: This default should be somewhere else together with the one used in the UI
            const size = ((_e = metric.settings) === null || _e === void 0 ? void 0 : _e.size) ? parseInt(metric.settings.size, 10) : 500;
        ...
        for (i = 0; i < target.bucketAggs.length; i++) {
            ...
            switch (aggDef.type) {
                ...
                case 'geohash_grid': {
                    esAgg['geohash_grid'] = {
                        field: aggDef.field,
                        precision: ((_f = aggDef.settings) === null || _f === void 0 ? void 0 : _f.precision) || defaultGeoHashPrecisionString,
                    };
                    break;
                }
                case 'nested': {
        ...
        for (i = 0; i < target.metrics.length; i++) {
            ...
            if (isMetricAggregationWithSettings(metric)) {
                Object.entries(metric.settings || {})
                    ...
                    .forEach(([k, v]) => {
                    metricAgg[k] =
                        k === 'script' ? this.buildScript(getScriptValue(metric)) : v;
                });
                ...
                switch (metric.type) {
                    case 'moving_avg':
                        metricAgg = Object.assign(Object.assign(Object.assign(Object.assign({}, metricAgg), ((metricAgg === null || metricAgg === void 0 ? void 0 : metricAgg.window) !== undefined && { window: this.toNumber(metricAgg.window) })), ((metricAgg === null || metricAgg === void 0 ? void 0 : metricAgg.predict) !== undefined && { predict: this.toNumber(metricAgg.predict) })), (isMovingAverageWithModelSettings(metric) && {
                            settings: Object.assign(Object.assign({}, metricAgg.settings), Object.fromEntries(Object.entries(metricAgg.settings || {})
                        ...
                        break;
                    case 'serial_diff':
                        metricAgg = Object.assign(Object.assign({}, metricAgg), (metricAgg.lag !== undefined && {
                            lag: this.toNumber(metricAgg.lag),
                        }));
                        break;
                    case 'top_metrics':
                        metricAgg = {
                            metrics: (_h = (_g = metric.settings) === null || _g === void 0 ? void 0 : _g.metrics) === null || _h === void 0 ? void 0 : _h.map((field) => ({ field })),
                            size: 1,
                        };
                        if ((_j = metric.settings) === null || _j === void 0 ? void 0 : _j.orderBy) {
                            metricAgg.sort = [{ [(_k = metric.settings) === null || _k === void 0 ? void 0 : _k.orderBy]: (_l = metric.settings) === null || _l === void 0 ? void 0 : _l.order }];
                        }
                        break;
                }
            }
    ...
    getLogsQuery(target, limit) {
        ...
        return Object.assign(Object.assign({}, query), { aggs: this.build(target).aggs, highlight: {
                fields: {
                    '*': {},
                },
