import { DataFrameView, FieldCache, FieldType, MutableDataFrame } from '@grafana/data';
import flatten from 'app/core/utils/flatten';
import { ElasticResponse } from './ElasticResponse';
import { highlightTags } from './queryDef';
function getTimeField(frame) {
...
describe('ElasticResponse', () => {
    ...
    describe('refId matching', () => {
        ...
        const commonTargets = [
            Object.assign({}, countQuery.target),
            Object.assign({}, countGroupByHistogramQuery.target),
            Object.assign({}, rawDocumentQuery.target),
            Object.assign({}, percentilesQuery.target),
            Object.assign({}, extendedStatsQuery.target),
        ];
        const commonResponses = [
            Object.assign({}, countQuery.response),
            Object.assign({}, countGroupByHistogramQuery.response),
            Object.assign({}, rawDocumentQuery.response),
            Object.assign({}, percentilesQuery.response),
            Object.assign({}, extendedStatsQuery.response),
        ];
    ...
    describe('Raw Data Query', () => {
        ...
        it('should have time field values in DateTime format', () => {
            ...
            expect(timeField === null || timeField === void 0 ? void 0 : timeField.values[0]).toBe(1546300800000);
        });
    });
    describe('simple logs query and count', () => {
        ...
        it('should return histogram aggregation and documents', () => {
            ...
            expect(result.data.length).toBe(2);
            const logResults = result.data[0];
        ...
        it('should map levels field', () => {
            ...
            expect(field === null || field === void 0 ? void 0 : field.values).toEqual(['debug', 'error']);
        });
        it('should re map levels field to new field', () => {
            const result = new ElasticResponse(targets, response).getLogs(undefined, 'fields.lvl');
            const fieldCache = new FieldCache(result.data[0]);
            const field = fieldCache.getFieldByName('level');
            expect(field === null || field === void 0 ? void 0 : field.values).toEqual(['debug', 'info']);
        });
...
//# sourceMappingURL=ElasticResponse.test.js.map