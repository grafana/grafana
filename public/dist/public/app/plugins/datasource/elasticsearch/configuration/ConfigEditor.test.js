...
describe('ConfigEditor', () => {
    ...
    it('should set defaults', () => {
        ...
        const { rerender } = render(React.createElement(ConfigEditor, { onOptionsChange: mockOnOptionsChange, options: options }));
        ...
        rerender(React.createElement(ConfigEditor, { onOptionsChange: mockOnOptionsChange, options: updatedOptions }));
        expect(mockOnOptionsChange).toHaveBeenCalledWith(expect.objectContaining({
            jsonData: expect.objectContaining({
                timeField: '@timestamp',
                maxConcurrentShardRequests: 5,
    ...
    it('should not apply default if values are set', () => {
        const mockOnOptionsChange = jest.fn();
        render(React.createElement(ConfigEditor, { onOptionsChange: mockOnOptionsChange, options: createDefaultConfigOptions() }));
