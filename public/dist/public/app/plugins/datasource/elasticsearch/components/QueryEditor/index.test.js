...
describe('QueryEditor', () => {
    describe('Alias Field', () => {
        it('Should correctly render and trigger changes on blur', () => {
            ...
            render(React.createElement(QueryEditor, { query: query, datasource: datasourceMock, onChange: onChange, onRunQuery: noop }));
            let aliasField = screen.getByLabelText('Alias');
        ...
        it('Should not be shown if last bucket aggregation is not Date Histogram', () => {
            ...
            render(React.createElement(QueryEditor, { query: query, datasource: datasourceMock, onChange: noop, onRunQuery: noop }));
