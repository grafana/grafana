 ...
 **/
export const interpolateStringArrayUsingSingleOrMultiValuedVariable = (templateSrv, strings, scopedVars, key) => {
...
export const isTemplateVariable = (templateSrv, string) => {
    const variableName = templateSrv.getVariableName(string);
...
//# sourceMappingURL=templateVariableUtils.js.map