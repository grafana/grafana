...
import { migrateCloudWatchQuery, migrateMultipleStatsAnnotationQuery, migrateMultipleStatsMetricsQuery, } from './dashboardMigrations';
describe('dashboardMigrations', () => {
    describe('migrateMultipleStatsMetricsQuery', () => {
        ...
        const panelQueries = [
            Object.assign({}, queryToMigrate),
            {
                refId: 'B',
            },
        ];
        const newQueries = migrateMultipleStatsMetricsQuery(queryToMigrate, panelQueries);
        const newMetricQueries = newQueries;
...
//# sourceMappingURL=dashboardMigrations.test.js.map