import { multiLineFullQuery, singleLineFullQuery, singleLineEmptyQuery, singleLineTwoQueries, } from '../../../__mocks__/cloudwatch-sql-test-data';
...
describe('statementPosition', () => {
    function assertPosition(query, position, expected) {
    ...
    ])('should be before select keyword', (query, position) => {
    ...
    ])('should be after select keyword', (query, position) => {
    ...
    ])('should be first argument in select statistic function', (query, position) => {
    ...
    ])('should be before the FROM keyword', (query, position) => {
    ...
    ])('should after the FROM keyword', (query, position) => {
    ...
    ])('should be namespace arg in the schema func', (query, position) => {
    ...
    ])('should be label key args within the schema func', (query, position) => {
    ...
    ])('should be after from schema/namespace', (query, position) => {
    ...
    ])('should after where keyword and before label key', (query, position) => {
    ...
    ])('should be before the comparison operator in a where filter', (query, position) => {
    ...
    ])('should be before or in the value in a where filter', (query, position) => {
    ...
    ])('should be after a where value', (query, position) => {
    ...
    ])('should be after group by keywords', (query, position) => {
    ...
    ])('should be after group by labels', (query, position) => {
    ...
    ])('should be after order by keywords', (query, position) => {
    ...
    ])('should be after order by function', (query, position) => {
    ...
    ])('should be after order by direction', (query, position) => {
