...
export function getStatementPosition(currentToken) {
    ...
    if (currentToken && previousNonWhiteSpace) {
        ...
        if (isWithinSearch) {
            ...
            if (lastComma) {
                const lastCommaIsAfterSearch = lastComma.range.startColumn > currentFunction.range.startColumn &&
    ...
    if (previousNonWhiteSpace === null || previousNonWhiteSpace === void 0 ? void 0 : previousNonWhiteSpace.endsWith(')')) {
