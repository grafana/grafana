...
export const CloudWatchAnnotationSupport = {
    ...
    prepareAnnotation: (query) => {
        ...
        return {
            ...
            hide: query.hide,
            target: Object.assign(Object.assign(Object.assign({}, query.target), query), { statistic: query.statistic || DEFAULT_ANNOTATIONS_QUERY.statistic, region: query.region || DEFAULT_ANNOTATIONS_QUERY.region, queryMode: 'Annotations', refId: query.refId || 'annotationQuery' }),
        };
    },
    ...
    prepareQuery: (anno) => {
        ...
        const { prefixMatching, actionPrefix, alarmNamePrefix, statistic, namespace, metricName, dimensions = {}, } = anno.target;
