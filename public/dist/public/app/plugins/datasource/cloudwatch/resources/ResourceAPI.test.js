...
describe('ResourcesAPI', () => {
    describe('describeLogGroup', () => {
        it('replaces region correctly in the query', () => __awaiter(void 0, void 0, void 0, function* () {
            const { api, resourceRequestMock } = setupMockedResourcesAPI();
            yield api.getLogGroups({ region: 'default' });
            expect(resourceRequestMock.mock.calls[0][1].region).toBe('us-west-1');
            yield api.getLogGroups({ region: 'eu-east' });
            expect(resourceRequestMock.mock.calls[1][1].region).toBe('eu-east');
        }));
        it('should return log groups as an array of options', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = [
                {
            ...
            const logGroups = yield api.getLogGroups({ region: 'default' });
            expect(logGroups).toEqual(expectedLogGroups);
        }));
    });
    describe('memoization', () => {
        it('should not initiate new api request in case a previous request had same args', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('should handle backend srv response mapping', () => {
        it('when getAllMetrics is called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const allMetrics = yield api.getAllMetrics({ region: 'us-east-2' });
            expect(allMetrics).toEqual([
                { metricName: 'CPUUtilization', namespace: 'AWS/EC2' },
                { metricName: 'CPUPercentage', namespace: 'AWS/Redshift' },
            ]);
        }));
        it('when getMetrics', () => __awaiter(void 0, void 0, void 0, function* () {
            const getMock = jest.fn().mockResolvedValue([
                {
                    value: {
                        namespace: 'AWS/EC2',
            ...
            const { api } = setupMockedResourcesAPI({ getMock });
            const allMetrics = yield api.getMetrics({ region: 'us-east-2', namespace: 'AWS/EC2' });
            expect(allMetrics).toEqual([
    ...
    describe('getRegions', () => {
        ...
        it('should return regions as an array of options when using legacy regions route', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const regions = yield api.getRegions();
            expect(regions).toEqual(expectedRegions);
        }));
        it('should return regions as an array of options when using new regions route', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=ResourceAPI.test.js.map