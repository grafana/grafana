...
export var ARITHMETIC_OPERATORS = ['+', '-', '*', '/', '^', '%'];
export var NUMERIC_OPERATORS = [
    {
        label: 'abs',
        detail: 'abs(a)',
...
export var BOOLEAN_FUNCTIONS = __spreadArray([
    {
        label: 'ispresent',
        detail: 'ispresent(fieldname)',
        documentation: 'Returns true if the field exists.',
...
], __read(IP_FUNCTIONS), false);
export var AGGREGATION_FUNCTIONS_STATS = [
    {
        label: 'avg',
...
export var NON_AGGREGATION_FUNCS_STATS = [
    {
        label: 'earliest',
...
export var STATS_FUNCS = __spreadArray(__spreadArray([], __read(AGGREGATION_FUNCTIONS_STATS), false), __read(NON_AGGREGATION_FUNCS_STATS), false);
export var KEYWORDS = ['as', 'like', 'by', 'in', 'desc', 'asc'];
export var FIELD_AND_FILTER_FUNCTIONS = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(NUMERIC_OPERATORS), false), __read(GENERAL_FUNCTIONS), false), __read(STRING_FUNCTIONS), false), __read(DATETIME_FUNCTIONS), false), __read(IP_FUNCTIONS), false);
export var FUNCTIONS = __spreadArray(__spreadArray([], __read(FIELD_AND_FILTER_FUNCTIONS), false), __read(STATS_FUNCS), false);
var tokenizer = {
    comment: {
        pattern: /^#.*/,
        greedy: true,
    ...
    'query-command': {
        pattern: new RegExp("\\b(?:" + QUERY_COMMANDS.map(function (command) { return command.label; }).join('|') + ")\\b", 'i'),
        alias: 'function',
    },
    function: {
        pattern: new RegExp("\\b(?:" + FUNCTIONS.map(function (f) { return f.label; }).join('|') + ")\\b", 'i'),
    },
    keyword: {
