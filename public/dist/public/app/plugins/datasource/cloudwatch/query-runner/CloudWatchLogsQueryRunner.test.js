...
import { DataQueryErrorType, FieldType, LogLevel, MutableDataFrame, dateTime, LogRowContextQueryDirection, } from '@grafana/data';
import { getTimeSrv } from 'app/features/dashboard/services/TimeSrv';
import { CloudWatchSettings, limitVariable, logGroupNamesVariable, regionVariable, } from '../__mocks__/CloudWatchDataSource';
...
describe('CloudWatchLogsQueryRunner', () => {
    ...
    describe('getLogRowContext', () => {
        it('replaces parameters correctly in the query', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield runner.getLogRowContext(row);
            ...
            yield runner.getLogRowContext(row, { direction: LogRowContextQueryDirection.Forward }, Object.assign(Object.assign({}, validLogsQuery), { region: 'eu-east' }));
    ...
    describe('logs query', () => {
        ...
        it('should stop querying when timed out', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let i = 0;
            jest.spyOn(runner, 'makeLogActionRequest').mockImplementation((subtype) => {
            ...
            const myResponse = yield lastValueFrom(runner.logsQuery([{ queryId: 'fake-query-id', region: 'default', refId: 'A' }], timeoutFunc));
            const expectedData = [
                Object.assign(Object.assign({}, fakeFrames[14]), { meta: {
                        custom: {
                            Status: 'Cancelled',
                        },
        ...
        it('should continue querying as long as new data is being received', () => __awaiter(void 0, void 0, void 0, function* () {
            const { runner } = setupMockedLogsQueryRunner();
        ...
        it('should stop querying when results come back with status "Complete"', () => __awaiter(void 0, void 0, void 0, function* () {
            const { runner } = setupMockedLogsQueryRunner();
    ...
    const legacyLogGroupNamesQuery = {
        queryMode: 'Logs',
    ...
    describe('handleLogQueries', () => {
        it('should map log queries to start query requests correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const { runner } = setupMockedLogsQueryRunner({
                variables: [logGroupNamesVariable, regionVariable, limitVariable],
                settings: Object.assign(Object.assign({}, CloudWatchSettings), { jsonData: Object.assign(Object.assign({}, CloudWatchSettings.jsonData), { logsTimeout: '500ms' }) }),
                mockGetVariableName: false,
            });
            const spy = jest.spyOn(runner, 'makeLogActionRequest');
            yield lastValueFrom(runner.handleLogQueries([legacyLogGroupNamesQuery, logGroupNamesQuery, logsScopedVarQuery], LogsRequestMock));
            const startQueryRequests = [
                {
                ...
                },
                {
                    ...
                    logGroups: [
                        ...
                        ...logGroupNamesVariable.current.value.map((v) => ({ arn: v, name: v })),
                    ],
                    refId: legacyLogGroupNamesQuery.refId,
                ...
                },
                {
                    ...
                    logGroupNames: [],
                    logGroups: [...logGroupNamesVariable.current.value.map((v) => ({ arn: v, name: v }))],
                    refId: legacyLogGroupNamesQuery.refId,
                    region: regionVariable.current.value,
                },
            ];
    ...
    describe('makeLogActionRequest', () => {
        it('should use the time range from the options if it is available', () => __awaiter(void 0, void 0, void 0, function* () {
            const { runner } = setupMockedLogsQueryRunner();
            const spy = jest.spyOn(runner, 'awsRequest');
            const from = dateTime(0);
            const to = dateTime(1000);
            const options = Object.assign(Object.assign({}, LogsRequestMock), { range: { from, to, raw: { from, to } } });
            yield lastValueFrom(runner.makeLogActionRequest('StartQuery', [genMockCloudWatchLogsRequest()], options));
            expect(spy).toHaveBeenNthCalledWith(1, '/api/ds/query', expect.objectContaining({ from: '0', to: '1000' }), {
                'X-Cache-Skip': 'true',
            });
        }));
        it('should use the time range from the timeSrv if the time range in the options is not available', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const spy = jest.spyOn(runner, 'awsRequest');
            yield lastValueFrom(runner.makeLogActionRequest('StartQuery', [genMockCloudWatchLogsRequest()]));
...
//# sourceMappingURL=CloudWatchLogsQueryRunner.test.js.map