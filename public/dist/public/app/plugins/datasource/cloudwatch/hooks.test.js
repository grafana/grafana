...
import { accountIdVariable, dimensionVariable, metricVariable, namespaceVariable, regionVariable, setupMockedDataSource, } from './__mocks__/CloudWatchDataSource';
...
describe('hooks', () => {
    ...
    describe('useIsMonitoringAccount', () => {
        it('should interpolate variables before calling api', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('useMetricNames', () => {
        it('should interpolate variables before calling api', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            renderHook(() => useMetrics(datasource, {
    ...
    describe('useDimensionKeys', () => {
        it('should interpolate variables before calling api', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            renderHook(() => useDimensionKeys(datasource, {
                namespace: `$${namespaceVariable.name}`,
    ...
    describe('useAccountOptions', () => {
        it('does not call the api if the feature toggle is off', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('interpolates region variables before calling the api', () => __awaiter(void 0, void 0, void 0, function* () {
            config.featureToggles.cloudWatchCrossAccountQuerying = true;
            const { api } = setupMockedResourcesAPI({
                variables: [regionVariable],
            });
        ...
        it('returns properly formatted account options, and template variables', () => __awaiter(void 0, void 0, void 0, function* () {
            config.featureToggles.cloudWatchCrossAccountQuerying = true;
            const { api } = setupMockedResourcesAPI({
                variables: [regionVariable],
            });
