        ...
        tokenize: (value, languageId) => {
            if (languageId === 'cloudwatch-sql') {
                const TestData = {
                    ...
                    [SQLTestData.multiLineIncompleteQueryWithoutNamespace.query]: SQLTestData.multiLineIncompleteQueryWithoutNamespace.tokens,
                };
