...
const QUERIES = [
    ...
    },
    {
        ...
        | fields @timestamp, @logStream as instanceId, ExceptionMessage`,
            ...
            {
                title: 'To get the number of exceptions logged every 5 minutes using regex where exception is not case sensitive',
...
const COMMANDS = [
    {
        ...
        examples: [
            {
                description: 'Retrieve one or more log fields. You can also use functions and operations such as abs(a+b), sqrt(a/b), log(a)+log(b), strlen(trim()), datefloor(), isPresent(), and others in this command.',
    ...
    },
    {
        ...
        examples: [
            {
                description: 'Retrieve log fields based on one or more conditions. You can use comparison operators such as =, !=, >, >=, <, <=, boolean operators such as and, or, and not, and regular expressions in this command.',
...
const LogsCheatSheet = (props) => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Collapse, { label: "Commands", collapsible: true, isOpen: isCommandsOpen, onToggle: (isOpen) => setIsCommandsOpen(isOpen) },
            React.createElement(React.Fragment, null, COMMANDS.map((cat, i) => (React.createElement("div", { key: `cat-${i}` },
                React.createElement("h5", null, cat.category),
                cat.examples.map((item, j) => (React.createElement("div", { key: `item-${j}` },
                    React.createElement("p", null, item.description),
                    React.createElement("button", { type: "button", className: "cheat-sheet-item__example", key: item.expr, onClick: () => {
                            var _a, _b;
                            return props.onClickExample({
                                refId: (_a = props.query.refId) !== null && _a !== void 0 ? _a : 'A',
                                expression: item.expr,
                                queryMode: 'Logs',
                                region: props.query.region,
                                id: (_b = props.query.refId) !== null && _b !== void 0 ? _b : 'A',
                        ...
                        React.createElement("pre", null, renderHighlightedMarkup(item.expr, `item-${j}`))))))))))),
        React.createElement(Collapse, { label: "Queries", collapsible: true, isOpen: isQueriesOpen, onToggle: (isOpen) => setIsQueriesOpen(isOpen) }, QUERIES.map((cat, i) => (React.createElement("div", { key: `cat-${i}` },
            React.createElement("div", { className: `cheat-sheet-item__title ${cx(exampleCategory)}` }, cat.category),
            cat.examples.map((item, j) => (React.createElement("div", { className: "cheat-sheet-item", key: `item-${j}` },
        ...
        React.createElement("div", null,
            ...
            ' ',
            React.createElement("a", { className: cx(link), href: "https://grafana.com/docs/grafana/latest/datasources/aws-cloudwatch/#cloudwatch-logs-data-protection", target: "_blank", rel: "noreferrer" }, "See documentation for details"),
            ".")));
};
