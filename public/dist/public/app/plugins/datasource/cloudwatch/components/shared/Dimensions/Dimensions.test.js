...
describe('Dimensions', () => {
    describe('when rendered with two existing dimensions', () => {
        it('should render two filter items', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            render(React.createElement(Dimensions, Object.assign({}, props, { metricStat: props.query, dimensionKeys: [] })));
    ...
    describe('when adding a new filter item', () => {
        it('it should add the new item but not call onChange', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            render(React.createElement(Dimensions, Object.assign({}, props, { metricStat: props.query, onChange: onChange, dimensionKeys: [] })));
    ...
    describe('when adding a new filter item with key', () => {
        it('it should add the new item but not call onChange', () => __awaiter(void 0, void 0, void 0, function* () {
            props.query.dimensions = {};
            const onChange = jest.fn();
            const { container } = render(React.createElement(Dimensions, Object.assign({}, props, { metricStat: props.query, onChange: onChange, dimensionKeys: [] })));
            yield userEvent.click(screen.getByLabelText('Add'));
    ...
    describe('when adding a new filter item with key and value', () => {
        it('it should add the new item and trigger onChange', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield userEvent.type(valueElement, 'my-value');
            fireEvent.keyDown(valueElement, { keyCode: 13 });
            expect(onChange).not.toHaveBeenCalledWith(Object.assign(Object.assign({}, props.query), { dimensions: {
                    'my-key': 'my-value',
                } }));
        }));
    });
