...
ds.datasource.resources.getDimensionKeys = jest
    .fn()
    .mockImplementation(({ namespace: region, dimensionFilters }) => {
    if (!!dimensionFilters) {
...
describe('VariableEditor', () => {
    ...
    describe('and a new variable is created', () => {
        it('should trigger a query using the first query type in the array', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = defaultQuery;
            render(React.createElement(VariableQueryEditor, Object.assign({}, props)));
            yield waitFor(() => {
    ...
    describe('and an existing variable is edited', () => {
        it('should trigger new query using the saved query type', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.Metrics, namespace: 'z2', region: 'a1' });
            render(React.createElement(VariableQueryEditor, Object.assign({}, props)));
            yield waitFor(() => {
                const querySelect = screen.queryByRole('combobox', { name: 'Query type' });
                expect(querySelect).toBeInTheDocument();
        ...
        it('should parse dimensionFilters correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.DimensionValues, namespace: 'z2', region: 'a1', metricName: 'i3', dimensionKey: 's4', dimensionFilters: { s4: 'foo' } });
            ...
            expect(onChange).toHaveBeenCalledWith(Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.DimensionValues, namespace: 'z2', region: 'a1', metricName: 'i3', dimensionKey: 's4', dimensionFilters: { v4: undefined } }));
            // set filter value
            const valueSelect = screen.getByRole('combobox', { name: 'Dimensions filter value' });
            yield select(valueSelect, 'bar', {
                container: document.body,
            });
            expect(onChange).toHaveBeenCalledWith(Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.DimensionValues, namespace: 'z2', region: 'a1', metricName: 'i3', dimensionKey: 's4', dimensionFilters: { v4: 'bar' } }));
        }));
        it('should parse multiFilters correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.EC2InstanceAttributes, region: 'a1', attributeName: 'Tags.blah', ec2Filters: { s4: ['foo', 'bar'] } });
            render(React.createElement(VariableQueryEditor, Object.assign({}, props)));
            yield waitFor(() => {
            ...
            yield userEvent.type(valueElement, ',baz');
            fireEvent.blur(valueElement);
            expect(screen.getByDisplayValue('foo, bar, baz')).toBeInTheDocument();
            expect(onChange).toHaveBeenCalledWith(Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.EC2InstanceAttributes, region: 'a1', attributeName: 'Tags.blah', ec2Filters: { s4: ['foo', 'bar', 'baz'] } }));
        }));
    });
    describe('and a different region is selected', () => {
        it('should clear invalid fields', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.DimensionValues, namespace: 'z2', region: 'a1', metricName: 'i3', dimensionKey: 's4', dimensionFilters: { s4: 'foo' } });
            render(React.createElement(VariableQueryEditor, Object.assign({}, props)));
            ...
            yield waitFor(() => select(regionSelect, 'b1', {
                container: document.body,
            }));
            ...
            expect(props.onChange).toHaveBeenCalledWith(Object.assign(Object.assign({}, defaultQuery), { refId: 'CloudWatchVariableQueryEditor-VariableQuery', queryType: VariableQueryType.DimensionValues, namespace: 'z2', region: 'b1', 
                ...
                dimensionKey: '', dimensionFilters: {} }));
        }));
    });
    describe('LogGroups queryType is selected', () => {
        it('should only render region and prefix', () => __awaiter(void 0, void 0, void 0, function* () {
            const props = defaultProps;
            props.query = Object.assign(Object.assign({}, defaultQuery), { queryType: VariableQueryType.LogGroups });
            render(React.createElement(VariableQueryEditor, Object.assign({}, props)));
            yield waitFor(() => {
