...
describe('Cloudwatch SQLBuilderEditor', () => {
    ...
    it('Displays the namespace', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        render(React.createElement(SQLBuilderEditor, Object.assign({}, baseProps, { query: query })));
        yield waitFor(() => expect(datasource.resources.getNamespaces).toHaveBeenCalled());
        expect(screen.getByText('AWS/EC2')).toBeInTheDocument();
        expect(screen.getByLabelText('With schema')).not.toBeChecked();
    }));
    it('Displays withSchema namespace', () => __awaiter(void 0, void 0, void 0, function* () {
        const query = makeSQLQuery({
            from: {
    ...
    it('Uses dimension filter when loading dimension keys if query includes InstanceID', () => __awaiter(void 0, void 0, void 0, function* () {
        const query = makeSQLQuery({
            from: {
                type: QueryEditorExpressionType.Function,
                name: 'SCHEMA',
        ...
        render(React.createElement(SQLBuilderEditor, Object.assign({}, baseProps, { query: query })));
        yield waitFor(() => expect(datasource.resources.getDimensionKeys).toHaveBeenCalledWith({
            namespace: 'AWS/EC2',
            region: query.region,
    ...
    it('Displays the SELECT correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        const query = makeSQLQuery({
            select: {
                type: QueryEditorExpressionType.Function,
                name: 'AVERAGE',
    ...
    describe('ORDER BY', () => {
        it('should display it correctly when its specified', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = makeSQLQuery({
                orderBy: {
                    type: QueryEditorExpressionType.Function,
                    name: 'AVG',
        ...
        it('should display it correctly when its not specified', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = makeSQLQuery({});
            render(React.createElement(SQLBuilderEditor, Object.assign({}, baseProps, { query: query })));
            yield waitFor(() => expect(datasource.resources.getNamespaces).toHaveBeenCalled());
...
//# sourceMappingURL=SQLBuilderEditor.test.js.map