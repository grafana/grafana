...
import { dataFrameToJSON, getDefaultTimeRange, dateTime, FieldType, createDataFrame, } from '@grafana/data';
...
describe('MSSQLDatasource', () => {
    ...
    describe('When runSql returns an empty dataframe', () => {
        ...
        it('should return an empty array when metricFindQuery is called', () => __awaiter(void 0, void 0, void 0, function* () {
            const query = 'select * from atable';
            const results = yield ctx.ds.metricFindQuery(query, { range: defaultRange });
            expect(results.length).toBe(0);
        }));
        it('should return an empty array when fetchDatasets is called', () => __awaiter(void 0, void 0, void 0, function* () {
            const results = yield ctx.ds.fetchDatasets();
            expect(results.length).toBe(0);
        }));
        it('should return an empty array when fetchTables is called', () => __awaiter(void 0, void 0, void 0, function* () {
            const results = yield ctx.ds.fetchTables();
            expect(results.length).toBe(0);
        }));
        it('should return an empty array when fetchFields is called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const results = yield ctx.ds.fetchFields(query);
            expect(results.length).toBe(0);
        }));
    });
    describe('When runSql returns a populated dataframe', () => {
        it('should return a list of datasets when fetchDatasets is called', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return a list of fields when fetchFields is called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const results = yield ctx.ds.fetchFields(sqlQuery);
            expect(results.length).toBe(3);
