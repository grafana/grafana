...
var MssqlDatasource = /** @class */ (function (_super) {
    __extends(MssqlDatasource, _super);
    ...
    MssqlDatasource.prototype.interpolateVariable = function (value, variable) {
        ...
        var quotedValues = _map(value, function (val) {
            if (typeof value === 'number') {
                return value;
            }
    ...
    MssqlDatasource.prototype.applyTemplateVariables = function (target, scopedVars) {
        return {
            refId: target.refId,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!options.annotation.rawQuery) {
                    return [2 /*return*/, Promise.reject({ message: 'Query missing in annotation definition' })];
                }
                query = {
    ...
    MssqlDatasource.prototype.filterQuery = function (query) {
        return !query.hide;
    };
    ...
    MssqlDatasource.prototype.targetContainsTemplate = function (query) {
        var rawSql = query.rawSql.replace('$__', '');
