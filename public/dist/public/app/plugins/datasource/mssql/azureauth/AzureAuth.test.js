import { AzureAuthType, AzureCloud } from '../types';
import { configWithManagedIdentityEnabled, configWithManagedIdentityDisabled, dataSourceSettingsWithMsiCredentials, dataSourceSettingsWithClientSecretOnServer, dataSourceSettingsWithClientSecretInSecureJSONData, } from './AzureAuth.testMocks';
...
export const CLIENT_SECRET_SYMBOL = Symbol('Concealed client secret');
    ...
    describe('AzureCredentialsConfig', () => {
        ...
        describe('getCredentials()', () => {
            it('should return the correct managed identity credentials', () => {
                ...
                // @ts-ignore
                dataSourceSettingsWithMsiCredentials, configWithManagedIdentityEnabled);
                ...
                // @ts-ignore
                dataSourceSettingsWithMsiCredentials, configWithManagedIdentityDisabled);
            ...
            it('should return the correct client secret credentials', () => {
                ...
                // @ts-ignore
                dataSourceSettingsWithClientSecretOnServer, configWithManagedIdentityDisabled);
                ...
                // @ts-ignore
                dataSourceSettingsWithClientSecretInSecureJSONData, configWithManagedIdentityDisabled);
                expect(resultForClientSecretCredentialsInSecureJSON).toEqual(Object.assign(Object.assign({}, basicExpectedResult), { clientSecret: CLIENT_SECRET_STRING }));
            });
        });
        describe('updateCredentials()', () => {
            ...
            it('should update the credentials for client secret correctly', () => {
                const basicClientSecretCredentials = {
                    authType: AzureAuthType.CLIENT_SECRET,
                    azureCloud: 'AzureCloud',
                    tenantId: 'XXXX-tenant-id-XXXX',
                    clientId: 'XXXX-client-id-XXXX',
                ...
                // @ts-ignore
                dataSourceSettingsWithClientSecretOnServer, configWithManagedIdentityDisabled, basicClientSecretCredentials);
                expect(resultForClientSecretCredentials1).toEqual({
                    jsonData: {
                        azureCredentials: Object.assign({}, basicClientSecretCredentials),
                    },
                ...
                // @ts-ignore
                dataSourceSettingsWithClientSecretInSecureJSONData, configWithManagedIdentityDisabled, Object.assign(Object.assign({}, basicClientSecretCredentials), { clientSecret: 'XXXX-super-secret-secret-XXXX' }));
...
//# sourceMappingURL=AzureAuth.test.js.map