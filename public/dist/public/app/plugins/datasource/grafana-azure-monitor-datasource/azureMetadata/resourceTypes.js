...
export var resourceTypeMetadata = [
    {
...
export var logsSupportedResourceTypesKusto = resourceTypeMetadata
    .filter(function (v) { return v.supportsLogs; })
    .map(function (v) { return "\"" + v.resourceType + "\""; })
    .join(',');
// Object, keyed by resourceType ID
export var resourceTypeDisplayNames = resourceTypeMetadata.reduce(function (acc, resourceType) {
    var _a;
    return (__assign(__assign({}, acc), (_a = {}, _a[resourceType.resourceType] = resourceType.displayName, _a)));
}, {});
