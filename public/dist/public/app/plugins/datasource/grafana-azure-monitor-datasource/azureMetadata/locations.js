...
export var logsSupportedLocationsKusto = locationMetadata
    .filter(function (v) { return v.supportsLogs; })
    .map(function (v) { return "\"" + v.location + "\""; })
    .join(',');
// Object, keyed by location ID
export var locationDisplayNames = locationMetadata.reduce(function (acc, location) {
    var _a;
    return (__assign(__assign({}, acc), (_a = {}, _a[location.location] = location.displayName, _a)));
}, {});
