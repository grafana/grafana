...
describe('AzureMonitor: migrateQuery', function () {
    it('modern queries should not change', function () {
        var result = migrateQuery(modernMetricsQuery);
