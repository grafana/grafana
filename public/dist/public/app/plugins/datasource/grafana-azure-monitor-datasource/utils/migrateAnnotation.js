...
export default function migrateAnnotation(annotation) {
    var _a, _b, _c, _d, _e;
    var oldQuery = typeof annotation.rawQuery === 'string' ? annotation.rawQuery : null;
    var oldWorkspace = typeof annotation.workspace === 'string' ? annotation.workspace : null;
    ...
    var newQuery = __assign(__assign({}, ((_c = annotation.target) !== null && _c !== void 0 ? _c : {})), { refId: (_e = (_d = annotation.target) === null || _d === void 0 ? void 0 : _d.refId) !== null && _e !== void 0 ? _e : 'Anno', queryType: AzureQueryType.LogAnalytics, azureLogAnalytics: {
            query: oldQuery,
            resource: oldWorkspace,
        } });
    return __assign(__assign({}, annotation), { rawQuery: undefined, workspace: undefined, subscription: undefined, queryType: undefined, target: newQuery });
}
