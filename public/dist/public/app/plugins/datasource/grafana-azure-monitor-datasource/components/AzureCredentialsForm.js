...
export var AzureCredentialsForm = function (props) {
    var credentials = props.credentials, azureCloudOptions = props.azureCloudOptions, onCredentialsChange = props.onCredentialsChange, getSubscriptions = props.getSubscriptions, disabled = props.disabled;
    ...
    return (React.createElement("div", { className: "gf-form-group" },
        props.managedIdentityEnabled && (React.createElement("div", { className: "gf-form-inline" },
            React.createElement("div", { className: "gf-form" },
                ...
                React.createElement(Select, { menuShouldPortal: true, className: "width-15", value: authTypeOptions.find(function (opt) { return opt.value === credentials.authType; }), options: authTypeOptions, onChange: onAuthTypeChange, isDisabled: disabled })))),
        credentials.authType === 'clientsecret' && (React.createElement(React.Fragment, null,
            azureCloudOptions && (React.createElement("div", { className: "gf-form-inline" },
                React.createElement("div", { className: "gf-form" },
                    ...
                    React.createElement(Select, { menuShouldPortal: true, className: "width-15", value: azureCloudOptions.find(function (opt) { return opt.value === credentials.azureCloud; }), options: azureCloudOptions, onChange: onAzureCloudChange, isDisabled: disabled })))),
            React.createElement("div", { className: "gf-form-inline" },
                React.createElement("div", { className: "gf-form" },
                    ...
                    React.createElement("div", { className: "width-15" },
                        React.createElement(Input, { className: "width-30", placeholder: "XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX", value: credentials.tenantId || '', onChange: onTenantIdChange, disabled: disabled })))),
            React.createElement("div", { className: "gf-form-inline" },
                React.createElement("div", { className: "gf-form" },
                    React.createElement(InlineFormLabel, { className: "width-12" }, "Application (client) ID"),
                    React.createElement("div", { className: "width-15" },
                        React.createElement(Input, { className: "width-30", placeholder: "XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX", value: credentials.clientId || '', onChange: onClientIdChange, disabled: disabled })))),
            !disabled &&
                (typeof credentials.clientSecret === 'symbol' ? (React.createElement("div", { className: "gf-form-inline" },
                    ...
                    React.createElement("div", { className: "gf-form" },
                        React.createElement("div", { className: "max-width-30 gf-form-inline" },
                            React.createElement(Button, { variant: "secondary", type: "button", onClick: onClientSecretReset, disabled: disabled }, "reset"))))) : (React.createElement("div", { className: "gf-form-inline" },
                    React.createElement("div", { className: "gf-form" },
                        React.createElement(InlineFormLabel, { className: "width-12" }, "Client Secret"),
                        React.createElement("div", { className: "width-15" },
                            React.createElement(Input, { className: "width-30", placeholder: "XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX", value: credentials.clientSecret || '', onChange: onClientSecretChange, disabled: disabled })))))))),
        getSubscriptions && (React.createElement(React.Fragment, null,
            ...
            !disabled && (React.createElement("div", { className: "gf-form-inline" },
                React.createElement("div", { className: "gf-form" },
                    React.createElement("div", { className: "max-width-30 gf-form-inline" },
