...
describe('AzureMonitorUrlBuilder', function () {
    describe('when metric definition is Microsoft.NetApp/netAppAccounts/capacityPools/volumes', function () {
        it('should build the getMetricNamespaces url in the even longer format', function () {
            var url = UrlBuilder.buildAzureMonitorGetMetricNamespacesUrl('', 'sub1', 'rg', 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes', 'rn1/rn2/rn3', '2017-05-01-preview');
            expect(url).toBe('/sub1/resourceGroups/rg/providers/Microsoft.NetApp/netAppAccounts/rn1/capacityPools/rn2/volumes/rn3/' +
    ...
    describe('when metric definition is Microsoft.Sql/servers/databases', function () {
        it('should build the getMetricNamespaces url in the longer format', function () {
            var url = UrlBuilder.buildAzureMonitorGetMetricNamespacesUrl('', 'sub1', 'rg', 'Microsoft.Sql/servers/databases', 'rn1/rn2', '2017-05-01-preview');
    ...
    describe('when metric definition is Microsoft.Sql/servers', function () {
        it('should build the getMetricNamespaces url in the shorter format', function () {
            var url = UrlBuilder.buildAzureMonitorGetMetricNamespacesUrl('', 'sub1', 'rg', 'Microsoft.Sql/servers', 'rn', '2017-05-01-preview');
            expect(url).toBe('/sub1/resourceGroups/rg/providers/Microsoft.Sql/servers/rn/' +
                'providers/microsoft.insights/metricNamespaces?api-version=2017-05-01-preview');
        });
    });
    describe('when metric definition is Microsoft.NetApp/netAppAccounts/capacityPools/volumes and the metricNamespace is default', function () {
        it('should build the getMetricNames url in the even longer format', function () {
            var url = UrlBuilder.buildAzureMonitorGetMetricNamesUrl('', 'sub1', 'rg', 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes', 'rn1/rn2/rn3', 'default', '2017-05-01-preview');
            expect(url).toBe('/sub1/resourceGroups/rg/providers/Microsoft.NetApp/netAppAccounts/rn1/capacityPools/rn2/volumes/rn3/' +
                'providers/microsoft.insights/metricdefinitions?api-version=2017-05-01-preview&metricnamespace=default');
        });
    });
    describe('when metric definition is Microsoft.Sql/servers/databases and the metricNamespace is default', function () {
    ...
    describe('when metric definition is Microsoft.Sql/servers and the metricNamespace is default', function () {
    ...
    describe('when metric definition is Microsoft.Storage/storageAccounts/blobServices and the metricNamespace is default', function () {
        it('should build the getMetricNames url in the longer format', function () {
    ...
    describe('when metric definition is Microsoft.Storage/storageAccounts/fileServices and the metricNamespace is default', function () {
        it('should build the getMetricNames url in the longer format', function () {
    ...
    describe('when metric definition is Microsoft.Storage/storageAccounts/tableServices and the metricNamespace is default', function () {
        it('should build the getMetricNames url in the longer format', function () {
    ...
    describe('when metric definition is Microsoft.Storage/storageAccounts/queueServices and the metricNamespace is default', function () {
        it('should build the getMetricNames url in the longer format', function () {
