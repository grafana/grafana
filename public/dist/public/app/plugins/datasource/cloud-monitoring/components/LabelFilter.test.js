...
describe('LabelFilter', () => {
    it('should render an add button with no filters passed in', () => {
        render(React.createElement(LabelFilter, { labels: {}, filters: [], onChange: () => { }, variableOptionGroup: [] }));
        expect(screen.getByLabelText('Add')).toBeInTheDocument();
    });
    it('should render filters if any are passed in', () => {
        const filters = ['key_1', '=', 'value_1'];
        render(React.createElement(LabelFilter, { labels: {}, filters: filters, onChange: () => { }, variableOptionGroup: [] }));
    ...
    it('can add filters', () => __awaiter(void 0, void 0, void 0, function* () {
        const onChange = jest.fn();
        render(React.createElement(LabelFilter, { labels: {}, filters: [], onChange: onChange, variableOptionGroup: [] }));
        yield userEvent.click(screen.getByLabelText('Add'));
        expect(onChange).toBeCalledWith(expect.arrayContaining(['', '=', '']));
    }));
    it('should render grouped labels', () => __awaiter(void 0, void 0, void 0, function* () {
        const filters = ['key_1', '=', 'value_1'];
        render(React.createElement(LabelFilter, { labels: labels, filters: filters, onChange: () => { }, variableOptionGroup: [] }));
        yield openMenu(screen.getByLabelText('Filter label key'));
    ...
    it('can select a label key to filter on', () => __awaiter(void 0, void 0, void 0, function* () {
        const onChange = jest.fn();
        const filters = ['key_1', '=', ''];
        render(React.createElement(LabelFilter, { labels: labels, filters: filters, onChange: onChange, variableOptionGroup: [] }));
        const key = screen.getByLabelText('Filter label key');
        yield select(key, 'metric.label.instance_name', { container: document.body });
        expect(onChange).toBeCalledWith(expect.arrayContaining(['metric.label.instance_name', '=', '']));
    }));
    it('should on render label values for the selected filter key', () => __awaiter(void 0, void 0, void 0, function* () {
        const filters = ['metric.label.instance_name', '=', ''];
        render(React.createElement(LabelFilter, { labels: labels, filters: filters, onChange: () => { }, variableOptionGroup: [] }));
        yield openMenu(screen.getByLabelText('Filter label value'));
    ...
    it('can select a label value to filter on', () => __awaiter(void 0, void 0, void 0, function* () {
        const onChange = jest.fn();
        const filters = ['metric.label.instance_name', '=', ''];
        render(React.createElement(LabelFilter, { labels: labels, filters: filters, onChange: onChange, variableOptionGroup: [] }));
        const key = screen.getByLabelText('Filter label value');
        yield select(key, 'instance_name_1', { container: document.body });
        expect(onChange).toBeCalledWith(expect.arrayContaining(['metric.label.instance_name', '=', 'instance_name_1']));
    }));
});
//# sourceMappingURL=LabelFilter.test.js.map