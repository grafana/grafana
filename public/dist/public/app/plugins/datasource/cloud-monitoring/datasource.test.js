...
import { PreprocessorType, QueryType, MetricKind } from './types/query';
describe('Cloud Monitoring Datasource', () => {
    describe('interpolateVariablesInQueries', () => {
        ...
        it('should correctly apply template variables for metricQuery (deprecated)', () => {
            ...
            expect((_a = templatedQuery[0].timeSeriesList) === null || _a === void 0 ? void 0 : _a.projectName).toEqual('project-variable');
        });
    ...
    describe('migrateQuery', () => {
        describe('should migrate the query to the new format', () => {
            ...
            ].forEach((t) => it(t.description, () => {
                const mockInstanceSettings = createMockInstanceSetttings();
                const ds = new Datasource(mockInstanceSettings);
                const oldQuery = Object.assign({}, t.input);
    ...
    describe('filterQuery', () => {
        [
            ...
            const mockInstanceSettings = createMockInstanceSetttings();
            const ds = new Datasource(mockInstanceSettings);
            const query = Object.assign({}, t.input);
            const result = ds.filterQuery(query);
            expect(result).toBe(t.expected);
        }));
    });
    describe('getLabels', () => {
        it('should get labels', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockInstanceSettings = createMockInstanceSetttings();
            const ds = new Datasource(mockInstanceSettings);
            ds.backendSrv = Object.assign(Object.assign({}, ds.backendSrv), { fetch: jest.fn().mockReturnValue(lastValueFrom(of({ results: [] }))) });
            yield ds.getLabels('gce_instance', 'A', 'my-project');
