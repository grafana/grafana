...
import { extractServicesFromMetricDescriptors, getAggregationOptionsByMetric, getAlignmentOptionsByMetric, getAlignmentPickerData, getLabelKeys, getMetricTypes, getMetricTypesByService, labelsToGroupedOptions, stringArrayToFilters, alignmentPeriodLabel, getMetricType, setMetricType, } from './functions';
import { newMockDatasource } from './specs/testData';
import { AlignmentTypes, MetricKind, ValueTypes } from './types/query';
jest.mock('@grafana/runtime', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/runtime')), { getTemplateSrv: () => ({
        replace: jest.fn().mockImplementation((s) => s),
    }) })));
describe('functions', () => {
    ...
    describe('getAlignmentOptionsByMetric', () => {
        ...
        describe('when double and gauge is passed', () => {
            ...
            it('should return all alignment options except two', () => {
                ...
                expect(result.map((o) => o.value)).toEqual(expect.not.arrayContaining(['REDUCE_COUNT_TRUE', 'REDUCE_COUNT_FALSE']));
            });
        });
        describe('when double and delta is passed', () => {
            ...
            it('should return all alignment options except four', () => {
                ...
                expect(result.map((o) => o.value)).toEqual(expect.not.arrayContaining([
                    'ALIGN_COUNT_TRUE',
                    'ALIGN_COUNT_FALSE',
                    'ALIGN_FRACTION_TRUE',
                    'ALIGN_INTERPOLATE',
    ...
    describe('getLabelKeys', () => {
        it('should return labels', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield getLabelKeys(ds, 'type', 'project')).toEqual(['l1', 'l2', ...SYSTEM_LABELS]);
        }));
    });
