...
function getTestcontext({ response = {}, throws = false, templateSrv = new TemplateSrv() } = {}) {
    jest.clearAllMocks();
...
describe('CloudMonitoringDataSource', () => {
    describe('When performing query', () => {
        describe('and no time series data is returned', () => {
            it('should return a list of datapoints', () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {
                    range: {
                        from: toUtc('2017-08-22T20:00:00Z'),
                        to: toUtc('2017-08-22T23:59:00Z'),
    ...
    describe('When loading labels', () => {
        describe('and no aggregation was specified', () => {
            it('should use default values', () => __awaiter(void 0, void 0, void 0, function* () {
                const { ds } = getTestcontext();
                yield ds.getLabels('cpu', 'a', 'default-proj');
                yield expect(fetchMock.mock.calls[0][0].data.queries[0].timeSeriesList).toMatchObject({
        ...
        describe('and an aggregation was specified', () => {
            it('should use the provided aggregation', () => __awaiter(void 0, void 0, void 0, function* () {
                const { ds } = getTestcontext();
                yield ds.getLabels('sql', 'b', 'default-proj', {
...
function initTemplateSrv(values, multi = false) {
    const templateSrv = new TemplateSrv();
    const test = Object.assign(Object.assign({}, initialCustomVariableModelState), { id: 'test', name: 'test', current: { value: values, text: Array.isArray(values) ? values.toString() : values, selected: true }, options: [{ value: values, text: Array.isArray(values) ? values.toString() : values, selected: false }], multi });
