import { DataFrameView, FieldColorModeId, MutableDataFrame, NodeGraphDataFrameFieldNames as Fields, FieldType, toDataFrame, } from '@grafana/data';
...
function convertTraceToGraph(data) {
    ...
    for (let i = 0; i < view.length; i++) {
        ...
        nodes.push({
            ...
            [Fields.title]: (_a = row.serviceName) !== null && _a !== void 0 ? _a : '',
...
function getMetricFrames(responses) {
    return responses[0].data.reduce((acc, frameDTO) => {
        var _a;
        const frame = toDataFrame(frameDTO);
        acc[(_a = frame.refId) !== null && _a !== void 0 ? _a : 'A'] = new DataFrameView(frame);
        return acc;
    }, {});
}
...
var AdditionalEdgeFields;
(function (AdditionalEdgeFields) {
    AdditionalEdgeFields["sourceName"] = "sourceName";
    AdditionalEdgeFields["sourceNamespace"] = "sourceNamespace";
    AdditionalEdgeFields["targetName"] = "targetName";
    AdditionalEdgeFields["targetNamespace"] = "targetNamespace";
})(AdditionalEdgeFields || (AdditionalEdgeFields = {}));
/**
...
function convertToDataFrames(nodesMap, edgesMap, range) {
    ...
    for (const nodeId of Object.keys(nodesMap)) {
        ...
        nodes.add({
            ...
            [Fields.secondaryStat]: node.total ? Math.round(node.total * 100) / 100 : Number.NaN,
