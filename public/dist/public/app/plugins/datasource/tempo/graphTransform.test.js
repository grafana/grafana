...
it('assigns correct field type even if values are numbers', () => __awaiter(void 0, void 0, void 0, function* () {
    const range = {
        from: dateTime('2000-01-01T00:00:00'),
        to: dateTime('2000-01-01T00:01:00'),
    };
    const { nodes } = mapPromMetricsToServiceMap([{ data: [serverIsANumber, serverIsANumber] }], Object.assign(Object.assign({}, range), { raw: range }));
...
describe('mapPromMetricsToServiceMap', () => {
    it('transforms prom metrics to service graph', () => __awaiter(void 0, void 0, void 0, function* () {
        const range = {
            from: dateTime('2000-01-01T00:00:00'),
            to: dateTime('2000-01-01T00:01:00'),
        };
        const { nodes, edges } = mapPromMetricsToServiceMap([{ data: [totalsPromMetric(), secondsPromMetric(), failedPromMetric()] }], Object.assign(Object.assign({}, range), { raw: range }));
        expect(nodes.fields).toMatchObject([
    ...
    it('transforms prom metrics to service graph including namespace', () => __awaiter(void 0, void 0, void 0, function* () {
        const range = {
            from: dateTime('2000-01-01T00:00:00'),
            to: dateTime('2000-01-01T00:01:00'),
        };
        const { nodes, edges } = mapPromMetricsToServiceMap([{ data: [totalsPromMetric(true), secondsPromMetric(true), failedPromMetric(true)] }], Object.assign(Object.assign({}, range), { raw: range }));
        expect(nodes.fields).toMatchObject([
    ...
    it('handles invalid failed count', () => {
        ...
        const { nodes } = mapPromMetricsToServiceMap([{ data: [totalsPromMetric(), secondsPromMetric(), invalidFailedPromMetric] }], Object.assign(Object.assign({}, range), { raw: range }));
        expect(nodes.fields).toMatchObject([
            { name: 'id', values: ['db', 'app', 'lb'] },
            { name: 'title', values: ['db', 'app', 'lb'] },
            { name: 'subtitle', values: [] },
...
const totalsPromMetric = (namespace) => createDataFrame({
...
const secondsPromMetric = (namespace) => createDataFrame({
...
const failedPromMetric = (namespace) => createDataFrame({
