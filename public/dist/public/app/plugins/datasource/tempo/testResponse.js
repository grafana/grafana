...
export var bigResponse = new MutableDataFrame({
    fields: [
        {
            name: 'traceID',
            values: [
        ...
        },
        {
            ...
            values: [
                ...
                [
                    ...
                    {
                        value: '/loki/api/v1/query_range?direction=BACKWARD&limit=1000&query=%7Bcompose_project%3D%22devenv%22%7D&start=1619709055000000000&end=1619712656000000000&step=2',
                        key: 'http.url',
                    },
                    {
                        value: 'net/http',
...
export var otlpDataFrame = new MutableDataFrame({
    meta: {
