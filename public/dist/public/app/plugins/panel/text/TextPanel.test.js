...
const setup = (props = defaultProps) => {
    render(React.createElement(TextPanel, Object.assign({}, props)));
};
describe('TextPanel', () => {
    ...
    it('sanitizes content in html mode', () => {
        ...
        setup(props);
        expect(screen.getByTestId('TextPanel-converted-content').innerHTML).toEqual('&lt;form&gt;<p>Form tags are sanitized.</p>&lt;/form&gt;\n&lt;script&gt;Script tags are sanitized.&lt;/script&gt;');
    });
    ...
    it('converts content to markdown when in markdown mode', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setup(props);
        const waited = yield screen.getByTestId('TextPanel-converted-content');
        expect(waited.innerHTML).toEqual('<p>We begin by a simple sentence.\n<code>code block</code></p>\n');
    }));
    it('interpolates variables before content is converted to markdown', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('interpolates variables correctly so they can be used in markdown urls', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(waited.innerHTML).toEqual('<p><a href="https://example.com/?from=now-6h&amp;to=now">Example: from=now-6h&amp;to=now</a></p>\n');
    }));
    it('converts content to html when in html mode', () => {
        ...
        setup(props);
        expect(screen.getByTestId('TextPanel-converted-content').innerHTML).toEqual('We begin by a simple sentence.\n```This is a code block\n```');
    });
});
//# sourceMappingURL=TextPanel.test.js.map