...
import { PluginState, FieldType, } from '@grafana/data';
...
export const defaultPhotosConfig = {
...
let photoLoad = []; // TODO find a better way to manage this, used to track image load
/**
 * Map layer configuration for circle overlay
 */
export const photosLayer = {
    id: PHOTOS_LAYER_ID,
    name: 'Photos',
    ...
    create: (map, options, eventBus, theme) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        vectorLayer.setStyle((feature) => {
            ...
            if (images.length > 0) {
                ...
                src = (_a = images[idx]) !== null && _a !== void 0 ? _a : unknownImage;
            }
            ...
            const blankStyle = new Style({
                image: new Photo({
                    ...
                    stroke: new Stroke({
                        width: (_b = config.border) !== null && _b !== void 0 ? _b : 0,
        ...
        return {
            ...
            update: (data) => {
                ...
                for (const frame of data.series) {
                    ...
                    if (config.src) {
                        const srcField = findField(frame, config.src);
                        if (srcField) {
                            images = srcField === null || srcField === void 0 ? void 0 : srcField.values;
                        }
                    }
                    else {
...
//# sourceMappingURL=photosLayer.js.map