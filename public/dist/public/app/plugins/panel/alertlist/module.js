...
import { GroupMode, ShowOption, SortOrder, ViewMode } from './types';
function showIfCurrentState(options) {
    return options.showOptions === ShowOption.Current;
}
const alertList = new PanelPlugin(AlertList)
    ...
    builder
        ...
        editor: function RenderFolderPicker({ value, onChange }) {
            return (React.createElement(ReadonlyFolderPicker, { initialFolderId: value, onChange: (folder) => onChange(folder === null || folder === void 0 ? void 0 : folder.id), extraFolders: [ALL_FOLDER, GENERAL_FOLDER] }));
        },
        category: ['Filter'],
        showIf: showIfCurrentState,
    })
...
const unifiedAlertList = new PanelPlugin(UnifiedAlertList).setPanelOptions((builder) => {
    builder
        ...
        editor: (props) => {
            var _a;
            return (React.createElement(GroupBy, { id: (_a = props.id) !== null && _a !== void 0 ? _a : 'groupBy', defaultValue: props.value.map((value) => ({ label: value, value })), onChange: props.onChange, dataSource: props.context.options.datasource }));
        },
    })
        .addNumberInput({
        name: 'Max items',
        ...
        editor: function RenderDatasourcePicker(props) {
            return (React.createElement(DataSourcePicker, Object.assign({}, props, { type: ['prometheus', 'loki', 'grafana'], noDefault: true, current: props.value, onChange: (ds) => props.onChange(ds.name), onClear: () => props.onChange(null) })));
        },
        category: ['Filter'],
    })
        .addCustomEditor({
        ...
        editor: function RenderFolderPicker(props) {
            var _a, _b;
            return (React.createElement(OldFolderPicker, Object.assign({ enableReset: true, showRoot: false, allowEmpty: true, initialTitle: (_a = props.value) === null || _a === void 0 ? void 0 : _a.title, initialFolderUid: (_b = props.value) === null || _b === void 0 ? void 0 : _b.uid, permissionLevel: PermissionLevelString.View, onClear: () => props.onChange('') }, props)));
        },
        category: ['Filter'],
    })
        .addBooleanSwitch({
