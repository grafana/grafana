...
export var alertListPanelMigrationHandler = function (panel) {
    ...
    var newOptions = {
        ...
        stateFilter: (_t = (_r = panel.options.stateFilter) !== null && _r !== void 0 ? _r : (_s = panel.stateFilter) === null || _s === void 0 ? void 0 : _s.reduce(function (filterObj, curFilter) {
            var _a;
            return (__assign(__assign({}, filterObj), (_a = {}, _a[curFilter] = true, _a)));
        }, {})) !== null && _t !== void 0 ? _t : {},
    };
    var previousVersion = parseFloat(panel.pluginVersion || '7.4');
