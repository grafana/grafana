import { FieldColorModeId, FieldConfigProperty, FieldType, identityOverrideProcessor, PanelPlugin, } from '@grafana/data';
...
import { defaultOptions, defaultFieldConfig } from './panelcfg.gen';
import { StatTimelineSuggestionsSupplier } from './suggestions';
export const plugin = new PanelPlugin(StateTimelinePanel)
