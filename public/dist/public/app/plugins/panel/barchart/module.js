import { FieldColorModeId, FieldConfigProperty, FieldType, getFieldDisplayName, identityOverrideProcessor, PanelPlugin, VizOrientation, } from '@grafana/data';
...
import { defaultFieldConfig, defaultOptions } from './panelcfg.gen';
...
export const plugin = new PanelPlugin(BarChartPanel)
    ...
    var _a, _b, _c, _d;
    const disp = prepareBarChartDisplayValues(context.data, config.theme2, (_a = context.options) !== null && _a !== void 0 ? _a : {});
    let xaxisPlaceholder = 'First string or time field';
    const viz = 'viz' in disp ? disp.viz[0] : undefined;
    if ((_b = viz === null || viz === void 0 ? void 0 : viz.fields) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    if (!((_c = context.options) === null || _c === void 0 ? void 0 : _c.fullHighlight) || ((_d = context.options) === null || _d === void 0 ? void 0 : _d.stacking) === StackingMode.None) {
