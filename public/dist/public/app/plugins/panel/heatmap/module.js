...
import { AxisPlacement, ScaleDistribution, HeatmapCellLayout, } from '@grafana/schema';
...
export const plugin = new PanelPlugin(HeatmapPanel)
    ...
    if (context.data.length > 0) {
        try {
            ...
            const v = prepareHeatmapData(context.data, undefined, opts, palette, config.theme2, undefined, context.replaceVariables);
    ...
    builder
        ...
        name: 'Placement',
        defaultValue: (_b = defaultOptions.yAxis.axisPlacement) !== null && _b !== void 0 ? _b : AxisPlacement.Left,
        category,
        settings: {
            options: [
    ...
    if (!opts.calculate) {
        builder.addRadio({
            ...
            name: 'Tick alignment',
            defaultValue: (_d = (_c = defaultOptions.rowsFrame) === null || _c === void 0 ? void 0 : _c.layout) !== null && _d !== void 0 ? _d : HeatmapCellLayout.auto,
            category,
            settings: {
                options: [
    ...
    builder
        ...
        editor: () => {
            ...
            return (React.createElement("div", null,
                React.createElement(ColorScale, { colorPalette: palette, min: 1, max: 100 })));
        },
    });
    builder
        .addNumberInput({
    ...
    if (!opts.calculate) {
        builder.addTextInput({
            ...
            name: 'Value name',
            defaultValue: (_e = defaultOptions.rowsFrame) === null || _e === void 0 ? void 0 : _e.value,
            settings: {
                placeholder: 'Value',
            },
            category,
    ...
    builder
        ...
        defaultValue: (_f = defaultOptions.filterValues) === null || _f === void 0 ? void 0 : _f.le,
        settings: {
            placeholder: 'None',
        },
        category,
        ...
        name: 'Hide cells with values >=',
        defaultValue: (_g = defaultOptions.filterValues) === null || _g === void 0 ? void 0 : _g.ge,
        settings: {
            placeholder: 'None',
        },
        category,
