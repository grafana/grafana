...
describe('Heatmap Migrations', () => {
    ...
    it('simple heatmap', () => {
        const panel = {};
        panel.options = heatmapChangedHandler(panel, 'heatmap', {
            angular: oldHeatmap,
        }, prevFieldConfig);
    ...
    it('Cell padding defaults', () => {
        // zero becomes 1
        expect(heatmapChangedHandler({}, 'heatmap', {
            angular: { cards: { cardPadding: 0 } },
        }, prevFieldConfig).cellGap).toEqual(1);
        // missing is 2
        expect(heatmapChangedHandler({}, 'heatmap', {
            angular: {},
        }, prevFieldConfig).cellGap).toEqual(2);
    });
});
const oldHeatmap = {
    id: 4,
