...
var HeatmapTooltip = /** @class */ (function () {
    ...
    HeatmapTooltip.prototype.show = function (pos, data) {
        ...
        var yData = find(xData.buckets, function (bucket, bucketIndex) {
    ...
    HeatmapTooltip.prototype.getXBucketIndex = function (x, data) {
        ...
        var xBucket = find(data.buckets, function (bucket) {
    ...
    HeatmapTooltip.prototype.addHistogram = function (data) {
        ...
        var histogramDomain = reduce(map(histogramData, function (d) { return d[1]; }), function (sum, val) { return sum + val; }, 0);
        var histYScale = d3.scaleLinear().domain([0, histogramDomain]).range([0, HISTOGRAM_HEIGHT]);
