...
describe('LogsPanel', function () {
    describe('when returned series include common labels', function () {
        var seriesWithCommonLabels = [
        ...
        it('shows common labels when showCommonLabels is set to true', function () {
        ...
        it('shows common labels on top when descending sort order', function () {
            var _a;
            var container = setup({
                data: { series: seriesWithCommonLabels },
                options: { showCommonLabels: true, sortOrder: LogsSortOrder.Descending },
            }).container;
            expect((_a = container.firstChild) === null || _a === void 0 ? void 0 : _a.childNodes[0].textContent).toMatch(/^Common labels:common_appcommon_job/);
        });
        it('shows common labels on bottom when ascending sort order', function () {
            var _a;
            var container = setup({
                data: { series: seriesWithCommonLabels },
        ...
        it('does not show common labels when showCommonLabels is set to false', function () {
    ...
    describe('when returned series does not include common labels', function () {
        var seriesWithoutCommonLabels = [
            new MutableDataFrame({
                fields: [
                    {
                        name: 'time',
        ...
        it('shows (no common labels) when showCommonLabels is set to true', function () {
...
var setup = function (propsOverrides) {
    var props = __assign({ data: {
        ...
        }, timeZone: 'utc', options: {}, title: 'Logs panel', id: 1 }, propsOverrides);
    return render(React.createElement(LogsPanel, __assign({}, props)));
};
//# sourceMappingURL=LogsPanel.test.js.map