...
export const TableCellOptionEditor = ({ value, onChange }) => {
    ...
    return (React.createElement("div", { className: styles.fixBottomMargin },
        React.createElement(Field, null,
            React.createElement(Select, { options: cellDisplayModeOptions, value: currentMode, onChange: onCellTypeChange })),
        cellType === TableCellDisplayMode.Gauge && (React.createElement(BarGaugeCellOptionsEditor, { cellOptions: value, onChange: onCellOptionsChange })),
        cellType === TableCellDisplayMode.ColorBackground && (React.createElement(ColorBackgroundCellOptionsEditor, { cellOptions: value, onChange: onCellOptionsChange })),
        cellType === TableCellDisplayMode.Sparkline && (React.createElement(SparklineCellOptionsEditor, { cellOptions: value, onChange: onCellOptionsChange }))));
};
...
//# sourceMappingURL=TableCellOptionEditor.js.map