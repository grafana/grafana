...
import { PanelModel as PanelModelState } from 'app/features/dashboard/state';
...
describe('Graph Migrations', () => {
    ...
    describe('time regions', () => {
        test('should migrate', () => {
            ...
            const panel = { datasource: { type: 'datasource', uid: 'gdev-testdata' } };
            ...
            expect(dashboard.annotations.list.filter((annotation) => { var _a; return ((_a = annotation.target) === null || _a === void 0 ? void 0 : _a.queryType) === GrafanaQueryType.TimeRegions; })).toHaveLength(1);
            expect(panel).toMatchSnapshot();
        });
    });
    describe('legend', () => {
