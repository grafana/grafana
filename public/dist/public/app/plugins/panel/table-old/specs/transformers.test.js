...
describe('when transforming time series table', function () {
    ...
    describe('given time series and table data', function () {
        var time = new Date().getTime();
        var data = [
            {
                target: 'series1',
...
describe('timeSeriesFormatFilterer', function () {
    describe('when called with an object that contains datapoints property', function () {
        it('then it should return same object in array', function () {
            var data = { datapoints: [] };
            var result = timeSeriesFormatFilterer(data);
            expect(result).toEqual([data]);
        });
    });
    describe('when called with an object that does not contain datapoints property', function () {
    ...
    describe('when called with an array of series with both timeseries and table data', function () {
        it('then it should return an array with timeseries', function () {
            var time = new Date().getTime();
            var data = [
                {
                    target: 'series1',
...
describe('tableDataFormatFilterer', function () {
    describe('when called with an object that contains columns property', function () {
        it('then it should return same object in array', function () {
            var data = { columns: [] };
            var result = tableDataFormatFilterer(data);
            expect(result).toEqual([data]);
        });
    });
    describe('when called with an object that does not contain columns property', function () {
        it('then it should return empty array', function () {
            var data = { prop: [] };
            var result = tableDataFormatFilterer(data);
            expect(result).toEqual([]);
    ...
    describe('when called with an array of series with both timeseries and table data', function () {
        it('then it should return an array with table data', function () {
            var time = new Date().getTime();
            var data = [
                {
                    target: 'series1',
