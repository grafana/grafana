    ...
    return (u) => {
        ...
        for (let i = idx0; i <= idx1; i++) {
            ...
            if (drawPrice && flatPath && upPath && downPath) {
                let outerPath = selectPath(colorStrategy === ColorStrategy.CloseClose ? interDir : intraDir, flatPath, upPath, downPath, i === idx0 && ColorStrategy.CloseClose ? false : flatAsUp);
                // stick
