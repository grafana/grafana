...
describe('Atom feed parser', () => {
    it('should successfully parse an atom feed', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(parsedFeed.items[0].content).toMatch(/Testing is the best because it lets you know your code isn't broken, probably./);
    }));
});
