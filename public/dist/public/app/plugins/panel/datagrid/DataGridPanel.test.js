...
import { ArrayVector, dateTime, FieldType, LoadingState } from '@grafana/data';
...
jest.mock('./utils', () => {
    ...
    return Object.assign(Object.assign({}, originalModule), { deleteRows: jest.fn(), clearCellsFromRangeSelection: jest.fn(), updateSnapshot: jest.fn() });
});
describe('DataGrid', () => {
    describe('when there is no data', () => {
        it('renders without error', () => {
            ...
            render(React.createElement(DataGridPanel, Object.assign({}, props)));
    ...
    describe('when there is data', () => {
        ...
        it('should open context menu on right click', () => __awaiter(void 0, void 0, void 0, function* () {
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            });
        ...
        it('should show correct deletion values when selection multiple rows', () => __awaiter(void 0, void 0, void 0, function* () {
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            });
        ...
        it('should show correct deletion values when selection multiple columns', () => __awaiter(void 0, void 0, void 0, function* () {
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            });
        ...
        it('editing a cell triggers publishing the snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const expectedField = Object.assign({}, props.data.series[0].fields[0]);
        ...
        it('should not be able to a edit cell when there is a grid selection', () => __awaiter(void 0, void 0, void 0, function* () {
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            });
        ...
        it('should add a new column', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should not add a new column if input is empty', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
        ...
        it('should add a new row', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
        ...
        it('should close context menu on right click', () => __awaiter(void 0, void 0, void 0, function* () {
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            });
        ...
        it('should clear cell when cell is selected and delete button clicked', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
        ...
        it('should clear row when row is selected delete button clicked', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
            const spyClearingCells = jest.spyOn(utils, 'clearCellsFromRangeSelection');
            const spyDeleteRows = jest.spyOn(utils, 'deleteRows');
            jest.useFakeTimers();
        ...
        it('should move column when column dragged and dropped', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            ...
            const df = Object.assign({}, props.data.series[0]);
        ...
        it('should move row when row dragged and dropped', () => __awaiter(void 0, void 0, void 0, function* () {
            const spy = jest.spyOn(utils, 'updateSnapshot');
            jest.useFakeTimers();
            render(React.createElement(DataGridPanel, Object.assign({}, props)), {
                wrapper: Context,
            ...
            fireEvent.mouseUp(canvas);
            const received = spy.mock.calls[spy.mock.calls.length - 1][0];
...
const Context = (props) => {
    return (React.createElement(React.Fragment, null,
        props.children,
        React.createElement("div", { id: "grafana-portal-container" })));
};
//# sourceMappingURL=DataGridPanel.test.js.map