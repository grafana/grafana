import { BigValueColorMode, BigValueTextMode, commonOptionsBuilder, sharedSingleStatMigrationHandler, } from '@grafana/ui';
...
export var plugin = new PanelPlugin(StatPanel)
    .useFieldConfig()
    .setPanelOptions(function (builder) {
    var mainCategory = ['Stat styles'];
