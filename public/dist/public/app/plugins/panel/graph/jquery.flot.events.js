...
var createAnnotationToolip = function (element, event, plot) {
    var injector = getLegacyAngularInjector();
...
var EventMarkers = /** @class */ (function () {
    ...
    EventMarkers.prototype.setupEvents = function (events) {
        var _this = this;
        var parts = partition(events, 'isRegion');
        var regions = parts[0];
        events = parts[1];
    ...
    EventMarkers.prototype.drawEvents = function () {
        ...
        $.each(this._events, function (index, event) {
            ...
            var insidePlot = _this._insidePlot(options.min) || _this._insidePlot(options.timeEnd);
            var overlapPlot = _this._overlapPlot(options.min, options.timeEnd);
    ...
    EventMarkers.prototype._buildDiv = function (event) {
        ...
        }, left, top, (_a = line.width()) !== null && _a !== void 0 ? _a : 1, (_b = line.height()) !== null && _b !== void 0 ? _b : 1);
        return drawableEvent;
    };
    /**
    ...
    EventMarkers.prototype._buildRegDiv = function (event) {
        ...
        var _c = __read([o.left, o.left + this._plot.width()], 2), xmin = _c[0], xmax = _c[1];
        var regionStart = Math.max(left, xmin);
        var regionEnd = Math.min(right, xmax);
        var regionOffset = right > xmax ? 0 : lineWidth; // only include lineWidth when right line is visible
        regionWidth = regionEnd - regionStart + regionOffset;
        each([left, right], function (position) {
        ...
        }, left, top, (_a = region.width()) !== null && _a !== void 0 ? _a : 1, (_b = region.height()) !== null && _b !== void 0 ? _b : 1);
        return drawableEvent;
    };
    /**
     ...
     */
    EventMarkers.prototype._overlapPlot = function (point0, point1) {
        var xaxis = this._plot.getXAxes()[this._plot.getOptions().events.xaxis - 1];
        var _a = __read([xaxis.p2c(point0), xaxis.p2c(point1)], 2), coord0 = _a[0], coord1 = _a[1];
        var _b = __read([0, xaxis.p2c(xaxis.max)], 2), coordMin = _b[0], coordMax = _b[1];
