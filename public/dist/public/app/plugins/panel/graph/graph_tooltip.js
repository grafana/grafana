...
export default function GraphTooltip(elem, dashboard, scope, getSeriesFn) {
    ...
    var hoverEvent = new LegacyGraphHoverEvent({ pos: {}, point: {}, panel: this.panel });
    ...
    elem.mouseleave(function () {
        var _a;
        if ((_a = panel.tooltip) === null || _a === void 0 ? void 0 : _a.shared) {
    ...
    this.show = function (pos, item) {
        ...
        if (pos.panelRelY) {
            ...
            var scrollTop = (_a = $(window).scrollTop()) !== null && _a !== void 0 ? _a : 0;
            var isVisible = pos.pageY >= scrollTop && pos.pageY <= $(window).innerHeight() + scrollTop;
            if (!isVisible) {
                self.clear(plot);
                return;
            }
        ...
        if (allSeriesMode) {
            ...
            for (i = 0; i < seriesHoverInfo.length; i++) {
                ...
                var color = textUtil.sanitize(hoverInfo.color);
                var label = textUtil.sanitize(hoverInfo.label);
                seriesHtml +=
            ...
            var color = textUtil.sanitize(item.series.color);
...
//# sourceMappingURL=graph_tooltip.js.map