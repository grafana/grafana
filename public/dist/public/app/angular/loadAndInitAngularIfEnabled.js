...
import { config, setAngularLoader, setLegacyAngularInjector, getDataSourceSrv, getBackendSrv, getTemplateSrv, } from '@grafana/runtime';
import { contextSrv } from 'app/core/core';
import { getDashboardSrv } from 'app/features/dashboard/services/DashboardSrv';
import { getTimeSrv } from 'app/features/dashboard/services/TimeSrv';
import { validationSrv } from 'app/features/manage-dashboards/services/ValidationSrv';
import { getLinkSrv } from 'app/features/panel/panellinks/link_srv';
export function loadAndInitAngularIfEnabled() {
            ...
            setLegacyAngularInjector({
                get: (key) => {
                    switch (key) {
                        ...
                        case 'datasourceSrv': {
                            deprecationWarning('getLegacyAngularInjector', 'datasourceSrv', 'use getDataSourceSrv() in @grafana/runtime');
...
//# sourceMappingURL=loadAndInitAngularIfEnabled.js.map