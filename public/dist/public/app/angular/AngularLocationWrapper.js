    ...
    url(newUrl) {
        ...
        if (newUrl !== undefined) {
            if (newUrl.startsWith('#')) {
                locationService.push(Object.assign(Object.assign({}, locationService.getLocation()), { hash: newUrl }));
            }
            else if (newUrl.startsWith('?')) {
                locationService.push(Object.assign(Object.assign({}, locationService.getLocation()), { search: newUrl }));
            }
