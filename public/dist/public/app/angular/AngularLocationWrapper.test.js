...
jest.mock('@grafana/data', () => (Object.assign(Object.assign({}, jest.requireActual('@grafana/data')), { deprecationWarning: () => { } })));
describe('AngularLocationWrapper', () => {
    ...
    beforeAll(() => {
        ...
        window.location = Object.assign(Object.assign({}, location), { hash: '#hash', host: 'localhost:3000', hostname: 'localhost', href: 'http://www.domain.com:9877/path/b?search=a&b=c&d#hash', origin: 'http://www.domain.com:9877', pathname: '/path/b', port: '9877', protocol: 'http:', search: '?search=a&b=c&d' });
    });
    afterAll(() => {
...
//# sourceMappingURL=AngularLocationWrapper.test.js.map