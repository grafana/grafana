...
describe('AngularLocationWrapper', function () {
    ...
    beforeAll(function () {
        ...
        window.location = __assign(__assign({}, location), { hash: '#hash', host: 'localhost:3000', hostname: 'localhost', href: 'http://www.domain.com:9877/path/b?search=a&b=c&d#hash', origin: 'http://www.domain.com:9877', pathname: '/path/b', port: '9877', protocol: 'http:', search: '?search=a&b=c&d' });
    });
    afterAll(function () {
        window.location = location;
    });
    var wrapper = new AngularLocationWrapper();
