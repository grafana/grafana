...
function link(scope, elem, attrs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { default: ace } = yield import(/* webpackChunkName: "brace" */ 'brace');
        yield import('brace/ext/language_tools');
        yield import('brace/theme/textmate');
        yield import('brace/mode/text');
        yield import('brace/snippets/text');
        yield import('brace/mode/sql');
        yield import('brace/snippets/sql');
        yield import('brace/mode/sqlserver');
        yield import('brace/snippets/sqlserver');
        yield import('brace/mode/markdown');
        yield import('brace/snippets/markdown');
        yield import('brace/mode/json');
        yield import('brace/snippets/json');
        // @ts-ignore
        yield import('./theme-grafana-dark');
