        ...
        link: function ($scope, elem, attrs) {
            ...
            if (attrs.ngModel) {
                $scope.$watch('model', function (newValue) {
                    each($scope.menuItems, function (item) {
                        each(item.submenu, function (subItem) {
            ...
            var typeaheadValues = reduce($scope.menuItems, function (memo, value, index) {
                if (!value.submenu) {
                    value.click = 'menuItemSelected(' + index + ')';
                    memo.push(value.text);
                }
                else {
                    each(value.submenu, function (item, subIndex) {
            ...
            $input.typeahead({
                ...
                updater: function (value) {
                    var result = {};
                    each($scope.menuItems, function (menuItem) {
                        each(menuItem.submenu, function (submenuItem) {
