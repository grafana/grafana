...
export function renderRuleEditor(identifier, recording = false) {
    if (identifier) {
    ...
    return render(React.createElement(TestProvider, null,
        React.createElement(Route, { path: ['/alerting/new/:type', '/alerting/:id/edit'], component: RuleEditor })));
}
//# sourceMappingURL=alertingRuleEditor.js.map