...
var LoginCtrl = /** @class */ (function () {
    /** @ngInject */
    function LoginCtrl($scope, backendSrv, contextSrv, $location) {
        $scope.formModel = {
            user: '',
            email: '',
            password: '',
        ...
        $scope.changeView = function () {
            ...
            var changePasswordView = document.querySelector('#change-password-view');
...
//# sourceMappingURL=login_ctrl.js.map