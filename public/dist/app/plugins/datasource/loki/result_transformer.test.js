...
describe('parseLabels()', function () {
    it('returns no labels on empty labels string', function () {
...
describe('formatLabels()', function () {
    it('returns no labels on empty label set', function () {
...
describe('mergeStreamsToLogs()', function () {
    ...
    it('detects ANSI codes', function () {
        expect(mergeStreamsToLogs([
            {
                labels: '{foo="bar"}',
                entries: [
                    {
