...
describe('ElasticDatasource', function () {
    ...
    var timeSrv = {
        ...
        timeRange: jest.fn(function () {
            return {
                from: dateMath.parse(_this.time.from, false),
                to: dateMath.parse(_this.time.to, true),
            };
        }),
    ...
    describe('When issuing metric query with interval pattern', function () {
        var requestOptions, parts, header, query;
        beforeEach(function () {
            createDatasource({
                url: 'http://es.com',
                index: '[asd-]YYYY.MM.DD',
        ...
        it('should resolve the alias variable', function () {
