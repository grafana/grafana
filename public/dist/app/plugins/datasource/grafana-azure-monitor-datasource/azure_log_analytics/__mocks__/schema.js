var FakeSchemaData = /** @class */ (function () {
    function FakeSchemaData() {
    }
    FakeSchemaData.getLogAnalyticsFakeSchema = function () {
        return {
            Tables: [
                {
                    TableName: 'Table_0',
    ...
    FakeSchemaData.getlogAnalyticsFakeMetadata = function () {
        return {
            tables: [
                {
                    id: 't/Alert',
            ...
            workspaces: [
                {
                    ...
                    name: 'danieltest',
                    resourceId: '/subscriptions/44693801-6ee6-49de-9b2d-999999999999/resourceGroups/danieltest/providers/' +
    ...
    return FakeSchemaData;
}());
export default FakeSchemaData;
