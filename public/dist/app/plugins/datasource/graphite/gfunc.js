...
var FuncInstance = /** @class */ (function () {
    ...
    FuncInstance.prototype.render = function (metricExp) {
        ...
        var parameters = _.map(this.params, function (value, index) {
            ...
            else if (_.get(_.last(_this.def.params), 'multiple')) {
                paramType = _.get(_.last(_this.def.params), 'type');
            }
...
function parseFuncDefs(rawDefs) {
    var funcDefs = {};
    _.forEach(rawDefs || {}, function (funcDef, funcName) {
        ...
        _.forEach(funcDef.params, function (rawParam) {
            var param = {
                name: rawParam.name,
                type: 'string',
