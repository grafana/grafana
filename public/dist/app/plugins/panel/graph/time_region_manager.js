...
var TimeRegionManager = /** @class */ (function () {
    ...
    TimeRegionManager.prototype.addFlotOptions = function (options, panel) {
        ...
        var tRange = { from: moment(this.panelCtrl.range.from).utc(), to: moment(this.panelCtrl.range.to).utc() };
        var i, hRange, timeRegion, regions, fromStart, fromEnd, timeRegionColor;
        var timeRegionsCopy = panel.timeRegions.map(function (a) { return (tslib_1.__assign({}, a)); });
