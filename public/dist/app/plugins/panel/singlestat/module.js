...
var SingleStatCtrl = /** @class */ (function (_super) {
    tslib_1.__extends(SingleStatCtrl, _super);
    /** @ngInject */
    ...
    SingleStatCtrl.prototype.setTableValues = function (tableData, data) {
        ...
        if (_.isString(data.value)) {
            ...
            var formatFunc = getValueFormat(this.panel.format);
    ...
    SingleStatCtrl.prototype.setValues = function (data) {
        ...
        if (this.series && this.series.length > 0) {
            ...
            if (this.panel.valueName === 'name') {
                ...
                var decimalInfo = this.getDecimalsForValue(data.value);
                data.valueFormatted = formatFunc(data.value, decimalInfo.decimals, decimalInfo.scaledDecimals, this.dashboard.isTimezoneUtc());
    ...
    SingleStatCtrl.prototype.link = function (scope, elem, attrs, ctrl) {
        ...
        function render() {
            ...
            data.colorMap = panel.colors.map(function (color) {
                return getColorFromHexRgbOrName(color, config.bootData.user.lightTheme ? GrafanaThemeType.Light : GrafanaThemeType.Dark);
            });
