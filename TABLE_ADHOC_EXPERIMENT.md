...
Dashboard tables use the Scenes-owned `table:view` stage. Standalone Explore,
Inspect, and Flamegraph tables keep the same config array locally and operate only
