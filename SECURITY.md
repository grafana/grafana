...
The key is available from [pgp.mit.edu](http://keys.gnupg.net/pks/lookup?search=0xF9887BEA027A049FAE8E5CAAD1258932BE24C5CA&fingerprint=on&op=index) by searching for [grafana](https://pgp.mit.edu/pks/lookup?search=grafana&op=index).
