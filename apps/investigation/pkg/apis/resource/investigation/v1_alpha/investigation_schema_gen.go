...
var (
	schemaInvestigation = resource.NewSimpleSchema("investigationsapp.ext.grafana.com", "v1-alpha", &Investigation{}, &InvestigationList{}, resource.WithKind("Investigation"),
