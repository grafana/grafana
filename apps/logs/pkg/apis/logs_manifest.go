			...
			Kinds: []app.ManifestVersionKind{
				{
					...
					Scope:      "Namespaced",
					Conversion: false,
					Schema:     &versionSchemaLogsv1alpha1,
				},
			},
...
func RemoteManifest() app.Manifest {
	return app.NewAPIServerManifest("logs")
}

var kindVersionToGoType = map[string]resource.Kind{
	"Logs/v1alpha1": v1alpha1.LogsKind(),
}
