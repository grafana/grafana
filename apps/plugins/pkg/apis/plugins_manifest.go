	...
	Versions: []app.ManifestVersion{
		{
			...
			Kinds: []app.ManifestVersionKind{
...

				{
					...
					Scope:      "Namespaced",
					Conversion: false,
					Schema:     &versionSchemaAppv0alpha1,
				},
			},
...
var kindVersionToGoType = map[string]resource.Kind{
	...
	"Meta/v0alpha1":   v0alpha1.MetaKind(),
	"App/v0alpha1":    v0alpha1.AppKind(),
}
