...
var appManifestData = app.ManifestData{
	...
	Roles: map[string]app.ManifestRole{
		"plugins:admin": {
			Title:       "plugins Admin",
			Description: "Allows all actions on Pluginsand Metas",
		...
		"plugins:editor": {
			...
			Description: "Create, Read, Update, and Delete Pluginsand Metas",
			Kinds: []app.ManifestRoleKind{
				{
					Kind:          "Plugin",
		...
		"plugins:reader": {
			...
			Description: "Read Pluginsand Metas",
			Kinds: []app.ManifestRoleKind{
				{
					Kind:          "Plugin",
