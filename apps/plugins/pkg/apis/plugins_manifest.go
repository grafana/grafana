...
var (
	...
	rawSchemaPluginInstallv0alpha1     = []byte(`{"OperatorState":{"additionalProperties":false,"properties":{"descriptiveState":{"description":"descriptiveState is an optional more descriptive state field which has no requirements on format","type":"string"},"details":{"additionalProperties":{"additionalProperties":{},"type":"object"},"description":"details contains any extra information that is operator-specific","type":"object"},"lastEvaluation":{"description":"lastEvaluation is the ResourceVersion last evaluated","type":"string"},"state":{"description":"state describes the state of the lastEvaluation.\nIt is limited to three possible states for machine evaluation.","enum":["success","in_progress","failed"],"type":"string"}},"required":["lastEvaluation","state"],"type":"object"},"PluginInstall":{"properties":{"spec":{"$ref":"#/components/schemas/spec"},"status":{"$ref":"#/components/schemas/status"}},"required":["spec"]},"spec":{"additionalProperties":false,"properties":{"pluginID":{"type":"string"},"source":{"additionalProperties":false,"properties":{"catalogOptions":{"additionalProperties":{},"type":"object"},"cdnOptions":{"additionalProperties":false,"properties":{"baseURL":{"type":"string"}},"required":["baseURL"],"type":"object"},"type":{"default":"catalog","description":"catalog, cdn, or url","type":"string"},"urlOptions":{"additionalProperties":false,"properties":{"checksum":{"type":"string"},"url":{"type":"string"}},"required":["url"],"type":"object"}},"required":["type"],"type":"object"},"version":{"type":"string"}},"required":["pluginID","version"],"type":"object"},"status":{"additionalProperties":false,"properties":{"additionalFields":{"additionalProperties":{"additionalProperties":{},"type":"object"},"description":"additionalFields is reserved for future use","type":"object"},"failedNodes":{"type":"integer"},"installingNodes":{"type":"integer"},"message":{"type":"string"},"nodeStatus":{"additionalProperties":{"additionalProperties":false,"properties":{"installedVersion":{"type":"string"},"lastReconciled":{"type":"string"},"message":{"type":"string"},"nodeName":{"type":"string"},"phase":{"type":"string"},"pluginClass":{"type":"string"}},"required":["nodeName","phase"],"type":"object"},"type":"object"},"operatorStates":{"additionalProperties":{"$ref":"#/components/schemas/OperatorState"},"description":"operatorStates is a map of operator ID to operator state evaluations.\nAny operator which consumes this kind SHOULD add its state evaluation information to this field.","type":"object"},"phase":{"description":"Pending, Installing, Ready, PartiallyFailed, Failed","type":"string"},"readyNodes":{"type":"integer"},"totalNodes":{"type":"integer"}},"type":"object"}}`)
