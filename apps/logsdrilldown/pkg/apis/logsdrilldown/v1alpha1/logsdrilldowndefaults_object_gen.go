...
type LogsDrilldownDefaults struct {
	...
	Spec LogsDrilldownDefaultsSpec `json:"spec" yaml:"spec"`
...
func (o *LogsDrilldownDefaults) SetSpec(spec any) error {
	cast, ok := spec.(LogsDrilldownDefaultsSpec)
	if !ok {
...
func (o *LogsDrilldownDefaults) SetSubresource(name string, value any) error {
	switch name {
	case "status":
		cast, ok := value.(LogsDrilldownDefaultsStatus)
		if !ok {
			return fmt.Errorf("cannot set status type %#v, not of type LogsDrilldownDefaultsStatus", value)
		}
		o.Status = cast
		return nil
	default:
...
func (s *LogsDrilldownDefaultsSpec) DeepCopy() *LogsDrilldownDefaultsSpec {
	cpy := &LogsDrilldownDefaultsSpec{}
	s.DeepCopyInto(cpy)
	return cpy
}

// DeepCopyInto deep copies Spec into another Spec object
func (s *LogsDrilldownDefaultsSpec) DeepCopyInto(dst *LogsDrilldownDefaultsSpec) {
	resource.CopyObjectInto(dst, s)
}

// DeepCopy creates a full deep copy of LogsDrilldownDefaultsStatus
func (s *LogsDrilldownDefaultsStatus) DeepCopy() *LogsDrilldownDefaultsStatus {
	cpy := &LogsDrilldownDefaultsStatus{}
	s.DeepCopyInto(cpy)
	return cpy
}

// DeepCopyInto deep copies LogsDrilldownDefaultsStatus into another LogsDrilldownDefaultsStatus object
func (s *LogsDrilldownDefaultsStatus) DeepCopyInto(dst *LogsDrilldownDefaultsStatus) {
	resource.CopyObjectInto(dst, s)
}
