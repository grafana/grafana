...
var ScopeResourceInfo = utils.NewResourceInfo(APIGroup, APIVersion,
	"scopes", "scope", "Scope",
...
var ScopeDashboardBindingResourceInfo = utils.NewResourceInfo(APIGroup, APIVersion,
...
var ScopeNavigationResourceInfo = utils.NewResourceInfo(APIGroup, APIVersion,
...
var ScopeNodeResourceInfo = utils.NewResourceInfo(APIGroup, APIVersion,
...
var (
	InternalGroupVersion = schema.GroupVersion{Group: APIGroup, Version: runtime.APIVersionInternal}
...
func init() {
	localSchemeBuilder.Register(func(s *runtime.Scheme) error {
		return AddKnownTypes(GroupVersion, s)
	})
}
