...
var (
	...
	rawSchemaIntegrationTypeSchemav0alpha1     = []byte(`{"Field":{"additionalProperties":false,"properties":{"dependsOn":{"type":"string"},"description":{"type":"string"},"element":{"type":"string"},"inputType":{"type":"string"},"label":{"type":"string"},"placeholder":{"type":"string"},"propertyName":{"type":"string"},"protected":{"type":"boolean"},"required":{"type":"boolean"},"secure":{"type":"boolean"},"selectOptions":{"items":{"$ref":"#/components/schemas/SelectOption"},"type":"array"},"showWhen":{"$ref":"#/components/schemas/ShowWhen"},"subformOptions":{"items":{"$ref":"#/components/schemas/Field"},"type":"array"},"validationRule":{"type":"string"}},"required":["element","inputType","label","description","placeholder","propertyName","showWhen","required","validationRule","secure","dependsOn"],"type":"object"},"IntegrationSchemaVersion":{"additionalProperties":false,"properties":{"canCreate":{"type":"boolean"},"deprecated":{"type":"boolean"},"info":{"type":"string"},"options":{"items":{"$ref":"#/components/schemas/Field"},"type":"array"},"typeAlias":{"type":"string"},"version":{"type":"string"}},"required":["version","canCreate","options"],"type":"object"},"IntegrationTypeSchema":{"properties":{"spec":{"$ref":"#/components/schemas/spec"}},"required":["spec"]},"SelectOption":{"additionalProperties":false,"properties":{"description":{"type":"string"},"label":{"type":"string"},"value":{"oneOf":[{"type":"string"},{"type":"number"}]}},"required":["label","value","description"],"type":"object"},"ShowWhen":{"additionalProperties":false,"properties":{"field":{"type":"string"},"is":{"type":"string"}},"required":["field","is"],"type":"object"},"spec":{"additionalProperties":false,"properties":{"currentVersion":{"type":"string"},"deprecated":{"type":"boolean"},"description":{"type":"string"},"heading":{"type":"string"},"info":{"type":"string"},"name":{"type":"string"},"type":{"type":"string"},"versions":{"items":{"$ref":"#/components/schemas/IntegrationSchemaVersion"},"type":"array"}},"required":["type","currentVersion","name","versions"],"type":"object"}}`)
	versionSchemaIntegrationTypeSchemav0alpha1 app.VersionSchema
	_                                          = json.Unmarshal(rawSchemaIntegrationTypeSchemav0alpha1, &versionSchemaIntegrationTypeSchemav0alpha1)
)
	...
	Versions: []app.ManifestVersion{
		{
			...
			Kinds: []app.ManifestVersionKind{
...

				{
					...
					Plural:     "IntegrationTypeSchemas",
					Scope:      "Namespaced",
					Conversion: false,
					Schema:     &versionSchemaIntegrationTypeSchemav0alpha1,
				},
			},
...
var kindVersionToGoType = map[string]resource.Kind{
	...
	"IntegrationTypeSchema/v0alpha1": v0alpha1.IntegrationTypeSchemaKind(),
}
