...
var (
	...
	rawSchemaReceiverv1beta1            = []byte(`{"EmailMimir1":{"additionalProperties":false,"properties":{"disableResolveMessage":{"type":"boolean"},"settings":{"additionalProperties":false,"properties":{"from":{"type":"string"},"html":{"type":"string"},"smarthost":{"type":"string"},"to":{"type":"string"}},"type":"object"},"type":{"const":"email","type":"string"},"uid":{"type":"string"},"variant":{"const":"email/v0mimir1","type":"string"},"version":{"const":"v0mimir1","type":"string"}},"required":["type","version","settings"],"type":"object"},"EmailV1":{"additionalProperties":false,"properties":{"disableResolveMessage":{"type":"boolean"},"settings":{"additionalProperties":false,"properties":{"addresses":{"type":"string"},"message":{"type":"string"},"singleEmail":{"type":"boolean"},"subject":{"type":"string"}},"required":["addresses"],"type":"object"},"type":{"const":"email","type":"string"},"uid":{"type":"string"},"variant":{"const":"email/v1","type":"string"},"version":{"const":"v1","type":"string"}},"required":["type","version","settings"],"type":"object"},"Integration":{"oneOf":[{"$ref":"#/components/schemas/EmailV1"},{"$ref":"#/components/schemas/EmailMimir1"},{"$ref":"#/components/schemas/SlackV1"},{"$ref":"#/components/schemas/SlackMimir1"},{"$ref":"#/components/schemas/WebhookV1"}]},"Receiver":{"properties":{"spec":{"$ref":"#/components/schemas/spec"}},"required":["spec"]},"SlackMimir1":{"additionalProperties":false,"properties":{"disableResolveMessage":{"type":"boolean"},"settings":{"additionalProperties":false,"properties":{"channel":{"type":"string"},"color":{"type":"string"},"fallback":{"type":"string"}},"type":"object"},"type":{"const":"slack","type":"string"},"uid":{"type":"string"},"variant":{"const":"slack/v0mimir1","type":"string"},"version":{"const":"v0mimir1","type":"string"}},"required":["type","version","settings"],"type":"object"},"SlackV1":{"additionalProperties":false,"properties":{"disableResolveMessage":{"type":"boolean"},"secureFields":{"additionalProperties":false,"properties":{"token":{"type":"boolean"},"url":{"type":"boolean"}},"type":"object"},"settings":{"additionalProperties":false,"properties":{"endpointUrl":{"type":"string"},"mentionChannel":{"type":"string"},"recipient":{"type":"string"},"text":{"type":"string"},"title":{"type":"string"},"username":{"type":"string"}},"type":"object"},"type":{"const":"slack","type":"string"},"uid":{"type":"string"},"variant":{"const":"slack/v1","type":"string"},"version":{"const":"v1","type":"string"}},"required":["type","version","settings"],"type":"object"},"WebhookV1":{"additionalProperties":false,"properties":{"disableResolveMessage":{"type":"boolean"},"secureFields":{"additionalProperties":{"type":"boolean"},"type":"object"},"settings":{"additionalProperties":false,"properties":{"httpMethod":{"type":"string"},"maxAlerts":{"type":"integer"},"url":{"type":"string"}},"required":["url"],"type":"object"},"type":{"const":"webhook","type":"string"},"uid":{"type":"string"},"variant":{"const":"webhook/v1","type":"string"},"version":{"const":"v1","type":"string"}},"required":["type","version","settings"],"type":"object"},"createReceiverIntegrationTestAlert":{"type":"object","required":["labels","annotations"],"properties":{"annotations":{"type":"object","additionalProperties":{"type":"string"}},"labels":{"type":"object","additionalProperties":{"type":"string"}}},"additionalProperties":false},"createReceiverIntegrationTestIntegrationInput":{"description":"The test route takes one integration in its request body, and codegen does not allow\na union there, so the route keeps the flat shape.","type":"object","required":["type","version","settings"],"properties":{"disableResolveMessage":{"type":"boolean"},"secureFields":{"type":"object","additionalProperties":{"type":"boolean"}},"settings":{"type":"object","additionalProperties":true},"type":{"type":"string"},"uid":{"type":"string"},"version":{"type":"string"}},"additionalProperties":false},"spec":{"additionalProperties":false,"properties":{"integrations":{"items":{"$ref":"#/components/schemas/Integration"},"type":"array"},"title":{"type":"string"}},"required":["title","integrations"],"type":"object"}}`)
