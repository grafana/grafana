...
var (
	schemaTemplateGroup = resource.NewSimpleSchema("notifications.alerting.grafana.app", "v1beta1", NewTemplateGroup(), &TemplateGroupList{}, resource.WithKind("TemplateGroup"),
