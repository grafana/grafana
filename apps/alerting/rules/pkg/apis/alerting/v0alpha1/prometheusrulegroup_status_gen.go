...
func (PrometheusRuleGroupstatusOperatorState) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.alerting.rules.pkg.apis.alerting.v0alpha1.PrometheusRuleGroupstatusOperatorState"
}
...
func (PrometheusRuleGroupStatus) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.alerting.rules.pkg.apis.alerting.v0alpha1.PrometheusRuleGroupStatus"
}
...
func (PrometheusRuleGroupStatusOperatorStateState) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.alerting.rules.pkg.apis.alerting.v0alpha1.PrometheusRuleGroupStatusOperatorStateState"
}
