...
func (in *EnricherConfig) DeepCopyInto(out *EnricherConfig) {
	*out = *in
	...
	if in.QuerySample != nil {
		in, out := &in.QuerySample, &out.QuerySample
		*out = new(QuerySampleEnricher)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuerySampleEnricher) DeepCopyInto(out *QuerySampleEnricher) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuerySampleEnricher.
func (in *QuerySampleEnricher) DeepCopy() *QuerySampleEnricher {
	if in == nil {
		return nil
	}
	out := new(QuerySampleEnricher)
