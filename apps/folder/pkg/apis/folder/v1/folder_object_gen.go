...
//
// PoC shortcut: the Status field/subresource wiring below (GetSubresources, GetSubresource,
// SetSubresource "status" cases, and the Status DeepCopy call) was hand-added rather than
// regenerated from apps/folder/kinds/folder.cue. Re-running app-sdk codegen should reproduce this
// shape; see folder_status_gen.go for the corresponding hand-written status type.
//
...
func (Folder) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.folder.pkg.apis.folder.v1.Folder"
}
...
func (FolderList) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.folder.pkg.apis.folder.v1.FolderList"
}
