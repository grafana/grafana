...
var (
	schemaGlobalRoleBinding = resource.NewSimpleSchema("authz.grafana.app", "v0alpha1", &GlobalRoleBinding{}, &GlobalRoleBindingList{}, resource.WithKind("GlobalRoleBinding"),
