...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.Preferences":                       schema_pkg_apis_preferences_v0alpha1_Preferences(ref),
		"github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.PreferencesCookiePreferences":      schema_pkg_apis_preferences_v0alpha1_PreferencesCookiePreferences(ref),
		"github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.PreferencesList":                   schema_pkg_apis_preferences_v0alpha1_PreferencesList(ref),
...
func schema_pkg_apis_preferences_v0alpha1_Preferences(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_preferences_v0alpha1_PreferencesCookiePreferences(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_preferences_v0alpha1_PreferencesList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.Preferences"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.Preferences", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_preferences_v0alpha1_PreferencesNavbarPreference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_preferences_v0alpha1_PreferencesQueryHistoryPreference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_preferences_v0alpha1_PreferencesSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"queryHistory": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.PreferencesQueryHistoryPreference"),
						},
					},
					"cookiePreferences": {
						SchemaProps: spec.SchemaProps{
							Description: "Cookie preferences",
							Ref:         ref("github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.PreferencesCookiePreferences"),
						},
					},
					"navbar": {
						SchemaProps: spec.SchemaProps{
							Description: "Navigation preferences",
							Ref:         ref("github.com/grafana/grafana/apps/preferences/pkg/apis/preferences/v0alpha1.PreferencesNavbarPreference"),
						},
					},
				},
			},
