...
func TestMigrateCommunityDashboards(t *testing.T) {
	...
	ResetForTesting()
	Initialize(migrationtestutil.NewDataSourceProvider(migrationtestutil.StandardTestConfig), migrationtestutil.NewLibraryElementProvider(), DefaultCacheTTL)
...
func TestMigrateHistoricalDevDashboards(t *testing.T) {
	...
	// to match the frontend devDashboardDataSources configuration
	ResetForTesting()
	Initialize(migrationtestutil.NewDataSourceProvider(migrationtestutil.DevDashboardConfig), migrationtestutil.NewLibraryElementProvider(), DefaultCacheTTL)
