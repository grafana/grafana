...
func convertElement_V2alpha1_to_V2beta1(in *dashv2alpha1.DashboardElement, out *dashv2beta1.DashboardElement, scope conversion.Scope) error {
	...
	if in.CellKind != nil {
		out.CellKind = &dashv2beta1.DashboardCellKind{
			Kind: in.CellKind.Kind,
		}
		convertCellContent_V2alpha1_to_V2beta1(&in.CellKind.Spec.Content, &out.CellKind.Spec.Content)
		return nil
	}
...
// convertCellContent_V2alpha1_to_V2beta1 copies a notebook cell's content union. The
...
func convertCellContent_V2alpha1_to_V2beta1(in *dashv2alpha1.DashboardCellContentKind, out *dashv2beta1.DashboardCellContentKind) {
	if in.MarkdownCellContentKind != nil {
		out.MarkdownCellContentKind = &dashv2beta1.DashboardMarkdownCellContentKind{
			Kind: in.MarkdownCellContentKind.Kind,
			Spec: dashv2beta1.DashboardMarkdownCellContentSpec{
	...
	if in.CodeCellContentKind != nil {
		out.CodeCellContentKind = &dashv2beta1.DashboardCodeCellContentKind{
			Kind: in.CodeCellContentKind.Kind,
			Spec: dashv2beta1.DashboardCodeCellContentSpec{
...
func convertLayout_V2alpha1_to_V2beta1(in *dashv2alpha1.DashboardGridLayoutKindOrRowsLayoutKindOrAutoGridLayoutKindOrTabsLayoutKindOrNotebookLayoutKind, out *dashv2beta1.DashboardGridLayoutKindOrRowsLayoutKindOrAutoGridLayoutKindOrTabsLayoutKindOrNotebookLayoutKind, scope conversion.Scope) error {
	...
	if in.NotebookLayoutKind != nil {
		out.NotebookLayoutKind = &dashv2beta1.DashboardNotebookLayoutKind{
			Kind: in.NotebookLayoutKind.Kind,
		}
		convertNotebookLayoutSpec_V2alpha1_to_V2beta1(&in.NotebookLayoutKind.Spec, &out.NotebookLayoutKind.Spec)
		return nil
	}
...
// convertNotebookLayoutSpec_V2alpha1_to_V2beta1 copies the notebook layout 1:1. The
...
func convertNotebookLayoutSpec_V2alpha1_to_V2beta1(in *dashv2alpha1.DashboardNotebookLayoutSpec, out *dashv2beta1.DashboardNotebookLayoutSpec) {
	out.Cells = make([]dashv2beta1.DashboardNotebookLayoutItemKind, len(in.Cells))
	for i, cell := range in.Cells {
		out.Cells[i] = dashv2beta1.DashboardNotebookLayoutItemKind{
			Kind: cell.Kind,
			Spec: dashv2beta1.DashboardNotebookLayoutItemSpec{
				Element: dashv2beta1.DashboardElementReference{
					Kind: cell.Spec.Element.Kind,
					Name: cell.Spec.Element.Name,
				},
				Source:    dashv2beta1.DashboardNotebookLayoutItemSpecSource(cell.Spec.Source),
...
// convertTabLayout_V2alpha1_to_V2beta1 converts a tab's nested layout. NotebookLayout is
// a top-level-only layout (it cannot nest in a tab), so this handles the four nestable
// kinds and intentionally does not delegate to convertLayout_V2alpha1_to_V2beta1.
