...
func RegisterConversions(s *runtime.Scheme, dsIndexProvider schemaversion.DataSourceIndexProvider, leIndexProvider schemaversion.LibraryElementIndexProvider) error {
	...
	if err := s.AddConversionFunc((*dashv0.Dashboard)(nil), (*dashv2beta2.Dashboard)(nil),
		withConversionMetrics(dashv0.APIVERSION, dashv2beta2.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V0_to_V2beta2(a.(*dashv0.Dashboard), b.(*dashv2beta2.Dashboard), scope, dsIndexProvider, leIndexProvider)
		})); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*dashv1.Dashboard)(nil), (*dashv2beta2.Dashboard)(nil),
		withConversionMetrics(dashv1.APIVERSION, dashv2beta2.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V1beta1_to_V2beta2(a.(*dashv1.Dashboard), b.(*dashv2beta2.Dashboard), scope, dsIndexProvider, leIndexProvider)
		})); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*dashv2alpha1.Dashboard)(nil), (*dashv2beta2.Dashboard)(nil),
		withConversionMetrics(dashv2alpha1.APIVERSION, dashv2beta2.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2alpha1_to_V2beta2(a.(*dashv2alpha1.Dashboard), b.(*dashv2beta2.Dashboard), scope)
		})); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*dashv2beta1.Dashboard)(nil), (*dashv2beta2.Dashboard)(nil),
		withConversionMetrics(dashv2beta1.APIVERSION, dashv2beta2.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2beta1_to_V2beta2(a.(*dashv2beta1.Dashboard), b.(*dashv2beta2.Dashboard), scope)
		})); err != nil {
		return err
	}

	// v2beta2 conversions
	if err := s.AddConversionFunc((*dashv2beta2.Dashboard)(nil), (*dashv0.Dashboard)(nil),
		withConversionMetrics(dashv2beta2.APIVERSION, dashv0.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2beta2_to_V0(a.(*dashv2beta2.Dashboard), b.(*dashv0.Dashboard), scope, dsIndexProvider)
		})); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*dashv2beta2.Dashboard)(nil), (*dashv1.Dashboard)(nil),
		withConversionMetrics(dashv2beta2.APIVERSION, dashv1.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2beta2_to_V1beta1(a.(*dashv2beta2.Dashboard), b.(*dashv1.Dashboard), scope, dsIndexProvider)
		})); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*dashv2beta2.Dashboard)(nil), (*dashv2alpha1.Dashboard)(nil),
		withConversionMetrics(dashv2beta2.APIVERSION, dashv2alpha1.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2beta2_to_V2alpha1(a.(*dashv2beta2.Dashboard), b.(*dashv2alpha1.Dashboard), scope)
		})); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*dashv2beta2.Dashboard)(nil), (*dashv2beta1.Dashboard)(nil),
		withConversionMetrics(dashv2beta2.APIVERSION, dashv2beta1.APIVERSION, func(a, b interface{}, scope conversion.Scope) error {
			return Convert_V2beta2_to_V2beta1(a.(*dashv2beta2.Dashboard), b.(*dashv2beta1.Dashboard), scope)
		})); err != nil {
		return err
	}
