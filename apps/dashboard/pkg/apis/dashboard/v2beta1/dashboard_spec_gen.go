...
func (DashboardDashboardPreferences) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v2beta1.DashboardDashboardPreferences"
}
...
type DashboardSpec struct {
	Preferences DashboardDashboardPreferences  `json:"preferences"`
...
func NewDashboardSpec() *DashboardSpec {
	return &DashboardSpec{
		Preferences:  *NewDashboardDashboardPreferences(),
...
func (DashboardAutoGridLayoutKindOrGridLayoutKind) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v2beta1.DashboardAutoGridLayoutKindOrGridLayoutKind"
}
