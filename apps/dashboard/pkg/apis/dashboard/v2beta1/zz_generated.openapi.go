...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		NotebookMarkdownCellContentKindOrCodeCellContentKindOrQueryCellContentKind{}.OpenAPIModelName(): schema_pkg_apis_dashboard_v2beta1_NotebookMarkdownCellContentKindOrCodeCellContentKindOrQueryCellContentKind(ref),
		...
		NotebookQueryCellContentKind{}.OpenAPIModelName():                                               schema_pkg_apis_dashboard_v2beta1_NotebookQueryCellContentKind(ref),
		NotebookQueryCellContentSpec{}.OpenAPIModelName():                                               schema_pkg_apis_dashboard_v2beta1_NotebookQueryCellContentSpec(ref),
...
func schema_pkg_apis_dashboard_v2beta1_NotebookCellKind(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "A cell holds non-panel narrative content (markdown text, code, an ad hoc query) in a notebook layout. Panel cells are not represented here — they reuse V2PanelKind.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_dashboard_v2beta1_NotebookCellSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"content": {
						SchemaProps: spec.SchemaProps{
							Ref: ref(NotebookMarkdownCellContentKindOrCodeCellContentKindOrQueryCellContentKind{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			NotebookMarkdownCellContentKindOrCodeCellContentKindOrQueryCellContentKind{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_dashboard_v2beta1_NotebookMarkdownCellContentKindOrCodeCellContentKindOrQueryCellContentKind(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"QueryCellContentKind": {
						SchemaProps: spec.SchemaProps{
							Ref: ref(NotebookQueryCellContentKind{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			NotebookCodeCellContentKind{}.OpenAPIModelName(), NotebookMarkdownCellContentKind{}.OpenAPIModelName(), NotebookQueryCellContentKind{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_dashboard_v2beta1_NotebookQueryCellContentKind(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "An ad hoc, Explore-like query: pick a datasource, write a query, run it, see a graph. Unlike a V2PanelKind, results are never persisted here — only the query itself, so re-opening a notebook never re-triggers a datasource call on its own. `query`/`queryOptions` reuse the same shared dashboard leaf types the panel chain below does (see its own comment on that).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(NotebookQueryCellContentSpec{}.OpenAPIModelName()),
						},
					},
				},
				Required: []string{"kind", "spec"},
		...
		Dependencies: []string{
			NotebookQueryCellContentSpec{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_dashboard_v2beta1_NotebookQueryCellContentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			NotebookPanelQueryKind{}.OpenAPIModelName(), NotebookQueryOptionsSpec{}.OpenAPIModelName()},
	}
}
