...
// +k8s:openapi-gen=true
type NotebookNotebookElement = NotebookPanelKindOrLibraryPanelKindOrCellKind
...
func NewNotebookNotebookElement() *NotebookNotebookElement {
	return NewNotebookPanelKindOrLibraryPanelKindOrCellKind()
}
...
// +k8s:openapi-gen=true
type NotebookPanelKindOrLibraryPanelKindOrCellKind struct {
...
// NewNotebookPanelKindOrLibraryPanelKindOrCellKind creates a new NotebookPanelKindOrLibraryPanelKindOrCellKind object.
func NewNotebookPanelKindOrLibraryPanelKindOrCellKind() *NotebookPanelKindOrLibraryPanelKindOrCellKind {
	return &NotebookPanelKindOrLibraryPanelKindOrCellKind{}
}

// MarshalJSON implements a custom JSON marshalling logic to encode `NotebookPanelKindOrLibraryPanelKindOrCellKind` as JSON.
func (resource NotebookPanelKindOrLibraryPanelKindOrCellKind) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements a custom JSON unmarshalling logic to decode `NotebookPanelKindOrLibraryPanelKindOrCellKind` from JSON.
func (resource *NotebookPanelKindOrLibraryPanelKindOrCellKind) UnmarshalJSON(raw []byte) error {
	if raw == nil {
		return nil
	}
...
// OpenAPIModelName returns the OpenAPI model name for NotebookPanelKindOrLibraryPanelKindOrCellKind.
func (NotebookPanelKindOrLibraryPanelKindOrCellKind) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v2beta1.NotebookPanelKindOrLibraryPanelKindOrCellKind"
}
