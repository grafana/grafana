...
func (c *DashboardClient) UpdateContext(ctx context.Context, identifier resource.Identifier, newContext DashboardContext, opts resource.UpdateOptions) (*Dashboard, error) {
