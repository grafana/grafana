...
func (DashboardItemOverrideRule) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v2.DashboardItemOverrideRule"
}
...
func (DashboardItemMatcherConfig) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v2.DashboardItemMatcherConfig"
}
