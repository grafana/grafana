...
func (DashboardConversionStatus) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v3alpha0.DashboardConversionStatus"
}
...
func (DashboardStatus) OpenAPIModelName() string {
	return "com.github.grafana.grafana.apps.dashboard.pkg.apis.dashboard.v3alpha0.DashboardStatus"
}
