...
// GetBotUserID provides a mock function with given fields: ctx, slug
func (_m *MockClient) GetBotUserID(ctx context.Context, slug string) (int64, error) {
	ret := _m.Called(ctx, slug)

	if len(ret) == 0 {
		panic("no return value specified for GetBotUserID")
	}
...
// MockClient_GetBotUserID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetBotUserID'
type MockClient_GetBotUserID_Call struct {
	*mock.Call
}

// GetBotUserID is a helper method to define mock.On call
//   - ctx context.Context
//   - slug string
func (_e *MockClient_Expecter) GetBotUserID(ctx interface{}, slug interface{}) *MockClient_GetBotUserID_Call {
	return &MockClient_GetBotUserID_Call{Call: _e.mock.On("GetBotUserID", ctx, slug)}
}

func (_c *MockClient_GetBotUserID_Call) Run(run func(ctx context.Context, slug string)) *MockClient_GetBotUserID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockClient_GetBotUserID_Call) Return(_a0 int64, _a1 error) *MockClient_GetBotUserID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_GetBotUserID_Call) RunAndReturn(run func(context.Context, string) (int64, error)) *MockClient_GetBotUserID_Call {
	_c.Call.Return(run)
	return _c
}
