...
func TestConnection_Test(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			conn := github.NewConnection(tt.connection, mockFactory, github.ConfigFromConnection(tt.connection), tt.secrets)
...
func TestConnection_TokenCreationTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			conn := github.NewConnection(connection, mockFactory, github.ConfigFromConnection(connection), tt.secrets)
...
func TestConnection_GenerateRepositoryToken(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			conn := github.NewConnection(tt.connection, mockFactory, github.ConfigFromConnection(tt.connection), github.ConnectionSecrets{
...
func TestConnection_ListRepositories(t *testing.T) {
	t.Run("should list repositories successfully", func(t *testing.T) {
		...
		conn := github.NewConnection(c, mockFactory, github.ConfigFromConnection(c), github.ConnectionSecrets{
...
func TestConnection_Test_GitHubEnterpriseURLs(t *testing.T) {
	...
	c := github.NewConnection(conn, &github.Factory{}, github.ConfigFromConnection(conn), github.ConnectionSecrets{
		PrivateKey: common.RawSecureValue(privateKeyBase64),
		Token:      token,
	})
