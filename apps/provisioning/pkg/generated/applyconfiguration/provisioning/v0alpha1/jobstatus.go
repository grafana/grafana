...
// WithUpdateCount sets the UpdateCount field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the UpdateCount field is set to the value of the last call.
func (b *JobStatusApplyConfiguration) WithUpdateCount(value int64) *JobStatusApplyConfiguration {
	b.UpdateCount = &value
	return b
}
