...
type HealthStatusApplyConfiguration struct {
	...
	Error *provisioningv1beta1.HealthFailureType `json:"error,omitempty"`
...
func (b *HealthStatusApplyConfiguration) WithError(value provisioningv1beta1.HealthFailureType) *HealthStatusApplyConfiguration {
	b.Error = &value
	return b
}
