...
type SyncOptionsApplyConfiguration struct {
	...
	Target *provisioningv1beta1.SyncTargetType `json:"target,omitempty"`
...
func (b *SyncOptionsApplyConfiguration) WithTarget(value provisioningv1beta1.SyncTargetType) *SyncOptionsApplyConfiguration {
	b.Target = &value
	return b
}
