...
type ConnectionSecureApplyConfiguration struct {
	...
	PrivateKey *v0alpha1.InlineSecureValue `json:"privateKey,omitempty"`
	...
	// This value is stored securely and cannot be read back
	ClientSecret *v0alpha1.InlineSecureValue `json:"clientSecret,omitempty"`
...
func (b *ConnectionSecureApplyConfiguration) WithPrivateKey(value v0alpha1.InlineSecureValue) *ConnectionSecureApplyConfiguration {
	b.PrivateKey = &value
	return b
}
...
func (b *ConnectionSecureApplyConfiguration) WithClientSecret(value v0alpha1.InlineSecureValue) *ConnectionSecureApplyConfiguration {
...
func (b *ConnectionSecureApplyConfiguration) WithToken(value v0alpha1.InlineSecureValue) *ConnectionSecureApplyConfiguration {
	b.Token = &value
	return b
}
