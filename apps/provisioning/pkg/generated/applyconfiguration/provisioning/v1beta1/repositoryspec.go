...
type RepositorySpecApplyConfiguration struct {
	...
	Workflows []provisioningv1beta1.Workflow `json:"workflows,omitempty"`
	...
	Type *provisioningv1beta1.RepositoryType `json:"type,omitempty"`
...
func (b *RepositorySpecApplyConfiguration) WithWorkflows(values ...provisioningv1beta1.Workflow) *RepositorySpecApplyConfiguration {
	for i := range values {
...
func (b *RepositorySpecApplyConfiguration) WithType(value provisioningv1beta1.RepositoryType) *RepositorySpecApplyConfiguration {
	b.Type = &value
	return b
}
