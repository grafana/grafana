...
type JobStatusApplyConfiguration struct {
	...
	Summary []*provisioningv1beta1.JobResourceSummary `json:"summary,omitempty"`
...
func (b *JobStatusApplyConfiguration) WithState(value provisioningv1beta1.JobState) *JobStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *JobStatusApplyConfiguration) WithSummary(values ...**provisioningv1beta1.JobResourceSummary) *JobStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
