...
type SecureValuesApplyConfiguration struct {
	...
	Token *v0alpha1.InlineSecureValue `json:"token,omitempty"`
	// Some webhooks (including github) require a secret key value
	WebhookSecret *v0alpha1.InlineSecureValue `json:"webhookSecret,omitempty"`
}
...
func (b *SecureValuesApplyConfiguration) WithToken(value v0alpha1.InlineSecureValue) *SecureValuesApplyConfiguration {
	b.Token = &value
	return b
}
...
func (b *SecureValuesApplyConfiguration) WithWebhookSecret(value v0alpha1.InlineSecureValue) *SecureValuesApplyConfiguration {
