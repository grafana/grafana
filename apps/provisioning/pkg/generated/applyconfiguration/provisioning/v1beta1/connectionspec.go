...
type ConnectionSpecApplyConfiguration struct {
	...
	Type *provisioningv1beta1.ConnectionType `json:"type,omitempty"`
	// The connection URL
...
func (b *ConnectionSpecApplyConfiguration) WithType(value provisioningv1beta1.ConnectionType) *ConnectionSpecApplyConfiguration {
	b.Type = &value
	return b
}
