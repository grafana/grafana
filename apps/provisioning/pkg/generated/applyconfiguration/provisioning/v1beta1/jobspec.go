...
type JobSpecApplyConfiguration struct {
	Action *provisioningv1beta1.JobAction `json:"action,omitempty"`
...
func (b *JobSpecApplyConfiguration) WithAction(value provisioningv1beta1.JobAction) *JobSpecApplyConfiguration {
	b.Action = &value
	return b
}
