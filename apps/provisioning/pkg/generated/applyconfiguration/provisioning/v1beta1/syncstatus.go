...
type SyncStatusApplyConfiguration struct {
	...
	State *provisioningv1beta1.JobState `json:"state,omitempty"`
...
func (b *SyncStatusApplyConfiguration) WithState(value provisioningv1beta1.JobState) *SyncStatusApplyConfiguration {
	b.State = &value
	return b
}
