...
type RepositoryInformer interface {
	...
	Lister() provisioningv1beta1.RepositoryLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1beta1().Repositories(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Repositories(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Repositories(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Repositories(namespace).Watch(ctx, options)
			},
		}, client),
		&apisprovisioningv1beta1.Repository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprovisioningv1beta1.Repository{}, f.defaultInformer)
}

func (f *repositoryInformer) Lister() provisioningv1beta1.RepositoryLister {
	return provisioningv1beta1.NewRepositoryLister(f.Informer().GetIndexer())
}
