...
type ConnectionInformer interface {
	...
	Lister() provisioningv1beta1.ConnectionLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1beta1().Connections(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Connections(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Connections(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Connections(namespace).Watch(ctx, options)
			},
		}, client),
		&apisprovisioningv1beta1.Connection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *connectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprovisioningv1beta1.Connection{}, f.defaultInformer)
}

func (f *connectionInformer) Lister() provisioningv1beta1.ConnectionLister {
	return provisioningv1beta1.NewConnectionLister(f.Informer().GetIndexer())
}
