...
type HistoricJobInformer interface {
	...
	Lister() provisioningv1beta1.HistoricJobLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1beta1().HistoricJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().HistoricJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().HistoricJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().HistoricJobs(namespace).Watch(ctx, options)
			},
		}, client),
		&apisprovisioningv1beta1.HistoricJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *historicJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprovisioningv1beta1.HistoricJob{}, f.defaultInformer)
}

func (f *historicJobInformer) Lister() provisioningv1beta1.HistoricJobLister {
	return provisioningv1beta1.NewHistoricJobLister(f.Informer().GetIndexer())
}
