...
import (
	...
	apisprovisioningv1beta1 "github.com/grafana/grafana/apps/provisioning/pkg/apis/provisioning/v1beta1"
	...
	provisioningv1beta1 "github.com/grafana/grafana/apps/provisioning/pkg/generated/listers/provisioning/v1beta1"
...
type JobInformer interface {
	...
	Lister() provisioningv1beta1.JobLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1beta1().Jobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Jobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Jobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1beta1().Jobs(namespace).Watch(ctx, options)
			},
		}, client),
		&apisprovisioningv1beta1.Job{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprovisioningv1beta1.Job{}, f.defaultInformer)
}

func (f *jobInformer) Lister() provisioningv1beta1.JobLister {
	return provisioningv1beta1.NewJobLister(f.Informer().GetIndexer())
}
