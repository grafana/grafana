...
func TestIsWriteAllowed(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantErr:     true,
			expectedErr: "write is not supported on resources of kind \"repositories.provisioning.grafana.app\"",
		...
		},
		{
			...
			ref:         "feature-branch",
			wantErr:     true,
			expectedErr: "branch is not supported on resources of kind \"repositories.provisioning.grafana.app\"",
			statusCode:  http.StatusMethodNotAllowed,
		},
		{
