...
func (_m *MockGitRepository) ValidatePermissions(ctx context.Context) ([]repository.Permission, error) {
	ret := _m.Called(ctx)
...
// MockGitRepository_ValidatePermissions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidatePermissions'
type MockGitRepository_ValidatePermissions_Call struct {
	*mock.Call
}

// ValidatePermissions is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockGitRepository_Expecter) ValidatePermissions(ctx interface{}) *MockGitRepository_ValidatePermissions_Call {
	return &MockGitRepository_ValidatePermissions_Call{Call: _e.mock.On("ValidatePermissions", ctx)}
}

func (_c *MockGitRepository_ValidatePermissions_Call) Run(run func(ctx context.Context)) *MockGitRepository_ValidatePermissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockGitRepository_ValidatePermissions_Call) Return(_a0 []repository.Permission, _a1 error) *MockGitRepository_ValidatePermissions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGitRepository_ValidatePermissions_Call) RunAndReturn(run func(context.Context) ([]repository.Permission, error)) *MockGitRepository_ValidatePermissions_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockGitRepository_WithMaxFileSize_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WithMaxFileSize'
type MockGitRepository_WithMaxFileSize_Call struct {
	*mock.Call
}

// WithMaxFileSize is a helper method to define mock.On call
//   - maxBytes int64
func (_e *MockGitRepository_Expecter) WithMaxFileSize(maxBytes interface{}) *MockGitRepository_WithMaxFileSize_Call {
	return &MockGitRepository_WithMaxFileSize_Call{Call: _e.mock.On("WithMaxFileSize", maxBytes)}
}

func (_c *MockGitRepository_WithMaxFileSize_Call) Run(run func(maxBytes int64)) *MockGitRepository_WithMaxFileSize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
func (_c *MockGitRepository_WithMaxFileSize_Call) Return() *MockGitRepository_WithMaxFileSize_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockGitRepository_WithMaxFileSize_Call) RunAndReturn(run func(int64)) *MockGitRepository_WithMaxFileSize_Call {
	_c.Run(run)
	return _c
}
