...
func (_m *MockGitRepository) ReadByHash(ctx context.Context, path string, ref string, contentHash string) (*repository.FileInfo, error) {
...
// MockGitRepository_ReadByHash_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReadByHash'
type MockGitRepository_ReadByHash_Call struct {
	*mock.Call
}
...
//   - ref string
//   - contentHash string
func (_e *MockGitRepository_Expecter) ReadByHash(ctx interface{}, path interface{}, ref interface{}, contentHash interface{}) *MockGitRepository_ReadByHash_Call {
	return &MockGitRepository_ReadByHash_Call{Call: _e.mock.On("ReadByHash", ctx, path, ref, contentHash)}
}

func (_c *MockGitRepository_ReadByHash_Call) Run(run func(ctx context.Context, path string, ref string, contentHash string)) *MockGitRepository_ReadByHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(string))
	})
	return _c
...
func (_c *MockGitRepository_ReadByHash_Call) Return(_a0 *repository.FileInfo, _a1 error) *MockGitRepository_ReadByHash_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGitRepository_ReadByHash_Call) RunAndReturn(run func(context.Context, string, string, string) (*repository.FileInfo, error)) *MockGitRepository_ReadByHash_Call {
	_c.Call.Return(run)
	return _c
}
