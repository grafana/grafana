...
func (_m *MockGitRepository) CreateBatch(ctx context.Context, ref string, pathsAndData map[string][]byte, message string) error {
...
// MockGitRepository_CreateBatch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateBatch'
type MockGitRepository_CreateBatch_Call struct {
	*mock.Call
}
...
//   - message string
func (_e *MockGitRepository_Expecter) CreateBatch(ctx interface{}, ref interface{}, pathsAndData interface{}, message interface{}) *MockGitRepository_CreateBatch_Call {
	return &MockGitRepository_CreateBatch_Call{Call: _e.mock.On("CreateBatch", ctx, ref, pathsAndData, message)}
}

func (_c *MockGitRepository_CreateBatch_Call) Run(run func(ctx context.Context, ref string, pathsAndData map[string][]byte, message string)) *MockGitRepository_CreateBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGitRepository_CreateBatch_Call) Return(_a0 error) *MockGitRepository_CreateBatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGitRepository_CreateBatch_Call) RunAndReturn(run func(context.Context, string, map[string][]byte, string) error) *MockGitRepository_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
