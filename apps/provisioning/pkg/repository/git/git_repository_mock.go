...
func (_m *MockGitRepository) CompareFiles(ctx context.Context, base string, refs ...string) ([]repository.VersionedFileChange, error) {
...
//   - base string
//   - refs ...string
func (_e *MockGitRepository_Expecter) CompareFiles(ctx interface{}, base interface{}, refs ...interface{}) *MockGitRepository_CompareFiles_Call {
	return &MockGitRepository_CompareFiles_Call{Call: _e.mock.On("CompareFiles",
		append([]interface{}{ctx, base}, refs...)...)}
}

func (_c *MockGitRepository_CompareFiles_Call) Run(run func(ctx context.Context, base string, refs ...string)) *MockGitRepository_CompareFiles_Call {
	_c.Call.Run(func(args mock.Arguments) {
