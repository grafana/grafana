...
func (_m *MockGithubRepository) PullRequestBase(ctx context.Context, prNumber int, headRef string) (string, error) {
...
// MockGithubRepository_PullRequestBase_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PullRequestBase'
type MockGithubRepository_PullRequestBase_Call struct {
	*mock.Call
}
...
//   - prNumber int
//   - headRef string
func (_e *MockGithubRepository_Expecter) PullRequestBase(ctx interface{}, prNumber interface{}, headRef interface{}) *MockGithubRepository_PullRequestBase_Call {
	return &MockGithubRepository_PullRequestBase_Call{Call: _e.mock.On("PullRequestBase", ctx, prNumber, headRef)}
}

func (_c *MockGithubRepository_PullRequestBase_Call) Run(run func(ctx context.Context, prNumber int, headRef string)) *MockGithubRepository_PullRequestBase_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGithubRepository_PullRequestBase_Call) Return(_a0 string, _a1 error) *MockGithubRepository_PullRequestBase_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGithubRepository_PullRequestBase_Call) RunAndReturn(run func(context.Context, int, string) (string, error)) *MockGithubRepository_PullRequestBase_Call {
	_c.Call.Return(run)
	return _c
}
