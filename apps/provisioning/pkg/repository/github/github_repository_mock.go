...
func (_m *MockGithubRepository) CompareFiles(ctx context.Context, base string, refs ...string) ([]repository.VersionedFileChange, error) {
...
//   - base string
//   - refs ...string
func (_e *MockGithubRepository_Expecter) CompareFiles(ctx interface{}, base interface{}, refs ...interface{}) *MockGithubRepository_CompareFiles_Call {
	return &MockGithubRepository_CompareFiles_Call{Call: _e.mock.On("CompareFiles",
		append([]interface{}{ctx, base}, refs...)...)}
}

func (_c *MockGithubRepository_CompareFiles_Call) Run(run func(ctx context.Context, base string, refs ...string)) *MockGithubRepository_CompareFiles_Call {
	_c.Call.Run(func(args mock.Arguments) {
