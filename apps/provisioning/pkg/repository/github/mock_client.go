...
func (_m *MockClient) CheckBranchProtection(_a0 context.Context, _a1 string) (bool, error) {
...
// MockClient_CheckBranchProtection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckBranchProtection'
type MockClient_CheckBranchProtection_Call struct {
	*mock.Call
}
...
//   - _a0 context.Context
//   - _a1 string
func (_e *MockClient_Expecter) CheckBranchProtection(_a0 interface{}, _a1 interface{}) *MockClient_CheckBranchProtection_Call {
	return &MockClient_CheckBranchProtection_Call{Call: _e.mock.On("CheckBranchProtection", _a0, _a1)}
}

func (_c *MockClient_CheckBranchProtection_Call) Run(run func(_a0 context.Context, _a1 string)) *MockClient_CheckBranchProtection_Call {
...
func (_c *MockClient_CheckBranchProtection_Call) Return(_a0 bool, _a1 error) *MockClient_CheckBranchProtection_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_CheckBranchProtection_Call) RunAndReturn(run func(context.Context, string) (bool, error)) *MockClient_CheckBranchProtection_Call {
	_c.Call.Return(run)
	return _c
}
