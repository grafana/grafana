...
func (_m *MockReaderWriter) ValidatePermissions(ctx context.Context) ([]Permission, error) {
	ret := _m.Called(ctx)
...
// MockReaderWriter_ValidatePermissions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidatePermissions'
type MockReaderWriter_ValidatePermissions_Call struct {
	*mock.Call
}

// ValidatePermissions is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockReaderWriter_Expecter) ValidatePermissions(ctx interface{}) *MockReaderWriter_ValidatePermissions_Call {
	return &MockReaderWriter_ValidatePermissions_Call{Call: _e.mock.On("ValidatePermissions", ctx)}
}

func (_c *MockReaderWriter_ValidatePermissions_Call) Run(run func(ctx context.Context)) *MockReaderWriter_ValidatePermissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockReaderWriter_ValidatePermissions_Call) Return(_a0 []Permission, _a1 error) *MockReaderWriter_ValidatePermissions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReaderWriter_ValidatePermissions_Call) RunAndReturn(run func(context.Context) ([]Permission, error)) *MockReaderWriter_ValidatePermissions_Call {
	_c.Call.Return(run)
	return _c
}
