...
func (_m *MockReaderWriter) CreateBatch(ctx context.Context, ref string, pathsAndData map[string][]byte, message string) error {
...
// MockReaderWriter_CreateBatch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateBatch'
type MockReaderWriter_CreateBatch_Call struct {
	*mock.Call
}
...
//   - message string
func (_e *MockReaderWriter_Expecter) CreateBatch(ctx interface{}, ref interface{}, pathsAndData interface{}, message interface{}) *MockReaderWriter_CreateBatch_Call {
	return &MockReaderWriter_CreateBatch_Call{Call: _e.mock.On("CreateBatch", ctx, ref, pathsAndData, message)}
}

func (_c *MockReaderWriter_CreateBatch_Call) Run(run func(ctx context.Context, ref string, pathsAndData map[string][]byte, message string)) *MockReaderWriter_CreateBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReaderWriter_CreateBatch_Call) Return(_a0 error) *MockReaderWriter_CreateBatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockReaderWriter_CreateBatch_Call) RunAndReturn(run func(context.Context, string, map[string][]byte, string) error) *MockReaderWriter_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
