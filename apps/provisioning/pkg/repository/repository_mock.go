...
func (_m *MockRepository) Config() *provisioningV1.Repository {
	ret := _m.Called()
	...
	var r0 *provisioningV1.Repository
	if rf, ok := ret.Get(0).(func() *provisioningV1.Repository); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*provisioningV1.Repository)
		}
	}
...
func (_m *MockRepository) History(ctx context.Context, path string, ref string) ([]provisioningV1.HistoryItem, error) {
	...
	var r0 []provisioningV1.HistoryItem
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]provisioningV1.HistoryItem, error)); ok {
		return rf(ctx, path, ref)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) []provisioningV1.HistoryItem); ok {
		r0 = rf(ctx, path, ref)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]provisioningV1.HistoryItem)
		}
	}
...
func (_m *MockRepository) Test(ctx context.Context) (*provisioningV1.TestResults, error) {
	ret := _m.Called(ctx)
	...
	var r0 *provisioningV1.TestResults
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*provisioningV1.TestResults, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *provisioningV1.TestResults); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*provisioningV1.TestResults)
		}
	}
...
func (_m *MockRepository) Webhook(ctx context.Context, req *http.Request) (*provisioningV1.WebhookResponse, error) {
	...
	var r0 *provisioningV1.WebhookResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *http.Request) (*provisioningV1.WebhookResponse, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *http.Request) *provisioningV1.WebhookResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*provisioningV1.WebhookResponse)
		}
	}
