...
// Mutate provides a mock function with given fields: ctx, obj, oldObj
func (_m *MockFactory) Mutate(ctx context.Context, obj runtime.Object, oldObj runtime.Object) error {
	ret := _m.Called(ctx, obj, oldObj)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, runtime.Object, runtime.Object) error); ok {
		r0 = rf(ctx, obj, oldObj)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockFactory_Expecter) Mutate(ctx interface{}, obj interface{}, oldObj interface{}) *MockFactory_Mutate_Call {
	return &MockFactory_Mutate_Call{Call: _e.mock.On("Mutate", ctx, obj, oldObj)}
}

func (_c *MockFactory_Mutate_Call) Run(run func(ctx context.Context, obj runtime.Object, oldObj runtime.Object)) *MockFactory_Mutate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockFactory_Mutate_Call) RunAndReturn(run func(context.Context, runtime.Object, runtime.Object) error) *MockFactory_Mutate_Call {
	_c.Call.Return(run)
	return _c
}
