...
func (_m *MockExtra) Mutate(ctx context.Context, obj runtime.Object, oldObj runtime.Object) error {
...
func (_e *MockExtra_Expecter) Mutate(ctx interface{}, obj interface{}, oldObj interface{}) *MockExtra_Mutate_Call {
	return &MockExtra_Mutate_Call{Call: _e.mock.On("Mutate", ctx, obj, oldObj)}
}

func (_c *MockExtra_Mutate_Call) Run(run func(ctx context.Context, obj runtime.Object, oldObj runtime.Object)) *MockExtra_Mutate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockExtra_Mutate_Call) RunAndReturn(run func(context.Context, runtime.Object, runtime.Object) error) *MockExtra_Mutate_Call {
	_c.Call.Return(run)
	return _c
}
