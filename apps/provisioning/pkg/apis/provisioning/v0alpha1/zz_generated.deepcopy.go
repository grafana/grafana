...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobURLs) DeepCopyInto(out *JobURLs) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobURLs.
func (in *JobURLs) DeepCopy() *JobURLs {
	if in == nil {
		return nil
	}
	out := new(JobURLs)
