...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RefURLs) DeepCopyInto(out *RefURLs) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RefURLs.
func (in *RefURLs) DeepCopy() *RefURLs {
	if in == nil {
		return nil
	}
	out := new(RefURLs)
