...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		GitHubOAuthConnectionConfig{}.OpenAPIModelName():           schema_pkg_apis_provisioning_v0alpha1_GitHubOAuthConnectionConfig(ref),
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"clientID", "workspace"},
			},
		},
	}
}
...
func schema_pkg_apis_provisioning_v0alpha1_ConnectionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"type": {
						SchemaProps: spec.SchemaProps{
							...
							Type:        []string{"string"},
							Format:      "",
							Enum:        []interface{}{"bitbucket", "github", "githubEnterprise", "githubEnterpriseOAuth", "githubOAuth", "gitlab"},
						},
					},
					"url": {
						SchemaProps: spec.SchemaProps{
					...
					"githubOAuth": {
						SchemaProps: spec.SchemaProps{
							Description: "GitHub OAuth app connection configuration Only applicable when provider is \"githubOAuth\"",
							Ref:         ref(GitHubOAuthConnectionConfig{}.OpenAPIModelName()),
						},
					},
					"githubEnterpriseOAuth": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			BitbucketConnectionConfig{}.OpenAPIModelName(), ConnectionWebhookConfig{}.OpenAPIModelName(), GitHubConnectionConfig{}.OpenAPIModelName(), GitHubEnterpriseConnectionConfig{}.OpenAPIModelName(), GitHubEnterpriseOAuthConnectionConfig{}.OpenAPIModelName(), GitHubOAuthConnectionConfig{}.OpenAPIModelName(), GitlabConnectionConfig{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_provisioning_v0alpha1_FixFolderMetadataJobOptions(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"clientID", "serverUrl"},
			},
		},
	}
}
...
func schema_pkg_apis_provisioning_v0alpha1_GitHubOAuthConnectionConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
