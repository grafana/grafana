...
require (
	...
	github.com/grafana/grafana-app-sdk v0.51.0
	github.com/grafana/grafana-app-sdk/logging v0.51.0
...
require (
	...
	github.com/grafana/alerting v0.0.0-20260219164054-852c35175ed5 // indirect
