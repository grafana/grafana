...
drone:
	...
	CGO_ENABLED=0 $(GO) tool drone starlark --format
	CGO_ENABLED=0 $(GO) tool drone lint .drone.yml --trusted
	CGO_ENABLED=0 $(GO) tool drone --server https://drone.grafana.net sign --save grafana/grafana
