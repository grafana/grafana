...
def secrets():
    return [
        ...
        vault_secret(docker_username, "secret/data/common/dockerhub/grafanaci", "username"),
        vault_secret(docker_password, "secret/data/common/dockerhub/grafanaci", "password"),
        vault_secret(
