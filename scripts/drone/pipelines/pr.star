...
def pr_pipelines(edition):
    ...
    steps = [
        ...
        build_binary_step("grafana-server", edition=edition, variants=variants, ver_mode=ver_mode),
        build_binary_step("grafana-cli", edition=edition, variants=variants, ver_mode=ver_mode),
