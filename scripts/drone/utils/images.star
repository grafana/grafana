...
# "go" and "node" images can be switched back to golang:{}-alpine once this is resolved https://github.com/mattn/go-sqlite3/pull/1177#issuecomment-1849176090
images = {
    "git": "alpine/git:2.40.1",
    "go": "golang:{}-alpine3.18".format(golang_version),
    "node": "node:{}-alpine3.18".format(nodejs_version),
