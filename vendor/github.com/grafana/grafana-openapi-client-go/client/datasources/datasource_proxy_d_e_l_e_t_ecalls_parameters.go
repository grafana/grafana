...
// NewDatasourceProxyDELETEcallsParams creates a new DatasourceProxyDELETEcallsParams object,
...
func NewDatasourceProxyDELETEcallsParams() *DatasourceProxyDELETEcallsParams {
	return &DatasourceProxyDELETEcallsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDatasourceProxyDELETEcallsParamsWithTimeout creates a new DatasourceProxyDELETEcallsParams object
...
// NewDatasourceProxyDELETEcallsParamsWithContext creates a new DatasourceProxyDELETEcallsParams object
...
// NewDatasourceProxyDELETEcallsParamsWithHTTPClient creates a new DatasourceProxyDELETEcallsParams object
...
func (o *DatasourceProxyDELETEcallsParams) WithDefaults() *DatasourceProxyDELETEcallsParams {
	o.SetDefaults()
	return o
}
...
func (o *DatasourceProxyDELETEcallsParams) WithTimeout(timeout time.Duration) *DatasourceProxyDELETEcallsParams {
...
func (o *DatasourceProxyDELETEcallsParams) WithContext(ctx context.Context) *DatasourceProxyDELETEcallsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the datasource proxy d e l e t ecalls params
func (o *DatasourceProxyDELETEcallsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the datasource proxy d e l e t ecalls params
func (o *DatasourceProxyDELETEcallsParams) WithHTTPClient(client *http.Client) *DatasourceProxyDELETEcallsParams {
...
func (o *DatasourceProxyDELETEcallsParams) WithID(id string) *DatasourceProxyDELETEcallsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the datasource proxy d e l e t ecalls params
func (o *DatasourceProxyDELETEcallsParams) SetID(id string) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *DatasourceProxyDELETEcallsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
