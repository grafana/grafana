...
func (m *LibraryElementArrayResponse) validateResult(formats strfmt.Registry) error {
...
func (m *LibraryElementArrayResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LibraryElementArrayResponse) UnmarshalBinary(b []byte) error {
	var res LibraryElementArrayResponse
