...
func (m *RestoreDashboardVersionByIDOKBody) validateID(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) validateStatus(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) validateTitle(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) validateUID(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) validateURL(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) validateVersion(formats strfmt.Registry) error {
...
func (m *RestoreDashboardVersionByIDOKBody) UnmarshalBinary(b []byte) error {
	var res RestoreDashboardVersionByIDOKBody
