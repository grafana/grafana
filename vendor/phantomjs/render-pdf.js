(function() {
  ...
  var usage = "url=<url> pdf=<filename> width=<width> height=<height> cookiename=<cookiename> sessionid=<sessionid> domain=<domain>";

  if (!params.url || !params.pdf || !params.cookiename || ! params.sessionid || !params.domain) {
    console.log(usage);
    phantom.exit();
  }
