...
- **+ Add from saved queries** - Add a saved query. Reuse a saved query, click the **Replace with saved query** button (or icon). To [save the query](ref:save-query) for reuse, click the **Save query** button (or icon).
