...
- **Show image** - Controls if the news social image is displayed. The image appears above the text content in narrow panels and beside the text content in wider panels.
