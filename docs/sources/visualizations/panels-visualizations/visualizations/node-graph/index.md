...
If the icon field contains a value, it’s displayed instead of the main and secondary stat. For a list of available icons, refer to [Icons Overview](https://developers.grafana.com/ui/latest/index.html?path=/story/iconography-icon--icons-overview).
