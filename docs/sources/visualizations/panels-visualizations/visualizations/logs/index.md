...
The logs visualization displays these records from data sources that support logs, such as Elastic, Influx, and Loki. The logs visualization shows the log line body with expandable log details, displayed fields, and log-level indicators when those fields are available.
