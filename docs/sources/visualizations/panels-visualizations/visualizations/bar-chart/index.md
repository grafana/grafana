...
| Rotate x-axis tick labels        | Rotate category-axis labels. Labels appear under the bars for vertical charts and beside the bars for horizontal charts. This setting is useful when bar chart labels are long and overlap.  |
