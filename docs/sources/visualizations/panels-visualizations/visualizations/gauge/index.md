...
| Bar Style | Choose **Flat** or **Rounded** for the gauge bar. This option is only displayed when **Segments** is `1`. |
| Endpoint marker | Choose **Point**, **Glow**, or **None** for the endpoint marker. **Glow** is only visible in dark mode. This option is only displayed when **Bar Style** is **Rounded** and **Segments** is `1`. |
...
| Show labels | Control whether threshold and neutral value labels are shown outside of the gauge. |
