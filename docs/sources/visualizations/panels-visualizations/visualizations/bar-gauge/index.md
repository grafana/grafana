...
| Option | Description |
| ------ | ----------- |
| Orientation | Choose a bar layout orientation:<ul><li>**Auto** - Grafana determines the best orientation.</li><li>**Horizontal** - Bars stretch horizontally, left to right.</li><li>**Vertical** - Bars stretch vertically, bottom to top.</li></ul> |
