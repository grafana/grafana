...
| Max height                              | Set the maximum height of the tooltip box.                                                                                     |

#### Tooltip mode

When you hover your cursor over the visualization, Grafana can display tooltips. Choose how tooltips behave. The default is **All**.
