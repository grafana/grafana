...
| Expand all groups | Show all instances of grouped functions. |
| Collapse all groups | Collapse grouped functions. |
...
| Top Table, Flame Graph, Both | Choose whether to show only the top table, only the flame graph, or both at the same time. |
