...
| Recently viewed | Display recently viewed dashboards in the order they were viewed. |
| Search | Display dashboards returned by search. Variable interpolation is supported for **Query** and **Tags**. For example, `$my_var` or `${my_var}`. |
