...
Click **Add series** to add a series, select a series from the series list to manage it, or click the series name to rename it.
...
You can customize the following standard option:
