...
| Bucket size | The size of the buckets. Leave this empty for automatic bucket sizing based on the data range and bucket count, which defaults to 30 buckets. |
