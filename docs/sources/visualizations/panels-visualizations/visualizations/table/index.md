...
{{< figure src="/media/docs/grafana/panels-visualizations/screenshot-nested-table-collapsed-v13.1.png" max-width="750px" alt="Table with all rows collapsed" >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/screenshot-nested-table-w-overrides-v13.1.png" max-width="750px" alt="Nested table with a threshold override applied to a column inside an expanded sub-table" >}}
