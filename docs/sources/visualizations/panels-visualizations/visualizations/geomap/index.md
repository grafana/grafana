...
| Default Style | Controls the style to apply when no rules match. <br> **Properties include:** <ul><li>**Color** - Configures the base color.</li><li>**Opacity** - Configures the transparency.</li><li>**Size** - Sets the size of the marker.</li><li>**Symbol** - Selects the marker icon. Clear this field to display **text only**.</li><li>**Text label** - Select a property from the GeoJSON features (e.g., `name`) to display as a label.</li><li>**Text styling** - Configures font size, weight (bold), style (italic), case (uppercase), and text outline (halo effect).</li></ul> |
