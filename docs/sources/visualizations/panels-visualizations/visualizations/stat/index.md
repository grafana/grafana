...
| Limit | This option is displayed when you select **All values** as your **Show** option. Set the maximum number of rows to display. The default is `25`, and the maximum is `5000`. |
...
- **Percent change** - Enter a numeric value for the percent-change text size.
