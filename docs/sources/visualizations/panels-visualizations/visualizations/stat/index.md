...
| Limit | This option is displayed when you select **All values** as your **Show** option. Set the maximum number of rows to display. Default is 25, and the maximum is 5,000. |
...
- **Title** - Enter a numeric value for the title size.
- **Value** - Enter a numeric value for the value size.
- **Percent change** - Enter a numeric value for the percent change size. This option is displayed when **Show percent change** is enabled.
