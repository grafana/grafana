...
Frontend-only data sources, such as the `-- Dashboard --` data source, aren't supported. Use one of the compatible data sources listed below for queries that you want to reference in a SQL expression.
