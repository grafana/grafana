...
| Colorblind safe                       | A palette validated to be distinguishable by users with protanopia, deuteranopia, and tritanopia. Located in the **Accessible** group in the color scheme selector.                                                                  |
