...
| Colorblind safe                       | A discrete palette of 17 colors based on Wong (2011) and Tol qualitative research, validated to be distinguishable under protanopia, deuteranopia, and tritanopia. Colors with insufficient contrast against the current theme background are automatically filtered out. Located in the **Accessible** group in the color scheme selector.                                                                  |
