...
1. Set link options:
   ...
   - **Show in controls menu** – Select this option to place the link in the dashboard controls menu instead of at the top of the dashboard. The dashboard controls menu appears as a button at the top of the dashboard.
