---
aliases:
  - /docs/grafana/next/features/panels/text/
  - /docs/grafana/next/panels/visualizations/text-panel/
  - /docs/grafana/next/reference/alertlist/
  - /docs/grafana/next/visualizations/text-panel/
keywords:
  - grafana
  - text
  - documentation
