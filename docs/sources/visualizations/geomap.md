...
- **Marker Shape** allows you to choose the shape, icon or graphic to aid in providing additional visual context to your data. Choose from assets which are included with Grafana such as simple shapes or the Unicon library. You can also specify a URL containing an image asset. The image must be a scalable vector graphic (svg). 
