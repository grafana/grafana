...
{{< docs-imagebox img="/static/img/docs/v45/prometheus_query_editor_still.png" class="docs-image--block" animated-gif="/static/img/docs/v45/prometheus_query_editor.gif" >}}

### Elasticsearch: Add ad-hoc filters from the table panel

{{< docs-imagebox img="/static/img/docs/v45/elastic_ad_hoc_filters.png" class="docs-image--block" >}}
