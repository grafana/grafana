...
{{< imgbox max-width="30%" img="/static/img/docs/v4/alert_list_panel.png" caption="Alert List Panel" >}}
...
{{< imgbox max-width="30%" img="/static/img/docs/v4/adhoc_filters.gif" caption="Ad-hoc filters variable" >}}
...
<div class="row">
  ...
  <div class="medium-6 columns">
   {{< lightboxhelper max-width="100%" img="/static/img/docs/v4/tvmode.png" caption="TV mode" >}}
...
{{< imgbox max-width="50%" img="/static/img/docs/v4/add_panel.gif" caption="Add Panel flow" >}}
...
{{< imgbox max-width="40%" img="/static/img/docs/v4/shortcuts.png" caption="Shortcuts" >}}
