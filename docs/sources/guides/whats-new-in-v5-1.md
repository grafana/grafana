...
- [Improved scrolling experience](#improved-scrolling-experience)
- [Improved docker image](#improved-docker-image-breaking-change) with a breaking change!
- [Heatmap support for Prometheus](#prometheus)
- [Microsoft SQL Server](#microsoft-sql-server) as metric and table data source!
- [Dashboards and Panels](#dashboards-panels) Improved adding panels to dashboards and enhancements to Graph and Table panels.
- [New variable interpolation syntax](#new-variable-interpolation-syntax)
- [Improved workflow for provisioned dashboards](#improved-workflow-for-provisioned-dashboards)
...
In the table below you can see some examples and you can find all different options in the [Variables documentation]({{< relref "../variables/templates-and-variables#advanced-formatting-options" >}}).
