...
{{< docs-imagebox img="/static/img/docs/v60/explore_prometheus.png" max-width="800px" class="docs-image--right" caption="Screenshot of the new Explore option in the panel menu" >}}
...
{{< docs-imagebox img="/static/img/docs/v60/explore_split.png" max-width="800px" caption="Screenshot of the new Explore option in the panel menu" >}}
...
{{< docs-imagebox img="/static/img/docs/v60/gauge_panel.png" max-width="600px" caption="Gauge Panel" >}}
...
{{< docs-imagebox img="/static/img/docs/v60/react_panels.png" max-width="600px" caption="React Panel" >}}
<br />
...
{{< docs-imagebox img="/static/img/docs/v60/named_colors.png" max-width="400px" class="docs-image--right" caption="Named Colors" >}}
