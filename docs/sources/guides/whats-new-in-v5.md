...
{{< docs-imagebox img="/static/img/docs/v50/new_grid.png" max-width="1000px" class="docs-image--right">}}
...
{{< docs-imagebox img="/static/img/docs/v50/new_ux_nav.png" max-width="1000px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/dashboard_settings.png" max-width="1000px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/new_white_theme.png" max-width="1000px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/new_search.png" max-width="1000px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/folder_permissions.png" max-width="1000px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/graphite_tags.png" max-width="1000px" class="docs-image--right" >}}
