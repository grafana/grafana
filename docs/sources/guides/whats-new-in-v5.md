...
It's also possible to update and delete data sources from the config file. More info in the [data source provisioning docs]({{< relref "../administration/provisioning#datasources" >}}).
