...
{{< docs-imagebox img="/static/img/docs/v54/alerting-for-dark-theme.png" max-width="600px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v54/stackdriver_template_query.png" max-width="600px" class="docs-image--right" >}}
...
{{< docs-imagebox img="/static/img/docs/v54/mysql_query_still.png" animated-gif="/static/img/docs/v54/mysql_query.gif" >}}
...
{{< docs-imagebox img="/static/img/docs/v54/graph_dot_single_point.png" max-width= "800px" >}}
