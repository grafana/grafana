...
- A new [Group By]({{< relref "../panels/transformations/types-options.md">}}) transformation that allows you to group by multiple fields and add any number of aggregations for other fields.
- The [Labels to fields]({{< relref "../panels/transformations/types-options.md">}}) transformation now allows you to pick one label and use that as the name of the value field.
