...
Token | If provided, Grafana will upload the generated image via Slack's file.upload API method, not the external image destination. If you use the [chat.postMessage](https://api.slack.com/methods/chat.postMessage) API, this is also required.
