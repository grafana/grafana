...
An alert rule definition is not an alert rule.  You define your alert rule, but you do not save it as an alert rule. It only becomes a saved alert rule once you provision it using Terraform.
