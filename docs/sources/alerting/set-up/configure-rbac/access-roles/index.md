...
| Contact Point Creator: `fixed:alerting.receivers:creator`                                | `alert.notifications.receivers:create` <br> `alert.notifications.receivers.test:create` for scope `receivers:type:new`                                                                                                                                                                                                                          | Create a new contact point. The user is automatically granted full access to the created contact point.                                                  |
