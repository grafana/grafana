...
Grafana 8 alerting added support external Alertmanager configuration. When you add an [Alertmanager data source]({{< relref "../../datasources/alertmanager.md" >}}), a drop down displays at the top of the create contact points page where you can select the external Alertmanager data source. Use this option to create and manage alerting for standalone Cortex or Loki data sources.
