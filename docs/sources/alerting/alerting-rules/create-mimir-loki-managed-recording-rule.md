...
1. In Step 1, add the rule name. Recording rule name must be valid metric name.
...
1. In Step 3, add evaluation behaviour.
   - Enter a valid **For** duration. Expression has to be true for this long for the alert to be fired.
