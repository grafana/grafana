...
To create a Grafana-managed alert rule, use the in-product alert creation flow and follow these steps to help you. For a quick start, check out our [tutorial on getting started with Grafana alerting](https://grafana.com/tutorials/alerting-get-started/).
