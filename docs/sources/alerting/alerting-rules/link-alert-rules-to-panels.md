...
For a hands-on example of integrating alert rules with dashboards, check out [Part 5 of our Get Started with Grafana Alerting tutorial](http://grafana.com/tutorials/alerting-get-started-pt5/).
{{% /admonition %}}
