---
aliases:
  - /docs/grafana/next/alerting/alerting-rules/create-mimir-loki-managed-rule/
  - /docs/grafana/next/alerting/unified-alerting/alerting-rules/create-cortex-loki-managed-recording-rule/
  - /docs/grafana/next/alerting/unified-alerting/alerting-rules/create-mimir-loki-managed-recording-rule/
  - /docs/grafana/next/alerting/unified-alerting/alerting-rules/create-mimir-loki-managed-rule/
