...
- **Assign it to notification policies** – Add the contact point to one or more [notification policies](/docs/grafana/<GRAFANA_VERSION>/alerting/configure-notifications/create-notification-policy/), which manage the alert notifications you want the contact point to receive.
