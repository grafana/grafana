...
The timing options decide how often notifications are sent for each group of alerts. There are three timers that you need to know about. These are called Group wait, Group interval, and Repeat interval. 
