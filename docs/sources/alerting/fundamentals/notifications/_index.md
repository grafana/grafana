...
By default, notification messages include common alert details, which are typically sufficient. You can customize notification messages and use notification templates.
