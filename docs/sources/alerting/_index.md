...
Depending on your use case, you can use Grafana Alerting for Grafana OSS, Grafana Enterprise, or Grafana Cloud. With Grafana OSS, you can create Grafana managed alerts or if your data already lives in Grafana Mimir or Grafana Loki, you can run alert expressions closer to your data and at massive scale, all managed by the Grafana UI.
