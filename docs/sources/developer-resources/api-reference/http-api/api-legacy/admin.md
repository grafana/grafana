...
Only works with Basic Authentication (username and password). See [introduction](#admin-api) for an explanation.
...
Create new user. Only works with Basic Authentication (username and password). See [introduction](#admin-api) for an explanation.
