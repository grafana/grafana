    ...
    "children": [
      {
        ...
        "children": [
          ...
          {
            "type": "mention",
            "mention": { "kind": "user", "targetId": "42", "displayName": "alice" },
            "text": "@alice"
          },
          { "type": "text", "text": ", see " },
          {
            "type": "mention",
            "mention": { "kind": "panel", "targetId": "abc:3", "displayName": "cpu" },
            "text": "#cpu"
          },
          { "type": "text", "text": "." }
        ]
...
`action` is one of `thread_created`, `thread_deleted`, `thread_closed`, `thread_reopened`, `pulse_added`, `pulse_edited`, `pulse_deleted`. Bodies are intentionally not included in the event — clients re-fetch via HTTP after seeing an event. This keeps the channel small and avoids leaking content to subscribers whose permissions may have changed since they connected.
