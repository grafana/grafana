...
**This document may not contain the latest version of the API. For the most up-to-date list of methods available, refer to [playlist.grafana.app/v1](https://play.grafana.org/swagger?api=playlist.grafana.app-v1) in Swagger.**
