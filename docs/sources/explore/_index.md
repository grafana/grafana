...
> Refer to [Role-based access control]({{< relref "../administration/manage-users-and-permissions/access-control/" >}}) in Grafana Enterprise to understand how you can control access with role-based permissions.
...
> Refer to [Role-based access Control]({{< relref "../administration/manage-users-and-permissions/access-control/" >}}) in Grafana Enterprise to understand how you can manage Explore with role-based permissions.
