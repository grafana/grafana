...
For details about the types see [TraceSpanRow](https://grafana.com/docs/grafana/v8.3/packages_api/data/tracespanrow/), [TraceKeyValuePair](https://grafana.com/docs/grafana/v8.3/packages_api/data/tracekeyvaluepair/) and [TraceLog](https://grafana.com/docs/grafana/v8.3/packages_api/data/tracelog/)
