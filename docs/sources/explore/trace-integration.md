...
The trace view provides an overview of a request as it travels through your system. The following sections provide detail on the elements of the trace view.
...
You can also focus on this path by clicking the **Show critical path only** button in **Span filters**.
