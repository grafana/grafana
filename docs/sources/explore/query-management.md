...
This functionality is similar to the panel inspector tasks [Inspect query performance](../../panels-visualizations/panel-inspector/#inspect-query-performance) and
[Inspect query request and response data](../../panels-visualizations/panel-inspector/#inspect-query-request-and-response-data).
