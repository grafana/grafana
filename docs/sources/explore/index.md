...
type = "docs"
aliases = ["/docs/grafana/v7.2/features/explore/"]
[menu.docs]
name = "Explore"
identifier = "explore"
weight = 90
...
{{< figure src="/static/img/docs/explore/parsed-fields-7-2.gif" max-width="800px" caption="Toggling parsed fields in Explore" >}}
