...
# User management: authenticate, provision, manage identity, and grant permissions
...
### Choose between teams and organizations
...
## Synchronize users between Grafana and identity providers
