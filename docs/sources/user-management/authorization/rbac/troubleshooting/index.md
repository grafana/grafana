...
Learn more about [access control audit logs](/docs/grafana/<GRAFANA_VERSION>/user-management/audit/audit-grafana/#access-control).

## Missing dashboard, folder or data source permissions

[Dashboard and folder permissions](/docs/grafana/<GRAFANA_VERSION>/user-management/authorization/#dashboard-permissions) and [data source permissions](/docs/grafana/<GRAFANA_VERSION>/user-management/authorization/#data-source-permissions) can go out of sync if a Grafana instance version is upgraded, downgraded and then upgraded again.
