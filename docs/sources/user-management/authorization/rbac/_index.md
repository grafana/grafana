...
aliases:
  ...
  - ../../administration/roles-and-permissions/access-control/
...
- [LDAP](/docs/grafana/<GRAFANA_VERSION>/user-management/authentication/ldap/)
...
- [Organizations](/docs/grafana/<GRAFANA_VERSION>/user-management/authorization/organization-management/)
