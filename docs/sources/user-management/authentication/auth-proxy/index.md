...
aliases:
  ...
  - ../../setup-grafana/configure-access/configure-authentication/auth-proxy/
...
First, we need to set up the mapping between your authentication provider and Grafana. Follow [these instructions](../../user-identity/team-sync/#synchronize-a-grafana-team-with-an-external-group) to add groups to a team within Grafana.
...
[Learn more about Team Sync](../../user-identity/team-sync/)
