...
| cacheLevel                 | string  | Prometheus                                                       | This determines how aggressive the browser cache is. Valid values include: `Low`, `Medium`, `High`, and `None`. This field is configurable when you enable the `prometheusResourceBrowserCache` feature flag.                                                                                             |
