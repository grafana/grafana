...
| incrementalQueryOverlapDuration | string  | Prometheus                                                       | Experimental: Configure incremental query overlap duration in seconds. Default value is `600000` milliseconds (10 minutes).                                                                                                                                                                                         |
