...
| cacheLevel                 | string  | Prometheus                                                       | The setting that determines how aggressive the browser cache is, valid values are: `Low`, `Medium`, `High`, or `None`. This field is only configurable when the prometheusResourceBrowserCache feature flag is enabled.                                                                                             |
