...
| incrementalQueryOverlapDuration | string  | Prometheus                                                       | Experimental: Configure incremental query overlap duration in seconds. Default value is `600000` seconds (10 minutes).                                                                                                                                                                                              |
