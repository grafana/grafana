...
Refer to [Add a data source]({{< relref "../../../datasources/graphite/add-a-data-source/" >}}) for instructions on how to add a data source to Grafana. Only organization admins can add data sources. To learn more about the Graphite data source, refer to Graphite's [product documentation](https://graphite.readthedocs.io/en/stable/).
...
| `Auth`                | Refer to [Authentication]({{< relref "../../../datasources/setup-grafana/configure-security/configure-authentication/" >}}) for more information. |
...
For more information, refer to [Variables and templates]({{< relref "../../../datasources/variables/" >}}).
...
For more information, refer to [Advanced variable format options]({{< relref "../../../datasources/variables/advanced-variable-format-options/" >}}).

## Annotations

[Annotations]({{< relref "../../../datasources/dashboards/annotations/" >}}) allow you to overlay rich event information on top of graphs. You add annotation
...
Grafana exposes metrics for Graphite on the `/metrics` endpoint. For detailed instructions, refer to [Internal Grafana metrics]({{< relref "../../../datasources/setup-grafana/set-up-grafana-monitoring/" >}}).
