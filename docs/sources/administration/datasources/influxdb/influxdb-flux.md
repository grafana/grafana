...
You can view the interpolated version of a query with the query inspector. For more information, refer to [Navigate the Query Inspector]({{< relref "../../../../datasources/panels/working-with-panels/navigate-inspector-panel/" >}}).
