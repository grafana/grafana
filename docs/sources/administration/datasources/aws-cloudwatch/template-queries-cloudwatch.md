...
For an introduction to templating and template variables, refer to the [Templating]({{< relref "../../../../datasources/variables/" >}}) documentation.
...
Variables can be used in the variable form. Refer to the [variable syntax documentation]({{< relref "../../../../datasources/variables/syntax/" >}}).
