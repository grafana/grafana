...
Querying and displaying traces from Zipkin is available via [Explore]({{< relref "../../../datasources/explore/" >}}).
...
You can link to Zipkin trace from logs in Loki or Splunk by configuring a derived field with internal link. See [Loki documentation]({{< relref "../../../datasources/zipkin/loki/#derived-fields" >}}) for details.
