...
Grafana ships with a built-in Microsoft SQL Server (MS SQL) data source plugin that allows you to query and visualize data from any Microsoft SQL Server 2005 or newer, including Microsoft Azure SQL Database. This topic explains options, variables, querying, and other options specific to the MS SQL data source. Refer to [Add a data source]({{< relref "../../../datasources/mssql/add-a-data-source/" >}}) for instructions on how to add a data source to Grafana. Only users with the organization admin role can add data sources.
...
Given the data frame result in the following example and using the graph panel, you will get two series named _value 10.0.1.1_ and _value 10.0.1.2_. To render the series with a name of _10.0.1.1_ and _10.0.1.2_ , use a [Standard field definition]({{< relref "../../../datasources/panels/standard-field-definitions/#display-name" >}}) display name value of `${__field.labels.hostname}`.
...
Read more about variable formatting options in the [Variables]({{< relref "../../../datasources/variables/variable-types/#advanced-formatting-options" >}}) documentation.
