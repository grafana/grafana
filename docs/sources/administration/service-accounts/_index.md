...
1. **Edit**: User or a team with this permission will be able to view, edit, enable and disable service account, as well as view, add or delete service account tokens.
