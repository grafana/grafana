...
You can change the default dashboard on the organization, team and user level. The home dashboard you set for the whole organization is the one all users will see by default. Teams can set their own home dashboard that overrides the organization setting. Individual users can also set their own home dashboard that overrides all the other settings.

## Set home dashboard for your organization

### Setting default dashboard through preferences
...
### Setting default dashboard through configuration
