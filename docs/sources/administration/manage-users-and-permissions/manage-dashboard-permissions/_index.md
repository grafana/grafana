...
> **Note**: If you are using Grafana Enterprise and customize users permissions using RBAC, the RBAC permissions will override the functionality enabled by `viewers_can_edit` flag.
