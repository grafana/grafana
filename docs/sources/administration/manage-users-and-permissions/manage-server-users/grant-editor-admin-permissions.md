...
> **Note**: If you are using Grafana Enterprise and customize users permissions using RBAC, the RBAC permissions will override the functionality enabled by `editors_can_admin` flag.
