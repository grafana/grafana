...
1. In the Preferences section, you can edit any of the following:
   ...
   - **Timezone -** Click to select an option in the **Timezone** list. **Default** is either the browser timezone or the timezone selected by your Grafana administrator. Refer to [Time range controls]({{< relref "../dashboards/time-range-controls.md" >}}) for more information about Grafana time settings.
1. Click **Save**.
