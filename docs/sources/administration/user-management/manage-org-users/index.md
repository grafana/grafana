...
When you invite users to join an organization, you assign the **Admin**, **Editor**, **Viewer**, or **None** role which controls user access to the dashboards and data sources owned by the organization. Users receive an email that prompts them to accept the invitation.
