...
Optional path to JSON key file associated with a Google service account to authenticate and authorize. If the value is empty then it tries to retrieve authorization from GCE metadata.
