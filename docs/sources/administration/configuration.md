...
Viewers can access and use [Explore]({{< relref "../explore/_index.md" >}}) and perform transient edits on panels in dashboards they have access to. They cannot save their changes. Default is `false`.
