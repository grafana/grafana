...
- **Proactive Updates:** Address plugin update recommendations under "Investigation needed" even if they haven't caused failures yet. On Grafana Cloud, plugins managed by Grafana are automatically kept up to date. Refer to [Manage your plugins](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/administration/plugin-management/#manage-your-plugins) for more details.
