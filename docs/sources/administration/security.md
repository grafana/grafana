...
> Request security is only available in Grafana Enterprise v7.4 and later versions. For more information, refer to [Request security]({{< relref "../enterprise/request-security.md" >}}) in [Grafana Enterprise]({{< relref "../enterprise" >}}).
