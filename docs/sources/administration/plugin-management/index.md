...
If you are a plugin developer and want to know how to sign your plugin, refer to [Sign a plugin]({{< relref "../../developers/plugins/create-a-grafana-plugin/develop-a-plugin/sign-a-plugin/" >}}).
