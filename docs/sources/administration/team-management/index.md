---
aliases:
  - /docs/grafana/next/administration/manage-users-and-permissions/manage-teams/
  - /docs/grafana/next/manage-users/add-or-remove-user-from-team/
  - /docs/grafana/next/manage-users/create-or-remove-team/
  - /docs/grafana/next/manage-users/manage-teams/
