...
Support for exemplars is available for the Prometheus data source only. Once you enable the functionality, exemplar data is available by default. For more information on exemplar configuration and how to enable exemplars, refer to [configuring exemplars in the Prometheus data source]({{< relref ".[./../datasources/prometheus/#configuring-exemplars](https://grafana.com/docs/grafana/latest/datasources/prometheus/#configure-exemplars)" >}}).
