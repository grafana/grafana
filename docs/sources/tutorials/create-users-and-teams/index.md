...
You can also configure Grafana to allow [anonymous access]({{< relref "/docs/grafana/latest/setup-grafana/configure-security/configure-authentication/#anonymous-authentication" >}}), to make dashboards available even to those who don't have a Grafana user account. That's how Grafana Labs made https://play.grafana.org publicly available.
{{% /admonition %}}
...
- [Organization Roles]({{< relref "/docs/grafana/latest/administration/roles-and-permissions#organization-roles" >}})
- [Permissions Overview]({{< relref "/docs/grafana/latest/administration/roles-and-permissions/" >}})
