...
The Traces to profile feature requires a configured Tempo data source with the Traces to profiles feature enabled and a Pyroscope data source. This integration supports profile data generated using Go, Ruby, and Java instrumentation SDKs.
{{< /admonition >}}
