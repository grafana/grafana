...
Control how overflow for long series names is handled. This option is only displayed when mode is **Table**.
...
Limit how many legend items are shown by default. Remaining items are available through **Show all**.
