...
Control how overflow for long series names is handled. This option is only displayed when the legend mode is **Table**.
...
Limit how many items are shown by default in the legend.
