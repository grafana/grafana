...
aliases:
  ...
  - /docs/grafana/latest/dashboards/configure-panels-visualizations/configure-data-links/
keywords:
  - grafana
  - url variables
  - variables
...
- `$__from and $__to` - For more information, refer to [Global variables]({{< relref "../../variables/add-template-variables/#__from-and-__to" >}}).
