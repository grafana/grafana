...
The Geomap panel is also able to share views across multiple Geomap panels on the same dashboard, making it straightforward to visualize and explore multiple types of geospatial data using the same map zoom and focus settings. For more information, refer to [Geomap panel]({{< relref "../dashboards/configure-panels-visualizations/visualizations/geomap/" >}}).
...
For more on how to configure Graphs with by value color schemes read [Graph and color schemes]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series/" >}}).

You can also create annotations in the new Time series panel bringing it closer to parity with the legacy Graph panel. To learn more, refer to the [time series panel]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series/" >}}).
...
This transformation enables panel config (Threshold, Min, Max, etc.) to be derived from query results. For more information, refer to [Config from query results]({{< relref "../dashboards/configure-panels-visualizations/transform-data/#config-from-query-results" >}}).
...
For more on how to use this transformation, refer to [Rows to fields transform]({{< relref "../dashboards/configure-panels-visualizations/transform-data/#rows-to-fields" >}}).
...
For more on how to prettify JSON logs, refer to [Visualization]({{< relref "../dashboards/configure-panels-visualizations/visualizations/" >}}) and [Display]({{< relref "../dashboards/configure-panels-visualizations/visualizations/logs/" >}}) options.
...
New panel summaries and preview on the top level [Visualizations]({{< relref "../dashboards/configure-panels-visualizations/visualizations/" >}}) page to help users pick or learn about specific visualizations more easily.
