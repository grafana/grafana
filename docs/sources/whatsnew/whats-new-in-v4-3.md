...
![A histogram visualization](/static/img/docs/v43/heatmap_histogram.png)
...
![A heatmap visualization](/static/img/docs/v43/heatmap_histogram_over_time.png)
...
![Query editor showing interpolated SQL](/static/img/docs/v43/mysql_table_query.png)

**The query editor will also show any errors that resulted from running the query (very useful when you have a syntax error!).**

![Query editor showing errors](/static/img/docs/v43/mysql_query_error.png)
...
![Prometheus data in table format](/static/img/docs/v43/prom_table_cols_as_labels.png)
