...
Starting with Grafana 8.4, you can [configure a WeCom]({{< relref "../alerting/unified-alerting/contact-points#wecom" >}}) contact point, to send alert notifications to WeCom.
