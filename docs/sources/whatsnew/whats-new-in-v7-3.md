...
As this new option is a standard field option it works in every panel. Here is another example from the [Bar Gauge]({{< relref "../dashboards/configure-panels-visualizations/visualizations/bar-gauge/" >}}) panel.
