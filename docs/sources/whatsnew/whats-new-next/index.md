...
<!--
  Add short configuration description at the end,
...
If you have an application that's already using Grafana Cloud Traces, you can configure this integration by adding a few lines of code to your existing k6 test scripts.
