...
Welcome to Grafana 13.1! Read on to learn about changes to dashboards and visualizations, data sources, alerting, and more.
...
## Breaking changes in Grafana v13.1

For Grafana v13.1, we've also provided a list of [breaking changes](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/whatsnew/whats-new-in-v13-1/#breaking-changes) to help you upgrade with greater confidence.
