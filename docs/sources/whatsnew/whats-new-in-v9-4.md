...
We've made the following changes to dashboards and visualizations.
...
_This feature is available for Enterprise customers_
Scale factor is a new feature for reports that allows users to change the dimension of the panels of the PDF document. It enables you to zoom out to show more columns in a table or zoom in to enlarge panels.
