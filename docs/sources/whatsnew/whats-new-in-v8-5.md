...
{{< figure src="/static/img/docs/alerting/unified/rule-grouping-8-5.png" max-width="1200px" caption="Rule group" >}}

Rules in a group are evaluated together, so you can also set the interval for the entire group.

{{< figure src="/static/img/docs//alerting/unified/rule-grouping-details-8-5.png" max-width="1200px" caption="Rule group details" >}}
