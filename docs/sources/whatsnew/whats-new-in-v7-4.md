...
> **Note:** Queries built with this feature may break with minor version upgrades until Grafana 8 is released. This feature also does not work with current Grafana alerting.
