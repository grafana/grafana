...
- [Time series panel]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series/" >}})
- [Graph time series as lines]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series#line-style" >}})
- [Graph time series as bars]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series#bar-alignment" >}})
- [Graph time series as points]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series#show-points" >}})
- [Change axis display]({{< relref "../dashboards/configure-panels-visualizations/visualizations/time-series#axis-options" >}})
...
For more information, refer to [Node graph panel]({{< relref "../dashboards/configure-panels-visualizations/visualizations/node-graph/" >}}).
...
For more information, refer to [Sort by]({{< relref "../dashboards/configure-panels-visualizations/transform-data/" >}}).
...
For more information, refer to [Filter data by value]({{< relref "../dashboards/configure-panels-visualizations/transform-data/#filter-data-by-value" >}}).

### New override option

On the Overrides tab, you can now set properties for fields returned by a specific query.

For more information, refer to [About field overrides]({{< relref "../dashboards/configure-panels-visualizations/configure-overrides/" >}}).
...
[Queries]({{< relref "../dashboards/configure-panels-visualizations/manage-queries/" >}}) was updated as a result of this feature.
