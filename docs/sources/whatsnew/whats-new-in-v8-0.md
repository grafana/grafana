...
To learn more about the differences between new alerts and the legacy alerts, refer to [What's New with Grafana 8 Alerts]({{< relref "/docs/grafana/v10.0/alerting/difference-old-new" >}}).
