...
[Filter table columns]({{< relref "../dashboards/configure-panels-visualizations/visualizations/table/#filter-table-columns" >}}) has been added as a result of this feature.
...
- A new [Group By]({{< relref "../dashboards/configure-panels-visualizations/transform-data/#group-by" >}}) transformation that allows you to group by multiple fields and add any number of aggregations for other fields.
- The [Labels to fields]({{< relref "../dashboards/configure-panels-visualizations/transform-data/#labels-to-fields" >}}) transformation now allows you to pick one label and use that as the name of the value field.
