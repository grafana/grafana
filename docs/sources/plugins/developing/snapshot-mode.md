...
{{< imgbox img="/static/img/docs/Grafana-snapshot-example.png" caption="A dashboard using snapshot data and not live data." >}}
...
{{< imgbox img="/static/img/docs/animated_gifs/snapshots.gif" caption="Selecting a snapshot" >}}
...
{{< imgbox img="/static/img/docs/Grafana-save-snapshot.png" caption="Save snapshot" >}}
