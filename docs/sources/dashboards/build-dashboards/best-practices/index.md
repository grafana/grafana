...
- Expressive charts with meaningful use of color and normalizing axes where you can.
  - Example of meaningful color: Blue means it's good, red means it's bad. [Thresholds]({{< relref "../../configure-panels-visualizations/configure-thresholds/" >}}) can help with that.
...
- Copying dashboards with no significant changes is not a good idea.
  ...
  - In many cases copies are being made to simply customize the view by setting template parameters. This should instead be done by maintaining a link to the master dashboard and customizing the view with [URL parameters]({{< relref "../../configure-panels-visualizations/configure-data-links/#data-link-variables" >}}).
...
- Maintain a dashboard of dashboards or cross-reference dashboards. This can be done in several ways:
  ...
  - Add a [Dashboard list panel]({{< relref "../../configure-panels-visualizations/visualizations/dashboard-list/" >}}). You can then customize what you see by doing tag or folder searches.
  - Add a [Text panel]({{< relref "../../configure-panels-visualizations/visualizations/text/" >}}) and use markdown to customize the display.
