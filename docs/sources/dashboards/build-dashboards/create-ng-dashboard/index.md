...
1. Click **+ Add visualization** in the middle of the dashboard or **+ Add panel** in the top-left corner. <!-- workflows diverge from here; need confirmation on whether that will be the case for launch -->
