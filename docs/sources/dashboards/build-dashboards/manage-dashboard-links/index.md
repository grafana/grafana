...
- If you want to drill down into a specific series, or even a single measurement, use [data links]({{< relref "../../configure-panels-visualizations/configure-data-links/#data-links" >}}).
