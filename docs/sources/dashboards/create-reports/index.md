...
You can include dynamic dashboards with panels or rows, set to repeat by a variable, into reports. For detailed information about setting up repeating panels or rows in dashboards, refer to [Repeat panels or rows]({{< relref "../configure-panels-visualizations/configure-panel-options/#configure-repeating-rows-or-panels" >}}).
