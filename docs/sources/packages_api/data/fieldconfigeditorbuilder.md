...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  config | <code>FieldConfigEditorConfig&lt;TOptions, TSettings, string&gt;</code> |  |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  config | <code>FieldConfigEditorConfig&lt;TOptions, TSettings &amp; SliderFieldConfigSettings, number&gt;</code> |  |
