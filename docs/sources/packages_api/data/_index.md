...
|  [LiveChannelScope](./livechannelscope/) | The channel id is defined as:<!-- -->$<!-- -->{<!-- -->scope<!-- -->}<!-- -->/$<!-- -->{<!-- -->namespace<!-- -->}<!-- -->/$<!-- -->{<!-- -->path<!-- -->}<!-- -->The scope drives how the namespace is used and controlled |
...
|  [PluginSignatureStatus](./pluginsignaturestatus/) | Describes status of [plugin signature](https://grafana.com/docs/grafana/latest/plugins/plugin-signatures/) |
|  [PluginState](./pluginstate/) | Describes plugins life cycle status |
|  [PluginType](./plugintype/) | Describes [type of plugin](https://grafana.com/docs/grafana/latest/plugins) |
|  [ReducerID](./reducerid/) |  |
...
|  [buildColorsMapForTheme(theme)](./buildcolorsmapfortheme/) |  |
...
|  [compareDataFrameStructures(a, b, skipProperties)](./comparedataframestructures/) | <b><i>(BETA)</i></b> Returns true if both frames have the same list of fields and configs. Field may have diferent names, labels and values but share the same structure<!-- -->To compare multiple frames use:
```
...
|  [getColorDefinitionByName(name)](./getcolordefinitionbyname/) |  |
...
|  [getFieldColorMode(mode)](./getfieldcolormode/) |  |
|  [getFieldColorModeForField(field)](./getfieldcolormodeforfield/) |  |
|  [getFieldConfigWithMinMax(field, local)](./getfieldconfigwithminmax/) |  |
...
|  [isValidLiveChannelAddress(addr)](./isvalidlivechanneladdress/) | Check if the address has a scope, namespace, and path |
...
|  [DataFrameFieldIndex](./dataframefieldindex/) | Describes where a specific data frame field is located within a dataset of type DataFrame\[\] |
...
|  [TableData](./tabledata/) |  |
|  [TextDisplayOptions](./textdisplayoptions/) | Explicit control for text settings |
|  [TextMatch](./textmatch/) |  |
|  [Threshold](./threshold/) |  |
