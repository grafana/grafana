...
| **MySQL multiple statement support** | Enables [multiple statement execution](https://dev.mysql.com/doc/c-api/5.7/en/c-api-multiple-queries.html). This might affect the structure of the returned result. For example, in case multiple result sets are returned, only the first one will be processed. Default is `false`.                                                                                                                                                                                                                                                                                                                                                                     |
