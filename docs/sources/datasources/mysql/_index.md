...
**Note:** If a default database has been chosen through the Data Source configuration page, the Dataset Dropdown will be disabled, and only the configured database will be available for querying.
