...
NOTE: If a default database has been choosen on the Data Source configuration page, the Dataset Dropdown will be disabled, and only that configured database will be avilable for querying.
