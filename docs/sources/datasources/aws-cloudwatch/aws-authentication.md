...
> **Note:** Although there are four different authentication methods available, only three of them (that are discussed here) are enabled by default for Grafana OSS.
