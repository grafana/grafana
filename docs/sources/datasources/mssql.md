...
To optionally customize the default series name formatting, refer to [Standard options definitions]({{< relref "../dashboards/configure-panels-visualizations/configure-standard-options/#display-name" >}}).
...
Given the data frame result in the following example and using the graph panel, you will get two series named _value 10.0.1.1_ and _value 10.0.1.2_. To render the series with a name of _10.0.1.1_ and _10.0.1.2_ , use a [Standard options definitions]({{< relref "../dashboards/configure-panels-visualizations/configure-standard-options/#display-name" >}}) display name value of `${__field.labels.hostname}`.
