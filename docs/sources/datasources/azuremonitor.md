...
Queries are written in the new [Kusto Query Language](https://docs.microsoft.com/en-us/azure/data-explorer/kusto/query/). A Log Analytics query can be formatted as time series data or as table data.
