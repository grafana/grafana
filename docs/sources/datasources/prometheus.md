...
| `Manage alerts via Alerting UI` | Do not select this option if you do not want to manage alerts for this Prometheus data source using [Grafana Alerting UI]({{< relref "../alerting/unified-alerting/_index.md" >}})                                                                                |
| `Custom ruler URL`              | Cortex only. If running Cortex in microservices mode, select this option to configure the URL and authentication options separately for the ruler service.                                                                                                        |
