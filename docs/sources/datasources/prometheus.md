...
| **Examplar configuration** |                                                                                                                                                                                                                                                                   |
| `Label name`               | Add a name for the exemplar traceID property.                                                                                                                                                                                                                     |
| `URL`                      | For external link, enter the full URL. You can interpolate the value from the field with `${__value.raw }` macro.                                                                                                                                                 |
| `URL Label`                | Optionally, add a custom display label to override the value of the `Label name` field.                                                                                                                                                                           |
| `Internal link`            | Enable this option for an internal link. The data source selector that can see now allows you to select the tracing data source for exemplar data.                                                                                                                |
