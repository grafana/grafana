...
| `Step`              | Optionally, set the lower or upper bounds on the interval between data points, for example, set "minimum 1h" to hiint that measurements were not taken more frequently. `$__interval` and `$__rate_interval` are supported.                                                                                                                                                                                             |
