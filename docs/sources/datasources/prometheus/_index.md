...
The Prometheus data source can be configured to disable recording rules under the data souce configuration or provisioning file (under `disableRecordingRules` in jsonData).
