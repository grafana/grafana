...
1.  Set the data source's basic configuration options:
    ...
    | `Scrape interval`               | Set this to the typical scrape and evaluation interval configured in Prometheus. Defaults to 15s. For Grafana Cloud the default is 60s. Please set to the scrape interval (e.g. 15s) of your agent if Grafana should visualize with higher resolution than 1 DPM.                                                                                                                                                                                                              |
