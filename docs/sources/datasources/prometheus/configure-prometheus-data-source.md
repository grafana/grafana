...
- **Default editor** - Sets a default editor. Options are `Builder` or `Code`. For information on query editor types see [Prometheus query editor]({{< relref "/docs/grafana/latest/datasources/prometheus/query-editor" >}}).
