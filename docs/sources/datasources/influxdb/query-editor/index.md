...
Grafana's query editors are unique to each data source. For general information on Grafana query editors, refer to [Query editors](/docs/grafana/<GRAFANA_VERSION>/panels-visualizations/query-transform-data/#query-editors). For general information on querying data sources in Grafana, refer to [Query and transform data](/docs/grafana/<GRAFANA_VERSION>/panels-visualizations/query-transform-data/).

The InfluxDB query editor is located on the [Explore page](/docs/grafana/<GRAFANA_VERSION>/explore/). You can also access the InfluxDB query editor from a dashboard panel. Click the ellipsis in the upper right of the panel and select **Edit**.
...
If your data source is [configured for Flux](/docs/grafana/<GRAFANA_VERSION>/datasources/influxdb/configure-influxdb-data-source/), you can use
...
To view the interpolated version of a query with the Query inspector, refer to [Panel Inspector](/docs/grafana/<GRAFANA_VERSION>/panels-visualizations/panel-inspector/).

## Query logs

You can query and display log data from InfluxDB in [Explore](/docs/grafana/<GRAFANA_VERSION>/explore/) and in the dashboard [Logs panel](/docs/grafana/<GRAFANA_VERSION>/panels-visualizations/visualizations/logs/).
...
[Annotations](/docs/grafana/<GRAFANA_VERSION>/dashboards/build-dashboards/annotate-visualizations/) overlay rich event information on top of graphs.
