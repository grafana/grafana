...
1. In the **Type**, select the type of data source. See [Supported data sources]({{< relref "datasources/#supported-data-sources/" >}}) for more information and how to configure your data source settings.
