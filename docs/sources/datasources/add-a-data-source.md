...
1. Configure the data source following instructions specific to that data source. See [Data sources]({{< relref "../administration/datasources/_index.md" >}}) for links to configuration instructions for all supported data sources.
