...
Querying and displaying log data from Elasticsearch is available in [Explore]({{< relref "../explore/" >}}), and in the [logs panel]({{< relref "../dashboards/configure-panels-visualizations/visualizations/logs/" >}}) in dashboards.
