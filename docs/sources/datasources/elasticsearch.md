...
![Elasticsearch data source details](/img/docs/v74/elasticsearch/elasticsearch_ds_details.png)
...
![Elasticsearch Query Editor](/img/docs/v74/elasticsearch/query_editor.png)
...
![Pipeline aggregation editor](/img/docs/v74/elasticsearch/pipeline_metrics_editor.png)
...
![Query with template variables](/img/docs/v74/elasticsearch/elastic_templating_query.png)
