...
You can upload JSON file that contains a single trace to visualize it. If the JSON contains multiple traces then the first one is going to be used. The JSON schema needs to look like this:
