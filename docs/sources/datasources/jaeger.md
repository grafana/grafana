...
- **Span start time shift -** The time to shift the start time for the Loki query based on the span start time. In order to extend to the past you need to use negative value.  Time units can be used here, for example: 5s, 1m, 3h. The default is 0.
- **Span end time shift -** The time to shift the end time for the Loki query based on the span end time. Time units can be used here, for example: 5s, 1m, 3h. The default is 0.
