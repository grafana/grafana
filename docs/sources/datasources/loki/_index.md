...
> Alternatively, you can create a duplicate of your provisioned Grafana Cloud Loki datasource, which would allow you to modify the Derived Fields in the Grafana UI.
