...
To configure this feature, refer to the [Derived fields]({{< relref "../../loki#configure-derived-fields" >}}) section of the Loki data source docs or the [Data links]({{< relref "../../elasticsearch#data-links" >}}) section of the Elasticsearch or Splunk data source docs.
