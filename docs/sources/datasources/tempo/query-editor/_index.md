...
For more information about the service graph, refer to [Service graph](../service-graph.md).
...
To add TraceQL panels to your dashboard, refer to the [Traces panel documentation](https://grafana.com/docs/grafana/latest/panels-visualizations/visualizations/traces/).
