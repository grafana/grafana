...
- Tempo must have `stream_over_http_enabled: true` for streaming to work, as per the [Tempo docs](https://grafana.com/docs/tempo/<TEMPO_VERSION>/api_docs/#tempo-grpc-api).
