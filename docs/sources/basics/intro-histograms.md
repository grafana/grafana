...
For more information about histogram visualization options, refer to [Histogram]({{< relref "../dashboards/configure-panels-visualizations/visualizations/histogram/" >}}).
...
For more information about heatmap visualization options, refer to [Heatmap]({{< relref "../dashboards/configure-panels-visualizations/visualizations//heatmap/" >}}).
