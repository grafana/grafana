...
Beta .deb for Debian-based Linux |   [grafana_3.0.0-beta31460425332_amd64.deb](https://grafanarel.s3.amazonaws.com/builds/grafana_3.0.0-beta31460425332_amd64.deb)
...
## Install 3.0 Beta
    ...
    $ wget https://grafanarel.s3.amazonaws.com/builds/grafana_3.0.0-beta31460425332_amd64.deb
    $ sudo apt-get install -y adduser libfontconfig
    $ sudo dpkg -i grafana_3.0.0-beta31460425332_amd64.deb
