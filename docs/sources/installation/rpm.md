...
Refer to the [Getting Started]({{< relref "../getting-started/add-preconfigured-dashboard/" >}}) guide for information about logging in, setting up data sources, and so on.
