...
Grafana Alerting can send alerts through several different alert notifiers, including PagerDuty, SMS, email, VictorOps, OpsGenie, Jira Service Management, or Slack.
