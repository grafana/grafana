...
**Grafana Alloy:** Grafana Alloy is a vendor-neutral, batteries-included telemetry collector with configuration inspired by Terraform. It is designed to be flexible, performant, and compatible with multiple ecosystems such as Prometheus and OpenTelemetry. For more information about Grafana Alloy, refer to [Grafana Alloy documentation](https://grafana.com/docs/alloy/latest/).
