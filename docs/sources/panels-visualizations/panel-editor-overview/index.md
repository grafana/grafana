...
1. Visualization preview: The visualization preview section contains the following options:
   ...
   - **Table view:** Convert any visualization to a table so that you can see the data. Table views are useful for troubleshooting. This view only contains the raw data. It does not include transformation you might have applied to the data.
