...
This section includes information about using thresholds in your visualizations. This section covers the basics of thresholds, including their defaults, how to add or delete a threshold, and adding a threshold to a legacy panel.
...
1. Complete the following fields:
   ...
   - **Y-Axis -** Choose to disply the Y-axis on either the **left** or the **right** of the panel.
