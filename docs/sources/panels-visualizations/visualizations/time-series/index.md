...
{{< figure src="screenshot-time-series-v12.0.png" max-width="750px" alt="Time series visualization" >}}
...
{{< figure src="screenshot-fill-below-to-v12.0.png" max-width="600px" alt="Fill below to example" >}}
