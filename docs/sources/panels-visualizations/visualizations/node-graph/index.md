...
| highlightedColor | string        | Sets the highlighted color of the edge. It can be an acceptable HTML color string, and requires that `highlighted` be `true` for use.                                                                                            |
