...
| iconSize      | string        | Size of the icon to show inside the node. Select from the following predefined values: xs, sm, md, lg, xl, xxl or xxxl.                                                                                                                                                                                                                                                   |
| fontSize      | number        | Font size in pixels for the text attached to node including mainStat and secondaryStat.                                                                                                                                                                                                                                                                                   |
