...
Select the **Count** calculation with **Count rows** enabled when you want to show the number of rows in the dataset instead of the number of values in the selected fields.
