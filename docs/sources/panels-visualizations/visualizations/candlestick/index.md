...
<!-- The raw content of the file docs/sources/shared/visualizations/axis-options-all.md is used for this section except for the "Time zone" setting. Do not update this section directly. Update that file and copy and paste the content here. -->
