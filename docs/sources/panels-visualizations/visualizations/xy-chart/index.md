...
{{< docs/public-preview product="The xy chart visualization" featureFlag="`autoMigrateXYChartPanel`" >}}
...
When you hover your cursor over the visualization, Grafana can display tooltips. Choose how they behave by selecting the **Tooltip mode**:
