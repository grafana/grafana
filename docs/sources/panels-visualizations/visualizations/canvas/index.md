...
1. Click **+ Add action**.
   ...
   | Variables            | **Key**, **Name**, **Type** pairs. Click the **+** icon to add as many variables as you need. To add a variable to the request, prefix the key with `$`. You can configure the values for the variables when performing an action. |
