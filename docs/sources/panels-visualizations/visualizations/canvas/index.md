...
> 1. Choose Reduce Row from the dropdown and click on the field name that you want to use for the element
> 1. Select All Values from the Calculation drop down
