...
This panel visualization displays an RSS feed. The panel is pre-configured to display articles from the Grafana Labs blog, and users can change this by entering a different RSS feed URL.
