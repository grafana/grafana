...
- **Symbol Vertical Align** configures the vertical alignment of the symbol relative to the data point. Note: This option is impacted by the symbol's rotation angle.
- **Symbol Horizontal Align** configures the horizontal alignment of the symbol relative to the data point. Note: This option is impacted by the symbol's rotation angle.
