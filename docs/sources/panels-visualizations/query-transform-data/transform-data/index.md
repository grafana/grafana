...
- **Mode -** Select a mode:
  ...
  - **Row Index -** Will insert a field with the row index.
...
- **Show percentage -** If you select **Row Index** mode, then the **Show percentage** switch appears. This switch allows you to show the row index as a percentage of the total number of rows.
