...
- **Mode -** Select a mode:
  ...
  - **Row index -** Inserts a field with the row index.
...
- **Show quantile -** If you select **Row index** mode, then the **Show quantile** switch appears. This switch allows you to show the row index as a quantile of the total number of rows. The default unit used is percent, but can be overridden.
