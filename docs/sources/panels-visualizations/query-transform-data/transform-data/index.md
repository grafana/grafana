...
- **as** - Select the FieldType to convert to
  ...
  - **Time** - attempts to parse the values as time
    - The input will be parsed according to the [momentjs parsing format](https://momentjs.com/docs/#/parsing/)
    - It will parse the numeric input as a Unix timestamp in milliseconds. You must multiply your input by 1000 if it's in seconds
