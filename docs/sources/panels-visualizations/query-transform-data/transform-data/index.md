...
- **Show percentile -** If you select **Row index** mode, then the **Show percentile** switch appears. This switch allows you to show the row index as a percentage of the total number of rows.
