...
- **Range** - Match a range between a specified minimum and maximum, min and max not included. A time field will pre-populate with variables to filter by selected time.
