...
> For Grafana Cloud instances, please use a Bearer token to authenticate. The examples within this section references Basic authentication which is for On-Prem Grafana instances.
