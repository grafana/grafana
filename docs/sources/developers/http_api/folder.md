...
- **uid** – Optional [unique identifier](http://docs.grafana.org/http_api/folder/#identifier-id-vs-unique-identifier-uid).
...
- **uid** – Provide another [unique identifier](http://docs.grafana.org/http_api/folder/#identifier-id-vs-unique-identifier-uid) than stored to change the unique identifier. Starting with 10.0, this is **deprecated**. It will be removed in a future release. Please avoid using it because it can result in folder losing its permissions.
- **title** – The title of the folder.
