...
```
{{% admonition type="note" %}}
`activeUsers` agreggates the number users who have logged-in in the last 30 days. `monthlyActiveUsers` aggregates the number of users who have logged-in during the calendar month. 
{{% /admonition %}}
