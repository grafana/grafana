...
| `filter`   | [MatcherConfig](#matcherconfig) | No       |         | Optional frame matcher. When missing it will be applied to all results                 |
...
| Property     | Type                                        | Required | Default | Description                                                            |
|--------------|---------------------------------------------|----------|---------|------------------------------------------------------------------------|
| `matcher`    | [MatcherConfig](#matcherconfig)             | **Yes**  |         | Optional frame matcher. When missing it will be applied to all results |
...
| Property | Type    | Required | Default | Description                                                                                                       |
|----------|---------|----------|---------|-------------------------------------------------------------------------------------------------------------------|
| `h`      | uint32  | **Yes**  | `9`     | Panel height. The height is the number of rows from the top edge of the grid                                      |
| `w`      | integer | **Yes**  | `12`    | Panel width. The width is the number of columns from the left edge of the grid<br/>Constraint: `>0 & <=24`.       |
