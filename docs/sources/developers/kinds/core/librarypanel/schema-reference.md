...
| `name`          | string                                          | **Yes**  | Panel name (also saved in the model)<br/>Constraint: `1 <= len(val) `.                                                               |
| `type`          | string                                          | **Yes**  | The panel type (from inside the model)<br/>Constraint: `1 <= len(val) `.                                                             |
...
| `schemaVersion` | integer                                         | No       | Dashboard version when this was saved (zero if unknown)<br/>Constraint: `0 <= val <= 65535`.                                         |
