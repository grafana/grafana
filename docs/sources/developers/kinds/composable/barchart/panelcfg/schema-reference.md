...
It extends [AxisConfig](#axisconfig) and [HideableFieldConfig](#hideablefieldconfig) and [PointsConfig](#pointsconfig) and [LineConfig](#lineconfig).
...
| `drawStyle`         | string                                                    | No       |         | Draw style                                                                                                                                                                                                                                                                    |
