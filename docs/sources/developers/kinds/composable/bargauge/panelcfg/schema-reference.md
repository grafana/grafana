...
| `maxVizHeight`  | uint32                                          | **Yes**  | `256`   |                                                                                                                                               |
| `minVizHeight`  | uint32                                          | **Yes**  | `16`    |                                                                                                                                               |
| `minVizWidth`   | uint32                                          | **Yes**  | `16`    |                                                                                                                                               |
...
| `sizing`        | string                                          | **Yes**  |         | Allows for the bar gauge size to be setted explicitly<br/>Possible values are: `auto`, `manual`.                                              |
