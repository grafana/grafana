...
> ** Note:** As of Grafana 10.0, the Toolkit is deprecated. It is replaced by the []`create-plugin`](https://grafana.github.io/plugin-tools/docs/creating-a-plugin) tool.
