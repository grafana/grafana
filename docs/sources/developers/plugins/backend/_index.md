...
Data source plugins can be extended with a backend component. In the future we plan to support additional types and possibly new kinds of plugins, such as [notifiers for Grafana Alerting]({{< relref "../../../alerting/unified-alerting/notifications/_index.md" >}}) and custom authentication to name a few.
