...
For more information on time series, refer to our [Introduction to time series](https://grafana.com/docs/grafana/latest/getting-started/timeseries/#introduction-to-time-series).
