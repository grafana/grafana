...
| `alerting`           | boolean                       | No       | For data source plugins, if the plugin supports alerting. Requires `backend` to be enabled as well.                                                                                                                                                                                                                                                                                                     |
...
| `builtIn`            | boolean                       | No       | Indicates whether the plugin is developed and shipped as part of Grafana. Also known as a 'core plugin'.                                                                                                                                                                                                                                                                                                |
...
| `metrics`            | boolean                       | No       | For data source plugins, if the plugin supports metric queries. Needs to be enabled for data source plugins. Used to enable the plugin in the panel editor.                                                                                                                                                                                                                                             |
| `pascalName`         | string                        | No       | The PascalCase name for the plugin. Used for creating machine-friendly identifiers, typically in code generation. If not provided, defaults to name, but title-cased and sanitized (only alphabetical characters allowed).                                                                                                                                                                              |
| `preload`            | boolean                       | No       | Initialize plugin on startup. By default, the plugin initializes on first use. Useful for app plugins that require to load without user interaction.                                                                                                                                                                                                                                                    |
...
| `streaming`          | boolean                       | No       | For data source plugins, if the plugin supports streaming. Used in Explore to start live stream.                                                                                                                                                                                                                                                                                                        |
