...
title = "Field options"
type = "docs"
aliases = ["/docs/grafana/v7.1/panels/field-configuration-options/"]
[menu.docs]
parent = "panels"
weight = 300
+++
...
The data model used in Grafana, the [data frame](https://grafana.com/developers/plugin-tools/introduction/data-frames),
