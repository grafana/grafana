...
- **Search -** Display dashboards by search query or tags. Requires you to enter at least one value in **Query** or **Tags**. Variable interpolation is supported using the dollar sign syntax, `$my_var`, in the **Query** and **Tags** fields.
