...
| `disableAngular`                  | Dynamic flag to disable angular at runtime. The prefered method is to set `angular_support_enabled` = false in the [security] settings, but this allows changing the state at runtime. |
