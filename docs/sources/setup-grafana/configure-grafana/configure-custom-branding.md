---
aliases:
  - /docs/grafana/next/enterprise/white-labeling/
  - /docs/grafana/next/setup-grafana/enable-custom-branding/
  - /docs/grafana/next/setup-grafana/configure-grafana/configure-custom-branding/
