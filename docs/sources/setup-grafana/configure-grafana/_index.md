...
The maximum number of open connections to the database. For MYSQL, this setting needs to be configured on both Grafana and database sides [`sysvar_max_connections`](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_max_connections.).
