...
1. Optional: [Configure a refresh token](#configure-a-refresh-token):
   ...
   b. Enable the [refresh token](#configure-a-refresh-token) at the Okta application settings.
...
> **Note:** Available in [Grafana Enterprise](../../../../introduction/grafana-enterprise/) and [Grafana Cloud](../../../../introduction/grafana-cloud/).
