...
| `login_prompt`                  | No       | Yes                | Indicates the type of user iteraction when the user logs in with Azure AD/Entra ID. Available values are `login`, `consent` and `select_account`.                                                                                                                                                                                                                                                                                                                                               |                                                      |
