...
| `auth_url`                   | Yes      | Yes                | Authorization endpoint of the Google OAuth2 provider.                                                                                                                                                                                                                                                                                                                                                                                                                                           | `https://accounts.google.com/o/oauth2/v2/auth`     |
...
| `allow_sign_up`              | No       | Yes                | Controls Grafana user creation through the Google login. Only existing Grafana users can log in with generic OAuth if set to `false`.                                                                                                                                                                                                                                                                                                                                                           | `true`                                             |
