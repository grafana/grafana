...
We do not currently sync roles from Google and instead set the AutoAssigned role to the user at first login; enabling this setting does not impact your Grafana currently.
