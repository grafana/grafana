...
1. Create an oncall integration of the type **Webhook** and set up alerts.
   To learn how to create a Grafana OnCall integration, refer to [Webhook integrations for Grafana OnCall]({{< relref "/docs/oncall/latest/integrations/available-integrations/configure-webhook" >}}).
