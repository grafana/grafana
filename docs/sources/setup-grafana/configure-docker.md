...
In order to install plugins from other sources, You will need to define the custom URL and specify it using the Environment Variable: `GF_INSTALL_PLUGINS=<url to plugin zip>;<plugin install folder name>`.
