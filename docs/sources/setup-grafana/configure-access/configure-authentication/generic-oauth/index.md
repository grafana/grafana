...
| `token_exchange_timeout`     | No       | No                 | Timeout in seconds for the OAuth token exchange HTTP request (e.g., the POST to the token endpoint). Increase this for environments with high network latency to your OAuth provider (e.g., private clouds, VPNs). Sub-timeouts (dial, TLS handshake) scale proportionally. Defaults to `15`.                                                                                                                                                                                                                                                                                                                        | `15`            |
