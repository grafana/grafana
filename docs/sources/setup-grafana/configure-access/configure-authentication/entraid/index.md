...
| `token_exchange_timeout`        | No       | Yes                | Timeout for exchanging the authorization code with the token endpoint. Use this when network latency to Entra ID can exceed the default request behavior. The value is a duration such as `30s` or `1m`.                                                                                                                                                                                                                                                                                        |                                                      |
