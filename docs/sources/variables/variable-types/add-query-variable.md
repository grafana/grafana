...
Query variables are only supported for strings. To use numbers, convert them to strings and then use them as query variables. For the Azure data source, for example, you can use the [tostring](https://docs.microsoft.com/en-us/azure/data-explorer/kusto/query/tostringfunction) function for this purpose.
