...
{{< docs-imagebox img="/static/img/docs/v50/export_modal.png" max-width="700px" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/import_step1.png" max-width="700px" >}}

From here you can upload a dashboard json file, paste a [Grafana.com](https://grafana.com) dashboard
url or paste dashboard json text directly into the text area.

{{< docs-imagebox img="/static/img/docs/v50/import_step2.png"  max-width="700px" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/gcom_dashboard_list.png" max-width="700px" >}}
