...
- **scale**: numeric value to configure device scale factor. Default is 1. Using a higher value will produce more detailed images (higher DPI). Supported in Grafana v7.0+.
