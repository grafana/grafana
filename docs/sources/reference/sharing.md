...
{{< docs-imagebox img="/static/img/docs/v50/share_panel_modal.png" max-width="700px" >}}
...
{{< docs-imagebox img="/static/img/docs/v50/export_panel_data.png" max-width="500px" >}}
