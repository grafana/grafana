...
(\*) Pure Git, GitLab and Bitbucket are supported in Grafana v12.4.x only. Refer to [Enable required feature toggles](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/as-code/observability-as-code/git-sync/git-sync-setup/set-up-before#enable-required-feature-toggles) to set them up.
