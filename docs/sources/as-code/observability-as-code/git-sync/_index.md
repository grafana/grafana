...
Refer to [key concepts](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/observability-as-code/git-sync/key-concepts) and [known issues](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/observability-as-code/git-sync/known-issues) for further details.
...
- If you enable the [webhooks feature](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/observability-as-code/git-sync/git-sync-setup/#configure-webhooks-and-image-rendering), repository notifications appear almost immediately.
