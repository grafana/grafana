...
You can sign up to the public preview using the [Git Sync early access form](https://forms.gle/WKkR3EVMcbqsNnkD9).
...
Refer to [key concepts](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/as-code/observability-as-code/git-sync/key-concepts) and [known issues](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/as-code/observability-as-code/git-sync/known-issues) for further details.
