...
type = "docs"
aliases = ["/docs/grafana/v7.2/guides/gettingstarted","/docs/grafana/v7.2/guides/getting_started"]
[menu.docs]
...
{{< figure class="float-right"  max-width="800px" src="/static/img/docs/getting-started/simple_grafana_prom_dashboard.png" caption="Alerting overview" >}}
