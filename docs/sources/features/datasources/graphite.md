...
type = "docs"
aliases = ["/docs/grafana/v7.0/datasources/graphite"]
[menu.docs]
name = "Graphite"
identifier = "graphite"
parent = "datasources"
...
{{< figure src="/static/img/docs/v45/graphite_query1_still.png"
...
{{< figure src="/static/img/docs/v45/graphite_query2_still.png"
...
{{< figure src="/static/img/docs/v45/graphite_query3_still.png"
...
{{< figure src="/static/img/docs/v45/graphite_nested_queries_still.png"
