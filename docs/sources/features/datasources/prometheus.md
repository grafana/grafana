...
| _Disable metrics lookup_  | Checking this option will disable the metrics chooser and metric/label support in the query fields autocomplete. This helps if you have performance issues with bigger Prometheus instances.           |
