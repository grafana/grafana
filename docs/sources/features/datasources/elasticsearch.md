...
Currently the versions available is 2.x, 5.x, 5.6+, 6.0+ or 7.0+. 5.6+ means a version of 5.6 or less than 6.0. 6.0+ means a version of 6.0 or higher, 6.3.2 for example, and 7.0+ means version 7.0 and higher (hopefully).
