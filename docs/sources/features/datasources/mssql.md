...
A lower limit for the [$__interval]({{< relref "../../variables/syntax-types/#the-interval-variable" >}}) and [$__interval_ms]({{< relref "../../variables/syntax-types/#the-interval-ms-variable" >}}) variables.
...
Read more about variable formatting options in the [Variables]({{< relref "../../variables/syntax-types.md#advanced-formatting-options" >}}) documentation.
