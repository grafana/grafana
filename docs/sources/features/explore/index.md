...
If you just want to explore your data and do not want to create a dashboard then Explore makes this much easier. Explore will show the results both as a graph and a table enabling you to see trends in the data and more details at the same time (if the data source supports both graph and table data).
