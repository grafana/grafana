...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-panel.png" class="docs-image--no-shadow" max-width="900px" >}}
...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-value-options.png" class="docs-image--no-shadow" max-width="900px" >}}
...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-color-options.png" max-width="500px" class="docs-image--right docs-image--no-shadow">}}
...
5. **Invert order**: This link toggles the threshold color order.</br>For example: Green, Orange, Red (<img class="no-shadow" src="/static/img/docs/v1/gyr.png">) will become Red, Orange, Green (<img class="no-shadow" src="/static/img/docs/v1/ryg.png">).
...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-spark-options.png" max-width="500px" class="docs-image--right docs-image--no-shadow">}}
...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-gauge-options.png" max-width="500px" class="docs-image--right docs-image--no-shadow">}}
...
{{< docs-imagebox img="/static/img/docs/v45/singlestat-value-mapping.png" class="docs-image--right docs-image--no-shadow">}}
...
{{< docs-imagebox img="/static/img/docs/v45/singelstat-multiple-series-error.png" class="docs-image--right docs-image--no-shadow">}}
