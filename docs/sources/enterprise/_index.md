...
- [AWS Secrets Manager integration]({{< relref "../setup-grafana/configure-security/configure-database-encryption/encrypt-secrets-using-aws-secrets-manager/" >}}) to store datasource secrets in AWS Secrets Manager.
