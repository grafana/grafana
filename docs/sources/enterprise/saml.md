...
| `allow_sign_up`                                            | No       | Whether to allow new Grafana users to be created through SAML login. If set to `false`, only pre-existing Grafana users will be able to login with SAML.                                            | `true`        |
