...
1. In the `[auth.saml]` section in the Grafana configuration file, set [`enabled`]({{< relref "../setup-grafana/configure-grafana/enterprise-configuration/#enabled" >}}) to `true`.
