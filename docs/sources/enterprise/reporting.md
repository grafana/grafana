...
Scheduled reports can be sent once or repeated on an hourly, daily, weekly and monthly basis, or at custom intervals. You can also disable scheduling by selecting **Never**: for example, if you want to send the report via the API.
