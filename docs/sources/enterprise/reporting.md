...
> **Note:** Available in [Grafana Enterprise]({{< relref "../enterprise" >}}) 7.5+ behind the `reportVariables` feature flag, Grafana Enterprise 8+ without a feature flag, and [Grafana Cloud Pro and Advanced]({{< relref "/grafana-cloud" >}}).
...
> **Note:** Available in [Grafana Enterprise]({{< relref "../enterprise" >}}) 8+, and [Grafana Cloud Pro and Advanced]({{< relref "/grafana-cloud" >}}).
...
> **Note:** Available in [Grafana Enterprise]({{< relref "../enterprise" >}}) 8+, and [Grafana Cloud Pro and Advanced]({{< relref "/grafana-cloud" >}}).
> Scheduler has been significantly changed in Grafana Enterprise v8.1.
...
> **Note:** Available in [Grafana Enterprise]({{< relref "../enterprise" >}}) 7+ and [Grafana Cloud Pro and Advanced]({{< relref "/grafana-cloud" >}}).
...
> **Note:** Available in [Grafana Enterprise]({{< relref "../enterprise" >}}) 7.2+ and [Grafana Cloud Pro and Advanced]({{< relref "/grafana-cloud" >}}).
