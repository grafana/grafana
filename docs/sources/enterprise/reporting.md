...
- The Image Renderer plugin must be installed or the remote rendering service must be set up. Refer to [Image rendering]({{< relref "../image_rendering.md" >}}) for more information.
...
This feature relies on the same plugin that supports the [image rendering]({{< relref "../image_rendering.md" >}}) features.
