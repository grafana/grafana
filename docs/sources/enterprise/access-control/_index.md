...
To grant or revoke access to your users, you can either use [user role assignments]({{< relref "./roles.md#user-role-assignments" >}}) or [built-in role assignments]({{< relref "./roles.md#built-in-role-assignments" >}}).
