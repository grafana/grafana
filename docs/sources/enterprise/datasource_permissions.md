...
> **Caution:** Enabling permissions for the default data source makes it unable to query for users not listed in the permissions. Panels using default data source will return `Access denied to datasource` error for that users.
