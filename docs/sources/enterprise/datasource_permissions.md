...
When permissions are enabled for a data source in an organization, the user who created the datasource will be able to edit the datasource and viewers can query by default.
