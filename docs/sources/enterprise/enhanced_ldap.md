...
> Refer to [Role-based access control]({{< relref "access-control/_index.md" >}}) in Grafana Enterprise to understand how you can control access with role-based permissions.
