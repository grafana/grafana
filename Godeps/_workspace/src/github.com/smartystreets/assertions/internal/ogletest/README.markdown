...
and then use `go doc`:
    ...
    go doc github.com/smartystreets/assertions/internal/ogletest
...
[reference]: http://gopkgdoc.appspot.com/pkg/github.com/smartystreets/assertions/internal/ogletest
[matcher-reference]: http://gopkgdoc.appspot.com/pkg/github.com/smartystreets/assertions/internal/oglematchers
