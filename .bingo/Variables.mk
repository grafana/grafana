...
$(MIGRATE): $(BINGO_DIR)/migrate.mod
	...
	@cd $(BINGO_DIR) && $(GO) build -tags=sqlite3,mysql,postgres -mod=mod -modfile=migrate.mod -o=$(GOBIN)/migrate-v4.15.2 "github.com/golang-migrate/migrate/v4/cmd/migrate"
