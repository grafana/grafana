  ...
  it('Tests various Panel edit scenarios', () => {
    ...
    e2e.components.PanelEditor.DataPane.content()
      ...
      .within(() => {
        ...
        e2e.components.Transforms.card('Add field from calculation').scrollIntoView().should('be.visible'); // JEV: is this the issue???? Merge is usable, and therefore not visible?
