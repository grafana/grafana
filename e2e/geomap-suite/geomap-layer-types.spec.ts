...
e2e.scenario({
  ...
  scenario: () => {
    ...
    // Heatmap
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('Heatmap{enter}').wait(500);
    ...
    // GeoJSON
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('GeoJSON{enter}').wait(500);
    ...
    // Open Street Map
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('Open Street Map{enter}').wait(500);
    ...
    // CARTO basemap
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('CARTO basemap{enter}').wait(500);
    ...
    // XYZ Tile layer
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('XYZ Tile layer{enter}').wait(500);
...
e2e.scenario({
  ...
  scenario: () => {
    ...
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('Dynamic GeoJSON{enter}').wait(500);
    ...
    // Night / Day (Alpha)
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('Night / Day{enter}').wait(500);
    ...
    // Route (Alpha)
    e2e.components.PanelEditor.OptionsPane.fieldLabel('Map layers Layer type').type('Route{enter}').wait(500);
