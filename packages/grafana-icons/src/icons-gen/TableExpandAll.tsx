...
const SvgTableExpandAll = (props: IconProps) => (
  <IconBase viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path stroke="currentColor" d="M2.5 5.5h11v2H2.5Z" />
    <path stroke="currentColor" d="M2.5 1.5h11v2H2.5Z" />
...
const Memo = memo(SvgTableExpandAll);
export default Memo;
