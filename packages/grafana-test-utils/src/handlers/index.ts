...
export { MERGED_PREFS_URL, preferencesHandlers } from './apis/preferences.grafana.app/v1/handlers';
export { starsRoute } from './apis/collections.grafana.app/v1alpha1/handlers';
export {
