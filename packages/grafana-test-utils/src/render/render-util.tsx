...
// TODO: Problematic imports below - we're reaching into the core code in order to get these
import { GrafanaContext, GrafanaContextType } from '../../../../public/app/core/context/GrafanaContext';
import { ModalsContextProvider } from '../../../../public/app/core/context/ModalsContextProvider';
import { configureStore } from '../../../../public/app/store/configureStore';
import { StoreState } from '../../../../public/app/types/store';
import { getGrafanaContextMock } from '../../../../public/test/mocks/getGrafanaContextMock';
...
): ReturnType<typeof render> & { user: ReturnType<typeof userEvent.setup>; store?: Store<StoreState> } => {
