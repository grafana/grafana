...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Bitcoin (B͈̎)', id: 'currencyBTC', fn: currency('B͈̎') },
      { name: 'micro Bitcoin (B͈̎)', id: 'currencymBTC', fn: currency('mBTC') },
      { name: 'milli Bitcoin (B͈̎)', id: 'currencyμBTC', fn: currency('μBTC') },
