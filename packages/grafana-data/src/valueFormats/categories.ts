...
export const getCategories = (): ValueFormatCategory[] => [
  {
    ...
    formats: [
      ...
      { name: 'decibel (dB)', id: 'dB', fn: toFixedUnit('dB') },
      ...
      { name: 'Pixels (px)', id: 'pixel', fn: toFixedUnit('px') },
    ],
  },
  {
    name: 'Acceleration',
    formats: [
      { name: 'Meters/sec² (m/s²)', id: 'accMS2', fn: toFixedUnit('m/sec²') },
      { name: 'Feet/sec² (f/s²)', id: 'accFS2', fn: toFixedUnit('f/sec²') },
      { name: 'G unit (g)', id: 'accG', fn: toFixedUnit('g') },
    ],
  },
  {
    name: 'Angle',
    formats: [
      ...
      { name: 'Radians (rad)', id: 'radian', fn: toFixedUnit('rad') },
      { name: 'Gradian (grad)', id: 'grad', fn: toFixedUnit('grad') },
      { name: 'Arc Minutes (arcmin)', id: 'arcmin', fn: toFixedUnit('arcmin') },
      { name: 'Arc Seconds (arcsec)', id: 'arcsec', fn: toFixedUnit('arcsec') },
    ],
  },
  {
    name: 'Area',
  ...
  },
  {
    name: 'Pressure',
    formats: [
      { name: 'Millibars (mbar)', id: 'pressurembar', fn: decimalSIPrefix('bar', -1) },
      { name: 'Bars (bar)', id: 'pressurebar', fn: decimalSIPrefix('bar') },
      { name: 'Kilobars (kbar)', id: 'pressurekbar', fn: decimalSIPrefix('bar', 1) },
      { name: 'Hectopascals (hPa)', id: 'pressurehpa', fn: toFixedUnit('hPa') },
      { name: 'Kilopascals (kPa)', id: 'pressurekpa', fn: toFixedUnit('kPa') },
      { name: 'Inches of mercury ("Hg)', id: 'pressurehg', fn: toFixedUnit('"Hg') },
      { name: 'PSI (psi)', id: 'pressurepsi', fn: scaledUnits(1000, ['psi', 'ksi', 'Mpsi']) },
    ],
  },
  {
    name: 'Radiation',
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'cubic meter (m³)', id: 'm3', fn: toFixedUnit('m³') },
      { name: 'Normal cubic meter (Nm³)', id: 'Nm3', fn: toFixedUnit('Nm³') },
      { name: 'cubic decimeter (dm³)', id: 'dm3', fn: toFixedUnit('dm³') },
      { name: 'gallons (gal)', id: 'gallons', fn: toFixedUnit('gal') },
    ],
  },
];
