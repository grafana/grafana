...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'GFLOP/s', id: 'gflops', fn: SIPrefix('FLOPS', 5) },
      { name: 'TFLOP/s', id: 'tflops', fn: SIPrefix('FLOPS', 6) },
      { name: 'PFLOP/s', id: 'pflops', fn: SIPrefix('FLOPS', 7) },
      { name: 'EFLOP/s', id: 'eflops', fn: SIPrefix('FLOPS', 8) },
      { name: 'ZFLOP/s', id: 'zflops', fn: SIPrefix('FLOPS', 9) },
      { name: 'YFLOP/s', id: 'yflops', fn: SIPrefix('FLOPS', 10) },
    ],
  },
  {
    name: 'Concentration',
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'kilobytes', id: 'deckbytes', fn: SIPrefix('B', 3) },
      { name: 'mebibytes', id: 'mbytes', fn: binaryPrefix('B', 2) },
      { name: 'megabytes', id: 'decmbytes', fn: SIPrefix('B', 4) },
      { name: 'gibibytes', id: 'gbytes', fn: binaryPrefix('B', 3) },
      { name: 'gigabytes', id: 'decgbytes', fn: SIPrefix('B', 5) },
      { name: 'tebibytes', id: 'tbytes', fn: binaryPrefix('B', 4) },
      { name: 'terabytes', id: 'dectbytes', fn: SIPrefix('B', 6) },
      { name: 'pebibytes', id: 'pbytes', fn: binaryPrefix('B', 5) },
      { name: 'petabytes', id: 'decpbytes', fn: SIPrefix('B', 7) },
    ],
  },
  {
    name: 'Data rate',
    formats: [
      ...
      { name: 'kilobytes/sec', id: 'KBs', fn: SIPrefix('B/s', 3) },
      { name: 'kilobits/sec', id: 'Kbits', fn: SIPrefix('b/s', 3) },
      { name: 'mebibytes/sec', id: 'MiBs', fn: binaryPrefix('B/s', 2) },
      { name: 'mebibits/sec', id: 'Mibits', fn: binaryPrefix('b/s', 2) },
      { name: 'megabytes/sec', id: 'MBs', fn: SIPrefix('B/s', 4) },
      { name: 'megabits/sec', id: 'Mbits', fn: SIPrefix('b/s', 4) },
      { name: 'gibibytes/sec', id: 'GiBs', fn: binaryPrefix('B/s', 3) },
      { name: 'gibibits/sec', id: 'Gibits', fn: binaryPrefix('b/s', 3) },
      { name: 'gigabytes/sec', id: 'GBs', fn: SIPrefix('B/s', 5) },
      { name: 'gigabits/sec', id: 'Gbits', fn: SIPrefix('b/s', 5) },
      { name: 'tebibytes/sec', id: 'TiBs', fn: binaryPrefix('B/s', 4) },
      { name: 'tebibits/sec', id: 'Tibits', fn: binaryPrefix('b/s', 4) },
      { name: 'terabytes/sec', id: 'TBs', fn: SIPrefix('B/s', 6) },
      { name: 'terabits/sec', id: 'Tbits', fn: SIPrefix('b/s', 6) },
      { name: 'pebibytes/sec', id: 'PiBs', fn: binaryPrefix('B/s', 5) },
      { name: 'pebibits/sec', id: 'Pibits', fn: binaryPrefix('b/s', 5) },
      { name: 'petabytes/sec', id: 'PBs', fn: SIPrefix('B/s', 7) },
      { name: 'petabits/sec', id: 'Pbits', fn: SIPrefix('b/s', 7) },
    ],
  },
  {
    name: 'Date & time',
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Kilowatt (kW)', id: 'kwatt', fn: SIPrefix('W', 3) },
      { name: 'Megawatt (MW)', id: 'megwatt', fn: SIPrefix('W', 4) },
      { name: 'Gigawatt (GW)', id: 'gwatt', fn: SIPrefix('W', 5) },
      { name: 'Milliwatt (mW)', id: 'mwatt', fn: SIPrefix('W', -3) },
      { name: 'Watt per square meter (W/m²)', id: 'Wm2', fn: toFixedUnit('W/m²') },
      { name: 'Volt-Ampere (VA)', id: 'voltamp', fn: SIPrefix('VA') },
      { name: 'Kilovolt-Ampere (kVA)', id: 'kvoltamp', fn: SIPrefix('VA', 3) },
      { name: 'Volt-Ampere reactive (VAr)', id: 'voltampreact', fn: SIPrefix('VAr') },
      { name: 'Kilovolt-Ampere reactive (kVAr)', id: 'kvoltampreact', fn: SIPrefix('VAr', 3) },
      { name: 'Watt-hour (Wh)', id: 'watth', fn: SIPrefix('Wh') },
      { name: 'Watt-hour per Kilogram (Wh/kg)', id: 'watthperkg', fn: SIPrefix('Wh/kg') },
      { name: 'Kilowatt-hour (kWh)', id: 'kwatth', fn: SIPrefix('Wh', 3) },
      { name: 'Kilowatt-min (kWm)', id: 'kwattm', fn: SIPrefix('W-Min', 3) },
      { name: 'Ampere-hour (Ah)', id: 'amph', fn: SIPrefix('Ah') },
      { name: 'Kiloampere-hour (kAh)', id: 'kamph', fn: SIPrefix('Ah', 3) },
      { name: 'Milliampere-hour (mAh)', id: 'mamph', fn: SIPrefix('Ah', -3) },
      { name: 'Joule (J)', id: 'joule', fn: SIPrefix('J') },
      { name: 'Electron volt (eV)', id: 'ev', fn: SIPrefix('eV') },
      { name: 'Ampere (A)', id: 'amp', fn: SIPrefix('A') },
      { name: 'Kiloampere (kA)', id: 'kamp', fn: SIPrefix('A', 3) },
      { name: 'Milliampere (mA)', id: 'mamp', fn: SIPrefix('A', -3) },
      { name: 'Volt (V)', id: 'volt', fn: SIPrefix('V') },
      { name: 'Kilovolt (kV)', id: 'kvolt', fn: SIPrefix('V', 3) },
      { name: 'Millivolt (mV)', id: 'mvolt', fn: SIPrefix('V', -3) },
      { name: 'Decibel-milliwatt (dBm)', id: 'dBm', fn: SIPrefix('dBm') },
      { name: 'Milliohm (mΩ)', id: 'mohm', fn: SIPrefix('Ω', -3) },
      { name: 'Ohm (Ω)', id: 'ohm', fn: SIPrefix('Ω') },
      { name: 'Kiloohm (kΩ)', id: 'kohm', fn: SIPrefix('Ω', 3) },
      { name: 'Megaohm (MΩ)', id: 'Mohm', fn: SIPrefix('Ω', 4) },
      { name: 'Farad (F)', id: 'farad', fn: SIPrefix('F') },
      { name: 'Microfarad (µF)', id: 'µfarad', fn: SIPrefix('F', -4) },
      { name: 'Nanofarad (nF)', id: 'nfarad', fn: SIPrefix('F', -5) },
      { name: 'Picofarad (pF)', id: 'pfarad', fn: SIPrefix('F', -6) },
      { name: 'Femtofarad (fF)', id: 'ffarad', fn: SIPrefix('F', -7) },
      { name: 'Henry (H)', id: 'henry', fn: SIPrefix('H') },
      { name: 'Millihenry (mH)', id: 'mhenry', fn: SIPrefix('H', -3) },
      { name: 'Microhenry (µH)', id: 'µhenry', fn: SIPrefix('H', -4) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Kilonewton-meters (kNm)', id: 'forcekNm', fn: SIPrefix('Nm', 3) },
      { name: 'Newtons (N)', id: 'forceN', fn: SIPrefix('N') },
      { name: 'Kilonewtons (kN)', id: 'forcekN', fn: SIPrefix('N', 3) },
    ],
  },
  {
    name: 'Hash rate',
    formats: [
      ...
      { name: 'kilohashes/sec', id: 'KHs', fn: SIPrefix('H/s', 3) },
      { name: 'megahashes/sec', id: 'MHs', fn: SIPrefix('H/s', 4) },
      { name: 'gigahashes/sec', id: 'GHs', fn: SIPrefix('H/s', 5) },
      { name: 'terahashes/sec', id: 'THs', fn: SIPrefix('H/s', 6) },
      { name: 'petahashes/sec', id: 'PHs', fn: SIPrefix('H/s', 7) },
      { name: 'exahashes/sec', id: 'EHs', fn: SIPrefix('H/s', 8) },
    ],
  },
  {
    name: 'Mass',
    formats: [
      { name: 'milligram (mg)', id: 'massmg', fn: SIPrefix('g', -3) },
      { name: 'gram (g)', id: 'massg', fn: SIPrefix('g') },
      { name: 'pound (lb)', id: 'masslb', fn: toFixedUnit('lb') },
      { name: 'kilogram (kg)', id: 'masskg', fn: SIPrefix('g', 3) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'millimeter (mm)', id: 'lengthmm', fn: SIPrefix('m', -3) },
      { name: 'centimeter (cm)', id: 'lengthcm', fn: SIPrefix('m', -2) },
      // { name: 'deci (dm)', id: 'lengtdm', fn: SIPrefix('m', -1) },
      { name: 'meter (m)', id: 'lengthm', fn: SIPrefix('m') },
      { name: 'kilometer (km)', id: 'lengthkm', fn: SIPrefix('m', 3) },
    ],
  },
  {
    name: 'Pressure',
    formats: [
      { name: 'Millibars', id: 'pressurembar', fn: SIPrefix('bar', -3) },
      { name: 'Bars', id: 'pressurebar', fn: SIPrefix('bar') },
      { name: 'Kilobars', id: 'pressurekbar', fn: SIPrefix('bar', 3) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'milliSievert (mSv)', id: 'radmsv', fn: SIPrefix('Sv', -3) },
      { name: 'microSievert (µSv)', id: 'radusv', fn: SIPrefix('Sv', -4) },
      ...
      { name: 'milliSievert/hour (mSv/h)', id: 'radmsvh', fn: SIPrefix('Sv/h', -3) },
      { name: 'microSievert/hour (µSv/h)', id: 'radusvh', fn: SIPrefix('Sv/h', -4) },
    ],
  },
  {
  ...
  },
  {
    name: 'Volume',
    formats: [
      { name: 'millilitre (mL)', id: 'mlitre', fn: SIPrefix('L', -3) },
