...
import {
  ...
  toDurationInNanoseconds,
  toDurationInMicroseconds,
...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'duration (ns)', id: 'dtdurationns', fn: toDurationInNanoseconds },
      { name: 'duration (µs)', id: 'dtdurationµs', fn: toDurationInMicroseconds },
