...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Рубль (₽)', id: 'currencyRUB', fn: currency('₽') },
      { name: 'Рубль (₽) (Фиксированный)', id: 'currencyRUBfix', fn: toFixedUnit('₽') },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Ватт (Вт) (Фиксированный)', id: 'wattrussfixshort', fn: toFixedUnit('Вт') },
      { name: 'Ватт (Вт) (Сокращенный)', id: 'wattrussfix', fn: SIPrefix('Вт', 0 ,true) },
      { name: 'Ватт (Вт)', id: 'wattruss', fn: SIPrefix('Вт') },
      { name: 'Kilowatt (kW)', id: 'kwatt', fn: SIPrefix('W', 1) },
      { name: 'Киловатт (кВт) (Фиксированный)', id: 'kwattrusfix', fn: toFixedUnit('кВт') },
      { name: 'Киловатт (кВт)', id: 'kwattrus', fn: SIPrefix('Вт', 1) },
      ...
      { name: 'Ватт-час (Вт⋅ч) (Фиксированный)', id: 'watthrusfix', fn: toFixedUnit('Вт⋅ч') },
      { name: 'Ватт-час (Вт⋅ч) (Сокращенный)', id: 'watthrusshort', fn: SIPrefix('Вт⋅ч', 0, true) },
      { name: 'Ватт-час (Вт⋅ч)', id: 'watthrus', fn: SIPrefix('Вт⋅ч') },
      { name: 'Watt-hour per Kilogram (Wh/kg)', id: 'watthperkg', fn: SIPrefix('Wh/kg') },
      { name: 'Kilowatt-hour (kWh)', id: 'kwatth', fn: SIPrefix('Wh', 1) },
      { name: 'Киловатт-час (кВт⋅ч) (Фиксированный)', id: 'kwatthrusfix', fn: toFixedUnit('кВт⋅ч') },
      { name: 'Киловатт-час (кВт⋅ч)', id: 'kwatthrus', fn: SIPrefix('Вт⋅ч', 1) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Миллисекунда (мс)', id: 'ms', fn: toMilliSeconds },
      { name: 'Секунда (с)', id: 's', fn: toSeconds },
      { name: 'Минута (м)', id: 'm', fn: toMinutes },
      ...
      { name: 'Продолжительность (дд чч:мм:сс)', id: 'dtdhms', fn: toDurationInDaysHoursMinutesSeconds },
  ...
  },
  {
    name: 'Boolean',
    formats: [
      { name: 'Правда / Ложь', id: 'bool', fn: booleanValueFormatter('Правда', 'Ложь') },
      { name: 'Да / Нет', id: 'bool_yes_no', fn: booleanValueFormatter('Да', 'Нет') },
      { name: 'Вкл. / Выкл.', id: 'bool_on_off', fn: booleanValueFormatter('Вкл.', 'Выкл.') },
    ],
  },
];
