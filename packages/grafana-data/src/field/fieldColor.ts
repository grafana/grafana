...
export const fieldColorModeRegistry = new Registry<FieldColorMode>(() => {
  return [
	...
	new FieldColorSchemeMode({
      id: 'continuous-GrYlRd-BiDir',
      name: 'Green-Yellow-Red (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['red', 'yellow', 'green', 'yellow', 'red'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-RdYlGr-BiDir',
      name: 'Red-Yellow-Green (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['green', 'yellow', 'red', 'yellow', 'green'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-BlYlRd-BiDir',
    ...
    new FieldColorSchemeMode({
      ...
      name: 'Yellow-Red (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-red', 'super-light-yellow', 'dark-red'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-BlPu-BiDir',
      name: 'Blue-Purple (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['purple', 'blue', 'purple'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-YlBl-BiDir',
      name: 'Yellow-Blue (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-blue', 'super-light-yellow', 'dark-blue'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-blues-BiDir',
      name: 'Blues (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-blue', 'panel-bg', 'dark-blue'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-reds-BiDir',
      name: 'Reds (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-red', 'panel-bg', 'dark-red'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-greens-BiDir',
      name: 'Greens (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-green', 'panel-bg', 'dark-green'],
    }),
    new FieldColorSchemeMode({
      id: 'continuous-purples-BiDir',
      name: 'Purples (Bidirectional)',
      isContinuous: true,
      isByValue: true,
      getColors: (theme: GrafanaTheme2) => ['dark-purple', 'panel-bg', 'dark-purple'],
    }),
  ];
});
