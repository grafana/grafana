...
const BASE_RANGE_OPTIONS: TimeOption[] = [
  ...
  { from: 'now-1d/d', to: 'now-1d', display: '昨天' },
  { from: 'now-2d/d', to: 'now-2d', display: '前天' },
  { from: 'now-7d/d', to: 'now-7d', display: '上周' },
  { from: 'now-1w/w', to: 'now-1w/w', display: '上周' },
  { from: 'now-1M/M', to: 'now-1M/M', display: '前月' },
...
const HIDDEN_RANGE_OPTIONS: TimeOption[] = [
  { from: 'now', to: 'now+1m', display: '最近1分钟' },
  { from: 'now', to: 'now+5m', display: '最近5分钟' },
  { from: 'now', to: 'now+15m', display: '最近15分钟' },
  { from: 'now', to: 'now+30m', display: '最近30分钟' },
  { from: 'now', to: 'now+1h', display: '最近1小时' },
  { from: 'now', to: 'now+3h', display: '最近3小时' },
  { from: 'now', to: 'now+6h', display: '最近6小时' },
  { from: 'now', to: 'now+12h', display: '最近12小时' },
  { from: 'now', to: 'now+24h', display: '最近24小时' },
  { from: 'now', to: 'now+2d', display: '最近2天' },
  { from: 'now', to: 'now+7d', display: '最近7天' },
  { from: 'now', to: 'now+30d', display: '最近30天' },
  { from: 'now', to: 'now+90d', display: '最近90天' },
  { from: 'now', to: 'now+6M', display: '最近6个月' },
  { from: 'now', to: 'now+1y', display: '最近1年' },
  { from: 'now', to: 'now+2y', display: '最近2年' },
  { from: 'now', to: 'now+5y', display: '最近5年' },
];
