...
const rangeOptions: TimeOption[] = [
  { from: 'now/d', to: 'now/d', display: 'Today', displayTranslated: () => t('range-options.today', 'Today') },
  {
    from: 'now/d',
    to: 'now',
    display: 'Today so far',
    displayTranslated: () => t('range-options.today-so-far', 'Today so far'),
  },
  {
    from: 'now/w',
    to: 'now/w',
    display: 'This week',
    displayTranslated: () => t('range-options.this-week', 'This week'),
  },
  {
    from: 'now/w',
    to: 'now',
    display: 'This week so far',
    displayTranslated: () => t('range-options.this-week-so-far', 'This week so far'),
  },
  {
    from: 'now/M',
    to: 'now/M',
    display: 'This month',
    displayTranslated: () => t('range-options.this-month', 'This month'),
  },
  {
    from: 'now/M',
    to: 'now',
    display: 'This month so far',
    displayTranslated: () => t('range-options.this-month-so-far', 'This month so far'),
  },
  {
    from: 'now/y',
    to: 'now/y',
    display: 'This year',
    displayTranslated: () => t('range-options.this-year', 'This year'),
  },
  {
    from: 'now/y',
    to: 'now',
    display: 'This year so far',
    displayTranslated: () => t('range-options.this-year-so-far', 'This year so far'),
  },

  {
    ...
    to: 'now-1d/d',
    display: 'Yesterday',
    displayTranslated: () => t('range-options.yesterday', 'Yesterday'),
  },
  {
    from: 'now-2d/d',
    to: 'now-2d/d',
    display: 'Day before yesterday',
    displayTranslated: () => t('range-options.day-before-yesterday', 'Day before yesterday'),
  },
  {
    from: 'now-7d/d',
    to: 'now-7d/d',
    display: 'This day last week',
    displayTranslated: () => t('range-options.this-day-last-week', 'This day last week'),
  },
  {
    from: 'now-1w/w',
    to: 'now-1w/w',
    display: 'Previous week',
    displayTranslated: () => t('range-options.previous-week', 'Previous week'),
  },
  {
    from: 'now-1M/M',
    to: 'now-1M/M',
    display: 'Previous month',
    displayTranslated: () => t('range-options.previous-month', 'Previous month'),
  },
  {
    from: 'now-1Q/fQ',
    to: 'now-1Q/fQ',
    display: 'Previous fiscal quarter',
    displayTranslated: () => t('range-options.previous-fiscal-quarter', 'Previous fiscal quarter'),
  },
  {
    from: 'now-1y/y',
    to: 'now-1y/y',
    display: 'Previous year',
    displayTranslated: () => t('range-options.previous-year', 'Previous year'),
  },
  {
    from: 'now-1y/fy',
    to: 'now-1y/fy',
    display: 'Previous fiscal year',
    displayTranslated: () => t('range-options.previous-fiscal-year', 'Previous fiscal year'),
  },

  {
    ...
    displayTranslated: () => t('range-options.last-5-minutes', 'Last 5 minutes'),
  },
  {
    from: 'now-15m',
    to: 'now',
    display: 'Last 15 minutes',
    displayTranslated: () => t('range-options.last-15-minutes', 'Last 15 minutes'),
  },
  {
    from: 'now-30m',
    to: 'now',
    display: 'Last 30 minutes',
    displayTranslated: () => t('range-options.last-30-minutes', 'Last 30 minutes'),
  },
  {
    from: 'now-1h',
    to: 'now',
    display: 'Last 1 hour',
    displayTranslated: () => t('range-options.last-1-hour', 'Last 1 hours'),
  },
  {
    from: 'now-3h',
    to: 'now',
    display: 'Last 3 hours',
    displayTranslated: () => t('range-options.last-3-hours', 'Last 3 hours'),
  },
  {
    from: 'now-6h',
    to: 'now',
    display: 'Last 6 hours',
    displayTranslated: () => t('range-options.last-6-hours', 'Last 6 hours'),
  },
  {
    from: 'now-12h',
    to: 'now',
    display: 'Last 12 hours',
    displayTranslated: () => t('range-options.last-12-hours', 'Last 12 hours'),
  },
  {
    from: 'now-24h',
    to: 'now',
    display: 'Last 24 hours',
    displayTranslated: () => t('range-options.last-24-hours', 'Last 24 hours'),
  },
  {
    from: 'now-2d',
    to: 'now',
    display: 'Last 2 days',
    displayTranslated: () => t('range-options.last-2-days', 'Last 2 days'),
  },
  {
    from: 'now-7d',
    to: 'now',
    display: 'Last 7 days',
    displayTranslated: () => t('range-options.last-7-days', 'Last 7 days'),
  },
  {
    from: 'now-30d',
    to: 'now',
    display: 'Last 30 days',
    displayTranslated: () => t('range-options.last-30-days', 'Last 30 days'),
  },
  {
    from: 'now-90d',
    to: 'now',
    display: 'Last 90 days',
    displayTranslated: () => t('range-options.last-90-days', 'Last 90 days'),
  },
  {
    from: 'now-6M',
    to: 'now',
    display: 'Last 6 months',
    displayTranslated: () => t('range-options.last-6-months', 'Last 6 months'),
  },
  {
    from: 'now-1y',
    to: 'now',
    display: 'Last 1 year',
    displayTranslated: () => t('range-options.last-1-year', 'Last 1 year'),
  },
  {
    from: 'now-2y',
    to: 'now',
    display: 'Last 2 years',
    displayTranslated: () => t('range-options.last-2-years', 'Last 2 years'),
  },
  {
    from: 'now-5y',
    to: 'now',
    display: 'Last 5 years',
    displayTranslated: () => t('range-options.last-5-years', 'Last 5 years'),
  },
  {
    from: 'now/fQ',
    to: 'now',
    display: 'This fiscal quarter so far',
    displayTranslated: () => t('range-options.this-fiscal-quarter-so-far', 'This fiscal quarter so far'),
  },
  {
    from: 'now/fQ',
    to: 'now/fQ',
    display: 'This fiscal quarter',
    displayTranslated: () => t('range-options.this-fiscal-quarter', 'This fiscal quarter'),
  },
  {
    from: 'now/fy',
    to: 'now',
    display: 'This fiscal year so far',
    displayTranslated: () => t('range-options.this-fiscal-year-so-far', 'This fiscal year so far'),
  },
  {
    from: 'now/fy',
    to: 'now/fy',
    display: 'This fiscal year',
    displayTranslated: () => t('range-options.this-fiscal-year', 'This fiscal year'),
  },
];
...
const hiddenRangeOptions: TimeOption[] = [
  {
    ...
    to: 'now+1m',
    display: 'Next minute',
    displayTranslated: () => t('range-options.next-minute', 'Next minute'),
  },
  {
    from: 'now',
    to: 'now+5m',
    display: 'Next 5 minutes',
    displayTranslated: () => t('range-options.next-5-minutes', 'Next 5 minutes'),
  },
  {
    from: 'now',
    to: 'now+15m',
    display: 'Next 15 minutes',
    displayTranslated: () => t('range-options.next-15-minutes', 'Next 15 minutes'),
  },
  {
    from: 'now',
    to: 'now+30m',
    display: 'Next 30 minutes',
    displayTranslated: () => t('range-options.next-30-minutes', 'Next 30 minutes'),
  },
  {
    from: 'now',
    to: 'now+1h',
    display: 'Next hour',
    displayTranslated: () => t('range-options.next-hour', 'Next hour'),
  },
  {
    from: 'now',
    to: 'now+3h',
    display: 'Next 3 hours',
    displayTranslated: () => t('range-options.next-3-hours', 'Next 3 hours'),
  },
  {
    from: 'now',
    to: 'now+6h',
    display: 'Next 6 hours',
    displayTranslated: () => t('range-options.next-6-hours', 'Next 6 hours'),
  },
  {
    from: 'now',
    to: 'now+12h',
    display: 'Next 12 hours',
    displayTranslated: () => t('range-options.next-12-hours', 'Next 12 hours'),
  },
  {
    from: 'now',
    to: 'now+24h',
    display: 'Next 24 hours',
    displayTranslated: () => t('range-options.next-24-hours', 'Next 24 hours'),
  },
  {
    from: 'now',
    to: 'now+2d',
    display: 'Next 2 days',
    displayTranslated: () => t('range-options.next-2-days', 'Next 2 days'),
  },
  {
    from: 'now',
    to: 'now+7d',
    display: 'Next 7 days',
    displayTranslated: () => t('range-options.next-7-days', 'Next 7 days'),
  },
  {
    from: 'now',
    to: 'now+30d',
    display: 'Next 30 days',
    displayTranslated: () => t('range-options.next-30-days', 'Next 30 days'),
  },
  {
    from: 'now',
    to: 'now+90d',
    display: 'Next 90 days',
    displayTranslated: () => t('range-options.next-90-days', 'Next 90 days'),
  },
  {
    from: 'now',
    to: 'now+6M',
    display: 'Next 6 months',
    displayTranslated: () => t('range-options.next-6-months', 'Next 6 months'),
  },
  {
    from: 'now',
    to: 'now+1y',
    display: 'Next year',
    displayTranslated: () => t('range-options.next-year', 'Next year'),
  },
  {
    from: 'now',
    to: 'now+2y',
    display: 'Next 2 years',
    displayTranslated: () => t('range-options.next-2-years', 'Next 2 years'),
  },
  {
    from: 'now',
    to: 'now+5y',
    display: 'Next 5 years',
    displayTranslated: () => t('range-options.next-5-years', 'Next 5 years'),
  },
];
