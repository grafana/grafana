...
export enum PluginExtensionPoints {
  ...
  AlertingRuleAnnotationsAssistant = 'grafana/alerting/alertingrule/annotations-assistant/v1',
  AlertingRuleNotificationPreview = 'grafana/alerting/alertingrule/notification-preview/v1',
  AlertingRuleListItemIndicator = 'grafana/alerting/alertingrule/list-item-indicator/v1',
