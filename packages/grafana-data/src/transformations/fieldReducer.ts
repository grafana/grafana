...
export const fieldReducers = new Registry<FieldReducerInfo>(() => [
  ...
  { id: ReducerID.first, name: 'First', description: 'First Value', standard: true, reduce: calculateFirst, preservesUnits: true },
  ...
  { id: ReducerID.mean, name: 'Mean', description: 'Average Value', standard: true, aliasIds: ['avg'], preservesUnits: true, },
  {
