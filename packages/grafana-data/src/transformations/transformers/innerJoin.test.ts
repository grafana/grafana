...
import { InnerJoinOptions, innerJoinTransformer } from './innerJoin';

describe('InnerJoin Transformer', () => {
  beforeAll(() => {
    mockTransformationsRegistry([innerJoinTransformer]);
  });
  ...
  it('inner joins by time field', async () => {
    const cfg: DataTransformerConfig<InnerJoinOptions> = {
