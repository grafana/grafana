...
// A notebook element is a panel, a library panel, or a narrative cell. Unlike the dashboard
// Element union, this one includes CellKind — and it is referenced ONLY by NotebookSpec.
export type NotebookElement = PanelKind | LibraryPanelKind | CellKind;

export const defaultNotebookElement = (): NotebookElement => (defaultPanelKind());
