...
export const AnnotationQuerySpecSchema = z.object({
	datasource: z.lazy(() => DataSourceRefSchema).optional(),
	query: z.lazy(() => DataQueryKindSchema).optional(),
	enable: z.boolean(),
	hide: z.boolean(),
	iconColor: z.string(),
	name: z.string(),
	...
	legacyOptions: z.record(z.string(), z.unknown()).optional().describe("Catch-all field for datasource-specific properties"),
});

export const DataSourceRefSchema = z.object({
	type: z.string().optional().describe("The plugin type-id"),
	uid: z.string().optional().describe("Specific datasource instance"),
});

export const DataQueryKindSchema = z.object({
	kind: z.string().describe("The kind of a DataQueryKind is the datasource type"),
...
export const VizConfigKindSchema = z.object({
	kind: z.string().describe("The kind of a VizConfigKind is the plugin ID"),
...
export const SwitchVariableSpecSchema = z.object({
	...
	skipUrlSync: z.boolean().optional().default(false),
	description: z.string().optional(),
}).describe("Switch variable specification");
