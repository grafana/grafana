...
export const DashboardSpecSchema = z.object({
	...
	preferences: z.lazy(() => PreferencesSchema).optional(),
});
...
export const TransformationKindSchema = z.object({
	kind: z.literal("Transformation").optional().default("Transformation"),
	group: z.string().describe("The group is the transformation ID"),
	spec: z.lazy(() => TransformationSpecSchema),
});
...
export const PreferencesSchema = z.object({
	layout: z.discriminatedUnion("kind", [z.lazy(() => AutoGridLayoutKindSchema), z.lazy(() => GridLayoutKindSchema)]).optional().describe("default layout template to be used when new containers are created"),
}).describe("Dashboard specific preferences (applied per dashboard = all users using the dashboard)");
