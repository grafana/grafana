...
TimeCompareOptions: {
	...
	timeCompare?: bool
	// How the difference between the current and comparison values is colored
	colorMode?: TimeCompareColorMode
} @cuetsy(kind="interface")

// Colors the difference between the current and comparison values. "standard" colors an increase
