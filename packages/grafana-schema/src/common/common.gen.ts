...
/**
 * Pill cell options
 * The value for a pill cell should be a list of strings (array), or a JSON string that parses to a list of strings. Each string will be rendered as a separate pill.
 */
