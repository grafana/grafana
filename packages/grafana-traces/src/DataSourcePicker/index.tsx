/**
 * Copy of DataSourcePicker from Grafana core, with the following changes:
 * - property `dataSourceSrv` has been added
 */
...
export class DataSourcePicker extends PureComponent<DataSourcePickerProps, DataSourcePickerState> {
  _dataSourceSrv = getDataSourceSrv();

  get dataSourceSrv() {
    return this._dataSourceSrv || this.props.dataSourceSrv || getDataSourceSrv();
  }
