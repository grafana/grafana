...
interface StackingEditorSettings {
...
export const StackingEditor = ({
  ...
  onChange,
  item,
}: StandardEditorProps<StackingConfig, StackingEditorSettings>) => {
  return (
    <HorizontalGroup>
      <RadioButtonGroup
...
export function addStackingConfig(
  ...
  builder.addCustomEditor<StackingEditorSettings, StackingConfig>({
    id: 'stacking',
    path: 'stacking',
    name: 'Stack series',
    category: category,
