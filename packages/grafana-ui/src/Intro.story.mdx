...
## A library of unified components and styles
Grafana-ui is a library of reusable components and guidelines on how to use and develop them. You can arrange them into any complex interface you need, for example in your Grafana plugin, streamlining your design process.
...
1. Understanding of how each component works and how you can use it to create a great user experience. 
2. Short development times and consistent code quality.
3. A beautiful, visually consistent Grafana experience.
4. Transparency about how we work and what we do.
