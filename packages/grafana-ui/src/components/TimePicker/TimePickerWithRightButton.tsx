...
export class TimePickerWithRightButton extends PureComponent<Props, State> {
    ...
    return (
      <div className="time-picker" ref={this.pickerTriggerRef}>
        <div className="time-picker-buttons">
          {isAbsolute && (
            <button className="btn navbar-button navbar-button--tight radius-right-0" onClick={onMoveBackward}>
              <i className="fa fa-chevron-left" />
            </button>
          )}
          <ButtonSelect
            className="time-picker-button-select btn--radius-right-0 "
            value={currentOption}
            label={label}
            options={options}
            maxMenuHeight={600}
          ...
          />
          {true && (
            <button className="btn navbar-button navbar-button--attached">
