...
5.- Unsigned: the plugin is not signed. In this case, as upon Loading Rubix Dashboard checks the plugins signature, Rubix Dashboard will not load or start it. Furthermore, it will write an error message to the server log.
