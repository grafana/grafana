...
Always keep in mind to add text for a tooltip **or** an aria label. The tooltip will be used as the aria-label as well. In case there is an aria-label defined there will **not** be a tooltip.
