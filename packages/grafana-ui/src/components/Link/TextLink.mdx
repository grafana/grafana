...
- _Initial appearence_: Blue and not underlined at first. Through the color prop the user will be able to change this value,
but the rest will be kept. - _On hover_: blue and underlined.
