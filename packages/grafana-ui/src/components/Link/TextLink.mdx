...
- _Initial appearence_: Blue and underlined at first. <br/>
...
- _Initial appearence_: ‘Primary’ color and not underlined at first.
- _On hover_: blue and underlined
  ...
  Through the color prop the user will be able to change this value, but the rest will be kept.{' '}

_Example_: A user renders an external and standalone _text link_ seting the color value to 'disabled'.
The text link will be 'grey', as set by the user, and not underlined at first while blue and underlined when onhover, as it inherits from the standalone default behaviour.

<Preview>
  <TextLink href="https://google.es" color="disabled" inline={false} external>
