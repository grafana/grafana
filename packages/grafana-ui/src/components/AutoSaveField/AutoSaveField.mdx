...
- Do not use if high-impact situations (e.g. deleting a data source)
  <br />
  <br />
...
The `Checkbox` component allows saving an specific value clicking or not the checkbox input.
...
- **Description:** used to inform the user the value of this input will be save automatically. _This is tentative requirement until users become familiar with this pattern_
  <br />
  <br />
...
A change on the input, such as after typing a text or selecting a new option.
