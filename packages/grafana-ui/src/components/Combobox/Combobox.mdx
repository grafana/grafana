...
- `description` - A longer description that describes the choice. If you have a description on one option, it is required on all options. Avoid longer descriptions.
