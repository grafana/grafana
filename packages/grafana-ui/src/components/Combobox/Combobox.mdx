...
- Use this component if you need custom components as options
...
To select an option, you can any `*ByRole` methods, as Combobox has proper roles for accessibility.
