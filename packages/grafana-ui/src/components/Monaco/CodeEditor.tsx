...
loader.config({
  paths: {
    // TODO: use public path, or something? for when grafana is hosted under a subpath
...
class UnthemedCodeEditor extends React.PureComponent<Props> {
  ...
  render() {
    const { height, language, onEditorWillMount } = this.props;
    const value = this.props.value ?? '';

    return <Editor height={height} defaultLanguage={language} defaultValue={value} beforeMount={onEditorWillMount} />;
