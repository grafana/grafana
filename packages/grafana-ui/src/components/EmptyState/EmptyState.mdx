...
<EmptyState variant="initial" message="You haven't created any library panels yet">
...
Use in place of a list of results when a search query or filter returns no results.
