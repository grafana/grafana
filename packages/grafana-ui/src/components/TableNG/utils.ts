...
import { applySort as _applySort } from '../DataGrid/utils';
...
export function applySort(
  ...
  if (hasNestedFrames) {
    return processNestedTableRows(rows, (parents) => _applySort([...parents], fields, sortColumns, columnTypes));
  }

  // Regular sort for tables without nesting
  return _applySort(rows, fields, sortColumns, columnTypes);
}
