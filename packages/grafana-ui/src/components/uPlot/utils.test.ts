...
describe('preparePlotData2', () => {
  ...
  // @TODO: this test dependended on `preparePlotFrame` in the graveyard. should that method in
  // public/app/core/components/GraphNG/utils.ts be moved to this package?
