...
![button emphasis](/button.emphasis.png 'Visual representation of button emphasis')
...
![button sizes](/button.sizes.png 'Visual representation of button sizes')
...
![Icon + Label Button anatomy](/button.anatomy.a.png)
...
![Icon Button anatomy](/button.anatomy.b.png)
