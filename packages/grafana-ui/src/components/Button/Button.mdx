...
When using a button please always follow a11y rules and make sure the context in which the button is located is also communicated by screen readers. If necessary add an aria label.
