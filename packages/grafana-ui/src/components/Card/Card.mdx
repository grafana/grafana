...
<ul>
  <Card
    ...
    description="Card that is rendered as li element."
    tag='li'
  />
  <Card
    title="List card item"
...
A Card can have a disabled state, effectively making it and its actions non-clickable. If there is more than one primary action, disabled state will disable them instead of the whole card.
