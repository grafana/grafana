...
### Basic
A basic Card component expects at least a heading to be used as it's heading. Optionally a `metaData` prop is accepted, which can be used to provide some extra information for the card, or to be used as a description text. Multiple meta data elements can be provided as an array, in which case they will be separated by a horizontal line: `|`.
```jsx
<Card
