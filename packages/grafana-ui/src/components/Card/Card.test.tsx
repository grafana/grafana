    ...
    it('Children should be independently enabled or disabled if explicitly set', () => {
      const { rerender } = render(
        <Card>
          ...
          <Card.SecondaryActions>
            <IconButton name="trash-alt" tooltip="Delete" disabled />
          </Card.SecondaryActions>
        </Card>
      );
      ...
      rerender(
        <Card disabled>
          ...
          <Card.SecondaryActions>
            <IconButton name="trash-alt" tooltip="Delete" disabled={false} />
          </Card.SecondaryActions>
        </Card>
      );
    ...
    it('Children should be conditional', () => {
      ...
      render(
        <Card>
          ...
          <Card.SecondaryActions>
            {shouldNotRender && <IconButton name="trash-alt" tooltip="Delete" disabled={false} />}
          </Card.SecondaryActions>
        </Card>
      );
