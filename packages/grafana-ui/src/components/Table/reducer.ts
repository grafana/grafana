...
import { TableSortByFieldState, GrafanaTableColumn, GrafanaTableState, GeneralTableProps } from './types';
...
export function useTableStateReducer({ onColumnResize, onSortByChange, data }: GeneralTableProps) {
  return useCallback(
