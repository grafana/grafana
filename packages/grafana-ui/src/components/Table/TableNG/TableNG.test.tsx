...
describe('TableNG', () => {
  ...
  describe('Pagination', () => {
    it('stacks pagination below the grid when the column sidebar is open', async () => {
      ...
      expect(pager.parentElement).toBe(grid.parentElement);
      expect(window.getComputedStyle(grid.parentElement!).display).toBe('flex');
      expect(window.getComputedStyle(grid.parentElement!).flexDirection).toBe('column');
