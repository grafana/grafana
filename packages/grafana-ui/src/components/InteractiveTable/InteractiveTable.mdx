...
It is a wrapper around [React Table](https://react-table-v7.tanstack.com/), for more information about it, refer to the [official documentation](https://react-table.tanstack.com/docs/overview).
