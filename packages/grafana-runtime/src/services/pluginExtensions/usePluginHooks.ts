...
export type UsePluginHooks = (options: UsePluginLinksOptions) => UsePluginLinksResult;

let singleton: UsePluginHooks | undefined;

export function setPluginHooksHook(hook: UsePluginHooks): void {
