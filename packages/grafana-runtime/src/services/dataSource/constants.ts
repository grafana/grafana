...
export const FALLBACK_TO_LEGACY_LIST_ITEM_WARNING = `DataSource: getDataSourceInstanceListItem found nothing in the new cache but the legacy DataSourceSrv did — falling back`;
...
export const RUNTIME_DATASOURCE_SYNC_CONFLICT_WARNING = `DataSource: legacy runtime registration replaced a conflicting async cache entry`;
