...
export function transformV2(
  ...
  response = JSON.parse(
    '{"data":[{"refId":"A","meta":{"type":"heatmap-cells","typeVersion":[0,0],"custom":{"calculatedMinStep":120000},"executedQueryString":"Expr: sum by(phase) (rate(cs_coordinator_txn_duration_seconds{namespace=~\\"cs-tenant-stackblitz\\"}[4m0s]))\\nStep: 2m0s"},"fields":[{"name":"xMax","type":"time","typeInfo":{"frame":"time.Time"},"labels":{},"config":{"interval":120000},"values":[],"entities":{}},{"name":"yMin","type":"number","typeInfo":{"frame":"float64"},"labels":{},"config":{"displayNameFromDS":"success"},"values":[],"entities":{}},{"name":"yMax","type":"number","typeInfo":{"frame":"float64"},"labels":{},"config":{},"values":[],"entities":{}},{"name":"count","type":"number","typeInfo":{"frame":"float64"},"labels":{},"config":{},"values":[],"entities":{}},{"name":"yLayout","type":"number","typeInfo":{"frame":"int8"},"labels":{},"config":{},"values":[],"entities":{}}],"length":0}],"state":"Done","traceIds":["cb5c494632af9d2c94520b8adc8b0eba"]}'
  );
