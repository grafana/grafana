...
export const PromExploreExtraField = memo(({ query, datasource, onChange, onRunQuery }: PromExploreExtraFieldProps) => {
  ...
  return (
    <div aria-label="Prometheus extra field" className="gf-form-inline" data-testid={exploreTestIds.extraFieldEditor}>
      {/*Query type field*/}
      <div
        data-testid={exploreTestIds.queryTypeField}
        className={cx(
      ...
      {/*Step field*/}
      <div
        data-testid={exploreTestIds.stepField}
        className={cx(
          'gf-form',
          css`
            flex-wrap: nowrap;
