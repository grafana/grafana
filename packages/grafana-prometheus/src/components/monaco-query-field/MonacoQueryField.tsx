...
const MonacoQueryField = (props: Props) => {
  ...
  const { languageProvider, history, onBlur, onRunQuery, initialValue, placeholder, datasource, timeRage } = props;
    ...
    >
      <ReactMonacoEditor
        ...
        onMount={(editor, monaco) => {
          ...
          const completionProvider = getCompletionProvider(monaco, dataProvider, timeRage);
