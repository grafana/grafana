 ...
 */
export class PrometheusLanguageProvider extends LanguageProvider implements PrometheusLanguageProviderInterface {
  ...
  /**
   * Same start logic but it uses resource clients.
   */
