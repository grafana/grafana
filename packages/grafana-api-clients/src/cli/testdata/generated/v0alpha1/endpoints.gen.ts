...
export type AppsdktestSettingsSpec = {
  /** can be executed */
  enabled?: boolean;
  jsonData?: {
    [key: string]: any;
...
export type Settings = {
  ...
  secure?: {
    [key: string]: InlineSecureValue;
  };
  spec?: AppsdktestSettingsSpec;
};
...
export const {
  ...
  useLazyGetSettingsHealthQuery,
  useGetSettingsResourcesQuery,
  useLazyGetSettingsResourcesQuery,
} = injectedRtkApi;
