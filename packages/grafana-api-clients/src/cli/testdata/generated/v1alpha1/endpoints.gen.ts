  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      deletecollectionTestResource: build.mutation<
        ...
        DeletecollectionTestResourceApiArg
      >({
        query: (queryArg) => ({
          url: `/testresources`,
          method: 'DELETE',
...
export type GetFooApiResponse = unknown;
export type GetFooApiArg = void;
...
export type GetBarApiResponse = unknown;
export type GetBarApiArg = void;
export type ListTestResourceApiResponse = /** status 200 OK */ TestResourceList;
export type ListTestResourceApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type CreateTestResourceApiResponse = /** status 200 OK */
  | TestResource
  | /** status 201 Created */ TestResource
  | /** status 202 Accepted */ TestResource;
export type CreateTestResourceApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed */
  dryRun?: string;
...
export type GetTestResourceApiResponse = /** status 200 OK */ TestResource;
export type GetTestResourceApiArg = {
...
export type GetBazApiResponse = unknown;
export type GetBazApiArg = {
...
export type ReplaceTestResourceStatusApiResponse = /** status 200 OK */
  | TestResource
  | /** status 201 Created */ TestResource;
export type ReplaceTestResourceStatusApiArg = {
  /** name of the TestResource */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdateTestResourceStatusApiResponse = /** status 200 OK */
  | TestResource
  | /** status 201 Created */ TestResource;
export type UpdateTestResourceStatusApiArg = {
  /** name of the TestResource */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type TestResourceSpec = {
  description: string;
  /** dummy is a demo field. The validator rejects the object if dummy == "forbidden". */
  dummy: string;
  title: string;
};
export type TestResourceOperatorState = {
...
export type TestResourceStatus = {
  ...
  operatorStates?: {
    [key: string]: TestResourceOperatorState;
  };
};
...
export const {
  ...
  useLazyListTestResourceQuery,
  useCreateTestResourceMutation,
  useDeletecollectionTestResourceMutation,
  useGetTestResourceQuery,
  useLazyGetTestResourceQuery,
  ...
  useLazyGetTestResourceStatusQuery,
  useReplaceTestResourceStatusMutation,
  useUpdateTestResourceStatusMutation,
} = injectedRtkApi;
