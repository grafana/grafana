...
export type SearchResultsFacets = { [key: string]: FacetResult };
 ...
 * The datasource
 */
export type DataResponseDatasource = {
...
Possible enum values:
 ...
 - `"log-lines"` 
 */
export type DataResponseResultAssertionsType =
  (typeof DataResponseResultAssertionsType)[keyof typeof DataResponseResultAssertionsType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DataResponseResultAssertionsType = {
  '': '',
 ...
 */
export type DataResponseResultAssertions = {
  /** Maximum frame count */
  maxFrames?: number;
  /** Type asserts that the frame matches a known type structure.
...
Possible enum values:
 ...
 - `"numeric-long"` 
 - `"log-lines"`  */
  type?: DataResponseResultAssertionsType;
  /**
 ...
 */
export type DataResponseTimeRange = {
...
/**
 * Generic query properties
 */
export interface DataResponse {
  /** The datasource */
  datasource?: DataResponseDatasource;
...
It can be used to distinguish different types of queries. */
  ...
  refId?: string;
  /** Optionally define expected query result behavior */
  resultAssertions?: DataResponseResultAssertions;
  /** TimeRange represents the query range
NOTE: unlike generic /ds/query, we can now send explicit time values in each query
NOTE: the values for timeRange are not saved in a dashboard, they are constructed on the fly */
  timeRange?: DataResponseTimeRange;
  [key: string]: unknown;
}
...
export interface LibraryPanelList {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion?: string;
  items: LibraryPanel[];
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
...
export interface LibraryPanelStatus {
 ...
 */
export type SnapshotSpecDashboard = { [key: string]: { [key: string]: unknown } };

export interface SnapshotSpec {
  /** The raw dashboard (unstructured for now) */
  dashboard?: SnapshotSpecDashboard;
...
export type ListLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type CreateLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type DeletecollectionLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type GetLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type ReplaceLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type DeleteLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type UpdateLibraryPanelParams = {
  /**
   * If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
   */
  pretty?: string;
...
export type SearchDashboardsAndFoldersParams = {
  /**
   * user query string
   */
  query?: string;
   ...
   */
  type?: SearchDashboardsAndFoldersType;
  /**
   ...
   */
  permission?: SearchDashboardsAndFoldersPermission;
  /**
   * sortable field
   */
  sort?: string;
...
export type SearchDashboardsAndFoldersType =
  (typeof SearchDashboardsAndFoldersType)[keyof typeof SearchDashboardsAndFoldersType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SearchDashboardsAndFoldersType = {
  Folder: 'folder',
  Dashboard: 'dashboard',
} as const;

export type SearchDashboardsAndFoldersPermission =
  (typeof SearchDashboardsAndFoldersPermission)[keyof typeof SearchDashboardsAndFoldersPermission];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SearchDashboardsAndFoldersPermission = {
  View: 'view',
  Edit: 'edit',
  Admin: 'admin',
} as const;

export type GetSortableFields200 = {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion?: string;
...
export type ListSnapshotParams = {
  /**
   * allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.
   */
  allowWatchBookmarks?: boolean;
