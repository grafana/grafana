...
export type CommitOptions = {
  ...
  /** When true, commits made through the UI are authored as the acting Grafana user (their name and email). When false, the default Grafana identity is used as the author. */
