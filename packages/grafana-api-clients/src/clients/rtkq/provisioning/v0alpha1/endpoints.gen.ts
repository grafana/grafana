...
export type CommitOptions = {
  /** Email used as the commit author and committer. Must match the signing key's identity and a verified email on the account where the matching public key is registered. When empty, defaults to "noreply@grafana.com". */
  authorEmail?: string;
  /** Name used as the commit author and committer. Required for the signing key's identity to match the commit, which providers need to mark commits as Verified. When empty, defaults to "Grafana". */
  authorName?: string;
  ...
  enforceTemplate?: boolean;
  /** Format of the key in secure.signingKey. One of "gpg", "ssh", or "smime". When empty, defaults to "gpg".
