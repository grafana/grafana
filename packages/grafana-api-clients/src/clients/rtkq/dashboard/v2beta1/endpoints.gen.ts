...
export type DashboardAnnotationQueryPlacement = string;
...
export type DashboardDashboardCursorSync = 'Crosshair' | 'Tooltip' | 'Off';
...
export type DashboardDataTopic = 'series' | 'annotations' | 'alertStates';
...
export type DashboardHttpRequestMethod = 'GET' | 'PUT' | 'POST' | 'DELETE' | 'PATCH';
export type DashboardFetchOptions = {
  body?: string;
  headers?: string[][];
  method: DashboardHttpRequestMethod;
...
export type DashboardActionType = 'fetch' | 'infinity';
export type DashboardActionVariableType = string;
...
export type DashboardFieldColorModeId =
  | 'thresholds'
  | 'palette-classic'
  ...
  | 'fixed'
  | 'shades';
export type DashboardFieldColorSeriesByMode = 'min' | 'max' | 'last';
export type DashboardFieldColor = {
  /** The fixed color value for fixed or shades color modes. */
  fixedColor?: string;
  mode: DashboardFieldColorModeId;
  seriesBy?: DashboardFieldColorSeriesByMode;
};
...
export type DashboardMappingType = 'value' | 'range' | 'regex' | 'special';
...
export type DashboardSpecialValueMatch = 'true' | 'false' | 'null' | 'nan' | 'null+nan' | 'empty';
export type DashboardSpecialValueMap = {
  options: {
    match: DashboardSpecialValueMatch;
    result: DashboardValueMappingResult;
  };
  type: DashboardMappingType;
};
export type DashboardValueMapping =
  | DashboardValueMap
  | DashboardRangeMap
  | DashboardRegexMap
  | DashboardSpecialValueMap;
export type DashboardNullValueMode = 'null' | 'connected' | 'null as zero';
export type DashboardThresholdsMode = 'absolute' | 'percentage';
...
export type DashboardFieldConfig = {
  ...
  mappings?: DashboardValueMapping[];
  ...
  noValue?: string;
  nullValueMode?: DashboardNullValueMode;
...
export type DashboardElement = DashboardPanelKind | DashboardLibraryPanelKind;
export type DashboardElementReference = {
  kind: string;
  name: string;
};
export type DashboardRepeatMode = string;
...
export type DashboardTabsLayoutTabSpec = {
  conditionalRendering?: DashboardConditionalRenderingGroupKind;
  layout: DashboardGridLayoutKind | DashboardRowsLayoutKind | DashboardAutoGridLayoutKind | DashboardTabsLayoutKind;
...
export type DashboardRowsLayoutRowSpec = {
  ...
  fillScreen?: boolean;
  hideHeader?: boolean;
  layout: DashboardGridLayoutKind | DashboardAutoGridLayoutKind | DashboardTabsLayoutKind | DashboardRowsLayoutKind;
...
export type DashboardDashboardLinkPlacement = string;
export type DashboardDashboardLinkType = 'link' | 'dashboards';
export type DashboardDashboardLink = {
  ...
  tooltip: string;
  type: DashboardDashboardLinkType;
...
export type DashboardVariableHide = 'dontHide' | 'hideLabel' | 'hideVariable' | 'inControlsMenu';
export type DashboardVariableRefresh = 'never' | 'onDashboardLoad' | 'onTimeRangeChanged';
export type DashboardVariableRegexApplyTo = 'value' | 'text';
export type DashboardVariableSort =
  | 'disabled'
  | 'alphabeticalAsc'
  | 'alphabeticalDesc'
  | 'numericalAsc'
...
export type DashboardQueryVariableSpec = {
  ...
  regex: string;
  regexApplyTo?: DashboardVariableRegexApplyTo;
  skipUrlSync: boolean;
  sort: DashboardVariableSort;
...
export type DashboardVariableKind =
