...
export type MergedPreferencesApiResponse = /** status 200 undefined */ {
...
export type PreferencesSpec = {
  /** Bitwise flags that will hide help modals in the UI NOTE: this property is only valid on user preferences */
  helpFlags1?: number;
