...
export const addTagTypes = ['API Discovery', 'AlertRule', 'PrometheusRuleGroup', 'RecordingRule'] as const;
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      listPrometheusRuleGroup: build.query<ListPrometheusRuleGroupApiResponse, ListPrometheusRuleGroupApiArg>({
        query: (queryArg) => ({
          url: `/prometheusrulegroups`,
          params: {
            pretty: queryArg.pretty,
            allowWatchBookmarks: queryArg.allowWatchBookmarks,
            continue: queryArg['continue'],
        ...
        providesTags: ['PrometheusRuleGroup'],
      }),
      createPrometheusRuleGroup: build.mutation<CreatePrometheusRuleGroupApiResponse, CreatePrometheusRuleGroupApiArg>({
        query: (queryArg) => ({
          url: `/prometheusrulegroups`,
          method: 'POST',
        ...
        invalidatesTags: ['PrometheusRuleGroup'],
      }),
      getPrometheusRuleGroup: build.query<GetPrometheusRuleGroupApiResponse, GetPrometheusRuleGroupApiArg>({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}`,
          params: {
            pretty: queryArg.pretty,
          },
        }),
      ...
      replacePrometheusRuleGroup: build.mutation<
        ReplacePrometheusRuleGroupApiResponse,
        ReplacePrometheusRuleGroupApiArg
      >({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}`,
          method: 'PUT',
      ...
      deletePrometheusRuleGroup: build.mutation<DeletePrometheusRuleGroupApiResponse, DeletePrometheusRuleGroupApiArg>({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}`,
          method: 'DELETE',
          params: {
      ...
      updatePrometheusRuleGroup: build.mutation<UpdatePrometheusRuleGroupApiResponse, UpdatePrometheusRuleGroupApiArg>({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}`,
          method: 'PATCH',
          body: queryArg.patch,
      ...
      getPrometheusRuleGroupStatus: build.query<
        GetPrometheusRuleGroupStatusApiResponse,
        GetPrometheusRuleGroupStatusApiArg
      >({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}/status`,
          params: {
            pretty: queryArg.pretty,
          },
        }),
      ...
      replacePrometheusRuleGroupStatus: build.mutation<
        ReplacePrometheusRuleGroupStatusApiResponse,
        ReplacePrometheusRuleGroupStatusApiArg
      >({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}/status`,
          method: 'PUT',
      ...
      updatePrometheusRuleGroupStatus: build.mutation<
        UpdatePrometheusRuleGroupStatusApiResponse,
        UpdatePrometheusRuleGroupStatusApiArg
      >({
        query: (queryArg) => ({
          url: `/prometheusrulegroups/${queryArg.name}/status`,
          method: 'PATCH',
...
export type ListPrometheusRuleGroupApiResponse = /** status 200 OK */ PrometheusRuleGroupList;
export type ListPrometheusRuleGroupApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
...
export type CreatePrometheusRuleGroupApiResponse = /** status 200 OK */
  | PrometheusRuleGroup
  | /** status 201 Created */ PrometheusRuleGroup
  | /** status 202 Accepted */ PrometheusRuleGroup;
export type CreatePrometheusRuleGroupApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed */
  dryRun?: string;
...
export type GetPrometheusRuleGroupApiResponse = /** status 200 OK */ PrometheusRuleGroup;
export type GetPrometheusRuleGroupApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
};
export type ReplacePrometheusRuleGroupApiResponse = /** status 200 OK */
  | PrometheusRuleGroup
  | /** status 201 Created */ PrometheusRuleGroup;
export type ReplacePrometheusRuleGroupApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type DeletePrometheusRuleGroupApiResponse = /** status 200 OK */ Status | /** status 202 Accepted */ Status;
export type DeletePrometheusRuleGroupApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdatePrometheusRuleGroupApiResponse = /** status 200 OK */
  | PrometheusRuleGroup
  | /** status 201 Created */ PrometheusRuleGroup;
export type UpdatePrometheusRuleGroupApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type GetPrometheusRuleGroupStatusApiResponse = /** status 200 OK */ PrometheusRuleGroup;
export type GetPrometheusRuleGroupStatusApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
};
export type ReplacePrometheusRuleGroupStatusApiResponse = /** status 200 OK */
  | PrometheusRuleGroup
  | /** status 201 Created */ PrometheusRuleGroup;
export type ReplacePrometheusRuleGroupStatusApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdatePrometheusRuleGroupStatusApiResponse = /** status 200 OK */
  | PrometheusRuleGroup
  | /** status 201 Created */ PrometheusRuleGroup;
export type UpdatePrometheusRuleGroupStatusApiArg = {
  /** name of the PrometheusRuleGroup */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type PrometheusRuleGroupPromDuration = string;
export type PrometheusRuleGroupPrometheusRule = {
  alert?: string;
  annotations?: {
    [key: string]: string;
  };
  expr: string;
  for?: PrometheusRuleGroupPromDuration;
  keepFiringFor?: PrometheusRuleGroupPromDuration;
  labels?: {
    [key: string]: string;
  };
  record?: string;
};
export type PrometheusRuleGroupSpec = {
  interval?: PrometheusRuleGroupPromDuration;
  labels?: {
    [key: string]: string;
  };
  limit?: number;
  name: string;
  queryOffset?: PrometheusRuleGroupPromDuration;
  rules: PrometheusRuleGroupPrometheusRule[];
};
export type PrometheusRuleGroupOperatorState = {
  /** descriptiveState is an optional more descriptive state field which has no requirements on format */
  descriptiveState?: string;
  /** details contains any extra information that is operator-specific */
  details?: {
...
export type PrometheusRuleGroupStatus = {
  /** additionalFields is reserved for future use */
  additionalFields?: {
    [key: string]: any;
  };
  /** operatorStates is a map of operator ID to operator state evaluations.
    Any operator which consumes this kind SHOULD add its state evaluation information to this field. */
  operatorStates?: {
    [key: string]: PrometheusRuleGroupOperatorState;
  };
};
export type PrometheusRuleGroup = {
  ...
  kind: string;
  metadata: ObjectMeta;
  spec: PrometheusRuleGroupSpec;
  status?: PrometheusRuleGroupStatus;
};
export type PrometheusRuleGroupList = {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion?: string;
...
export const {
  ...
  useListPrometheusRuleGroupQuery,
  useLazyListPrometheusRuleGroupQuery,
  useCreatePrometheusRuleGroupMutation,
  useGetPrometheusRuleGroupQuery,
  useLazyGetPrometheusRuleGroupQuery,
  useReplacePrometheusRuleGroupMutation,
  useDeletePrometheusRuleGroupMutation,
  useUpdatePrometheusRuleGroupMutation,
  useGetPrometheusRuleGroupStatusQuery,
  useLazyGetPrometheusRuleGroupStatusQuery,
  useReplacePrometheusRuleGroupStatusMutation,
  useUpdatePrometheusRuleGroupStatusMutation,
