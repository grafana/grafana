...
COPY public.authentik_blueprints_blueprintinstance (created, last_updated, managed, instance_uuid, name, metadata, path, context, last_applied, last_applied_hash, status, enabled, managed_models) FROM stdin;
...
2022-10-25 09:00:53.291824+00	2022-10-25 09:10:17.864408+00	\N	f999866c-2729-44cd-aee3-53e3df227bd6	Default - Invalidation flow	{"name": "Default - Invalidation flow", "labels": {}}	default/10-flow-default-invalidation-flow.yaml	{}	2022-10-25 09:10:17.864412+00	d9226b45bce626036c2fdbd22a0bf9619b1f9cf9c4ad455381627643a000586d8c5d5f605b82df1775336a758529595e70eb29531e28c0e20a9f6dba79c8bd6a	successful	t	{}
...
COPY public.authentik_core_source (policybindingmodel_ptr_id, name, slug, enabled, authentication_flow_id, enrollment_flow_id, managed, user_matching_mode, user_path_template) FROM stdin;
...
COPY public.authentik_flows_flow (flow_uuid, name, slug, designation, policybindingmodel_ptr_id, title, background, compatibility_mode, layout, denied_action) FROM stdin;
c6e83269-3b5e-4f2a-8014-f198578240c1	Welcome to authentik! Please select a username.	default-source-enrollment	enrollment	63e07f88-3fd7-4180-807f-470bb3209bac	Welcome to authentik! Please select a username.		f	stacked	message_continue
7bd42149-dc52-445a-bd1e-4513c50d01dd	Pre-Authentication	default-source-pre-authentication	stage_configuration	081ce9e5-201f-48e9-af60-7c10076f0857	Pre-authentication		f	stacked	message_continue
7c801f5d-8952-4b95-9f6c-385af22e798d	default-oobe-setup	initial-setup	stage_configuration	db71b00d-8d55-4ce6-a1a4-8fa8be93e810	Welcome to authentik!		f	stacked	message_continue
0bcbad7c-01fc-4ed0-b3f1-a1671683d6b3	default-authenticator-static-setup	default-authenticator-static-setup	stage_configuration	c4f758ad-0e74-4b1a-a1bc-32ae3a370b69	Setup Static OTP Tokens		f	stacked	message_continue
35537410-5840-48ee-ba54-76f2a7d42617	default-authenticator-totp-setup	default-authenticator-totp-setup	stage_configuration	62e82cc0-d670-4f23-8d7b-14675757dd8c	Setup Two-Factor authentication		f	stacked	message_continue
611b3458-aadd-47c1-b37e-1940bc72ede7	default-authenticator-webauthn-setup	default-authenticator-webauthn-setup	stage_configuration	3d7a1eb4-72c2-44dd-bdf7-741750024ce2	Setup WebAuthn		f	stacked	message_continue
4ca3e92c-7f33-4d2f-bb5e-1efa4c6c902a	Welcome to authentik!	default-source-authentication	authentication	181928f0-b530-4858-bee9-376597ac63ed	Welcome to authentik!		f	stacked	message_continue
4b14409d-da92-4b6c-91e8-bad06d0966c2	Change Password	default-password-change	stage_configuration	65c208d9-e145-4259-bb87-deecf97c3643	Change password		f	stacked	message_continue
3b01d5c4-0d46-4bfe-b37f-553a7b4d051c	Authorize Application	default-provider-authorization-explicit-consent	authorization	ab6b7aa3-82da-4972-9158-7b7fc70ab973	Redirecting to %(app)s		f	stacked	message_continue
c4257191-cb7a-4120-9566-a38ba8a50248	Welcome to authentik!	default-authentication-flow	authentication	5be1e1aa-8051-417e-b03a-1a0e87cd8101	Welcome to authentik!		f	stacked	message_continue
2287d235-72aa-4d23-80a2-44278d7c7839	Logout	default-invalidation-flow	invalidation	7c8e66c0-7a12-42bd-901f-a88fcd742a5e	Default Invalidation Flow		f	stacked	message_continue
a7ef54bb-7959-4559-979d-9345c022e086	Authorize Application	default-provider-authorization-implicit-consent	authorization	cba52268-0d9a-40bd-ae7f-b723f5e05671	Redirecting to %(app)s		f	stacked	message_continue
1d2dd494-c62d-438a-8d0b-f864084f883c	User settings	default-user-settings-flow	stage_configuration	71205979-10a2-41db-9e08-c05f1644f732	Update your info		f	stacked	message_continue
87ca9599-5323-451c-8603-2f5bee7a0c12	ldap-authentication-flow	ldap-authentication-flow	authentication	105415a2-7753-4a7f-bdf5-ed9841420289	ldap-authentication-flow		f	stacked	message_continue
\.
...
COPY public.authentik_stages_authenticator_validate_authenticatorvalida499c (stage_ptr_id, not_configured_action, device_classes, last_auth_threshold) FROM stdin;
b461e46b-7c2f-4188-b4a7-7a4df1c2c142	skip	{static,totp,webauthn,duo,sms}	seconds=0
\.
...
COPY public.authentik_stages_invitation_invitation (invite_uuid, expires, fixed_data, created_by_id, single_use, expiring, name) FROM stdin;
\.
...
COPY public.authentik_stages_prompt_prompt (prompt_uuid, field_key, label, type, required, placeholder, "order", sub_text, placeholder_expression) FROM stdin;
8cbc609d-e3f5-43e6-9134-078ac015b0e6	oobe-header-text	oobe-header-text	static	t	Welcome to authentik! Please set a password for the default admin user, akadmin.	100		f
75430f27-c76f-4a41-863a-ca2603ed855d	password	Password	password	t	Password	300		f
c75f2e96-7892-43c0-94b8-815962250d00	password_repeat	Password (repeat)	password	t	Password (repeat)	301		f
...
COPY public.authentik_stages_user_write_userwritestage (stage_ptr_id, create_users_as_inactive, create_users_group_id, user_path_template) FROM stdin;
dfc93c1c-c398-4e8f-aa34-fdc21b6accfb	f	\N	
e87982c6-2f31-4dc5-bdce-2f680601c023	f	\N	
9934f0fc-b4b4-44e0-a90d-7587844ac68b	f	\N	
\.
...
162	authentik_policies_hibp	0001_initial	2022-10-25 09:00:56.011974+00
163	authentik_policies_hibp	0002_haveibeenpwendpolicy_password_field	2022-10-25 09:00:56.021012+00
164	authentik_policies_hibp	0003_haveibeenpwendpolicy_authentik_p_policy__6957d7_idx	2022-10-25 09:00:56.030132+00
...
SELECT pg_catalog.setval('public.django_migrations_id_seq', 382, true);
...
--
-- Name: authentik_p_policy__6957d7_idx; Type: INDEX; Schema: public; Owner: authentik
--

CREATE INDEX authentik_p_policy__6957d7_idx ON public.authentik_policies_hibp_haveibeenpwendpolicy USING btree (policy_ptr_id);
