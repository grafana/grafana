...
test.use({ viewport: { width: 1000, height: 1440 }, featureToggles: { annotationsClustering: false } });

test.describe('Panels test: Annotations - deprecated', { tag: ['@panels', '@annotations'] }, () => {
