...
| `CanvasGridAddActions` | `CanvasGridAddActions.ts`     | Add/group/ungroup action buttons in the dashboard canvas               | `getAction(name)`, `clickAction(name)`, `clickLastAction(name)`                                                                                                                                                     |
| `EditPaneHeader`       | `EditPaneHeader.ts`           | Header buttons in the selected element edit pane                       | `getButton(name)`, `clickButton(name)`                                                                                                                                                                              |
| `Row`                  | `Row.ts`                      | Dashboard row layout elements                                          | `getTitle(title)`, `getWrapper(title)`, `getTitleInput()`, `select(title)`, `toggle(title)`                                                                                                                         |
| `Tab`                  | `Tab.ts`                      | Dashboard tab layout elements                                          | `getTitle(title)`, `getTitleInput()`, `select(title)`                                                                                                                                                               |
