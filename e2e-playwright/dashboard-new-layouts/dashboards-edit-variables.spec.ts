...
test.describe(
  ...
  () => {
    ...
    test('can make a hidden variable visible', async ({ dashboardPage, page, controls, sidebar }) => {
    ...
    test('can hide variable under the controls menu', async ({ dashboardPage, page, controls, sidebar }) => {
