...
test.describe(
  ...
  () => {
    test('should be able to repeat a panel vertically', async ({ gotoDashboardPage, dashboardPage, selectors }) => {
    ...
    test('loads a dashboard based on the query params correctly', async ({
      ...
      await gotoDashboardPage({ uid: `${PAGE_UNDER_TEST}?var-vertical=1&var-vertical=3` });
