...
func (s *Service) RegisterModels(ctx context.Context, models ...kubecontroller.Interface) error {
...
func GenerateScheme(models []kubecontroller.Interface) (*runtime.Scheme, error) {
